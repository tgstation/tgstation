...
.revenant					{color: #5000A0;}
.revenant_bold				{color: #5000A0;	font-weight: bold;}
.revenant_italics			{color: #5000A0;	font-style: italic;}
.revenant_emphasis			{color: #5000A0;	font-weight: bold;	font-style: italic;}
.revenant_large			{color: #5000A0;	font-size: 3;}
