...
/datum/species/slugcat
	...
	death_sound = 'modular_doppler/species/scugs/sounds/scugdeath.ogg'
...
/datum/species/slugcat/get_scream_sound(mob/living/carbon/human/scug)
	return pick(
		'modular_doppler/species/scugs/sounds/scugscream_1.ogg',
	)
...
/datum/species/lizard/get_laugh_sound(mob/living/carbon/human/scug)
	return 'modular_doppler/species/scugs/sounds/scuglaugh_1.ogg'
