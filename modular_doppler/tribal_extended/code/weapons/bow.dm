/obj/item/gun/ballistic/bow/tribalbow
	icon = 'modular_doppler/tribal_extended/icons/projectile.dmi'
	lefthand_file = 'modular_doppler/tribal_extended/icons/bows_lefthand.dmi'
	righthand_file = 'modular_doppler/tribal_extended/icons/bows_righthand.dmi'
