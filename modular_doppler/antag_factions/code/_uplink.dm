...
/datum/antagonist/traitor/on_gain()
	...
	while (!faction) // spin up a thing so people can choose what they want
		...
		if (istype(faction_choice, /datum/antag_faction/none))
			return
	...
	uplink_handler.add_telecrystals(faction.bonus_tc)
...
/datum/antagonist/traitor/proc/query_antag_faction_choice(datum/source, mob/chooser)
