...
/datum/sprite_accessory/snouts/slugcat
	icon = 'modular_doppler/modular_species/species_types/slugcats/icons/slugcat_external.dmi'
	name = "Slugcat"
...
/datum/sprite_accessory/tails/lizard/slugcat
	icon = 'modular_doppler/modular_species/species_types/slugcats/icons/slugcat_tails.dmi'
	name = "Slugcat"
	icon_state = "scug_std"
...
/datum/sprite_accessory/lizard_markings/slugcat
	icon = 'modular_doppler/modular_species/species_types/slugcats/icons/slugcat_markings.dmi'
