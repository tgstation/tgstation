...
/obj/machinery/computer/custom_shuttle/Initialize(mapload)
	. = ..()
 ...
 */
/obj/machinery/computer/custom_shuttle/proc/launch_check(mob/user)
...
**/
/obj/machinery/computer/custom_shuttle/proc/get_valid_destinations()
 ...
 */
/obj/machinery/computer/custom_shuttle/proc/send_shuttle(dest_id, mob/user)
...
/obj/machinery/computer/custom_shuttle/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
	if(!allowed(usr))
...
/obj/machinery/computer/custom_shuttle/emag_act(mob/user, obj/item/card/emag/emag_card)
...
/obj/machinery/computer/custom_shuttle/connect_to_shuttle(mapload, obj/docking_port/mobile/port, obj/docking_port/stationary/dock)
	if(!mapload)
		return
	if(!port)
		return
