...
/obj/item/supermatter_replacer/attack_self(mob/user, modifiers)
	...
	var/turf/supermatter_corner = locate(supermatter.x, supermatter.y, supermatter.z) // have to do a little bit of coord manipulation to get it in the right spot
