...
/obj/item/supermatter_replacer/attack_self(mob/user, modifiers)
	var/area/thunderdome = GLOB.areas_by_type[/area/station/engineering/supermatter/room]
	...
	var/turf/thunderdome_corner = locate(thunderdome.x, thunderdome.y, thunderdome.z) // have to do a little bit of coord manipulation to get it in the right spot
