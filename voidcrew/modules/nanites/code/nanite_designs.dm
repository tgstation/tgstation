/datum/design/nanites
	...
	id = "default_nanites" //DESIGN_ID_IGNORE can't use this because it will error as it isn't checked in '/datum/asset/spritesheet/proc/queuedInsert'

	build_type = NANITE_PROGRAM
	category = list()
...
/datum/design/nanites/metabolic_synthesis
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_UTILITY,
	)
...
/datum/design/nanites/regenerative
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_MEDICAL,
	)
...
/datum/design/nanites/nervous
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_AUGMENTATION,
	)
...
/datum/design/nanites/glitch
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_DEFECTIVE,
	)
...
/datum/design/nanites/flesh_eating
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_WEAPONIZED,
	)
...
/datum/design/nanites/shock
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_SUPRESSION,
	)
...
/datum/design/nanites/sensor_health
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_SENSOR,
	)
...
/datum/design/nanites/kickstart
	...
	category = list(
		RND_CATEGORY_NANITE_PROGRAMS + RND_SUBCATEGORY_NANITE_PROTOCOL,
	)
