/datum/map_generator/cave_generator/lavaland
	...
	mob_spawn_list = list(
		/mob/living/simple_animal/hostile/asteroid/goliath/beast/wasteland = 50, /obj/structure/spawner/lavaland/goliath = 3, \
		/mob/living/basic/mining/basilisk = 40, /obj/structure/spawner/lavaland = 3, \
