// Wardtakahashi Surplus (хламовый уровень)
...
// Wardtakahashi Normal (стандартный уровень, cyborg)
...
// Wardtakahashi Advanced (продвинутый уровень)

/obj/item/bodypart/arm/left/robot/advanced/wardtakahashi
	should_draw_greyscale = FALSE
	icon_state = "robotic_l_arm"
	is_emissive = FALSE
	icon_static = 'modular_bandastation/augmentation_preferences/icons/wardtakahashi_augments.dmi'
...
/obj/item/bodypart/arm/right/robot/advanced/wardtakahashi
	should_draw_greyscale = FALSE
	icon_state = "robotic_r_arm"
	is_emissive = FALSE
	icon_static = 'modular_bandastation/augmentation_preferences/icons/wardtakahashi_augments.dmi'
...
/obj/item/bodypart/leg/left/robot/advanced/wardtakahashi
	should_draw_greyscale = FALSE
	icon_state = "robotic_l_leg"
	is_emissive = FALSE
	icon_static = 'modular_bandastation/augmentation_preferences/icons/wardtakahashi_augments.dmi'
...
/obj/item/bodypart/leg/right/robot/advanced/wardtakahashi
	should_draw_greyscale = FALSE
	icon_state = "robotic_r_leg"
	is_emissive = FALSE
	icon_static = 'modular_bandastation/augmentation_preferences/icons/wardtakahashi_augments.dmi'
