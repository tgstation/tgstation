/datum/preference/choiced/species_feature/tajaran_head_markings
...
/datum/preference/choiced/species_feature/tajaran_head_markings/get_accessory_list()
	return SSaccessories.feature_list[FEATURE_TAJARAN_HEAD_MARKINGS]

/datum/preference/choiced/species_feature/tajaran_head_markings/icon_for(value)
...
/datum/preference/choiced/species_feature/tajaran_head_markings/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features[FEATURE_TAJARAN_HEAD_MARKINGS] = value

/datum/preference/choiced/species_feature/tajaran_head_markings/compile_constant_data()
	var/list/data = ..()
