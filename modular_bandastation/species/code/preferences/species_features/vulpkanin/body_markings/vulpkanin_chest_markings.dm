/datum/preference/choiced/species_feature/vulpkanin_chest_markings
	savefile_key = "feature_vulpkanin_chest_markings"
...
/datum/preference/choiced/species_feature/vulpkanin_chest_markings/get_accessory_list()
	return SSaccessories.feature_list[FEATURE_VULPKANIN_CHEST_MARKINGS]

/datum/preference/choiced/species_feature/vulpkanin_chest_markings/icon_for(value)
	...
	if(value != SPRITE_ACCESSORY_NONE)
		...
		var/datum/universal_icon/body_marking_icon = uni_icon(\
			markings.icon,\
			"[markings.gender_specific ? "male_" : ""][markings.icon_state]_[/obj/item/bodypart/chest/vulpkanin::body_zone]"\
		)
...
/datum/preference/choiced/species_feature/vulpkanin_chest_markings/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features[FEATURE_VULPKANIN_CHEST_MARKINGS] = value

/datum/preference/choiced/species_feature/vulpkanin_chest_markings/compile_constant_data()
	var/list/data = ..()
