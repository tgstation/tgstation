...
/datum/area_spawn
	...
	/// See code/__DEFINES/~nemesis_defines/automapper.dm
	var/mode = AREA_SPAWN_MODE_OPEN
	/// Map blacklist, this is used to determine what maps we should not spawn on.
	var/list/blacklisted_stations = list("Runtime Station", "MultiZ Debug", "Gateway Test", "Minimal Runtime Station")
...
/obj/effect/turf_test
	name = "PASS"
	icon = 'modular_nemesis/modules/automapper/icons/area_test.dmi'
