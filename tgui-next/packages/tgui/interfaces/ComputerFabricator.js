...
import { Box, Button, LabeledList, NumberInput, Section, Grid, Table, Tooltip } from '../components';
import { multiline } from 'common/string';

// This had a pretty gross backend so this was unfortunately one of the best ways of doing it.
export const CFScreen = props => {
  const { state } = props;
            ...
            <Grid width="100%">
              <Grid.Item width="50%">
                <Button
                  ...
                  fontSize="30px"
                  lineHeight="50px"
                  onClick={() => act(ref, "pick_device", {pick: "1"})}
                />
              </Grid.Item>
              <Grid.Item width="50%">
                <Button
                  ...
                  fontSize="30px"
                  lineHeight="50px"
                  onClick={() => act(ref, "pick_device", {pick: "2"})}
                />
              </Grid.Item>
            </Grid>
          </Box>
          ...
          <Table width="100%">
            <Table.Row>
              ...
              >
                ...
                <Tooltip
                  content={multiline`
                    Allows your device to operate without external utility power source.
                    Advanced batteries increase battery life.
                  `}
                  position="right"
                />
              </Table.Cell>
              <Table.Cell >
                <Button
                  ...
                  onClick={() => act(ref, "hw_battery", {battery: "1"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_battery", {battery: "2"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_battery", {battery: "3"})}
                />
              </Table.Cell>
            </Table.Row>
            <Table.Row>
              ...
              >
                ...
                <Tooltip
                  content={multiline`
                    Stores file on your device.
                    Advanced drives can store more files, but use more power, shortening battery life.
                  `}
                  position="right"
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_disk", {disk: "1"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_disk", {disk: "2"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_disk", {disk: "3"})}
                />
              </Table.Cell>
            </Table.Row>
            <Table.Row>
              ...
              >
                ...
                <Tooltip
                  content={multiline`
                    Allows your device to wirelessly connect to stationwide NTNet network.
                    Basic cards are limited to on-station use, while advanced cards can operate anywhere near
                    the station, which includes asteroid outposts
                  `}
                  position="right"
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_netcard", {netcard: "0"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_netcard", {netcard: "1"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_netcard", {netcard: "2"})}
                />
              </Table.Cell>
            </Table.Row>
            <Table.Row>
              ...
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_nanoprint", {print: "0"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_nanoprint", {print: "1"})}
                />
              </Table.Cell>
            </Table.Row>
            <Table.Row>
              ...
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_card", {card: "0"})}
                />
              </Table.Cell>
              <Table.Cell>
                <Button
                  ...
                  onClick={() => act(ref, "hw_card", {card: "1"})}
                />
              </Table.Cell>
            </Table.Row>
            {data.devtype !== 2 && (
                ...
                <Table.Row>
                  ...
                  <Table.Cell>
                    <Button
                      ...
                      onClick={() => act(ref, "hw_tesla", {tesla: "0"})}
                    />
                  </Table.Cell>
                  <Table.Cell>
                    <Button
                      ...
                      onClick={() => act(ref, "hw_tesla", {tesla: "1"})}
                    />
                  </Table.Cell>
                </Table.Row>
              </Fragment>
