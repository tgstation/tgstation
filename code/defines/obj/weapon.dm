...
/obj/item/weapon/fakecash
	name = "play money"
	desc = "Some fake money used for pretend economics."
	gender = PLURAL
	icon = 'icons/obj/economy.dmi'
	icon_state = "spacecash10"
	opacity = 0
...
/obj/item/weapon/fakecash/New()
	icon_state = "spacecash[pick(10,20,50,100,200,500,1000)]"
