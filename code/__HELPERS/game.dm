...
/proc/AnnounceArrival(var/mob/living/carbon/human/character, var/rank)
	...
	deadchat_broadcast("<span class='game'><span class='name'>[character.real_name]</span> ([rank])", " has arrived at the station at <span class='name'>[A.name]</span>.", follow_target = character, message_type=DEADCHAT_ARRIVALRATTLE)
