 ...
 * HTML renderers collapse multiple whitespaces into one, trims prepending and appending spaces, alongside other things. This proc attempts to do the same thing.
