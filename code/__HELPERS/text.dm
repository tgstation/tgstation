 ...
 * Returns: ["coefficient" = si unit coefficient, "unit" = prefixed si unit.]
 */
/proc/siunit_isolated(value, unit, maxdecimals=1)
	...
	. = list("coefficient" = coefficient, "unit" = " [prefix][unit]")
...
/proc/siunit(value, unit, maxdecimals=1)
	...
	return "[si_isolated["coefficient"]][si_isolated["unit"]]"
