...
// These macros exist to help working with this system, and other associated small bits

/// Takes an atom to change the plane of, a new plane value. Something that can be used as a reference to a z level as input
