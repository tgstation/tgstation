...
/client/proc/browse_files(root="data/logs/", max_iterations=10, list/valid_extensions=list(".txt",".log",".htm"))
	...
	if( !fexists(path) || !(extension in valid_extensions) )
		src << "<font color='blue'>Error: browse_files(): File not found/Invalid file([path]).</font>"
		return
...
/client/proc/file_spam_check()
	...
	if(time_to_wait > 0)
		src << "<font color='blue'>Error: file_spam_check(): Spam. Please wait [round(time_to_wait/10)] seconds.</font>"
		return 1
