...
var/list/WALLITEMS = list(
	...
	"/obj/structure/mirror", "/obj/structure/closet/fireaxecabinet", "/obj/structure/closet/fireaxecabinet/empty", 
	"/obj/machinery/computer/security/telescreen/entertainment", "obj/structure/sign"
	)
