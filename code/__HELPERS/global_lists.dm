...
/proc/make_datum_references_lists()
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/tails/kobold, GLOB.tails_list_kobold)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/diaper, GLOB.diaper_list)
