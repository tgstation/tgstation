...
/mob/log_message(message, message_type, color = null, log_globally = TRUE)
	...
	var/list/timestamped_message = list("\[[time_stamp(format = "YYYY-MM-DD hh:mm:ss")]\] [key_name(src)] ([src.tag]) [loc_name(src)] (Event #[LAZYLEN(logging[smessage_type])])" = colored_message)
