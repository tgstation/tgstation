...
/proc/random_features()
	...
	if(!antennae_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/antennae, antennae_list)
	if(!ears_list.len)
