...
/proc/random_underwear(gender)
	if(!ACCESSORIES.underwear_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/underwear, ACCESSORIES.underwear_list, ACCESSORIES.underwear_m, ACCESSORIES.underwear_f)
	switch(gender)
		if(MALE)
			return pick(ACCESSORIES.underwear_m)
		if(FEMALE)
			return pick(ACCESSORIES.underwear_f)
		else
			return pick(ACCESSORIES.underwear_list)

/proc/random_undershirt(gender)
	if(!ACCESSORIES.undershirt_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/undershirt, ACCESSORIES.undershirt_list, ACCESSORIES.undershirt_m, ACCESSORIES.undershirt_f)
	switch(gender)
		if(MALE)
			return pick(ACCESSORIES.undershirt_m)
		if(FEMALE)
			return pick(ACCESSORIES.undershirt_f)
		else
			return pick(ACCESSORIES.undershirt_list)

/proc/random_socks()
	if(!ACCESSORIES.socks_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/socks, ACCESSORIES.socks_list)
	return pick(ACCESSORIES.socks_list)
...
/proc/random_hairstyle(gender)
	switch(gender)
		if(MALE)
			return pick(ACCESSORIES.hairstyles_male_list)
		if(FEMALE)
			return pick(ACCESSORIES.hairstyles_female_list)
		else
			return pick(ACCESSORIES.hairstyles_list)

/proc/random_facial_hairstyle(gender)
	switch(gender)
		if(MALE)
			return pick(ACCESSORIES.facial_hairstyles_male_list)
		if(FEMALE)
			return pick(ACCESSORIES.facial_hairstyles_female_list)
		else
			return pick(ACCESSORIES.facial_hairstyles_list)
