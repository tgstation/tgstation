<<<<<<< HEAD:code/modules/atmospherics/machinery/components/unary_devices/cryo.dm
	...
	switch(action)
		...
		if("ejectbeaker")
			if(beaker)
				...
				. = TRUE
	update_icon()
>>>>>>> dbd4169c0e4c4afad12aa45d35bc095f56f20461:code/ATMOSPHERICS/components/unary_devices/cryo.dm
