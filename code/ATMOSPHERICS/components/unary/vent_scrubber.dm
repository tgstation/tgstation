...
/obj/machinery/atmospherics/unary/vent_scrubber/update_icon_nopipes()
	overlays.Cut()
	if(showpipe)
		overlays += image('icons/obj/atmospherics/unary_devices.dmi', icon_state="scrub_cap", dir=initialize_directions)
...
/obj/machinery/atmospherics/unary/vent_scrubber/attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
	if (!istype(W, /obj/item/weapon/wrench))
		return ..()
	if (!(stat & NOPOWER) && on)
		user << "<span class='notice'>You cannot unwrench this [src], turn it off first.</span>"
		return 1
	return ..()
