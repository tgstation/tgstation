...
//Spawns the rest of the commando gear.
	for (var/obj/effect/landmark/L in landmarks_list)
		if (L.name == "Commando_Manual")
			...
			var/obj/item/office/paper/P = new(L.loc)
...
/mob/living/carbon/human/proc/equip_death_commando(leader_selected = 0)
	...
	equip_to_slot_or_del(new /obj/item/weapon/ammo/magazine/a357(src), slot_in_backpack)
	...
	equip_to_slot_or_del(new /obj/item/tool/flashlight(src), slot_in_backpack)
	if (!leader_selected)
		equip_to_slot_or_del(new /obj/item/weapon/plastique(src), slot_in_backpack)
	else
		equip_to_slot_or_del(new /obj/item/device/pinpointer(src), slot_in_backpack)
		equip_to_slot_or_del(new /obj/item/office/disk/nuclear(src), slot_in_backpack)
	...
	var/obj/item/medical/implant/loyalty/L = new/obj/item/medical/implant/loyalty(src)//Here you go Deuryn
	L.imp_in = src
	L.implanted = 1



	var/obj/item/security/card/id/W = new(src)
