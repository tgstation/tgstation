...
GLOBAL_LIST_EMPTY(crafting_recipe_items) //list of all crafting recipe requirement items
GLOBAL_LIST_EMPTY(crafting_recipe_items_blacklist) //list of blacklisted crafting recipe items
