GLOBAL_LIST_INIT(generic_ambience,
	list('sound/ambience/ambigen1.ogg','sound/ambience/ambigen3.ogg',
...
GLOBAL_LIST_INIT(holy_ambience,
	list('sound/ambience/ambicha1.ogg','sound/ambience/ambicha2.ogg',
...
GLOBAL_LIST_INIT(danger_ambience,
	list('sound/ambience/ambidanger.ogg', 'sound/ambience/ambidanger2.ogg'))

GLOBAL_LIST_INIT(ruins_ambience,
	list('sound/ambience/ambimine.ogg','sound/ambience/ambicave.ogg',
...
GLOBAL_LIST_INIT(engi_ambience,
	list('sound/ambience/ambisin1.ogg','sound/ambience/ambisin2.ogg',
...
GLOBAL_LIST_INIT(mining_ambience,
	list('sound/ambience/ambimine.ogg','sound/ambience/ambicave.ogg',
		'sound/ambience/ambiruin.ogg','sound/ambience/ambiruin2.ogg',
		'sound/ambience/ambiruin3.ogg','sound/ambience/ambiruin4.ogg',
		'sound/ambience/ambiruin5.ogg','sound/ambience/ambiruin6.ogg',
...
GLOBAL_LIST_INIT(medical_ambience,
	list('sound/ambience/ambinice.ogg'))

GLOBAL_LIST_INIT(spooky_ambience,
	list('sound/ambience/ambimo1.ogg','sound/ambience/ambimo2.ogg',
		'sound/ambience/ambiruin7.ogg','sound/ambience/ambiruin6.ogg',
		'sound/ambience/ambiodd.ogg','sound/ambience/ambimystery.ogg'))

GLOBAL_LIST_INIT(space_ambience,
	list('sound/ambience/ambispace.ogg','sound/ambience/ambispace2.ogg',
		'sound/ambience/title2.ogg','sound/ambience/ambiatmos.ogg'))

GLOBAL_LIST_INIT(maint_ambience,
	list('sound/ambience/ambimaint1.ogg','sound/ambience/ambimaint2.ogg',
...
GLOBAL_LIST_INIT(away_ambience,
	list('sound/ambience/ambitech.ogg','sound/ambience/ambitech2.ogg',
		'sound/ambience/ambiruin.ogg','sound/ambience/ambiruin2.ogg',
		'sound/ambience/ambiruin3.ogg','sound/ambience/ambiruin4.ogg',
		'sound/ambience/ambiruin5.ogg','sound/ambience/ambiruin6.ogg',
		'sound/ambience/ambiruin7.ogg','sound/ambience/ambidanger.ogg',
...
GLOBAL_LIST_INIT(reebe_ambience,
	list('sound/ambience/ambireebe1.ogg','sound/ambience/ambireebe2.ogg',
		'sound/ambience/ambireebe3.ogg'))

GLOBAL_LIST_INIT(creepy_ambience,
	list('sound/effects/ghost.ogg','sound/effects/ghost2.ogg',
...
GLOBAL_LIST_INIT(ambience_assoc,
	list(AMBIENCE_GENERIC = GLOB.generic_ambience,
