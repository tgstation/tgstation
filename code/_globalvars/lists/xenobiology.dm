...
GLOBAL_LIST_INIT(cell_line_tables, list(
	CELL_LINE_TABLE_DUMPSTER = list(/datum/micro_organism/cell_line/mouse = 3, /datum/micro_organism/cell_line/gelatinous = 2, /datum/micro_organism/cell_line/cockroach = 2)
	))
