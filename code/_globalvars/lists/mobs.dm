...
GLOBAL_LIST_EMPTY(player_list)				//all mobs **with clients attached**. Excludes lobby players
GLOBAL_LIST_EMPTY(mob_list)					//all mobs, including clientless
GLOBAL_LIST_EMPTY(mob_directory)            //mob_id -> mob
GLOBAL_LIST_EMPTY(alive_mob_list)			//all alive mobs, including clientless. Excludes lobby players
GLOBAL_LIST_EMPTY(drones_list)
GLOBAL_LIST_EMPTY(dead_mob_list)			//all dead mobs, including clientless
...
GLOBAL_LIST_EMPTY(lobby_players)
