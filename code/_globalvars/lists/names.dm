...
GLOBAL_LIST_INIT(experiment_names, world.file2list("strings/names/experiment_names.txt"))
GLOBAL_LIST_INIT(russian_names, world.file2list("strings/names/russian_names.txt"))
GLOBAL_LIST_INIT(beef_names, world.file2list("strings/names/beefman_names.txt"))
