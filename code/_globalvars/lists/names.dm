...
GLOBAL_LIST_INIT(wizard_first, world.file2list("strings/names/wizard_first.txt"))
GLOBAL_LIST_INIT(wizard_second, world.file2list("strings/names/wizard_last.txt"))
GLOBAL_LIST_INIT(ninja_titles, world.file2list("strings/names/ninja_title.txt"))
GLOBAL_LIST_INIT(ninja_names, world.file2list("strings/names/ninja_name.txt"))
...
GLOBAL_LIST_INIT(first_names_unisex, world.file2list("strings/names/first_unisex.txt"))
...
GLOBAL_LIST_INIT(megacarp_first_names, world.file2list("strings/names/megacarp_first.txt"))
GLOBAL_LIST_INIT(megacarp_last_names, world.file2list("strings/names/megacarp_last.txt"))
GLOBAL_LIST_INIT(syndicate_prefix, world.file2list("strings/names/syndicate_prefix.txt"))
GLOBAL_LIST_INIT(syndicate_suffix_full, world.file2list("strings/names/syndicate_suffix_full.txt"))
GLOBAL_LIST_INIT(syndicate_suffix_broken_first, world.file2list("strings/names/syndicate_suffix_broken_first.txt"))
GLOBAL_LIST_INIT(syndicate_suffix_broken_second, world.file2list("strings/names/syndicate_suffix_broken_second.txt"))
GLOBAL_LIST_INIT(syndicate_small, world.file2list("strings/names/syndicate_small.txt"))
