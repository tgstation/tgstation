...
GLOBAL_LIST_INIT(first_names_male_us, world.file2list("strings/names/first_male_us.txt"))
GLOBAL_LIST_INIT(first_names_male_mx, world.file2list("strings/names/first_male_mx.txt"))
GLOBAL_LIST_INIT(first_names_female_us, world.file2list("strings/names/first_female_us.txt"))
GLOBAL_LIST_INIT(first_names_female_mx, world.file2list("strings/names/first_female_mx.txt"))
GLOBAL_LIST_INIT(last_names_us, world.file2list("strings/names/last_us.txt"))
GLOBAL_LIST_INIT(last_names_mx, world.file2list("strings/names/last_mx.txt"))
