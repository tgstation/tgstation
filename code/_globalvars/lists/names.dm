...
GLOBAL_LIST_INIT(moth_names_male, world.file2list("strings/names/moth_male.txt"))
GLOBAL_LIST_INIT(moth_names_female, world.file2list("strings/names/moth_female.txt"))
