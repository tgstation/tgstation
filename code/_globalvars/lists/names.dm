...
GLOBAL_LIST_INIT(lizard_name_verbs, world.file2list("strings/names/lizard_verbs.txt"))
GLOBAL_LIST_INIT(lizard_name_nouns, world.file2list("strings/names/lizard_nouns.txt"))
