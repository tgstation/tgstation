...
GLOBAL_LIST_INIT(admin_readable_layers, list(
	...
	"ABOVE_BODY_FRONT_LAYER" = -ABOVE_BODY_FRONT_LAYER,
	"ABOVE_SHOES_LAYER" = -ABOVE_SHOES_LAYER,
	...
	"UNDER_HEAD_LAYER" = -UNDER_HEAD_LAYER,
	"UNDER_SUIT_LAYER" = -UNDER_SUIT_LAYER,
	"UNDER_UNIFORM_LAYER" = -UNDER_UNIFORM_LAYER,
))
