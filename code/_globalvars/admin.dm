...
GLOBAL_LIST_INIT(spanname_to_formatting, list(
	...
	"Phantom Big Notice" = "phantombignotice",
	"Phantom Bold Notice" = "phantomboldnotice",
	"Phantom Danger" = "phantomdanger",
	"Phantom Minor" = "phantomminor",
	"Phantom Notice" = "phantomnotice",
	"Phantom Warning" = "phantomwarning",
	"Robot" = "robot",
	"Rose" = "rose",
	"Comic Sans" = "sans",
