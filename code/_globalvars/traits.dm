...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_SOCIAL_ANXIETY" = TRAIT_SOCIAL_ANXIETY,
		"TRAIT_BIPOLAR" = TRAIT_BIPOLAR,
		"TRAIT_COLLECTOR" = TRAIT_COLLECTOR,
		"TRAIT_PARANOID" = TRAIT_PARANOID,
		"TRAIT_CATATONIA" = TRAIT_CATATONIA,
		...
		"TRAIT_RELAXED" = TRAIT_RELAXED,
		"TRAIT_UNDER_CONTROL" = TRAIT_UNDER_CONTROL,
		"TRAIT_LITHIATED" = TRAIT_LITHIATED,
