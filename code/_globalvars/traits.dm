...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_COLDBLOODED" = TRAIT_COLDBLOODED,// FULP Additions
		"TRAIT_NONATURALHEAL" = TRAIT_NONATURALHEAL, // FULP Additions
		"TRAIT_NORUNNING" = TRAIT_NORUNNING, // FULP Additions
		"TRAIT_NOMARROW" = TRAIT_NOMARROW, // FULP Additions
		"TRAIT_NOPULSE" = TRAIT_NOPULSE, // FULP Additions
