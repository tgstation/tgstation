...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_CHUNKY_FINGERS" = TRAIT_CHUNKY_FINGERS,
		...
		"TRAIT_IGNORE_SLOWDOWN" = TRAIT_IGNORE_SLOWDOWN,
		"TRAIT_IGNORE_DAMAGE_SLOWDOWN" = TRAIT_IGNORE_DAMAGE_SLOWDOWN,
		"TRAIT_DEATH_COMA" = TRAIT_DEATH_COMA,
		"TRAIT_FAKE_DEATH" = TRAIT_FAKE_DEATH,
		"TRAIT_DISFIGURED" = TRAIT_DISFIGURED,
		"TRAIT_XENO_HOST" = TRAIT_XENO_HOST,
		"TRAIT_STUN_IMMUNE" = TRAIT_STUN_IMMUNE,
		"TRAIT_BATON_RESISTANCE" = TRAIT_BATON_RESISTANCE,
		"TRAIT_BATON_COOLDOWN" = TRAIT_BATON_COOLDOWN,
		"TRAIT_SLEEP_IMMUNE" = TRAIT_SLEEP_IMMUNE,
		"TRAIT_PUSH_IMMUNE" = TRAIT_PUSH_IMMUNE,
		"TRAIT_SHOCK_IMMUNE" = TRAIT_SHOCK_IMMUNE,
		"TRAIT_TESLA_SHOCK_IMMUNE" = TRAIT_TESLA_SHOCK_IMMUNE,
		...
		"TRAIT_RESIST_HEAT_HANDS" = TRAIT_RESIST_HEAT_HANDS,
		"TRAIT_RESIST_COLD" = TRAIT_RESIST_COLD,
		"TRAIT_RESIST_HIGH_PRESSURE" = TRAIT_RESIST_HIGH_PRESSURE,
		"TRAIT_RESIST_LOW_PRESSURE" = TRAIT_RESIST_LOW_PRESSURE,
		"TRAIT_BOMB_IMMUNE" = TRAIT_BOMB_IMMUNE,
		"TRAIT_RAD_IMMUNE" = TRAIT_RAD_IMMUNE,
		"TRAIT_GENELESS" = TRAIT_GENELESS,
		"TRAIT_VIRUS_IMMUNE" = TRAIT_VIRUS_IMMUNE,
		"TRAIT_PIERCE_IMMUNE" = TRAIT_PIERCE_IMMUNE,
		"TRAIT_NO_DISMEMBER" = TRAIT_NO_DISMEMBER,
		"TRAIT_FLAME_IMMUNE" = TRAIT_FLAME_IMMUNE,
		"TRAIT_NO_GUNS" = TRAIT_NO_GUNS,
		"TRAIT_NO_HUNGER" = TRAIT_NO_HUNGER,
		"TRAIT_NO_METABOLISM" = TRAIT_NO_METABOLISM,
		"TRAIT_NO_CLONE_LOSS" = TRAIT_NO_CLONE_LOSS,
		"TRAIT_TOX_IMMUNE" = TRAIT_TOX_IMMUNE,
		"TRAIT_EASY_DISMEMBER" = TRAIT_EASY_DISMEMBER,
		"TRAIT_LIMB_ATTACHMENT" = TRAIT_LIMB_ATTACHMENT,
		"TRAIT_NO_LIMB_DISABLE" = TRAIT_NO_LIMB_DISABLE,
		...
		"TRAIT_NO_MOB_SWAP" = TRAIT_NO_MOB_SWAP,
		...
		"TRAIT_TRAIT_MEDIBOTCOMINGTHROUGH" = TRAIT_MEDIBOT_GOTO_PATIENT,
		"TRAIT_PASSTABLE" = TRAIT_PASSTABLE,
		"TRAIT_NO_FLASH" = TRAIT_NO_FLASH,
		...
		"TRAIT_UNDERWATER_BASKETWEAVER" = TRAIT_UNDERWATER_BASKETWEAVER,
		...
		"TRAIT_GLOWING_RED_EYES" = TRAIT_GLOWING_RED_EYES,
	...
	/obj/item/bodypart = list(
		...
		"TRAIT_PLASMA_BURNT" = TRAIT_PLASMA_BURNT,
		),
	/obj/item = list(
	...
	/atom/movable = list(
		...
		"TRAIT_MOVE_VENT_CRAWLING" = TRAIT_MOVE_VENT_CRAWLING,
...
GLOBAL_LIST_INIT(movement_type_trait_to_flag, list(
	...
	TRAIT_MOVE_VENT_CRAWLING = VENTCRAWLING,
