...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/datum = list(
		"TRAIT_FACTION_NEUTRAL" = TRAIT_FACTION_NEUTRAL,
		"TRAIT_FACTION_MINING" = TRAIT_FACTION_MINING,
		"TRAIT_FACTION_ORION" = TRAIT_FACTION_ORION,
		"TRAIT_FACTION_SYNDICATE" = TRAIT_FACTION_SYNDICATE,
		"TRAIT_FACTION_SILICON" = TRAIT_FACTION_SILICON,
		"TRAIT_FACTION_TURRET" = TRAIT_FACTION_TURRET,
		"TRAIT_FACTION_SPIDER" = TRAIT_FACTION_SPIDER,
		"TRAIT_FACTION_NANOTRASEN" = TRAIT_FACTION_NANOTRASEN,
		"TRAIT_FACTION_SKELETON" = TRAIT_FACTION_SKELETON,
		"TRAIT_FACTION_CLOWN" = TRAIT_FACTION_CLOWN,
		"TRAIT_FACTION_BLOB" = TRAIT_FACTION_BLOB,
		"TRAIT_FACTION_HELL" = TRAIT_FACTION_HELL,
		"TRAIT_FACTION_GONDOLA" = TRAIT_FACTION_GONDOLA,
		"TRAIT_FACTION_STATION" = TRAIT_FACTION_STATION,
		"TRAIT_FACTION_WIZARD" = TRAIT_FACTION_WIZARD,
		"TRAIT_FACTION_HOSTILE" = TRAIT_FACTION_HOSTILE,
		"TRAIT_FACTION_ALIEN" = TRAIT_FACTION_ALIEN,
		"TRAIT_FACTION_MONKEY" = TRAIT_FACTION_MONKEY,
		"TRAIT_FACTION_CULT" = TRAIT_FACTION_CULT,
		"TRAIT_FACTION_HERETIC" = TRAIT_FACTION_HERETIC,
		"TRAIT_FACTION_RAT" = TRAIT_FACTION_RAT,
		"TRAIT_FACTION_RUSSIAN" = TRAIT_FACTION_RUSSIAN,
		"TRAIT_FACTION_CARP" = TRAIT_FACTION_CARP,
		"TRAIT_FACTION_SHADOW" = TRAIT_FACTION_SHADOW,
		"TRAIT_FACTION_CREATURE" = TRAIT_FACTION_CREATURE,
		"TRAIT_FACTION_HIVEBOT" = TRAIT_FACTION_HIVEBOT,
		"TRAIT_FACTION_ILLUSION" = TRAIT_FACTION_ILLUSION,
		"TRAIT_FACTION_PLANTS" = TRAIT_FACTION_PLANTS,
		"TRAIT_FACTION_MIMIC" = TRAIT_FACTION_MIMIC,
		"TRAIT_FACTION_MUSHROOM" = TRAIT_FACTION_MUSHROOM,
		"TRAIT_FACTION_NETHER" = TRAIT_FACTION_NETHER,
		"TRAIT_FACTION_SLIME" = TRAIT_FACTION_SLIME,
		"TRAIT_FACTION_PIRATE" = TRAIT_FACTION_PIRATE,
		"TRAIT_FACTION_STATUE" = TRAIT_FACTION_STATUE,
		"TRAIT_FACTION_STICKMAN" = TRAIT_FACTION_STICKMAN,
		"TRAIT_FACTION_JUNGLE" = TRAIT_FACTION_JUNGLE,
		"TRAIT_FACTION_BOSS" = TRAIT_FACTION_BOSS,
		"TRAIT_FACTION_SWARMER" = TRAIT_FACTION_SWARMER,
		"TRAIT_FACTION_ASHWALKER" = TRAIT_FACTION_ASHWALKER,
		"TRAIT_FACTION_NINJA" = TRAIT_FACTION_NINJA,
		"TRAIT_FACTION_GREYTIDE" = TRAIT_FACTION_GREYTIDE,
		"TRAIT_FACTION_LAZARUS" = TRAIT_FACTION_LAZARUS,
		"TRAIT_FACTION_CHEMICAL" = TRAIT_FACTION_CHEMICAL,
		),
	/atom = list(
...
GLOBAL_LIST_INIT(faction_traits, list(
	...
	TRAIT_FACTION_ORION,
	TRAIT_FACTION_SYNDICATE,
	TRAIT_FACTION_SILICON,
	TRAIT_FACTION_TURRET,
	TRAIT_FACTION_SPIDER,
	TRAIT_FACTION_NANOTRASEN,
	TRAIT_FACTION_SKELETON,
	TRAIT_FACTION_CLOWN,
	TRAIT_FACTION_BLOB,
	TRAIT_FACTION_HELL,
	TRAIT_FACTION_GONDOLA,
	TRAIT_FACTION_STATION,
	TRAIT_FACTION_WIZARD,
	TRAIT_FACTION_HOSTILE,
	TRAIT_FACTION_ALIEN,
	TRAIT_FACTION_MONKEY,
	TRAIT_FACTION_CULT,
	TRAIT_FACTION_HERETIC,
	TRAIT_FACTION_RAT,
	TRAIT_FACTION_RUSSIAN,
	TRAIT_FACTION_CARP,
	TRAIT_FACTION_SHADOW,
	TRAIT_FACTION_CREATURE,
	TRAIT_FACTION_HIVEBOT,
	TRAIT_FACTION_ILLUSION,
	TRAIT_FACTION_PLANTS,
	TRAIT_FACTION_MIMIC,
	TRAIT_FACTION_MUSHROOM,
	TRAIT_FACTION_NETHER,
	TRAIT_FACTION_SLIME,
	TRAIT_FACTION_PIRATE,
	TRAIT_FACTION_STATUE,
	TRAIT_FACTION_STICKMAN,
	TRAIT_FACTION_JUNGLE,
	TRAIT_FACTION_BOSS,
	TRAIT_FACTION_SWARMER,
	TRAIT_FACTION_ASHWALKER,
	TRAIT_FACTION_NINJA,
	TRAIT_FACTION_GREYTIDE,
	TRAIT_FACTION_LAZARUS,
	TRAIT_FACTION_CHEMICAL,
	))
