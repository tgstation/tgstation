...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_THICK_SKIN" = TRAIT_THICK_SKIN,
		...
		"TRAIT_MASOCHIST" = TRAIT_MASOCHIST,
		"TRAIT_CRY_BABY" = TRAIT_CRY_BABY,
		"TRAIT_ADDICT_RESISTANCE" = TRAIT_ADDICT_RESISTANCE,
		"TRAIT_ADDICTIVE_PERSONALITY" = TRAIT_ADDICTIVE_PERSONALITY,
		"TRAIT_BULLET_DODGER" = TRAIT_BULLET_DODGER,
		"TRAIT_CONNOISSEUR" = TRAIT_CONNOISSEUR,
		"TRAIT_EXPERT_SLEEPER" = TRAIT_EXPERT_SLEEPER,
		"TRAIT_IRON_STOMACH" = TRAIT_IRON_STOMACH,
		"TRAIT_SUPER_IMMUNE" = TRAIT_SUPER_IMMUNE,
		"TRAIT_SWEET_TOOTH" = TRAIT_SWEET_TOOTH,
		"TRAIT_ATHEIST" = TRAIT_ATHEIST,
		"TRAIT_BAD_KNEES" = TRAIT_BAD_KNEES,
		"TRAIT_LACTOSE_INTOLERANT" = TRAIT_LACTOSE_INTOLERANT,
	),
