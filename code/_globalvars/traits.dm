...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_DEPRESSION_MINIMAL" = TRAIT_DEPRESSION_MINIMAL,
		"TRAIT_DEPRESSION_MILD" = TRAIT_DEPRESSION_MILD,
		"TRAIT_DEPRESSION_MODERATE" = TRAIT_DEPRESSION_MODERATE,
		"TRAIT_DEPRESSION_SEVERE" = TRAIT_DEPRESSION_SEVERE,
