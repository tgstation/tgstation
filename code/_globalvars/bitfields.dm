...
DEFINE_BITFIELD(atom_flags, list(
	...
	"ALLOW_DARK_PAINTS" = ALLOW_DARK_PAINTS,
	"ATMOS_IS_PROCESSING" = ATMOS_IS_PROCESSING,
	"CAN_BE_DIRTY" = CAN_BE_DIRTY,
	"CONDUCT" = CONDUCT,
	"HAS_CONTEXTUAL_SCREENTIPS" = HAS_CONTEXTUAL_SCREENTIPS,
	"HAS_DISASSOCIATED_STORAGE" = HAS_DISASSOCIATED_STORAGE,
	"HOLOGRAM" = HOLOGRAM,
	"INITIALIZED" = INITIALIZED,
	"IS_ONTOP" = IS_ONTOP,
	"IS_PLAYER_COLORABLE" = IS_PLAYER_COLORABLE,
	...
	"SHOCKED" = SHOCKED,
	"SUPERMATTER_IGNORES" = SUPERMATTER_IGNORES,
