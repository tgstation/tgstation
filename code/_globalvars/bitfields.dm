GLOBAL_LIST_INIT(bitfields, list(
	...
	"interaction_flags_atom" = list(
		...
		"INTERACT_ATOM_STANDING" = INTERACT_ATOM_STANDING,
		"INTERACT_ATOM_IGNORE_IMMOBILITY" = INTERACT_ATOM_IGNORE_IMMOBILITY,
		"INTERACT_ATOM_IGNORE_HANDBLOCK" = INTERACT_ATOM_IGNORE_HANDBLOCK,
