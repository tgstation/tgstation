...
DEFINE_BITFIELD(bodyshape, list(
	...
	"BODYSHAPE_CERULEAN" = BODYSHAPE_CERULEAN,
))
...
DEFINE_BITFIELD(supports_variations_flags, list(
	...
	"CLOTHING_CERULEAN_VARIATION" = CLOTHING_CERULEAN_VARIATION,
	"CLOTHING_CERULEAN_MASK_LEGS" = CLOTHING_CERULEAN_MASK_LEGS,
	"CLOTHING_CERULEAN_MASK_INBETWEEN" = CLOTHING_CERULEAN_MASK_INBETWEEN,
))
