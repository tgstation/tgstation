...
DEFINE_BITFIELD(empath_info, list(
...
DEFINE_BITFIELD(smite_targets, list(
	"SMITE_AWAY" = SMITE_AWAY
))

DEFINE_BITFIELD(ghost_role_allow_custom, list(
	"GHOSTROLE_ALLOW_NAME" = GHOSTROLE_ALLOW_NAME,
