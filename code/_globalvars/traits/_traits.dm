...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_GALACTIC_GRANT" = STATION_TRAIT_GALACTIC_GRANT,
		"STATION_TRAIT_BOUNTIFUL_BOUNTIES" = STATION_TRAIT_BOUNTIFUL_BOUNTIES,
		"STATION_TRAIT_SCARVES" = STATION_TRAIT_SCARVES,
		"STATION_TRAIT_IAN_ADVENTURE" = STATION_TRAIT_IAN_ADVENTURE,
		"STATION_TRAIT_DEATHRATTLED_DEPARTMENT" = STATION_TRAIT_DEATHRATTLED_DEPARTMENT,
		"STATION_TRAIT_DEATHRATTLED_ALL" = STATION_TRAIT_DEATHRATTLED_ALL,
		"STATION_TRAIT_SLOW_SHUTTLE" = STATION_TRAIT_SLOW_SHUTTLE,
		"STATION_TRAIT_ION_STORMS" = STATION_TRAIT_ION_STORMS,
		"STATION_TRAIT_RAD_STORMS" = STATION_TRAIT_RAD_STORMS,
		"STATION_TRAIT_BLACKOUT" = STATION_TRAIT_BLACKOUT,
		"STATION_TRAIT_DISTANT_SUPPLYLINES" = STATION_TRAIT_DISTANT_SUPPLYLINES,
	),
