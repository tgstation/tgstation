...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_FARSTAR_SHARED" = TRAIT_FARSTAR_SHARED,
		...
		"TRAIT_FLESH_PECKISH" = TRAIT_FLESH_PECKISH,
		...
		"TRAIT_HAD_FOOTSOLDIERS_RAZOR" = TRAIT_HAD_FOOTSOLDIERS_RAZOR,
		"TRAIT_HAD_LAST_WORD" = TRAIT_HAD_LAST_WORD,
		"TRAIT_HAD_SLEEPY_DRINK" = TRAIT_HAD_SLEEPY_DRINK,
