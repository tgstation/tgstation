...
/turf/closed/wall
	...
	///lower numbers are harder. (hardness - 40) is used as a modifier for objects trying to embed in this (hardness of 30 results in a -10% chance)
	var/hardness = 40
...
/turf/closed/wall/attack_hulk(mob/user)
	...
	take_damage(hulk_damage(), BRUTE, "melee", FALSE, user.dir, hulk_damage())
	return TRUE
