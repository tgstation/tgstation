...
/turf/open/floor/proc/MakeDirty()
	...
	var/static/list/high_dirt_areas = STATIC_INIT(typecacheof(list(
	...
	var/static/list/engine_dirt_areas = STATIC_INIT(typecacheof(list(
	...
	var/static/list/bathroom_dirt_areas = STATIC_INIT(typecacheof(list(
	...
	var/static/list/gib_covered_areas = STATIC_INIT(typecacheof(list(
	...
	var/static/list/kitchen_dirt_areas = STATIC_INIT(typecacheof(list(
	...
	var/static/list/medical_dirt_areas = STATIC_INIT(typecacheof(list(
	...
	var/static/list/science_dirt_areas = STATIC_INIT(typecacheof(list(
