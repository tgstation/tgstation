...
/turf/open/floor/carpet/neon/Initialize(mapload)
	...
	AddElement(/datum/element/decal/emissive, neon_icon || icon, neon_icon_state || base_icon_state, dir, EMISSIVE_PLANE, null, emissive_alpha, GLOB.emissive_color, smoothing_junction)
