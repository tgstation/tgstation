...
/turf/open/floor/carpet/neon/Initialize(mapload)
	...
	AddElement(/datum/element/decal/emissive, neon_icon || icon, neon_icon_state || base_icon_state, null, null, null, emissive_alpha, null, smoothing_junction, null, null, null, EMISSIVE_BLOOM)
