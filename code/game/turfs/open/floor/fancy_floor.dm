...
/turf/open/floor/carpet/money
	name = "money carpet"
	desc = "Soft velvet carpeting. Feels dangerous for your pockets and toes."
	icon = 'icons/turf/floors/carpet_money.dmi'
	icon_state = "money_carpet-255"
	base_icon_state = "money_carpet"
	floor_tile = /obj/item/food/clownbill
	smoothing_groups = list(SMOOTH_GROUP_TURF_OPEN, SMOOTH_GROUP_CARPET_MONEY)
	canSmoothWith = list(SMOOTH_GROUP_CARPET_MONEY)
	var/carpet_damage = 5
	var/heal_amount = 3
...
/turf/open/floor/carpet/money/proc/do_heal(atom/movable/honky_target, delta_time = 1)
	...
	heal_clown_mobs.adjustBruteLoss(-heal_amount * delta_time)
	heal_clown_mobs.adjustFireLoss(-heal_amount * delta_time)
