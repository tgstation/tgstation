...
/turf/closed/wall/r_vall/rcd_vals(mob/user, obj/item/weapon/construction/rcd/the_rcd)
	return FALSE

/turf/closed/wall/r_vall/rcd_act(mob/user, obj/item/weapon/construction/rcd/the_rcd, passed_mode)
	return FALSE