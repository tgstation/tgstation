...
/turf/closed/wall/r_wall/deconstruction_hints(mob/user)
	switch(d_state)
		if(INTACT)
			to_chat(user, "<span class='info'>The outer <b>grille</b> is fully intact.</span>")
		if(SUPPORT_LINES)
			to_chat(user, "<span class='info'>The outer <i>grille</i> has been cut, and the support lines are <b>screwed</b> securely to the outer cover.</span>")
		if(COVER)
			to_chat(user, "<span class='info'>The support lines have been <i>unscrewed</i>, and the metal cover is <b>welded</b> firmly in place.</span>")
		if(CUT_COVER)
			to_chat(user, "<span class='info'>The metal cover has been <i>sliced through</i>, and is <b>connected loosely</b> to the girder.</span>")
		if(ANCHOR_BOLTS)
			to_chat(user, "<span class='info'>The outer cover has been <i>pried away</i>, and the bolts anchoring the support rods are <b>wrenched</b> in place.</span>")
		if(SUPPORT_RODS)
			to_chat(user, "<span class='info'>The bolts anchoring the support rods have been <i>loosened</i>, but are still <b>welded</b> firmly to the girder.</span>")
		if(SHEATH)
			to_chat(user, "<span class='info'>The support rods have been <i>sliced through</i>, and the outer sheath is <b>connected loosely</b> to the girder.</span>")
