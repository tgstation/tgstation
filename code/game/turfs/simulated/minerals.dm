...
/turf/closed/mineral/proc/gets_drilled()
	...
	playsound(src, 'sound/effects/break_stone.ogg', 50, DEFAULT_SOUND_VARY) //beautiful destruction
...
/turf/closed/mineral/attack_alien(mob/living/carbon/alien/M)
	...
	playsound(src, 'sound/effects/break_stone.ogg', 50, DEFAULT_SOUND_VARY)
...
/turf/closed/mineral/gibtonite/gets_drilled(mob/user, triggered_by_explosion = 0)
	if(stage == GIBTONITE_UNSTRUCK && mineralAmt >= 1) //Gibtonite deposit is activated
		playsound(src,'sound/effects/hit_on_shattered_glass.ogg',50,DEFAULT_SOUND_VARY)
