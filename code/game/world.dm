...
/world/proc/SetupLogs()
	...
	GLOB.tgui_error_log = "[GLOB.log_directory]/tgui_error.log"
	GLOB.tgui_debug_log = "[GLOB.log_directory]/tgui_debug.log"
	...
	start_log(GLOB.tgui_error_log)
	start_log(GLOB.tgui_debug_log)
