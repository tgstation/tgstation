...
/obj/structure/barricade/sandbags
	...
	climbable = TRUE
	smooth = SMOOTH_TRUE
	smoothWith = list(/obj/structure/barricade/sandbags, /turf/closed/wall=TRUE, /obj/structure/falsewall, /obj/structure/falsewall/reinforced, /turf/closed/wall/rust, /turf/closed/wall/r_wall/rust, /obj/structure/barricade/security)
