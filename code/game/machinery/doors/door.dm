...
/obj/machinery/door/examine(mob/user)
	...
	if(red_alert_access)
		if(GLOB.security_level >= SEC_LEVEL_RED)
			to_chat(user, "<span class='info'>Due to a security threat, its access requirements have been lifted!</span>")
		else
			to_chat(user, "<span class='info'>In the event of a red alert, its access requirements will automatically lift.</span>")
	if(!poddoor)
		to_chat(user, "<span class='info'>Its maintenance panel is <b>screwed</b> in place.</span>")
