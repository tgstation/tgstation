...
/obj/item/circuit_component/firealarm/register_usb_parent(atom/movable/parent)
	...
	if(istype(parent, /obj/machinery/firealarm))
		...
		register_signal(parent, COMSIG_FIREALARM_ON_TRIGGER, .proc/on_firealarm_triggered)
		register_signal(parent, COMSIG_FIREALARM_ON_RESET, .proc/on_firealarm_reset)

/obj/item/circuit_component/firealarm/unregister_usb_parent(atom/movable/parent)
	attached_alarm = null
	unregister_signal(parent, COMSIG_FIREALARM_ON_TRIGGER)
	unregister_signal(parent, COMSIG_FIREALARM_ON_RESET)
	return ..()
