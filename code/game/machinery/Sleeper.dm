...
/obj/machinery/sleeper
	...
	var/list/possible_chems = list(
		list("epinephrine", "morphine", "salbutamol", "ibuprofen", "naproxen"),
		list("oculine","inacusiate"),
		list("acamprosate", "mutadone", "mannitol", "pen_acid"),
		list("omnizine")
	)
	var/list/chem_buttons	//Used when emagged to scramble which chem is used, eg: acamprosate -> morphine
...
/obj/machinery/sleeper/clockwork
	...
	possible_chems = list(list("epinephrine", "salbutamol", "ibuprofen", "naproxen", "oculine", "inacusiate", "mannitol"))
