...
/obj/machinery/roulette
	...
	var/static/list/numbers = STATIC_INIT(list("0" = "green", "1" = "red", "3" = "red", "5" = "red", "7" = "red", "9" = "red", "12" = "red", "14" = "red", "16" = "red",\
	...
	var/locked = FALSE
	var/drop_dir = SOUTH
	var/static/list/coin_values = STATIC_INIT(list(/obj/item/coin/diamond = 100, /obj/item/coin/gold = 25, /obj/item/coin/silver = 10, /obj/item/coin/iron = 1)) //Make sure this is ordered from left to right.
