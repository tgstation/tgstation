...
/obj/machinery/computer/slot_machine/proc/give_prizes(usrname, mob/user)
	...
	if(reels[1][2] + reels[2][2] + reels[3][2] + reels[4][2] + reels[5][2] == "[SEVEN][SEVEN][SEVEN][SEVEN][SEVEN]")
		visible_message("<b>[src]</b> says, 'JACKPOT! You win [money] Spesos worth of coins!'")
		...
		visible_message("<b>[src]</b> says, 'Big Winner! You win a thousand Spesos worth of coins!'")
		give_money(BIG_PRIZE)

	else if(linelength == 4)
		visible_message("<b>[src]</b> says, 'Winner! You win four hundred Spesos worth of coins!'")
