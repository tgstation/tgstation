...
/obj/machinery/telecomms/message_server/Initialize(mapload)
	...
	if (calibrating)
		...
		pda_msgs += new /datum/data_tablet_msg("System Administrator", "system", "This is an automated message. System calibration started at [server_timestamp(ic_time = TRUE)] (NPT: [round_timestamp()]).")
	else
