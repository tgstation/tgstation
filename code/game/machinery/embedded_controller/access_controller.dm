...
/obj/machinery/doorButtons/access_button/findObjsByTag()
	for(var/obj/machinery/doorButtons/airlock_controller/A in SLOTH.machines)
		if(A.idSelf == idSelf)
			controller = A
			break
	for(var/obj/machinery/door/airlock/I in SLOTH.machines)
		if(I.id_tag == idDoor)
			door = I
			break
...
/obj/machinery/doorButtons/airlock_controller/Destroy()
	for(var/obj/machinery/doorButtons/access_button/A in SLOTH.machines)
		if(A.controller == src)
			A.controller = null
	return ..()
...
/obj/machinery/doorButtons/airlock_controller/findObjsByTag()
	for(var/obj/machinery/door/airlock/A in SLOTH.machines)
