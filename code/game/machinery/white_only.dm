...
/obj/machinery/vending/security/New()
	...
	if(loadgamewhite != 1)
		...
		var/zlv=1
		for(var/i=0;i<3;i++)
			var/obj/item/ammo_box/magazine/white_only/enhanced_traumatic/M1 = new/obj/item/ammo_box/magazine/white_only/enhanced_traumatic()
			M1.x=xlv
			M1.y=ylv
			M1.z=zlv
		for(var/i=0;i<2;i++)
			var/obj/item/ammo_box/magazine/white_only/enhanced_traumatic/lethal/LM0 = new/obj/item/ammo_box/magazine/white_only/enhanced_traumatic/lethal()
			LM0.x=xlv
			LM0.y=ylv
			LM0.z=zlv
