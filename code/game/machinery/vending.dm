...
/obj/machinery/vending/boozeomat
	name = "\improper Drinking Glass Vendor"
	desc = "A drinking glass vendor."
	icon_state = "boozeomat"        //////////////18 drink entities below, plus the glasses, in case someone wants to edit the number of bottles
	icon_deny = "boozeomat-deny"
	products = list(/obj/item/weapon/reagent_containers/food/drinks/drinkingglass = 50,/obj/item/weapon/reagent_containers/food/drinks/ice = 20)
