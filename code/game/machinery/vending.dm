...
/obj/machinery/vending/attackby(obj/item/W, mob/user, params)
	...
	if(istype(W, /obj/item/screwdriver))
		...
		return
	else if(istype(W, /obj/item/device/multimeter/multitool)||istype(W, /obj/item/wirecutters))
		if(panel_open)
			attack_hand(user)
		return
...
/obj/machinery/vending/engivend
	...
	products = list(/obj/item/clothing/glasses/meson/engine = 2, /obj/item/device/multimeter/multitool = 4, /obj/item/electronics/airlock = 10, /obj/item/electronics/apc = 10, /obj/item/electronics/airalarm = 10, /obj/item/stock_parts/cell/high = 10, /obj/item/construction/rcd/loaded = 3, /obj/item/device/geiger_counter = 5, /obj/item/grenade/chem_grenade/smart_metal_foam = 10)
...
/obj/machinery/vending/engineering
	...
	products = list(/obj/item/clothing/under/rank/chief_engineer = 4, /obj/item/clothing/under/rank/engineer = 4, /obj/item/clothing/shoes/sneakers/orange = 4, /obj/item/clothing/head/hardhat = 4,
					...
					/obj/item/crowbar = 12, /obj/item/wirecutters = 12, /obj/item/device/multimeter/multitool = 12, /obj/item/wrench = 12, /obj/item/device/t_scanner = 12,
