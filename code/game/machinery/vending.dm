...
/obj/machinery/vending/security
	...
	icon_deny = "sec-deny"
	req_access_txt = "1"
	products = list(/obj/item/weapon/restraints/handcuffs = 8,/obj/item/weapon/restraints/handcuffs/zipties = 10,/obj/item/weapon/grenade/flashbang = 4,/obj/item/device/flash = 5,
