...
/obj/machinery/bot
	...
	luminosity = 3
	use_power = 0
	var/obj/item/security/card/id/botcard			// the ID card that the bot "holds"
	var/on = 1
...
/obj/machinery/bot/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	else if (istype(W, /obj/item/security/card/emag) && emagged < 2)
		Emag(user)
	else
...
/obj/machinery/bot/bullet_act(var/obj/item/weapon/projectile/Proj)
	health -= Proj.damage
	..()
	healthcheck()
...
/turf/proc/CardinalTurfsWithAccess(var/obj/item/security/card/id/ID)
	var/L[] = new()
...
/proc/LinkBlockedWithAccess(turf/A, turf/B, obj/item/security/card/id/ID)
...
/proc/DirBlockedWithAccess(turf/loc,var/dir,var/obj/item/security/card/id/ID)
