...
var/global/list/autolathe_recipes = list( \
		/* screwdriver removed*/ \
		new /obj/item/chem/glass/bucket(), \
		new /obj/item/tool/crowbar(), \
		new /obj/item/tool/flashlight(), \
		new /obj/item/tool/extinguisher(), \
		new /obj/item/tool/multitool(), \
		new /obj/item/device/scanner/t_ray(), \
		new /obj/item/tool/welder(), \
		new /obj/item/tool/screwdriver(), \
		new /obj/item/part/wirecutters(), \
		new /obj/item/tool/wrench(), \
		new /obj/item/clothing/head/welding(), \
		new /obj/item/part/basic/console_screen(), \
		new /obj/item/part/board/airlock(), \
		new /obj/item/part/board/air_alarm(), \
		new /obj/item/part/board/fire_alarm(), \
		new /obj/item/part/stack/sheet/metal(), \
		...
		new /obj/item/medical/drill(),\
		new /obj/item/medical/retractor(),\
		new /obj/item/medical/cautery(),\
		new /obj/item/medical/hemostat(),\
		new /obj/item/chem/glass/beaker(), \
		new /obj/item/chem/glass/beaker/large(), \
		new /obj/item/weapon/ammo/casing/shotgun/blank(), \
		new /obj/item/weapon/ammo/casing/shotgun/beanbag(), \
		new /obj/item/weapon/ammo/magazine/c38(), \
		new /obj/item/security/recorder(), \
		new /obj/item/part/assembly/igniter(), \
		new /obj/item/part/assembly/signaler(), \
		new /obj/item/device/radio/headset(), \
		new /obj/item/device/radio(), \
		new /obj/item/part/assembly/infra(), \
		new /obj/item/part/assembly/timer(), \
		new /obj/item/part/light/tube(), \
		new /obj/item/part/light/bulb(), \
		new /obj/item/part/frame/camera(), \
	)

var/global/list/autolathe_recipes_hidden = list( \
		new /obj/item/weapon/flamethrower/full(), \
		new /obj/item/tool/rcd(), \
		new /obj/item/device/radio/electropack(), \
		new /obj/item/tool/welder/largetank(), \
		new /obj/item/security/handcuffs(), \
		new /obj/item/weapon/ammo/magazine/a357(), \
		new /obj/item/weapon/ammo/casing/shotgun(), \
		new /obj/item/weapon/ammo/casing/shotgun/dart(), \
...
/obj/machinery/autolathe
	...
	proc
		...
		regular_win(mob/user as mob)
			...
			for(var/obj/t in objs)
				...
				if (istype(t, /obj/item/part/stack))
					var/obj/item/part/stack/S = t
	...
	attackby(var/obj/item/O as obj, var/mob/user as mob)
		...
		if (O.m_amt == 0 && O.g_amt == 0)
			...
			return 1
	/*
		if (istype(O, /obj/item/effect/grab) && src.hacked)
	...
	*/
		...
		var/amount = 1
		var/obj/item/part/stack/stack
		var/m_amt = O.m_amt
		var/g_amt = O.g_amt
		if (istype(O, /obj/item/part/stack))
			stack = O
			amount = stack.amount
			if (m_amt)
					...
					spawn(16)
						...
						spawn(16)
							...
							spawn(16)
								...
								if (multiplier>1)
									var/obj/item/part/stack/S = new_item
									S.amount = multiplier
								busy = 0
								src.updateUsrDialog()
			if(href_list["act"])
	...
	RefreshParts()
		..()
		var/tot_rating = 0
		for(var/obj/item/part/basic/matter_bin/MB in component_parts)
	...
	New()
		...
		component_parts += new /obj/item/part/circuitboard/autolathe(src)
