...
/obj/machinery/autolathe/Initialize(mapload)
	materials = AddComponent( \
		...
		GLOB.materials.materials_by_category[MAT_CATEGORY_ITEM_MATERIAL], \
		0, \
...
/obj/machinery/autolathe/ui_act(action, list/params, datum/tgui/ui)
	...
	for(var/material in design.materials)
		...
		if(istext(material)) // category
			...
			for(var/datum/material/valid_candidate as anything in GLOB.materials.materials_by_category[material])
