...
/obj/machinery/recycler/Initialize()
	AddComponent(/datum/component/material_container, list(MAT_CATEGORY_IRON, MAT_CATEGORY_GLASS, MAT_CATEGORY_PLASMA, MAT_CATEGORY_SILVER, MAT_CATEGORY_GOLD, MAT_CATEGORY_DIAMOND, MAT_CATEGORY_URANIUM, MAT_CATEGORY_BANANIUM, MAT_CATEGORY_TITANIUM, MAT_CATEGORY_BLUESPACE, MAT_CATEGORY_PLASTIC), INFINITY, FALSE, null, null, null, TRUE)
