...
GLOBAL_LIST_INIT(dye_registry, list(
	...
	DYE_REGISTRY_BEDSHEET = list(
		...
		DYE_RED = /obl/item/bedsheet/red/double,
		DYE_ORANGE = /obl/item/bedsheet/orange/double,
		DYE_YELLOW = /obl/item/bedsheet/yellow/double,
		DYE_GREEN = /obl/item/bedsheet/green/double,
		DYE_BLUE = /obl/item/bedsheet/blue/double,
		DYE_PURPLE = /obl/item/bedsheet/purple/double,
		DYE_BLACK = /obl/item/bedsheet/black/double,
		DYE_WHITE = /obl/item/bedsheet/double,
		DYE_RAINBOW = /obl/item/bedsheet/rainbow/double,
		DYE_MIME = /obl/item/bedsheet/mime/double,
		DYE_CLOWN = /obl/item/bedsheet/clown/double,
		DYE_CHAP = /obl/item/bedsheet/chaplain/double,
		DYE_QM = /obl/item/bedsheet/qm/double,
		DYE_LAW = /obl/item/bedsheet/black/double,
		DYE_CAPTAIN = /obl/item/bedsheet/captain/double,
		DYE_HOP = /obl/item/bedsheet/hop/double,
		DYE_HOS = /obl/item/bedsheet/hos/double,
		DYE_CE = /obl/item/bedsheet/ce/double,
		DYE_RD = /obl/item/bedsheet/rd/double,
		DYE_CMO = /obl/item/bedsheet/cmo/double,
		DYE_COSMIC = /obl/item/bedsheet/cosmos/double,
		DYE_SYNDICATE = /obl/item/bedsheet/syndie/double,
		DYE_CENTCOM = /obl/item/bedsheet/centcom/double
	),
