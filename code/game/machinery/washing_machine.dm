...
/obj/item/paper/machine_wash(obj/machinery/washing_machine/WM)
	if(WM.color_source)
		if(istype(WM.color_source, /obj/item/toy/crayon))
			...
			if(istype(WM.color_source, /obj/item/grown/rainbow_flower))
				var/obj/item/grown/rainbow_flower/RF = WM.color_source
...
/obj/machinery/washing_machine/attackby(obj/item/W, mob/user, params)
	...
	if(default_deconstruction_screwdriver(user, null, null, W))
		...
		if(istype(W, /obj/item/toy/crayon) || istype(W, /obj/item/stamp) || istype(W, /obj/item/grown/rainbow_flower))
			color_source = W
		update_icon()
