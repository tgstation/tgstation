...
/obj/machinery/GBP_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/GBP_equipment("Reflector Box x3",			/obj/structure/reflector/box,								5000,	3),
		new /datum/GBP_equipment("Radiation Collector x4",			/obj/machinery/power/rad_collector,						4000,	4),
		new /datum/GBP_equipment("Bluespace RCD x3",			/obj/item/weapon/rcd/arcd,										6000,	3),
		new /datum/GBP_equipment("ERT Hardsuit x5",		/obj/item/clothing/suit/space/hardsuit/ert,							7500,	5),
