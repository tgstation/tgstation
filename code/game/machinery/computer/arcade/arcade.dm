...
/obj/machinery/computer/arcade
	...
	interaction_flags_machine = INTERACT_MACHINE_ALLOW_SILICON|INTERACT_MACHINE_SET_MACHINE|INTERACT_MACHINE_REQUIRES_SIGHT // we don't need to be literate to play video games fam
