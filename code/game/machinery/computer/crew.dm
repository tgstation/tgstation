...
/datum/crewmonitor/ui_data(mob/user)
	...
	. = list(
		...
		"green_alert" = SSsecurity_level.get_current_level_as_number() <= SEC_LEVEL_GREEN,
	)
...
/datum/crewmonitor/proc/update_data(z)
	...
	var/green_alert = SSsecurity_level.get_current_level_as_number() <= SEC_LEVEL_GREEN
	...
	for(var/tracked_mob in GLOB.suit_sensors_list)
		...
		// Location
		if (sensor_mode >= SENSOR_COORDS && green_alert)
