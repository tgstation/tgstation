...
/obj/machinery/computer/prison_shuttle
	...
	circuit = "/obj/item/part/circuitboard/prison_shuttle"
	var/temp = null
	var/hacked = 0
	var/allowedtocall = 0
	var/prison_break = 0
	...
	attackby(I as obj, user as mob)
		if(istype(I, /obj/item/tool/screwdriver))
			...
			if(do_after(user, 20))
				...
				var/obj/item/part/circuitboard/prison_shuttle/M = new /obj/item/part/circuitboard/prison_shuttle( A )
				...
				del(src)
		else if(istype(I,/obj/item/security/card/emag) && (!hacked))
			hacked = 1
