/obj/machinery/computer
	...
	interaction_flags_machine = INTERACT_MACHINE_ALLOW_SILICON|INTERACT_MACHINE_SET_MACHINE|INTERACT_MACHINE_REQUIRES_SIGHT|INTERACT_MACHINE_REQUIRES_LITERACY
	var/brightness_on = 1
