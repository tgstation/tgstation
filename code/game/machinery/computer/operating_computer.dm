...
/obj/machinery/computer/operating/ui_data(mob/user)
	...
	if(blood_id == /datum/reagent/blood)
		data["patient"]["blood_type"] = patient.dna?.blood_type.display_name
	else
		var/datum/reagent/special_blood = GLOB.chemical_reagents_list[blood_id]
		data["patient"]["blood_type"] = patient.dna?.blood_type.display_name || (special_blood ? special_blood.name : blood_id)
