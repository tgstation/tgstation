	...
	switch(action)
		...
		if("print_injector")
			...
			if(is_activator)
				...
				var/base_cd_time = min(MIN_ACTIVATOR_TIMEOUT, abs(HM.instability))
				...
				var/base_cd_time = min(MIN_INJECTOR_TIMEOUT, abs(HM.instability))
		...
		if("print_adv_inj")
			...
			var/base_cd_time = min(MIN_ADVANCED_TIMEOUT, abs(total_stability))
