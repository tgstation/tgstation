...
<BR><b>Severity:</b> [disease.severity]"}
				...
				investigate_log("has deleted all medical records.", INVESTIGATE_RECORDS)
				...
				investigate_log("has deleted the medical records for [active1.fields["name"]].", INVESTIGATE_RECORDS)
				if(active2)
					qdel(active2)
					active2 = null
