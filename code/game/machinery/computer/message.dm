					...
					if("Send")
						...
						if(isnull(PDARec))
							...
							if (!customrecepient.silent)
								...
								customrecepient.audible_message("[bIcon(customrecepient, viewers(customrecepient))] *[customrecepient.ttone]*", null, 3)
								if( customrecepient.loc && ishuman(customrecepient.loc) )
									var/mob/living/carbon/human/H = customrecepient.loc
									to_chat(H, "[bIcon(customrecepient, viewers(H))] <b>Message from [customsender] ([customjob]), </b>\"[custommessage]\" (<a href='byond://?src=\ref[src];choice=Message;skiprefresh=1;target=\ref[src]'>Reply</a>)")
						...
						//Sender is faking as someone who exists
							...
							if (!customrecepient.silent)
								...
								if( customrecepient.loc && ishuman(customrecepient.loc) )
									var/mob/living/carbon/human/H = customrecepient.loc
									to_chat(H, "[bIcon(customrecepient, H)] <b>Message from [PDARec.owner] ([customjob]), </b>\"[custommessage]\" (<a href='byond://?src=\ref[customrecepient];choice=Message;skiprefresh=1;target=\ref[PDARec]'>Reply</a>)")
