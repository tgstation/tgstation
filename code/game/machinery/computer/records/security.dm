...
/obj/machinery/computer/records/security/proc/print_record(mob/user, datum/record/crew/target, list/params)
	...
	switch(params["type"])
		if("missing")
			...
			var/obj/item/poster/wanted/missing/missing_poster = new(null, new_poster_structure = null, mugshot.picture.picture_image, input_alias, input_description, input_header)
		...
		if("wanted")
			...
			var/obj/item/photo/mugshot = target.get_front_photo()
			var/obj/item/poster/wanted/wanted_poster = new(null, new_poster_structure = null, mugshot.picture.picture_image, input_alias, input_description, input_header)
