...
/datum/action/innate/camera_jump/Activate()
	...
	playsound(origin, 'sound/machines/terminal/terminal_prompt.ogg').volume(25).play()
	...
	if(final)
		playsound(origin, 'sound/machines/terminal/terminal_prompt_confirm.ogg').volume(25).play()
		...
		playsound(origin, 'sound/machines/terminal/terminal_prompt_deny.ogg').volume(25).play()
