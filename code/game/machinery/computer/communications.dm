...
/obj/machinery/computer/communications/proc/get_shuttles_for_sale()
	var/dat = ""
	for(var/datum/map_template/shuttle/emergency/E in shuttle_templates)
		var/datum/map_template/shuttle/S = E

		dat += "[S.name] | [S.credit_cost] Credits<BR>"
		dat += "[S.description]<BR>"
		dat += "<A href='?src=\ref[src];buyshuttle=\ref[S]'>(<font color=red><i>Purchase</i></font>)</A>"
	return dat