				...
				if(prob(success))
					...
					if(prob(success*5))
						...
						if(emagged)
							...
							for(var/i, i<=3, i++)
								var/mob/living/animal/hostile/syndicate/ranged/orion/O = new/mob/living/animal/hostile/syndicate/ranged/orion(get_turf(src))
								O.target = usr
...
/mob/living/animal/hostile/syndicate/ranged/orion
