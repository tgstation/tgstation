...
/obj/machinery/wish_granter/attack_hand(var/mob/user as mob)
	...
	if(charges <= 0)
		...
		user.whisper(pick(wish_whispers), heard="kneels before [src] and mumbles sinisterly,", unheard="kneels before [src] and mumbles something sinisterly.", allow_lastwords = 0)
		spawn(10) //OH SHI-
			message_admins("[user] has interacted with [src] (Wish Granter) and is now its powerful avatar!")
