...
/obj/machinery/porta_turret_construct_fixed
	name = "turret frame"
...
/obj/machinery/porta_turret_construct/New()
	..()
	var/obj/machinery/porta_turret_construct_fixed/F = new/obj/machinery/porta_turret_construct_fixed()
	F.loc = src.loc
	qdel(src) //There can be only one

/obj/machinery/porta_turret_construct_fixed/attackby(obj/item/I, mob/user, params)
		...
		if(PTURRET_START_EXTERNAL_ARMOUR)
			if(istype(I, /obj/item/weapon/weldingtool))
				...
				if(do_after(user, 30/I.toolspeed, target = src))
					...
					var/obj/machinery/porta_turret_fixed/turret = new/obj/machinery/porta_turret_fixed(loc)
...
/obj/machinery/porta_turret_construct_fixed/attack_hand(mob/user)
	switch(build_step)
		if(PTURRET_GUN_EQUIPPED)
			build_step = PTURRET_INTERNAL_ARMOUR_ON
...
/obj/machinery/porta_turret_construct_fixed/attack_ai()
	return
