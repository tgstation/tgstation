...
/obj/machinery/porta_turret_cover_fixed
	name = "turret"
...
/obj/machinery/porta_turret_cover_fixed/attack_ai(mob/user)
	. = ..()
	if(.)
		return
...
/obj/machinery/porta_turret_cover_fixed/attack_hand(mob/user)
	. = ..()
	if(.)
		return
...
/obj/machinery/porta_turret_cover_fixed/attackby(obj/item/I, mob/user, params)
...
/obj/machinery/porta_turret_cover_fixed/attacked_by(obj/item/I, mob/user)
	parent_turret.attacked_by(I, user)

/obj/machinery/porta_turret_cover_fixed/can_be_overridden()
	. = 0

/obj/machinery/porta_turret_cover_fixed/emag_act(mob/user)
