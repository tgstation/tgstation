...
/obj/machinery/atmospherics/components/unary/cold_sink/freezer/attack_paw(mob/user as mob)
	return interact(user)
...
/obj/machinery/atmospherics/components/unary/heat_reservoir/heater/attack_paw(mob/user as mob)
	return src.attack_hand(user)
