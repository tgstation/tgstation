...
/obj/machinery/space_heater/proc/heating_examine()
	...
	return span_notice("The status display reads:<br>Heating power: <b>[display_power(heating_energy, convert = TRUE, scheduler = SSair)] at [(efficiency / SPACE_HEATING_COEFFICIENT) * 100]% efficiency.</b><br>Target temperature: <b>[target_temp]°C [min_temp]°C - [max_temp]°C]</b>\n")
...
#undef SPACE_HEATING_COEFFICIENT
