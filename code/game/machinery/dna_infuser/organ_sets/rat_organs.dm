...
/obj/item/organ/heart/rat/on_insert(mob/living/carbon/receiver)
	. = ..()
	if(!. || !ishuman(receiver))
		return
...
/obj/item/organ/heart/rat/on_remove(mob/living/carbon/heartless, special)
	. = ..()
...
/obj/item/organ/tongue/rat/on_insert(mob/living/carbon/tongue_owner, special, drop_if_replaced)
	. = ..()
	RegisterSignal(tongue_owner, COMSIG_CARBON_ITEM_GIVEN, PROC_REF(its_on_the_mouse))

/obj/item/organ/tongue/rat/on_remove(mob/living/carbon/tongue_owner)
	. = ..()
