...
/obj/item/organ/tongue/carp/on_insert(mob/living/carbon/tongue_owner)
	. = ..()
...
/obj/item/organ/tongue/carp/on_remove(mob/living/carbon/tongue_owner)
	. = ..()
	if(!ishuman(tongue_owner))
		return
	var/mob/living/carbon/human/human_receiver = tongue_owner
...
/obj/item/organ/brain/carp/on_insert(mob/living/carbon/brain_owner)
	. = ..()
...
/obj/item/organ/brain/carp/on_remove(mob/living/carbon/brain_owner)
	. = ..()
