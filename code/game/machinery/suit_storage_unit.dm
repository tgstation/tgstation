...
/obj/machinery/suit_storage_unit/process(seconds_per_tick)
	...
	for(var/obj/item/charging in list(mod, suit, helmet, mask, storage))
		var/obj/item/stock_parts/power_store/cell/cell_charging = charging.get_cell()
	...
	for(var/obj/item/stock_parts/power_store/cell/cell as anything in cells_to_charge)
