...
/obj/machinery/suit_storage_unit/proc/cook()
	...
	if(uv_cycles)
		...
		if(uv_super)
			...
			playsound(src, 'sound/machines/airlock/airlock_alien_prying.ogg').vary(TRUE).play()
			...
			playsound(src, 'sound/machines/airlock/airlockclose.ogg').volume(25).vary(TRUE).play()
