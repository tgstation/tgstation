...
/obj/machinery/launchpad/briefcase/MouseDrop(over_object, src_location, over_location)
	...
	if(over_object == usr)
		...
		if(!usr.canUseTopic(src, BE_CLOSE, ismonkey(usr)))
			return
		usr.visible_message("[usr] starts closing [src]...", "<span class='notice'>You start closing [src]...</span>")
...
/obj/item/storage/briefcase/launchpad/attack_self(mob/user)
	...
	user.visible_message("[user] starts setting down [src]...", "<span class='notice'>You start setting up [pad]...</span>")
