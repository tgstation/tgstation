...
#define POINT_OVERFLOW_ALLOWED "ALLOW OVERFLOWING"
#define POINT_OVERFLOW_FILTERS "COMPARE TO FILTERS"
#define POINT_OVERFLOW_HELD "COMPARE TO HELD"
#define POINT_OVERFLOW_FORBIDDEN "DO NOT OVERFLOW"
