...
/obj/machinery/microwave/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(src.broken > 0)
		...
		user << "<span class='danger'>You have no idea what you can cook with this [O].</span>"
		return 1
	src.updateUsrDialog()
...
/obj/machinery/microwave/proc/start()
	src.visible_message("<span class='notice'>The microwave turns on.", "\blue You hear a microwave.</span>")
	src.operating = 1
	src.icon_state = "mw1"
	src.updateUsrDialog()
