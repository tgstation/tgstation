...
/obj/machinery/newscaster
	...
	var/obj/item/office/photo/photo = null
...
/*	if (istype(I, /obj/item/security/card/id) || istype(I, /obj/item/device/pda) ) //Name verification for channels or messages
		if(src.screen == 4 || src.screen == 5)
			if( istype(I, /obj/item/device/pda) )
				...
				var/obj/item/security/card/id/T = I
...
/obj/machinery/newscaster/proc/AttachPhoto(mob/user as mob)
	if(photo)
		...
		photo = null
	if(istype(user.get_active_hand(), /obj/item/office/photo))
...
/*obj/item/office/newspaper/attack_hand(mob/user as mob)
	..()
	world << "derp"*/

obj/item/office/newspaper/attack_self(mob/user as mob)
	if(ishuman(user))
...
obj/item/office/newspaper/Topic(href, href_list)
...
obj/item/office/newspaper/attackby(obj/item/weapon/W as obj, mob/user as mob)
		...
		if(human_user.wear_id)                                      //Newscaster scans you
			if(istype(human_user.wear_id, /obj/item/device/pda) )	//autorecognition, woo!
				...
				if(P.id)
					...
					src.scanned_user = "Unknown"
			else if(istype(human_user.wear_id, /obj/item/security/card/id) )
				var/obj/item/security/card/id/ID = human_user.wear_id
...
/obj/machinery/newscaster/proc/print_paper()
	...
	var/obj/item/office/newspaper/NEWSPAPER = new /obj/item/office/newspaper
	for(var/datum/feed_channel/FC in news_network.network_channels)
