...
/datum/shuttle/salvage/initialize()
	.=..()
	add_dock(/obj/structure/docking_port/destination/salvage/start)
	add_dock(/obj/structure/docking_port/destination/salvage/arrivals)
	add_dock(/obj/structure/docking_port/destination/salvage/north)
	add_dock(/obj/structure/docking_port/destination/salvage/east)
	add_dock(/obj/structure/docking_port/destination/salvage/south)
	add_dock(/obj/structure/docking_port/destination/salvage/mining)
	add_dock(/obj/structure/docking_port/destination/salvage/trading_post)
	add_dock(/obj/structure/docking_port/destination/salvage/clown)
	add_dock(/obj/structure/docking_port/destination/salvage/derelict)
	add_dock(/obj/structure/docking_port/destination/salvage/dj)
	add_dock(/obj/structure/docking_port/destination/salvage/commssat)
	add_dock(/obj/structure/docking_port/destination/salvage/abandoned_ship)

	set_transit_dock(/obj/structure/docking_port/destination/salvage/transit)
...
/obj/structure/docking_port/destination/salvage/start
	areaname = "deep space"

/obj/structure/docking_port/destination/salvage/arrivals
	areaname = "station auxillary docking"

/obj/structure/docking_port/destination/salvage/north
	areaname = "north of the station"

/obj/structure/docking_port/destination/salvage/east
	areaname = "east of the station"

/obj/structure/docking_port/destination/salvage/south
	areaname = "south of the station"

/obj/structure/docking_port/destination/salvage/mining
	areaname = "south-west of the mining asteroid"

/obj/structure/docking_port/destination/salvage/trading_post
	areaname = "trading post"

/obj/structure/docking_port/destination/salvage/clown
	areaname = "clown asteroid"

/obj/structure/docking_port/destination/salvage/derelict
	areaname = "derelict station"

/obj/structure/docking_port/destination/salvage/dj
	areaname = "ruskie DJ station"

/obj/structure/docking_port/destination/salvage/commssat
	areaname = "communications satelite"

/obj/structure/docking_port/destination/salvage/abandoned_ship
