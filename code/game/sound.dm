...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("shoewalk") soundin = pick('sound/effects/shoewalk1.ogg','sound/effects/shoewalk2.ogg','sound/effects/shoewalk3.ogg','sound/effects/shoewalk4.ogg')
			if ("shoerun") soundin = pick('sound/effects/shoerun1.ogg','sound/effects/shoerun2.ogg','sound/effects/shoerun3.ogg','sound/effects/shoerun4.ogg')
			if ("bootwalk") soundin = pick('sound/effects/bootwalk1.ogg','sound/effects/bootwalk2.ogg','sound/effects/bootwalk3.ogg','sound/effects/bootwalk4.ogg')
			if ("bootrun") soundin = pick('sound/effects/bootrun1.ogg','sound/effects/bootrun2.ogg','sound/effects/bootrun3.ogg','sound/effects/bootrun4.ogg')
