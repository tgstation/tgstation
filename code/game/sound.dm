...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if("humanfemale")
				soundin = pick('sound/voice/speech/female1.ogg', 'sound/voice/speech/female2.ogg', 'sound/voice/speech/female3.ogg', 'sound/voice/speech/female4.ogg')
			if("humanneuter")
				soundin = pick('sound/voice/speech/neuter.ogg')
			if("lizard")
