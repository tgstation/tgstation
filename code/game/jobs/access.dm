...
/proc/get_centcom_access(job)
	switch(job)
		...
		if("Emergency Responder")
			return (get_ert_access() | list(access_cent_general, access_cent_ert))
		if("Emergency Responders Leader")
			return (get_ert_access() | list(access_cent_general, access_cent_ert, access_change_ids, access_heads, access_captain))
		if("Death Commando")
