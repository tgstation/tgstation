...
/datum/job/hos/equip_items(var/mob/living/carbon/human/H)
	if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Trenchcoat")
	...
	else if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Greatcoat")
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/head_of_security(H), slot_w_uniform)
...
/datum/job/warden/equip_items(var/mob/living/carbon/human/H)
	...
	if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Navy Jacket")
		H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/warden(H), slot_wear_suit)
	else if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Red Jacket")
...
/datum/job/detective/equip_items(var/mob/living/carbon/human/H)
	...
	else if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Noir")
