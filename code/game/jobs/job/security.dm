...
/datum/job/hos
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/security (H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_sec(H), slot_back)
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/heads/hos(H), slot_ears)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/armor/hos(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/black(H), slot_gloves)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/HoS(H), slot_head)
...
/datum/job/warden
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_sec(H), slot_ears)
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/security(H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_sec(H), slot_back)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/armor/vest/warden(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/warden(H), slot_head)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/black(H), slot_gloves)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/glasses/sunglasses/sechud(H), slot_glasses)
//		H.equip_to_slot_or_qdel(new /obj/item/clothing/mask/gas(H), slot_wear_mask) //Grab one from the armory you donk
...
/datum/job/detective
	...
	equip(var/mob/living/carbon/human/H)
		...
		CIG.light("")
		H.equip_to_slot_or_qdel(CIG, slot_wear_mask)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/black(H), slot_gloves)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/det_suit(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/weapon/lighter/zippo(H), slot_l_store)
...
/datum/job/officer
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/armor/vest(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet(H), slot_head)
