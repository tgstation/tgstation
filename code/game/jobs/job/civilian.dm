...
/datum/job/bartender
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_srv(H), slot_ears)
...
/datum/job/qm
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_cargo(H), slot_ears)
...
/datum/job/mining
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_cargo (H), slot_ears)
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/industrial (H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_eng(H), slot_back)
...
//		H.equip_to_slot_or_qdel(new /obj/item/clothing/gloves/black(H), slot_gloves)
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_qdel(new /obj/item/weapon/mining_voucher(H), slot_in_backpack)
		return 1
...
/datum/job/clown
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/weapon/reagent_containers/food/snacks/grown/banana(H, 50), slot_in_backpack)
		...
		H.equip_to_slot_or_qdel(new /obj/item/weapon/reagent_containers/spray/waterflower(H), slot_in_backpack)
...
/datum/job/librarian
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/shoes/black(H), slot_shoes)
		H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/bag/books(H), slot_l_hand)
		H.equip_to_slot_or_qdel(new /obj/item/weapon/barcodescanner(H), slot_r_store)
		H.equip_to_slot_or_qdel(new /obj/item/device/laser_pointer(H), slot_l_store)
		return 1
...
/datum/job/lawyer
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(!lawyer)
			lawyer = 1
			H.equip_to_slot_or_qdel(new /obj/item/clothing/under/lawyer/bluesuit(H), slot_w_uniform)
			H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/lawyer/bluejacket(H), slot_wear_suit)
		else
			H.equip_to_slot_or_qdel(new /obj/item/clothing/under/lawyer/purpsuit(H), slot_w_uniform)
			H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/lawyer/purpjacket(H), slot_wear_suit)
