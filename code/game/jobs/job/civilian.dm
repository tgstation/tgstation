...
/datum/job/librarian
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
		H.equip_to_slot_or_del(new /obj/item/weapon/barcodescanner(H), slot_l_store)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/briefcase(H), slot_l_hand)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/photo_album(H), slot_r_hand)
/*		if(H.backbag == 1)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/photo_album(H), slot_r_hand)
		else
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/photo_album(H), slot_in_backpack)
*/
		return 1
