...
/datum/job/bartender
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/bar(H), slot_wear_id)
		else
...
/datum/job/chef
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/chef(H), slot_wear_id)
		else
...
/datum/job/hydro
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/botanist(H), slot_wear_id)
		else
...
/datum/job/qm
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/quartermaster(H), slot_wear_id)
		else
...
/datum/job/cargo_tech
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/cargo(H), slot_wear_id)
		else
...
/datum/job/mining
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/shaftminer(H), slot_wear_id)
		else
...
/datum/job/clown
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/clown(H), slot_wear_id)
		else
...
/datum/job/mime
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/mime(H), slot_wear_id)
		else
...
/datum/job/janitor
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/janitor(H), slot_wear_id)
		else
...
/datum/job/librarian
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/librarian(H), slot_wear_id)
		else
...
/datum/job/lawyer
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/brown(H), slot_shoes)
		if(H.id2pda)
			H.equip_to_slot_or_del(new /obj/item/device/pda/lawyer(H), slot_wear_id)
		else
