...
/datum/job/chef/equip_items(var/mob/living/carbon/human/H)
	...
	if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Chef")
...
/datum/job/lawyer/equip_items(var/mob/living/carbon/human/H)
	if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Blue")
	...
	else if(H.mind.role_alt_clothing && H.mind.role_alt_clothing == "Purple")
