/datum/job/captain
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/captain(H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_cap(H), slot_back)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/armor/vest/capcarapace(H), slot_wear_suit)
...
/datum/job/hop
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/heads/hop(H), slot_ears)
