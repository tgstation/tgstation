/datum/job/cmo
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/heads/cmo(H), slot_ears)
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/medic (H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_med(H), slot_back)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/labcoat/cmo(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/firstaid/regular(H), slot_l_hand)
...
/datum/job/doctor
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_med(H), slot_ears)
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/medic (H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_med(H), slot_back)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/labcoat(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/firstaid/regular(H), slot_l_hand)
		H.equip_to_slot_or_qdel(new /obj/item/device/flashlight/pen(H), slot_s_store)
		if(H.backbag == 1)
			H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/box/survival(H), slot_r_hand)
...
/datum/job/chemist
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/labcoat/chemist(H), slot_wear_suit)
		return 1
...
/datum/job/geneticist
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_medsci(H), slot_ears)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/labcoat/genetics(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/device/flashlight/pen(H), slot_s_store)
		return 1
...
/datum/job/virologist
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/clothing/shoes/white(H), slot_shoes)
		H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/labcoat/virologist(H), slot_wear_suit)
		H.equip_to_slot_or_qdel(new /obj/item/device/flashlight/pen(H), slot_s_store)
		if(H.backbag == 1)
			H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/box/survival(H), slot_r_hand)
		else
