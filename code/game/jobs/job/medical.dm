/datum/job/cmo
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.backbag == 2) H.equip_to_slot_or_del(new /obj/item/storage/backpack/medic (H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_med(H), slot_back)
		...
		H.equip_to_slot_or_del(new /obj/item/storage/firstaid/regular(H), slot_l_hand)
		H.equip_to_slot_or_del(new /obj/item/tool/flashlight/pen(H), slot_s_store)
		if(H.backbag == 1)
