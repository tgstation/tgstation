/datum/job/cmo
	...
	equip(var/mob/living/carbon/human/H)
		...
		PDA_job_path = /obj/item/device/pda/heads/cmo 
		PDA_slot = slot_belt
		..()
...
/datum/job/doctor
	...
	equip(var/mob/living/carbon/human/H)
		...
		PDA_job_path = /obj/item/device/pda/medical 
		PDA_slot = slot_belt
		..()
...
/datum/job/chemist
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/white(H), slot_shoes)
		PDA_job_path = /obj/item/device/pda/chemist 
		PDA_slot = slot_belt
		..()
...
/datum/job/geneticist
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/white(H), slot_shoes)
		PDA_job_path = /obj/item/device/pda/geneticist 
		PDA_slot = slot_belt
		..()
...
/datum/job/virologist
	...
	equip(var/mob/living/carbon/human/H)
		...
		PDA_job_path = /obj/item/device/pda/viro 
		PDA_slot = slot_belt
		..()
