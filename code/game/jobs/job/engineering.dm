/datum/job/chief_engineer
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/heads/ce(H), slot_ears)
...
/datum/job/engineer
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_eng(H), slot_ears)
		if(H.backbag == 2) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/industrial(H), slot_back)
		if(H.backbag == 3) H.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_eng(H), slot_back)
...
/datum/job/atmos
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_qdel(new /obj/item/device/analyzer(H), slot_r_store)
