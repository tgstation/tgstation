...
/datum/job/chaplain/equip_items(var/mob/living/carbon/human/H)
	...
	H.equip_to_slot_or_del(new /obj/item/device/pda/chaplain(H), slot_l_store)	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
	H.equip_to_slot_or_del(new obj/item/weapon/holysword(H), slot_belt)
