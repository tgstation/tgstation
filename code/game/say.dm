...
#define ENCODE_HTML_EMPHASIS(input, char, html, varname) \
	var/static/regex/##varname = STATIC_INIT(regex("(?<!\\\\)[char](.+?)(?<!\\\\)[char]", "g"));\
...
/atom/movable/proc/say_emphasis(input)
	...
	var/static/regex/remove_escape_backlashes = STATIC_INIT(regex("\\\\(_|\\+|\\|)", "g")) // Removes backslashes used to escape text modification.
