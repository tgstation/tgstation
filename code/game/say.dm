...
/atom/movable/proc/say(message, datum/language/language = null)
	...
	message = replacetext(message, " nvm ", " nevermind ")
	message = replacetext(message, " btw ", " by the way ")
	message = replacetext(message, " thx ", " thanks ")
	message = replacetext(message, " ty ", " thanks ")
	message = replacetext(message, " wtf ", " what the fuck ")
	message = replacetext(message, " afaik ", " as far as I know ")
	message = replacetext(message, " etc ", " et cetera ")
	message = replacetext(message, " y ", " why ")
	message = replacetext(message, " u ", " you ")
	message = replacetext(message, " k ", " 'kay ")
	message = replacetext(message, " ok ", " okay ")
	message = replacetext(message, " lol ", " hahahah ")
	message = replacetext(message, " kek ", " hahahah ")
	message = replacetext(message, " lmao ", " hahahah ")
