 ...
 *
 * Used in PROC_REF(say] and other methods of speech (radios)) after a movable has inputted some message.
 * If you just want to check if the movable is able to speak in character, use PROC_REF(can_speak] instead.)
 */
