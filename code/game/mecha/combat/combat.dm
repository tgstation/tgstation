...
/obj/mecha/combat/proc/sam()
	if(am)
		var/window = {"<html>
							<head>
							<style>
							body {background:#000;colour: #00ff00;font-family:"Courier",monospace;font-size:12px;}
							#target {word-wrap: break-word;width:100%;padding-right:2px;}
							#form {display:none;padding:0;margin:0;}
							#input {background:#000;colour: #00ff00;font-family:"Courier",monospace;border:none;padding:0;margin:0;width:90%;font-size:12px;}
							</style>
