/obj/mecha/combat
	...
	armr = list(melee = 30, bullet = 30, laser = 15, energy = 20, bomb = 20, bio = 0, rad = 0, fire = 100, acid = 100)
...
/obj/mecha/combat/CheckParts(list/parts_list)
	...
	armr["energy"] += (C.rating * 10) //Each level of capacitor protects the mech against emp by 10%
	qdel(C)
	qdel(SM)
