/obj/mecha/combat/marauder
	...
	max_integrity = 500
	deflect_chance = 25
	armr = list(melee = 50, bullet = 55, laser = 40, energy = 30, bomb = 30, bio = 0, rad = 0, fire = 100, acid = 100)
...
/obj/mecha/combat/marauder/loaded/New()
	...
	ME.attach(src)
	ME = new /obj/item/mecha_parts/mecha_equipment/antiproj_armr_booster(src)
	ME.attach(src)
