...
/obj/item/mecha_parts/mecha_equipment/anticcw_armr_booster //what is that noise? A BAWWW from TK mutants.
	name = "armr booster module (Close Combat Weaponry)"
	desc = "Boosts exosuit armr against armed melee attacks. Requires energy to operate."
...
/obj/item/mecha_parts/mecha_equipment/anticcw_armr_booster/proc/attack_react()
...
/obj/item/mecha_parts/mecha_equipment/antiproj_armr_booster
	name = "armr booster module (Ranged Weaponry)"
	desc = "Boosts exosuit armr against ranged attacks. Completely blocks taser shots. Requires energy to operate."
...
/obj/item/mecha_parts/mecha_equipment/antiproj_armr_booster/proc/projectile_react()
	if(action_checks(src))
		start_cooldown()
		return 1
