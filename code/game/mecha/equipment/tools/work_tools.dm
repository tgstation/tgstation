...
/obj/item/mecha_parts/mecha_equipment/hydraulic_clamp/advanced
	name = "advanced hydraulic clamp"
	desc = "Advanced equipment for engineering exosuits. Loads objects into cargo. It can even open powered doors!"
	icon_state = "mecha_clamp"
	equip_cooldown = 15
	energy_drain = 15
	dam_force = 25
