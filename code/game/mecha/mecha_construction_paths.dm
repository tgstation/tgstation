...
// Cleaner
/datum/component/construction/unordered/mecha_chassis/cleaner
	result = /datum/component/construction/mecha/cleaner
	steps = list(
...
/datum/component/construction/mecha/cleaner
	result = /obj/mecha/working/cleaner
	base_icon = "ripley"
	steps = list(
		//1
		list(
		...
		//5
		list(
			"key" = /obj/item/circuitboard/mecha/cleaner/main,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "The wiring is adjusted."
		),
		...
		//7
		list(
			"key" = /obj/item/circuitboard/mecha/cleaner/peripherals,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "Central control module is secured."
		),
...
/datum/component/construction/mecha/cleaner/custom_action(obj/item/I, mob/living/user, diff)
	if(!..())
		return FALSE
