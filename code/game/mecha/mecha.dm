...
/obj/mecha/proc/ai_enter_mech(mob/living/silicon/ai/AI, interaction)
	...
	var/message = "<span class='notice'>You have been uploaded to a mech's onboard computer.</span>"
	if(AI.can_dominate_mechs)
		message = "<span class='announce'>Takeover of [name] complete! You are now loaded onto the onboard computer. Do not attempt to leave the station sector!</span>"
	to_chat(AI, message)
