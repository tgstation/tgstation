	...
	if(occupant)
		if(cell)
			...
			switch(cellcharge)
				...
				if(0.5 to 0.75)
					occupant.throw_alert("charge",/obj/screen/alert_icon/lowcell, 1)
				if(0.25 to 0.5)
					occupant.throw_alert("charge",/obj/screen/alert_icon/lowcell, 2)
				if(0.01 to 0.25)
					occupant.throw_alert("charge",/obj/screen/alert_icon/lowcell, 3)
				else
					occupant.throw_alert("charge",/obj/screen/alert_icon/emptycell)

		var/integrity = obj_integrity/max_integrity*100
		switch(integrity)
			if(30 to 45)
				occupant.throw_alert("mech damage", /obj/screen/alert_icon/low_mech_integrity, 1)
			if(15 to 35)
				occupant.throw_alert("mech damage", /obj/screen/alert_icon/low_mech_integrity, 2)
			if(-INFINITY to 15)
				occupant.throw_alert("mech damage", /obj/screen/alert_icon/low_mech_integrity, 3)
			else
