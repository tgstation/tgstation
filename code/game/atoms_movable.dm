...
/atom/movable/proc/setGrabState(newstate)
	...
	switch(grab_state) // Current state.
		if(GRAB_PASSIVE)
			pulling.RemoveTraits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), CHOKEHOLD_TRAIT)
		...
		if(GRAB_AGGRESSIVE)
			if(. >= GRAB_NECK) // Grab got downgraded.
				...
				pulling.AddTraits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), CHOKEHOLD_TRAIT)
