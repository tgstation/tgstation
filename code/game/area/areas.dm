...
/area
	...
	var/chumbiswork_warp_allowed = TRUE // Can servants warp into this area from Reebe?
	var/chumbiswork_warp_fail = "The structure there is too dense for warping to pierce. (This is normal in high-security areas.)"
