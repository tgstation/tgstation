...
/area
	...
	var/clockwork_warp_allowed = FALSE // Can servants warp into this area from Reebe?
	var/clockwork_warp_fail = "The warp can't penetrate the structure here. Try somewhere more thinly shielded, like public areas."
