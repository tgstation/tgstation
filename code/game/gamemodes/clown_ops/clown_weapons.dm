...
/obj/item/clothing/shoes/clown_shoes/banana_shoes/combat/Initialize()
	...
	bananium.insert_amount_mat(max_recharge, getmaterialref(/datum/material/bananium))
...
/obj/item/clothing/shoes/clown_shoes/banana_shoes/combat/process()
	...
	if(bananium_amount < max_recharge)
		bananium.insert_amount_mat(min(recharge_rate, max_recharge - bananium_amount), getmaterialref(/datum/material/bananium))
