...
/obj/effect/proc_holder/changeling/mimicvoice/sting_action(mob/user)
	...
	changeling.chem_recharge_slowdown += 0.5
	user << "<span class='notice'>We shape our glands to take the voice of <b>[russian_html2text(mimic_voice)]</b>, this will slow down regenerating chemicals while active.</span>"
