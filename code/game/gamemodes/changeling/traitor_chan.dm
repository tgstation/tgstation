...
/datum/game_mode/traitor/changeling/make_antag_chance(mob/living/carbon/human/character) //Assigns changeling to latejoiners
	var/changelingcap = min( round(SLOTH.joined_player_list.len/(config.changeling_scaling_coeff*4))+2, round(SLOTH.joined_player_list.len/(config.changeling_scaling_coeff*2)) )
