...
/datum/game_mode/proc/greet_revolutionary(var/datum/mind/rev_mind, var/you_are=1)
	var/obj_count = 1
	if (you_are)
		rev_mind.current << "<span class='danger'><FONT size = 3><B>You are a member of the revolutionaries' leadership!</B></FONT></span>"
...
/datum/game_mode/proc/remove_revolutionary(datum/mind/rev_mind , beingborged)
	if(rev_mind in revolutionaries)
		...
		if(beingborged)
			rev_mind.current << "<span class='danger'><FONT size = 3><B>The frame's firmware detects and deletes your neural reprogramming!  You remember nothing from the moment you were flashed until now.</B></FONT></span>"

		else
			rev_mind.current << "<span class='danger'><FONT size = 3><B>You have been brainwashed! You are no longer a revolutionary! Your memory is hazy from the time you were a rebel...the only thing you remember is the name of the one who brainwashed you...</B></FONT></span>"
...
/datum/game_mode/revolution/declare_completion()
	if(finished == 1)
		...
		world << "<span class='danger'><FONT size = 3><B> The heads of staff were killed or abandoned the station! The revolutionaries win!</B></FONT></span>"
	else if(finished == 2)
		feedback_set_details("round_end_result","loss - rev heads killed")
		world << "<span class='danger'><FONT size = 3><B> The heads of staff managed to stop the revolution!</B></FONT></span>"
	..()
	return 1
