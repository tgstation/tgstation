...
/datum/game_mode/revolution
	...
	antag_flag = ROLE_REV
	restricted_jobs = list("Shaft Miner", "Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
	required_players = 20
	required_enemies = 1
