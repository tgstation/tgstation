...
/obj/item/weapon/pinpointer/advpinpointer
	...
	icon = 'device.dmi'
	desc = "A larger version of the normal pinpointer, this unit features a helpful quantum entanglement detection system to locate various objects that do not broadcast a locator singnal."
	var/mode = 0  // Mode 0 locates disk, mode 1 locates coordinates, mode 2 locates an object or a person.
