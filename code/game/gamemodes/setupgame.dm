...
/proc/setupcorpses()
	for (var/obj/effect/landmark/A in landmarks_list)
		...
		//	M.equip_to_slot_or_del(new /obj/item/storage/toolbox/mechanical(M), slot_l_hand)
			...
			M.equip_to_slot_or_del(new /obj/item/device/scanner/t_ray(M), slot_r_store)
		...
		if (A.name == "Corpse-Engineer-Space")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), slot_ears)
			M.equip_to_slot_or_del(new /obj/item/clothing/tank/emergency_oxygen(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/engineer(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/orange(M), slot_shoes)
		...
		if (A.name == "Corpse-Syndicate")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/tank/jetpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas(M), slot_wear_mask)
			if (prob(50))
