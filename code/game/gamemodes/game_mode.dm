...
/obj/item/weapon/pen/paralysis:5:Paralysis Pen;
...
Whitespace:Seperator;
Devices and Tools;
/obj/item/weapon/card/emag:5:Cryptographic Sequencer;
/obj/item/weapon/storage/toolbox/syndicate:1:Fully Loaded Toolbox;
/obj/item/weapon/storage/box/syndie_kit/space:2:Space Suit;
/obj/item/clothing/glasses/thermal/syndi:2:Thermal Imaging Glasses;
/obj/item/device/encryptionkey/binary:3:Binary Translator Key;
/obj/item/weapon/plastique:4:C-4 (Destroys walls);
/obj/item/device/powersink:10:Powersink (DANGER!);
Whitespace:Seperator;
Implants;
