...
/datum/action/camera_off/abductor/Activate()
	...
	var/obj/machinery/computer/camera_advanced/abductor/origin = holder
	if (!C.remote_control)
		C.remote_control = origin.eyeobj
