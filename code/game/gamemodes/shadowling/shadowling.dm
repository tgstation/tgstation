...
/datum/game_mode/proc/greet_shadow(datum/mind/shadow)
	...
	to_chat(shadow.current, "<b>If you are new to shadowling, or want to read about abilities, check the wiki page at https://tgstation13.org/wiki/index.php?title=Shadowling</b><br>")
