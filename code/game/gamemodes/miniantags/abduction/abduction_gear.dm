...
/obj/item/restraints/handcuffs/energy/used/dropped(mob/user)
	user.visible_message("<span class='danger'>[user]'s [name] break in a discharge of energy!</span>", \
							"<span class='userdanger'>[user]'s [name] break in a discharge of energy!</span>")
