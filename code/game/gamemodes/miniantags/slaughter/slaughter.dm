...
/mob/living/simple_animal/slaughter
	...
	var/playstyle_string = "<B><span class='big_bold'>You are a slaughter demon,</span> a terrible creature from another realm. You have a single desire: To kill.  \
...
/mob/living/simple_animal/slaughter/laughter
	...
	playstyle_string = "<span class='big_bold'>You are a laughter \
