...
/obj/effect/mob_spawn/swarmer
	...
	mob_type = /mob/living/animal/hostile/swarmer
	mob_name = "a swarmer"
	death = FALSE
	roundstart = FALSE
	flavour_text = {"
...
/mob/living/animal/hostile/swarmer
	name = "Swarmer"
	unique_name = 1
	icon = 'icons/mob/swarmer.dmi'
...
/mob/living/animal/hostile/swarmer/Initialize()
	. = ..()
	verbs -= /mob/living/verb/pulled
	var/datum/atom_hud/data/diagnostic/diag_hud = GLOB.huds[DATA_HUD_DIAGNOSTIC]
	diag_hud.add_to_hud(src)

/mob/living/animal/hostile/swarmer/med_hud_set_health()
	var/image/holder = hud_list[DIAG_HUD]
	var/icon/I = icon(icon, icon_state, dir)
	holder.pixel_y = I.Height() - world.icon_size
	holder.icon_state = "huddiag[RoundDiagBar(health/maxHealth)]"

/mob/living/animal/hostile/swarmer/med_hud_set_status()
	var/image/holder = hud_list[DIAG_STAT_HUD]
	var/icon/I = icon(icon, icon_state, dir)
	holder.pixel_y = I.Height() - world.icon_size
	holder.icon_state = "hudstat"

/mob/living/animal/hostile/swarmer/Stat()
	..()
	if(statpanel("Status"))
		stat("Resources:",resources)

/mob/living/animal/hostile/swarmer/handle_inherent_channels(message, message_mode)
...
/mob/living/animal/hostile/swarmer/get_spans()
	return ..() | SPAN_ROBOT

/mob/living/animal/hostile/swarmer/emp_act()
	if(health > 1)
		adjustHealth(health-1)
	else
		death()

/mob/living/animal/hostile/swarmer/CanPass(atom/movable/O)
...
/mob/living/animal/hostile/swarmer/AttackingTarget()
	if(!isliving(target))
		return target.swarmer_act(src)
	else
		return ..()

/mob/living/animal/hostile/swarmer/CtrlClickOn(atom/A)
	face_atom(A)
	if(!isturf(loc))
		return
...
/atom/proc/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	return TRUE //return TRUE/FALSE whether or not an AI swarmer should try this swarmer_act() again, NOT whether it succeeded.

/obj/effect/mob_spawn/swarmer/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.Integrate(src)
...
/obj/item/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/obj/structure/swarmer/swarmer_act(mob/living/animal/hostile/swarmer/S)
	if(S.AIStatus == AI_ON)
		return FALSE
	else
		return ..()
...
/obj/effect/decal/cleanable/robot_debris/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	qdel(src)
	return TRUE
...
/obj/machinery/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DismantleMachine(src)
	return TRUE

/obj/machinery/light/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	return TRUE

/obj/machinery/door/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/obj/machinery/camera/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	toggle_cam(S, 0)
	return TRUE

/obj/machinery/particle_accelerator/control_box/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	return TRUE

/obj/machinery/field/generator/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	return TRUE

/obj/machinery/gravity_generator/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	return TRUE

/obj/machinery/vending/swarmer_act(mob/living/animal/hostile/swarmer/S)//It's more visually interesting than dismantling the machine
	S.DisIntegrate(src)
	return TRUE

/obj/machinery/turretid/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisIntegrate(src)
	return TRUE

/obj/machinery/chem_dispenser/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>The volatile chemicals in this machine would destroy us. Aborting.</span>")
	return FALSE

/obj/machinery/nuclearbomb/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/obj/machinery/dominator/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/obj/machinery/message_server/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>This communications relay should be preserved, it will be a useful resource to our masters in the future. Aborting.</span>")
	return FALSE

/obj/machinery/deepfryer/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/obj/machinery/power/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>Disrupting the power grid would bring no benefit to us. Aborting.</span>")
	return FALSE

/obj/machinery/gateway/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>This bluespace source will be important to us later. Aborting.</span>")
	return FALSE

/turf/closed/wall/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/obj/structure/window/swarmer_act(mob/living/animal/hostile/swarmer/S)
	var/isonshuttle = istype(get_area(src), /area/shuttle)
	for(var/turf/T in range(1, src))
		var/area/A = get_area(T)
		if(isspaceturf(T) || (!isonshuttle && (istype(A, /area/shuttle) || istype(A, /area/space))) || (isonshuttle && !istype(A, /area/shuttle)))
...
/obj/item/stack/cable_coil/swarmer_act(mob/living/animal/hostile/swarmer/S)//Wiring would be too effective as a resource
	to_chat(S, "<span class='warning'>This object does not contain enough materials to work with.</span>")
	return FALSE

/obj/machinery/porta_turret/swarmer_act(mob/living/animal/hostile/swarmer/S)
...
/mob/living/swarmer_act(mob/living/animal/hostile/swarmer/S)
	S.DisperseTarget(src)
	return TRUE

/mob/living/animal/slime/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>This biological resource is somehow resisting our bluespace transceiver. Aborting.</span>")
	return FALSE

/obj/machinery/droneDispenser/swarmer/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>This object is receiving unactivated swarmer shells to help us. Aborting.</span>")
	return FALSE

/obj/structure/destructible/clockwork/massive/celestial_gateway/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>This object is multiplying existing resources. Aborting.</span>")
	return FALSE

/obj/structure/lattice/catwalk/swarmer_act(mob/living/animal/hostile/swarmer/S)
	. = ..()
...
/obj/machinery/hydroponics/soil/swarmer_act(mob/living/animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>This object does not contain enough materials to work with.</span>")
	return FALSE

////END CTRL CLICK FOR SWARMERS////

/mob/living/animal/hostile/swarmer/proc/Fabricate(atom/fabrication_object,fabrication_cost = 0)
	if(!isturf(loc))
...
/mob/living/animal/hostile/swarmer/proc/Integrate(atom/movable/target)
...
/mob/living/animal/hostile/swarmer/proc/DisIntegrate(atom/movable/target)
...
/mob/living/animal/hostile/swarmer/proc/DisperseTarget(mob/living/target)
	if(target == src)
		return
...
/mob/living/animal/hostile/swarmer/proc/DismantleMachine(obj/machinery/target)
	do_attack_animation(target)
...
/obj/structure/swarmer/trap/Crossed(atom/movable/AM)
	if(isliving(AM))
		var/mob/living/L = AM
		if(!istype(L, /mob/living/animal/hostile/swarmer))
...
/mob/living/animal/hostile/swarmer/proc/CreateTrap()
...
/mob/living/animal/hostile/swarmer/proc/CreateBarricade()
...
/mob/living/animal/hostile/swarmer/proc/CreateSwarmer()
	set name = "Replicate"
	set category = "Swarmer"
...
/mob/living/animal/hostile/swarmer/proc/SwarmerTypeToCreate()
	return /obj/effect/mob_spawn/swarmer


/mob/living/animal/hostile/swarmer/proc/RepairSelf()
...
/mob/living/animal/hostile/swarmer/proc/ToggleLight()
	if(!light_range)
		set_light(3)
	else
		set_light(0)

/mob/living/animal/hostile/swarmer/proc/swarmer_chat(msg)
...
/mob/living/animal/hostile/swarmer/proc/ContactSwarmers()
