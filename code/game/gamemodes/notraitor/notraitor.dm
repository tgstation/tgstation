/datum/game_mode/notraitor
	name = "notraitor"
	config_tag = "notraitor"
	report_type = "notraitor"
...
/datum/game_mode/notraitor/pre_setup()
...
/datum/game_mode/notraitor/post_setup()
...
/datum/game_mode/notraitor/make_antag_chance(mob/living/carbon/human/character) //Assigns traitor to latejoiners
	var/tsc = CONFIG_GET(number/traitor_scaling_coeff)
...
/datum/game_mode/notraitor/proc/add_latejoin_traitor(datum/mind/character)
	var/datum/antagonist/traitor/new_antag = new antag_datum()
	character.add_antag_datum(new_antag)

/datum/game_mode/notraitor/generate_report()
