...
//			user.take_organ_damage(5, 0)
	...
	proc/supply(var/key)
		...
		//dat += "<A href='?src=\ref[src];rune=armor'>Sa tatha najin</A> - Allows you to summon armored robes and an unholy blade<BR>" // A fledgling cult who just started out does not need one of the members completely fucking over the other 2 by going instant murderbone obvious cultist rampage. - Iamgoofball
