...
//					call(/obj/item/weapon/tome/proc/edit_notes)()
			...
			if("Scribe a rune")		//fixed more assbackward tabbing
				...
				user.visible_message("<span class='danger'>[user] slices open a finger and begins to chant and paint symbols on the floor.</span>", "<span class='userdanger'>You slice open one of your fingers and begin drawing a rune on the floor whilst chanting the ritual that binds your life essence with the dark arcane energies flowing through the surrounding world.</span>", "<span class='italics'>You hear chanting.</span>")
