...
/mob/living/carbon/demon/initialize()
	create_dna(src)
	dna.initialize_dna(random_blood_type())

/mob/living/carbon/demon/prepare_data_huds()
	//Prepare our med HUD...
	..()
	//...and display it.
...
/mob/living/carbon/demon/movement_delay()
	if(reagents)
...
/mob/living/carbon/demon/attack_paw(mob/living/M)
...
/mob/living/carbon/demon/attack_larva(mob/living/carbon/alien/larva/L)
...
/mob/living/carbon/demon/attack_hand(mob/living/carbon/human/M)
...
/mob/living/carbon/demon/attack_alien(mob/living/carbon/alien/humanoid/M)
...
/mob/living/carbon/demon/attack_animal(mob/living/simple_animal/M)
	if(..())
...
/mob/living/carbon/demon/attack_slime(mob/living/simple_animal/slime/M)
...
/mob/living/carbon/demon/verb/removeinternal()
	set name = "Remove Internals"
	set category = "IC"
	internal = null
	return

/mob/living/carbon/demon/ex_act(severity, target)
	..()
	switch(severity)
		if(1)
			gib()
...
/mob/living/carbon/demon/IsAdvancedToolUser()
	return 1

/mob/living/carbon/demon/reagent_check(datum/reagent/R)
	return 0

/mob/living/carbon/demon/canBeHandcuffed()
	return 1

/mob/living/carbon/demon/assess_threat(mob/living/simple_animal/bot/secbot/judgebot, lasercolor)
	return 666

/mob/living/carbon/demon/acid_act(acidpwr, toxpwr, acid_volume)
	if(wear_mask)
...
/mob/living/carbon/demon/help_shake_act(mob/living/carbon/M)
...
/mob/living/carbon/demon/get_permeability_protection()
	var/protection = 0
	if(head)
...
/mob/living/carbon/demon/check_eye_prot()
	var/number = ..()
...
/mob/living/carbon/demon/fully_heal(admin_revive = 0)
	if(!getorganslot("lungs"))
		var/obj/item/organ/internal/lungs/L = new()
		L.Insert(src)
	..()

/mob/living/carbon/demon/IsVocal()
	if(!getorganslot("lungs"))
		return 0
	return 1