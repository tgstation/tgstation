...
/mob/living/carbon/demon/regenerate_icons()
	if(!..())
...
/mob/living/carbon/demon/update_icons()
	overlays.Cut()
	icon_state = "monkey1"
...
/mob/living/carbon/demon/update_fire()
	..("Monkey_burning")

/mob/living/carbon/demon/update_inv_handcuffed()
	remove_overlay(HANDCUFF_LAYER)
	if(handcuffed)
		overlays_standing[HANDCUFF_LAYER] = image("icon"='icons/mob/mob.dmi', "icon_state"="handcuff1", "layer"=-HANDCUFF_LAYER)
		apply_overlay(HANDCUFF_LAYER)

/mob/living/carbon/demon/update_inv_legcuffed()
...
/mob/living/carbon/demon/update_hud_head(obj/item/I)
	if(client && hud_used && hud_used.hud_shown)
		I.screen_loc = ui_monkey_head
		client.screen += I

//update whether our mask item appears on our hud.
/mob/living/carbon/demon/update_hud_wear_mask(obj/item/I)
	if(client && hud_used && hud_used.hud_shown)
		I.screen_loc = ui_monkey_mask
		client.screen += I

//update whether our back item appears on our hud.
/mob/living/carbon/demon/update_hud_back(obj/item/I)
	if(client && hud_used && hud_used.hud_shown)
