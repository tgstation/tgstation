...
/obj/item/weapon/antag_spawner/contract/spawn_antag(var/client/C, var/turf/T, var/type = "")
	...
	switch(type)
		if("destruction")
			M.spell_list += new /atom/movable/spell/targeted/projectile/magic_missile()
			M.spell_list += new /atom/movable/spell/targeted/projectile/dumbfire/fireball()
		...
		if("bluespace")
			M.spell_list += new /atom/movable/spell/area_teleport()
			M.spell_list += new /atom/movable/spell/targeted/ethereal_jaunt()
		...
		if("healing")
			...
			M.spell_list += new /atom/movable/spell/aoe_turf/conjure/forcewall(M)
		...
		*/
		if("robeless")
			M.spell_list += new /atom/movable/spell/aoe_turf/knock()
			M.spell_list += new /atom/movable/spell/targeted/mind_transfer()
