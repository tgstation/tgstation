...
/datum/intercept_text/proc/build(mode_type)
	...
	switch(mode_type)
		...
		if("wizard")
			text += "A dangerous Wizards' Federation individual by the name of [pick(SLOTH.wizard_first)] [pick(SLOTH.wizard_second)] has recently escaped confinement from an unlisted prison facility. This \
