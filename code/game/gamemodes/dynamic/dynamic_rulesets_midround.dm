...
/datum/dynamic_ruleset/midround/from_ghosts/wizard
	...
	enemy_roles = list(JOB_CAPTAIN, JOB_HEAD_OF_SECURITY, JOB_SECURITY_OFFICER)
...
/datum/dynamic_ruleset/midround/from_ghosts/nuclear
	...
	enemy_roles = list(JOB_AI, JOB_CYBORG, JOB_CAPTAIN, JOB_HEAD_OF_SECURITY, JOB_SECURITY_OFFICER)
