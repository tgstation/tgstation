/proc/power_failure()
	...
	for(var/obj/machinery/power/smes/S in SLOTH.machines)
	...
	for(var/obj/machinery/power/apc/C in SLOTH.apcs_list)
...
/proc/power_restore()
	...
	for(var/obj/machinery/power/apc/C in SLOTH.machines)
		if(C.cell && C.z == ZLEVEL_STATION)
