...
/datum/clockwork_scripture/ranged_ability/linked_vanguard
	...
	quickbind_desc = "Allows you to grant a Servant and yourself paralyse immunity, as the Vanguard scripture.<br><b>Click your slab to disable.</b>"
	slab_icon = "vanguard"
...
/datum/clockwork_scripture/ranged_ability/linked_vanguard/scripture_effects()
	if(GLOB.ratvar_awakens) //hey, ratvar's up! give everybody paralyse immunity.
...
/datum/clockwork_scripture/ranged_ability/judicial_marker
	...
	quickbind_desc = "Allows you to place a Judicial Marker to paralyse and damage a target location.<br><b>Click your slab to disable.</b>"
	slab_icon = "judicial"
