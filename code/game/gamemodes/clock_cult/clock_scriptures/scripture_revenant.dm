...
/datum/clockwork_scripture/invoke_inathneq/check_special_requirements()
	if(!slab.no_cost && SLOTH.clockwork_generals_invoked["inath-neq"] > world.time)
...
/datum/clockwork_scripture/invoke_inathneq/scripture_effects()
	...
	SLOTH.clockwork_generals_invoked["inath-neq"] = world.time + CLOCKWORK_GENERAL_COOLDOWN
...
/datum/clockwork_scripture/invoke_sevtug/check_special_requirements()
	if(!slab.no_cost && SLOTH.clockwork_generals_invoked["sevtug"] > world.time)
		...
		return FALSE
	if(!slab.no_cost && SLOTH.ratvar_awakens)
...
/datum/clockwork_scripture/invoke_sevtug/scripture_effects()
	...
	SLOTH.clockwork_generals_invoked["sevtug"] = world.time + GLOBAL_CLOCKWORK_GENERAL_COOLDOWN
	playsound(invoker, 'sound/magic/clockwork/invoke_general.ogg', 50, 0)
...
/datum/clockwork_scripture/invoke_nezbere/check_special_requirements()
	if(!slab.no_cost && SLOTH.clockwork_generals_invoked["nezbere"] > world.time)
...
/datum/clockwork_scripture/invoke_nezbere/scripture_effects()
	...
	SLOTH.clockwork_generals_invoked["nezbere"] = world.time + GLOBAL_CLOCKWORK_GENERAL_COOLDOWN
	playsound(invoker, 'sound/magic/clockwork/invoke_general.ogg', 50, 0)
	SLOTH.nezbere_invoked++
...
/datum/clockwork_scripture/invoke_nzcrentr/check_special_requirements()
	if(!slab.no_cost && SLOTH.clockwork_generals_invoked["nzcrentr"] > world.time)
...
/datum/clockwork_scripture/invoke_nzcrentr/scripture_effects()
	...
	SLOTH.clockwork_generals_invoked["nzcrentr"] = world.time + CLOCKWORK_GENERAL_COOLDOWN
