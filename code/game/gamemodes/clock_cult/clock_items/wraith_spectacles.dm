...
/datum/status_effect/wraith_spectacles
	...
	tick_interval = 20
	alert_type = /obj/screen/alert_icon/status_effect/wraith_spectacles
	var/eye_damage_done = 0
	var/nearsight_breakpoint = 30
	var/blind_breakpoint = 45

/obj/screen/alert_icon/status_effect/wraith_spectacles
	name = "Wraith Spectacles"
	desc = "You shouldn't actually see this, as it should be procedurally generated."
	icon_state = "wraithspecs"
	alerttooltipstyle = "clockcult"

/obj/screen/alert_icon/status_effect/wraith_spectacles/MouseEntered(location,control,params)
