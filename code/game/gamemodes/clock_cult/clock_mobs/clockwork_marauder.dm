...
/mob/living/simple_animal/hostile/clockwork/marauder
	...
	light_range = 2
	light_power = 1.1
	playstyle_string = "<span class='big_bold'><span class='neovgre'>You are a clockwork marauder,</span></span><b> a well-rounded frontline construct of Ratvar. Although you have no \
