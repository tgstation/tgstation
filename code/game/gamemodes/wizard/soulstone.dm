			...
			if(A)
				...
				switch(construct_class)
					if("Juggernaut")
						...
						Z.spell_list += new /atom/movable/spell/aoe_turf/conjure/forcewall/lesser(Z)
						Z.cancel_camera()
						deleteafter = 1
					...
					if("Wraith")
						...
						Z << "<B>You are still bound to serve your creator, follow their orders and help them complete their goals at all costs.</B>"
						Z.spell_list += new /atom/movable/spell/targeted/ethereal_jaunt/shift()
						Z.cancel_camera()
						deleteafter = 1
					...
					if("Artificer")
						...
						Z << "<B>You are still bound to serve your creator, follow their orders and help them complete their goals at all costs.</B>"
						Z.spell_list += new /atom/movable/spell/aoe_turf/conjure/construct/lesser(Z)
						Z.spell_list += new /atom/movable/spell/aoe_turf/conjure/wall(Z)
						Z.spell_list += new /atom/movable/spell/aoe_turf/conjure/floor(Z)
						Z.spell_list += new /atom/movable/spell/aoe_turf/conjure/soulstone(Z)
						Z.cancel_camera()
						deleteafter = 1
