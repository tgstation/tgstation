				...
				if(!already_knows)
					switch(href_list["spell_choice"])
						...
						if("masssleep")
							...
							temp = "You have learned mass sleep."
						/*if("disintegrate")
							if(!ticker.mode.rage)
