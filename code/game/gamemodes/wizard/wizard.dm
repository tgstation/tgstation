...
/datum/game_mode/wizard/declare_completion()
	if(finished)
		...
		world << "<span class='danger'><FONT size = 3><B> The wizard[(wizards.len>1)?"s":""] has been killed by the crew! The Space Wizards Federation has been taught a lesson they will not soon forget!</B></FONT></span>"
	..()
	return 1
