...
/datum/game_mode/proc/name_wizard(mob/living/carbon/human/wizard_mob)
	...
	spawn(0)
		var/newname = copytext(sanitize(input(wizard_mob, "You are the Space Wizard. Would you like to change your name to something else?", "Name change", randomname, nullable = TRUE, istext = TRUE)),1,MAX_NAME_LEN)
