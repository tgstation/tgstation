...
//	wizard_mob.equip_to_slot_or_del(new /obj/item/magic/scrying_gem(wizard_mob), slot_l_store) For scrying gem.
	wizard_mob.equip_to_slot_or_del(new /obj/item/magic/scroll/tele(wizard_mob), slot_r_store)
	wizard_mob.equip_to_slot_or_del(new /obj/item/magic/spellbook(wizard_mob), slot_r_hand)
