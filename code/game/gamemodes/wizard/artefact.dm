...
/obj/effect/rend/cow/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I, /obj/item/weapon/nullrod))
		visible_message("<span class='userdanger'>[I] strikes a blow against \the [src], banishing it!</span>")
		qdel(src)
		return
	..()
...
/obj/item/weapon/scrying/attack_self(mob/user as mob)
	...
	visible_message("<span class='userdanger'>[usr] stares into [src], their eyes glazing over.</span>")
	user.ghostize(1)
	return