...
/datum/game_mode/proc/equip_traitor(mob/living/carbon/human/traitor_mob, safety = 0)
	...
	if (!I)
		...
		if(istype(I, /obj/item/device/radio))
			...
			P.lock_code = "[rand(000,999)] [pick("Alpha","Bravo","Charlie","Delta","Echo","Foxtrot","Golf","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey",X-ray","Yankee","Zulu")]"
