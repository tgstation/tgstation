...
/datum/objective/proc/considered_escaped(datum/mind/M)
	...
	if(!location || istype(location, /turf/open2/floor/plasteel/shuttle/red) || istype(location, /turf/open2/floor/mineral/plastitanium/brig)) // Fails if they are in the shuttle brig
		return FALSE
