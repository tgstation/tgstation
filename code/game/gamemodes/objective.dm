...
/datum/objective/proc/deathrattle() //does something when the deathrattle status effect linked to this objective goes off. you could set it to be your own deathrattle, or someone elses. see creep.dm and neutral.dm for an example
