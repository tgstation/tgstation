...
/datum/objective/assassinate/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Assassinate [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role]."
	else
...
/datum/objective/mutiny/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Assassinate or exile [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role]."
	else
		explanation_text = "Free objective."
...
/datum/objective/maroon/update_explanation_text()
	if(target?.current)
		explanation_text = "Prevent [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role], from escaping alive."
	else
		explanation_text = "Free objective."
...
/datum/objective/debrain/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Steal the brain of [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role]."
	else
		explanation_text = "Free objective."
...
/datum/objective/protect/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Protect [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role]."
	else
		explanation_text = "Free objective."
...
/datum/objective/jailbreak/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Ensure that [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role] escapes alive and out of custody."
	else
		explanation_text = "Free objective."
...
/datum/objective/jailbreak/detain/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Ensure that [target.name], the [!target_role_type ? target.assigned_role.get_title() : target.special_role] is delivered to Nanotrasen alive and in custody."
	else
		explanation_text = "Free objective."
...
/datum/objective/escape/escape_with_identity/update_explanation_text()
	if(target?.current)
		...
		explanation_text = "Escape on the shuttle or an escape pod with the identity of [target_real_name], the [target.assigned_role.get_title()]"
