...
/obj/effect/meteor/medium/meteor_effect()
	..()
	SSexplosion.Create(src.loc, 0, 1, 2, 3, 0)
...
/obj/effect/meteor/big/meteor_effect()
	..()
	SSexplosion.Create(src.loc, 1, 2, 3, 4, 0)
...
/obj/effect/meteor/flaming/meteor_effect()
	..()
	SSexplosion.Create(src.loc, 1, 2, 3, 4, 0, 0, 5)
...
/obj/effect/meteor/irradiated/meteor_effect()
	..()
	SSexplosion.Create(src.loc, 0, 0, 4, 3, 0)
...
/obj/effect/meteor/tunguska/meteor_effect()
	..()
	SSexplosion.Create(src.loc, 5, 10, 15, 20, 0)

/obj/effect/meteor/tunguska/Bump()
	..()
	if(prob(20))
		SSexplosion.Create(src.loc,2,4,6,8)
