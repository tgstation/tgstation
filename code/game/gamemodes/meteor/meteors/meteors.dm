...
GLOBAL_LIST_INIT(meteors_oreo, list(/obj/effect/meteor/medium=100, /obj/effect/meteor/big=100, \
						  /obj/effect/meteor/flaming=100, /obj/effect/meteor/irradiated=100, /obj/effect/meteor/tunguska = 100)) //for when someone eats all your oreos
