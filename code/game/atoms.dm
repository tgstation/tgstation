 ...
 * * Removes alternate appearances from huds that see them
...
/atom/proc/CanPass(atom/movable/mover, border_dir)
	...
	// This is cheaper than calling the proc every time since most things don't override CanPassThrough
 ...
 *
 * Default behavior is to send the [COMSIG_ATOM_PRE_EMP_ACT] and [COMSIG_ATOM_EMP_ACT] signal
 *
