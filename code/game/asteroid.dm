...
proc/make_mining_asteroid_secret()
	...
	switch(pick(possiblethemes))//what kind of room is this gonna be?
		if("organharvest")
			...
			treasureitems = list(/obj/item/weapon/guardiancreator/biological/choose=1, /obj/machinery/bot/medbot/mysterious=1, /obj/item/weapon/circular_saw=1, /obj/structure/closet/critter/cat=2)
		...
		if("cult")
			...
			treasureitems = list(/obj/item/weapon/guardiancreator/choose=1, /obj/item/device/soulstone=1, /obj/item/clothing/suit/space/cult=1, /obj/item/weapon/bedsheet/cult=2,
		...
		if("wizden")
			...
			treasureitems = list(/obj/item/weapon/guardiancreator/choose=2, /obj/item/weapon/veilrender/vealrender=2, /obj/item/weapon/spellbook/oneuse/blind=1,/obj/item/clothing/head/wizard/red=2,
		...
		if("hitech")
			...
			treasureitems = list(/obj/item/weapon/guardiancreator/tech/choose=2, /obj/item/weapon/stock_parts/cell/hyper=1, /obj/machinery/chem_dispenser/constructable=1,/obj/machinery/computer/telescience=1, /obj/machinery/r_n_d/protolathe=1,
