...
/obj/structure/dispenser/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I, /obj/item/clothing/tank/oxygen) || istype(I, /obj/item/clothing/tank/air) || istype(I, /obj/item/clothing/tank/anesthetic))
		if(oxygentanks < 10)
			user.drop_item()
			I.loc = src
			oxytanks.Add(I)
	...
	if(istype(I, /obj/item/clothing/tank/plasma))
		if(plasmatanks < 10)
			user.drop_item()
			I.loc = src
			platanks.Add(I)
...
/obj/structure/dispenser/Topic(href, href_list)
	...
	if(get_dist(src, usr) <= 1)
		...
		if(href_list["oxygen"])
			if(oxygentanks > 0)
				var/obj/item/clothing/tank/oxygen/O
				if(oxytanks.len == oxygentanks)
					O = oxytanks[1]
					oxytanks.Remove(O)
				else
					O = new /obj/item/clothing/tank/oxygen(loc)
				O.loc = loc
		...
		if(href_list["plasma"])
			if(plasmatanks > 0)
				var/obj/item/clothing/tank/plasma/P
				if(platanks.len == plasmatanks)
					P = platanks[1]
					platanks.Remove(P)
				else
					P = new /obj/item/clothing/tank/plasma(loc)
				P.loc = loc
