...
/obj/structure/dispenser/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I, /obj/item/weapon/tank/large/oxygen) || istype(I, /obj/item/weapon/tank/large/air) || istype(I, /obj/item/weapon/tank/large/anesthetic))
		if(oxygentanks < 10)
			user.drop_item()
			I.loc = src
			oxytanks.Add(I)
	...
	if(istype(I, /obj/item/weapon/tank/large/plasma))
		if(plasmatanks < 10)
			user.drop_item()
			I.loc = src
			platanks.Add(I)
...
/obj/structure/dispenser/Topic(href, href_list)
	...
	if(Adjacent(usr))
		...
		if(href_list["oxygen"])
			if(oxygentanks > 0)
				var/obj/item/weapon/tank/large/oxygen/O
				if(oxytanks.len == oxygentanks)
					O = oxytanks[1]
					oxytanks.Remove(O)
				else
					O = new /obj/item/weapon/tank/large/oxygen(loc)
				O.loc = loc
		...
		if(href_list["plasma"])
			if(plasmatanks > 0)
				var/obj/item/weapon/tank/large/plasma/P
				if(platanks.len == plasmatanks)
					P = platanks[1]
					platanks.Remove(P)
				else
					P = new /obj/item/weapon/tank/large/plasma(loc)
				P.loc = loc
