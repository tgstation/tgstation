...
/obj/effect/mob_spawn/human/golem/attack_hand(mob/user)
	...
	if(isgolem(user) && can_transfer)
		...
		user.visible_message("<span class='warning'>A faint light leaves [user], moving to [src] and animating it!</span>","<span class='notice'>You leave your old body behind, and transfer into [src]!</span>")
		show_flavour = FALSE
