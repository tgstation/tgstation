...
/obj/item/card/id/away/quantumanomaly/assistant
...
/obj/item/card/id/away/quantumanomaly/botanist
	assignment = "Botanist"

/obj/effect/mob_spawn/human/quantumanomaly
	name = "malfunctioning sleeper"
	desc = "An enclosed machine used to stabilize and heal patients. This one seems broken, and its occupant is comatose."
	mob_name = "the quantum traveler"
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	roundstart = FALSE
	death = FALSE
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span class='big bold'>You are an assistant working for Nanotrasen,</span><b> stationed onboard a state of the art research station. You vaguely recall being dragged into a \
	sleeper pod due to getting shot by a traitor. The last thing you remember is the whole ship being squashed and stretched and a tremendous ammount of pain, before passing out. As you open \
	...
	An anomaly has taken you into a new dimension, Your only goal is to survive.</b>"
	uniform = /obj/item/clothing/under/color/random
	shoes = /obj/item/clothing/shoes/sneakers/black
	ears = /obj/item/radio/headset
	id = /obj/item/card/id/away/quantumanomaly/assistant
	back = /obj/item/storage/backpack
...
/obj/effect/mob_spawn/human/quantumanomaly/Destroy()
	var/obj/structure/showcase/machinery/oldpod/pod = new/obj/structure/showcase/machinery/oldpod/used(drop_location())
	pod.dir = src.dir
	return ..()
...
/obj/effect/mob_spawn/human/quantumanomaly/Initialize(mapload)
	...
	switch(arrpee)
		...
		if(2)
			...
			assignedrole = "Cargo Technician"
			belt = /obj/item/pda/cargo
			ears = /obj/item/radio/headset/headset_cargo
			uniform = /obj/item/clothing/under/rank/cargotech
			id = /obj/item/card/id/away/quantumanomaly/cargo
		if(3)
			job = "cook"
			assignedrole = "Cook"
			...
			id = /obj/item/card/id/away/quantumanomaly/cook
		if(4)
			job = "botanist"
			assignedrole = "Botanist"
