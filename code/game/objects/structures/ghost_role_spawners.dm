...
/obj/effect/mob_spawn/human/syndicatespace
	...
	important_info = "Obey orders given by your captain. DO NOT let the ship fall into enemy hands - HOWEVER, YOU ARE NOT AN ANTAGONIST. Do not assault the station without the express permission of an admin."
...
/obj/effect/mob_spawn/human/syndicatespace/captain
	...
	important_info = "Protect the ship and secret documents in your backpack with your own life. YOU ARE NOT AN ANTAGONIST. Do not assault the station without the express permission of an admin."
