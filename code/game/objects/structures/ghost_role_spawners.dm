...
/obj/effect/mob_spawn/human/ash_walker
	...
	You have seen lights in the distance... they foreshadow the arrival of outsiders that seek to tear apart the Necropolis and its domain. Fresh sacrifices for your nest.</b><br><span class='danger'> You are essentially a caveman lizard; \
	doing things like flying shuttles and hacking doors will get you banned.</span>"
