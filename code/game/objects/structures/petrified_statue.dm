...
/obj/structure/statue/petrified/Initialize(mapload, mob/living/L, statue_timer)
	...
	if(L)
		...
		L.forceMove(src)
		ADD_TRAIT(L, TRAIT_MUTE, SOURCE_STATUE_MUTE)
...
/obj/structure/statue/petrified/Destroy()
	...
	if(petrified_mob)
		...
		REMOVE_TRAIT(petrified_mob, TRAIT_MUTE, SOURCE_STATUE_MUTE)
		REMOVE_TRAIT(petrified_mob, TRAIT_NO_BLEED, SOURCE_MAGIC)
...
/mob/living/carbon/human/petrify(statue_timer)
	...
	ADD_TRAIT(src, TRAIT_NO_BLEED, SOURCE_MAGIC)
	S.copy_overlays(src)
