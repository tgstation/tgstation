...
/obj/structure/sign/attackby(obj/item/I, mob/user, params)
	if(is_editable && I.get_writing_implement_details()?["interaction_mode"] == MODE_WRITING)
...
/obj/item/sign/add_context(atom/source, list/context, obj/item/held_item, mob/user)
	. = ..()
	if(is_editable && held_item.get_writing_implement_details()?["interaction_mode"] == MODE_WRITING)
