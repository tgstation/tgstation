...
/obj/structure/girder/examine(mob/user)
	...
	switch(state)
		if(GIRDER_REINF)
			to_chat(user, "The <i>reinforced</i> plate is missing a part.\nThe support struts are <i>screwed</i> in place.")
		if(GIRDER_REINF_STRUTS)
			to_chat(user, "The support struts are <i>unscrewed</i>.\nThe inner <i>grille</i> is intact.")
		if(GIRDER_NORMAL)
			if(can_displace)
				to_chat(user, "It's missing a <i>normal</i> or <i>reinforced</i> cover.\nThe bolts are <i>wrenched</i> in place.")
		if(GIRDER_DISPLACED)
			to_chat(user, "The <i>bolts</i> have been loosened.\nThe <i>screws</i> are holding [src] together.")
