...
/obj/structure/mystery_box/proc/activate(mob/living/user)
	...
	playsound(src, open_sound).volume(70).channel(current_sound_channel).falloff_exponent(10).play()
...
/obj/structure/mystery_box/proc/grant_weapon(mob/living/user)
	...
	playsound(src, grant_sound).volume(70).channel(current_sound_channel).falloff_exponent(10).play()
	close_box()
