...
/obj/structure/chair/e_chair/Initialize(mapload)
	...
	var/mutable_appearance/export_to_component = mutable_appearance('icons/obj/chairs.dmi', "echair_over", OBJ_LAYER, src)
	export_to_component.appearance_flags |= KEEP_APART
