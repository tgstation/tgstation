...
/obj/structure/flora/tree/pine/Initialize()
	icon_state = "pine_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/tree/palm/Initialize()
	. = ..()
	icon_state = SSrng.pick_from_list("palm1","palm2")
	pixel_x = 0
...
/obj/structure/flora/tree/dead/Initialize()
	icon_state = "tree_[SSrng.random(1, 6)]"
	. = ..()
...
/obj/structure/flora/tree/jungle/Initialize()
	icon_state = "[icon_state][SSrng.random(1, 6)]"
	. = ..()
...
/obj/structure/flora/grass/brown/Initialize()
	icon_state = "snowgrass[SSrng.random(1, 3)]bb"
	. = ..()
...
/obj/structure/flora/grass/green/Initialize()
	icon_state = "snowgrass[SSrng.random(1, 3)]gb"
	. = ..()
...
/obj/structure/flora/grass/both/Initialize()
	icon_state = "snowgrassall[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/bush/Initialize()
	icon_state = "snowbush[SSrng.random(1, 6)]"
	. = ..()
...
/obj/structure/flora/ausbushes/Initialize()
	if(icon_state == "firstbush_1")
		icon_state = "firstbush_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/reedbush/Initialize()
	icon_state = "reedbush_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/leafybush/Initialize()
	icon_state = "leafybush_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/palebush/Initialize()
	icon_state = "palebush_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/stalkybush/Initialize()
	icon_state = "stalkybush_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/grassybush/Initialize()
	icon_state = "grassybush_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/fernybush/Initialize()
	icon_state = "fernybush_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/sunnybush/Initialize()
	icon_state = "sunnybush_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/genericbush/Initialize()
	icon_state = "genericbush_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/pointybush/Initialize()
	icon_state = "pointybush_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/lavendergrass/Initialize()
	icon_state = "lavendergrass_[SSrng.random(1, 4)]"
	. = ..()
...
/obj/structure/flora/ausbushes/ywflowers/Initialize()
	icon_state = "ywflowers_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/brflowers/Initialize()
	icon_state = "brflowers_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/ppflowers/Initialize()
	icon_state = "ppflowers_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/sparsegrass/Initialize()
	icon_state = "sparsegrass_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/structure/flora/ausbushes/fullgrass/Initialize()
	icon_state = "fullgrass_[SSrng.random(1, 3)]"
	. = ..()
...
/obj/item/twohanded/required/kirbyplants/random/Initialize()
	...
	if(!states)
		generate_states()
	icon_state = SSrng.pick_from_list(states)
...
/obj/structure/flora/rock/Initialize()
	. = ..()
	icon_state = "[icon_state][SSrng.random(1,3)]"
...
/obj/structure/flora/grass/jungle/Initialize()
	icon_state = "[icon_state][SSrng.random(1, 5)]"
	. = ..()
...
/obj/structure/flora/rock/jungle/Initialize()
	. = ..()
	icon_state = "[initial(icon_state)][SSrng.random(1,5)]"
...
/obj/structure/flora/rock/pile/largejungle/Initialize()
	. = ..()
	icon_state = "[initial(icon_state)][SSrng.random(1,3)]"
