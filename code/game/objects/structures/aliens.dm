...
/obj/structure/alien/weeds/Destroy()
	if(parent_node)
		unregister_signal(parent_node, COMSIG_PARENT_QDELETING)
		parent_node = null
	return ..()
...
/obj/structure/alien/weeds/proc/try_expand()
	...
	for(var/turf/check_turf in src_turf.get_atmos_adjacent_turfs())
		...
		check_weed.register_signal(parent_node, COMSIG_PARENT_QDELETING, .proc/after_parent_destroyed)
...
/obj/structure/alien/weeds/proc/find_new_parent()
	...
	for(var/obj/structure/alien/weeds/node/new_parent in range(node_range, src))
		...
		register_signal(parent_node, COMSIG_PARENT_QDELETING, .proc/after_parent_destroyed)
		return parent_node
	return FALSE
