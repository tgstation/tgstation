...
/obj/structure/sink/attack_hand(mob/living/user)
	...
	var/washing_face = (selected_area == BODY_ZONE_HEAD || selected_area == BODY_ZONE_PRECISE_MOUTH || selected_area == BODY_ZONE_PRECISE_EYES)
...
/obj/structure/sink/attackby(obj/item/O, mob/living/user, params)
	...
	if(istype(O, /obj/item/reagent_containers))
		...
		return TRUE
	else if(istype(O, /obj/item/stack/medical/gauze))
		...
		G.use(1)
		return TRUE
	else if(!istype(O) || (O.item_flags & ABSTRACT))
		return TRUE
