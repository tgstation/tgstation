...
/obj/structure/chair/MouseDrop(over_object, src_location, over_location)
	...
	if(over_object == usr && Adjacent(usr))
		...
		if(!usr.canUseTopic(src, BE_CLOSE, ismonkey(usr)))
			return
		usr.visible_message("<span class='none'>[usr] grabs \the [src.name].</span>", "<span class='notice'>You grab \the [src.name].</span>")
...
/obj/item/chair/proc/plant(mob/user)
	...
	user.visible_message("<span class='none'>[user] rights \the [src.name].</span>", "<span class='notice'>You right \the [name].</span>")
...
/obj/structure/chair/brass/AltClick(mob/living/user)
	...
	if(!(datum_flags & DF_ISPROCESSING))
		user.visible_message("<span class='none'>[user] spins [src] around, and Ratvarian technology keeps it spinning FOREVER.</span>", \
		"<span class='notice'>Automated spinny chairs. The pinnacle of Ratvarian technology.</span>")
		START_PROCESSING(SSfastprocess, src)
	else
		user.visible_message("<span class='none'>[user] stops [src]'s uncontrollable spinning.</span>", \
