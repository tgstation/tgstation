...
/obj/item/chair/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
