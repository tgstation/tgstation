...
/obj/structure/plasticflaps/examine(mob/user)
	. = ..()
	if(anchored)
		to_chat(user, "<span class='info'>[src] are <b>screwed</b> to the floor.</span>")
	else
		to_chat(user, "<span class='info'>[src] are no longer <i>screwed</i> to the floor, and the flaps can be <b>cut</b> apart.</span>")
