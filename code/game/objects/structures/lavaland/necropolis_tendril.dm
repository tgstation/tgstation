...
/obj/effect/collapse/Initialize()
	...
	playsound(loc,'sound/effects/tendril_destroyed.ogg', 200, 0, 50, 1, DEFAULT_SOUND_VARY)
...
/obj/effect/collapse/proc/collapse()
	for(var/mob/M in range(7,src))
		shake_camera(M, 15, 1)
	playsound(get_turf(src), 'sound/effects/explosionfar.ogg', 100, DEFAULT_SOUND_VARY)
