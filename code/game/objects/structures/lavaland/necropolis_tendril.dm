...
/obj/effect/collapse/proc/collapse()
	...
	visible_message("<span class='boldannounce'>The tendril begins to writhe to and fro, the ground around it suddenly glowing red-hot and melting into a pit of magma!</span>")
