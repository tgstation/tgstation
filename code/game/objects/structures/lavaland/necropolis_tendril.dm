...
/obj/effect/collapse/proc/collapse()
	...
	visible_message("<span class='boldannounce'>The tendril falls inward, the ground around it erupting into a pool of lava.</span>")
	for(var/turf/T in range(2,src))
		if(!T.density)
			T.TerraformTurf(/turf/open/lava/smooth/lava_land_surface, /turf/open/lava/smooth/lava_land_surface)
	qdel(src)
