...
/obj/structure/table/proc/table_place_act(mob/living/user, obj/item/tool, list/modifiers)
	...
	if(LAZYACCESS(modifiers, ICON_X) && LAZYACCESS(modifiers, ICON_Y))
		...
		tool.pixel_x = clamp(text2num(LAZYACCESS(modifiers, ICON_X)) - 16, -(ICONSIZE_X*0.5), ICONSIZE_X*0.5)
		tool.pixel_y = clamp(text2num(LAZYACCESS(modifiers, ICON_Y)) - 16, -(ICONSIZE_Y*0.5), ICONSIZE_Y*0.5)
