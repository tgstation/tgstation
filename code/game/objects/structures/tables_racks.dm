...
/obj/structure/table/proc/tablepush(mob/living/user, mob/living/pushed_mob)
	...
	if(user.mind?.martial_art?.smashes_tables && user.mind?.martial_art.can_use(user))
		deconstruct(FALSE)
	PLAYSOUND(pushed_mob, 'sound/effects/tableslam.ogg').volume(90).vary_frequency(TRUE).play()
...
/obj/structure/table/proc/tablelimbsmash(mob/living/user, mob/living/pushed_mob)
	...
	if(user.mind?.martial_art?.smashes_tables && user.mind?.martial_art.can_use(user))
		deconstruct(FALSE)
	PLAYSOUND(pushed_mob, 'sound/effects/bang.ogg').volume(90).vary_frequency(TRUE).play()
...
/obj/structure/table/glass/proc/table_shatter(mob/living/victim)
	...
	PLAYSOUND(get_sfx(loc), SFX_SHATTER).volume(50).vary_frequency(TRUE).play()
...
/obj/structure/table/glass/atom_deconstruct(disassembled = TRUE)
	if(disassembled)
		...
		PLAYSOUND(get_sfx(T), SFX_SHATTER).volume(50).vary_frequency(TRUE).play()
