	...
	if(Adjacent(user) && user.pulling)
		if(isliving(user.pulling))
			...
			if(user.a_intent == INTENT_HELP)
				pushed_mob.visible_message("<span class='none'>[user] begins to place [pushed_mob] onto [src]...</span>", \
			...
			if (user.pulling.loc == loc)
				user.visible_message("<span class='none'>[user] places [user.pulling] onto [src].</span>",
...
/obj/structure/table/proc/tableplace(mob/living/user, mob/living/pushed_mob)
	...
	pushed_mob.visible_message("<span class='none'>[user] places [pushed_mob] onto [src].</span>", \
...
/obj/structure/table/optable/tablepush(mob/living/user, mob/living/pushed_mob)
	pushed_mob.forceMove(loc)
	pushed_mob.set_resting(TRUE, TRUE)
	visible_message("<span class='none'>[user] has laid [pushed_mob] on [src].</span>")
	check_patient()
...
/obj/item/rack_parts/attack_self(mob/user)
	...
	if(do_after(user, 50, target = user, progress=TRUE))
		...
		user.visible_message("<span class='none'>[user] assembles \a [R].\
