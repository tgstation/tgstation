...
/obj/structure/bodycontainer/crematorium/creamatorium/cremate(mob/user)
	...
	for(var/mob/living/i_scream as anything in get_all_contents_type(/mob/living))
		var/obj/item/food/icecream/IC = new /obj/item/food/icecream(null, starting_reagent_purity = null, no_base_reagents = FALSE, /* prefill_flavors = */ list(ICE_CREAM_MOB = list(null, i_scream.name)))
		icecreams += IC
	. = ..()
