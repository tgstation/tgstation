...
/obj/structure/window/reinforced
	...
	armor = list(MELEE = 80, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 25, FIRE = 80, ACID = 100)
	max_integrity = 75
	explosion_block = 1
...
/obj/structure/window/plasma
	...
	armor = list(MELEE = 80, BULLET = 5, LASER = 0, ENERGY = 0, BOMB = 45, FIRE = 99, ACID = 100)
	max_integrity = 200
	explosion_block = 1
...
/obj/structure/window/reinforced/plasma
	...
	armor = list(MELEE = 80, BULLET = 20, LASER = 0, ENERGY = 0, BOMB = 60, FIRE = 99, ACID = 100)
	max_integrity = 500
...
/obj/structure/window/reinforced/shuttle//this is called reinforced because it is reinforced w/titanium
	...
	reinf = TRUE
	heat_resistance = 1600
	armor = list(MELEE = 90, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 50, FIRE = 80, ACID = 100)
	smoothing_flags = SMOOTH_BITMASK
...
/obj/structure/window/reinforced/plasma/plastitanium
	...
	flags_1 = PREVENT_CLICK_UNDER_1
	heat_resistance = 1600
	armor = list(MELEE = 95, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 50, FIRE = 80, ACID = 100)
	smoothing_flags = SMOOTH_BITMASK
