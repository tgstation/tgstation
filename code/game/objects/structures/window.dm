...
/obj/structure/window/examine(mob/user)
	...
	if(reinf)
		if(anchored && state == WINDOW_SCREWED_TO_FRAME)
			to_chat(user, "<span class='info'>The window is <b>screwed</b> to the frame.</span>")
		else if(anchored && state == WINDOW_IN_FRAME)
			to_chat(user, "<span class='info'>The window is <i>unscrewed</i> but <b>pried</b> into the frame.</span>")
		else if(anchored && state == WINDOW_OUT_OF_FRAME)
			to_chat(user, "<span class='info'>The window is out of the frame, but could be <i>pried</i> in. It is <b>screwed</b> to the floor.</span>")
		else if(!anchored)
			to_chat(user, "<span class='info'>The window is <i>unscrewed</i> from the floor. There's only a couple of <b>bolts</b> keeping it intact.</span>")
	else
		if(anchored)
			to_chat(user, "<span class='info'>The window is <b>screwed</b> to the floor.</span>")
		else
			to_chat(user, "<span class='info'>The window is <i>unscrewed</i> from the floor. There's only a couple of <b>bolts</b> keeping it intact.</span>")
