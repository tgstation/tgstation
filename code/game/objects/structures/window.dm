...
/obj/structure/window/examine(mob/user)
	...
	if(reinf)
		if(anchored && state == WINDOW_SCREWED_TO_FRAME)
			to_chat(user, "The window is <i>screwed</i> to the frame.")
		else if(anchored && state == WINDOW_IN_FRAME)
			to_chat(user, "The window is <i>unscrewed</i> but <i>pried</i> into the frame.")
		else if(anchored && state == WINDOW_OUT_OF_FRAME)
			to_chat(user, "The window is out of the frame, but could be <i>pried</i> in. It is <i>screwed</i> to the floor.")
		else if(!anchored)
			to_chat(user, "The window is <i>unscrewed</i> from the floor, and could be deconstructed by <i>wrenching</i>.")
	else
		if(anchored)
			to_chat(user, "The window is <i>screwed</i> to the floor.</span>")
		else
			to_chat(user, "The window is <i>unscrewed</i> from the floor, and could be deconstructed by <i>wrenching</i>.")
