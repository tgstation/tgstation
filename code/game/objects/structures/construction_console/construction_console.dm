 ...
 *
 * Using this console will put the user in control of a [base building drone][/mob/eye/camera/ai/remote/base_construction].
...
/obj/machinery/computer/camera_advanced/base_construction/CreateEye()
	...
	if (!spawn_spot)
		return FALSE
	eyeobj = new /mob/eye/camera/ai/remote/base_construction(spawn_spot, src)
	eyeobj.origin = src
	return TRUE
 ...
 *
 */
/mob/eye/camera/ai/remote/base_construction
...
/mob/eye/camera/ai/remote/base_construction/Initialize(mapload, obj/machinery/computer/camera_advanced/console_link)
...
/mob/eye/camera/ai/remote/base_construction/setLoc(turf/destination, force_update = FALSE)
...
/mob/eye/camera/ai/remote/base_construction/relaymove(mob/living/user, direction)
