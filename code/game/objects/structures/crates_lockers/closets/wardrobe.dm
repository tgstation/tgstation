...
/obj/structure/closet/wardrobe/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/blue(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/pink/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/pink(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/brown(src)
	return
...
/obj/structure/closet/wardrobe/black/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/black(src)
	if(prob(25))
...
/obj/structure/closet/wardrobe/green/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/green(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/black(src)
...
/obj/structure/closet/wardrobe/yellow/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/yellow(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/orange(src)
...
/obj/structure/closet/wardrobe/white/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/white(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/grey/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/dress/skirt/color/grey(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/black(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/mixed/PopulateContents()
	...
	new /obj/item/clothing/under/dress/skirt/color/orange(src)
	new /obj/item/clothing/under/color/pink(src)
	new /obj/item/clothing/under/dress/skirt/color/pink(src)
	new /obj/item/clothing/under/color/red(src)
	new /obj/item/clothing/under/dress/skirt/color/red(src)
	new /obj/item/clothing/under/color/darkblue(src)
	new /obj/item/clothing/under/dress/skirt/color/darkblue(src)
	new /obj/item/clothing/under/color/teal(src)
	new /obj/item/clothing/under/dress/skirt/color/teal(src)
	new /obj/item/clothing/under/color/lightpurple(src)
	new /obj/item/clothing/under/dress/skirt/color/lightpurple(src)
	new /obj/item/clothing/under/color/green(src)
	new /obj/item/clothing/under/dress/skirt/color/green(src)
