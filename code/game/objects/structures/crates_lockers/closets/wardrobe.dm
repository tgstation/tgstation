...
/obj/structure/closet/wardrobe/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/blue/skirt(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/pink/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/pink/skirt(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/brown(src)
	return
...
/obj/structure/closet/wardrobe/black/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/black/skirt(src)
	if(prob(25))
...
/obj/structure/closet/wardrobe/green/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/green/skirt(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/black(src)
...
/obj/structure/closet/wardrobe/yellow/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/yellow/skirt(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/orange(src)
...
/obj/structure/closet/wardrobe/white/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/white/skirt(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/grey/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/color/grey/skirt(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/black(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/mixed/PopulateContents()
	...
	new /obj/item/clothing/under/color/orange/skirt(src)
	new /obj/item/clothing/under/color/pink(src)
	new /obj/item/clothing/under/color/pink/skirt(src)
	new /obj/item/clothing/under/color/red(src)
	new /obj/item/clothing/under/color/red/skirt(src)
	new /obj/item/clothing/under/color/darkblue(src)
	new /obj/item/clothing/under/color/darkblue/skirt(src)
	new /obj/item/clothing/under/color/teal(src)
	new /obj/item/clothing/under/color/teal/skirt(src)
	new /obj/item/clothing/under/color/lightpurple(src)
	new /obj/item/clothing/under/color/lightpurple/skirt(src)
	new /obj/item/clothing/under/color/green(src)
	new /obj/item/clothing/under/color/green/skirt(src)
