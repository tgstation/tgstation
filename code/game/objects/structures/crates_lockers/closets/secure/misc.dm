...
/obj/structure/closet/secure_closet/ert_engi/PopulateContents()
	..()
	SSwardrobe.provide(/obj/item/stack/sheet/plasteel, src, STACK_AMOUNT(50))
	SSwardrobe.provide(/obj/item/stack/sheet/iron, src, STACK_AMOUNT(50))
	SSwardrobe.provide(/obj/item/stack/sheet/glass, src, STACK_AMOUNT(50))
	SSwardrobe.provide(/obj/item/stack/sheet/mineral/sandbags, src, STACK_AMOUNT(30))
