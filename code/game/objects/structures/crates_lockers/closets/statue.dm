...
/obj/structure/statue/petrified/New(loc, mob/living/L, statue_timer)
	...
	if(L)
		...
		L.visible_message("<span class='warning'>[IDENTITY_SUBJECT(1)]'s skin rapidly turns to marble!</span>", "<span class='userdanger'>Your body freezes up! Can't... move... can't...  think...</span>", subjects=list(L))
		L.forceMove(src)
		L.disabilities |= MUTE
