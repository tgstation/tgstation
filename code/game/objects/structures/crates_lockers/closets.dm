...
/obj/structure/closet/examine(mob/user)
	..()
	if(welded)
		to_chat(user, "<span class='info'>It's welded shut.</span>")
	if(anchored)
		to_chat(user, "<span class='info'>It is <b>bolted</b> to the ground.</span>")
	if(opened)
		to_chat(user, "<span class='info'>The parts are <b>welded</b> together.</span>")
