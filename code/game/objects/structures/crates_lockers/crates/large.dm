...
/obj/structure/locker/crate/large/Initialize(mapload)
	. = ..()
	ADD_TRAIT(src, TRAIT_NO_MISSING_ITEM_ERROR, TRAIT_GENERIC)

/obj/structure/locker/crate/large/attack_hand(mob/user, list/modifiers)
...
/obj/structure/locker/crate/large/attackby(obj/item/W, mob/living/user, params)
