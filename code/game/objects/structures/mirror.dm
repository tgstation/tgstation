...
/obj/structure/mirror/attack_hand(mob/user)
	...
	if(ishuman(user))
		...
		if(H.gender == MALE)
			var/new_style = input(user, "Select a facial hair style", "Grooming")  as null|anything in SLOTH.facial_hair_styles_list
			if(userloc != H.loc)
		...
		//handle normal hair
		var/new_style = input(user, "Select a hair style", "Grooming")  as null|anything in SLOTH.hair_styles_list
		if(userloc != H.loc)
			return	//no tele-grooming
		if(new_style)
...
/obj/structure/mirror/magic/lesser/New()
	choosable_races = SLOTH.roundstart_species
	..()
...
/obj/structure/mirror/magic/attack_hand(mob/user)
	...
	switch(choice)
		...
		if("race")
			...
			newrace = SLOTH.species_list[racechoice]
			...
			if(H.dna.species.use_skintones)
				var/new_s_tone = input(user, "Choose your skin tone:", "Race change")  as null|anything in SLOTH.skin_tones
