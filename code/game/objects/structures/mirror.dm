...
/obj/structure/mirror/proc/change_beard(mob/living/carbon/human/beard_dresser)
	...
	var/new_style = tgui_input_list(beard_dresser, "Select a facial hairstyle", "Grooming", ACCESSORIES.facial_hairstyles_list)
...
/obj/structure/mirror/proc/change_hair(mob/living/carbon/human/hairdresser)
	var/new_style = tgui_input_list(hairdresser, "Select a hairstyle", "Grooming", ACCESSORIES.hairstyles_list)
	if(isnull(new_style))
		return TRUE
