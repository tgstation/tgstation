...
/obj/structure/mirror/attacked_by(obj/item/I, mob/living/user)
	...
	if(broken) // breaking a mirror truly gets you bad luck!
		...
		user.add_component(/datum/component/omen, silent = TRUE) // we have our own message
...
/obj/structure/mirror/bullet_act(obj/projectile/P)
	...
	if(broken) // breaking a mirror truly gets you bad luck!
		...
		unlucky_dude.add_component(/datum/component/omen, silent=TRUE) // we have our own message
