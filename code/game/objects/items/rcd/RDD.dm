...
GLOBAL_LIST_INIT(rdd_designs, list(
	...
	"Flowers" = list(
		...
		list("name" = "Plastic Fire Blossom", "path" = /obj/structure/decoration/fireblossom/first),
		list("name" = "Plastic Fire Blossom (Alt)", "path" = /obj/structure/decoration/fireblossom/second),
		list("name" = "Plastic Fire Blossom (Random)", "path" = /obj/structure/decoration/fireblossom/style_random),
		list("name" = "Plastic Cacti", "path" = /obj/structure/decoration/cacti/first),
		list("name" = "Plastic Cacti (Alt)", "path" = /obj/structure/decoration/cacti/second),
		list("name" = "Plastic Cacti (Alt 2)", "path" = /obj/structure/decoration/cacti/third),
		list("name" = "Plastic Cacti (Alt 3)", "path" = /obj/structure/decoration/cacti/fourth),
		list("name" = "Plastic Cacti (Random)", "path" = /obj/structure/decoration/cacti/style_random),
	),
	"Snow" = list(
	...
	"Mushrooms" = list(
		list("name" = "Plastic Large Mushrooms", "path" = /obj/structure/decoration/mushroom/large/first),
		list("name" = "Plastic Large Mushrooms (Alt)", "path" = /obj/structure/decoration/mushroom/large/second),
		list("name" = "Plastic Large Mushrooms (Alt2)", "path" = /obj/structure/decoration/mushroom/large/third),
		list("name" = "Plastic Large Mushrooms (Alt3)", "path" = /obj/structure/decoration/mushroom/large/fourth),
		list("name" = "Plastic Large Mushrooms (Random)", "path" = /obj/structure/decoration/mushroom/large/style_random),
		list("name" = "Plastic Leafy Mushrooms", "path" = /obj/structure/decoration/mushroom/leaf_shroom/first),
		list("name" = "Plastic Leafy Mushrooms (Alt)", "path" = /obj/structure/decoration/mushroom/leaf_shroom/second),
		list("name" = "Plastic Leafy Mushrooms (Alt2)", "path" = /obj/structure/decoration/mushroom/leaf_shroom/third),
		list("name" = "Plastic Leafy Mushrooms (Alt3)", "path" = /obj/structure/decoration/mushroom/leaf_shroom/fourth),
		list("name" = "Plastic Leafy Mushrooms (Random)", "path" = /obj/structure/decoration/mushroom/leaf_shroom/style_random),
		list("name" = "Plastic Tall Mushrooms", "path" = /obj/structure/decoration/mushroom/cap_shroom/first),
		list("name" = "Plastic Tall Mushrooms (Alt)", "path" = /obj/structure/decoration/mushroom/cap_shroom/second),
		list("name" = "Plastic Tall Mushrooms (Alt2)", "path" = /obj/structure/decoration/mushroom/cap_shroom/third),
		list("name" = "Plastic Tall Mushrooms (Alt3)", "path" = /obj/structure/decoration/mushroom/cap_shroom/fourth),
		list("name" = "Plastic Tall Mushrooms (Random)", "path" = /obj/structure/decoration/mushroom/cap_shroom/style_random),
		list("name" = "Plastic Numerous Mushrooms", "path" = /obj/structure/decoration/mushroom/stem_shroom/first),
		list("name" = "Plastic Numerous Mushrooms (Alt)", "path" = /obj/structure/decoration/mushroom/stem_shroom/second),
		list("name" = "Plastic Numerous Mushrooms (Alt2)", "path" = /obj/structure/decoration/mushroom/stem_shroom/third),
		list("name" = "Plastic Numerous Mushrooms (Alt3)", "path" = /obj/structure/decoration/mushroom/stem_shroom/fourth),
		list("name" = "Plastic Numerous Mushrooms (Random)", "path" = /obj/structure/decoration/mushroom/stem_shroom/style_random),
		list("name" = "Plastic Seraka Mushrooms", "path" = /obj/structure/decoration/mushroom/seraka/first),
		list("name" = "Plastic Seraka Mushrooms (Alt)", "path" = /obj/structure/decoration/mushroom/seraka/second),
		list("name" = "Plastic Seraka Mushrooms (Random)", "path" = /obj/structure/decoration/mushroom/seraka/style_random),
		list("name" = "Plastic Glowgrowth Colony", "path" = /obj/structure/decoration/mushroom/glowgrowth/first),
		list("name" = "Plastic Glowgrowth Colony (Alt)", "path" = /obj/structure/decoration/mushroom/glowgrowth/second),
		list("name" = "Plastic Glowgrowth Colony (Alt2)", "path" = /obj/structure/decoration/mushroom/glowgrowth/third),
		list("name" = "Plastic Glowgrowth Colony (Random)", "path" = /obj/structure/decoration/mushroom/glowgrowth/style_random),
	),
))
