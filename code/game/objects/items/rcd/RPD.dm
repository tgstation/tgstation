...
GLOBAL_LIST_INIT(disposal_pipe_recipes, list(
	"Disposal Pipes" = list(
		...
		new /datum/pipe_info/disposal("Down Junction", /obj/structure/disposalpipe/trunk/multiz/down),
		new /datum/pipe_info/disposal("Up Junction", /obj/structure/disposalpipe/trunk/multiz),
