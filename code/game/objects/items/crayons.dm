...
/obj/item/toy/crayon/red
	...
	paint_color = "#DA0000"
	item_color = "red"
	reagent_contents = list("nutriment" = 1, "redcrayonpowder" = 10)

/obj/item/toy/crayon/orange
	icon_state = "crayonorange"
	paint_color = "#FF9300"
	item_color = "orange"
	reagent_contents = list("nutriment" = 1, "orangecrayonpowder" = 10)

/obj/item/toy/crayon/yellow
	icon_state = "crayonyellow"
	paint_color = "#FFF200"
	item_color = "yellow"
	reagent_contents = list("nutriment" = 1, "yellowcrayonpowder" = 10)

/obj/item/toy/crayon/green
	icon_state = "crayongreen"
	paint_color = "#A8E61D"
	item_color = "green"
	reagent_contents = list("nutriment" = 1, "greencrayonpowder" = 10)

/obj/item/toy/crayon/blue
	icon_state = "crayonblue"
	paint_color = "#00B7EF"
	item_color = "blue"
	reagent_contents = list("nutriment" = 1, "bluecrayonpowder" = 10)

/obj/item/toy/crayon/purple
	icon_state = "crayonpurple"
	paint_color = "#DA00FF"
	item_color = "purple"
	reagent_contents = list("nutriment" = 1, "purplecrayonpowder" = 10)

/obj/item/toy/crayon/black
	icon_state = "crayonblack"
	paint_color = "#1C1C1C" //Not completely black because total black looks bad. So Mostly Black.
	item_color = "black"
	reagent_contents = list("nutriment" = 1, "blackcrayonpowder" = 10)

/obj/item/toy/crayon/white
	icon_state = "crayonwhite"
	paint_color = "#FFFFFF"
	item_color = "white"
	reagent_contents = list("nutriment" = 1, "whitecrayonpowder" = 10)
...
/obj/item/toy/crayon/mime
	...
	paint_color = "#FFFFFF"
	item_color = "mime"
	reagent_contents = list("nutriment" = 1, "invisiblecrayonpowder" = 10)
	charges = -1
...
/obj/item/toy/crayon/rainbow
	...
	paint_color = "#FFF000"
	item_color = "rainbow"
	reagent_contents = list("nutriment" = 1, "colorful_reagent" = 10)
