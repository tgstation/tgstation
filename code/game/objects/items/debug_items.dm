...
/obj/item/debug/omnitool/attack_self(mob/user)
	...
	var/list/tool_list = list(
		...
		"Retractor" = image(icon = 'icons/obj/medical/surgery_tools.dmi', icon_state = "retractor_stg"),
		"Hemostat" = image(icon = 'icons/obj/medical/surgery_tools.dmi', icon_state = "hemostat_stg"),
		"Cautery" = image(icon = 'icons/obj/medical/surgery_tools.dmi', icon_state = "cautery_stg"),
		"Drill" = image(icon = 'icons/obj/medical/surgery_tools.dmi', icon_state = "drill_stg"),
		"Scalpel" = image(icon = 'icons/obj/medical/surgery_tools.dmi', icon_state = "scalpel_stg"),
		"Saw" = image(icon = 'icons/obj/medical/surgery_tools.dmi', icon_state = "saw_stg"),
