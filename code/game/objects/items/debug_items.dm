...
/obj/item/debug/omnitool/attack_self(mob/user)
	...
	var/list/tool_list = list(
		...
		"Multitool" = image(icon = 'icons/obj/devices/device.dmi', icon_state = "multitool"),
		...
		"Analyzer" = image(icon = 'icons/obj/devices/device.dmi', icon_state = "analyzer"),
		"Pickaxe" = image(icon = 'icons/obj/mining_zones/equipement.dmi', icon_state = "minipick"),
		"Shovel" = image(icon = 'icons/obj/mining_zones/equipement.dmi', icon_state = "shovel"),
