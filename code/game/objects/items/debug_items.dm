...
/obj/item/debug/omnitool/attack_self(mob/user)
	...
	var/list/tool_list = list(
		...
		"Retractor" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "retractor"),
		"Hemostat" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "hemostat"),
		"Cautery" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "cautery"),
		"Drill" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "drill"),
		"Scalpel" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "scalpel"),
		"Saw" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "saw"),
		"Bonesetter" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "bone setter"),
		"Knife" = image(icon = 'icons/obj/kitchen.dmi', icon_state = "knife"),
		"Blood Filter" = image(icon = 'icons/obj/medical/surgery.dmi', icon_state = "bloodfilter"),
