...
/obj/item/storage/bag/ore/proc/Pickup_ores(mob/living/user)
	...
	if(show_message)
		...
		if (box)
			user.visible_message("<span class='none'>[user] offloads the ores beneath [user.p_them()] into [box].</span>", \
			"<span class='notice'>You offload the ores beneath you into your [box].</span>")
		else
			user.visible_message("<span class='none'>[user] scoops up the ores beneath [user.p_them()].</span>", \
