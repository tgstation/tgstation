...
/obj/item/storage/box/syndie_kit/chemical/PopulateContents()
	...
	new /obj/item/reagent_containers/glass/bottle/neurotoxin(src)
	new /obj/item/reagent_containers/glass/bottle/entpoly(src)
	new /obj/item/reagent_containers/glass/bottle/spewium(src)
	new /obj/item/reagent_containers/glass/bottle/cyanide(src)
	new /obj/item/reagent_containers/glass/bottle/krokodil(src)
