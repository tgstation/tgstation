...
/obj/item/storage/box/suicide_act(mob/living/carbon/user)
	user.visible_message("<span class='suicide'>[user] puts [user.p_their()] head into \the [src] and starts hyperventilating! It looks like [user.p_theyre()] trying to commit suicide!</span>")
	return OXYLOSS
