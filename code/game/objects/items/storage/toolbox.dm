...
/obj/item/storage/toolbox/electrical/PopulateContents()
	...
	new /obj/item/crowbar(src)
	new /obj/item/stack/cable_coil/power(src,30,pickedcolor)
	new /obj/item/stack/cable_coil/power(src,30,pickedcolor)
	if(prob(5))
...
/obj/item/storage/toolbox/artistic/PopulateContents()
	...
	new/obj/item/crowbar(src)
	new/obj/item/stack/cable_coil/power/red(src)
	new/obj/item/stack/cable_coil/power/yellow(src)
	new/obj/item/stack/cable_coil/power/blue(src)
	new/obj/item/stack/cable_coil/power/green(src)
	new/obj/item/stack/cable_coil/power/pink(src)
	new/obj/item/stack/cable_coil/power/orange(src)
	new/obj/item/stack/cable_coil/power/cyan(src)
	new/obj/item/stack/cable_coil/power/white(src)
