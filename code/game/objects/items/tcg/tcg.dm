...
/obj/item/cardpack
	...
	///The guaranteed rarity table, acts about the same as the rarity table. it can have as many or as few rarities as you'd like
...
/datum/card
	...
	var/faction = "socks"
	///Used to define the behavior the card uses during the game.
