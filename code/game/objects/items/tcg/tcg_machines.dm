...
/obj/machinery/trading_card_button
	...
	/// Where the panel will be spawned in relation to the button on the Why axis.
...
/// A display panel that renders a set of icons (in this case mana crystals), this is generated by /obj/machinery/trading_card_button. Can be manipulated by the button which generates it.
/obj/effect/trading_card_panel
	...
	var/max_gems = 10
	/// Where the gem bar is placed in relation to the centre of the panel on the Why axis.
	...
	/// The gap between each gem on the Why axis
