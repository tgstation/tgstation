...
/obj/item/melee/supermatter_sword/Initialize(mapload)
	...
	AddComponent(/datum/component/dusting, consume_on_bumped = FALSE, consume_on_attackby = TRUE, consume_on_attack_hand = FALSE, consume_all_contents = TRUE, consume_turfs = TRUE, ignore_subtypesof = list()) //If you can hit it, consume it
