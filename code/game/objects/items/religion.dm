...
/obj/item/clothing/suit/armor/plate/crusader
	...
	armor = list(MELEE = 50, BULLET = 50, LASER = 50, ENERGY = 50, BOMB = 60, FIRE = 60, ACID = 60)
...
/obj/item/clothing/shoes/plate
	...
	icon_state = "crusader"
	w_class = WEIGHT_CLASS_NORMAL
	armor = list(MELEE = 50, BULLET = 50, LASER = 50, ENERGY = 50, BOMB = 60, FIRE = 60, ACID = 60) //does this even do anything on boots?
