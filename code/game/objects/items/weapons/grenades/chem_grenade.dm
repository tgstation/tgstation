...
/obj/item/weapon/grenade/chem_grenade/prime()
	...
	if(reagents && reagents.total_volume)	//The possible reactions didnt use up all reagents, so we spread it around.
