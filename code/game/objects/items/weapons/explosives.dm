...
/obj/item/weapon/plastique/afterattack(atom/movable/target, mob/user, flag)
	if (!flag)
		return
	if (istype(target, /turf/unsimulated) || istype(target, /turf/simulated/floor/shuttle)|| istype(target, /turf/simulated/wall/shuttle) || istype(target, /obj/item/weapon/storage/))
		return
