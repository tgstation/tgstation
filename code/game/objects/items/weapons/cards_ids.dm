...
/obj/item/weapon/card/id/attack_self(mob/user)
	user.visible_message("<span class='notice'>[IDENTITY_SUBJECT(1)] shows you: \icon[src] [src.name].</span>", \
					"<span class='notice'>You show \the [src.name].</span>", subjects=list(user))
