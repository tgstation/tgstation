...
/obj/item/weapon/storage/box/syndicate/New()
	..()
	switch (pickweight(list("bloodyspai" = 1, "stealth" = 1, "bond" = 1, "screwed" = 1, "guns" = 1, "murder" = 1, "implant" = 1, "hacker" = 1, "lordsingulo" = 1, "darklord" = 1, "jacket" = 1111)))
		if("bloodyspai")
		...
		if("jacket") //Do you like hurting other people?
			new /obj/item/device/voice_synthesizer/tape(src)
			...
			if(prob(50))
				new /obj/item/weapon/psycho/machete(src)
			else
