...
/obj/item/weapon/storage/bag/trash/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[IDENTITY_SUBJECT(1)] puts [src] over [user.p_their()] head and starts chomping at the insides! Disgusting!</span>", subjects=list(user))
