...
/obj/item/weapon/twohanded/dualsaber/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text, final_block_chance)
	if(wielded)
		return ..()
	return 0
...
/obj/item/weapon/twohanded/required/chainsaw/doomslayer/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text, final_block_chance, damage, attack_type)
...
/obj/item/weapon/twohanded/vibro_weapon/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text, final_block_chance, damage, attack_type)
	if(wielded)
