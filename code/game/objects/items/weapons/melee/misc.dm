...
/obj/item/weapon/melee/classic_baton/telescopic/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] stuffs the [src] down their throat and presses the 'extend' button! It looks like they're trying to commit suicide.</span>")
