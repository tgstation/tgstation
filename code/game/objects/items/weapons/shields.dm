...
/obj/item/weapon/shield/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text, final_block_chance, damage, attack_type)
...
/obj/item/weapon/shield/energy/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text, final_block_chance)
	return 0
...
/obj/item/weapon/shield/riot/tele/hit_reaction(mob/living/carbon/human/owner, atom/movable/AM, attack_text, final_block_chance)
	if(active)
		return ..()
	return 0
