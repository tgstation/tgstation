...
/obj/machinery/implantchair
	...
	var/ready = 1
	var/malfunction = 0
	var/list/obj/item/medical/implant/loyalty/implant_list = list()
	var/max_implants = 5
	...
	implant(var/mob/M)
		...
		for(var/obj/item/medical/implant/loyalty/imp in implant_list)
			if(!imp)	continue
			if(istype(imp, /obj/item/medical/implant/loyalty))
	...
	add_implants()
		for(var/i=0, i<src.max_implants, i++)
			var/obj/item/medical/implant/loyalty/I = new /obj/item/medical/implant/loyalty(src)
			implant_list += I
		return
