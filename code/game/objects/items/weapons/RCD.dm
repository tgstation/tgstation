...
/obj/item/weapon/rcd/verb/change_airlock_setting()
	...
	var airlockcat = input(usr, "Select whether the airlock is solid or glass.", choices = list("Solid", "Glass"))
	switch(airlockcat)
		if("Solid")
			if(advanced_airlock_setting == 1)
				var airlockpaint = input(usr, "Select the paintjob of the airlock.", choices = list("Default", "Engineering", "Atmospherics", "Security", "Command", "Medical", "Research", "Mining", "Maintenance", "External", "High Security"))
				switch(airlockpaint)
					if("Default")
		...
		if("Glass")
			if(advanced_airlock_setting == 1)
				var airlockpaint = input(usr, "Select the paintjob of the airlock.", choices = list("Default", "Engineering", "Atmospherics", "Security", "Command", "Medical", "Research", "Mining"))
				switch(airlockpaint)
					if("Default")
