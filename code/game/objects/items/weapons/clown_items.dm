...
/obj/item/weapon/soap/afterattack(atom/target, mob/user as mob, proximity)
	...
	if(user.client && (target in user.client.screen))
		...
		user.visible_message("<span class='warning'>[user] begins to scrub \the [target.name] out with [src].</span>", "<span class='notice'>You begin to scrub \the [target.name] out with [src]...</span>")
		...
		user.visible_message("<span class='warning'>[user] begins to clean \the [target.name] with [src].</span>", "<span class='notice'>You begin to clean \the [target.name] with [src]...</span>")
		if(do_after(user, src.cleanspeed))
