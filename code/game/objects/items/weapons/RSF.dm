...
/obj/item/weapon/rsf/afterattack(atom/A, mob/user, proximity)
	...
	else if (istype(A, /turf/floor) && mode == 1)
		if (istype(A, /turf/floor) && matter >= 1)
			user << "Dispensing Dosh..."
			playsound(src.loc, 'sound/machines/click.ogg', 10, 1)
	...
	else if (istype(A, /turf/floor) && mode == 2)
		if (istype(A, /turf/floor) && matter >= 1)
			user << "Dispensing Drinking Glass..."
			playsound(src.loc, 'sound/machines/click.ogg', 10, 1)
	...
	else if (istype(A, /turf/floor) && mode == 3)
		if (istype(A, /turf/floor) && matter >= 1)
			user << "Dispensing Paper Sheet..."
			playsound(src.loc, 'sound/machines/click.ogg', 10, 1)
	...
	else if (istype(A, /turf/floor) && mode == 4)
		if (istype(A, /turf/floor) && matter >= 1)
			user << "Dispensing Pen..."
			playsound(src.loc, 'sound/machines/click.ogg', 10, 1)
	...
	else if (istype(A, /turf/floor) && mode == 5)
		if (istype(A, /turf/floor) && matter >= 1)
			user << "Dispensing Dice Pack..."
			playsound(src.loc, 'sound/machines/click.ogg', 10, 1)
	...
	else if (istype(A, /turf/floor) && mode == 6)
		if (istype(A, /turf/floor) && matter >= 1)
			user << "Dispensing Cigarette..."
			playsound(src.loc, 'sound/machines/click.ogg', 10, 1)
