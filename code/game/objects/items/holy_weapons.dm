...
/obj/item/nullrod/carp/Initialize()
	. = ..()
	AddComponent(/datum/component/faction_granter, "carp", holy_role_required = TRUE, grant_message = span_boldnotice("You are blessed by Carp-Sie. Wild space carp will no longer attack you."))
