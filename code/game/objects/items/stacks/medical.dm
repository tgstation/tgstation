...
/obj/item/stack/medical/gauze/proc/can_gauze_limb(mob/user, mob/living/patient, obj/item/bodypart/limb)
...
/obj/item/stack/medical/gauze/proc/on_gauze_limb(mob/user, mob/living/patient, obj/item/bodypart/limb)
