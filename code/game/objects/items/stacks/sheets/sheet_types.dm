...
GLOBAL_LIST_INIT(plastic_recipes, list(
	...
	new /datum/stack_recipe("liquid cooler jug", /obj/item/reagent_containers/cooler_jug, 10, crafting_flags = NONE, category = CAT_CONTAINERS), \
	new /datum/stack_recipe("liquid cooler", /obj/structure/reagent_dispensers/water_cooler/jugless, 25, crafting_flags = NONE, category = CAT_STRUCTURE), \
