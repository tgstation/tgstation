...
GLOBAL_LIST_INIT(plasteel_recipes, list ( \
	...
	new/datum/stack_recipe("shutter assembly", /obj/machinery/door/poddoor/shutters/preopen/deconstructed, 5, time = 5 SECONDS, one_per_turf = TRUE, check_density = CAT_STRUCTURE, category = CAT_ATMOSPHERIC),
	null,
	new /datum/stack_recipe_list("airlock assemblies", list( \
