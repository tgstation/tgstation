 ...
 * Dye
 */
/obj/item/stack/sheet/dye
	name = "universal dye"
	desc = "A universal dyeing agent used for clothing production. Do not eat and keep out of reach of clowns."
	singular_name = "dye packet"
	icon_state = "sheet-cloth"
	item_state = "sheet-cloth"
	color = "#DA0000"
	resistance_flags = FLAMMABLE
	materials = list(MAT_DYE=MINERAL_MATERIAL_AMOUNT)
	force = 0
	throwforce = 0
	merge_type = /obj/item/stack/sheet/dye
