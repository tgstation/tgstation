...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	new/datum/stack_recipe("wooden boat",  /obj/vehicle/ridden/lavaboat, 9, time = 1 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF, category = CAT_STRUCTURE), \
	new/datum/stack_recipe("wooden oar",  /obj/item/oar, 1, crafting_flags = NONE, category = CAT_TOOLS), \
