...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new/datum/stack_recipe("stairs", /obj/structure/stairs, 10, time = 10 SECONDS, one_per_turf = TRUE, on_solid_ground = TRUE), \
	null, \
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("wooden stairs", /obj/structure/stairs/wood, 10, time = 10 SECONDS, one_per_turf = TRUE, on_solid_ground = TRUE), \
