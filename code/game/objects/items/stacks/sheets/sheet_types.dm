...
GLOBAL_LIST_INIT(plasteel_recipes, list ( \
	...
	new/datum/stack_recipe("shutter assembly", /obj/machinery/door/poddoor/shutters/preopen/deconstructed, 5, time = 5 SECONDS, one_per_turf = TRUE, check_density = TRUE, category = CAT_DOORS),
	null,
	new /datum/stack_recipe_list("airlock assemblies", list( \
