...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	new/datum/stack_recipe("wooden boat",  /obj/vehicle/ridden/lavaboat, 4, time = 1 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF, category = CAT_STRUCTURE), \
