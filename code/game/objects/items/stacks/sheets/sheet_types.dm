...
var/global/list/datum/stack_recipe/runed_metal_recipes = list ( \
	...
	new/datum/stack_recipe("archives", /obj/structure/table/cult, 4, time = 40, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("altar", /obj/structure/table/altar, 10, time = 40, one_per_turf = 1, on_floor = 1), \
	)
