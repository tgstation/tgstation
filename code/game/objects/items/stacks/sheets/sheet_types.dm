...
/*		new/datum/stack_recipe("multi-tile airlock assembly",    /obj/structure/door_assembly/multi_tile,                 4, time = 50, one_per_turf = 1, on_floor = 1), \ */
	...
	null, \
	new/datum/stack_recipe("iron door", /obj/machinery/door/mineral_door/iron, 20, one_per_turf = 1, on_floor = 1), \
)
...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("wooden door", /obj/machinery/door/mineral_door/wood, 10, time = 20, one_per_turf = 1, on_floor = 1), \
