...
GLOBAL_LIST_INIT(brass_recipes, list ( \
	...
	null,
	new/datum/stack_recipe("brass filaments", /obj/item/clockwork/brass_filaments, 1, time = 0), \
	null,
	new/datum/stack_recipe("pressure sensor", /obj/structure/destructible/clockwork/trap/trigger/pressure_sensor, 3, time = 30, one_per_turf = TRUE, on_floor = TRUE), \
	null,
	new/datum/stack_recipe("brass skewer", /obj/structure/destructible/clockwork/trap/brass_skewer, 5, time = 50, one_per_turf = TRUE, on_floor = TRUE) \
))
