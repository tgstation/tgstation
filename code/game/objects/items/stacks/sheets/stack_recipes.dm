var/global/list/datum/stack_recipe/all_recipes = list ( \
	...
	null, \
	new/datum/stack_recipe("door", /obj/structure/mineral_door, 20, one_per_turf = 1, on_floor = 1), \
	...
	new/datum/stack_recipe("sandals", /obj/item/clothing/shoes/sandal, 1), \
	new/datum/stack_recipe("rifle stock", /obj/item/weaponcrafting/stock, 10, time = 40), \
	new/datum/stack_recipe("barricade", /obj/structure/barricade/wooden, 5, time = 50, one_per_turf = 1, on_floor = 1), \
