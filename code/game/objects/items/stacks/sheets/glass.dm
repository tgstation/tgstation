...
/obj/item/stack/sheet/glass
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 50, ACID = 100)
...
/obj/item/stack/sheet/plasmaglass
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 75, ACID = 100)
	resistance_flags = ACID_PROOF
...
/obj/item/stack/sheet/rglass
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 70, ACID = 100)
	resistance_flags = ACID_PROOF
...
/obj/item/stack/sheet/plasmarglass
	...
	armor = list(MELEE = 20, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 80, ACID = 100)
	resistance_flags = ACID_PROOF
	material_flags = NONE
...
/obj/item/shard
	...
	resistance_flags = ACID_PROOF
	armor = list(MELEE = 100, BULLET = 0, LASER = 0, ENERGY = 100, BOMB = 0, FIRE = 50, ACID = 100)
	max_integrity = 40
