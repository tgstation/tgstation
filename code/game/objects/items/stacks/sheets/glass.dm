...
GLOBAL_LIST_INIT(titaniumglass_recipes, list(
	...
	new/datum/stack_recipe("titanium glass tile", /obj/item/stack/tile/titanium_glass, 1, 4, 20, category = CAT_TILES) \
	))
...
GLOBAL_LIST_INIT(plastitaniumglass_recipes, list(
	new/datum/stack_recipe("directional pod window", /obj/structure/window/reinforced/survival_pod/unanchored, time = 0.5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ON_SOLID_GROUND | CRAFT_CHECK_DIRECTION, category = CAT_WINDOWS), \
	...
	new/datum/stack_recipe("plastitanium glass tile", /obj/item/stack/tile/plastitanium_glass, 1, 4, 20, category = CAT_TILES) \
	))
