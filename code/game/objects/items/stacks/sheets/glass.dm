...
/obj/item/stack/sheet/rglass
	...
	materials = list(MAT_CATEGORY_IRON=MINERAL_MATERIAL_AMOUNT * 0.5, MAT_CATEGORY_GLASS=MINERAL_MATERIAL_AMOUNT)
...
/obj/item/stack/sheet/plastitaniumglass
	...
	materials = list(MAT_CATEGORY_TITANIUM=MINERAL_MATERIAL_AMOUNT * 0.5, MAT_CATEGORY_PLASMA=MINERAL_MATERIAL_AMOUNT * 0.5, MAT_CATEGORY_GLASS=MINERAL_MATERIAL_AMOUNT)
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 100)
	resistance_flags = ACID_PROOF
