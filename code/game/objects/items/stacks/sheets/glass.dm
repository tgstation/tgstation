...
/obj/item/stack/sheet/plasmaglass
	...
	grind_results = list("silicon" = 20, "plasma" = 20)
...
/obj/item/stack/sheet/rglass
	...
	materials = list(MAT_METAL=MINERAL_MATERIAL_AMOUNT*0.5, MAT_GLASS=MINERAL_MATERIAL_AMOUNT) //divide by 2 was complete non-issue for 3 years, and is optimized away by compiler nowadays, but good coding practices I guess
...
/obj/item/stack/sheet/plasmarglass
	...
	grind_results = list("silicon" = 20, "plasma" = 20, "iron" = 10)
