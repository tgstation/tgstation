...
GLOBAL_LIST_INIT(plastitaniumglass_recipes, list(
	new/datum/stack_recipe("directional plastitanium window", /obj/structure/window/reinforced/survival_pod, time = 0.5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ON_SOLID_GROUND | CRAFT_CHECK_DIRECTION, category = CAT_WINDOWS), \
