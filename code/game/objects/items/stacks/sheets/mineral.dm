...
GLOBAL_LIST_INIT(clay_recipes, list(
	new /datum/stack_recipe("bar mold", /obj/item/weapon/reagent_containers/glass/mold/bar, req_amount=1, res_amount=1),
	new /datum/stack_recipe("pickaxe mold", /obj/item/weapon/reagent_containers/glass/mold/pickaxe, req_amount=1, res_amount=1),
	new /datum/stack_recipe("sword mold", /obj/item/weapon/reagent_containers/glass/mold/sword, req_amount=1, res_amount=1),
