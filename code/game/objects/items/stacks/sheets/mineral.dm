...
/obj/item/stack/sheet/mineral/metal_hydrogen/atmos_expose(datum/gas_mixture/air, exposed_temperature)
	if(air.has_gas(/datum/gas/plasma, MINIMUM_MOLE_COUNT))
		total_progress += clamp(air.gases[/datum/gas/plasma][MOLES] * 0.1, 0, 10)
		air.gases[/datum/gas/plasma][MOLES] = max(air.gases[/datum/gas/plasma][MOLES] - clamp(air.gases[/datum/gas/plasma][MOLES] * 0.01, 0, 10), 0)
		air.garbage_collect()
...
/obj/item/stack/sheet/mineral/plasma_coated_metal_hydrogen/fifty
	amount = 50
