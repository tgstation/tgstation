...
GLOBAL_LIST_INIT(abductor_recipes, list ( \
	...
	new/datum/stack_recipe("strange closet", /obj/structure/closet/acloset, 4, time = 5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONTAINERS), \
