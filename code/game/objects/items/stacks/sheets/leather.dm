...
GLOBAL_LIST_INIT(leather_recipes, list ( \
	...
	new/datum/stack_recipe("leather gloves", /obj/item/clothing/gloves/botanic_leather, 3), \
	new/datum/stack_recipe("leather belt", /obj/item/storage/belt, 4), \
	new/datum/stack_recipe("leather satchel", /obj/item/storage/backpack/satchel/leather, 5), \
	new/datum/stack_recipe("hide poncho", /obj/item/clothing/suit/poncho/leather, 5), \
	new/datum/stack_recipe("tribal clothes", /obj/item/clothing/under/tribal, 5), \
	new/datum/stack_recipe("padded vest", /obj/item/clothing/suit/armor/vest/primitiveleather, 5), \
))
