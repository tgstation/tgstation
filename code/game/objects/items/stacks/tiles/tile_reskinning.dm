...
/obj/item/stack/tile/attack_self(mob/user)
	...
	if(tile_reskin_types && tile_rotate_dirs)
		radial_options["Reskin"] = image(icon = 'icons/ui/hud/radial.dmi', icon_state = "radial_reskin")
		radial_options["Rotate"] = image(icon = 'icons/ui/hud/radial.dmi', icon_state = "radial_rotate")
