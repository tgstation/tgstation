...
/obj/item/screwdriver/abductor
	...
	custom_materials = list(/datum/material/iron=ROD_MATERIAL_AMOUNT*5MATERIAL_AMOUNT*5, /datum/material/silver=2500, /datum/material/plasma =ROD_MATERIAL_AMOUNT, /datum/material/titanium =MINERAL_MATERIAL_AMOUNT, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT)
