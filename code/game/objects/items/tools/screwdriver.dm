...
/obj/item/screwdriver/power
	...
	lefthand_file = 'icons/mob/inhands/equipment/tools_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/tools_righthand.dmi'
	materials = list(MAT_CATEGORY_IRON=150,MAT_CATEGORY_SILVER=50,MAT_CATEGORY_TITANIUM=25) //done for balance reasons, making them high value for research, but harder to get
