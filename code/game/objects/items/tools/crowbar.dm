...
/obj/item/crowbar/mechremoval/proc/empty_mech(obj/vehicle/sealed/mecha/mech, mob/user)
	...
	PLAYSOUND(mech, 'sound/machines/airlock/airlock_alien_prying.ogg').volume(100).vary_frequency(TRUE).play()
	...
	PLAYSOUND(mech, 'sound/machines/airlock/airlockforced.ogg').volume(75).vary_frequency(TRUE).play()
