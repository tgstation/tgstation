/obj/item/wrench
	...
	attack_verb_continuous = list("bashed", "battered", "bludgeoned", "whacked")
...
/obj/item/wrench/medical
	...
	force = 2 //MEDICAL
	throwforce = 4
	attack_verb_continuous = list("healed", "medicaled", "tapped", "poked", "analyzed") //"cobbyed"
...
/obj/item/wrench/combat
	...
	attack_verb_continuous = list("devastated", "brutalized", "committed a war crime against", "obliterated", "humiliated")
