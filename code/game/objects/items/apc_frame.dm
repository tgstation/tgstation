/obj/item/wallframe
	...
	materials = list(MAT_CATEGORY_IRON=MINERAL_MATERIAL_AMOUNT*2)
	flags_1 = CONDUCT_1
...
/obj/item/wallframe/attackby(obj/item/W, mob/user, params)
	...
	var/metal_amt = round(materials[MAT_CATEGORY_IRON]/MINERAL_MATERIAL_AMOUNT)
	var/glass_amt = round(materials[MAT_CATEGORY_GLASS]/MINERAL_MATERIAL_AMOUNT)
