...
/obj/item/implant/uplink/Initialize(mapload, owner, uplink_flag)
	...
	var/datum/component/uplink/new_uplink = AddComponent(/datum/component/uplink, owner = owner, lockable = TRUE, enabled = FALSE, uplink_flag = uplink_flag, starting_tc = starting_tc)
