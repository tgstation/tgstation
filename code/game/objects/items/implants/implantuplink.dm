...
/obj/item/implant/nanouplink/Initialize(mapload, uplink_handler)
	. = ..()
	if(!uplink_flag)
		uplink_flag = src.uplink_flag
	src.uplink_handler = uplink_handler
 ...
 * the component, so delete itself.
 */
/obj/item/implant/nanouplink/proc/_component_removal(datum/source, datum/component/component)
	SIGNAL_HANDLER
