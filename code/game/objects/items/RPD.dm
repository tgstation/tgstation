...
GLOBAL_LIST_INIT(atmos_pipe_recipes, list(
	"Pipes" = list(
		...
		new /datum/pipe_info/pipe("Reinforced Pipe", /obj/machinery/atmospherics/pipe/simple/reinforced, TRUE),
		new /datum/pipe_info/pipe("Manifold", /obj/machinery/atmospherics/pipe/manifold, TRUE),
		new /datum/pipe_info/pipe("Reinforced Manifold", /obj/machinery/atmospherics/pipe/manifold/reinforced, TRUE),
		new /datum/pipe_info/pipe("4-Way Manifold", /obj/machinery/atmospherics/pipe/manifold4w, TRUE),
		new /datum/pipe_info/pipe("Reinforced 4-Way Manifold", /obj/machinery/atmospherics/pipe/manifold4w/reinforced, TRUE),
			...
			if(ATMOS_CATEGORY) //Making pipes
				...
				if (recipe.type == /datum/pipe_info/meter)
					...
					if(istype(queued_p_type, /obj/machinery/atmospherics/pipe/simple/reinforced) \
						|| istype(queued_p_type, /obj/machinery/atmospherics/pipe/manifold/reinforced) \
						|| istype(queued_p_type, /obj/machinery/atmospherics/pipe/manifold4w/reinforced))
						atmos_build_speed += 1.2 SECONDS
