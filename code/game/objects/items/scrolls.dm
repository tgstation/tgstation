...
/obj/item/teleportation_scroll/no_smoke/teleportscroll(mob/user)
	...
	for(var/L in acceptable_locations)
		...
		if(istype(T, /area/security) || istype(T, /area/shuttle/arrival) || istype(T, /area/crew_quarters/dorms) || istype(T, /area/awaymission/basketball) || istype(T, /area/crew_quarters/theatre) || istype(T, /area/hydroponics/garden/cornmaze) || istype(T, /area/awaymission/cabin/snowforest/forest) || istype(T, /area/awaymission/cabin/snowforest/field) || istype(T, /area/awaymission/cabin/snowforest/hauntedhouse) || istype(T, /area/crew_quarters/bar) || istype(T, /area/tdome/arena)) // areas you aren't allowed to teleport to
