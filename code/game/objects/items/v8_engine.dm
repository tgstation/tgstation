...
/obj/item/house_edge
	...
	custom_materials = list(/datum/material/iron = SHEET_MATERIAL_AMOUNT * 14.05, /datum/material/cardboard = SHEET_MATERIAL_AMOUNT, /datum/material/glass = SMALL_MATERIAL_AMOUNT * 0.7)
