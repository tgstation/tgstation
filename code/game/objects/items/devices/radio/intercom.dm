...
/obj/item/radio/intercom/examine(mob/user)
	..()
	if(!unfastened)
		to_chat(user, "<span class='info'>It's <b>screwed</b> and secured to the wall.</span>")
	else
		to_chat(user, "<span class='info'>It's <i>unscrewed</i> from the wall, and can be <b>detached</b>.</span>")
