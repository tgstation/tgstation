...
/obj/item/taperecorder/attackby(obj/item/I, mob/user, params)
	if(!mytape && istype(I, /obj/item/tape))
		...
		playsound(src, 'sound/items/taperecorder/taperecorder_close.ogg').play()
		update_appearance()
...
/obj/item/taperecorder/proc/eject(mob/user)
	...
	if(playing)
		...
		return
	playsound(src, 'sound/items/taperecorder/taperecorder_open.ogg').play()
...
/obj/item/taperecorder/verb/record()
	...
	playsound(src, 'sound/items/taperecorder/taperecorder_play.ogg').play()
	...
	if(mytape.used_capacity < mytape.max_capacity)
		...
		balloon_alert(usr, "tape full!")
		playsound(src, 'sound/items/taperecorder/taperecorder_stop.ogg').play()
...
/obj/item/taperecorder/verb/print_transcript()
	...
	playsound(src, 'sound/items/taperecorder/taperecorder_print.ogg').play()
	...
	if(icons_available)
		...
		switch(selection)
			if("Flip tape")
				...
				playsound(src, 'sound/items/taperecorder/tape_flip.ogg').volume(70).play()
			if("Unwind tape")
				if(loc != user)
					return
				unspool()
