...
/obj/item/device/hailer/attack_self(mob/living/carbon/user as mob)
	...
	if(emagged)
		if(insults >= 1)
			...
			user.visible_message("<span class='warning'>[user]'s [name] gurgles, \"FUCK YOUR CUNT YOU SHIT EATING COCKSTORM AND EAT A GUN FUCKING ASS-ENDING SHIT FUCK,EAT PENISES IN YOUR FUCK FACE AND SHIT OUT ABORTIONS TO FUCK AND SHIT IN YOUR ASS, YOU COCK SHIT FUCK MONKEY PUNK-ASS WANKER FROM THE DEPTHS OF SHIT.\"</span>")
			insults--
		else
