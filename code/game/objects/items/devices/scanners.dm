...
/proc/healthscan(var/mob/living/user, var/mob/living/M, var/mode = 1)
	...
	if (M.reagents && M.reagents.get_reagent_amount("ephedrine"))
		user.show_message("<span class='notice'>Bloodstream Analysis located [M.reagents:get_reagent_amount("ephedrine")] units of rejuvenation chemicals.</span>", 1)
