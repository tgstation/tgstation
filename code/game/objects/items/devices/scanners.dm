...
/obj/item/healthanalyzer/attack(mob/living/M, mob/living/carbon/human/user)
	...
	user.visible_message("<span class='none'>[user] has analyzed [M]'s vitals.</span>")
...
/obj/item/nanite_scanner/attack(mob/living/M, mob/living/carbon/human/user)
	user.visible_message("<span class='none'>[user] has analyzed [M]'s nanites.</span>")
...
/obj/item/sequence_scanner/attack(mob/living/M, mob/living/carbon/human/user)
	...
	if (!HAS_TRAIT(M, TRAIT_RADIMMUNE) && !HAS_TRAIT(M, TRAIT_BADDNA)) //no scanning if its a husk or DNA-less Species
		user.visible_message("<span class='none'>[user] has analyzed [M]'s genetic sequence.</span>")
		gene_scan(M, user)

	else
		user.visible_message("<span class='none'>[user] failed to analyse [M]'s genetic sequence.</span>", "<span class='warning'>[M] has no readable genetic sequence!</span>")
