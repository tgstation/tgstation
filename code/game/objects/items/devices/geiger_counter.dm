...
/obj/item/geiger_counter/Initialize(mapload)
	...
	RegisterSignal(src, COMSIG_PRE_POTENTIAL_IRRADIATION, .proc/on_pre_potential_irradiation)
...
/obj/item/geiger_counter/equipped(mob/user, slot, initial)
	...
	RegisterSignal(user, COMSIG_PRE_POTENTIAL_IRRADIATION, .proc/on_pre_potential_irradiation)

/obj/item/geiger_counter/dropped(mob/user, silent = FALSE)
	. = ..()

	UnregisterSignal(user, COMSIG_PRE_POTENTIAL_IRRADIATION, .proc/on_pre_potential_irradiation)
