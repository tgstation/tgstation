...
/proc/woundscan(mob/user, mob/living/carbon/patient, obj/item/healthanalyzer/scanner, simple_scan = FALSE)
	...
	if(render_list == "")
		if(simple_scan)
			...
			PLAYSOUND(simple_scanner, 'sound/machines/ping.ogg').vary_frequency(FALSE).play()
		...
		if(simple_scan)
			...
			PLAYSOUND(simple_scanner, 'sound/machines/beep/twobeep.ogg').vary_frequency(FALSE).play()
...
/proc/diseasescan(mob/user, mob/living/carbon/patient, obj/item/healthanalyzer/simple/scanner)
	...
	if(!length(render))
		PLAYSOUND(scanner, 'sound/machines/ping.ogg').vary_frequency(FALSE).play()
		...
		PLAYSOUND(scanner, 'sound/machines/beep/twobeep.ogg').vary_frequency(FALSE).play()
