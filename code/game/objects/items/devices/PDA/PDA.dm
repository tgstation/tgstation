...
/obj/item/device/pda
	...
	var/list/currentevents2 = list("CEO Discount Dan has been sued. Again.",
		...
		"Discount Dan's has created a new line of Discountu Danu food product for Space Japan. The food comprises of Space Carp on rice. More at ten.",
	...
	var/list/currentevents3 = list("Border patrol around Space America has tightened today after a wave of Tajarans yiffed their way across. We have reports of over 2000 molested Space Americans. More to come at seven.",
		...
		"Archaeologists have discovered gods final message to his creation today. The message reads, 'bawk'.",
		"Scientists have peered into the realm of the dead today. They say it was a horrible place full of unrobust faggots.",
