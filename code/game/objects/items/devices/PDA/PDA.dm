...
/obj/item/device/pda
	...
	var/list/currentevents1 = list("The Prime Minister of Space Australia has announced today a new policy to hand out fake dollar bills to the poor.",
		"The President of Space America issued a press release today stating that he is not in fact, a Tajarin in disguise.",
		...
		"Space Isreal has gone not gotten into trouble for bombing dirty Space Palistine again today. Don't be so anti-semetic.",
		"Our sources tell us that the Earth country Poland has issued a press release stating that 'they didn't want to go to space anyways' and that 'space sucks'. More at eleven.",
		...
		"Dirty Space Palistine just declared Jihad on Mighty Space Isreal. For shame, Space Palistine.",
		"The President of Space America was questioned today about his reaction to the Space Superstorm Baldman disaster, he replyed 'I didn't send anybody since I figured it would quit about three quarters through.",
		...
		"The President of Space America was photographed today with a fairly obvious tail protruding out of his pants, he denies the photo is real, saying 'I, president T'jkar Aw'krejn, am no Tajarin-- I mean catbeast.",
		...
		"The Czar of Space Russia has accused the President of Space America of being a dirty catbeast. The President wiggled his trademark ears and said that if he was a Tajarin, the Czar was a space shark. The President is being treated for bite wounds.",
	...
	var/list/currentevents2 = list("CEO Discount Dan has been sued. Again.",
		"NanoTransen has inducted a new policy wherein clowns will be spanked for stealing milk.",
		"Discount Dan's has created a new line of Discountue Danue food product for Space Japan. The food comprises of Space Carp on rice. More at ten.",
		"Discount Dan's has come under fire for their new 'Horsemeat Lasagna'",
		"NanoTransen's official website has been hacked this morning. The site read 'NT SUXZ, GO SYNDIEKATTZ!!1!1!!' for 48 hours until the site was fixed.",
		"Read the all new book by a former unnamed syndicate, 'NanoTransen sucks but the dental is good so whatever.'",
		"NanoTransen has released a new study that has been made useless by the internet.",
		"Discount Dan's 'Spooky Dan' line of product has come under fire for being unintentionally racist torward ghosts.",
		...
		"The Syndicate has issued a press release stating that 'NanoTransen sucks dicks.'",
		"NanoTransen CEO Johnson Lovelocker has been photographed kicking a Tajarin to death. This shameful publicity stunt is part of the new 'NT Hates Catbeasts, do you?' campaign.",
		"NanoTransen CEO Johnson Lovelocker has been photographed kicking a Vox in the cloaca. He commented that, 'BIRDS BELONG IN MY FUCKING MEALS DAMN IT'.",
		"NanoTransen CEO Johnson Lovelocker is in hot water for an alleged sex scandal with a confused syndicate woman that took the motto 'Fuck NT' too seriously.",
		"NanoTransen CEO Johnson Lovelocker issued a press release stating, 'Anybody who's fucking impersonating me is going to get fucking bluespaced unto a spike.'. We do not condone Lovelocker's use of foul language in the newsroom.",
		"NanoTransen CEO Johnson Lovelocker and Discount Dan's CEO Discount Dan have been photographed buying a new friend necklace. The Syndicate issued a statement that 'That's totally gay.'",
		"Discount Dan has been photographed this evening hunting the endangered albino space panda. When questioned, he replyed that the endangered animal was 'Good eats'.",
		"NanoTransen's head programmer quit this evening when people did not respond well to his new features on NTOS. Said features included the ability to instantly transmit pictures of your butt to people by blinking.",
		"NanoTransen CEO Johnson Lovelocker was photographed this morning celebrating his birthday will well deserved hookers and blow.",
		"Discount Dan's stock has risen 20 points today after CEO Discount Dan promised to include a free toy in every 'Happy Dan' meal. In other news, we have over 300 confirmed reports of broken teeth and lead poisioning in children 6 and under.",
		...
		"NanoTransen's treasurer Shlomo Goldburginstein died today in a tragic cooking incident with NT Officer Gass Judenraigh."
		)
	var/list/currentevents3 = list("Border patrol around Space America has tightened today after a wave of Tajarins yiffed their way across. We have reports of over 2000 molested Space Americans. More to come at seven.",
		"Tajarins continue to protest in their 'Trillion Fur March' today. We have reports that the Space American army is giving a KOS order on all non-humans in the area.",
		...
		"Scientists working at the Large Hadron Collider have discovered nothing today. A skeptical scientist was quoted as saying, 'It could be nothing, but it's probably just something again.'",
		"Johnny Hips has released a new album today, 'Tibia Blues'. The songs include classics such as 'I aint got monney for milk.', 'Skeleton Rock', and a new song named, 'Bone Marrow'.",
		"Doctors have discovered that clowns indeed do have a funny bone.",
		"Renown mime scientist Free Shrugs has discovered a new element today. He has named it '  ', he also says that it has the proporties of '   '.",
		"Archeologists have discovered gods final message to his creation today. The message reads, 'bawk'.",
		"Scientists have peired into the realm of the dead today. They say it was a horrible place full of unrobust faggots.",
		...
		"Supermatter researchers today have reported that the substance is highly volitile and could possibly rip apart the universe in large quantities. Discount Dan has been reported as ordering over 1000 pounds of supermatter shards.",
	...
	var/list/history = list("Adolf Hitler's cyborg body was layed to rest after the ending of WW4.",
		...
		"The first great zombie apocolypse began on Venus.",
		...
		"NanoTransen's new 'Space Station 13' project was announced.",
		...
		"The first transgender man in space was thrown out an airlock, along with his fursuit.",
