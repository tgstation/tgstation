...
/obj/item/device/pda
	...
	var/list/currentevents2 = list("CEO Discount Dan has been sued. Again.",
		...
		"NanoTrasen CEO Johnson Lovelocker has been photographed kicking a Tajarin to death. This shameful publicity stunt is part of the new 'NT Hates Catbeasts, do you?' campaign.",
