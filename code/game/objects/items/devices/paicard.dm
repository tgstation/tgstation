...
/obj/item/paicard/attack_self(mob/user)
	...
	if(pai)
		...
		dat += {"Installed Personality: [pai.name]<br>
			Prime directive: <br>[pai.laws.zeroth]<br>"}
		...
		if(pai.radio)
			...
			dat += {"<b>Radio Uplink</b><br>
				Transmit: <A href='byond://?src=[REF(src)];wires=[WIRE_TX]'>[(pai.radio.wires.is_cut(WIRE_TX)) ? "Disabled" : "Enabled"]</A><br>
				Receive: <A href='byond://?src=[REF(src)];wires=[WIRE_RX]'>[(pai.radio.wires.is_cut(WIRE_RX)) ? "Disabled" : "Enabled"]</A><br>"}
