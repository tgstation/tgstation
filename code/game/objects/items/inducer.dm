...
/obj/item/inducer/syndicate
	...
	desc = "A tool for inductively charging internal power cells. This one has a suspicious colour scheme, and seems to be rigged to inducer at a much faster rate."
	powertransfer = 2000
