...
/obj/item/melee/powerfist/attack(mob/living/target, mob/living/user)
    ...
    if(!gasused)
        ...
        playsound(loc, 'sound/weapons/punch1.ogg', 50, DEFAULT_SOUND_VARY)
    ...
    if(gasused.total_moles() < gasperfist * fisto_setting)
        ...
        playsound(loc, 'sound/weapons/punch4.ogg', 50, DEFAULT_SOUND_VARY)
    ...
    playsound(loc, 'sound/weapons/resonator_blast.ogg', 50, DEFAULT_SOUND_VARY)
    playsound(loc, 'sound/weapons/genhit2.ogg', 50, DEFAULT_SOUND_VARY)
