...
/obj/item/melee/powerfist/attack(mob/living/target, mob/living/user)
	...
	if(!gas_used)
		...
		playsound(loc, 'sound/items/weapons/punch1.ogg').vary(TRUE).play()
	...
	if(!molar_cmp_equals(gas_used.total_moles(), gas_per_fist * fist_pressure_setting))
		...
		playsound(loc, 'sound/items/weapons/punch4.ogg').vary(TRUE).play()
	...
	playsound(src, 'sound/items/weapons/resonator_blast.ogg').vary(TRUE).play()
	playsound(src, 'sound/items/weapons/genhit2.ogg').vary(TRUE).play()
