...
/obj/item/food/salad/validsalad
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/protein = 5, /datum/reagent/consumable/syndie_syrup = 8, /datum/reagent/consumable/nutriment/vitamin = 6)
