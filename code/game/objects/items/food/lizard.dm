...
/obj/item/food/kebab/picoss_skewers
	name = "picoss skewers"
	desc = "A popular Tiziran streetfood consisting of chunks of vinegar-marinated meat on a skewer with onion and chillis."
	...
	tastes = list("meat" = 1, "acid" = 1, "onion" = 1, "heat" = 1)
	foodtypes = MEAT | VEGETABLES
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/food/spaghetti/nizaya
	...
	microwaved_type = /obj/item/food/spaghetti/boilednizaya
...
/obj/item/food/rootdough
	...
	microwaved_type = /obj/item/food/rootbread
...
/obj/item/food/flatrootdough
	...
	microwaved_type = /obj/item/food/root_flatbread
...
/obj/item/food/pizza/rustic_flatbread
	...
	slice_type = /obj/item/food/pizzaslice/rustic_flatbread
	foodtypes = VEGETABLES | NUTS
