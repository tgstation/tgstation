...
/obj/item/food/peanutbutterjellysandwich
	name = "peanut butter and jelly sandwich"
	desc = "A classic PB&J sandwich, just like your mom used to make."
	icon = 'icons/obj/food/burgerbread.dmi'
	icon_state = "peanutbutterjellysandwich"
...
/obj/item/food/peanutbutterbananasandwich
	...
	icon = 'icons/obj/food/burgerbread.dmi'
	icon_state = "peanutbutterbananasandwich"
