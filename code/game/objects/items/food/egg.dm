...
/obj/item/food/egg/interact_with_atom_secondary(atom/interacting_with, mob/living/user, list/modifiers)
	...
	if(LAZYACCESS(modifiers, ICON_X))
		broken_egg.pixel_x = clamp(text2num(LAZYACCESS(modifiers, ICON_X)) - 16, -(ICONSIZE_X/2), ICONSIZE_X/2)
	if(LAZYACCESS(modifiers, ICON_Y))
		broken_egg.pixel_y = clamp(text2num(LAZYACCESS(modifiers, ICON_Y)) - 16, -(ICONSIZE_Y/2), ICONSIZE_Y/2)
