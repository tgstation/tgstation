...
/obj/item/device/malf_upgrade/afterattack(mob/living/silicon/ai/AI, mob/user)
	...
	if(AI.malf_picker)
		...
		to_chat(AI, "<span class='userdanger'>[IDENTITY_SUBJECT(1)] has attempted to upgrade you with combat software that you already possess. You gain 50 points to spend on Malfunction Modules instead.</span>", list(user))
	else
		to_chat(AI, "<span class='userdanger'>[IDENTITY_SUBJECT(1)] has upgraded you with combat software!</span>", list(user))
		AI.add_malf_picker()
...
/obj/item/device/surveillance_upgrade/afterattack(mob/living/silicon/ai/AI, mob/user)
	...
	if(AI.eyeobj)
		...
		to_chat(AI, "<span class='userdanger'>[IDENTITY_SUBJECT(1)] has upgraded you with surveillance software!</span>", list(user))
