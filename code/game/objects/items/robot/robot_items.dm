...
/obj/item/borg/lollipop/proc/dispense(atom/A, mob/user)
	...
	if(into_hands)
		user.visible_message("[user] dispenses a treat into the hands of [A].", "<span class='notice'>You dispense a treat into the hands of [A].</span>", "<span class='italics'>You hear a click.</span>")
	else
		user.visible_message("[user] dispenses a treat.", "<span class='notice'>You dispense a treat.</span>", "<span class='italics'>You hear a click.</span>")
