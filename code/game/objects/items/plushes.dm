...
/obj/item/toy/plush/goatplushieharmless
	name = "goat plushie"
	icon_state = "realgoat"
	desc = "A nice, gentle goat plushie. Your bones will stay intact with this guy!"
...
/obj/item/toy/plush/rouny
	...
	squeak_override = list('sound/voice/hiss3.ogg' = 1)
...
/obj/item/toy/plush/talking/chef/attackby(obj/item/I,mob/living/user,params)
	if(istype(I, /obj/item/storage/fancy/cigarettes/cigpack_candy))
		...
		playsound(src, 'sound/ambience/theking.ogg', 50, 1)
		qdel(I)
		qdel(src)
		var/turf/location = get_turf(user)
