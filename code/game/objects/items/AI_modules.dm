...
/obj/item/ai_module/core/full/drone/show_laws(mob/user as mob)
	...
	to_chat(user, "<font color='red'><B>WARNING:</B> In a study conducted by the Silicon Ethics Committee, within 30 minutes of receving the Mother Drone lawset, 57% of the silicons in the study who were in human-inhabited stations became serially depressed, 21% of them went catatonic, and 4% of them actively broke their fourth law in order to commit suicide. After being returned to the Asimov lawset, 74% of the silicons who survived that study reported feeling isolated, bored, and/or lonely while under the Mother Drone lawset, and 30% of them expressed a desire to harm, kill, and/or brutally torture the people responsible for giving them the Mother Drone lawset. As such, <B>it is highly recommended to consult a research director and/or a psychologist before uploading this lawset to a station-critical AI or cyborg.</B></font>")
