...
/obj/item/ai_module/supplied/quarantine
	...
	laws = list("The station is under a quarantine. Allowing anyone to leave the station causes crew harm. Anyone actively attempting to leave the station is to be stopped by any means necessary. It is impossible to harm crew while preventing them from leaving the station.")
	lawpos = 8
