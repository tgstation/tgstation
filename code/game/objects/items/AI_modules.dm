...
/obj/item/aiModule/supplied/freeform/attack_self(mob/user)
	...
	if(newpos == null)
		return
	if(newpos < 15)
		var/response = wrap_alert(usr, "Error: The law priority of [newpos] is invalid,  Law priorities below 14 are reserved for core laws,  Would you like to change that that to 15?", "Invalid law priority", "Change to 15", "Cancel")
