...
/obj/item/spear/grey_tide
	...
	desc = "Recovered from the aftermath of a revolt aboard Defense Outpost Theta Aegis, in which a seemingly endless tide of Assistants caused heavy casualities alongside Nanotrasen military forces."
