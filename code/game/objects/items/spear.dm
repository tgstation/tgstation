...
/obj/item/spear
	...
	custom_materials = list(/datum/material/iron = ROD_MATERIAL_AMOUNT, /datum/material/glass= ROD_MATERIAL_AMOUNT * 2)
...
/obj/item/spear/CheckParts(list/parts_list)
	...
	switch(tip.type)
		if(/obj/item/shard/plasma)
			force = 11
			throwforce = 21
			custom_materials = list(/datum/material/iron= ROD_MATERIAL_AMOUNT, /datum/material/alloy/plasmaglass= ROD_MATERIAL_AMOUNT * 2)
		...
		if(/obj/item/shard/titanium)
			...
			throw_range = 8
			throw_speed = 5
			custom_materials = list(/datum/material/iron= ROD_MATERIAL_AMOUNT, /datum/material/alloy/titaniumglass= ROD_MATERIAL_AMOUNT * 2)
			wound_bonus = -10
			force_unwielded = 13
			force_wielded = 18
		...
		if(/obj/item/shard/plastitanium)
			...
			throw_range = 9
			throw_speed = 5
			custom_materials = list(/datum/material/iron= ROD_MATERIAL_AMOUNT, /datum/material/alloy/plastitaniumglass= ROD_MATERIAL_AMOUNT * 2)
			wound_bonus = -10
			bare_wound_bonus = 20
			force_unwielded = 13
			force_wielded = 20
...
/obj/item/spear/bonespear //Blatant imitation of spear, but made out of bone. Not valid for explosive modification.
	...
	custom_materials = list(/datum/material/bone = ROD_MATERIAL_AMOUNT * 7)
	force_unwielded = 12
	force_wielded = 20
