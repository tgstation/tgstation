...
/obj/item/cardboard_cutout/proc/change_appearance(obj/item/toy/crayon/crayon, mob/living/user)
	...
	switch(new_appearance)
		if("Assistant")
			name = "[pick(SLOTH.first_names_male)] [pick(SLOTH.last_names)]"
		...
		if("Wizard")
			name = "[pick(SLOTH.wizard_first)], [pick(SLOTH.wizard_second)]"
		...
		if("Deathsquad Officer")
			name = pick(SLOTH.commando_names)
