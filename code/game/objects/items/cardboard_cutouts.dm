// Cardboard cutouts!. They're man-shaped. Can be colored with a crayon to look like a human in a certain outfit, although it's limited, discolored. Obvious to more than a cursory glance.
