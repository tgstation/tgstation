...
/obj/item/grenade/gluon
	desc = "An advanced grenade that releases a harmful stream of gluons that makes victims feel exhausted, and induce shivering. This extreme coldness will also likely wet any nearby floors."
