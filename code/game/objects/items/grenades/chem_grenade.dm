...
/obj/item/grenade/chem_grenade/stockmarketbomb
	name = "materials crate grenade"
	desc = "...How did this get here?"
	stage = GRENADE_READY

/obj/item/grenade/chem_grenade/stockmarketbomb/Initialize(mapload)
	. = ..()
	var/obj/item/reagent_containers/cup/beaker/beaker_one = new(src)
	var/obj/item/reagent_containers/cup/beaker/beaker_two = new(src)

	beaker_one.reagents.add_reagent(/datum/reagent/water, 30)
	beaker_two.reagents.add_reagent(/datum/reagent/potassium, 30)
