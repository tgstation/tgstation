...
/obj/item/nuke_core_container/proc/seal()
	if(istype(core))
		...
		playsound(src, 'sound/items/deconstruct.ogg', 60, DEFAULT_SOUND_VARY)
		if(ismob(loc))
...
/obj/item/nuke_core/supermatter_sliver/attackby(obj/item/W, mob/living/user, params)
	if(istype(W, /obj/item/hemostat/supermatter))
		...
		playsound(src, 'sound/effects/supermatter.ogg', 50, DEFAULT_SOUND_VARY)
		qdel(W)
		qdel(src)
...
/obj/item/nuke_core/supermatter_sliver/pickup(mob/living/user)
	...
	playsound(get_turf(user), 'sound/effects/supermatter.ogg', 50, DEFAULT_SOUND_VARY)
	ded.dust()
