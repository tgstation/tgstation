...
/obj/item/circuitboard/computer/atmos_control/wordimadeupium_tank
	name = "Wordimadeupium Supply Control (Computer Board)"
	build_path = /obj/machinery/computer/atmos_control/wordimadeupium_tank
