...
//MALLETS BELOW//
	...
	else if(istype(I, /obj/item/storage/toolbox) && !(I.flags_1 & NODROP_1) && !istype(/obj/item/storage/toolbox/brass))//safety net to catch all other types of toolboxes since red is the most common, but we don't want any brass shit
