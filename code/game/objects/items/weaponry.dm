...
/obj/item/banhammer/attack(mob/M, mob/living/user)
	...
	create_sound(loc, 'sound/effects/adminhelp.ogg').volume(15).play() //keep it at 15% volume so people don't jump out of their skin too much
	if(user.combat_mode)
		return ..(M, user)
...
/obj/item/balloon_mallet/attack(mob/living/target, mob/living/user)
	create_sound(loc, 'sound/mobs/non-humanoids/clown/hehe.ogg').volume(20).play()
	if (!isliving(target))
		return
...
/obj/item/claymore/highlander/proc/add_notch(mob/living/user) //DYNAMIC CLAYMORE PROGRESSION SYSTEM - THIS IS THE FUTURE
	...
	name = new_name
	create_sound(user, 'sound/items/tools/screwdriver2.ogg').vary(TRUE).play()
...
/obj/item/melee/baseball_bat/attack_self(mob/user)
	...
	create_sound(get_turf(src), 'sound/effects/magic/lightning_chargeup.ogg').volume(65).vary(TRUE).play()
...
/obj/item/melee/baseball_bat/attack(mob/living/target, mob/living/user)
	...
	if(homerun_ready)
		...
		create_sound(get_turf(src), 'sound/items/weapons/homerun.ogg').volume(100).vary(TRUE).play()
		homerun_ready = FALSE
		return
...
/obj/item/melee/baseball_bat/proc/try_launch(atom/movable/target, mob/living/user)
	...
	create_sound(src, 'sound/items/baseballhit.ogg').volume(100).vary(TRUE).play()
...
/obj/item/melee/baseball_bat/proc/launch_back(atom/movable/target, mob/living/user, turf/target_turf, datum_throw_speed)
	create_sound(target, 'sound/effects/magic/tail_swing.ogg').vary(TRUE).play()
...
/obj/item/highfrequencyblade/proc/slash(atom/target, mob/living/user, params)
	...
	create_sound(src, 'sound/items/weapons/bladeslice.ogg').volume(100).vary(TRUE).play()
	create_sound(src, 'sound/items/weapons/zapbang.ogg').vary(TRUE).play()
	if(isliving(target))
		var/mob/living/living_target = target
