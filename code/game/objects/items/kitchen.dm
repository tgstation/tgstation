...
/obj/item/kitchen/fork/attack(mob/living/carbon/M, mob/living/carbon/user)
	...
	if(forkload)
		if(M == user)
			M.visible_message("<span class='none'>[user] eats a delicious forkful of omelette!</span>")
			M.reagents.add_reagent(forkload.type, 1)
		else
			M.visible_message("<span class='none'>[user] feeds [M] a delicious forkful of omelette!</span>")
			M.reagents.add_reagent(forkload.type, 1)
		icon_state = "fork"
		forkload = null
