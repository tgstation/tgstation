...
/obj/item/book/granter/proc/turn_page(mob/user)
	playsound(user, pick('sound/effects/pageturn1.ogg','sound/effects/pageturn2.ogg','sound/effects/pageturn3.ogg'), 30, DEFAULT_SOUND_VARY)
...
/obj/item/book/granter/martial/cqc/recoil(mob/living/carbon/user)
	...
	playsound(src,'sound/effects/explosion1.ogg',40,DEFAULT_SOUND_VARY)
	user.flash_act(1, 1)
