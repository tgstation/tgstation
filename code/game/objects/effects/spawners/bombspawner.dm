...
/obj/effect/spawner/newbomb/plasma/Initialize(mapload)
	...
	first_gasmix.adjust_gas(/datum/gas/plasma, calculate_pressure(first_gasmix, TANK_LEAK_PRESSURE - 1))
	second_gasmix.adjust_gas(/datum/gas/oxygen, calculate_pressure(second_gasmix, TANK_LEAK_PRESSURE - 1))
...
/obj/effect/spawner/newbomb/tritium/Initialize(mapload, obj/item/assembly)
	...
	var/list/new_gases = list(/datum/gas/oxygen = 0.67 * calculate_pressure(second_gasmix, TANK_LEAK_PRESSURE - 1), /datum/gas/tritium = 0.33 * calculate_pressure(second_gasmix, TANK_LEAK_PRESSURE - 1))
	first_gasmix.adjust_gas(/datum/gas/plasma, calculate_pressure(first_gasmix, TANK_LEAK_PRESSURE - 1))
	second_gasmix.adjust_multiple_gases(new_gases)
...
/obj/effect/spawner/newbomb/isolated_tritium/Initialize(mapload)
	...
	var/list/new_gases = list(/datum/gas/hypernoblium = REACTION_OPPRESSION_THRESHOLD - 0.01, /datum/gas/tritium = 0.5 * calculate_pressure(first_gasmix, TANK_LEAK_PRESSURE - 1))
	first_gasmix.adjust_multiple_gases(new_gases)
	second_gasmix.adjust_gas(/datum/gas/oxygen, calculate_pressure(second_gasmix, TANK_LEAK_PRESSURE-1))
...
/obj/effect/spawner/newbomb/noblium/Initialize(mapload)
	...
	first_gasmix.adjust_gas(/datum/gas/nitrogen, calculate_pressure(first_gasmix, TANK_LEAK_PRESSURE - 1))
	second_gasmix.adjust_gas(/datum/gas/tritium, calculate_pressure(second_gasmix, TANK_LEAK_PRESSURE - 1))
...
/obj/effect/spawner/newbomb/pressure/Initialize(mapload)
	...
	first_gasmix.adjust_gas(/datum/gas/hypernoblium, calculate_pressure(first_gasmix, TANK_LEAK_PRESSURE - 1))
	second_gasmix.adjust_gas(/datum/gas/tritium, calculate_pressure(second_gasmix, TANK_LEAK_PRESSURE - 1))
