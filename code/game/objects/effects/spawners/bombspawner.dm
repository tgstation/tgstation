...
/obj/effect/spawner/bomb/New()
	...
	switch (src.btype)
		...
		if (0)
			...
			var/obj/item/weapon/tank/large/plasma/p3 = new /obj/item/weapon/tank/large/plasma(R)
		...
		if(3)
			...
			var/obj/item/weapon/tank/large/plasma/p4 = new /obj/item/weapon/tank/large/plasma(R)
...
/obj/effect/spawner/newbomb/New()
	...
	switch (src.btype)
		...
		if (0)
			...
			var/obj/item/weapon/tank/large/plasma/PT = new(V)
			var/obj/item/weapon/tank/large/oxygen/OT = new(V)
