...
/obj/effect/particle_effect/fluid/foam/Initialize(mapload)
	...
	PLAYSOUND(src, 'sound/effects/bubbles/bubbles2.ogg').volume(80).vary(TRUE).range(-3 + SOUND_RANGE).play()
...
/obj/structure/foamedmetal/play_attack_sound(damage_amount, damage_type = BRUTE, damage_flag = 0)
	PLAYSOUND(src.loc, 'sound/items/weapons/tap.ogg').volume(100).vary(TRUE).play()
