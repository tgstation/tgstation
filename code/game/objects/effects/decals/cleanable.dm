/obj/effect/decal/cleanable
	...
	var/beauty = 0
	var/clean_type = CLEAN_TYPE_LIGHT_DECAL //the type of cleaning required to clean the decal, CLEAN_TYPE_LIGHT_DECAL can be cleaned with mops and soap, CLEAN_TYPE_HARD_DECAL can be cleaned by soap, see __DEFINES/cleaning.dm for the others
