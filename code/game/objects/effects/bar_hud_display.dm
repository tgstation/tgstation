///A display panel that renders a set of icons
///Has to be manually manipulated, but uses update_overlays to show it.
/obj/effect/bar_hud_display
	...
	///How much "active" dots will appear
	var/active_dots = 1
	///How many "inactive" dots will appear
	var/dot_slots = 1
	///Where the dot bar is placed in relation to the centre of the panel on the Y axis.
	var/bar_offset_z = -11
	///Where the dot bar is placed in relation to the centre of the panel on the X axis, useful for multi-column displays.
	var/bar_offset_w = 0
	///The gap between each dot on the Y axis
	var/individual_dot_offset_y = 5
	///The gap between each dot on the X axis
	...
	///File that both icon states for dots are pulled from
	var/dot_icon = 'icons/obj/toys/tcgmisc.dmi'
	///The icon of an "active" dots.
	var/dot_icon_state
	///The icon of an "inactive" dots.
