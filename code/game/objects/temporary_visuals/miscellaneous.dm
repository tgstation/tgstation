...
/obj/effect/temp_visual/love_heart/invisible/Initialize(mapload, var/mob/seer)
	. = ..()
	...
	add_alt_appearance(/datum/atom_hud/alternate_appearance/basic/onePerson, "heart", I, FALSE, seer)
	pixel_x = rand(-4,4)
	pixel_y = rand(-4,4)
	animate(src, pixel_y = pixel_y + 32, alpha = 0, time = 25)
