...
/atom/movable/item_interaction(mob/living/user, obj/item/tool, tool_type, is_right_clicking)
	...
	return mouse_buckle_handling(carried_mob, user) ? TOOL_ACT_TOOLTYPE_SUCCESS: TOOL_ACT_SIGNAL_BLOCKING
