...
/datum/quirk/item_quirk/junkie/smoker/post_add()
	...
	quirk_holder.mind.add_memory(MEMORY_QUIRK_DRUG, list(DETAIL_FAV_BRAND = brand), memory_flags = MEMORY_FLAG_NOLOCATION, story_value = STORY_VALUE_MEH)
...
/datum/quirk/item_quirk/allergic/post_add()
	quirk_holder.mind.add_memory(MEMORY_ALLERGY, list(DETAIL_ALLERGY_TYPE = allergy_string), memory_flags = MEMORY_FLAG_NOLOCATION, story_value = STORY_VALUE_MEH)
