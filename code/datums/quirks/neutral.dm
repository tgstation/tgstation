...
/datum/quirk/item_quirk/tongue_tied/add_unique()
	...
	if(isplasmaman(human_holder))
		give_item_to_holder(/obj/item/clothing/gloves/color/plasmaman/radio, list(LOCATION_GLOVES = ITEM_SLOT_GLOVES, LOCATION_BACKPACK = ITEM_SLOT_BACKPACK, LOCATION_HANDS = ITEM_SLOT_HANDS))
	else
