...
/datum/material/meat/proc/make_edible(atom/source, amount, material_flags)
	...
	source.add_component(/datum/component/edible, list(/datum/reagent/consumable/nutriment = nutriment_count, /datum/reagent/consumable/cooking_oil = oil_count), null, RAW | MEAT | GROSS, null, 30, list("Fleshy"))
