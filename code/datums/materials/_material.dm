...
/datum/material
	...
	var/desc = "its..stuff."
	/// What the material is indexed by in the GLOB.materials.materials list. Defaults to the type of the material.
	var/id
	...
	var/starlight_color
	///Bitflags that influence how GLOB.materials handles this material.
