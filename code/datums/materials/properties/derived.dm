...
/datum/material_property/derived/integrity/get_value(datum/material/material)
	...
	// But unless it has enough bend to it, it'll also fracture - which is why flexibility needs to be in a sweetspot, good on density
...
/datum/material_property/derived/beauty/get_value(datum/material/material)
	// Needs the material to be especially shiny or dull
...
/datum/material_property/derived/insulation/get_value(datum/material/material)
	...
	// 1.18. 0.15 here are to allow 6 to map to 1. 10 to map to 2. Are pulled out of my ass (system in the desmos below)
