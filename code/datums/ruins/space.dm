...
/datum/map_template/ruin/space/derelict1
	...
	name = "Derelict 1"
	description = "Nothing to see here citizen, move along, certainly no beno outbreaks on this piece of station debris. That purple stuff? It's uh... station nectar. \
