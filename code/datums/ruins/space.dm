...
/datum/map_template/ruin/space/djstation
	...
	description = "Until very recently this pirate radio station was used \
		to harangue local space stations over a variety of perceived \"ethics violations\". \
...
/datum/map_template/ruin/space/thederelict
	...
	description = "The true fate of Kosmicheskaya Stantsiya 13 is an open question to this day. \
		Most corporations deny its existence, for fear of questioning on what became of its crew."
...
/datum/map_template/ruin/space/abandonedteleporter
	...
	description = "In space construction the teleporter is often the first system brought online. \
		This lonely half built teleporter is a sign of a proposed structure that for one reason or another \
...
/datum/map_template/ruin/space/crashedclownship
	...
	description = "For centuries the promise of a new clown homeworld has been the siren call for countless \
		clown vessels. Alas the clown's lust for shinanagans means that successful voyages are almost unheard of, \
		with most vessels falling to hilarious consequences almost immediately."

/datum/map_template/ruin/space/crashedship
	id = "crashedship"
	suffix = "crashedship.dmm"
	name = "Crashed Ship"
	description = "Among civilian vessels the most common cause of tragedy is lack of food. This ship \
	was outfited with a multitude of food generating features, then summarily ran into an asteroid shortly \
		after takeoff."
...
/datum/map_template/ruin/space/listeningstation
	...
	description = "Listening stations form the backbone of the syndicate's information gathering operations. \
		Assignment to these stations is dreaded by most agents, as it entails long and lonely shifts \
		listening to nearby stations chatter incessently about the most meaningless things."

/datum/map_template/ruin/space/oldAIsat
	id = "oldAIsat"
	suffix = "oldAIsat.dmm"
	name = "Abandoned AI Satellite"
	description = "Early experiments in AI housing focused on large remote structures that could not be easily penitrated. \
		Over time the benifits of having immediate physicall access to the AI have been proven in the blood of dozens of \
		\"liberated\" stations."
...
/datum/map_template/ruin/space/oldteleporter
	...
	description = "The structure of this surprisingly intact teleporter suggests that it was once part of a larger structure, \
		but what remains of said structure, if anything, can only be guessed at."
