...
/datum/datacore/proc/manifest_inject(mob/living/carbon/human/H, datum/client_base/C)
...
/datum/datacore/proc/get_id_photo(mob/living/carbon/human/H, datum/client_base/C)
