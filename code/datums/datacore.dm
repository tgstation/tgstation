...
/datum/datacore/proc/get_id_photo(mob/living/carbon/human/H)
	...
	switch(H.mind.assigned_role)
		...
		if("Scientist")
			clothes_s = icon('icons/mob/uniform.dmi', "toxins_s")
		...
		if("Cargo Technician")
			clothes_s = icon('icons/mob/uniform.dmi', "cargotech_s")
			clothes_s.Blend(icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Shaft Miner")
		...
		if("Chemist")
			clothes_s = icon('icons/mob/uniform.dmi', "chemistry_s")
			clothes_s.Blend(icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
		...
		if("Janitor")
			...
			clothes_s.Blend(icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Geneticist")
			clothes_s = icon('icons/mob/uniform.dmi', "genetics_s")
			clothes_s.Blend(icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(icon('icons/mob/suit.dmi', "labcoat_gen"), ICON_OVERLAY)
		if("Virologist")
			clothes_s = icon('icons/mob/uniform.dmi', "virology_s")
			clothes_s.Blend(icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
		...
		if("Chaplain")
			clothes_s = icon('icons/mob/uniform.dmi', "chaplain_s")
			clothes_s.Blend(icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		...
		if("Chief Engineer")
			clothes_s = icon('icons/mob/uniform.dmi', "chiefengineer_s")
			clothes_s.Blend(icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
			clothes_s.Blend(icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
			clothes_s.Blend(icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
