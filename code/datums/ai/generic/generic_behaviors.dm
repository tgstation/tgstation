 ...
 * Pass finish_on_arrival = TRUE to succeed when within required_dist — use in BT_SEQUENCE nodes.
 * Leave FALSE (default) to run indefinitely — use as the movement leg of a BT_PARALLEL.
 */
