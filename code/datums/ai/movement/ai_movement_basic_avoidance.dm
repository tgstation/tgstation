...
/datum/ai_movement/basic_avoidance
	...
	/// Additional flags to provide to movement loop
	var/movement_flags = NONE
...
/datum/ai_movement/basic_avoidance/start_moving_towards(datum/ai_controller/controller, atom/current_movement_target, min_distance)
	...
	var/datum/move_loop/loop = SSmove_manager.move_to(moving, current_movement_target, min_dist, delay, flags = movement_flags, subsystem = SSai_movement, extra_info = controller)
...
/datum/ai_movement/basic_avoidance/no_glide
	movement_flags = MOVEMENT_LOOP_IGNORE_GLIDE
