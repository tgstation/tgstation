...
/datum/ai_planning_subtree/random_speech/insect
	speech_chance = 5
	sound = list('sound/mobs/creatures/chitter.ogg')
...
/datum/ai_planning_subtree/random_speech/mouse
	...
	sound = list('sound/mobs/creatures/mousesqueek.ogg')
...
/datum/ai_planning_subtree/random_speech/sheep
	...
	sound = list('sound/mobs/creatures/sheep1.ogg', 'sound/mobs/creatures/sheep2.ogg', 'sound/mobs/creatures/sheep3.ogg')
...
/datum/ai_planning_subtree/random_speech/chicken
	...
	sound = list('sound/mobs/creatures/clucks.ogg', 'sound/mobs/creatures/bagawk.ogg')
...
/datum/ai_planning_subtree/random_speech/chick
	...
	sound = list('sound/mobs/creatures/chick_peep.ogg')
...
/datum/ai_planning_subtree/random_speech/cow
	...
	sound = list('sound/mobs/creatures/cow.ogg')
...
/datum/ai_planning_subtree/random_speech/pig
	...
	sound = list('sound/mobs/creatures/pig1.ogg', 'sound/mobs/creatures/pig2.ogg')
	emote_hear = list("snorts.")
	emote_see = list("sniffs around.")

/datum/ai_planning_subtree/random_speech/pony
	speech_chance = 3
	sound = list('sound/mobs/creatures/pony/whinny01.ogg', 'sound/mobs/creatures/pony/whinny02.ogg', 'sound/mobs/creatures/pony/whinny03.ogg')
	emote_hear = list("whinnies!")
	emote_see = list("horses around.")

/datum/ai_planning_subtree/random_speech/pony/tamed
	speech_chance = 3
	sound = list('sound/mobs/creatures/pony/snort.ogg')
	emote_hear = list("snorts.")
...
/datum/ai_planning_subtree/random_speech/crab
	speech_chance = 1
	sound = list('sound/mobs/creatures/claw_click.ogg')
