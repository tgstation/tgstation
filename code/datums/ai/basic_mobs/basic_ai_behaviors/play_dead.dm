...
/datum/bt_node/ai_behavior/play_dead/setup(datum/ai_controller/controller, probability = 10)
...
/datum/bt_node/ai_behavior/play_dead/perform(seconds_per_tick, datum/ai_controller/controller, probability = 10)
	if(SPT_PROB(probability, seconds_per_tick))
		return AI_BEHAVIOR_DELAY | AI_BEHAVIOR_SUCCEEDED
	return AI_BEHAVIOR_DELAY

/datum/bt_node/ai_behavior/play_dead/finish_action(datum/ai_controller/controller, succeeded, probability = 10)
	. = ..()
	var/mob/living/basic/pawn = controller.pawn
