...
/datum/uplink_item/stealthy_tools/agent_card
	...
	desc = "Agent cards prevent artificial intelligences from tracking the wearer and can copy access from other identification cards in addition to stealing all credits on the ID. The access is cumulative, so scanning one card does not erase the access gained from another."
