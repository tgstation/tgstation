...
/datum/uplink_item/dangerous/mustard_gas
	name = "Mustard Gas Grenade"
	desc = "A Smoke grenade containing Mustard Gas, an incredibly dangerous neurotoxin often used by bioterrorists. \
	Use with extreme caution, to prevent exposure to yourself and your fellow operatives."
	item = /obj/item/weapon/grenade/chem_grenade/large/mustard_gas
	cost = 5
	gamemodes = list(/datum/game_mode/nuclear)
	surplus = 0
