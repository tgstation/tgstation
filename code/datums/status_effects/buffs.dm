...
/datum/status_effect/shadow_mend/on_apply()
	...
	playsound(owner, 'sound/magic/teleport_app.ogg', 50, DEFAULT_SOUND_VARY)
	return ..()
...
/datum/status_effect/shadow_mend/on_remove()
	...
	playsound(owner, 'sound/magic/teleport_diss.ogg', 50, DEFAULT_SOUND_VARY)
...
/datum/status_effect/inathneqs_endowment/on_apply()
	...
	playsound(owner, 'sound/magic/ethereal_enter.ogg', 50, DEFAULT_SOUND_VARY)
	return ..()
...
/datum/status_effect/inathneqs_endowment/on_remove()
	...
	owner.status_flags &= ~GODMODE
	playsound(owner, 'sound/magic/ethereal_exit.ogg', 50, DEFAULT_SOUND_VARY)
...
/datum/status_effect/cyborg_power_regen/tick()
	...
	if(!istype(cyborg) || !cyborg.cell)
		qdel(src)
		return
	playsound(cyborg, 'sound/effects/light_flicker.ogg', 50, DEFAULT_SOUND_VARY)
...
/datum/status_effect/blooddrunk/on_apply()
	...
	if(.)
		...
		owner.playsound_local(get_turf(owner), 'sound/effects/singlebeat.ogg', 40, DEFAULT_SOUND_VARY)
