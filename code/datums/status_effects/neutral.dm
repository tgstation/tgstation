...
/datum/status_effect/high_fiving/proc/we_did_it(mob/living/carbon/successful_taker)
	...
	if(slappers_owner >= 2) // we only check this if it's already established the taker has 2+ hands free
		...
		owner.mind.add_memory(MEMORY_HIGH_FIVE, list(DETAIL_VICTIM = successful_taker, DETAIL_HIGHFIVE_TYPE = "high ten"))
		successful_taker.mind.add_memory(MEMORY_HIGH_FIVE, list(DETAIL_VICTIM = owner, DETAIL_HIGHFIVE_TYPE = "high ten"))
		...
		owner.mind.add_memory(MEMORY_HIGH_FIVE, list(DETAIL_VICTIM = successful_taker, DETAIL_HIGHFIVE_TYPE = "high five"))
		successful_taker.mind.add_memory(MEMORY_HIGH_FIVE, list(DETAIL_VICTIM = owner, DETAIL_HIGHFIVE_TYPE = "high five"))
