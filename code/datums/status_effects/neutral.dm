...
/datum/status_effect/bounty/on_apply()
	...
	PLAYSOUND(owner, 'sound/items/weapons/gun/shotgun/rack.ogg').volume(75).vary_frequency(FALSE).play()
	return ..()
...
/datum/status_effect/bounty/proc/rewards()
	if(rewarded && rewarded.mind && rewarded.stat != DEAD)
		...
		PLAYSOUND(owner, 'sound/items/weapons/gun/shotgun/shot.ogg').volume(75).vary_frequency(FALSE).play()
