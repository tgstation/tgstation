...
/datum/status_effect/bounty/on_apply()
	...
	playsound(owner, 'sound/items/weapons/gun/shotgun/rack.ogg').volume(75).vary(FALSE).play()
	return ..()
...
/datum/status_effect/bounty/proc/rewards()
	if(rewarded && rewarded.mind && rewarded.stat != DEAD)
		...
		playsound(owner, 'sound/items/weapons/gun/shotgun/shot.ogg').volume(75).vary(FALSE).play()
