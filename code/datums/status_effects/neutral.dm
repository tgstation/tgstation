...
/datum/status_effect/high_fiving/proc/we_did_it(mob/living/carbon/successful_taker)
	...
	if(slappers_owner >= 2) // we only check this if it's already established the taker has 2+ hands free
		...
		owner.mind.add_memory("high tenned [lowertext(successful_taker)]", MEMORY_HIGH_FIVE, successful_taker, list("high ten"))
		successful_taker.mind.add_memory("high tenned [lowertext(owner)]", MEMORY_HIGH_FIVE, owner, list("high ten"))
		...
		owner.mind.add_memory("high fived [lowertext(successful_taker)]", MEMORY_HIGH_FIVE, successful_taker, list("high five"))
		successful_taker.mind.add_memory("high fived [lowertext(owner)]", MEMORY_HIGH_FIVE, owner, list("high five"))
