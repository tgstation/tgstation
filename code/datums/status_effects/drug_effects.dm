/datum/status_effect/woozy
	...
	alert_type = /obj/screen/alert/status_effect/woozy


/datum/status_effect/woozy/nextmove_modifier()
	return 1.5

/obj/screen/alert/status_effect/woozy
	name = "Woozy"
...
/datum/status_effect/high_blood_pressure
	...
	tick_interval = -1
	status_type = STATUS_EFFECT_UNIQUE
	alert_type = /obj/screen/alert/status_effect/high_blood_pressure
...
/obj/screen/alert/status_effect/high_blood_pressure
...
/datum/status_effect/seizure
	...
	tick_interval = -1
	status_type = STATUS_EFFECT_UNIQUE
	alert_type = /obj/screen/alert/status_effect/seizure
...
/obj/screen/alert/status_effect/seizure
	name = "Seizure"
...
/datum/status_effect/stoned
	id = "stoned"
	duration = 10 SECONDS
	alert_type = /obj/screen/alert/status_effect/stoned
...
/obj/screen/alert/status_effect/stoned
	name = "Stoned"
