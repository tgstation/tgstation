...
/datum/status_effect/incapacitating/stun/on_apply()
	...
	if(!.)
		return
	owner.AddTraits(list(TRAIT_INCAPACITATED, TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), TRAIT_STATUS_EFFECT(id))

/datum/status_effect/incapacitating/stun/on_remove()
	owner.RemoveTraits(list(TRAIT_INCAPACITATED, TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), TRAIT_STATUS_EFFECT(id))
	return ..()
...
/datum/status_effect/incapacitating/paralyzed/on_apply()
	...
	if(!.)
		return
	owner.AddTraits(list(TRAIT_INCAPACITATED, TRAIT_IMMOBILIZED, TRAIT_FLOORED, TRAIT_HANDS_BLOCKED), TRAIT_STATUS_EFFECT(id))

/datum/status_effect/incapacitating/paralyzed/on_remove()
	owner.RemoveTraits(list(TRAIT_INCAPACITATED, TRAIT_IMMOBILIZED, TRAIT_FLOORED, TRAIT_HANDS_BLOCKED), TRAIT_STATUS_EFFECT(id))
	return ..()
...
/datum/status_effect/grouped/stasis/on_apply()
	...
	if(!.)
		return
	owner.AddTraits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), TRAIT_STATUS_EFFECT(id))
...
/datum/status_effect/grouped/stasis/on_remove()
	owner.RemoveTraits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), TRAIT_STATUS_EFFECT(id))
...
/datum/status_effect/gonbola_pacify/on_apply()
	. = ..()
	owner.AddTraits(list(TRAIT_PACIFISM, TRAIT_MUTE), CLOTHING_TRAIT)
...
/datum/status_effect/gonbola_pacify/on_remove()
	owner.RemoveTraits(list(TRAIT_PACIFISM, TRAIT_MUTE), CLOTHING_TRAIT)
