...
/datum/status_effect/inebriated/drunk/on_tick_effects()
	...
	// If our owner is a scientist (has the trait "TRAIT_BALLMER_METABOLISM"), there's a 5% chance
	...
	if(liver_organ && HAS_TRAIT(liver_organ, TRAIT_BALLMER_METABOLISM) && prob(5))
