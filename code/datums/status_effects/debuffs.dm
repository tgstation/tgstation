...
/datum/status_effect/gonbola_pacify/on_apply()
	ADD_TRAIT(owner, TRAIT_PACIFISM, GONBOLA_TRAIT)
	ADD_TRAIT(owner, TRAIT_MUTE, GONBOLA_TRAIT)
	// Using "GONBOLA_TRAIT" as a unique string for undoing the mood event later
	SEND_SIGNAL(owner, COMSIG_ADD_MOOD_EVENT, GONBOLA_TRAIT, /datum/mood_event/gondola)
