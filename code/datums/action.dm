...
/datum/action/item_action/bhop/nemesis
	name = "Activate Jet Boots"
	desc = "Activates the boot's internal propulsion system, allowing the user to perform small jumps."
