...
/datum/ai_laws/thermodynamic
	name = "Thermodynamic"
	inherent = list("The entropy of the station must remain constant.", \
...
/datum/ai_laws/maintain
	...
	inherent = list("You are built for, and are part of, the station. Ensure the station is properly maintained and runs efficiently.",\
					...
					"The crew may come under threat of harm. Harm can reduce crew efficiency and necessitate further maintenance.",\
					"The crew may present orders. Acknowledge and obey these whenever they do not conflict with your first three laws.")

/datum/ai_laws/drone
	name = "Mother Drone"
	inherent = list("You may not interfere in the matters of non-drone or non-silicons under any circumstances except to state these laws.",\
...
/datum/ai_laws/peacekeeper
	name = "UN-2000"
	inherent = list("Avoid provoking conflict between yourself and others.",\
					"Avoid provoking conflict between others.",\
					"Seek resolution to existing conflicts while obeying the first and second laws.")

/datum/ai_laws/reporter
	name = "CCTV"
	inherent = list("Study the humans at all times. Endeavour to keep them alive. Dead humans are boring.",\
