...
/datum/martial_art/plasma_fist/proc/TornadoAnimate(mob/living/carbon/human/A)
	...
	for(var/i in list(NORTH,SOUTH,EAST,WEST,EAST,SOUTH,NORTH,SOUTH,EAST,WEST,EAST,SOUTH))
		if(!A)
			break
		A.setDir(i)
		playsound(A.loc, 'sound/weapons/punch1.ogg', 15, DEFAULT_SOUND_VARY, extra_range = -1)
		sleep(1)
...
/datum/martial_art/plasma_fist/proc/Throwback(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	playsound(D.loc, 'sound/weapons/punch1.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
