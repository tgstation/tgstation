...
/datum/martial_art/the_sleeping_carp/proc/wristWrench(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsStun() && !D.IsParalyzed())
		...
		playsound(get_turf(A), 'sound/weapons/thudswoosh.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
		D.emote("scream")
...
/datum/martial_art/the_sleeping_carp/proc/backKick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsParalyzed())
		if(A.dir == D.dir)
			...
			D.Paralyze(80)
			playsound(get_turf(D), 'sound/weapons/punch1.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
			return 1
		else
...
/datum/martial_art/the_sleeping_carp/proc/elbowDrop(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!(D.mobility_flags & MOBILITY_STAND))
		...
		playsound(get_turf(D), 'sound/weapons/punch1.ogg', 75, DEFAULT_SOUND_VARY, extra_range = -1)
		return 1
	return basic_hit(A,D)
...
/datum/martial_art/the_sleeping_carp/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	playsound(get_turf(D), 'sound/weapons/punch1.ogg', 25, DEFAULT_SOUND_VARY, extra_range = -1)
...
/obj/item/twohanded/bostaff/attack(mob/target, mob/living/user)
	...
	if(user.a_intent == INTENT_DISARM)
		...
		playsound(get_turf(user), 'sound/effects/woodhit.ogg', 75, DEFAULT_SOUND_VARY, extra_range = -1)
