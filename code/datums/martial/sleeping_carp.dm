...
/datum/martial_art/the_sleeping_carp/teach(mob/living/target, make_temporary = FALSE)
	...
	RegisterSignal(target, COMSIG_ATOM_BULLET_ACT, PROC_REF(on_projectile_hit))
...
/datum/martial_art/the_sleeping_carp/proc/on_projectile_hit(mob/living/carp_user, obj/projectile/P, def_zone)
	SIGNAL_HANDLER
