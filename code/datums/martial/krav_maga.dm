...
/datum/martial_art/krav_maga/proc/quick_choke(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)//is actually lung punch
	...
	playsound(get_turf(A), 'sound/effects/hit_punch.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
	if(D.losebreath <= 10)
...
/datum/martial_art/krav_maga/harm_act(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	if(picked_hit_type == "kicks" || picked_hit_type == "stomps on")
		...
		playsound(get_turf(D), 'sound/effects/hit_kick.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
	else
		A.do_attack_animation(D, ATTACK_EFFECT_PUNCH)
		playsound(get_turf(D), 'sound/effects/hit_punch.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
...
/datum/martial_art/krav_maga/disarm_act(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	if(prob(60))
		...
		playsound(D, 'sound/weapons/thudswoosh.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
	else
