...
/datum/uplink_item/dangerous/rapid
	...
	desc = "These gloves teach the user a martial art that lets them punch people very fast. Does not improve weapon attack speed or the meaty fists of a hulk."
