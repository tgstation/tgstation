...
/datum/martial_art/cqc/proc/Slam(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(D.mobility_flags & MOBILITY_STAND)
		...
		playsound(get_turf(A), 'sound/weapons/slam.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
...
/datum/martial_art/cqc/proc/Kick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!D.stat || !D.IsParalyzed())
		...
		playsound(get_turf(A), 'sound/weapons/cqchit1.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
	...
	if(D.IsParalyzed() && !D.stat)
		...
		playsound(get_turf(A), 'sound/weapons/genhit1.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
		D.SetSleeping(300)
...
/datum/martial_art/cqc/proc/Consecutive(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!D.stat)
		...
		playsound(get_turf(D), 'sound/weapons/cqchit2.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
...
/datum/martial_art/cqc/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(picked_hit_type == "kicks" || picked_hit_type == "stomps on")
		...
		playsound(get_turf(D), 'sound/weapons/cqchit1.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
	...
	if(A.resting && !D.stat && !D.IsParalyzed())
		...
		playsound(get_turf(A), 'sound/effects/hit_kick.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
		D.apply_damage(10, BRUTE)
		D.Paralyze(60)
...
/datum/martial_art/cqc/disarm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(prob(65))
		...
		playsound(D, 'sound/weapons/punchmiss.ogg', 25, DEFAULT_SOUND_VARY, extra_range = -1)
