...
/datum/martial_art/cqc/proc/Slam(mob/living/attacker, mob/living/defender)
	...
	PLAYSOUND(attacker, 'sound/items/weapons/slam.ogg').volume(50).vary_frequency(TRUE).range(-1 + SOUND_RANGE).play()
...
/datum/martial_art/cqc/proc/Kick(mob/living/attacker, mob/living/defender)
	...
	if(defender.body_position == LYING_DOWN && !defender.IsUnconscious() && defender.getStaminaLoss() >= 100)
		...
		PLAYSOUND(attacker, 'sound/items/weapons/genhit1.ogg').volume(50).vary_frequency(TRUE).range(-1 + SOUND_RANGE).play()
		...
		PLAYSOUND(attacker, 'sound/items/weapons/cqchit1.ogg').volume(50).vary_frequency(TRUE).range(-1 + SOUND_RANGE).play()
...
/datum/martial_art/cqc/proc/Consecutive(mob/living/attacker, mob/living/defender)
	...
	PLAYSOUND(defender, 'sound/items/weapons/cqchit2.ogg').volume(50).vary_frequency(TRUE).range(-1 + SOUND_RANGE).play()
...
/datum/martial_art/cqc/disarm_act(mob/living/attacker, mob/living/defender)
	...
	if(prob(65) && (defender.stat == CONSCIOUS || !defender.IsParalyzed() || !restraining_mob?.resolve()))
		...
		PLAYSOUND(defender, 'sound/items/weapons/cqchit1.ogg').volume(50).vary_frequency(TRUE).range(-1 + SOUND_RANGE).play()
	...
	PLAYSOUND(defender, 'sound/items/weapons/punchmiss.ogg').volume(25).vary_frequency(TRUE).range(-1 + SOUND_RANGE).play()
