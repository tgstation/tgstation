	...
	switch(rand(1,8))
				...
				if(A.pulling)
					...
					if(A.a_intent == INTENT_GRAB)
						...
						D.visible_message("<span class='warning'>[A] violently grabs [D]!</span>", \
										"<span class='userdanger'>You're violently grabbed by [A]!</span>", null, null, A)
		...
		if(4)
			...
			D.visible_message("<span class='danger'>[A] [atk_verb]s [D]!</span>", \
							"<span class='userdanger'>You're [atk_verb]ed by [A]!</span>", null, null, A)
		...
		if(5,6)
			...
			D.visible_message("<span class='danger'>[A] [atk_verb]s [D] with such inhuman strength that it sends [D.p_them()] flying backwards!</span>", \
							"<span class='userdanger'>You're [atk_verb]ed by [A] with such inhuman strength that it sends you flying backwards!</span>", null, null, A)
