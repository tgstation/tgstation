...
/datum/martial_art/psychotic_brawling/proc/psycho_attack(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	switch(rand(1,8))
		...
		if(4)
			...
			D.apply_damage(rand(5,10), A.dna.species.attack_type, BODY_ZONE_HEAD, crit_array = A.get_crit_array())
			A.apply_damage(rand(5,10), A.dna.species.attack_type, BODY_ZONE_HEAD, crit_array = A.get_crit_array())
		...
		if(5,6)
			...
			D.apply_damage(rand(15,30), A.dna.species.attack_type, crit_array = A.get_crit_array())
