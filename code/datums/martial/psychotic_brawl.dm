...
/datum/martial_art/psychotic_brawling/proc/psycho_attack(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	switch(rand(1,8))
		...
		if(4)
			...
			playsound(get_turf(D), 'sound/weapons/punch1.ogg', 40, DEFAULT_SOUND_VARY, extra_range = -1)
		...
		if(5,6)
			...
			playsound(get_turf(D), 'sound/effects/meteorimpact.ogg', 25, DEFAULT_SOUND_VARY, extra_range = -1)
