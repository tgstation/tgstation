...
/datum/antagonist/wizard/proc/rename_wizard()
	...
	var/newname = copytext(sanitize(input(wiz_mob, "You are [src]. Would you like to change your name to something else?", "Name change", randomname) as null|text),1,MAX_NAME_LEN)
