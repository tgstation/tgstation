...
/datum/beam/proc/Start()
	...
	Draw()
	register_signal(origin, COMSIG_MOVABLE_MOVED, .proc/redrawing)
	register_signal(target, COMSIG_MOVABLE_MOVED, .proc/redrawing)
...
/datum/beam/Destroy()
	QDEL_LIST(elements)
	QDEL_NULL(visuals)
	unregister_signal(origin, COMSIG_MOVABLE_MOVED)
