...
/datum/wound/muscle
	...
	processes = TRUE
	/// How much do we need to regen. Will regen faster if we're splinted and or laying down, sleeping
...
/datum/wound/muscle/severe
	...
	occur_text = "jerks in pain and goes limp, it's tendon ruptured"
