...
/datum/wound_pregen_data
	...
	/// If true, this wound can only be generated by all [required_wound_types] at once, not just any.
...
/datum/wound_pregen_data/proc/wound_types_valid(list/wound_types)
	...
	for (var/iter_wound_type as anything in wound_types)
		if (!(iter_wound_type in required_wound_types))
