...
/datum/wound/cranial_fissure/try_handling(mob/living/user)
	...
	playsound(victim, 'sound/items/handling/surgery/organ2.ogg').vary(TRUE).play()
	...
	playsound(victim, 'sound/items/handling/surgery/organ1.ogg').volume(75).vary(TRUE).play()
	user.visible_message(
