...
/datum/mood_event/food
	description = "That food tasted like bade code!"

/datum/mood_event/food/add_effects(param)
	if(HAS_TRAIT(src, TRAIT_CONNOISSEUR))
		mood_change *= 2

/datum/mood_event/food/favorite_food
	description = "I really enjoyed eating that."
	mood_change = 5
	timeout = 4 MINUTES

/datum/mood_event/food/gross_food
	description = "I really didn't like that food."
	mood_change = -2
	timeout = 4 MINUTES

/datum/mood_event/food/disgusting_food
	description = "That food was disgusting!"
	mood_change = -6
	timeout = 4 MINUTES

/datum/mood_event/food/breakfast
