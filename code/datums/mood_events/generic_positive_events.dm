...
/datum/mood_event/rattsi
	description = "<span class='nicegreen'>mmmm, the delicious taste of Opsilon in a bottle.</span>\n"
	mood_change = 3
	timeout = 3 MINUTES

/datum/mood_event/spring_nya
	description = "<span class='nicegreen'>Stami-Nya restored! I'm ready for more cat-related antics!</span>\n"
	mood_change = 3
	timeout = 3 MINUTES
