...
/datum/mutation/human/hulk/on_acquiring(mob/living/carbon/human/owner)
	if(..())
		return
	ADD_TRAIT(owner, TRAIT_STUN_IMMUNE, SOURCE_GENETIC_MUTATION)
	ADD_TRAIT(owner, TRAIT_PUSH_IMMUNE, SOURCE_GENETIC_MUTATION)
	ADD_TRAIT(owner, TRAIT_CHUNKY_FINGERS, SOURCE_GENETIC_MUTATION)
	ADD_TRAIT(owner, TRAIT_IGNORE_DAMAGE_SLOWDOWN, SOURCE_GENETIC_MUTATION)
	ADD_TRAIT(owner, TRAIT_HULK, SOURCE_GENETIC_MUTATION)
...
/datum/mutation/human/hulk/on_losing(mob/living/carbon/human/owner)
	if(..())
		return
	REMOVE_TRAIT(owner, TRAIT_STUN_IMMUNE, SOURCE_GENETIC_MUTATION)
	REMOVE_TRAIT(owner, TRAIT_PUSH_IMMUNE, SOURCE_GENETIC_MUTATION)
	REMOVE_TRAIT(owner, TRAIT_CHUNKY_FINGERS, SOURCE_GENETIC_MUTATION)
	REMOVE_TRAIT(owner, TRAIT_IGNORE_DAMAGE_SLOWDOWN, SOURCE_GENETIC_MUTATION)
	REMOVE_TRAIT(owner, TRAIT_HULK, SOURCE_GENETIC_MUTATION)
	for(var/obj/item/bodypart/part as anything in owner.bodyparts)
