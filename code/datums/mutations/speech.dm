...
/datum/mutation/human/simplewords
	name = "Simple speech"
	desc = "A mutation that impairs the speech centers ability to form complex words."
	quality = NEGATIVE
	locked = TRUE
	text_gain_indication = "<span class='notice'>Your thoughts feel more simple.</span>"
	text_lose_indication = "<span class='notice'>You feel able to form complex conjugations of words again.</span>"

	var/static/list/common_words = world.file2list("strings/1000_most_common.txt")

/datum/mutation/human/simplewords/say_mod(message)
	if(message)
