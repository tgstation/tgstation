...
/datum/mutation/human/canadian/say_mod(message)
	if(message)
		...
		message = replacetext(message," color "," colour ")
		message = replacetext(message," armor "," armour ")
		message = replacetext(message," armory "," armoury ")
		message = replacetext(message," defense "," defence ")
		message = replacetext(message," honor "," honour ")
		message = replacetext(message," labor "," labour ")
		message = replacetext(message," humor "," humour ")
		message = replacetext(message," humorous "," humourous ")
		message = replacetext(message," gray "," grey ")
		message = replacetext(message," labeled "," labelled ")
		message = replacetext(message," luster "," lustre ")
		message = replacetext(message," inch "," centimetre ")
		message = replacetext(message," inches "," centimetres ")
		message = replacetext(message," yard "," metre ")
		message = replacetext(message," yards "," metres ")
		message = replacetext(message," tumor "," tumour ")
		message = replacetext(message," mile "," kilometre ")
		message = replacetext(message," pound "," kilograms ")
		message = replacetext(message," pounds "," kilograms ")
