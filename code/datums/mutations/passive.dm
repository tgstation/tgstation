...
/datum/mutation/human/clever/on_acquiring(mob/living/carbon/human/owner)
	if(..())
		return
	ADD_TRAIT(owner, TRAIT_ADVANCED_TOOL_USER, SOURCE_GENETIC_MUTATION)
	ADD_TRAIT(owner, TRAIT_LITERATE, SOURCE_GENETIC_MUTATION)

/datum/mutation/human/clever/on_losing(mob/living/carbon/human/owner)
	if(..())
		return
	REMOVE_TRAIT(owner, TRAIT_ADVANCED_TOOL_USER, SOURCE_GENETIC_MUTATION)
	REMOVE_TRAIT(owner, TRAIT_LITERATE, SOURCE_GENETIC_MUTATION)
