...
/obj/item/hardened_spike
	...
	force = 2
	throwforce = 15 //15 + 2 (ITEM_SIZE_SMALL) * 4 (EMBEDDED_IMPACT_PAIN_MULTIPLIER) = i didnt do the math
	throw_speed = 4
...
/obj/item/hardened_spike/chem
	...
	throwforce = 2 //2 + 2 (ITEM_SIZE_SMALL) * 0 (EMBEDDED_IMPACT_PAIN_MULTIPLIER) = i didnt do the math again but very low or smthin
