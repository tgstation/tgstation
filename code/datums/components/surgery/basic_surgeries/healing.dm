/datum/component/surgery/healing
	steps = list(
	...
	replaced_by = /datum/component
	ignore_clothes = TRUE
	var/healing_step_type
	var/antispam = FALSE

/datum/component/surgery/healing/can_start(mob/user, mob/living/patient)
	. = ..()
	if(isanimal(patient))
...
/datum/component/surgery/healing/New(surgery_target, surgery_location, surgery_bodypart)
	..()
...
/datum/surgery_step/heal/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
	var/woundtype
	if(brutehealing && burnhealing)
		...
		woundtype = "burns"
	if(istype(surgery,/datum/component/surgery/healing))
		var/datum/component/surgery/healing/the_surgery = surgery
...
/datum/surgery_step/heal/initiate(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery, try_to_fail = FALSE)
	if(!..())
		return
...
/datum/surgery_step/heal/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery, default_display_results = FALSE)
...
/datum/surgery_step/heal/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
...
/***************************BRUTE***************************/
/datum/component/surgery/healing/brute
	name = "Tend Wounds (Bruises)"

/datum/component/surgery/healing/brute/basic
	name = "Tend Wounds (Bruises, Basic)"
	replaced_by = /datum/component/surgery/healing/brute/upgraded
...
/datum/component/surgery/healing/brute/upgraded
	name = "Tend Wounds (Bruises, Adv.)"
	replaced_by = /datum/component/surgery/healing/brute/upgraded/femto
	requires_tech = TRUE
...
/datum/component/surgery/healing/brute/upgraded/femto
	name = "Tend Wounds (Bruises, Exp.)"
	replaced_by = /datum/component/surgery/healing/combo/upgraded/femto
	requires_tech = TRUE
...
/***************************BURN***************************/
/datum/component/surgery/healing/burn
	name = "Tend Wounds (Burn)"

/datum/component/surgery/healing/burn/basic
	name = "Tend Wounds (Burn, Basic)"
	replaced_by = /datum/component/surgery/healing/burn/upgraded
...
/datum/component/surgery/healing/burn/upgraded
	name = "Tend Wounds (Burn, Adv.)"
	replaced_by = /datum/component/surgery/healing/burn/upgraded/femto
	requires_tech = TRUE
...
/datum/component/surgery/healing/burn/upgraded/femto
...
/***************************COMBO***************************/
/datum/component/surgery/healing/combo


/datum/component/surgery/healing/combo
	name = "Tend Wounds (Mixture, Basic)"
	replaced_by = /datum/component/surgery/healing/combo/upgraded
	requires_tech = TRUE
...
/datum/component/surgery/healing/combo/upgraded
...
/datum/component/surgery/healing/combo/upgraded/femto //no real reason to type it like this except consistency, don't worry you're not missing anything
...
/datum/surgery_step/heal/combo/upgraded/femto/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
	display_results(user, target, span_warning("You screwed up!"),
		span_warning("[user] screws up!"),
		span_notice("[user] fixes some of [target]'s wounds."), TRUE)
