/datum/component/surgery/organ_manipulation
	...
	steps = list(
		...
		/datum/surgery_step/incise/pre_manipulation,
		/datum/surgery_step/manipulate_organs, //there should be bone fixing
		/datum/surgery_step/close)

/datum/component/surgery/organ_manipulation/soft
...
/datum/component/surgery/organ_manipulation/alien
	...
	steps = list(
		...
		/datum/surgery_step/incise,
		/datum/surgery_step/retract_skin,
		/datum/surgery_step/saw/pre_manipulation,
		/datum/surgery_step/manipulate_organs,
		/datum/surgery_step/close)

/datum/component/surgery/organ_manipulation/mechanic
...
/datum/component/surgery/organ_manipulation/mechanic/soft
	possible_locs = list(BODY_ZONE_PRECISE_GROIN, BODY_ZONE_PRECISE_EYES, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_L_ARM, BODY_ZONE_R_ARM)
	steps = list(
		/datum/surgery_step/mechanic_open,
		/datum/surgery_step/open_hatch,
...
/datum/surgery_step/manipulate_organs/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
	target_organ = null
...
/datum/surgery_step/manipulate_organs/success(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery, default_display_results)
	var/obj/item/bodypart/manipulated_bodypart = target.get_bodypart(target_zone)
	REMOVE_TRAIT(manipulated_bodypart, TRAIT_BEING_ORGAN_MANIPULATED, surgery.type)
	if (target_zone == BODY_ZONE_PRECISE_EYES)
		target_zone = check_zone(target_zone)
