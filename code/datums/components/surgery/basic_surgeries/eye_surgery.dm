/datum/component/surgery/eye_surgery
	name = "Eye surgery"
	steps = list(
...
/datum/component/surgery/eye_surgery/can_start(mob/user, mob/living/carbon/target)
...
/datum/surgery_step/fix_eyes/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
...
/datum/surgery_step/fix_eyes/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery, default_display_results = FALSE)
	var/obj/item/organ/eyes/target_eyes = target.getorganslot(ORGAN_SLOT_EYES)
...
/datum/surgery_step/fix_eyes/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
