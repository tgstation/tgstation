/datum/component/surgery/dental_implant
	name = "Dental implant"
	steps = list(
...
/datum/surgery_step/insert_pill/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
...
/datum/surgery_step/insert_pill/success(mob/user, mob/living/carbon/target, target_zone, obj/item/reagent_containers/pill/tool, datum/component/surgery/surgery, default_display_results = FALSE)
	if(!istype(tool))
		return FALSE
