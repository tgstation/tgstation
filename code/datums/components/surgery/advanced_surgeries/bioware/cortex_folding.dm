/datum/component/surgery/advanced/bioware/cortex_folding
	name = "Cortex Folding"
...
/datum/component/surgery/advanced/bioware/cortex_folding/can_start(mob/user, mob/living/carbon/target)
...
/datum/surgery_step/fold_cortex/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
...
/datum/surgery_step/fold_cortex/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery, default_display_results = FALSE)
...
/datum/surgery_step/fold_cortex/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/component/surgery/surgery)
