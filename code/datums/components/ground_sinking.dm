...
/datum/component/ground_sinking/Initialize(target_icon_state,
			...
			damage_res_sinked = string_list(list(BRUTE = 1, BURN = 1, TOX = 1, STAMINA = 0, OXY = 1)))
...
/datum/component/ground_sinking/proc/unsink()
	...
	living_target.damage_coeff = string_list(list(BRUTE = 1, BURN = 1, TOX = 1, STAMINA = 0, OXY = 1))
