...
/datum/component/sizzle/proc/setup_sizzle()
	...
	grill_marks.Blend(icon('icons/obj/machines/kitchen_machines.dmi', "grillmarks"), ICON_MULTIPLY) //adds grill marks and the remaining white areas become transparent
