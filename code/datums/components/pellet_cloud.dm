...
/datum/component/pellet_cloud/proc/handle_martyrs(mob/living/punishable_triggerer)
	...
	if(punishable_triggerer && prob(60))
		to_chat(punishable_triggerer, span_userdanger("Ваш план огреть кого-то гранатой на палке оборачивается против вас - в прямом смысле!"))
	...
	for(var/M in martyrs)
		...
		if(radius > 4)
			martyr.visible_message("<b>[span_danger("[martyr] героически закрывает собой [parent.declent_ru(ACCUSATIVE)], принимая на себя большую часть осколков!")]</b>", span_userdanger("Вы героически закрываете собой [parent.declent_ru(ACCUSATIVE)], принимая на себя большую часть осколков!"))
			magnitude_absorbed += round(radius * 0.5)
		else if(radius >= 2)
			martyr.visible_message("<b>[span_danger("[martyr] героически закрывает собой [parent.declent_ru(ACCUSATIVE)], принимая на себя часть осколков!")]</b>", span_userdanger("Вы героически закрываете собой [parent.declent_ru(ACCUSATIVE)], принимая на себя часть осколков!"))
			magnitude_absorbed += 2
		else
			martyr.visible_message("<b>[span_danger("[martyr] героически закрывает собой [parent.declent_ru(ACCUSATIVE)], полностью гася осколки!")]</b>", span_userdanger("Вы героически закрываете собой [parent.declent_ru(ACCUSATIVE)], полностью гася осколки!"))
