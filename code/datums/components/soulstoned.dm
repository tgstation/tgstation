...
/datum/component/soulstoned/Initialize(atom/movable/container)
	...
	ADD_TRAIT(S, TRAIT_IMMOBILE, SOULSTONE_TRAIT)
	ADD_TRAIT(S, TRAIT_HANDSBLOCKED, SOULSTONE_TRAIT)
...
/datum/component/soulstoned/UnregisterFromParent()
	var/mob/living/simple_animal/S = parent
	S.status_flags &= ~GODMODE
	REMOVE_TRAIT(S, TRAIT_IMMOBILE, SOULSTONE_TRAIT)
	REMOVE_TRAIT(S, TRAIT_HANDSBLOCKED, SOULSTONE_TRAIT)
