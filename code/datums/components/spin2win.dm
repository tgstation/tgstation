...
/datum/component/spin2win/proc/start_spinning(mob/living/spinning_user)
	...
	PLAYSOUND(spinning_user, 'sound/items/weapons/fwoosh.ogg').volume(75).vary_frequency(FALSE).play()
...
/datum/component/spin2win/proc/stop_spinning(mob/living/user)
	...
	PLAYSOUND(user, 'sound/items/weapons/fwoosh.ogg').volume(75).vary_frequency(FALSE).play()
...
/datum/component/spin2win/process(seconds_per_tick)
	...
	PLAYSOUND(item_owner, 'sound/items/weapons/fwoosh.ogg').volume(75).vary_frequency(FALSE).play()
