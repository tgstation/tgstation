...
/datum/component/spin2win/proc/start_spinning(mob/living/spinning_user)
	...
	create_sound(spinning_user, 'sound/items/weapons/fwoosh.ogg').volume(75).play()
...
/datum/component/spin2win/proc/stop_spinning(mob/living/user)
	...
	create_sound(user, 'sound/items/weapons/fwoosh.ogg').volume(75).play()
...
/datum/component/spin2win/process(seconds_per_tick)
	...
	create_sound(item_owner, 'sound/items/weapons/fwoosh.ogg').volume(75).play()
