...
/datum/component/gps/item/ui_interact(mob/user, ui_key = "gps", datum/tgui/ui = null, force_open = FALSE, datum/tgui/master_ui = null)
	if(emped)
	...
	if(!ui)
		...
		ui = new(user, src, ui_key, "Gps", "Global Positioning System", 470, gps_window_height, master_ui, ui_state()) //width, height
		ui.open()
