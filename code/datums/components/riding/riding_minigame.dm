...
/datum/riding_minigame/New(mob/living/ridden, mob/living/rider)
	...
	minigame_holder = image(icon='icons/effects/effects.dmi', loc=rider,icon_state="nothing", layer = 0, pixel_w = 32, pixel_z = 0)
	heart_counter = image(icon='icons/effects/effects.dmi', loc=rider,icon_state="nothing", layer = 0, pixel_w = 0, pixel_z = -32)
