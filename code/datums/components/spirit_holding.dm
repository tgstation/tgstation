...
/datum/component/spirit_holding/proc/attempt_spirit_awaken(mob/awakener)
	...
	var/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates("Do you want to play as the spirit of [awakener.real_name]'s blade?", ROLE_PAI, FALSE, 100, POLL_IGNORE_POSSESSED_BLADE)
