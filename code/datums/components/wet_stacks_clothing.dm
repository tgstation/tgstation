...
/datum/component/wet_stacks_granting
...
/datum/component/wet_stacks_granting/Initialize(datum/callback/use_cell, must_be_worn)
	. = ..()
	if(!isobj(parent))
...
/datum/component/wet_stacks_granting/RegisterWithParent()
	. = ..()
...
/datum/component/wet_stacks_granting/UnregisterFromParent()
	. = ..()
	UnregisterSignal(parent, list(COMSIG_ITEM_EQUIPPED,	COMSIG_ITEM_DROPPED))

/// proc when picked up or worn by someone
/datum/component/wet_stacks_granting/proc/start_processing(obj/item/source, mob/living/user, slot)
	SIGNAL_HANDLER
...
/// proc when dropped
/datum/component/wet_stacks_granting/proc/stop_processing(obj/item/source, mob/living/user)
	SIGNAL_HANDLER
	STOP_PROCESSING(SSobj, src)
	wearer = null

/datum/component/wet_stacks_granting/process(seconds_per_tick)
