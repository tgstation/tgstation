...
/datum/component/object_possession/proc/bind_to_new_object(obj/target)
	...
	target.AddElement(/datum/element/weather_listener, /datum/weather/rain, ZTRAIT_RAINSTORM, GLOB.rain_storm_sounds)
...
/datum/component/object_possession/proc/cleanup_object_binding()
	...
	possessed.RemoveElement(/datum/element/weather_listener, /datum/weather/rain, ZTRAIT_RAINSTORM, GLOB.rain_storm_sounds)
