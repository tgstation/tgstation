...
/datum/component/directional_lighting/Initialize(_range, _power, _color, starts_on)
	. = ..()
...
/datum/component/directional_lighting/proc/update_visual(new_dir)
	if(new_dir)
		direction = new_dir
