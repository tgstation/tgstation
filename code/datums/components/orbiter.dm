...
/datum/component/orbiter/inherit_component(datum/component/orbiter/newcomp, original, atom/movable/orbiter, radius, clockwise, rotation_speed, rotation_segments, pre_rotation)
	...
	for(var/o in newcomp.orbiter_list)
		...
		newcomp.unregister_signal(incoming_orbiter, COMSIG_MOVABLE_MOVED)
		register_signal(incoming_orbiter, COMSIG_MOVABLE_MOVED, .proc/orbiter_move_react)
...
/datum/component/orbiter/proc/begin_orbit(atom/movable/orbiter, radius, clockwise, rotation_speed, rotation_segments, pre_rotation)
	...
	register_signal(orbiter, COMSIG_MOVABLE_MOVED, .proc/orbiter_move_react)
...
/datum/component/orbiter/proc/end_orbit(atom/movable/orbiter, refreshing=FALSE)
	if(!orbiter_list[orbiter])
		return
	unregister_signal(orbiter, COMSIG_MOVABLE_MOVED)
...
/atom/movable/proc/orbit(atom/A, radius = 10, clockwise = FALSE, rotation_speed = 20, rotation_segments = 36, pre_rotation = TRUE)
	...
	if (HAS_TRAIT(A, TRAIT_ORBITING_FORBIDDEN))
		...
		return
	orbit_target = A
	return A.add_component(/datum/component/orbiter, src, radius, clockwise, rotation_speed, rotation_segments, pre_rotation)
