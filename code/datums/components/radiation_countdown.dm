...
/datum/component/radiation_countdown/RegisterWithParent()
	RegisterSignal(parent, COMSIG_PRE_POTENTIAL_IRRADIATION_WITHIN_RANGE, .proc/on_pre_potential_irradiation_within_range)

/datum/component/radiation_countdown/UnregisterFromParent()
	UnregisterSignal(parent, COMSIG_PRE_POTENTIAL_IRRADIATION_WITHIN_RANGE)
