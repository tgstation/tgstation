...
/datum/component/edible/Initialize(
	...
	RegisterSignal(parent, COMSIG_ATOM_ATTACK_HAND_SECONDARY, .proc/show_radial_recipes)
...
/datum/component/edible/proc/TakeBite(mob/living/eater, mob/living/feeder)
	...
	if(owner.reagents.total_volume)
		...
		owner.reagents.trans_to(eater, bite_consumption, transfered_by = feeder, methods = EATEN_FOOD)
		bitecount++
		if(!owner.reagents.total_volume)
