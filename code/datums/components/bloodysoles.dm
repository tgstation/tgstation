...
/datum/component/bloodysoles/proc/is_obscured()
	return wielder.check_obscured_slots(transparent_protection = TRUE) & equipped_slot || is_under_feet_covered()
...
/datum/component/bloodysoles/feet/is_obscured()
	if(wielder.shoes)
		return TRUE
	return wielder.check_obscured_slots(transparent_protection = TRUE) & ITEM_SLOT_FEET
