...
/datum/component/regenerative_shield/proc/block_attack(
	...
	create_sound(get_turf(parent), 'sound/items/weapons/tap.ogg').volume(20).play()
...
/datum/component/regenerative_shield/proc/disable_shield()
	...
	create_sound(parent, 'sound/vehicles/mecha/mech_shield_drop.ogg').volume(20).play()
...
/datum/component/regenerative_shield/proc/enable_shield()
	...
	create_sound(parent, 'sound/vehicles/mecha/mech_shield_raise.ogg').volume(20).play()
