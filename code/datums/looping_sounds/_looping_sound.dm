...
/datum/looping_sound
	...
	var/loud_machine = FALSE

/datum/looping_sound/New(parent, start_immediately = FALSE, direct = FALSE, skip_starting_sounds = FALSE)
	if(!mid_sounds)
...
/datum/looping_sound/proc/play(soundfile, volume_override)
	...
	playsound(parent, S, volume, vary, extra_range, falloff_exponent = falloff_exponent, falloff_distance = falloff_distance, player_sensitive = loud_machine)
