...
/datum/brain_trauma/special/obsessed/on_gain()
	...
	register_signal(obsession, COMSIG_MOB_EYECONTACT, .proc/stare)
	..()
	//antag stuff//
	antagonist.forge_objectives(obsession.mind)
	antagonist.greet()
	register_signal(owner, COMSIG_CARBON_HUG, .proc/on_hug)
...
/datum/brain_trauma/special/obsessed/on_lose()
	...
	if(obsession)
		unregister_signal(obsession, COMSIG_MOB_EYECONTACT)
