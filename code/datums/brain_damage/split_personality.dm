...
/datum/brain_trauma/severe/split_personality/proc/get_ghost()
	...
	if(LAZYLEN(candidates))
		...
		stranger_backseat.log_message("became [key_name(owner)]'s split personality.")
...
/datum/brain_trauma/severe/split_personality/proc/switch_personalities(reset_to_owner = FALSE)
	...
	current_backseat.log_message("assumed control of [key_name(owner)] due to [src]. (Original owner: [current_controller == OWNER ? owner.key : current_backseat.key])")
