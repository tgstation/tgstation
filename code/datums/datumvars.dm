	...
	if(istype(D, /atom))
		...
		if(isliving(A))
			...
			atomsnowflake += {"<a href='?_src_=vars;[HrefToken()];rename=[refid]'><b id='name'>[D]</b></a>
				<br><font size='1'><a href='?_src_=vars;[HrefToken()];rotatedatum=[refid];rotatedir=left'><<</a> <a href='?_src_=vars;[HrefToken()];datumedit=[refid];varnameedit=dir' id='dir'>[dir2text(A.dir) || A.dir]</a> <a href='?_src_=vars;[HrefToken()];rotatedatum=[refid];rotatedir=right'>>></a></font>"}
