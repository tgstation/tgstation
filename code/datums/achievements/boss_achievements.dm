...
/datum/achievement/hierophant_crusher
	name = "Hierophant Crusher"
	desc = "Hierophant, but not triumphant."
	achievement_type = ACHIEVEMENT_DEFAULT
	hub_id = BOSS_MEDAL_HIEROPHANT_CRUSHER

/datum/achievement/legion_crusher
	name = "Legion Crusher"
	desc = "We were many..now we are none."
	achievement_type = ACHIEVEMENT_DEFAULT
	hub_id = BOSS_MEDAL_LEGION_CRUSHER

/datum/achievement/swarmer_beacon_crusher
