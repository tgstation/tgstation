...
/datum/element/spooky/proc/spectral_attack(datum/source, mob/living/carbon/C, mob/user)
	...
	if(ishuman(user)) //this weapon wasn't meant for mortals.
		...
		if(!istype(U.dna.species, /datum/species/skeleton))
			...
			U.Jitter(35)
			U.set_speech_impediment(40 SECONDS, /datum/status_effect/speech/stutter)
	...
	if(ishuman(C))
		...
		C.Jitter(35)
		C.set_speech_impediment(40 SECONDS, /datum/status_effect/speech/stutter)
		...
		C.Jitter(15)
		C.set_speech_impediment(20 SECONDS, /datum/status_effect/speech/stutter)
