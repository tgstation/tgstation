...
/datum/element/plumbing_milkable/proc/take_required(datum/reagents/victim)
	for(var/A in required_reagents)
...
/datum/element/plumbing_milkable/proc/try_trade(datum/source, datum/reagents/target, datum/reagents/victim)
