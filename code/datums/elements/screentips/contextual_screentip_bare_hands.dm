...
/datum/element/contextual_screentip_bare_hands/Attach(
	...
	register_signal(atom_target, COMSIG_ATOM_REQUESTING_CONTEXT_FROM_ITEM, .proc/on_requesting_context_from_item)

/datum/element/contextual_screentip_bare_hands/Detach(datum/source, ...)
	unregister_signal(source, COMSIG_ATOM_REQUESTING_CONTEXT_FROM_ITEM)
