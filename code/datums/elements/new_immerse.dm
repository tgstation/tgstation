...
/datum/element/immerse_new/Attach(turf/target, mask_icon = "immerse", alpha = 180)
	. = ..()
...
/datum/element/immerse_new/Detach(turf/source)
...
/datum/element/immerse_new/proc/start_immersion(turf/source)
	SIGNAL_HANDLER
...
/datum/element/immerse_new/proc/stop_immersion(turf/source)
	SIGNAL_HANDLER
 ...
 */
/datum/element/immerse_new/proc/on_init_or_entered(turf/source, atom/movable/movable)
	SIGNAL_HANDLER
	if(QDELETED(movable))
		return
...
/datum/element/immerse_new/proc/on_movable_qdel(atom/movable/source)
	SIGNAL_HANDLER
 ...
 */
/datum/element/immerse_new/proc/try_immerse(atom/movable/movable, atom/movable/buckled)
...
/datum/element/immerse_new/proc/try_unimmerse(atom/movable/movable, atom/movable/buckled)
	var/atom/movable/to_check = buckled || movable
	if(!(to_check.movement_type & MOVETYPES_NOT_TOUCHING_GROUND) && !movable.throwing)
...
/datum/element/immerse_new/proc/on_set_buckled(mob/living/source, atom/movable/new_buckled)
	SIGNAL_HANDLER
	try_unimmerse(source, source.buckled)
	try_immerse(source, new_buckled)

/// Removes the overlay from mob and bucklees is flying.
/datum/element/immerse_new/proc/on_move_flag_enabled(atom/movable/source, flag, old_movement_type)
	SIGNAL_HANDLER
...
/datum/element/immerse_new/proc/on_throw(atom/movable/source)
	SIGNAL_HANDLER
...
/datum/element/immerse_new/proc/on_move_flag_disabled(atom/movable/source, flag, old_movement_type)
	SIGNAL_HANDLER
...
/datum/element/immerse_new/proc/on_throw_landed(atom/movable/source)
	SIGNAL_HANDLER
	if(source.movement_type & MOVETYPES_NOT_TOUCHING_GROUND)
		return
	add_immerse_overlay(source)
...
/datum/element/immerse_new/proc/on_atom_exited(turf/source, atom/movable/exited, direction)
	SIGNAL_HANDLER
...
/datum/element/immerse_new/proc/remove_from_element(turf/source, atom/movable/movable)
	var/atom/movable/buckled = null
	if(isliving(movable))
		var/mob/living/living_mob = movable
		buckled = living_mob.buckled
...
/datum/element/immerse_new/proc/generate_immerse_mask(width, height, is_below_water)
...
/datum/element/immerse_new/proc/add_immerse_overlay(atom/movable/movable)
...
/datum/element/immerse_new/proc/remove_immerse_overlay(atom/movable/movable, deleting = TRUE)
...
/datum/element/immerse_new/proc/on_spin_animation(atom/source, speed, loops, segments, segment)
	SIGNAL_HANDLER
...
/datum/element/immerse_new/proc/on_update_offsets(mob/living/source, new_x, new_y, new_w, new_z, animate)
	SIGNAL_HANDLER
