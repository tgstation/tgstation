...
/datum/personality/department/impulsive
	...
	name = "Импульсивный"
	desc = "Я лучше справляюсь, действуя спонтанно и импровизируя по ходу дела."
	neut_gameplay_desc = "Предпочитает работать в социальных сферах, таких как карго, командование, безопасность или обслуживание"
	applicable_areas = list(
