/datum/map_generator/cave_generator/icemoon
	weighted_open_turf_types = list(/turf/open/misc/grass/jungle = 19, /turf/open/misc/dirt/jungle/dark = 1)
	...
	weighted_flora_spawn_list = list(
		...
		/obj/structure/flora/grass/jungle/a/style_random = 6,
...
/datum/map_generator/cave_generator/icemoon/surface/forested
	weighted_open_turf_types = list(/turf/open/misc/grass/jungle = 1)
...
/datum/map_generator/cave_generator/icemoon/deep
	...
	weighted_mob_spawn_list = list(
		...
		/mob/living/simple_animal/hostile/asteroid/hivelord/legion = 100,
		/mob/living/basic/mining/watcher = 100,
	...
	weighted_flora_spawn_list = list(
		...
		/obj/structure/flora/rock/pile/jungle/style_random = 6,
		/obj/structure/flora/ash/leaf_shroom = 1,
	)
