/datum/map_generator/cave_generator/lavaland
	...
	veins_spawn_list = list(
		/obj/structure/ore_vein = 5,
		/obj/structure/ore_vein/iron = 10,
		/obj/structure/ore_vein/plasma = 10,
		/obj/structure/ore_vein/gold = 5,
		/obj/structure/ore_vein/silver = 5
		)
