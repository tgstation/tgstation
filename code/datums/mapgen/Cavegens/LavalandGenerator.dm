/datum/map_generator/cave_generator/lavaland
	...
	weighted_mob_spawn_list = list(
		/mob/living/simple_animal/hostile/asteroid/goliath/beast/random = 500,
		/obj/structure/spawner/lavaland/goliath = 30,
		/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/random = 400,
		/obj/structure/spawner/lavaland = 20,
		/mob/living/simple_animal/hostile/asteroid/hivelord/legion/random = 300,
		/obj/structure/spawner/lavaland/legion = 30,
		SPAWN_MEGAFAUNA = 40,
		/mob/living/simple_animal/hostile/asteroid/goldgrub = 100,
		/mob/living/simple_animal/hostile/asteroid/lobstrosity/lava = 200,
		/mob/living/simple_animal/hostile/asteroid/brimdemon = 200,
		/mob/living/basic/mining/bileworm = 200,
		/mob/living/basic/mining/hugglebipper = 2,
	)
