/datum/map_generator/cave_generator/lavaland
	...
	feature_spawn_list = list(/obj/structure/geyser/wittel = 5, /obj/structure/geyser/random = 1, /obj/structure/geyser/plasma_oxide = 10, /obj/structure/geyser/protozine = 10)
