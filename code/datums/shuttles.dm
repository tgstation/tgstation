...
/datum/map_template/shuttle/emergency/bar
	...
	description = "Features include sentient bar staff (a Bardrone), bathroom, a quality lounge for the heads, and a large gathering table."
	admin_notes = "Bardrone is GODMODE, will be automatically sentienced by the fun balloon at 60 seconds before arrival. Has medical facilities."
	credit_cost = 5000
