/datum/disease/tuberculosis
	...
	//cures = list(/datum/reagent/medicine/spaceacillin, /datum/reagent/medicine/C2/convermol) austation -- trekchems added back. Changes in equiv file in austation dir
