...
/datum/disease/advance
	...
	var/static/list/advance_cures = 	list(
									...
									list(	//level 4
										/datum/reagent/medicine/spaceacillin, /datum/reagent/medicine/salglu_solution, /datum/reagent/medicine/epinephrine, /datum/reagent/medicine/charcoal // austation -- revert cobbychem
									),
									list(	//level 5
