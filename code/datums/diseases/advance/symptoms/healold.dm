...
/datum/symptom/healold/Start(datum/disease/advance/A)
	if(!..())
		return
...
/datum/symptom/healold/Activate(datum/disease/advance/A)
	if(!..())
		return
...
/datum/symptom/healold/proc/Heal(mob/living/M, datum/disease/advance/A)
	return 1
...
/datum/symptom/healold/toxin/Heal(mob/living/M, datum/disease/advance/A)
...
/datum/symptom/healold/toxin/plus
...
/datum/symptom/healold/toxin/plus/Heal(mob/living/M, datum/disease/advance/A)
...
/datum/symptom/healold/brute/Heal(mob/living/carbon/M, datum/disease/advance/A)
	var/heal_amt = 2 * power
...
/datum/symptom/healold/brute/plus
...
/datum/symptom/healold/brute/plus/Heal(mob/living/carbon/M, datum/disease/advance/A)
...
/datum/symptom/healold/burn/Heal(mob/living/carbon/M, datum/disease/advance/A)
	var/heal_amt = 2 * power
...
/datum/symptom/healold/burn/plus
...
/datum/symptom/healold/burn/plus/Heal(mob/living/carbon/M, datum/disease/advance/A)
	var/heal_amt = 4 * power
...
/datum/symptom/healold/dna/Heal(mob/living/carbon/M, datum/disease/advance/A)
