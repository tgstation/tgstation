...
/datum/symptom/alkali
	...
	treshold_descs = list(
		...
		"Transmission 8" = "Additionally synthesizes chlorine trifluoride and napalm inside the host. More chemicals are synthesized if the resistance 9 treshold has been met."
	)
