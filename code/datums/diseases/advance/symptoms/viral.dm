...
/datum/symptom/viraladaptation
	...
	desc = "The virus mimics the function of normal body cells, becoming harder to spot and to eradicate, but reducing its speed. Has no effects on its own."
	stealth = 3
	resistance = 5
	stage_speed = -3
	transmittable = 0
...
/datum/symptom/viralevolution
	...
	This, however, makes the virus easier to spot, and less able to fight off a cure. Has no effects on its own."
	stealth = -2
	resistance = -3
	stage_speed = 5
	transmittable = 3
