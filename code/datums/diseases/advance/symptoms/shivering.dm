...
/datum/symptom/shivering/Activate(datum/disease/advance/A)
	...
	if(!unsafe || A.stage < 4)
		to_chat(M, "<span class='warning'>[SSrng.pick_from_list("You feel cold.", "You shiver.")]</span>")
	else
		to_chat(M, "<span class='userdanger'>[SSrng.pick_from_list("You feel your blood run cold.", "You feel ice in your veins.", "You feel like you can't heat up.", "You shiver violently." )]</span>")
