...
/datum/id_trim
	...
	/// Accesses that this trim unlocks on a card that need wildcard slots to apply.. If a card cannot accept all a trim's wildcard accesses, the card is incompatible with the trim.
