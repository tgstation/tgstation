...
/datum/id_trim/job/cargo_technician
	...
	extra_access = list(ACCESS_MINING, ACCESS_MINING_STATION)
	minimal_access = list(ACCESS_CARGO, ACCESS_SHIPPING, ACCESS_MAINT_TUNNELS, ACCESS_MECH_MINING, ACCESS_MINERAL_STOREROOM)
...
/datum/id_trim/job/head_of_personnel
	...
	extra_access = list()
	extra_wildcard_access = list()
	minimal_access = list(ACCESS_AI_UPLOAD, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_BAR, ACCESS_CHAPEL_OFFICE,
					...
					ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINERAL_STOREROOM,
					ACCESS_MORGUE, ACCESS_PSYCHOLOGY, ACCESS_RC_ANNOUNCE,
					ACCESS_RESEARCH, ACCESS_BRIG_ENTRANCE, ACCESS_TELEPORTER, ACCESS_THEATRE, ACCESS_WEAPONS, ACCESS_SERVICE)
...
/datum/id_trim/job/quartermaster
	...
	extra_access = list()
	minimal_access = list(ACCESS_AUX_BASE, ACCESS_CARGO, ACCESS_SHIPPING, ACCESS_MAINT_TUNNELS, ACCESS_MECH_MINING, ACCESS_MINING_STATION,
					ACCESS_KEYCARD_AUTH, ACCESS_COMMAND, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_BRIG_ENTRANCE, ACCESS_TELEPORTER,
					ACCESS_MINERAL_STOREROOM, ACCESS_MINING, ACCESS_RC_ANNOUNCE, ACCESS_VAULT)
...
/datum/id_trim/job/shaft_miner
	...
	minimal_access = list(ACCESS_CARGO, ACCESS_AUX_BASE, ACCESS_SHIPPING, ACCESS_MECH_MINING, ACCESS_MINERAL_STOREROOM, ACCESS_MINING,
					ACCESS_MINING_STATION)
	template_access = list(ACCESS_CAPTAIN, ACCESS_QM, ACCESS_CHANGE_IDS)
