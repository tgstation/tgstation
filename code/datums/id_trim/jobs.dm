...
/datum/id_trim/job/proc/refresh_trim_access()
	...
	if(CONFIG_GET(flag/jobs_have_minimal_access))
		...
		access = minimal_access + full_access
		wildcard_access = minimal_wildcard_access + full_wildcard_access
...
/datum/id_trim/job/atmospheric_technician
	...
	full_access = list(ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_MINERAL_STOREROOM, ACCESS_TECH_STORAGE)
...
/datum/id_trim/job/cook
	...
	full_access = list(ACCESS_BAR, ACCESS_HYDROPONICS)
...
/datum/id_trim/job/geneticist
	...
	full_access = list(ACCESS_ROBOTICS, ACCESS_TECH_STORAGE, ACCESS_XENOBIOLOGY)
...
/datum/id_trim/job/roboticist
	...
	full_access = list(ACCESS_GENETICS, ACCESS_MECH_SCIENCE, ACCESS_ORDNANCE, ACCESS_ORDNANCE_STORAGE, ACCESS_RND, ACCESS_XENOBIOLOGY)
...
/datum/id_trim/job/scientist
	...
	full_access = list(ACCESS_GENETICS, ACCESS_ROBOTICS, ACCESS_TECH_STORAGE)
	minimal_access = list(ACCESS_RND, ACCESS_ORDNANCE, ACCESS_ORDNANCE_STORAGE, ACCESS_RESEARCH, ACCESS_XENOBIOLOGY, ACCESS_MECH_SCIENCE,
...
/datum/id_trim/job/security_officer
	...
	full_access = list(ACCESS_FORENSICS_LOCKERS, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE)
...
/datum/id_trim/job/shaft_miner
	...
	full_access = list(ACCESS_CARGO, ACCESS_MAINT_TUNNELS, ACCESS_QM)
...
/datum/id_trim/job/virologist
	...
	full_access = list(ACCESS_CHEMISTRY, ACCESS_MORGUE, ACCESS_SURGERY)
...
/datum/id_trim/job/warden
	...
	full_access = list(ACCESS_COURT, ACCESS_FORENSICS_LOCKERS, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE)
