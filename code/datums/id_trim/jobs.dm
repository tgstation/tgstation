...
/datum/id_trim/job/atmospheric_technician
	...
	minimal_access = list(ACCESS_ENGINEERING, ACCESS_ATMOSPHERICS, ACCESS_CONSTRUCTION, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_MAINT_TUNNELS, ACCESS_MECH_ENGINE,
...
/datum/id_trim/job/chief_engineer
	...
	minimal_access = list(ACCESS_ATMOSPHERICS, ACCESS_CE, ACCESS_CONSTRUCTION, ACCESS_ENGINEERING, ACCESS_ENGINE_EQUIP, ACCESS_EVA,
...
/datum/id_trim/job/head_of_security
	...
	extra_access = list(ACCESS_TELEPORTER)
	extra_wildcard_access = list()
	minimal_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_ARMORY, ACCESS_BRIG, ACCESS_CONSTRUCTION, ACCESS_COURT,
...
/datum/id_trim/job/research_director
	...
	extra_access = list()
	extra_wildcard_access = list()
	minimal_access = list(ACCESS_AI_UPLOAD, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_GENETICS, ACCESS_COMMAND, ACCESS_KEYCARD_AUTH,
...
/datum/id_trim/job/roboticist
	...
	minimal_access = list(ACCESS_MECH_SCIENCE, ACCESS_MINERAL_STOREROOM, ACCESS_MORGUE, ACCESS_RESEARCH, ACCESS_SCIENCE,
...
/datum/id_trim/job/security_officer/engineering
	...
	department_access = list(ACCESS_ATMOSPHERICS, ACCESS_CONSTRUCTION, ACCESS_ENGINEERING, ACCESS_ENGINE_EQUIP, ACCESS_TCOMMS)
...
/datum/id_trim/job/security_officer/science
	...
	department_access = list(ACCESS_GENETICS, ACCESS_ORDNANCE, ACCESS_ORDNANCE_STORAGE, ACCESS_RESEARCH, ACCESS_ROBOTICS, ACCESS_SCIENCE, ACCESS_XENOBIOLOGY)
...
/datum/id_trim/job/station_engineer
	...
	minimal_access = list(ACCESS_CONSTRUCTION, ACCESS_ENGINEERING, ACCESS_ENGINE_EQUIP, ACCESS_EXTERNAL_AIRLOCKS,
