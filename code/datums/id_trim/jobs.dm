...
/datum/id_trim/job/head_of_personnel
	...
	extra_access = list(ACCESS_AI_UPLOAD, ACCESS_SECURITY)
	extra_wildcard_access = list()
	minimal_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_AUX_BASE, ACCESS_BAR, ACCESS_CARGO, ACCESS_CHAPEL_OFFICE,
