...
/datum/quirk/junkie
	...
	var/drug_list = list(/datum/reagent/drug/crank, /datum/reagent/drug/krokodil, "morphine", /datum/reagent/drug/happiness, /datum/reagent/drug/methamphetamine) //List of possible IDs
