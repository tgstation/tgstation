...
/datum/quirk/junkie
	...
	var/drug_list = list(/datum/reagent/drug/crank, /datum/reagent/drug/krokodil, /datum/reagent/drug/opioid/morphine, /datum/reagent/drug/opioid/diamorphine, /datum/reagent/drug/ecstasy, /datum/reagent/drug/amphetamine/methamphetamine , /datum/reagent/drug/amphetamine/adderal) //List of possible IDs
