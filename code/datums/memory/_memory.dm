...
/datum/memory
	...
	// These are common infobits passed to memories, placed into strings.
...
/datum/memory/proc/get_names()
	stack_trace("[type] didn't have any names setup, these are necessary!")
	return list()

/datum/memory/proc/get_starts()
	stack_trace("[type] didn't have any starts setup, these are necessary!")
	return list()
