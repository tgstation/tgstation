...
/datum/recipe
	...
	var/list/items // example: =list(/obj/item/tool/crowbar, /obj/item/weapon/welder) // place /foo/bar before /foo
	var/result //example: = /obj/item/chem/food/snacks/donut/normal
