...
/datum/weather/ash_storm
	name = "ash storm"
	desc = "An intense atmospheric storm lifts ash off the planet's surface and billows it down across the area, dealing intense fire damage to the unprotected."
