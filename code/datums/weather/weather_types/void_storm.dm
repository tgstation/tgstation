/datum/weather/snow_storm
	...
	telegraph_message = "<span class='warning'>Pitch black particles start drifting in the air</span>"
	telegraph_duration = 2 SECONDS
	telegraph_overlay = "void"

	weather_message = "<span class='userdanger'><i>You feel air around you getting colder... and void's sweet embrace...</i></span>"
	weather_overlay = "snow_storm"
	weather_duration_lower = 60 SECONDS
	weather_duration_upper = 120 SECONDS

	end_duration = 60 SECONDS
	end_message = "<span class='boldannounce'>Void storm has calmed down... the void has spared you this time..</span>"
