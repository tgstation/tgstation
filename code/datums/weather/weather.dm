...
/datum/weather/proc/telegraph()
	...
	for(var/V in GLOB.player_list)
		...
		if(M.z == target_z)
			...
			if(M.client && (M.client.prefs.toggles & SOUND_AMBIENCE) && telegraph_sound)
...
/datum/weather/proc/start()
	...
	for(var/V in GLOB.player_list)
		...
		if(M.z == target_z)
			...
			if(M.client && (M.client.prefs.toggles & SOUND_AMBIENCE) && weather_sound)
...
/datum/weather/proc/wind_down()
	...
	for(var/V in GLOB.player_list)
		...
		if(M.z == target_z)
			...
			if(M.client && (M.client.prefs.toggles & SOUND_AMBIENCE) && end_sound)
