...
/datum/proximity_monitor/advanced/projectile_dampener
	var/static/image/edgeturf_south = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_south"))
	var/static/image/edgeturf_north = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_north"))
	var/static/image/edgeturf_west = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_west"))
	var/static/image/edgeturf_east = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_east"))
	var/static/image/northwest_corner = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_northwest"))
	var/static/image/southwest_corner = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_southwest"))
	var/static/image/northeast_corner = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_northeast"))
	var/static/image/southeast_corner = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_southeast"))
	var/static/image/generic_edge = STATIC_INIT(image('icons/effects/fields.dmi', icon_state = "projectile_dampen_generic"))
