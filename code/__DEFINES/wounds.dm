...
/// If an attack rolls this high with their wound (including mods), we try to outright dismember the limb. Note 225 is high enough that with a oerfect max roll of 145 (see max cons'd damage), you'd need +80 in mods to do this
#define WOUND_DISMEMBER_OUTRIGHT_THRESH	225
