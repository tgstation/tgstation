...
#define COMPUTER_FRAME_DEFAULT 0
#define COMPUTER_FRAME_BOARD_INSTALLED 1
#define COMPUTER_FRAME_BOARD_SECURED 2
#define COMPUTER_FRAME_WIRED 3
#define COMPUTER_FRAME_SCREEN_INSTALLED 4
