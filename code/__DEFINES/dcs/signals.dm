...
#define COMSIG_LIVING_REMOVE_LIMB "living_remove_limb"			//from base of /obj/item/bodypart/proc/attach_limb(): (new_limb, special) allows you to fail limb attachment
...
#define COMSIG_CARBON_ADD_WOUND "carbon_gain_wound"				//from /item/organ/proc/Remove() (/obj/item/organ/)
#define COMSIG_CARBON_REMOVE_WOUND "carbon_lose_wound"				//from /item/organ/proc/Remove() (/obj/item/organ/)
