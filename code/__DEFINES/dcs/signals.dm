...
///from base of mob/living/hitby(): (mob/living/target, hit_zone, /datum/thrownthing/throwingdatum)
...
#define COMSIG_MOB_THROW "mob_throw"
	///Return this to interrupt the throw
	#define COMPONENT_MOB_NO_THROW (1<<0)
