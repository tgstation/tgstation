...
///from base of [/datum/reagents/proc/remove_reagent]: ()
#define COMSIG_REAGENTS_REM_REAGENT		"reagents_rem_reagent"
///from base of [/datum/reagents/proc/set_temperature]: (old_temp)
#define COMSIG_REAGENTS_TEMP_CHANGE		"reagents_temp_change"
///from base of [/atom/proc/expose_reagents]: (/obj, )
#define COMSIG_REAGENTS_EXPOSE_ATOM		"reagents_expose_atom"
///from base of [/obj/proc/expose_reagents]: (/obj, )
#define COMSIG_REAGENTS_EXPOSE_OBJ		"reagents_expose_obj"
///from base of [/mob/living/proc/expose_reagents]: (/mob/living, )
#define COMSIG_REAGENTS_EXPOSE_MOB		"reagents_expose_mob"
///from base of [/turf/proc/expose_reagents]: (/turf, )
