...
/// Called from [/mob/living/proc/send_item_attack_message()]: (obj/item/weapon, mob/living/user, hit_area, def_zone)
#define COMSIG_SEND_ITEM_ATTACK_MESSAGE
	/// Return value if the hitby messages are changed.
	#define SIGNAL_MESSAGE_MODIFIED
