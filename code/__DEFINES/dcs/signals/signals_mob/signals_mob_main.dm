...
/// From /datum/surgery_step/success(): (mob/living/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results)
#define COMSIG_MOB_SURGEY_STEP_SUCCESS "mob_surgery_step_success"
