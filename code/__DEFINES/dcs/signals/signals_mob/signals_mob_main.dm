...
/// From base of /client/Move(), invoked when the cliented mob is possessing an object: (list/move_args)
#define COMSIG_MOB_CLIENT_MOVE_POSSESSED_OBJECT "mob_client_move_possessed_object"
