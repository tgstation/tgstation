...
///(NOT on humans) from mob/living/*/click_on_without_item(): (mob/living/source, atom/target, proximity, modifiers)
...
///from /mob/living/proc/check_block(): (atom/hit_by, damage, attack_text, attack_type, armour_penetration, damage_type, attack_flag)
