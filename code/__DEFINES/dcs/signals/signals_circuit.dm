...
///Called when an Ntnet sender (list literal) is sending Ntnet data
#define COMSIG_GLOB_CIRCUIT_NTNET_DATA_SENT_LIST_LITERAL "!circuit_ntnet_data_sent_list_literal"
