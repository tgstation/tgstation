...
///sent from the pawn when an ai controller possesses it: (datum/ai_controller/source_controller)
#define COMSIG_PAWN_POSSESSED_BY_AI_CONTROLLER "pawn_possessed_by_ai_controller"
