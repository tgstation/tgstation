...
/// Singularity stage 1
#define STAGE_ONE_ENERGY ((STAGE_TWO_ENERGY_REQUIREMENT - STAGE_ONE_ENERGY_REQUIREMENT) / 2 ) + STAGE_ONE_ENERGY_REQUIREMENT
/// Singularity stage 2
#define STAGE_TWO_ENERGY ((STAGE_THREE_ENERGY_REQUIREMENT - STAGE_TWO_ENERGY_REQUIREMENT) / 2 ) + STAGE_TWO_ENERGY_REQUIREMENT
/// Singularity stage 3
#define STAGE_THREE_ENERGY ((STAGE_FOUR_ENERGY_REQUIREMENT - STAGE_THREE_ENERGY_REQUIREMENT) / 2 ) + STAGE_THREE_ENERGY_REQUIREMENT
/// Singularity stage 4
#define STAGE_FOUR_ENERGY ((STAGE_FIVE_ENERGY_REQUIREMENT - STAGE_FOUR_ENERGY_REQUIREMENT) / 2 ) + STAGE_FOUR_ENERGY_REQUIREMENT
/// Singularity stage 5
#define STAGE_FIVE_ENERGY ((STAGE_SIX_ENERGY_REQUIREMENT - STAGE_FIVE_ENERGY_REQUIREMENT) / 2 ) + STAGE_FIVE_ENERGY_REQUIREMENT
