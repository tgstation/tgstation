...
///weakref of the retreat turf. If a hugglebipper has this, it will prioritize getting far enough away from it.
#define BB_HUGGLEBIPPER_WEAK_RETREAT_TURF "BB_hugglebipper_weak_retreat_turf"
