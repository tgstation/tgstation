...
///assoc list, person = aggro level (subtracted by 1 for each attack)
#define BB_ITEM_AGGRO_LIST "bb_item_aggro"
///Amount of aggro you get when picking up an item
#define BB_ITEM_AGGRO_ADDITION "bb_aggro_added"

///our targetted mob for attacking
#define BB_ITEM_TARGET "bb_item_target"
///How far an item will chase a target
#define ITEM_AGGRO_VIEW_RANGE 7
///the type of move and attack behavior being used
#define BB_ITEM_MOVE_AND_ATTACK_TYPE "bb_item_move_and_attack_type"
///How many times
#define BB_ITEM_THROW_ATTEMPT_COUNT "BB_item_throw_attempt_count"
///If true, tolerates the equipper holding/equipping the item.
...
#define ITEM_AGGRO_ATTACK_CHANCE 10
