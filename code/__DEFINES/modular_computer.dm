...
GLOBAL_LIST_INIT(pda_id_to_theme, list(
	PDA_THEME_ID_CAT = PDA_THEME_CAT,
	PDA_THEME_ID_LIGHT_MODE = PDA_THEME_LIGHT_MODE,
	PDA_THEME_ID_SPOOKY = PDA_THEME_SPOOKY,
	PDA_THEME_ID_HACKERMAN = PDA_THEME_HACKERMAN,
	PDA_THEME_ID_ROULETTE = PDA_THEME_ROULETTE,
	PDA_THEME_ABDUCTOR = PDA_THEME_ABDUCTOR,
))
