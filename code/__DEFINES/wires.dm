...
#define WIRE_ARROW_DAMAGE "Damage Arrow"
#define WIRE_ARROW_EMP "EMP Arrow"
#define WIRE_ARROW_REPULSE "Repulse Arrow"
#define WIRE_ARROW_CHANGE_CONTROL "Arrow Change Control"
