...
#define HUMAN_AUTHORITY_DISABLED 0
#define HUMAN_AUTHORITY_HUMAN_WHITELIST 1
#define HUMAN_AUTHORITY_NON_HUMAN_WHITELIST 2
#define HUMAN_AUTHORITY_ENFORCED 3
