...
#define CLOWN_INSPECTOR_PRINT_SOUND_MODE_CLASSIC 2
#define CLOWN_INSPECTOR_PRINT_SOUND_MODE_HONK 3
#define CLOWN_INSPECTOR_PRINT_SOUND_MODE_FAFAFOGGY 4
#define CLOWN_INSPECTOR_PRINT_SOUND_MODE_FAFAFOGGY_ALT 5
#define BANANIUM_INSPECTOR_PRINT_SOUND_MODE_LAST 5
#define CLOWN_INSPECTOR_PRINT_SOUND_MODE_LAST 5
