...
#define TURBINE_WORK_CONVERSION_MULTIPLIER 0.1
///Multiplier when converting gas work back into heat
#define TURBINE_HEAT_CONVERSION_MULTIPLIER 0.01
...
#define TURBINE_COMPRESSOR_STATOR_INTERACTION_MULTIPLIER 0.05
