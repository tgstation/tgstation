...
#define POD_STYLES list(\
    ...
    list("missilepod", "cruise missile", "A big ass missile that didn't seem to fully detonate. It was likely launched from some far-off deep space missile silo. There appears to be an auxillery payload hatch on the side, though opening it is likely impossible."),\
    list("smissilepod", "\improper Syndicate cruise missile", "A decomissioned Nanotrasen cruise missile stolen and repurposed by the syndicate."),\
