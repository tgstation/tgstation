...
//number defines
#define CLEAN_SKILL_BEAUTY_ADJUSTMENT	-15//It's a denominator so no 0. Higher number = less cleaningXP per cleanable. Negative value means cleanables with negative beauty giveXP.
