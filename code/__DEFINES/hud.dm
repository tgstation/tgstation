...
#define ui_sstore1(x_px, y_px) "CENTER-5:[10+x_px],SOUTH:[5+y_px]"
...
#define ui_inv1(x_px, y_px) "CENTER-2:[16+x_px],SOUTH:[5+y_px]"
#define ui_inv2(x_px, y_px) "CENTER-1:[16+x_px],SOUTH:[5+y_px]"
#define ui_inv3(x_px, y_px) "CENTER:[16+x_px],SOUTH:[5+y_px]"
