...
#define MACHINE_ELECTRIFIED_TEMPORARY 1
#define MACHINE_ELECTRIFIED_EMP 2
#define MACHINE_ELECTRIFIED_PERM_TOGGLE 3
#define MACHINE_DEFAULT_ELECTRIFY_TIME 30 SECONDS
#define MACHINE_DEFAULT_EMP_ELECTRIFY_TIME 5 MINUTES
