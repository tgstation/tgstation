/// electrified_buckle needs a shock kit attached to it in order to shock
#define SHOCK_REQUIREMENT_ITEM (1<<0)
/// electrified_buckle needs a live cable to work, and draws power from it
#define SHOCK_REQUIREMENT_LIVE_CABLE (1<<1)
/// electrified_buckle needs to be turned on with a signal in order to shock the buckled mob
#define SHOCK_REQUIREMENT_ON_SIGNAL_RECEIVED (1<<2)
/// electrified_buckle needs the parent to be alive in order to shock (if parent is a mob)
...
/// electrified buckle needs the area to be powered but not necessarily connected by cable
