...
#define span_phantombignotice(str) ("<span class='phantombignotice'>" + str + "</span>")
#define span_phantomboldnotice(str) ("<span class='phantomboldnotice'>" + str + "</span>")
#define span_phantomdanger(str) ("<span class='phantomdanger'>" + str + "</span>")
#define span_phantomminor(str) ("<span class='phantomminor'>" + str + "</span>")
#define span_phantomnotice(str) ("<span class='phantomnotice'>" + str + "</span>")
#define span_phantomwarning(str) ("<span class='phantomwarning'>" + str + "</span>")
