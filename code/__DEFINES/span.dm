...
#define span_binaryannounce(str) ("<span class='binaryannounce'>" + str + "</span>")
#define span_binarysay(str) ("<span class='binarysay'>" + str + "</span>")
#define span_binarynotice(str) ("<span class='binarynotice'>" + str + "</span>")
#define span_binarynoticebold(str) ("<span class='binarynoticebold'>" + str + "</span>")
...
#define span_hypnophraselarge(str) ("<span class='reallybig hypnophrase'>" + str + "</span>")
