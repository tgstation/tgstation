...
GLOBAL_LIST_INIT(footstep, list(
	...
	FOOTSTEP_ROOTS = list(list(
		'sound/effects/footstep/roots1.ogg',
		'sound/effects/footstep/roots2.ogg',
		'sound/effects/footstep/roots3.ogg'), 75, 0),
))
