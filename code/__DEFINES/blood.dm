...
#define BLOOD_STATE_HUMAN "blood" /// Red blood
#define BLOOD_STATE_XENO "xeno" /// Green xeno blood
#define BLOOD_STATE_OIL "oil" /// Black robot oil
#define BLOOD_STATE_NOT_BLOODY "no blood whatsoever" /// No blood is present 
