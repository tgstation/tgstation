...
///Dictates whether a user (source) is interacting with the frame of a stationary modular computer or the cpu inside it. Needed for circuits I guess.
#define TRAIT_MODPC_INTERACTING_WITH_FRAME "modp_interacting_with_frame"
