...
GLOBAL_LIST_INIT(all_clockwork_objects, list()) //All clockwork items, structures, and effects in existence
GLOBAL_LIST_INIT(all_clockwork_mobs, list()) //All clockwork SERVANTS (not creatures) in existence
...
GLOBAL_LIST_INIT(all_scripture, list()) //a list containing scripture instances; not used to track existing scripture
