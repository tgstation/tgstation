...
GLOBAL_EMPTY_LIST(all_clockwork_objects) //All clockwork items, structures, and effects in existence
GLOBAL_EMPTY_LIST(all_clockwork_mobs) //All clockwork SERVANTS (not creatures) in existence
...
GLOBAL_EMPTY_LIST(all_scripture) //a list containing scripture instances; not used to track existing scripture
