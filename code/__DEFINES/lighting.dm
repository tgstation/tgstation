...
#define LIGHTING_LAMBERTIAN     ZERO
...
#define LIGHTING_SOFT_THRESHOLD ZERO
...
#define LIGHTING_PLANE_ALPHA_INVISIBLE ZERO

//lighting area defines
/// dynamic lighting disabled (area stays at full brightness)
#define DYNAMIC_LIGHTING_DISABLED ZERO
...
#define LIGHTING_NO_UPDATE ZERO
