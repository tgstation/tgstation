...
#define ATMOS_TANK_NITRYUM "nitryum=100000;TEMP=293.15"
...
#define ATMOS_GAS_MONITOR_INPUT_NITRYUM "nitryum_in"
#define ATMOS_GAS_MONITOR_OUTPUT_NITRYUM "nitryum_out"
#define ATMOS_GAS_MONITOR_SENSOR_NITRYUM "nitryum_sensor"
