...
#define MINIMUM_TEMPERATURE_DELTA_TO_SUSPEND		10		//Minimum temperature difference before group processing is suspended
#define MINIMUM_TEMPERATURE_DELTA_TO_CONSIDER		5		//Minimum temperature difference before the gas temperatures are just set to be equal
