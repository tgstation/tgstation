...
#define CANISTER_LEAK_PRESSURE					(150.*ONE_ATMOSPHERE)	//Tank starts leaking
#define CANISTER_RUPTURE_PRESSURE				(200.*ONE_ATMOSPHERE)	//Tank spills all contents into atmosphere
#define CANISTER_FRAGMENT_PRESSURE				(250.*ONE_ATMOSPHERE)	//Boom 3x3 base explosion
#define CANISTER_FRAGMENT_SCALE	    			(50.*ONE_ATMOSPHERE)	//+1 for each SCALE kPa aboe threshold
