...
//COLD FIRE
#define COLD_FIRE_MAXIMUM_TEMPERATURE_TO_SPREAD	173
#define COLD_FIRE_MAXIMUM_TEMPERATURE_TO_EXIST	223
#define COLD_FIRE_SPREAD_RADIOSITY_SCALE		0.95
#define COLD_FIRE_GROWTH_RATE					40000
#define FREON_MAXIMUM_BURN_TEMPERATURE			263
#define FREON_LOWER_TEMPERATURE					25
