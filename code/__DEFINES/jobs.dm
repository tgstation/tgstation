...
//Service
#define JOB_TELECOMMUNICATION_DISPATCHER "Telecommunication Dispatcher"
...
#define JOB_DISPLAY_ORDER_TELECOMMUNICATION_DISPATCHER 5
...
#define JOB_DISPLAY_ORDER_PSYCHOLOGIST 15
