...
#define FUSION_MOLE_THRESHOLD				5 	//Mole count required (tritium/plasma) to start a fusion reaction
...
#define MIN_HEAT_VARIATION -1e4
#define MAX_HEAT_VARIATION 1e4
