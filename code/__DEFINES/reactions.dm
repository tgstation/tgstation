...
// Water Vapor:
/// The temperature needed for water vapor to condense.
#define WATER_VAPOR_CONDENSATION_POINT (T20C + 10)
/// The temperature needed for water vapor to condense as ice instead of water.
...
/// The temperature needed to sterilize an additional mole of miasma in a reaction tick.
...
// BZ:
/// The maximum temperature BZ can form at... Deliberately set lower than the minimum burn temperature for most combustible gases in an try to prevent long fuse singlecaps.
...
/// The number of moles of hyper-noblium needed to prevent reactions.
#define REACTION_OPPRESSION_THRESHOLD 5
/// Minimum temperature needed for hypernoblium to prevent reactions.
...
/// The minimum temperature needed for halon to combust.
...
/// Amount of halon needed to be consumed in order to release resin... This is always possible as long as there's enough gas.
