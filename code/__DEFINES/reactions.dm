...
#define FUSION_ENERGY_TRESHOLD				3e9 	//Amount of energy it takes to start a fusion reaction
#define FUSION_MOLE_TRESHOLD				250 	//Mole count required (tritium/plasma) to start a fusion reaction
...
#define FUSION_TEMPERATURE_TRESHOLD	    10000
