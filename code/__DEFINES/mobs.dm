...
/// Determines the rate at which humans lose blood when they have the blood deficiency quirk. The default is BLOOD_REGEN_FACTOR + BLOOD_DEFICIENCY_DRAIN_MODIFIER.
#define BLOOD_DEFICIENCY_DRAIN_MODIFIER 0.025
