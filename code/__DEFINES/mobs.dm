...
/// Combination flag for the archvile revive.
#define HEAL_ARCHVILE (HEAL_BRUTE|HEAL_BURN|HEAL_TOX|HEAL_OXY|HEAL_STAM|HEAL_LIMBS|HEAL_WOUNDS|HEAL_BLOOD|HEAL_ORGANS|HEAL_TEMP|HEAL_STATUS|HEAL_CC_STATUS)
