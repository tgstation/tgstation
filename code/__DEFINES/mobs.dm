...
#define ETHEREAL_CHARGE_LOWPOWER 4e5
#define ETHEREAL_CHARGE_NORMAL 1e6
#define ETHEREAL_CHARGE_ALMOSTFULL 1.5e6
#define ETHEREAL_CHARGE_FULL 2e6
#define ETHEREAL_CHARGE_OVERLOAD 2.5e6
#define ETHEREAL_CHARGE_DANGEROUS 3e6
