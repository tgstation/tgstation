...
#define BLOOD_VOLUME_MAX_LETHAL (BLOOD_VOLUME_MAXIMUM * 1.075)
#define BLOOD_VOLUME_EXCESS (BLOOD_VOLUME_MAXIMUM * 1.05)
#define BLOOD_VOLUME_SLIME_SPLIT (BLOOD_VOLUME_MAXIMUM * 0.56)
