...
//breathing
#define CARBON_SAFE_OXY_MIN 16
#define CARBON_SAFE_CO2_MAX 10
#define CARBON_SAFE_TOX_MAX 0.05
#define CARBON_SA_PARA_MIN 1
#define CARBON_SA_SLEEP_MIN 5

#define ALIEN_TOX_DETECT 0.02

#define MIASMA_MINIMUM_PP 0.25
#define MIASMA_LOW_PP 5
#define MIASMA_MED_PP 20
#define MIASMA_HIGH_PP 30
