...
#define DOING_INTERACTION(user, interaction_key) (LAZYACCESS(user.do_afters, source))
#define DOING_INTERACTION_LIMIT(user, interaction_key, max_interaction_count) ((LAZYACCESS(user.do_afters, source) || 0) >= max_interaction_count)
