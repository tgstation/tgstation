...
#define SOUND_AREA_STANDARD_STATION SOUND_ENVIRONMENT_GENERIC
...
#define SOUND_AREA_SPACE SOUND_ENVIRONMENT_NONE
#define SOUND_AREA_LAVALAND SOUND_ENVIRONMENT_FOREST
