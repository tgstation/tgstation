...
#define STATUS_EFFECT_VANGUARD /datum/status_effect/vanguard_shield //Grants temporary paralyse absorption, but will paralyse the user based on how many paralyses they absorbed.
#define STATUS_EFFECT_INATHNEQS_ENDOWMENT /datum/status_effect/inathneqs_endowment //A 15-second invulnerability and paralyse absorption, granted by Inath-neq.
