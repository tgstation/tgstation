...
//FLAGS 2 SON OF FLAGS

#define SURGICAL_TOOL_2				(1<<0)		//Tool commonly used for surgery: won't attack targets in an active surgical operation on help intent (in case of mistakes)
