...
/// Inserts the signal type in the first argument of any signal handler proc. Useful for anything that has more complex signal usage.
#define DF_SIGNAL_VERBOSE (1<<3)
