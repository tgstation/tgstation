...
//tg coder movement speeds
// 125 fps
#define CLIENTSIDE_TICK_LAG_SILKY 0.08
// 10 fps, for when you want to travel back to 2012 /tg/station.
#define CLIENTSIDE_TICK_LAG_CLASSIC 1

///Broken down, here's what this does:
/// divides the world icon_size (32) by delay divided by the chosen ticklag from the 3 options to get the number of pixels something should be moving each tick.
