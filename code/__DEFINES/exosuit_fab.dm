...
#define EXOSUIT_MODULE_CLARKE (1<<1)
/// Module is compatible with a mech carrying an empty Concealed Weapon Bay
#define EXOSUIT_MODULE_CONCEALED_WEP_BAY (1<<2)
...
#define EXOSUIT_MODULE_RETICENCE (1<<8)
/// Module is compatible with Marauder models
#define EXOSUIT_MODULE_MARAUDER (1<<9)
/// Module is compatible with Paddy models
#define EXOSUIT_MODULE_PADDY (1<<10)
