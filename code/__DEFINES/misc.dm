...
#define APPEARENCE_IGNORE_TRANSFORM			RESET_TRANSFORM
#define APPEARENCE_IGNORE_COLOUR			RESET_COLOR
#define	APPEARENCE_IGNORE_CLIENT_COLOUR		NO_CLIENT_COLOR
#define APPEARENCE_IGNORE_COLOURING			RESET_COLOR|NO_CLIENT_COLOR
#define APPEARENCE_IGNORE_ALPHA				RESET_ALPHA
#define APPEARENCE_NORMAL_GLIDE				~LONG_GLIDE

// Enabling certain features
#define APPEARENCE_CONSIDER_TRANSFORM		~RESET_TRANSFORM
#define APPEARENCE_CONSIDER_COLOUR			~RESET_COLOUR
#define APPEARENCE_CONSIDER_CLIENT_COLOUR	~NO_CLIENT_COLOR
#define APPEARENCE_CONSIDER_COLOURING		~RESET_COLOR|~NO_CLIENT_COLOR
#define APPEARENCE_CONSIDER_ALPHA			~RESET_ALPHA
#define APPEARENCE_LONG_GLIDE				LONG_GLIDE

// Consider these images/atoms as part of the UI/HUD
#define APPEARENCE_UI_IGNORE_ALPHA			RESET_COLOR|RESET_TRANSFORM|NO_CLIENT_COLOR|RESET_ALPHA
#define APPEARENCE_UI						RESET_COLOR|RESET_TRANSFORM|NO_CLIENT_COLOR
