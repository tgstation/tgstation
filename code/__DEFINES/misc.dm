...
#define debug_world(msg) if (GLOB.Debug2) to_chat(world, list( \
	"type" = MESSAGE_TYPE_DEBUG, \
	"text" = "DEBUG: [msg]", \
))
#define debug_usr(msg) if (GLOB.Debug2&&usr) to_chat(usr, list( \
	"type" = MESSAGE_TYPE_DEBUG, \
	"text" = "DEBUG: [msg]", \
))
#define debug_admins(msg) if (GLOB.Debug2) to_chat(GLOB.admins, list( \
	"type" = MESSAGE_TYPE_DEBUG, \
	"text" = "DEBUG: [msg]", \
))
