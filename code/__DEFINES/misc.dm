...
// Maggots
#define MAGGOTS_INFESTATION_LEVEL_1 2.5 MINUTES
#define MAGGOTS_INFESTATION_LEVEL_2 5 MINUTES
#define MAGGOTS_INFESTATION_LEVEL_3 10 MINUTES
#define MAGGOTS_FLY_MINIMUM_CHANCE  5
#define MAGGOTS_FLY_MAXIMUM_CHANCE  60
