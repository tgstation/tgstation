...
#define BLOOD_AMOUNT_PER_DECAL      20 /// How much blood a regular blood splatter contains
#define BLOOD_ITEM_MAX              100 /// How much blood an item can have stuck on it
#define BLOOD_POOL_MAX              100 /// How much blood a blood decal can contain
