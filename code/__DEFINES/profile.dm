...
#define PROFILE_SET ;PROFILE_TIME = TICK_USAGE_REAL; PROFILE_LINE = __LINE__; PROFILE_FILE = __TG_FILE__; PROFILE_SLEEPCHECK = world.time;

#define PROFILE_TICK ;\
	if (PROFILE_STORE) {\
		var/PROFILE_TICK_USAGE_REAL = TICK_USAGE_REAL;\
		if (PROFILE_SLEEPCHECK == world.time) {\
			var/PROFILE_STRING = "[PROFILE_FILE]:[PROFILE_LINE] - [__TG_FILE__]:[__LINE__]";\
