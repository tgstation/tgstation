...
#define COMPONENT_DUPE_ALLOWED			(1<<0)	//duplicates allowed
#define COMPONENT_DUPE_UNIQUE			(1<<1)	//new component is deleted
#define COMPONENT_DUPE_UNIQUE_PASSARGS	(1<<2)	//old component is given the initialization args of the new
