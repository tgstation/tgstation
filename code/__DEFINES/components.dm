...
// /obj/structure/closet signals
#define COMSIG_CLOSET_STUFFED_INSIDE "obj_closet_stuffed_inside" //from obj/structure/closet/MouseDrop_T (/mob/living, mob/living, /obj/structure/closet/)
