...
#define COMSIG_PARENT_QDELETING "parent_qdeleted"				//after a datum's Destroy() is called: (force), at this point none of the other components chose to interrupt qdel and Destroy has been called
