...
#define COMSIG_BORG_SAFE_DECONSTRUCT "borg_safe_decon"			//sent from borg mobs to their contents to indicate upcoming destroy() due to safe decon (rather than detonation)
