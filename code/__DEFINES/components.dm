...
//Nanites
#define COMSIG_GET_NANITES	"get_nanites"						//() - returns nanite component.
#define COMSIG_NANITE_SET_VARS "nanite_set_vars"				//(_nanite_volume, _max_nanites, _safety_threshold, _cloud_id, _regen_rate)
