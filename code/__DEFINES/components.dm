...
#define COMSIG_ITEM_AFTER_PICKUP "item_after_pickup"			//from mob/put_in_hand(): (mob/user)
...
#define COMSIG_ITEM_HIT_REACT "item_hit_react"					//from base of obj/item/hit_reaction(): (list/args)
	#define COMPONENT_HIT_STOPPED 1
...
// /datum/component/personalshield signals
#define COMPONENT_RECHARGE_SHIELD "recharge_shield"
#define COMPONENT_SHIELD_TOGGLE_COLOR "shield_toggle_color"
