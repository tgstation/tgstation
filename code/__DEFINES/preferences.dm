...
//#define SOUND_PRAYERS (1<<9) - Deprecated in favor of requests system
...
#define SOUND_REQUESTS_NUKE (1<<24) // Nuke code request notifs
#define SOUND_REQUESTS_COMM (1<<25) // Centcom/syndicate request notifs
#define SOUND_REQUESTS_ALLPRAY (1<<26) // ALL prayer notifs

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|SOUND_ENDOFROUND|MEMBER_PUBLIC|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_SHIP_AMBIENCE|SOUND_REQUESTS_CHAPPRAY|SOUND_ANNOUNCEMENTS|SOUND_COMBATMODE)

// Request sound toggles
#define SOUND_REQUESTS_CHAPPRAY (1<<0) // Chaplain prayer notifs
#define SOUND_REQUESTS_NUKE (1<<1) // Nuke code request notifs
#define SOUND_REQUESTS_COMM (1<<2) // Centcom/syndicate request notifs
#define SOUND_REQUESTS_ALLPRAY (1<<3) // ALL prayer notifs

#define TOGGLES_REQUESTS_DEFAULT (SOUND_REQUESTS_CHAPPRAY)
