...
#define SOUND_ENDOFROUND		(1<<4)
#define MEMBER_PUBLIC			(1<<5)
#define INTENT_STYLE			(1<<6)
#define MIDROUND_ANTAG			(1<<7)
#define SOUND_INSTRUMENTS		(1<<8)
#define SOUND_SHIP_AMBIENCE		(1<<9)
#define SOUND_PRAYERS			(1<<10)
#define ANNOUNCE_LOGIN			(1<<11)
#define SOUND_ANNOUNCEMENTS		(1<<12)
#define DISABLE_DEATHRATTLE		(1<<13)
#define DISABLE_ARRIVALRATTLE	(1<<14)
#define COMBOHUD_LIGHTING		(1<<15)
