...
#define MONKEY_UNIFORM_FILE 'icons/mob/humanoid/monkey/uniform.dmi'

//DIGITIGRADE PATHS
///The dmi containing digitigrade uniforms
#define DIGITIGRADE_UNIFORM_FILE 'icons/mob/humanoid/misc/digitigrade.dmi'
///The dmi containing digitigrade shoes
#define DIGITIGRADE_SHOES_FILE 'icons/mob/humanoid/misc/digitigrade_shoes.dmi'
///The dmi containing digitigrade oversuits
#define DIGITIGRADE_SUIT_FILE 'icons/mob/humanoid/misc/digitigrade_suits.dmi'
