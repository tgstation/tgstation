...
#define CRUEL_IMPLEMENT (1<<13) //This object, when used for surgery, is causes a lot more pain for the patient, and are more efficient in a morbid users hands
