...
//#define DEPARTMENTAL_FLAG_MINING		(1<<6)			//I swear I'm actually going to use this eventually leave it here - it's 2020 and this is still here, epic kevinz moment
