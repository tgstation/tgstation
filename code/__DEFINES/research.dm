...
/// The maximum amount of cash you can get from ordnance experiments.
#define TECHWEB_BOMB_CASHCAP 50000
/// The range required to generate any cash from ordnance experiments.
#define TECHWEB_BOMB_MIN_RANGE (GLOB.MAX_EX_LIGHT_RANGE)
/// The range required to produce the maximum amount of cash from ordnance experiments.
