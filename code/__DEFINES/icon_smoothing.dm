...
#define SMOOTH_GROUP_HOLOBUBBLE S_OBJ(71) ///obj/structure/holobubble

#define MAX_S_OBJ SMOOTH_GROUP_HOLOBUBBLE //Always match this value with the one above it.
