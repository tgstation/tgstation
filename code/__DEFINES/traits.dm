...
/// Allows the mob to see visual effects for sound cues as if blind, if the source of the effect is not visible (e.g. behind a wall)
#define TRAIT_SEE_NOISES "see_noises"
