...
#define TRAIT_DEPRESSION_MINIMAL "depression_minimal"
#define TRAIT_DEPRESSION_MILD	"depression_mild"
#define TRAIT_DEPRESSION_MODERATE "depression_moderate"
#define TRAIT_DEPRESSION_SEVERE	"depression_severe"
