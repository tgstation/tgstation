...
/// Mob is currently disguised as something else (like a morph being another mob or an object). Should hold the source as the type of the thing we are disguised as.
