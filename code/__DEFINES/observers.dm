...
/// Determines if an in-chat minor_announcement will be made. Currently unused.
#define GHOST_NOTIFY_MAKE_ANNOUNCEMENT (1<<3)

/// The default set of flags to be passed into a notify_ghosts call.
#define NOTIFY_CATEGORY_DEFAULT (GHOST_NOTIFY_FLASH_WINDOW | GHOST_NOTIFY_IGNORE_MAPLOAD | GHOST_NOTIFY_NOTIFY_SUICIDERS | GHOST_NOTIFY_MAKE_ANNOUNCEMENT)
/// The default set of flags, without the flash_window flag.
#define NOTIFY_CATEGORY_NOFLASH (GHOST_NOTIFY_IGNORE_MAPLOAD | GHOST_NOTIFY_NOTIFY_SUICIDERS | GHOST_NOTIFY_MAKE_ANNOUNCEMENT)
