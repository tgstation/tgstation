...
#define REFILLABLE		4 | INJECTABLE	// Makes it possible to add reagents through any reagent container.
#define DRAINABLE		8 | DRAWABLE	// Makes it possible to remove reagents through any reagent container.
