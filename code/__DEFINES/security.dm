...
#define DETSCAN_DEFAULT_ORDER list(DETSCAN_CAT_FINGERS, DETSCAN_CAT_BLOOD, DETSCAN_CAT_FIBERS, DETSCAN_CAT_DRINK, DETSCAN_CAT_ACCESS, \
	DETSCAN_CAT_SET, DETSCAN_CAT_HOLY, DETSCAN_CAT_ILL, DETSCAN_CAT_SYN, DETSCAN_CAT_SET, \
	DETSCAN_CAT_ADD)

// the order departments show up in for the id scan (its sorted by red to blue on the color wheel)
#define DETSCAN_ACCESS_ORDER list(REGION_SECURITY, REGION_ENGINEERING, REGION_SUPPLY, REGION_GENERAL, REGION_MEDBAY, \
