...
#define IS_SOUND_FILE_SAFE(file) is_file_type_in_list(##file, SSsounds.safe_extensions)

#define IS_SOUND_FILE(file) is_file_type_in_list(##file, SSsounds.byond_sound_extensions)
