...
#define ZTRAIT_EARTH_RUINS "Earth Ruins"
...
#define ZTRAITS_STATION list(ZTRAIT_LINKAGE = CROSSLINKED,ZTRAIT_EARTH_RUINS = TRUE, ZTRAIT_STATION = TRUE, ZTRAIT_BASETURF = /turf/open/floor/plating/asteroid)
