...
#define BLOODSUCKER_FRENZY_OUT_TIME	120	// How long the vamp goes back into frenzy.
#define BLOODSUCKER_STARVE_VOLUME	10	// Amount of blood, below which a Vamp is at risk of frenzy.
