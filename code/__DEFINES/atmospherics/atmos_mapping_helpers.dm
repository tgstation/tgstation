...
/// space
#define AIRLESS_ATMOS TURF_TEMPERATURE(TCMB)
/// -93.15°C snow and ice turfs
#define FROZEN_ATMOS GAS_O2 + "=22;" + GAS_N2 + "=82;" + TURF_TEMPERATURE(FROZEN_ROOM_TEMP)
/// -14°C snow and ice turfs, a more breatheable coldroom atmos.
#define COLD_ATMOS GAS_O2 + "=22;" + GAS_N2 + "=82;" + TURF_TEMPERATURE(COLD_ROOM_TEMP)
/// -14°C kitchen coldroom, just might loss your tail; higher amount of mol to reach about 101.3 kpA
#define KITCHEN_COLDROOM_ATMOS GAS_O2 + "=26;" + GAS_N2 + "=97;" + TURF_TEMPERATURE(COLD_ROOM_TEMP)
/// used in the holodeck burn test program
#define BURNMIX_ATMOS GAS_O2 + "=2500;" + GAS_PLASMA + "=5000;" + TURF_TEMPERATURE(370)
///-153.15°C plasma air, used for burning people.
#define BURNING_COLD GAS_N2 + "=82;" + GAS_PLASMA + "=24;" + TURF_TEMPERATURE(120)
///Space temperature hyper nob
#define SPACE_TEMP_NOBLIUM GAS_HYPER_NOBLIUM + "=7500;" + TURF_TEMPERATURE(TCMB)

//ATMOSPHERICS DEPARTMENT GAS TANK TURFS
#define ATMOS_TANK_N2O GAS_N2O + "=6000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_CO2 GAS_CO2 + "=50000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_PLASMA GAS_PLASMA + "=70000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_O2 GAS_O2 + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_N2 GAS_N2 + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_BZ GAS_BZ + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_FREON GAS_FREON + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_HALON GAS_HALON + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_HEALIUM GAS_HEALIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_H2 GAS_HYDROGEN + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_HYPERNOBLIUM GAS_HYPER_NOBLIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_MIASMA GAS_MIASMA + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_NITRIUM GAS_NITRIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_PLUOXIUM GAS_PLUOXIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_PROTO_NITRATE GAS_PROTO_NITRATE + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_TRITIUM GAS_TRITIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_H2O GAS_WATER_VAPOR + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_ZAUKER GAS_ZAUKER + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_HELIUM GAS_HELIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_ANTINOBLIUM GAS_ANTINOBLIUM + "=100000;" + TURF_TEMPERATURE(T20C)
#define ATMOS_TANK_AIRMIX GAS_O2 + "=2644;" + GAS_N2 + "=10580;" + TURF_TEMPERATURE(T20C)
