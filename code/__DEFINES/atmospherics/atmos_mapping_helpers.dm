...
#define OPENTURF_DEFAULT_ATMOS "[GAS_O2]=22;[GAS_N2]=82;TEMP=[T20C]"
#define OPENTURF_LOW_PRESSURE "[GAS_O2]=14;[GAS_N2]=30;TEMP=[T20C]"
/// -193,15°C telecommunications. also used for xenobiology slime killrooms
#define TCOMMS_ATMOS "[GAS_N2]=100;TEMP=80"
/// space
#define AIRLESS_ATMOS "TEMP=[TCMB]"
/// -93.15°C snow and ice turfs
#define FROZEN_ATMOS "[GAS_O2]=22;[GAS_N2]=82;TEMP=[FROZEN_ROOM_TEMP]"
/// -14°C snow and ice turfs, a more breatheable coldroom atmos.
#define COLD_ATMOS "[GAS_O2]=22;[GAS_N2]=82;TEMP=[COLD_ROOM_TEMP]"
/// -14°C kitchen coldroom, just might loss your tail; higher amount of mol to reach about 101.3 kpA
#define KITCHEN_COLDROOM_ATMOS "[GAS_O2]=26;[GAS_N2]=97;TEMP=[COLD_ROOM_TEMP]"
...
#define SPACE_TEMP_NOBLIUM "[GAS_HYPER_NOBLIUM]=7500;TEMP=[TCMB]"

//ATMOSPHERICS DEPARTMENT GAS TANK TURFS
#define ATMOS_TANK_N2O "[GAS_N2O]=6000;TEMP=[T20C]"
#define ATMOS_TANK_CO2 "[GAS_CO2]=50000;TEMP=[T20C]"
#define ATMOS_TANK_PLASMA "[GAS_PLASMA]=70000;TEMP=[T20C]"
#define ATMOS_TANK_O2 "[GAS_O2]=100000;TEMP=[T20C]"
#define ATMOS_TANK_N2 "[GAS_N2]=100000;TEMP=[T20C]"
#define ATMOS_TANK_BZ "[GAS_BZ]=100000;TEMP=[T20C]"
#define ATMOS_TANK_FREON "[GAS_FREON]=100000;TEMP=[T20C]"
#define ATMOS_TANK_HALON "[GAS_HALON]=100000;TEMP=[T20C]"
#define ATMOS_TANK_HEALIUM "[GAS_HEALIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_H2 "[GAS_HYDROGEN]=100000;TEMP=[T20C]"
#define ATMOS_TANK_HYPERNOBLIUM "[GAS_HYPER_NOBLIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_MIASMA "[GAS_MIASMA]=100000;TEMP=[T20C]"
#define ATMOS_TANK_NITRIUM "[GAS_NITRIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_PLUOXIUM "[GAS_PLUOXIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_PROTO_NITRATE "[GAS_PROTO_NITRATE]=100000;TEMP=[T20C]"
#define ATMOS_TANK_TRITIUM "[GAS_TRITIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_H2O "[GAS_WATER_VAPOR]=100000;TEMP=[T20C]"
#define ATMOS_TANK_ZAUKER "[GAS_ZAUKER]=100000;TEMP=[T20C]"
#define ATMOS_TANK_HELIUM "[GAS_HELIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_ANTINOBLIUM "[GAS_ANTINOBLIUM]=100000;TEMP=[T20C]"
#define ATMOS_TANK_AIRMIX "[GAS_O2]=2644;[GAS_N2]=10580;TEMP=[T20C]"
