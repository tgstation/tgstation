...
///Allows for ventcrawling to occur. All atmospheric machines have this flag on by default.
...
///Used to check if a machinery is visible. Called by update_pipe_vision().
