...
#define HAS_SILICON_ACCESS(possible_silicon) (isAdminGhostAI(possible_silicon) || HAS_TRAIT(possible_silicon, SILICON_ACCESS_TRAIT))
///This is used to see if you have the access of an AI. This doesn't mean you are an AI, just have the same access as one.
#define HAS_AI_ACCESS(possible_ai) (isAdminGhostAI(possible_ai) || HAS_TRAIT(possible_ai, AI_ACCESS_TRAIT))
