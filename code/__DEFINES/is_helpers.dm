...
#define is_area_virtual(checked_area) (length(GLOB.virtual_areas) && (ispath(checked_area) ? GLOB.virtual_areas[checked_area] : GLOB.virtual_areas[checked_area.type]))
