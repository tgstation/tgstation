...
/// Hypermatter state
#define HYPERMATTER_PARTICLE_BASE_POWER 1000

#define HYPERMATTER_LIGHT_COLOUR "#53a9ff"
#define HYPERMATTER_LIGHT_RANGE 5
#define HYPERMATTER_LIGHT_POWER 2

#define HYPERMATTER_FILTER_SIZE 75
#define HYPERMATTER_FILTER_FACTOR 7
#define HYPERMATTER_FILTER_DENSITY 65
