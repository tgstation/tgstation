...
#define ANTINOBLIUM_TRANSMIT_MODIFIER 30
...
#define ANTINOBLIUM_HEAT_RESISTANCE 5 //Its very low specific heat and the nature of giving SM high power heats it up very easily.
