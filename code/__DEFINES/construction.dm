...
///The amount of materials you get from a rod. Used in average object quantities.
#define ROD_MATERIAL_AMOUNT 1000
///The amount of materials used in the smallest of objects, like pens and screwdrivers.
#define SMALL_MATERIAL_AMOUNT 100
