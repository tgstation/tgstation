...
/world/Reboot(var/reason, var/feedback_c, var/feedback_r, var/time)
	...
	spawn(0)
		if(ticker && ticker.round_end_sound)
			...
			world << sound(pick('sound/AI/newroundsexy.ogg','sound/misc/apcdestroyed.ogg','sound/misc/bangindonk.ogg','sound/misc/leavingtg.ogg','goon/sound/newround1.ogg','goon/sound/newround2.ogg')) // random end sounds!! - LastyBatsy
	for(var/client/C in clients)
