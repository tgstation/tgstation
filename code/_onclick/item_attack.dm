...
/obj/item/proc/melee_attack_chain(mob/user, atom/target, params)
	...
	if(target.attackby(src,user, params))
		return
	if(QDELETED(src))
		// stack_trace("An item got deleted while performing an item attack and did not stop melee_attack_chain.")  // FULP: Jesus christ SHUT THE FUCK UP.
		return
	if(QDELETED(target))
		// stack_trace("The target of an item attack got deleted and melee_attack_chain was not stopped.")  // FULP: SAME THING SHUT UP.
		return
