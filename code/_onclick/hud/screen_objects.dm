		...
		if(!C.stat && !C.stunned && !C.paralysis && !C.restrained())
			if(C.internal)
				...
				if(!istype(C.wear_mask, /obj/item/clothing/mask))
					...
					if(!C.internal && istype(C.back, /obj/item/weapon/tank/large))
