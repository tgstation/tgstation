...
/atom/movable/screen/plane_master/proc/add_relay_to(target_plane)
	...
	generate_relay_to(target_plane, show_to = home.our_hud.mymob.client)

/atom/movable/screen/plane_master/proc/generate_relay_to(target_plane, relay_loc, client/show_to)
