...
/obj/screen/alert/not_enough_plas
	name = "Choking (No Plasma)"
	desc = "You're not getting enough plasma. Find some good air before you pass out!"
	icon_state = "not_enough_plas"

/obj/screen/alert/too_much_plas
	name = "Choking (Plasma)"
...
/obj/screen/alert/lowcell/ethereal
...
/obj/screen/alert/emptycell/ethereal
...
/obj/screen/alert/buckled/Click()
	. = ..()
	if(!.)
		return
