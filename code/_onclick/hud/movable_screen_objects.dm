...
ADMIN_VERB(test_movable_ui, "Spawn Movable UI Object", "", R_DEBUG, VERB_CATEGORY_DEBUG)
...
ADMIN_VERB(test_snap_ui, "Spawn Snap UI Object", "", R_DEBUG, VERB_CATEGORY_DEBUG)
