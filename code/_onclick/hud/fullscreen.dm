...
/obj/screen/fullscreen/see_through_darkness/night_vision //the icon for this is a good bit larger, but all it does in-game is remove the corner darkness by default
