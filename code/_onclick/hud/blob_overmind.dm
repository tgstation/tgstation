...
/obj/screen/blob/Blobbernaut
	...
	desc = "Produces a strong, smart blobbernaut from a factory blob for 40 points.<br>The factory blob used will become fragile and briefly unable to produce spores."
