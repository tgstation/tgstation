/datum/bt_node/subtree/simple_fearful_combat
	behavior_nodes = list(\
		...
		"__c" = list(\
			...
			list("__t" = /datum/bt_node/ai_behavior/update_targets/nearest, "default_behavior_args" = list(BB_BASIC_MOB_CURRENT_TARGET, BB_TARGETING_STRATEGY, BB_BASIC_MOB_CURRENT_TARGET_HIDING_LOCATION))\
		)\
	)
