											...
											list(\
												...
												"__c" = list(\
													list(\
														"__t" = /datum/bt_node/composite/selector,\
														"__c" = list(\
															list("__t" = /datum/bt_node/ai_behavior/targeted_mob_ability, "default_behavior_args" = list(BB_RAPIDSEEDS_ABILITY, BB_BASIC_MOB_CURRENT_TARGET)),\
															list("__t" = /datum/bt_node/ai_behavior/targeted_mob_ability, "default_behavior_args" = list(BB_SOLARBEAM_ABILITY, BB_BASIC_MOB_CURRENT_TARGET)),\
