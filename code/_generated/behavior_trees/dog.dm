					...
					list(\
						...
						"__c" = list(\
							list(\
								...
								"__c" = list(\
									list("__t" = /datum/bt_node/ai_behavior/basic_melee_attack/dog, "default_behavior_args" = list(BB_CURRENT_PET_TARGET, BB_PET_TARGETING_STRATEGY, BB_PET_ATTACK_HIDING_LOCATION))\
								)\
							),\
