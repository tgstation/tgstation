											...
											list(\
												...
												"__c" = list(\
													list(\
														"__t" = /datum/bt_node/composite/selector,\
														"__c" = list(\
															list("__t" = /datum/bt_node/ai_behavior/targeted_mob_ability, "default_behavior_args" = list(BB_LEAPER_BUBBLE, BB_BASIC_MOB_CURRENT_TARGET)),\
															list("__t" = /datum/bt_node/ai_behavior/targeted_mob_ability, "default_behavior_args" = list(BB_LEAPER_FLOP, BB_BASIC_MOB_CURRENT_TARGET)),\
															list("__t" = /datum/bt_node/ai_behavior/targeted_mob_ability, "default_behavior_args" = list(BB_LEAPER_VOLLEY, BB_BASIC_MOB_CURRENT_TARGET)),\
															list("__t" = /datum/bt_node/ai_behavior/targeted_mob_ability, "default_behavior_args" = list(BB_LEAPER_SUMMON, BB_BASIC_MOB_CURRENT_TARGET)),\
