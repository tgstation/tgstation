	...
	behavior_nodes = list(\
		...
		"__c" = list(\
			...
			list(\
				...
				"__c" = list(\
					list("__t" = /datum/bt_node/ai_behavior/call_reinforcements/mining, "default_behavior_args" = list())\
				),\
				"cooldown_key" = BB_BASIC_MOB_REINFORCEMENTS_COOLDOWN,\
				"cooldown_duration" = "1 SECONDS",\
				"lock_on_succeed" = TRUE\
			),\
			list(\
