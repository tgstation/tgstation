...
/obj/effect/bmode/buildhelp
	...
	Click()
		switch(master.cl.buildmode)
			...
			if(4)
				usr << "<span class='notice'>***********************************************************</span>"
				usr << "<span class='notice'>Left Mouse Button on turf/obj/mob      = Throw</span>"
				usr << "<span class='notice'>Right Mouse Button on turf/obj/mob     = Select</span>"
				usr << "<span class='notice'>***********************************************************</span>"
		return 1
		...
		if(3)
			if(pa.Find("left")) //I cant believe this shit actually compiles.
				if(object.vars.Find(holder.buildmode.varholder))
					...
					usr << "<span class='danger'>[initial(object.name)] does not have a var called '[holder.buildmode.varholder]'</span>"
			if(pa.Find("right"))
				if(object.vars.Find(holder.buildmode.varholder))
					log_admin("[key_name(usr)] modified [object.name]'s [holder.buildmode.varholder] to [holder.buildmode.valueholder]")
