...
/mob/living/simple_animal/sculpture/proc/GrabMob(var/mob/living/target)
	if(target && target != src && ishuman(target))
		...
		//Figure out how to "pick sounds" before uncommenting
		//playsound(loc, 'sound/scp/firstpersonsnap.ogg', 50, 1, -1)
		//playsound(loc, 'sound/scp/firstpersonsnap2.ogg', 50, 1, -1)
		playsound(loc, 'sound/scp/firstpersonsnap3.ogg', 100, 1, -1)
		...
		if(G)
			...
			if(target)
				...
				if(in_darkness)
					...
					playsound(loc, 'sound/scp/scare1.ogg', 50, 1, -1)
					//Figure out how to "pick sounds" before uncommenting
					//playsound(loc, 'sound/scp/scare2.ogg', 50, 1, -1)
					//playsound(loc, 'sound/scp/scare3.ogg', 50, 1, -1)
					//playsound(loc, 'sound/scp/scare4.ogg', 50, 1, -1)
				else
