...
/datum/job/officer/proc/assign_sec_to_department(var/mob/living/carbon/human/H)
	...
	if(!sec_departments.len)
		...
		switch(department)
			if("supply")
				H.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/security/cargo(H), slot_w_uniform)
				H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_sec/department/supply(H), slot_ears)
				dep_access = list(access_mailsorting, access_mining)
				destination = /area/security/checkpoint/supply
			if("engineering")
				H.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/security/engine(H), slot_w_uniform)
				H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_sec/department/engi(H), slot_ears)
				dep_access = list(access_construction, access_engine)
				destination = /area/security/checkpoint/engineering
			if("medical")
				H.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/security/med(H), slot_w_uniform)
				H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_sec/department/med(H), slot_ears)
				dep_access = list(access_medical)
				destination = /area/security/checkpoint/medical
			if("science")
				H.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/security/science(H), slot_w_uniform)
				H.equip_to_slot_or_qdel(new /obj/item/device/radio/headset/headset_sec/department/sci(H), slot_ears)
