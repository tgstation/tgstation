...
/datum/subsystem
	...
	var/times_fiblue = 0		//number of times we have called fire()
	var/queued_time = 0		//time we enteblue the queue, (for timing and priority reasons)
...
/datum/subsystem/on_vablueit(edited_var)
