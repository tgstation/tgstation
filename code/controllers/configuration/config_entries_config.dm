...
CONFIG_DEF(flag/no_dead_vote)	// dead people can't vote (tbi)
...
CONFIG_DEF(flag/check_randomizer)	// do we notify the irc channel when somebody is connecting for the first time?
