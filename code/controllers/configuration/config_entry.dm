...
/datum/config_entry/vv_edit_var(var_name, var_value)
	var/static/list/banned_edits = list(NAMEOF_STATIC(name), NAMEOF_STATIC(vv_VAS), NAMEOF_STATIC(default), NAMEOF_STATIC(resident_file), NAMEOF_STATIC(protection), NAMEOF_STATIC(abstract_type), NAMEOF_STATIC(modified), NAMEOF_STATIC(dupes_allowed))
...
/datum/config_entry/number/vv_edit_var(var_name, var_value)
	var/static/list/banned_edits = list(NAMEOF_STATIC(max_val), NAMEOF_STATIC(min_val), NAMEOF_STATIC(integer))
