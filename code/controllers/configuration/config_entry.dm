...
/datum/config_entry/vv_edit_var(var_name, var_value)
	var/static/list/banned_edits = STATIC_INIT(list(NAMEOF_STATIC(src, name), NAMEOF_STATIC(src, vv_VAS), NAMEOF_STATIC(src, default), NAMEOF_STATIC(src, resident_file), NAMEOF_STATIC(src, protection), NAMEOF_STATIC(src, abstract_type), NAMEOF_STATIC(src, modified), NAMEOF_STATIC(src, dupes_allowed)))
...
/datum/config_entry/number/vv_edit_var(var_name, var_value)
	var/static/list/banned_edits = STATIC_INIT(list(NAMEOF_STATIC(src, max_val), NAMEOF_STATIC(src, min_val), NAMEOF_STATIC(src, integer)))
