...
/datum/controller/master/proc/Setup(zlevel)
	...
	// deep space ruins
	seedRuins(7, rand(1,2), /area/space, space_ruins_templates)
	seedRuins(8, rand(1,2), /area/space, space_ruins_templates)
	seedRuins(9, rand(1,2), /area/space, space_ruins_templates)
