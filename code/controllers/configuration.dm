...
/datum/configuration
	...
	var/roundstart_role_uplink_items = 0 //Whether or not traitors can only order uplink items that coincide with their roundstart job rather than their current one.
