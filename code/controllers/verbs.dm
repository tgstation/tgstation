...
/client/proc/debug_controller(controller in list("Air", "Cameras", "Configuration", "Emergency Shuttle", "failsafe", "garbage", "Jobs", "lighting", "master", "pAI", "Radio", "Sun", "Supply Shuttle", "Ticker"))
	set category = "Debug"
