...
/datum/subsystem/ticker/New()
	...
	login_music = pickweight(list('sound/ambience/title2.ogg' = 14, 'sound/ambience/title1.ogg' =14, 'sound/ambience/title3.ogg' =14, 'sound/ambience/title4.ogg' =14, 'sound/misc/i_did_not_grief_them.ogg' = 14, 'sound/misc/lobby_pictureperfect.ogg' = 14, 'sound/ambience/clown.ogg' = 14)) // choose title music!
