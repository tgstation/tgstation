...
/datum/subsystem/ticker/proc/send_news_report()
	...
	switch(news_report)
		...
		if(SHUTTLE_HIJACK)
			news_message = "During routine evacuation procedures, the emergency shuttle of [station_name()] had its navigation protocols corrupted, and was hijakced to an unknown location."
