...
/datum/subsystem/ticker/Initialize(timeofday)
    var/list/music = list('sound/ambience/title1.ogg','sound/ambience/title3.ogg','sound/ambience/title4.ogg','sound/misc/i_did_not_grief_them.ogg','sound/ambience/miles.ogg','sound/ambience/viklund.ogg','sound/ambience/fingerspit.ogg')//file2list(ROU
ND_START_MUSIC_LIST, "\n")
