...
SUBSYSTEM_DEF(points_of_interest)
	...
	/// Special helper to track any Nar'sies.
	var/list/obj/narsie/narsies = null
 ...
 */
/datum/controller/subsystem/points_of_interest/proc/get_mob_pois(datum/callback/poi_validation_override = null)
	var/list/pois = list()
