...
/datum/controller/subsystem/mapping/proc/LoadGroup(list/errorList, name, path, files, list/traits, list/default_traits, silent = FALSE, orientation)
	. = list()
...
/datum/controller/subsystem/mapping/proc/loadWorld()
	...
	LoadGroup(FailedZs, "Station", config.map_path, config.map_file, config.traits, ZTRAITS_STATION, orientation = config.orientation)
