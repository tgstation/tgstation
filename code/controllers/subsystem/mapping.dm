...
/datum/controller/subsystem/mapping/proc/preloadRuinTemplates()
	...
	var/list/banned = generateMapList("[GLOB.config_dir]/lavaruinblacklist.txt")
	banned += generateMapList("[GLOB.config_dir]/spaceruinblacklist.txt")
...
/datum/controller/subsystem/mapping/proc/preloadShuttleTemplates()
	var/list/unbuyable = generateMapList("[GLOB.config_dir]/unbuyableshuttles.txt")
