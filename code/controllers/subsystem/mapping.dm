...
/datum/controller/subsystem/mapping/proc/setup_ruins()
	...
	if (ocean_ruins.len)
		seedRuins(ocean_ruins, CONFIG_GET(number/icemoon_budget), list(/area/rainworld/surface/outdoors/unexplored), themed_ruins[ZTRAIT_OCEAN_RUINS], clear_below = TRUE, mineral_budget = 15, mineral_budget_update = OREGEN_PRESET_LAVALAND, ruins_type = ZTRAIT_OCEAN_RUINS)
