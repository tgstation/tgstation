...
/datum/controller/subsystem/pai/proc/recruitWindow(mob/M)
	...
	dat += "<table>"
	dat += "<tr class=\"d0\"><td>Name:</td><td>[russian_text2html(candidate.name)]</td></tr>"
	...
	dat += "<tr class=\"d0\"><td>Description:</td><td>[russian_text2html(candidate.description)]</td></tr>"
	...
	dat += "<tr class=\"d0\"><td>Preferred Role:</td><td>[russian_text2html(candidate.role)]</td></tr>"
	...
	dat += "<tr class=\"d0\"><td>OOC Comments:</td><td>[russian_text2html(candidate.comments)]</td></tr>"
...
/datum/controller/subsystem/pai/proc/findPAI(obj/item/device/paicard/p, mob/user)
	...
	for(var/datum/paiCandidate/c in available)
		dat += "<tr class=\"d0\"><td>Name:</td><td>[russian_text2html(c.name)]</td></tr>"
		dat += "<tr class=\"d1\"><td>Description:</td><td>[russian_text2html(c.description)]</td></tr>"
		dat += "<tr class=\"d0\"><td>Preferred Role:</td><td>[russian_text2html(c.role)]</td></tr>"
		dat += "<tr class=\"d1\"><td>OOC Comments:</td><td>[russian_text2html(c.comments)]</td></tr>"
