...
TIMER_SUBSYSTEM_DEF(ai_behavior)
...
/datum/controller/subsystem/timer/ai_behavior/Initialize()
	SetupAIBehaviors()
	return SS_INIT_SUCCESS

/datum/controller/subsystem/timer/ai_behavior/proc/SetupAIBehaviors()
	ai_behaviors = list()
