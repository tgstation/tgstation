...
SUBSYSTEM_DEF(materials)
	...
	var/list/base_stack_recipes = list(
		new /datum/stack_recipe("Chair", /obj/structure/chair/grayscale, one_per_turf = TRUE, on_floor = TRUE, applies_mats = TRUE),
		new /datum/stack_recipe("Toilet", /obj/structure/toilet/grayscale, one_per_turf = TRUE, on_floor = TRUE, applies_mats = TRUE),
