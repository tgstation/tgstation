...
/obj/machinery/light_switch/get_save_vars(save_flags=ALL)
	. = ..()
	. -= NAMEOF(src, name)
	return .

/obj/machinery/requests_console/get_save_vars(save_flags=ALL)
	. = ..()
	. -= NAMEOF(src, name)
	return .

/obj/machinery/airalarm/get_save_vars(save_flags=ALL)
	. = ..()
	. -= NAMEOF(src, name)
	return .

/obj/item/vending_refill/get_save_vars(save_flags=ALL)
	. = ..()
	. -= NAMEOF(src, name)
	return .
