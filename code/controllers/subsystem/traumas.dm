SUBSYSTEM_DEF(traumas)
	...
	var/list/phobia_types = list("spiders", "space", "security", "clowns", "greytide", "lizards", "skeletons")
	var/list/phobia_words = list("spiders"  = list("spider","web","arachnid"),
	...
	var/list/phobia_mobs = list("spiders"  = typecacheof(/mob/living/simple_animal/hostile/poison/giant_spider),
								"security" = typecacheof(/mob/living/simple_animal/bot/secbot),
								"lizards"  = typecacheof(/mob/living/simple_animal/hostile/lizard)
								)

	var/list/phobia_objs = list("spiders"   = typecacheof(/obj/structure/spider),
	...
	var/list/phobia_turfs = list("space" = typecacheof(/turf/open/space, /turf/open/floor/holofloor/space, /turf/open/floor/fakespace))

	var/list/phobia_species = list("lizards"   = typecacheof(/datum/species/lizard),
