...
/datum/controller/subsystem/garbage/proc/HardDelete(datum/D)
	...
	if (time > 10)
		log_world("Error: [type]([refID]) took longer than 1 second to delete (took [time/10] seconds to delete)")
		message_admins2("Error: [type]([refID]) took longer than 1 second to delete (took [time/10] seconds to delete).")
		postpone(time)
