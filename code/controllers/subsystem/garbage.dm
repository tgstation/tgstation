...
SUBSYSTEM_DEF(garbage)
	...
	var/list/collection_timeout = list(GARBAGE_QUEUE_FIRST_LEVEL_TIMEOUT, 10 SECONDS) // deciseconds to wait before moving something up in the queue to the next level
