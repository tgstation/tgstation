...
/datum/controller/subsystem/shuttle/proc/requestEvac(mob/user, call_reason)
	...
	deadchat_broadcast("<span class='name'>[user.real_name]</span>", " has called the shuttle at <span class='name'>[A.name]</span>.", user)
	if(call_reason)
...
/datum/controller/subsystem/shuttle/proc/cancelEvac(mob/user)
	if(canRecall())
		...
		deadchat_broadcast("<span class='name'>[user.real_name]</span>", " has recalled the shuttle from <span class='name'>[get_area_name(user, TRUE)]</span>.", user)
		return 1
