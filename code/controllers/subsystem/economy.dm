...
/datum/controller/subsystem/economy/proc/exp_payout()
	var/exp_cash = 1000
	var/datum/bank_account/D = get_dep_account(ACCOUNT_EXP)
	if(D)
		D.adjust_money(exp_cash)
