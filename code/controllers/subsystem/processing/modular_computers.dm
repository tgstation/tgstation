PROCESSING_SUBSYSTEM_DEF(modular_computers)
	name = "Modular Computers"

	wait = 1 SECONDS // we prefer good processing times on apps
	runlevels = RUNLEVEL_GAME | RUNLEVEL_POSTGAME
	stat_tag = "NTOS" // not MC, thats way too dank
...
/datum/controller/subsystem/processing/modular_computers/Initialize()
	build_software_lists()
	initialized = TRUE
	return SS_INIT_SUCCESS

///Finds all downloadable programs and adds them to their respective downloadable list.
/datum/controller/subsystem/processing/modular_computers/proc/build_software_lists()
...
/datum/controller/subsystem/processing/modular_computers/proc/check_relay_operation()
...
/datum/controller/subsystem/processing/modular_computers/proc/toggle_function(function)
	if(!function)
		return
...
/datum/controller/subsystem/processing/modular_computers/proc/check_function(specific_action = NONE)
...
/datum/controller/subsystem/processing/modular_computers/proc/find_ntnet_file_by_name(filename)
...
/datum/controller/subsystem/processing/modular_computers/proc/get_chat_channel_by_id(id)
