...
/datum/move_loop
	...
	///Mostly comes up in high performance scenarios where we care about things being singletons
	...
	///Used primarily as a hint to be reasoned about by our [controller], and as the id of our bucket
...
///Pause our loop until restarted with resume_loop()
