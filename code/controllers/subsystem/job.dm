SUBSYSTEM_DEF(job)
	...
	## Lastly there's Human Authority Whitelist Setting. If set to 0, you'll set it to \"Human Only\". If set to 1, it'll be set to \"Allow Non-Humans\". Check the \"Human Authority\" setting on the game_options to know which you should choose. Know that this entry only appears on jobs that are marked as heads of staff.\n\n\
