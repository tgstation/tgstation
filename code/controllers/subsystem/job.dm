...
/datum/controller/subsystem/job/proc/EquipRank(mob/M, rank, joined_late = FALSE)
	...
	if(!joined_late)
		...
		if(!S && !dont_go_to_latejoin) //if there isn't a spawnpoint send them to latejoin, if there's no latejoin go yell at your mapper
