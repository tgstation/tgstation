...
/datum/controller/subsystem/parallax/PreInit()
	...
	if(prob(100))	//70% chance to pick a special extra layer
		random_layer = /atom/movable/screen/parallax_layer/planet/gas //pick(/atom/movable/screen/parallax_layer/random/space_gas, /atom/movable/screen/parallax_layer/random/asteroids)
