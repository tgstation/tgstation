...
/datum/controller/subsystem/tgui/PreInit()
	...
	basehtml = replacetextEx(basehtml, "<!-- tgui:nt-copyright -->", "Nanotrasen (c) 2525-[CURRENT_STATION_YEAR]") // This can't use the GLOB as it runs before those are populated
