...
/datum/controller/subsystem/tgui/PreInit()
	...
	basehtml = replacetextEx(basehtml, "<!-- tgui:nt-copyright -->", "Nanotrasen (c) 2525-[UTC_YEAR + STATION_YEAR_OFFSET]") // This can't use the GLOB as it runs before those are populated
