...
/datum/controller/subsystem/lighting/fire(resumed, init_tick_checks)
	var/real_tick_limit
	if(!init_tick_checks)
		real_tick_limit = SLOTH.CURRENT_TICKLIMIT
		SLOTH.CURRENT_TICKLIMIT = ((real_tick_limit - world.tick_usage) / 3) + world.tick_usage
	var/i = 0
	...
	if(!init_tick_checks)
		SLOTH.CURRENT_TICKLIMIT = ((real_tick_limit - world.tick_usage)/2)+world.tick_usage
	...
	if(!init_tick_checks)
		SLOTH.CURRENT_TICKLIMIT = real_tick_limit
