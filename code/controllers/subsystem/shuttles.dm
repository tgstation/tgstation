...
/datum/subsystem/shuttle/proc/color_space()
	...
	//to_chat(//world.log, "[transit_turfs.len] transit turfs registered")
...
/*
to_chat(world, "The attempted transit dock will be [transit_width] width, and [transit_height] in height. The travel dir is [travel_dir].")
*/
