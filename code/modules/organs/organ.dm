/datum/organ
	...
	proc/CanInsert(var/mob/living/carbon/human/H, var/mob/surgeon=null, var/quiet=0)
		return 1
	proc/Insert(var/mob/living/carbon/human/H, var/mob/surgeon=null)
		return 1
	proc/CanRemove(var/mob/living/carbon/human/H, var/mob/surgeon=null, var/quiet=0)
		return 1
	proc/Remove(var/mob/living/carbon/human/H, var/mob/surgeon=null)
		return 1
