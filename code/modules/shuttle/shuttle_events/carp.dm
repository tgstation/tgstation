...
/datum/shuttle_event/simple_spawner/carp/friendly
	...
	/// Chance we hit the shuttle, instead of flying past it (most carp will go through anyway. We dont want this to be too annoying to take away from the majesty)
