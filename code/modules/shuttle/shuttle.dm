...
/obj/docking_port/mobile/proc/hyperspace_sound(phase, list/areas)
	...
	for(var/mob/zlevel_mobs as anything in SSmobs.clients_by_zlevel[z])
		...
		if(dist_far <= long_range && dist_far > range)
			playsound(distant_source, "sound/runtime/hyperspace/[selected_sound]_distance.ogg").volume(100).direct_listeners(zlevel_mobs).play()
			...
			playsound(source, "sound/runtime/hyperspace/[selected_sound].ogg").volume(100).direct_listeners(zlevel_mobs).play()
