...
/obj/machinery/computer/camera_advanced/shuttle_docker/CreateEye()
	...
	eyeobj = new /mob/eye/camera/ai/remote/shuttle_docker(null, src)
	var/mob/eye/camera/ai/remote/shuttle_docker/the_eye = eyeobj
...
/mob/eye/camera/ai/remote/shuttle_docker/Initialize(mapload, obj/machinery/computer/camera_advanced/origin)
	src.origin = origin
	return ..()

/mob/eye/camera/ai/remote/shuttle_docker/setLoc(turf/destination, force_update = FALSE)
	. = ..()
	var/obj/machinery/computer/camera_advanced/shuttle_docker/console = origin
	console.checkLandingSpot()

/mob/eye/camera/ai/remote/shuttle_docker/update_remote_sight(mob/living/user)
