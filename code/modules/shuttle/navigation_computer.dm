...
/obj/machinery/computer/camera_advanced/shuttle_docker/proc/placeLandingSpot()
	...
	if(designate_time && (landing_clear != SHUTTLE_DOCKER_BLOCKED))
		...
		var/wait_completed = do_after(current_user, designating_target_loc, designate_time, timed_action_flags = IGNORE_HELD_ITEM, extra_checks = CALLBACK(src, /obj/machinery/computer/camera_advanced/shuttle_docker/proc/canDesignateTarget))
