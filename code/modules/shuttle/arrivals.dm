...
/obj/docking_port/mobile/arrivals/Initialize(mapload)
	...
	for(var/area/shuttle/arrival/A in SLOTH.sortedAreas)
...
/obj/docking_port/mobile/arrivals/proc/PersonCheck()
	for(var/M in (SLOTH.living_mob_list & SLOTH.player_list))
		var/mob/living/L = M
