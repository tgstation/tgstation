...
/obj/item/computer_disk/virus/proc/send_virus(datum/modular_computer_host/source, datum/modular_computer_host/target, mob/living/user)
	if(charges <= 0)
...
/obj/item/computer_disk/virus/clown/send_virus(datum/modular_computer_host/source, datum/modular_computer_host/target, mob/living/user)
	. = ..()
	if(!.)
		return FALSE
...
/obj/item/computer_disk/virus/mime/send_virus(datum/modular_computer_host/source, datum/modular_computer_host/target, mob/living/user)
	. = ..()
	if(!.)
		return FALSE
...
/obj/item/computer_disk/virus/detomatix/send_virus(datum/modular_computer_host/source, datum/modular_computer_host/target, mob/living/user)
	. = ..()
	if(!.)
		return FALSE
...
/obj/item/computer_disk/virus/frame/send_virus(datum/modular_computer_host/source, datum/modular_computer_host/target, mob/living/user)
	. = ..()
	if(!.)
		return FALSE
