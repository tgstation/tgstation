...
/datum/computer_file/program/revelation/proc/activate()
	if(computer)
		...
		computer.visible_message(span_notice("\The [physical]'s screen brightly flashes and loud electrical buzzing is heard."))
		computer.turn_off()
		update_computer_appearance()
		physical.take_damage(25, BRUTE, 0, 0)
		if(computer.internal_cell && prob(25))
			QDEL_NULL(computer.internal_cell)
			computer.visible_message(span_notice("\The [physical]'s battery explodes in rain of sparks."))
