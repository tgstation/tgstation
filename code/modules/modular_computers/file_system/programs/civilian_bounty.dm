/// Everything within this file is an edited form from this file, stripping it of some various components because they are not needed f. The PDA app: code/game/machinery/civilian_bounties.dm
