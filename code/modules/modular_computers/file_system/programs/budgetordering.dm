	...
	switch(action)
		if("send")
			...
			if(SSshuttle.supply.getDockedId() == docking_home)
				...
				physical.investigate_log("[key_name(usr)] sent the supply shuttle away.", INVESTIGATE_CARGO)
			else
				physical.investigate_log("[key_name(usr)] called the supply shuttle.", INVESTIGATE_CARGO)
		...
		if("loan")
			...
			if(SSshuttle.supply_blocked)
				...
				physical.investigate_log("[key_name(usr)] accepted a shuttle loan event.", INVESTIGATE_CARGO)
