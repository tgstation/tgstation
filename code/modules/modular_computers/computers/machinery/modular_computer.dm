...
/obj/machinery/modular_computer/attacked_by(obj/item/attacking_item, mob/living/user, list/modifiers)
	return CPU_INTERACTABLE(user) ? cpu.attacked_by(attacking_item, user, modifiers) : ..()
