...
/datum/aquarium_behaviour/fish
	...
	var/fillet_type = /obj/item/food/carpmeat/imitation
...
/datum/aquarium_behaviour/fish/proc/update_animation()
	SIGNAL_HANDLER
	var/obj/structure/aquarium/aquarium = parent.current_aquarium
	if(!aquarium)
		return
	var/old_animation = current_animation
	if(aquarium.fluid_type == AQUARIUM_FLUID_AIR || status == FISH_DEAD)
