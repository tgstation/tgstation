/obj/vehicle/ridden/wheelchair //ported from Hippiestation (by Jujumatic)
	...
	layer = OBJ_LAYER
	max_integrity = 100
	armor = list(MELEE = 10, BULLET = 10, LASER = 10, ENERGY = 0, BOMB = 10, FIRE = 20, ACID = 30) //Wheelchairs aren't super tough yo
...
/obj/vehicle/ridden/wheelchair/gold
	...
	max_integrity = 200
	armor = list(MELEE = 20, BULLET = 20, LASER = 20, ENERGY = 0, BOMB = 20, FIRE = 30, ACID = 40)
