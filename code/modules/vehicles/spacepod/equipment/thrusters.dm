...
/obj/item/pod_equipment/thrusters/blazer
	...
	desc = "An array of... wait. This thing seems to be a haphazardly modified thruster array for pods. Notably, <b>stabilizers have been removed to make way</b>. Not safe."
