...
/obj/vehicle/ridden/janicart/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/storage/bag/trash))
		...
		trash_bag = I
		register_signal(trash_bag, COMSIG_PARENT_QDELETING, .proc/bag_deleted)
...
/obj/vehicle/ridden/janicart/proc/try_remove_bag(mob/remover = null)
	...
	unregister_signal(trash_bag, COMSIG_PARENT_QDELETING)
	trash_bag = null
...
/obj/item/janicart_upgrade/vacuum/install(obj/vehicle/ridden/janicart/installee)
	installee.add_component(/datum/component/vacuum, installee.trash_bag)
