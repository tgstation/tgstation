...
/obj/vehicle/sealed/mecha/Initialize(mapload)
	...
	cabin_air.set_moles(/datum/gas/oxygen, O2STANDARD * cabin_air.volume / (R_IDEAL_GAS_EQUATION * cabin_air.temperature))
	cabin_air.set_moles(/datum/gas/nitrogen, N2STANDARD * cabin_air.volume / (R_IDEAL_GAS_EQUATION * cabin_air.temperature))
