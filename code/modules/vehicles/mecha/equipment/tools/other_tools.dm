...
/obj/item/mecha_parts/mecha_equipment/armor
	...
	var/list/armor_mod = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 0, ACID = 0)
...
/obj/item/mecha_parts/mecha_equipment/armor/anticcw_armor_booster
	...
	armor_mod = list(MELEE = 15, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 0, ACID = 0)
...
/obj/item/mecha_parts/mecha_equipment/armor/antiproj_armor_booster
	...
	armor_mod = list(MELEE = 0, BULLET = 10, LASER = 10, ENERGY = 0, BOMB = 0, FIRE = 0, ACID = 0)
