...
/obj/item/mecha_parts/mecha_equipment/medical/sleeper/proc/get_patient_dam()
	...
	if(ishuman(patient))
		...
		core_temp = {"<font color="[patient.coretemperature > 300 ? "#3d5bc3" : "#c51e1e"]"><b>Body Temperature:</b> [patient.bodytemperature-T0C]&deg;C ([patient.bodytemperature*1.8-459.67]&deg;F)</font><br />"}
