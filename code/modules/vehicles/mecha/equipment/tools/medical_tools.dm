...
/obj/item/mecha_parts/mecha_equipment/medical/mechmedbeam
	...
	custom_materials = list(/datum/material/iron = MINERAL_MATERIAL_AMOUNT*7.5, /datum/material/glass = MINERAL_MATERIAL_AMOUNT*4, /datum/material/plasma = MINERAL_MATERIAL_AMOUNT*1.5, /datum/material/gold = MINERAL_MATERIAL_AMOUNT*4, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT)
