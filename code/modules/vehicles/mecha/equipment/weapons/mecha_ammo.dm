...
/obj/item/mecha_ammo/missiles_pep
	...
	custom_materials = list(/datum/material/iron=MINERAL_MATERIAL_AMOUNT*4,/datum/material/gold=SMALL_MATERIAL_AMOUNT*5)
	rounds = 6
	direct_load = TRUE
	load_audio = 'sound/weapons/gun/general/mag_bullet_insert.ogg'
...
/obj/item/mecha_ammo/flashbang
	...
	custom_materials = list(/datum/material/iron=MINERAL_MATERIAL_AMOUNT*2,/datum/material/gold=SMALL_MATERIAL_AMOUNT*5)
	rounds = 6
