...
/obj/item/mecha_parts/proc/try_attach_part(mob/user, obj/vehicle/sealed/mecha/M, rightclickattach = FALSE) //For attaching parts to a finished mech
...
/obj/item/mecha_parts/part/try_attach_part(mob/user, obj/vehicle/sealed/mecha/M, rightclickattach = FALSE)
	return
