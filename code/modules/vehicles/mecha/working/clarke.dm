...
/obj/vehicle/sealed/mecha/working/clarke
	...
	armor = list(MELEE = LIGHT_DAMAGE_THRESHOLD, BULLET = LIGHT_DAMAGE_THRESHOLD, LASER = NO_DAMAGE_THRESHOLD, ENERGY = NO_DAMAGE_THRESHOLD, BOMB = 60, BIO = 0, FIRE = 100, ACID = 100) //low armor to compensate for fire protection and speed
	max_equip = 7
