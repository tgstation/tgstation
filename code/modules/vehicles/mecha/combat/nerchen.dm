 ...
 * ...Hilarious, right?
 */
/obj/vehicle/sealed/mecha/combat/nerchen
	...
	desc = "An incredibly ancient mecha, mostly out of common use because of it being from a time where mecha designers delegated functions to two pilots. \
			Because the Nerchen needed to store two people, it is a hulking, armored tank that, with two coordinated pilots, could absolutely mash even the \
			most menacing of single-pilot opponents."
	icon = 'icons/mecha/coop_mech.dmi'
	icon_state = "nerchen_0_0"
	movedelay = 3
...
/obj/vehicle/sealed/mecha/combat/nerchen/get_mecha_occupancy_state()
...
/obj/vehicle/sealed/mecha/combat/nerchen/auto_assign_occupant_flags(mob/M)
