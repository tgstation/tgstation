...
/obj/vehicle/sealed/mecha/justice/set_safety(mob/user)
	...
	playsound(src, 'sound/vehicles/mecha/mech_blade_safty.ogg').volume(75).play() //everyone need to hear this sound
...
/obj/vehicle/sealed/mecha/justice/proc/finish_him(obj/vehicle/sealed/mecha/my_mech, mob/finisher, mob/living/him)
	...
	playsound(src, 'sound/vehicles/mecha/mech_stealth_pre_attack.ogg').volume(75).play()
...
/obj/vehicle/sealed/mecha/justice/mob_exit(mob/M, silent, randomstep, forced)
	...
	playsound(src, 'sound/vehicles/mecha/mech_stealth_effect.ogg').volume(75).play()
