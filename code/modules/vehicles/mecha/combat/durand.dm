...
/obj/durand_shield/proc/activate(datum/source, mob/owner, list/signal_args)
	...
	if(chassis.defense_mode)
		...
		create_sound(src, 'sound/vehicles/mecha/mech_shield_raise.ogg').play()
		icon_state = "shield"
		...
		create_sound(src, 'sound/vehicles/mecha/mech_shield_drop.ogg').play()
		icon_state = "shield_null"
...
/obj/durand_shield/play_attack_sound()
	create_sound(src, 'sound/vehicles/mecha/mech_shield_deflect.ogg').volume(100).vary(TRUE).play()
