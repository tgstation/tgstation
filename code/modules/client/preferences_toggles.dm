...
/client/proc/pick_form()
	if(!is_content_unlocked())
		...
		return
	var/new_form = input(src, "Thanks for supporting BYOND - Choose your ghostly form:","Thanks for supporting BYOND",null, nullable = TRUE, choices = ghost_forms)
	if(new_form)
...
/client/proc/pick_ghost_orbit()
	if(!is_content_unlocked())
		alert("This setting is for accounts with BYOND premium only.")
		return
	var/new_orbit = input(src, "Thanks for supporting BYOND - Choose your ghostly orbit:","Thanks for supporting BYOND",null, nullable = TRUE, choices = ghost_orbits)
	if(new_orbit)
