...
/datum/asset/simple/goonchat
	...
	assets = list(
		...
		"twemoji.min.js"           = 'code/modules/goonchat/browserassets/js/twemoji.min.js',
		...
		"unicode_9_annotations.json" = 'code/modules/goonchat/browserassets/json/unicode_9_annotations.json',
	)
