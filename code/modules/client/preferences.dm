	...
	switch(current_tab)
		...
		if(2) //OOC Preferences
			...
			if(user.client.holder)
				...
				if(timegate)
					dat += "<b>Noted roles will automatically deadmin during the first [FLOOR(timegate / 60, 1)] minutes of the round, and will defer to individual preferences after.</b>"
