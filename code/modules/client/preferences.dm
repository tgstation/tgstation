...
/datum/preferences
	...
	proc/SetDisabilities(mob/user)
		var/HTML = "<body>"
		HTML += "<tt><center>"
		HTML += "<b>Choose disabilities</b><ul>"
		...
		HTML += "</ul>"
		HTML += "<a href=\"?_src_=prefs;task=close;preference=disabilities\">\[Done\]</a>"
		HTML += "<a href=\"?_src_=prefs;task=reset;preference=disabilities\">\[Reset\]</a>"
		HTML += "</center></tt>"
