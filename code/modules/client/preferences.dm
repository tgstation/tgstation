...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		if (0) // Character Settings#
			...
			if("tail_lizard" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("snout" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("horns" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("frills" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("spines" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("body_markings" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("legs" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if("moth_wings" in pref_species.selectable_mutant_bodyparts)
				if(!mutant_category)
					dat += APPEARANCE_CATEGORY_COLUMN
			...
			if(CONFIG_GET(flag/join_with_mutant_humans))
				...
				if("tail_human" in pref_species.selectable_mutant_bodyparts)
					if(!mutant_category)
						dat += APPEARANCE_CATEGORY_COLUMN
				...
				if("ears" in pref_species.selectable_mutant_bodyparts)
					if(!mutant_category)
						dat += APPEARANCE_CATEGORY_COLUMN
				...
				if("wings" in pref_species.selectable_mutant_bodyparts && GLOB.r_wings_list.len >1)
					if(!mutant_category)
						dat += APPEARANCE_CATEGORY_COLUMN
