...
/mob/living/carbon/human/verb/suicide()
	...
	if(confirm == "Yes")
		...
		if(a_intent == INTENT_DISARM)
			...
			if(prob(1))
				suicide_message = "Critical Suicide! [src] pull both arms outwards in front of [p_their()] chest and pumps them behind [p_their()] back, repeats this motion in a smaller range of motion \
