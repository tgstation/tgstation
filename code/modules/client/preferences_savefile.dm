...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["toggle_combat_mode_vignette"], toggle_combat_mode_vignette)
	...
	toggle_combat_mode_vignette = sanitize_integer(toggle_combat_mode_vignette, FALSE, TRUE, initial(toggle_combat_mode_vignette))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["toggle_combat_mode_vignette"], toggle_combat_mode_vignette)
