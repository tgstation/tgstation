...
/datum/preferences/proc/load_character(slot)
	...
	S["feature_tattoo_chest"]				>> features["tattoo_chest"]
	S["feature_tattoo_legs"]				>> features["tattoo_legs"]
	...
	features["tattoo_chest"] 	= sanitize_inlist(features["tattoo_chest"], tattoos_chest_list, "None")
	features["snout"]	= sanitize_inlist(features["snout"], snouts_list)
	features["horns"] 	= sanitize_inlist(features["horns"], horns_list)
	features["tattoo_legs"]	= sanitize_inlist(features["tattoo_legs"], tattoos_legs_list, "None")
