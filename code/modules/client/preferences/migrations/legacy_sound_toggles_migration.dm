...
/datum/preferences/proc/migrate_legacy_sound_toggles(savefile/savefile)
	write_preference(GLOB.preference_entries[/datum/preference/toggle/sound_ambience_volume], toggles & 1<<2)
	...
	write_preference(GLOB.preference_entries[/datum/preference/toggle/sound_lobby_volume], toggles & 1<<3)
	write_preference(GLOB.preference_entries[/datum/preference/toggle/sound_midi], toggles & 1<<1)
	write_preference(GLOB.preference_entries[/datum/preference/toggle/sound_ship_ambience_volume], toggles & 1<<8)
