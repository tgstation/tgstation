...
/datum/preferences/proc/migrate_legacy_sound_toggles(savefile/savefile)
	write_preference(GLOB.preference_entries[/datum/preference/numeric/sound_ambience], toggles & 1<<2)
	...
	write_preference(GLOB.preference_entries[/datum/preference/numeric/sound_ship_ambience], toggles & 1<<8)
