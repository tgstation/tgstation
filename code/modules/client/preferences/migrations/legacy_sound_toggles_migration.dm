...
/datum/preferences/proc/migrate_legacy_sound_toggles(savefile/savefile)
	...
	write_preference(GLOB.preference_entries[/datum/preference/numeric/volume/sound_announcements], toggles & 1<<11)
	write_preference(GLOB.preference_entries[/datum/preference/numeric/volume/sound_combatmode], toggles & 1<<22)
	write_preference(GLOB.preference_entries[/datum/preference/numeric/volume/sound_endofround], toggles & 1<<20)
