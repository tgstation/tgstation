...
/datum/preference/choiced/socks/init_possible_values()
	return assoc_to_keys_features(DSaccessories.socks_list)
...
/datum/preference/choiced/socks/icon_for(value)
	...
	return generate_underwear_icon(DSaccessories.socks_list[value], lower_half)
...
/datum/preference/choiced/undershirt/init_possible_values()
	return assoc_to_keys_features(DSaccessories.undershirt_list)
...
/datum/preference/choiced/undershirt/icon_for(value)
	...
	if (value != "Nude")
		var/datum/sprite_accessory/accessory = DSaccessories.undershirt_list[value]
...
/datum/preference/choiced/underwear/init_possible_values()
	return assoc_to_keys_features(DSaccessories.underwear_list)
...
/datum/preference/choiced/underwear/icon_for(value)
	...
	return generate_underwear_icon(DSaccessories.underwear_list[value], lower_half, COLOR_ALMOST_BLACK)
