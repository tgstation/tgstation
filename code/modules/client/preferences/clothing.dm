/proc/generate_values_for_underwear(list/accessory_list, list/icons, color)
	...
	for (var/icon in icons)
		lower_half.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', icon), ICON_OVERLAY)
...
/datum/preference/choiced/undershirt/init_possible_values()
	var/icon/body = icon('icons/mob/species/human_parts_greyscale.dmi', "human_r_leg")
	body.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', "human_l_leg"), ICON_OVERLAY)
	body.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', "human_r_arm"), ICON_OVERLAY)
	body.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', "human_l_arm"), ICON_OVERLAY)
	body.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', "human_r_hand"), ICON_OVERLAY)
	body.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', "human_l_hand"), ICON_OVERLAY)
	body.Blend(icon('icons/mob/species/human_parts_greyscale.dmi', "human_chest_m"), ICON_OVERLAY)
