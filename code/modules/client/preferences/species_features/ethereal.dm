...
/datum/preference/choiced/ethereal_color/init_possible_values()
	...
	var/icon/ethereal_base = icon('icons/mob/humanoid/ethereal/bodyparts.dmi', "ethereal_head")
	ethereal_base.Blend(icon('icons/mob/humanoid/ethereal/bodyparts.dmi', "ethereal_chest"), ICON_OVERLAY)
	ethereal_base.Blend(icon('icons/mob/humanoid/ethereal/bodyparts.dmi', "ethereal_l_arm"), ICON_OVERLAY)
	ethereal_base.Blend(icon('icons/mob/humanoid/ethereal/bodyparts.dmi', "ethereal_r_arm"), ICON_OVERLAY)

	var/icon/eyes = icon('icons/mob/humanoid/human_face.dmi', "eyes")
