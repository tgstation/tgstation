...
/datum/preference/choiced/moth_antennae/init_possible_values()
	...
	var/icon/moth_head = icon('icons/mob/humanoid/moth/bodyparts.dmi', "moth_head")
	moth_head.Blend(icon('icons/mob/humanoid/human_face.dmi', "motheyes"), ICON_OVERLAY)
...
/datum/preference/choiced/moth_markings/init_possible_values()
	...
	moth_body.Blend(icon('icons/mob/humanoid/moth/moth_wings.dmi', "m_moth_wings_plain_BEHIND"), ICON_OVERLAY)
	...
	for (var/obj/item/bodypart/body_part in body_parts)
		...
		moth_body.Blend(icon('icons/mob/humanoid/moth/bodyparts.dmi', "moth_[body_part][gender]"), ICON_OVERLAY)

	moth_body.Blend(icon('icons/mob/humanoid/human_face.dmi', "motheyes"), ICON_OVERLAY)
	...
	for (var/markings_name in GLOB.moth_markings_list)
		...
		icon_with_markings.Blend(icon('icons/mob/humanoid/moth/moth_wings.dmi', "m_moth_wings_plain_FRONT"), ICON_OVERLAY)
		icon_with_markings.Blend(icon('icons/mob/humanoid/moth/moth_antennae.dmi', "m_moth_antennae_plain_FRONT"), ICON_OVERLAY)
