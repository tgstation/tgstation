...
/datum/preference/choiced/moth_antennae/init_possible_values()
	...
	moth_head.Blend(icon('icons/mob/species/human_face.dmi', "motheyes"), ICON_OVERLAY)
...
/datum/preference/choiced/moth_markings/init_possible_values()
	...
	moth_body.Blend(icon('icons/mob/species/human_face.dmi', "motheyes"), ICON_OVERLAY)
