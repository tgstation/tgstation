...
/datum/preference/choiced/species_feature/moth_antennae/icon_for(value)
	...
	if (isnull(moth_head))
		...
		moth_head.blend_icon(uni_icon('icons/mob/human/human_eyes.dmi', "motheyes_l"), ICON_OVERLAY)
		moth_head.blend_icon(uni_icon('icons/mob/human/human_eyes.dmi', "motheyes_r"), ICON_OVERLAY)
...
/datum/preference/choiced/species_feature/moth_markings/icon_for(value)
	...
	if (isnull(moth_body))
		...
		moth_body.blend_icon(uni_icon('icons/mob/human/human_eyes.dmi', "motheyes_l"), ICON_OVERLAY)
		moth_body.blend_icon(uni_icon('icons/mob/human/human_eyes.dmi', "motheyes_r"), ICON_OVERLAY)
