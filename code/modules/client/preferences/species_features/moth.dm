...
/datum/preference/choiced/moth_antennae/init_possible_values()
	return assoc_to_keys_features(SSsprite_accessories.moth_antennae_list)
...
/datum/preference/choiced/moth_antennae/icon_for(value)
	...
	var/datum/sprite_accessory/antennae = SSsprite_accessories.moth_antennae_list[value]
...
/datum/preference/choiced/moth_markings/init_possible_values()
	return assoc_to_keys_features(SSsprite_accessories.moth_markings_list)
...
/datum/preference/choiced/moth_markings/icon_for(value)
	...
	var/datum/sprite_accessory/markings = SSsprite_accessories.moth_markings_list[value]
...
/datum/preference/choiced/moth_wings/init_possible_values()
	return assoc_to_keys_features(SSsprite_accessories.moth_wings_list)

/datum/preference/choiced/moth_wings/icon_for(value)
	var/datum/sprite_accessory/moth_wings = SSsprite_accessories.moth_wings_list[value]
