...
/datum/preference/choiced/moth_antennae/init_possible_values()
	return assoc_to_keys_features(ACCESSORIES.moth_antennae_list)
...
/datum/preference/choiced/moth_antennae/icon_for(value)
	...
	var/datum/sprite_accessory/antennae = ACCESSORIES.moth_antennae_list[value]
...
/datum/preference/choiced/moth_markings/init_possible_values()
	return assoc_to_keys_features(ACCESSORIES.moth_markings_list)
...
/datum/preference/choiced/moth_markings/icon_for(value)
	...
	var/datum/sprite_accessory/markings = ACCESSORIES.moth_markings_list[value]
...
/datum/preference/choiced/moth_wings/init_possible_values()
	return assoc_to_keys_features(ACCESSORIES.moth_wings_list)

/datum/preference/choiced/moth_wings/icon_for(value)
	var/datum/sprite_accessory/moth_wings = ACCESSORIES.moth_wings_list[value]
