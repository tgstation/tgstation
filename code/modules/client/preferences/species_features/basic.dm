...
/datum/preference/choiced/facial_hairstyle/init_possible_values()
	return assoc_to_keys_features(DSaccessories.facial_hairstyles_list)

/datum/preference/choiced/facial_hairstyle/icon_for(value)
	return generate_icon_with_head_accessory(DSaccessories.facial_hairstyles_list[value])
...
/datum/preference/choiced/facial_hair_gradient/init_possible_values()
	return assoc_to_keys_features(DSaccessories.facial_hair_gradients_list)
...
/datum/preference/choiced/hairstyle/init_possible_values()
	return assoc_to_keys_features(DSaccessories.hairstyles_list)

/datum/preference/choiced/hairstyle/icon_for(value)
	var/datum/sprite_accessory/hair/hairstyle = DSaccessories.hairstyles_list[value]
...
/datum/preference/choiced/hair_gradient/init_possible_values()
	return assoc_to_keys_features(DSaccessories.hair_gradients_list)
