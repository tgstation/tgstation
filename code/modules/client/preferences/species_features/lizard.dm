/proc/generate_lizard_side_shots(list/sprite_accessories, key, include_snout = TRUE)
	...
	var/icon/lizard = icon('icons/mob/humanoid/lizard/bodyparts.dmi', "lizard_head", EAST)
	var/icon/eyes = icon('icons/mob/humanoid/human_face.dmi', "eyes", EAST)
	eyes.Blend(COLOR_GRAY, ICON_MULTIPLY)
	lizard.Blend(eyes, ICON_OVERLAY)

	if (include_snout)
		lizard.Blend(icon('icons/mob/humanoid/mutant_bodyparts.dmi', "m_snout_round_ADJ", EAST), ICON_OVERLAY)
...
/datum/preference/choiced/lizard_body_markings/init_possible_values()
	...
	var/icon/lizard = icon('icons/mob/humanoid/lizard/bodyparts.dmi', "lizard_chest_m")
	...
	for (var/name in GLOB.body_markings_list)
		...
		if (sprite_accessory.icon_state != "none")
			var/icon/body_markings_icon = icon(
				'icons/mob/humanoid/mutant_bodyparts.dmi',
