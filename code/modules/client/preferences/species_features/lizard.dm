...
/datum/preference/choiced/lizard_body_markings/init_possible_values()
	return assoc_to_keys_features(DSaccessories.body_markings_list)

/datum/preference/choiced/lizard_body_markings/icon_for(value)
	var/datum/sprite_accessory/sprite_accessory = DSaccessories.body_markings_list[value]
...
/datum/preference/choiced/lizard_frills/init_possible_values()
	return assoc_to_keys_features(DSaccessories.frills_list)

/datum/preference/choiced/lizard_frills/icon_for(value)
	return generate_lizard_side_shot(DSaccessories.frills_list[value], "frills")
...
/datum/preference/choiced/lizard_horns/init_possible_values()
	return assoc_to_keys_features(DSaccessories.horns_list)

/datum/preference/choiced/lizard_horns/icon_for(value)
	return generate_lizard_side_shot(DSaccessories.horns_list[value], "horns")
...
/datum/preference/choiced/lizard_legs/init_possible_values()
	return assoc_to_keys_features(DSaccessories.legs_list)
...
/datum/preference/choiced/lizard_snout/init_possible_values()
	return assoc_to_keys_features(DSaccessories.snouts_list)

/datum/preference/choiced/lizard_snout/icon_for(value)
	return generate_lizard_side_shot(DSaccessories.snouts_list[value], "snout", include_snout = FALSE)
...
/datum/preference/choiced/lizard_spines/init_possible_values()
	return assoc_to_keys_features(DSaccessories.spines_list)
...
/datum/preference/choiced/lizard_tail/init_possible_values()
	return assoc_to_keys_features(DSaccessories.tails_list_lizard)
