...
/datum/preference/choiced/pod_hair/init_possible_values()
	return assoc_to_keys_features(DSaccessories.pod_hair_list)

/datum/preference/choiced/pod_hair/icon_for(value)
	var/datum/sprite_accessory/pod_hair = DSaccessories.pod_hair_list[value]
...
/datum/preference/choiced/pod_hair/create_default_value()
	return pick(assoc_to_keys_features(DSaccessories.pod_hair_list))
