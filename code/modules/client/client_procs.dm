...
/client/Topic(href, href_list, hsrc)
	...
	//overloaded
	if(hsrc && hsrc != holder && TRY_QUEUE_VERB(src, .proc/Topic_wrapper, VERB_DEFAULT_QUEUE_THRESHOLD, hsrc, href, href_list))
		return
...
/client/proc/Topic_wrapper(datum/hsrc, href, list/href_list)
