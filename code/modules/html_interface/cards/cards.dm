...
/datum/html_interface/cards/New()
	...
	head = head + "<link rel=\"stylesheet\" type=\"text/css\" href=\"cards.css\" />"
	updateLayout("<div id=\"headbar\"></div><div class=\"wrapper\"><table><tr><td style=\"vertical-align: middle;\"><div id=\"hand\"></div></td></tr></table></div>")
