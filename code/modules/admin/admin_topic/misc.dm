...
/datum/datum_topic/admins_topic/stickyban/Run(list/input)
...
/datum/datum_topic/admins_topic/getplaytime/Run(list/input)
...
/datum/datum_topic/admins_topic/toggleexempt/Run(list/input)
	if(!check_rights(R_ADMIN))
		return
