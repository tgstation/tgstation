...
/obj/effect/fun_balloon/sentience/effect()
	...
	var/list/candidates = SSpolling.poll_ghost_candidates_for_mobs(question, jobban = ROLE_PAI, poll_time = 10 SECONDS, mobs = bodies, pic_source = /mob/dead/observer, role_name_text = "sentience balloon possesser")
