...
ADMIN_VERB_NO_CONTEXT_MENU(change_command_name, R_ADMIN, "Change Command Name", "Change the name of Central Command.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB_NO_CONTEXT_MENU(create_command_report, R_ADMIN, "Create Command Report", "Create a command report to be sent to the station.", ADMIN_CATEGORY_EVENTS)
