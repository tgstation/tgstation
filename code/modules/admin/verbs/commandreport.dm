...
ADMIN_VERB(command_change_name, "Change Command Name", "", R_ADMIN, VERB_CATEGORY_EVENTS)
...
ADMIN_VERB(command_report, "Create Command Report", "", R_ADMIN, VERB_CATEGORY_EVENTS)
