...
/client/proc/adminchangemap()
	...
	if(chosenmap == "Custom")
		...
		VM.config_filename = "[CONFIG_GET(string/data_directory)]/next_map.json"
		var/json_value = list(
		...
		if(fexists("[CONFIG_GET(string/data_directory)]/next_map.json"))
			fdel("[CONFIG_GET(string/data_directory)]/next_map.json")
		text2file(json_encode(json_value), "[CONFIG_GET(string/data_directory)]/next_map.json")
