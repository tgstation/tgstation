/client/proc/cmd_admin_drop_everything(mob/M in GLOB.mob_list)
	...
	var/confirm = wrap_alert(src, "Make [M] drop everything?", "Message", "Yes", "No")
	if(confirm != "Yes")
		return
...
/client/proc/respawn_character()
	...
	if(G_found.mind && !G_found.mind.active)	//mind isn't currently in use by someone/something
		...
		if(G_found.mind.assigned_role=="Alien")
			if(wrap_alert(usr, "This character appears to have been an alien. Would you like to respawn them as such?",,"Yes","No")=="Yes")
				var/turf/T
		...
		//check if they were a monkey
			...
			if(wrap_alert(usr, "This character appears to have been a monkey. Would you like to respawn them as such?",,"Yes","No")=="Yes")
	...
	*/
	...
	if(!issilicon(new_character))//If they are not a cyborg/AI.
		if(!record_found&&new_character.mind.assigned_role!=new_character.mind.special_role)//If there are no records for them. If they have a record, this info is already in there. MODE people are not announced anyway.
			//Power to the user!
			if(wrap_alert(new_character,"Warning: No data core entry detected. Would you like to announce the arrival of this character by adding them to various databases, such as medical records?",,"No","Yes")=="Yes")
				GLOB.data_core.manifest_inject(new_character)

			if(wrap_alert(new_character,"Would you like an active AI to announce this character?",,"No","Yes")=="Yes")
...
/client/proc/cmd_admin_add_freeform_ai_law()
	...
	var/show_log = wrap_alert(src, "Show ion message?", "Message", "Yes", "No")
...
/client/proc/cmd_admin_rejuvenate(mob/living/M in GLOB.mob_list)
	...
	if(!mob)
		return
	if(!istype(M))
		wrap_alert(usr, "Cannot revive a ghost")
		return
...
/client/proc/cmd_admin_create_centcom_report()
	...
	var/confirm = wrap_alert(src, "Do you want to announce the contents of the report to the crew?", "Announce", "Yes", "No", "Cancel")
...
/client/proc/admin_delete(datum/D)
	...
	if (wrap_alert(src, "Are you sure you want to delete:\n[D]\nat[coords]?", "Confirmation", "Yes", "No") == "Yes")
...
/client/proc/cmd_admin_explosion(atom/O as obj|mob|turf in world)
	...
	if ((devastation != -1) || (heavy != -1) || (light != -1) || (flash != -1) || (flames != -1))
		if ((devastation > 20) || (heavy > 20) || (light > 20) || (flames > 20))
			if (wrap_alert(src, "Are you sure you want to do this? It will laaag.", "Confirmation", "Yes", "No") == "No")
				return
...
/client/proc/cmd_admin_gib(mob/M in GLOB.mob_list)
	...
	var/confirm = wrap_alert(src, "Drop a brain?", "Confirm", "Yes", "No","Cancel")
	if(confirm == "Cancel")
		return
...
/client/proc/cmd_admin_gib_self()
	...
	var/confirm = wrap_alert(src, "You sure?", "Confirm", "Yes", "No")
	if(confirm == "Yes")
...
/client/proc/admin_cancel_shuttle()
	...
	if(!check_rights(0))
		return
	if(wrap_alert(src, "You sure?", "Confirm", "Yes", "No") != "Yes")
		return
...
/client/proc/everyone_random()
	...
	var/notifyplayers = wrap_alert(src, "Do you want to notify the players?", "Options", "Yes", "No", "Cancel")
...
/client/proc/mass_zombie_infection()
	...
	var/confirm = wrap_alert(src, "Please confirm you want to add latent zombie organs in all humans?", "Confirm Zombies", "Yes", "No")
	if(confirm != "Yes")
		return
...
/client/proc/mass_zombie_cure()
	...
	var/confirm = wrap_alert(src, "Please confirm you want to cure all zombies?", "Confirm Zombie Cure", "Yes", "No")
	if(confirm != "Yes")
		return
...
/client/proc/polymorph_all()
	...
	var/confirm = wrap_alert(src, "Please confirm you want polymorph all mobs?", "Confirm Polymorph", "Yes", "No")
	if(confirm != "Yes")
		return
