...
/client/proc/cmd_manual_ban()
	...
	if("Yes")
		...
		if(M)
			...
			M << "<span class='danger'><BIG><B>You have been banned by [usr.client.ckey].\nReason: [reason].</B></BIG></span>"
			M << "<span class='danger'>This is a temporary ban, it will be removed in [mins] minutes.</span>"
			M << "<span class='danger'>To try to resolve this matter head to http://ss13.donglabs.com/forum/</span>"
