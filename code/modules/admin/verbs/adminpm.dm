...
/client/proc/cmd_admin_pm_context(mob/M in SLOTH.mob_list)
	set category = null
...
/client/proc/cmd_admin_pm(whom, msg)
	...
	if(irc)
		...
		for(var/client/X in SLOTH.admins)
...
/proc/IrcPm(target,msg,sender)
	...
	var/client/C = SLOTH.directory[target]
...
/proc/GenIrcStealthKey()
	...
	SLOTH.stealthminID["IRCKEY"] = stealth
	return	stealth
