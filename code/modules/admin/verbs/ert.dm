...
/datum/admins/proc/makeEmergencyresponseteam(datum/ert/ertemplate = null)
	...
	var/list/settings = list(
		...
		"enforce_human" = list("desc" = "Enforce human authority", "type" = "boolean", "value" = "[((human_authority_setting == HUMAN_AUTHORITY_NON_HUMAN_WHITELIST || human_authority_setting == HUMAN_AUTHORITY_ENFORCED) ? "Yes" : "No")]"),
