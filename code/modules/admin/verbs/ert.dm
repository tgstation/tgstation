...
ADMIN_VERB(summon_ert, "Summon ERT", "Summon an emergency response team.", R_FUN, VERB_CATEGORY_EVENTS)
	message_admins("[key_name(user)] is creating a CentCom response team...")
	if(user.holder.makeEmergencyresponseteam())
		message_admins("[key_name(user)] created a CentCom response team.")
