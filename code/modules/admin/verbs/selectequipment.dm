...
/datum/select_equipment/ui_static_data(mob/user)
	...
	if(!cached_outfits)
		...
		cached_outfits += make_outfit_entries("General", subtypesof(/datum/outfit) - typesof(/datum/outfit/job) - typesof(/datum/outfit/plasmaman) - typesof(/datum/outfit/mafia))
		...
		cached_outfits += make_outfit_entries("Mafia", typesof(/datum/outfit/mafia))
