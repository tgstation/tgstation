	...
	if(M)
		if(M.mind in ticker.mode.cult)
			...
			if(alert("Spawn that person a tome?",,"Yes","No")=="Yes")
				M << "<span class='danger'>You catch a glimpse of the Realm of Nar-Sie, The Geometer of Blood. You now see how flimsy the world is, you see that it should be open to the knowledge of Nar-Sie. A tome, a message from your new master, appears on the ground.</span>"
				new /obj/item/weapon/tome(M.loc)
			else
				M << "<span class='danger'>You catch a glimpse of the Realm of Nar-Sie, The Geometer of Blood. You now see how flimsy the world is, you see that it should be open to the knowledge of Nar-Sie.</span>"
			var/glimpse=pick("1","2","3","4","5","6","7","8")
			switch(glimpse)
				if("1")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordtravel] is travel...</span>"
				if("2")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordblood] is blood...</span>"
				if("3")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordjoin] is join...</span>"
				if("4")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordhell] is Hell...</span>"
				if("5")
					M << "<span class='danger'>You remembered one thing from the glimpse... [worddestr] is destroy...</span>"
				if("6")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordtech] is technology...</span>"
				if("7")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordself] is self...</span>"
				if("8")
					M << "<span class='danger'>You remembered one thing from the glimpse... [wordsee] is see...</span>"
