...
/client/proc/cmd_assume_direct_control(mob/M in GLOB.mob_list)
	...
	if(M.ckey)
		if(alert(usr, "This mob is being controlled by [M.ckey]. Are you sure you wish to assume control of it? [M.ckey] will be made a ghost.",,"Yes","No") != "Yes")
			return
		else
...
/client/proc/startSinglo()
	...
	if(alert(usr, "Are you sure? This will start up the engine. Should only be used during debug!",,"Yes","No") != "Yes")
		return
