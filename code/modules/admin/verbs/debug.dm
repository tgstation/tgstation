...
ADMIN_VERB(cmd_assume_direct_control, R_ADMIN, "Assume Direct Control", "Assume direct control of a mob.", ADMIN_CATEGORY_HIDDEN, mob/M) // BANDASTATION REPLACEMENT: Original: ADMIN_CATEGORY_DEBUG
	if(M.ckey)
