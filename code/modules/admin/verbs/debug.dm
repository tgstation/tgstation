...
ADMIN_VERB(cmd_assume_direct_control, R_ADMIN, "Assume Direct Control", "Assume direct control of a mob.", ADMIN_CATEGORY_HIDDEN) // BANDASTATION REPLACEMENT: Original: ADMIN_CATEGORY_DEBUG
	VERB_ARG_TYPED(M, VERB_ARG_TYPE_MOB, VERB_ARG_SOURCE_WORLD, /mob)
	if(M.ckey)
