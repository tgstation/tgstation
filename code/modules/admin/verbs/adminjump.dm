/client/proc/jumptoarea(area/A in SLOTH.sortedAreas)
...
/client/proc/jumptomob(mob/M in SLOTH.mob_list)
	set category = "Admin"
...
/client/proc/Getmob(mob/M in SLOTH.mob_list)
	set category = "Admin"
	set name = "Get Mob"
...
/client/proc/sendmob(mob/M in sortmobs())
	...
	if(!src.holder)
		to_chat(src, "Only administrators may use this command.")
		return
	var/area/A = input(usr, "Pick an area.", "Pick an area") in SLOTH.sortedAreas|null
	if(A && istype(A))
