...
ADMIN_VERB_AND_CONTEXT_MENU(admin_smite, R_ADMIN|R_FUN, "Smite", "Smite a player with divine power.", ADMIN_CATEGORY_HIDDEN, /mob/living) // BANDASTATION EDIT: Original - ADMIN_CATEGORY_FUN
