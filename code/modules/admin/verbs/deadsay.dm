/client/proc/dsay(msg as text)
	...
	var/rendered = "<span class='game deadsay'><span class='prefix'>DEAD:</span> <span class='name'>ADMIN([src.holder.fakekey ? SSrng.pick_from_list(nicknames) : src.key])</span> says, <span class='message'>\"[msg]\"</span></span>"
