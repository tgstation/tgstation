...
/datum/admin_help/proc/TimeoutVerb()
	...
	initiator.adminhelptimerid = addtimer(CALLBACK(initiator, /client/proc/giveadminhelpverb), 1200, TIMER_STOPPABLE | TIMER_CLIENT_TIME) //2 minute cooldown of admin helps
