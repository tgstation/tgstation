...
/datum/admin_help/proc/ClosureLinks(ref_src)
	...
	. += " (<A HREF='?_src_=holder;[HrefToken(forceGlobal = TRUE)];ahelp=[ref_src];ahelp_action=skissue'>SK</A>)"
...
/datum/admin_help/proc/SkillIssue(key_name = key_name_admin(usr))
	...
	msg += "<font color='red'>Your issue has been determined by an administrator to be a character's skill issue and does NOT require administrator intervention at this time. For further resolution you should pursue options that help you git gud.</font>"
