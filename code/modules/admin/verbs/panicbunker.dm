ADMIN_VERB(panic_bunker, "Toggle Panic Bunker", "Toggle the ability for new players to join.", R_SERVER, VERB_CATEGORY_SERVER)
...
ADMIN_VERB(toggle_interviews, "Toggle PB Interviews", "Toggle the ability for new players to apply to join the server.", R_SERVER, VERB_CATEGORY_SERVER)
