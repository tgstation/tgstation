ADMIN_VERB(map_template_load, "Map Template - Place", "Place a map template at your current location.", R_DEBUG, VERB_CATEGORY_DEBUG)
	var/datum/map_template/template
	var/map = input(user, "Choose a Map Template to place at your CURRENT LOCATION","Place Map Template") as null|anything in sort_list(SSmapping.map_templates)
	if(!map)
		return
...
ADMIN_VERB(map_template_upload, "Map Template - Upload", "Upload a map template.", R_DEBUG, VERB_CATEGORY_DEBUG)
