...
//Regular jobs
	...
	//Antagonist (Orange)
		...
		if(jobban_isbanned(M, "shadowling") || isbanned_dept)
			dat += "<td width='20%'><a href='?src=\ref[src];jobban3=shadowling;jobban4=\ref[M]'><font color=red>[replacetext("Shadowling", " ", "&nbsp")]</font></a></td>"
		else
			dat += "<td width='20%'><a href='?src=\ref[src];jobban3=shadowling;jobban4=\ref[M]'>[replacetext("Shadowling", " ", "&nbsp")]</a></td>"
