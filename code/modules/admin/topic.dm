...
// Now isn't that much better? IT IS NOW A PROC, i.e. kinda like a big panel like unstable
		...
		H.equip_to_slot_or_del( new /obj/item/chem/food/snacks/cookie(H), slot_l_hand )
		if(!(istype(H.l_hand,/obj/item/chem/food/snacks/cookie)))
			H.equip_to_slot_or_del( new /obj/item/chem/food/snacks/cookie(H), slot_r_hand )
			if(!(istype(H.r_hand,/obj/item/chem/food/snacks/cookie)))
