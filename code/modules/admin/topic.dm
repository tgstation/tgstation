...
/datum/admins/Topic(href, href_list)
	...
	if(href_list["ahelp"])
		...
		switch(href_list["simplemake"])
			...
			if("slime")
				M.change_mob_type( /mob/living/animal/slime , null, null, delmob )
			if("monkey")
				M.change_mob_type( /mob/living/carbon/monkey , null, null, delmob )
			if("robot")
				M.change_mob_type( /mob/living/silicon/robot , null, null, delmob )
			if("cat")
				M.change_mob_type( /mob/living/animal/pet/cat , null, null, delmob )
			if("runtime")
				M.change_mob_type( /mob/living/animal/pet/cat/Runtime , null, null, delmob )
			if("corgi")
				M.change_mob_type( /mob/living/animal/pet/dog/corgi , null, null, delmob )
			if("ian")
				M.change_mob_type( /mob/living/animal/pet/dog/corgi/Ian , null, null, delmob )
			if("pug")
				M.change_mob_type( /mob/living/animal/pet/dog/pug , null, null, delmob )
			if("crab")
				M.change_mob_type( /mob/living/animal/crab , null, null, delmob )
			if("coffee")
				M.change_mob_type( /mob/living/animal/crab/Coffee , null, null, delmob )
			if("parrot")
				M.change_mob_type( /mob/living/animal/parrot , null, null, delmob )
			if("polyparrot")
				M.change_mob_type( /mob/living/animal/parrot/Poly , null, null, delmob )
			if("constructarmored")
				M.change_mob_type( /mob/living/animal/hostile/construct/armored , null, null, delmob )
			if("constructbuilder")
				M.change_mob_type( /mob/living/animal/hostile/construct/builder , null, null, delmob )
			if("constructwraith")
				M.change_mob_type( /mob/living/animal/hostile/construct/wraith , null, null, delmob )
			if("shade")
				M.change_mob_type( /mob/living/animal/shade , null, null, delmob )
