...
/obj/effect/sound_emitter/proc/edit_emitter(mob/user)
	...
	dat += {"<b>Label:</b> <a href='?src=\ref[src];edit_label=1'>[maptext ? maptext : "No label set!"]</a><br>
		<br>
		<b>Sound File:</b> <a href='?src=\ref[src];edit_sound_file=1'>[sound_file ? sound_file : "No file chosen!"]</a><br>
		<b>Volume:</b> <a href='?src=\ref[src];edit_volume=1'>[sound_volume]%</a><br>
		<br>
		<b>Mode:</b> <a href='?src=\ref[src];edit_mode=1'>[motus_operandi]</a><br>"}
	...
	dat += {"<br>
		<a href='?src=\ref[src];play=1'>Play Sound</a> (interrupts other sound emitter sounds)"}
