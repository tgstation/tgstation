...
/client/proc/view_var_Topic(href, href_list, hsrc)
	...
	if(href_list["Vars"])
		SSadmin_verbs.dynamic_invoke_admin_verb(src, /mob/admin_module_holder/debug/view_variables, list(locate(href_list["Vars"])))
...
//Stuff below aren't in dropdowns/etc.
	...
	if(href_list["datumrefresh"])
		...
		if(isdatum(DAT) || istype(DAT, /client) || islist(DAT))
			SSadmin_verbs.dynamic_invoke_admin_verb(usr.client, /mob/admin_module_holder/debug/view_variables, list(DAT))
