...
GLOBAL_LIST_INIT(admin_verbs_sounds, list(/client/proc/play_web_sound, /client/proc/play_local_sound, /client/proc/play_sound, /client/proc/set_round_end_sound))
