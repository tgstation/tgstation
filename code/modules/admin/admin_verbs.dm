...
/client/proc/toggle_AI_interact()
	...
	if(!src.AI_Interact)
		src.AI_Interact = 1
		log_admin("[key_name(usr)] has activated Admin AI Interact")
		message_admins("[key_name(usr)] has activated their AI interaction")
	else
		src.AI_Interact = 0
		log_admin("[key_name(usr)] has deactivated Admin AI Interact")
		message_admins("[key_name(usr)] has deactivated their AI interaction")