...
/proc/AddBan(ckey, computerid, reason, bannedby, temp, minutes, address)
	...
	if ( GLOB.Banlist.dir.Find("[ckey][computerid]") )
		...
		if(!temp)
			create_message("note", ckey, bannedby, "Permanently banned - [reason]", null, null, 0, 0, null, 0)
		else
			create_message("note", ckey, bannedby, "Banned for [minutes] minutes - [reason]", null, null, 0, 0, null, 0)
	return 1
