...
/datum/crafting_recipe/dwarf/warhammer
	...
	result = /obj/item/twohanded/smithed_warhammer
	reqs = list(/obj/item/grown/log = 1,
				/obj/item/mold_result/hammer_head = 1)
	parts = list(/obj/item/mold_result/hammer_head = 1)
	time = 40
	category = CAT_SMITH

/datum/crafting_recipe/dwarf/shield
	name = "Smithed Buckler"
	result = /obj/item/shield/riot/buckler/smith
	reqs = list(/obj/item/grown/log = 1,
				/obj/item/mold_result/shield_backing = 1)
	parts = list(/obj/item/mold_result/shield_backing = 1)
	time = 40
	category = CAT_SMITH
...
/datum/crafting_recipe/dwarf/smith_armor
	...
	reqs = list(/obj/item/stack/sheet/leather = 4,
				/obj/item/mold_result/armor_plating = 1)
	parts = list(/obj/item/mold_result/armor_plating = 1)
	time = 40
	category = CAT_SMITH
...
/datum/crafting_recipe/dwarf/crossbow
	...
	result = /obj/item/gun/ballistic/automatic/speargun/crossbow
	reqs = list(/obj/item/stack/sheet/leather = 2,
				/obj/item/mold_result/crossbow_base = 1)
	parts = list(/obj/item/mold_result/crossbow_base = 1)
	time = 40
	category = CAT_SMITH

/datum/crafting_recipe/dwarf/smeltery // Smelt shit.
	name = "Fort-In-A-Box (Smeltery) (Stand next to anvil)"
	result = /obj/item/survivalcapsule/fort_in_a_box/smeltery
...
/datum/crafting_recipe/dwarf/throne_room // Make nobles.
	...
	result = /obj/item/survivalcapsule/fort_in_a_box/throne_room
...
/datum/crafting_recipe/dwarf/dining_hall // A place to gather.
	...
	result = /obj/item/survivalcapsule/fort_in_a_box/dining_hall
...
/datum/crafting_recipe/dwarf/brewery // Mandatory.
	...
	result = /obj/item/survivalcapsule/fort_in_a_box/brewery
...
/datum/crafting_recipe/dwarf/dorm // Allow new migrants.
	...
	result = /obj/item/survivalcapsule/fort_in_a_box/dorm
...
/datum/crafting_recipe/dwarf/farm // Grow ale supplies.
	...
	result = /obj/item/survivalcapsule/fort_in_a_box/farm
