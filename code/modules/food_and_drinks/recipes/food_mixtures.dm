...
/datum/chemical_reaction/food/raw_pita_bread
	required_reagents = list(/datum/reagent/water = 5, /datum/reagent/consumable/flour = 10, /datum/reagent/consumable/sugar = 2, /datum/reagent/consumable/quality_oil = 2)
