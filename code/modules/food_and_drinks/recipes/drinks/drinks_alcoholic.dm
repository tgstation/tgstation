...
/datum/chemical_reaction/drink/telepole
	...
	required_reagents = list(/datum/reagent/consumable/ethanol/wine_voltaic = 2, /datum/reagent/consumable/ethanol/dark_and_stormy = 2, /datum/reagent/consumable/ethanol/sake = 1)
