...
/datum/chemical_reaction/drink/gin_garden
	...
	required_reagents = list(/datum/reagent/consumable/lemonjuice = 1, /datum/reagent/consumable/sugar = 1, /datum/reagent/consumable/ethanol/gin = 3, /datum/reagent/consumable/cucumberjuice = 3, /datum/reagent/consumable/rootbeer = 5, /datum/reagent/consumable/ice = 2)
