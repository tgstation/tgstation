...
/datum/chemical_reaction/moonshine
	...
	required_reagents = list("nutriment" = 10, "enzyme" = 0)

/datum/chemical_reaction/wine
	id = "wine"
	results = list("wine" = 10)
	required_reagents = list("grapejuice" = 10, "enzyme" = 0)

/datum/chemical_reaction/spacebeer
	id = "spacebeer"
	results = list("beer" = 10)
	required_reagents = list("flour" = 10, "enzyme" = 0)

/datum/chemical_reaction/vodka
	id = "vodka"
	results = list("vodka" = 10)
	required_reagents = list("potato" = 10, "enzyme" = 0)

/datum/chemical_reaction/kahlua
	id = "kahlua"
	results = list("kahlua" = 5)
	required_reagents = list("coffee" = 5, "sugar" = 5, "enzyme" = 0)
...
/datum/chemical_reaction/hooch
	...
	required_reagents = list ("ethanol" = 2, "welding_fuel" = 1, "enzyme" = 0)
...
/datum/chemical_reaction/mead
	id = "mead"
	results = list("mead" = 2)
	required_reagents = list("honey" = 2, "enzyme" = 0)
