...
/datum/crafting_recipe/candycornwhiskey
	name = "candy corn whiskey"
	result = /obj/item/reagent_containers/food/drinks/bottle/candycornwhiskey
	time = 30
	reqs = list(/datum/reagent/consumable/ethanol/whiskey = 5,
