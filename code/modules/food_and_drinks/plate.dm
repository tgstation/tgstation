...
/obj/item/plate/proc/AddToPlate(obj/item/item_to_plate)
	...
	register_signal(item_to_plate, COMSIG_MOVABLE_MOVED, .proc/ItemMoved)
	register_signal(item_to_plate, COMSIG_PARENT_QDELETING, .proc/ItemMoved)
	update_appearance()
...
/obj/item/plate/proc/ItemRemovedFromPlate(obj/item/removed_item)
	...
	unregister_signal(removed_item, list(COMSIG_MOVABLE_MOVED, COMSIG_PARENT_QDELETING))
