...
/datum/customer_data/moth/get_underlays(mob/living/simple_animal/robot_customer/customer)
	...
	var/mutable_appearance/wings_behind = mutable_appearance(icon = 'icons/mob/humanoid/moth/moth_wings.dmi', icon_state = "m_moth_wings_[wings.icon_state]_BEHIND")
...
/datum/customer_data/moth/get_overlays(mob/living/simple_animal/robot_customer/customer)
	...
	var/mutable_appearance/wings_front = mutable_appearance(icon = 'icons/mob/humanoid/moth/moth_wings.dmi', icon_state = "m_moth_wings_[wings.icon_state]_FRONT")
