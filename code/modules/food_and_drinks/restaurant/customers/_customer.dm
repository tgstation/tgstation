/datum/customer_data
	...
	var/speech_sound = 'sound/mobs/creatures/tourist/tourist_talk.ogg'
...
/datum/customer_data/french
	...
	speech_sound = 'sound/mobs/creatures/tourist/tourist_talk_french.ogg'
	orderable_objects = list(
		VENUE_RESTAURANT = list(
...
/datum/customer_data/japanese
	...
	speech_sound = 'sound/mobs/creatures/tourist/tourist_talk_japanese1.ogg'
	orderable_objects = list(
		VENUE_RESTAURANT = list(
...
/datum/customer_data/japanese/salaryman
	...
	speech_sound = 'sound/mobs/creatures/tourist/tourist_talk_japanese2.ogg'
	orderable_objects = list(
		VENUE_RESTAURANT = list(
...
/datum/customer_data/moth
	...
	speech_sound = 'sound/mobs/creatures/tourist/tourist_talk_moth.ogg'
...
/datum/customer_data/mexican
	...
	speech_sound = 'sound/mobs/creatures/tourist/tourist_talk_mexican.ogg'
...
/datum/customer_data/british
	...
	speech_sound = 'sound/mobs/creatures/tourist/tourist_talk_british.ogg'
