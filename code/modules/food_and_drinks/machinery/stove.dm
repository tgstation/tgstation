/obj/machinery/stove
	name = "stove"
	ru_names = RU_NAMES_LIST_INIT("stove", "плита", "плиты", "плите", "плиту", "плитой", "плите")
...
/obj/item/reagent_containers/cup/soup_pot
	name = "soup pot"
	ru_names = RU_NAMES_LIST_INIT("soup pot", "кастрюля", "кастрюли", "кастрюле", "кастрюлю", "кастрюлей", "кастрюле")
