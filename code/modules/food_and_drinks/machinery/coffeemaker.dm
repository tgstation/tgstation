...
/obj/machinery/coffeemaker
	...
	var/static/radial_brew = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_brew"))
	var/static/radial_eject_pot = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_eject_pot"))
	var/static/radial_eject_cartridge = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_eject_cartridge"))
	var/static/radial_take_cup = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_take_cup"))
	var/static/radial_take_sugar = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_take_sugar"))
	var/static/radial_take_sweetener = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_take_sweetener"))
	var/static/radial_take_creamer = STATIC_INIT(image(icon = 'icons/hud/radial_coffee.dmi', icon_state = "radial_take_creamer"))
