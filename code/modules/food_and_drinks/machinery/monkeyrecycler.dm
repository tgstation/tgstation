...
/obj/machinery/monkey_recycler/proc/stuff_monkey_in(mob/living/carbon/human/target, mob/living/user)
	...
	PLAYSOUND(src.loc, 'sound/machines/juicer.ogg').volume(50).vary_frequency(TRUE).play()
...
/obj/machinery/monkey_recycler/interact(mob/user)
	if(stored_matter >= 1)
		...
		PLAYSOUND(src.loc, 'sound/machines/hiss.ogg').volume(50).vary_frequency(TRUE).play()
