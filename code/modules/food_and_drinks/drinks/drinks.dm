...
/obj/item/reagent_containers/food/drinks/soda_bottle/rattsi
	name = "Rattsi"
	desc = "A health tonic turned soft drink created in Opsilon, Tizira. Some lizardpeople are disgusted by it's unusual ingredients, but it maintains nationalistic popularity amongst Opsiloners."
	icon_state = "rattsi"
