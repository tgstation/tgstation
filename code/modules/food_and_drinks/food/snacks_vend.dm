...
/obj/item/reagent_containers/food/snacks/sosjerky
	...
	list_reagents = list("nutriment" = 1, "sugar" = 3, /datum/reagent/consumable/sodiumchloride = 2)
	junkiness = 25
...
/obj/item/reagent_containers/food/snacks/chips
	...
	bitesize = 1
	list_reagents = list("nutriment" = 1, "sugar" = 3, /datum/reagent/consumable/sodiumchloride = 1)
	junkiness = 20
