/obj/item/food
	var/list/initial_reagents = list(/datum/reagent/nutriment = 1)
	var/food_flags = NONE
	var/food_types = NONE
	var/volume 50
	var/eat_time = 30
	var/list/tastes = "poo"
	var/list/eatverbs = list("bite","chew","nibble","gnaw","gobble","chomp")
	var/bite_consumption = 2
	var/customizable_food_ingredient = TRUE
	var/filling_color = "#000000"

/obj/item/food/Initialize()
	setup_edible_component()

/obj/item/food/proc/setup_edible_component(datum/callback/after_eat)
	Initialize(initial_reagents, food_flags, foodtypes, volume, eat_time, tastes, eatverbs, bite_consumption, customizable_food_ingredient, filling_color, after_eat)

/obj/item/food/burger
	icon = 'icons/obj/food/burgerbread.dmi'
	icon_state = "hburger"
	eatverbs = 3
	initial_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/nutriment/vitamin = 1)
