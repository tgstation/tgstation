...
/obj/item/reagent_containers/food/snacks/meat/slab/bear
	...
	icon_state = "bearmeat"
	list_reagents = list(/datum/reagent/consumable/nutriment = 12, /datum/reagent/drug/opioid/morphine = 5, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/cooking_oil = 6)
