	...
	if(istype(I, /obj/item/reagent_containers/food/snacks))
		...
		if(I.w_class > WEIGHT_CLASS_SMALL)
			...
			if(reagents.has_reagent(/datum/reagent/water, 10)) //are we starting a soup or a salad?
				var/obj/item/reagent_containers/food/snacks/customizable/A = new/obj/item/reagent_containers/food/snacks/customizable/soup(drop_location())
				A.initialize_custom_food(src, S, user)
			else
				var/obj/item/reagent_containers/food/snacks/customizable/A = new/obj/item/reagent_containers/food/snacks/customizable/salad(drop_location())
				A.initialize_custom_food(src, S, user)
	else
		. = ..()
	return
