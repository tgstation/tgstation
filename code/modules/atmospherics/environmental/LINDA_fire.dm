...
/obj/effect/hotspot/proc/update_color()
	...
	if(temperature > 4500000) //This is where noblium happens. Some fusion-y effects.
		...
		var/mutable_appearance/fusion_overlay = mutable_appearance('icons/turf/floor_overlays/atmospherics.dmi', "fusion_gas")
		fusion_overlay.blend_mode = BLEND_ADD
		fusion_overlay.alpha = fusion_amt * 255
		var/mutable_appearance/rainbow_overlay = mutable_appearance('icons/ui/hud/screen_gen.dmi', "druggy")
