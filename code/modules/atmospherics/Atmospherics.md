...
If you aren't familiar with the default subsystem stats, you can see them explained here: [MC Tab Guide](https://github.com/tgstation/tgstation/blob/master/.github/guides/MC_tab.md)
