...
/datum/gas_recipe/crystallizer/shard
	...
	min_temp = 0.1 * FUSION_MAXIMUM_TEMPERATURE
	max_temp = 2.1 * FUSION_MAXIMUM_TEMPERATURE
	energy_release = -3e10
	dangerous = TRUE
