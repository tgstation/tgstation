...
//7 reworks
	...
	m_nitrium = moderator_internal.gases[/datum/gas/nitrium][MOLES]
	...
	var/scaled_m_nitrium = max((m_nitrium - FUSION_MOLE_THRESHOLD) / scale_factor, 0)
