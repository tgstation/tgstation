...
/obj/machinery/atmospherics/components/unary/hypertorus/core/proc/play_ambience()
	...
	if(last_accent_sound < world.time && prob(20))
		...
		if(critical_threshold_proximity >= 300)
			playsound(src, SFX_HYPERTORUSMELTING, max(50, aggression), FALSE, 40, 30, falloff_distance = 10)
		else
			playsound(src, SFX_HYPERTORUSCALM, max(50, aggression), FALSE, 25, 25, falloff_distance = 10)
