...
/obj/machinery/atmospherics/components/update_icon()
	...
	for(var/i in 1 to device_type) //adds intact pieces
		...
		var/mutable_appearance/pipe_appearance = mutable_appearance('icons/obj/pipes_n_cables/pipes/pipe_underlays.dmi', "intact_[node_dir]_[underlay_pipe_layer]")
	...
	for(var/direction in GLOB.cardinals)
		if((initialize_directions & direction) && !(connected & direction))
			var/mutable_appearance/pipe_appearance = mutable_appearance('icons/obj/pipes_n_cables/pipes/pipe_underlays.dmi', "exposed_[direction]_[underlay_pipe_layer]")
