/obj/machinery/atmospherics/pipe/bridge_pipe
	icon = 'icons/obj/pipes_n_cables/pipes/bridge_pipe.dmi'
...
/obj/machinery/atmospherics/pipe/bridge_pipe/update_overlays()
	. = ..()
	var/mutable_appearance/center = mutable_appearance('icons/obj/pipes_n_cables/pipes/bridge_pipe.dmi', "bridge_center")
