/obj/machinery/atmospherics/pipe/layer_manifold
	name = "layer adaptor"
	icon = 'icons/obj/pipes_n_cables/pipes/manifold.dmi'
...
/obj/machinery/atmospherics/pipe/layer_manifold/proc/get_attached_image(p_dir, p_layer, p_color)
	var/mutable_appearance/muta = mutable_appearance('icons/obj/pipes_n_cables/pipes/layer_manifold_underlays.dmi', "intact_[p_dir]_[p_layer]", layer = layer - 0.01, appearance_flags = RESET_COLOR)
	muta.color = p_color
	return muta
