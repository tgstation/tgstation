/obj/machinery/atmospherics/pipe/color_adapter
	icon = 'icons/obj/pipes_n_cables/pipes/color_adapter.dmi'
...
/obj/machinery/atmospherics/pipe/color_adapter/update_overlays()
	...
	for(var/i in 1 to device_type)
		if(!nodes[i])
			continue
		var/image/pipe = get_pipe_image('icons/obj/pipes_n_cables/pipes/manifold.dmi', "pipe-3", get_dir(src, nodes[i]), nodes[i].pipe_color)
