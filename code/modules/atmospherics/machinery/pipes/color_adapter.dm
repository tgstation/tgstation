...
/obj/machinery/atmospherics/pipe/color_adapter/update_overlays()
	...
	for(var/i in 1 to device_type)
		...
		if (istype(nodes[i], /obj/machinery/atmospherics/pipe/color_adapter) && ((node_dir & (SOUTH|EAST)) || nodes[i].pipe_color == COLOR_VERY_LIGHT_GRAY) && pipe_color != COLOR_VERY_LIGHT_GRAY)
