/obj/machinery/portable_atmospherics/scrubber
	...
	var/list/scrubbing = list(/datum/gas/plasma, /datum/gas/carbon_dioxide, /datum/gas/nitrous_oxide, /datum/gas/bz, /datum/gas/freon, /datum/gas/tritium, /datum/gas/hypernoblium, /datum/gas/water_vapor)
