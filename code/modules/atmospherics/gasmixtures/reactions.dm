...
/datum/gas_reaction/nobliumformation/react(datum/gas_mixture/air)
	...
	cached_gases[/datum/gas/tritium][MOLES] -= 5 * nob_formed * (min(nob_formed/max(cached_gases[/datum/gas/bz][MOLES], nob_formed), 1)) //bz reduces the trit consumption the more mols there are
