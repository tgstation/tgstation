...
/datum/gas_reaction/nobliumformation/react(datum/gas_mixture/air)
	...
	cached_gases[/datum/gas/tritium][MOLES] -= 5 * nob_formed * (min(nob_formed/max(cached_gases[/datum/gas/bz][MOLES], nob_formed), 1)) //bz acts as a catalyst and substitue for trit
	...
	cached_gases[/datum/gas/bz][MOLES] -= 5 * nob_formed //bz will be consumed to reduce trit consumption, value might need to be tweaked
