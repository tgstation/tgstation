...
/proc/init_gas_reactions()
	...
	for(var/datum/gas_reaction/reaction as anything in subtypesof(/datum/gas_reaction))
		...
		if(reaction.blocks_reactions)
			blocking_reactions += reaction
		else
			reactions[reaction_key] += reaction
			sortTim(reactions[reaction_key], /proc/cmp_gas_reaction)
	...
	return list(blocking_reactions, reactions, all_reactions, priority_reactions)
