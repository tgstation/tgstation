...
/datum/addiction/nicotine
	name = "nicotine"
	withdrawal_stage_messages = list("Feel like having a smoke...", "Can't concentrate. Really need a smoke now.", "I can't take it! Need a smoke NOW!")
...
/datum/addiction/nicotine/withdrawal_stage_2_process(mob/living/carbon/affected_carbon, delta_time)
	. = ..()
	affected_carbon.Jitter(10 * delta_time)
	SEND_SIGNAL(affected_carbon, COMSIG_ADD_MOOD_EVENT, "depression_minimal", /datum/mood_event/depression_minimal)
	if(DT_PROB(10, delta_time))
		affected_carbon.emote("cough")
...
/datum/addiction/nicotine/withdrawal_stage_3_process(mob/living/carbon/affected_carbon, delta_time)
	. = ..()
	affected_carbon.Jitter(15 * delta_time)
	SEND_SIGNAL(affected_carbon, COMSIG_ADD_MOOD_EVENT, "depression_moderate", /datum/mood_event/depression_moderate)
	if(DT_PROB(15, delta_time))
		affected_carbon.emote("cough")
