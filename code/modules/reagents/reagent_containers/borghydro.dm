...
/obj/item/reagent_containers/borghypo/syndicate
	...
	charge_cost = 20
	recharge_time = 2
	reagent_ids = list(/datum/reagent/medicine/syndicate_nanites, /datum/reagent/medicine/potass_iodide, /datum/reagent/medicine/opioid/morphine)
	bypass_protection = 1
	accepts_reagent_upgrades = FALSE
...
/obj/item/reagent_containers/borghypo/peace/hacked
	...
	icon_state = "borghypo_s"
	reagent_ids = list(/datum/reagent/peaceborg/confuse,/datum/reagent/peaceborg/tire,/datum/reagent/pax/peaceborg,/datum/reagent/toxin/staminatoxin,/datum/reagent/toxin/sulfonal,/datum/reagent/toxin/sodium_thiopental,/datum/reagent/toxin/cyanide,/datum/reagent/medicine/opioid/fentanyl)
	accepts_reagent_upgrades = FALSE
