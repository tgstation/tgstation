...
/obj/item/reagent_containers/borghypo
	...
	var/list/reagent_ids = list(/datum/reagent/medicine/C2/perfluorodecalin, /datum/reagent/medicine/C2/acetaminophen, /datum/reagent/medicine/C2/palletta, /datum/reagent/medicine/C2/neomycin_sulfate, /datum/reagent/medicine/epinephrine, /datum/reagent/medicine/spaceacillin, /datum/reagent/medicine/salglu_solution)
