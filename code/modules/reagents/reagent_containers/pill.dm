...
/obj/item/reagent_containers/pill/adminordrazine
	...
	icon_state = "pill16"
	list_reagents = list(/datum/reagent/medicine/adminordrazine = 50) //It's a magic pill it can hold more than 15U
...
/obj/item/reagent_containers/pill/maintenance //Maint pills can be big and magical too
