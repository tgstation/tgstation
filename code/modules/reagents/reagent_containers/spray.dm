...
/obj/item/weapon/reagent_containers/spray/afterattack(atom/A as mob|obj, mob/user as mob)
	...
	user.changeNext_move(CLICK_CD_RANGE*3)
	...
	if(reagents.has_reagent("kekeacid"))
		message_admins("[key_name_admin(user)] fired Keke acid from \a [src].")
		log_game("[key_name(user)] fired Keke acid from \a [src].")
