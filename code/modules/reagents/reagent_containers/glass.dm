...
/obj/item/reagent_containers/glass/beaker/large/libital
	...
	list_reagents = list(/datum/reagent/medicine/C2/libital = 10,/datum/reagent/medicine/acetaminophen = 40)

/obj/item/reagent_containers/glass/beaker/large/aiuri
	name = "aiuri reserve tank (diluted)"
	list_reagents = list(/datum/reagent/medicine/C2/aiuri = 10, /datum/reagent/medicine/acetaminophen = 40)

/obj/item/reagent_containers/glass/beaker/large/multiver
	name = "multiver reserve tank (diluted)"
	list_reagents = list(/datum/reagent/medicine/C2/multiver = 10, /datum/reagent/medicine/acetaminophen = 40)

/obj/item/reagent_containers/glass/beaker/large/epinephrine
	name = "epinephrine reserve tank (diluted)"
	list_reagents = list(/datum/reagent/medicine/epinephrine = 50)

/obj/item/reagent_containers/glass/beaker/syniphen
	list_reagents = list(/datum/reagent/medicine/C2/syniphen = 50)
