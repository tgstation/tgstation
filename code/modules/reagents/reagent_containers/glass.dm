...
/obj/item/reagent_containers/glass/bucket
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 75, ACID = 50) //Weak melee protection, because you can wear it on your head
...
/obj/item/reagent_containers/glass/bucket/wooden
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 0, ACID = 50)
