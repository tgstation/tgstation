...
/obj/item/reagent_containers/glass/bottle/palletta
	name = "palletta bottle"
	desc = "A small bottle of palletta, which removes toxins and other chemicals from the bloodstream but causes shortness of breath. All effects scale with the amount of reagents in the patient."
	list_reagents = list(/datum/reagent/medicine/C2/palletta = 30)
...
/obj/item/reagent_containers/glass/bottle/tuberculosiscure
	...
	list_reagents = list(/datum/reagent/medicine/atropine = 5, /datum/reagent/medicine/epinephrine = 5, /datum/reagent/medicine/C2/perfluorodecalin = 10, /datum/reagent/medicine/spaceacillin = 10)
