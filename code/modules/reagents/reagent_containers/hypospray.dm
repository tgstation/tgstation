...
/obj/item/weapon/reagent_containers/hypospray/medipen/stimpack
	...
	desc = "A rapid way to stimulate your body's adrenaline, allowing for freer movement in bulky clothing at the cost of blood pollution."
	icon_state = "stimpen"
...
/obj/item/weapon/reagent_containers/hypospray/medipen/stimpack/New()
	...
	reagents.add_reagent("synaptizine", 2)
	update_icon()
	return