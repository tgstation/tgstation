...
/obj/item/reagent_containers/hypospray/medipen/tuberculosiscure
	...
	list_reagents = list(/datum/reagent/medicine/atropine = 10, /datum/reagent/medicine/epinephrine = 10, /datum/reagent/medicine/omnizine = 20, /datum/reagent/medicine/salbutamol = 15, /datum/reagent/medicine/spaceacillin = 20)
