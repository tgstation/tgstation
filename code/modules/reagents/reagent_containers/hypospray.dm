...
/obj/item/weapon/reagent_containers/hypospray/medipen/survival
	...
	icon_state = "stimpen"
	volume = 81
	amount_per_transfer_from_this = 81
	list_reagents = list("nanites" = 1, "salbutamol" = 10, "coffee" = 20, "leporazine" = 20, "tricordrazine" = 15, "epinephrine" = 10, "omnizine" = 5, "stimulants" = 10)
