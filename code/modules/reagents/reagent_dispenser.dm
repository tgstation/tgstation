...
/obj/structure/reagent_dispensers/fueltank/attackby(obj/item/I, mob/living/user, params)
	if(I.tool_behaviour == TOOL_WELDER)
		...
		if(!W.welding)
			...
			user.visible_message("<span class='none'>[user] refills [user.p_their()] [W.name].</span>", "<span class='notice'>You refill [W].</span>")
...
/obj/structure/reagent_dispensers/water_cooler/attack_hand(mob/living/user)
	...
	if(!paper_cups)
		...
		return
	user.visible_message("<span class='none'>[user] takes a cup from [src].</span>", "<span class='notice'>You take a paper cup from [src].</span>")
