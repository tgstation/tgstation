...
/obj/structure/reagent_dispensers/fueltank/attackby(obj/item/I, mob/user, params, prevent_warning = 0)
	if((istype(I, /obj/item/weapon/weldingtool) || /obj/item/weapon/weldingtool/largetank || /obj/item/weapon/weldingtool/largetank/cyborg || /obj/item/weapon/weldingtool/mini || /obj/item/weapon/weldingtool/hugetank || /obj/item/weapon/weldingtool/experimental || /obj/item/weapon/weldingtool/experimental/brass)
		var/safety = alert(user, "Attacking a fuel tank with a welding tool suddenly seems like a very bad idea...", "Proceed", "Abort")
