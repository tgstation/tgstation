...
/obj/structure/reagent_dispensers/proc/boom()
	...
	if(fuel_amt) // with that done, actually explode
		...
		// big fuel tank =MINERAL_MATERIAL_AMOUNT * 2.5 units = devastation_range = 1, heavy_impact_range = 2, light_impact_range = 7, flame_range = 12
...
/obj/structure/reagent_dispensers/fueltank/large
	...
	tank_volume =MINERAL_MATERIAL_AMOUNT * 2.5
