...
datum/reagent/drug/happyhappy/on_mob_life(mob/living/M)
        ...
        M.AdjustStunned(-5)
        M.AdjustParalysis(-5)
        M.radiation = max(0,M.radiation - 3) //was -= 3, need to ask Remmie why.
...
datum/reagent/drug/happyhappy/proc/disturbing_messages(mob/living/M) //added mob/living/M, doesn't work without it.
