...
/datum/reagent/inverse/neurine/on_mob_life(mob/living/carbon/owner, delta_time, times_fired)
	...
	var/list/forbiddentraumas = list(
		...
		/datum/brain_trauma/hypnosis // Hypnosis, antag nonsense, plus a bug makes it remain even after the neurowhine purges and then turn into "nothing" on the med reading upon a second application
	)
