...
/datum/reagent/toxin/plantbgone/expose_obj(obj/exposed_obj, reac_volume, methos=TOUCH, show_message=TRUE)
	. = ..()
...
/datum/reagent/toxin/acid/expose_obj(obj/exposed_obj, reac_volume, methos=TOUCH, show_message=TRUE)
	. = ..()
