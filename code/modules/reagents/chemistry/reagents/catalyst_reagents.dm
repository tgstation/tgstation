...
/datum/reagent/catalyst_agent
	...
	/// The minimumvolume needed in the beaker for them to have an effect
	var/min_volume = 10
...
/// Catalyst precursors (oh boy here i go competing again).. P is the harder one to make, that is needs a good heater or some extra materials), because it is probably more useful
