...
/datum/reagent/consumable/ethanol/reaction_obj(obj/O, reac_volume)
	...
	if(istype(O, /obj/item/book))
		if(reac_volume >= 5)
			...
			O.visible_message("<span class='notice'>\The [O]'s writing is washed away by [id]!</span>")
		else
			O.visible_message("<span class='warning'>\The [O]'s ink is smeared by [id], but doesn't wash away!</span>")
	return
