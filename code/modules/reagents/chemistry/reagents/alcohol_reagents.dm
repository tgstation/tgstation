...
/datum/reagent/consumable/ethanol/kahlua/on_mob_life(mob/living/carbon/drinker, delta_time, times_fired)
	drinker.adjust_timed_status_effect(10 SECONDS * REM * delta_time, /datum/status_effect/dizziness)
...
/datum/reagent/consumable/ethanol/atomicbomb/on_mob_life(mob/living/carbon/drinker, delta_time, times_fired)
	...
	drinker.adjust_timed_status_effect(20 SECONDS * REM * delta_time, /datum/status_effect/dizziness)
...
/datum/reagent/consumable/ethanol/hippies_delight/on_mob_life(mob/living/carbon/drinker, delta_time, times_fired)
	...
	switch(current_cycle)
		...
		if(5 to 10)
			...
			drinker.adjust_timed_status_effect(40 SECONDS * REM * delta_time, /datum/status_effect/dizziness)
			drinker.set_drugginess(45 * REM * delta_time)
			if(DT_PROB(10, delta_time))
				drinker.emote(pick("twitch","giggle"))
		if (10 to 200)
			drinker.Jitter(40 * REM * delta_time)
			drinker.adjust_timed_status_effect(80 SECONDS * REM * delta_time, /datum/status_effect/dizziness)
			drinker.set_drugginess(60 * REM * delta_time)
			if(DT_PROB(16, delta_time))
				drinker.emote(pick("twitch","giggle"))
		if(200 to INFINITY)
			drinker.Jitter(60 * REM * delta_time)
			drinker.adjust_timed_status_effect(120 SECONDS * REM * delta_time, /datum/status_effect/dizziness)
