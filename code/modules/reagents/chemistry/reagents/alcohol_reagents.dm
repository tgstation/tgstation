...
/datum/reagent/consumable/ethanol/e_tank
	name = "E Tank"
	description = "A weirdly named energy drink. Tastes tropical and refills your energy!"
	boozepwr = 90 //robots may not feel it but this is STRONG
	color = "#5555FF"
	quality = DRINK_FANTASTIC //atleast its a good drink
	taste_description = "tropical energy"
	glass_icon_state = "etank"
	glass_name = "E Tank"
	glass_desc = "A weirdly named energy drink can. Tastes tropical and refills your energy!"
	metabolization_rate = 2.5 * REAGENTS_METABOLISM //goes away quickly, 1u for 2 stamina heals.
