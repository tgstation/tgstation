...
/datum/reagent/unstableslimetoxin/on_mob_life(mob/living/carbon/human/H)
	...
	H.Weaken(3)
	sleep(30)
	var/list/blacklisted_species = list(/datum/species/zombie, /datum/species/skeleton, /datum/species/golem, /datum/species/golem/adamantine, /datum/species/shadow, /datum/species/shadow/ling, /datum/species/shadow/ling/lesser, /datum/species/plasmaman, /datum/species/plasmaman/skin)
