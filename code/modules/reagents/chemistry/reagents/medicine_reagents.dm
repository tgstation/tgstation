...
/datum/reagent/medicine/oxandrolone/on_mob_life(mob/living/carbon/M)
	if(M.getFireLoss() > 50)
		M.adjustFireLoss(-4*REM, 0) //Twice as effective as kelotane for severe burns
	else
...
/datum/reagent/medicine/sal_acid/on_mob_life(mob/living/carbon/M)
	if(M.getBruteLoss() > 50)
		M.adjustBruteLoss(-4*REM, 0) //Twice as effective as bicaridine for severe bruising
	else
