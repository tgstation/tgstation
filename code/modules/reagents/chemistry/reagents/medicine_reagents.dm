...
/datum/reagent/medicine/polypyr/on_mob_life(mob/living/carbon/M) //I wánted a collection of small positive effects, this is as hard to obtain as coniine after all.
