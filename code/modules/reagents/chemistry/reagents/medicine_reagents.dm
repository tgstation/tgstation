...
// regen jelly with less regen potential but slower metabolism - basically just toxlover-friendly omnizine that also makes you pink
// exists solely for balance reasons
/datum/reagent/medicine/regen_jelly/weakened
