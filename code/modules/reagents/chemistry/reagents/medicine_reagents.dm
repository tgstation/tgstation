...
/datum/reagent/medicine/adminordrazine //An OP chemical for admins
	...
	var/full_heal_flags = ~(HEAL_BRUTE|HEAL_BURN|HEAL_TOX|HEAL_RESTRAINTS|HEAL_ORGANS|HEAL_HUNGER)
...
/datum/reagent/medicine/adminordrazine/quantum_heal
	...
	full_heal_flags = ~(HEAL_ADMIN|HEAL_BRUTE|HEAL_BURN|HEAL_TOX|HEAL_RESTRAINTS|HEAL_ALL_REAGENTS|HEAL_ORGANS|HEAL_HUNGER)
