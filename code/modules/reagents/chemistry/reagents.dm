...
/datum/reagent/proc/expose_obj(obj/exposed_obj, methods=TOUCH, reac_volume, show_message=TRUE)
	SHOULD_CALL_PARENT(TRUE)

	return SEND_SIGNAL(src, COMSIG_REAGENT_EXPOSE_OBJ, exposed_obj, methods, reac_volume, show_message)
