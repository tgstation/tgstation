/obj/machinery/reagentgrinder
		...
		var/list/juice_items = list (
				...
				/obj/item/weapon/reagent_containers/food/snacks/grown/watermelon = list("brawndomelonjuice" = 0),
				/obj/item/weapon/reagent_containers/food/snacks/brawndomelonslice = list("brawndomelonjuice" = 0),
