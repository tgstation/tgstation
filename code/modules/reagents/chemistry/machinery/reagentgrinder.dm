...
/obj/machinery/reagentgrinder
	...
	var/static/radial_grind = STATIC_INIT(image(icon = 'icons/hud/radial.dmi', icon_state = "radial_grind"))
	var/static/radial_juice = STATIC_INIT(image(icon = 'icons/hud/radial.dmi', icon_state = "radial_juice"))
	var/static/radial_mix = STATIC_INIT(image(icon = 'icons/hud/radial.dmi', icon_state = "radial_mix"))
