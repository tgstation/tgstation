...
/obj/machinery/chem_heater/process()
	...
	if(on)
		if(beaker && beaker.reagents.total_volume)
			...
			beaker.reagents.adjust_thermal_energy((target_temperature - beaker.reagents.chem_temp) * heater_coefficient * SSMACHINES_DT * SPECIFIC_HEAT_DEFAULT * beaker.reagents.total_volume)
