...
/datum/chemical_reaction/itching_powder
	...
	//required_reagents = list(/datum/reagent/fuel = 1, /datum/reagent/ammonia = 1, /datum/reagent/medicine/C2/multiver = 1) austation -- trekchems added back. Changes in equiv file in austation dir
...
/datum/chemical_reaction/mindbreaker
	...
	//required_reagents = list(/datum/reagent/silicon = 1, /datum/reagent/hydrogen = 1, /datum/reagent/medicine/C2/multiver = 1) austation -- trekchems added back. Changes in equiv file in austation dir
