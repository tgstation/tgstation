...
/datum/chemical_reaction/itching_powder
	...
	required_reagents = list(/datum/reagent/fuel = 1, /datum/reagent/ammonia = 1, /datum/reagent/medicine/C2/palletta = 1)
...
/datum/chemical_reaction/mindbreaker
	...
	required_reagents = list(/datum/reagent/silicon = 1, /datum/reagent/hydrogen = 1, /datum/reagent/medicine/C2/palletta = 1)
