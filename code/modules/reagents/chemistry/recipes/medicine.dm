...
/datum/chemical_reaction/mine_salve2
	...
	required_reagents = list("plasma" = 5, /datum/reagent/iron = 5, /datum/reagent/consumable/sugar = 1) // A sheet of plasma, a twinkie and a sheet of metal makes four of these
