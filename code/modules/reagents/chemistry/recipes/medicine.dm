...
/datum/chemical_reaction/trophazole
	...
	results = list(/datum/reagent/medicine/trophazole = 3)
	required_reagents = list(/datum/reagent/copper = 1, /datum/reagent/acetone = 2,  /datum/reagent/phosphorus = 1, /datum/reagent/consumable/enzyme = 1)
...
/datum/chemical_reaction/rhigoxane
	...
	required_reagents = list(/datum/reagent/cryostylane = 3, /datum/reagent/bromine = 1, /datum/reagent/lye = 1, /datum/reagent/consumable/enzyme = 1)
	required_temp = 47
	is_cold_recipe = TRUE
...
/datum/chemical_reaction/calomel
	...
	results = list(/datum/reagent/medicine/calomel = 1)
	required_reagents = list(/datum/reagent/consumable/tea = 1, /datum/reagent/medicine/C2/multiver = 1)
	required_temp = 374

/datum/chemical_reaction/potass_iodide //technically rads but rads do tox so *wink*
...
/datum/chemical_reaction/instabitaluri
	...
	results = list(/datum/reagent/medicine/C2/instabitaluri = 1)
