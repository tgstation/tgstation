...
/datum/chemical_reaction/medicine/lamphrite
	results = list(/datum/reagent/medicine/lamphrite = 3)
	required_reagents = list(/datum/reagent/phenol = 2, /datum/reagent/mercury = 1)
	reaction_tags = REACTION_TAG_EASY | REACTION_TAG_HEALING | REACTION_TAG_ORGAN
