...
/datum/chemical_reaction/medsuture
	required_reagents = list(/datum/reagent/cellulose = 10, /datum/reagent/toxin/formaldehyde = 10, /datum/reagent/medicine/C2/libital = 20)
...
/datum/chemical_reaction/medmesh
	required_reagents = list(/datum/reagent/cellulose = 10, /datum/reagent/consumable/aloejuice = 10, /datum/reagent/medicine/C2/aiuri = 20)
