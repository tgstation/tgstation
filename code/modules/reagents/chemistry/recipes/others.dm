...
/datum/chemical_reaction/foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam, 3 * created_volume, notification = span_danger("The solution spews out foam!"))
	reaction_tags = REACTION_TAG_EASY | REACTION_TAG_UNIQUE
...
/datum/chemical_reaction/metalfoam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal, 7.5 * created_volume, /obj/structure/foamedmetal, span_danger("The solution spews out a metallic foam!"))
...
/datum/chemical_reaction/smart_foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal/smart, 7.5 * created_volume, /obj/structure/foamedmetal, span_danger("The solution spews out metallic foam!"))
...
/datum/chemical_reaction/ironfoam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal/iron, 7.5 * created_volume, /obj/structure/foamedmetal/iron, span_danger("The solution spews out a metallic foam!"))
