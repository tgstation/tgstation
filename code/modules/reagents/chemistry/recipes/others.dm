...
/datum/chemical_reaction/scream
	...
	required_temp = 500
	mix_message = "The mixture bubbles explodes into violent scream!"
...
/datum/chemical_reaction/scream/mega/on_reaction(datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/mob/living/carbon/S in get_hearers_in_view(created_volume*3, location))
		playsound(S.loc, pick(list( 'sound/voice/human/malescream_1.ogg', 'sound/voice/human/malescream_2.ogg', 'sound/voice/human/malescream_3.ogg', 'sound/voice/human/malescream_4.ogg', 'sound/voice/human/malescream_5.ogg', 'sound/voice/human/malescream_6.ogg', 'sound/voice/human/femalescream_1.ogg', 'sound/voice/human/femalescream_2.ogg', 'sound/voice/human/femalescream_3.ogg', 'sound/voice/human/femalescream_4.ogg', 'sound/voice/human/femalescream_5.ogg', 'sound/voice/human/wilhelm_scream.ogg')), 5,TRUE)
	for(var/mob/living/carbon/C in get_hearers_in_view(created_volume, location))
