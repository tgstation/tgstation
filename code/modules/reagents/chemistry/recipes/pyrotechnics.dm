...
/datum/chemical_reaction/reagent_explosion/holyboom/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	if(created_volume >= 150)
		...
		PLAYSOUND(T, 'sound/effects/pray.ogg').vlume(80).vary_frequency(FALSE).range(SOUND_RANGE + effective_size).play()
...
/datum/chemical_reaction/beesplosion/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	...
	if(created_volume < 5)
		PLAYSOUND(location, 'sound/effects/sparks/sparks1.ogg').volume(100).vary_frequency(TRUE).play()
	else
		PLAYSOUND(location, 'sound/mobs/non-humanoids/bee/bee.ogg').volume(100).vary_frequency(TRUE).play()
...
/datum/chemical_reaction/sonic_powder/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	...
	var/location = get_turf(holder.my_atom)
	PLAYSOUND(location, 'sound/effects/bang.ogg').volume(25).vary_frequency(TRUE).play()
