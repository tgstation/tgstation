...
/datum/chemical_reaction/proc/chemical_mob_spawn(datum/reagents/holder, amount_to_spawn, reaction_name, mob_class = HOSTILE_SPAWN, mob_faction = "chemicalsummon")
	if(holder && holder.my_atom)
		...
		log_game("[reaction_name] chemical mob spawn reaction occuring at [COORD(T)]([T.area]) carried by [M]([M.ckey]) with last fingerprint [A.fingerprintslast? A.fingerprintslast : "N/A"]")
