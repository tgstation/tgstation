...
// HIPPIESTART: Mirrored this function in <hippiestation\code\modules\reagents\chem_splash.dm> for <reducing the duplication of solid and turchchems by refactoring chem splash code to use a particle_effect holder atom akin to smoke>
/*
