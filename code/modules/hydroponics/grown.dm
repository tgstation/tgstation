...
/obj/item/reagent_containers/food/snacks/grown
	...
	var/distill_reagent = null //If NULL and this object can be distilled, it uses a generic fruit_wine reagent and adjusts its variables.
	var/wine_flavor = null //If NULL, this is automatically set to the fruit's flavor. Determines the flavor of the wine if distill_reagent is NULL.
