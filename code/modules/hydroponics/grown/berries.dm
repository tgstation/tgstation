...
/obj/item/seeds/berry/poison
	...
	reagents_add = list(/datum/reagent/toxin/cyanide = 0.15, /datum/reagent/toxin/staminatoxin = 0.2, "vitamin" = 0.04, "nutriment" = 0.1)
...
/obj/item/seeds/berry/death
	...
	potency = 50
	mutatelist = list()
	reagents_add = list(/datum/reagent/toxin/coniine = 0.08, /datum/reagent/toxin/staminatoxin = 0.1, "vitamin" = 0.04, "nutriment" = 0.1)
	rarity = 30
...
/obj/item/seeds/berry/glow
	...
	reagents_add = list("uranium" = 0.25, /datum/reagent/iodine = 0.2, "vitamin" = 0.04, "nutriment" = 0.1)
	rarity = 20
