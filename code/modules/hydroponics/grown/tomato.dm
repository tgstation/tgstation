...
/obj/item/seeds/tomato/blood
	...
	mutatelist = list()
	reagents_add = list("blood" = 0.2, "vitamin" = 0.08, "nutriment" = 0.2)
	rarity = 20
...
/obj/item/seeds/tomato/blue
	...
	reagents_add = list("lube" = 0.2, "vitamin" = 0.08, "nutriment" = 0.2)
	rarity = 20
...
/obj/item/seeds/tomato/blue/bluespace
	...
	reagents_add = list("lube" = 0.2, "bluespace" = 0.2, "vitamin" = 0.08, "nutriment" = 0.2)
	rarity = 50
