...
/obj/item/weapon/reagent_containers/food/snacks/grown/meatwheat/attack_self(mob/living/user)
	user.visible_message("<span class='notice'>[IDENTITY_SUBJECT(1)] crushes [src] into meat.</span>", "<span class='notice'>You crush [src] into something that resembles meat.</span>", subjects=list(user))
