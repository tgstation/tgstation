...
/obj/item/seeds/tea/astra
	...
	mutatelist = list()
	reagents_add = list("synaptizine" = 0.1, "vitamin" = 0.04, /datum/reagent/toxin/teapowder = 0.1)
	rarity = 20
...
/obj/item/reagent_containers/food/snacks/grown/tea/astra
	...
	grind_results = list(/datum/reagent/toxin/teapowder = 0, "salglu_solution" = 0)
...
/obj/item/seeds/coffee
	...
	reagents_add = list("vitamin" = 0.04, /datum/reagent/toxin/coffeepowder = 0.1)
...
/obj/item/seeds/coffee/robusta
	...
	mutatelist = list()
	reagents_add = list("ephedrine" = 0.1, "vitamin" = 0.04, /datum/reagent/toxin/coffeepowder = 0.1)
	rarity = 20
...
/obj/item/reagent_containers/food/snacks/grown/coffee/robusta
	...
	grind_results = list(/datum/reagent/toxin/coffeepowder = 0, "morphine" = 0)
