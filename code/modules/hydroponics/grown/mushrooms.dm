...
/obj/item/seeds/reishi
	...
	//reagents_add = list(/datum/reagent/medicine/morphine = 0.35, /datum/reagent/medicine/C2/multiver = 0.35, /datum/reagent/consumable/nutriment = 0) austation -- trekchems added back. Changes in equiv file in austation dir
