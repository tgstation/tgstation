...
/obj/item/seeds/poppy
	...
	//reagents_add = list(/datum/reagent/medicine/C2/libital = 0.2, /datum/reagent/consumable/nutriment = 0.05) austation -- trekchems added back. Changes in equiv file in austation dir
