...
/obj/item/seeds/kudzu
	...
	//reagents_add = list(/datum/reagent/medicine/C2/multiver = 0.04, /datum/reagent/consumable/nutriment = 0.02) austation -- trekchems added back. Changes in equiv file in austation dir
