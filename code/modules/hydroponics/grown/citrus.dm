...
/obj/item/seeds/orange_3d
	...
	icon_dead = "lime-dead"
	genes = list(/datum/plant_gene/trait/repeated_harvest)
	reagents_add = list(/datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment = 0.05, /datum/reagent/medicine/psyloperidol = 0.15) //insert joke about the effects of psyloperidol and our glorious headcoder here
