...
/obj/item/seeds/ambrosia
	...
	reagents_add = list(/datum/reagent/medicine/oxandrolone = 0.1, /datum/reagent/medicine/sal_acid = 0.1, /datum/reagent/drug/space_drugs = 0.15, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment = 0.05, /datum/reagent/toxin = 0.1)
