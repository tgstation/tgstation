...
/obj/item/seeds/ambrosia
	...
	reagents_add = list(/datum/reagent/medicine/C2/neomycin_sulfate = 0.1, /datum/reagent/medicine/C2/acetaminophen = 0.1 ,/datum/reagent/drug/space_drugs = 0.15, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment = 0.05, /datum/reagent/toxin = 0.1)
