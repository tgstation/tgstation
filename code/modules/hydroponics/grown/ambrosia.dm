...
/obj/item/seeds/ambrosia
	...
	reagents_add = list("space_drugs" = 0.15, "bicaridine" = 0.1, "kelotane" = 0.1, "vitamin" = 0.08, "nutriment" = 0.1, "toxin" = 0.1)
...
/obj/item/seeds/ambrosia/deus
	...
	reagents_add = list("omnizine" = 0.15, "synaptizine" = 0.15, "space_drugs" = 0.1, "vitamin" = 0.08, "nutriment" = 0.1)
	rarity = 40
