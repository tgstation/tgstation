...
/obj/item/seeds/chili
	...
	reagents_add = list("capsaicin" = 0.25, "vitamin" = 0.08, "nutriment" = 0.08)
...
/obj/item/seeds/chili/ice
	...
	rarity = 20
	mutatelist = list()
	reagents_add = list("frostoil" = 0.25, "vitamin" = 0.04, "nutriment" = 0.04)
...
/obj/item/seeds/chili/ghost
	...
	rarity = 20
	mutatelist = list()
	reagents_add = list("condensedcapsaicin" = 0.3, "capsaicin" = 0.55, "nutriment" = 0.08)
