...
/obj/item/seeds/starthistle/corpse_flower/process()
	...
	stank.gases[/datum/gas/miasma][MOLES] = (yield + 6)*3.5*MIASMA_CORPSE_MOLES*SSOBJ_DT // this process is only being called about 2/7 as much as corpses so this is 12-32 times a corpses
