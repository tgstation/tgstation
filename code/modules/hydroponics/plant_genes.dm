...
/datum/plant_gene/trait/slip/on_new_plant(obj/item/our_plant, newloc)
	...
	our_plant.add_component(/datum/component/slippery, min(stun_len, 140), NONE, CALLBACK(src, .proc/handle_slip, our_plant))
...
/datum/plant_gene/trait/glow/on_new_plant(obj/item/our_plant, newloc)
	...
	our_plant.add_component(/datum/component/overlay_lighting, glow_range(our_seed), glow_power(our_seed), glow_color)
