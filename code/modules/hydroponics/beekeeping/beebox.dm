...
#define BEEBOX_MAX_FRAMES				6		//Max frames per box
#define BEES_RATIO						1.5 	//Multiplied by the max number of honeycombs to find the max number of bees
#define BEE_PROB_NEW_BEE				30		//The chance for spare bee_resources to be turned into new bees
...
#define BEE_RESOURCE_NEW_BEE_COST		20		//The amount of bee_resources for a new bee to be produced, percentage cost 1-100
