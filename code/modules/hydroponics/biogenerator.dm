...
/obj/machinery/biogenerator/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		to_chat(user, "<span class='notice'>The status display reads: Efficiency at <b>[efficiency*100]</b>%.<br>Productivity at <b>[productivity*100]%</b><br>Machine can hold up to <b>[max_items]</b> pieces of produce.<span>")
