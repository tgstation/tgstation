...
//Sun/Novaflower
/obj/item/botany/grown/sunflower/attack(mob/M as mob, mob/user as mob)
	M << "<font color='green'><b> [user] smacks you with a sunflower!</font><font color='yellow'><b>FLOWER POWER<b></font>"
	user << "<font color='green'> Your sunflower's </font><font color='yellow'><b>FLOWER POWER</b></font><font color='green'> strikes [M]</font>"

/obj/item/botany/grown/novaflower/attack(mob/living/carbon/M as mob, mob/user as mob)
	if(!..()) return
	if(istype(M, /mob/living))
		M << "\red You are heated by the warmth of the of the [name]!"
		M.bodytemperature += potency/2 * TEMPERATURE_DAMAGE_COEFFICIENT

/obj/item/botany/grown/novaflower/afterattack(atom/A as mob|obj, mob/user as mob)
	if(endurance > 0)
...
/obj/item/botany/grown/novaflower/pickup(mob/living/carbon/human/user as mob)
	if(!user.gloves)
		user << "\red The [name] burns your bare hand!"
		user.adjustFireLoss(rand(1,5))

//Nettle
/obj/item/botany/grown/nettle/pickup(mob/living/carbon/human/user as mob)
	if(!user.gloves)
...
/obj/item/botany/grown/nettle/afterattack(atom/A as mob|obj, mob/user as mob)
	if(force > 0)
...
/obj/item/botany/grown/nettle/changePotency(newValue) //-QualityVan
	potency = newValue
	force = round((5+potency/5), 1)

//Deathnettle
/obj/item/botany/grown/deathnettle/pickup(mob/living/carbon/human/user as mob)
	if(!user.gloves)
		if(istype(user, /mob/living/carbon/human))
			var/organ = ((user.hand ? "l_":"r_") + "arm")
			var/datum/limb/affecting = user.get_organ(organ)
...
/obj/item/botany/grown/deathnettle/attack(mob/living/carbon/M as mob, mob/user as mob)
	if(!..()) return
	if(istype(M, /mob/living))
...
/obj/item/botany/grown/deathnettle/afterattack(atom/A as mob|obj, mob/user as mob)
	if (force > 0)
		force -= rand(1,(force/3)+1) // When you whack someone with it, leaves fall off
...
/obj/item/botany/grown/deathnettle/changePotency(newValue) //-QualityVan
	potency = newValue
	force = round((5+potency/2.5), 1)


//Corncob
/obj/item/trash/corncob/attackby(obj/item/weapon/W as obj, mob/user as mob)
	..()
	if(istype(W, /obj/item/medical/saw) || istype(W, /obj/item/botany/hatchet) || istype(W, /obj/item/kitchen/utensil/knife))
...
//Bluespace Tomatoes
/obj/item/chem/food/snacks/grown/bluespacetomato/throw_impact(atom/hit_atom)
	..()
	var/mob/M = usr
