 ...
 **/
/datum/subsystem/processing/tgui/proc/try_update_ui(mob/user, datum/src_object, ui_key, datum/tgui/ui, force_open = 0)
  ...
  * return datum/tgui The found UI.
 **/
/datum/subsystem/processing/tgui/proc/get_open_ui(mob/user, datum/src_object, ui_key)
 ...
 **/
/datum/subsystem/processing/tgui/proc/update_uis(datum/src_object)
	var/src_object_key = "\ref[src_object]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
 ...
 **/
/datum/subsystem/processing/tgui/proc/close_uis(datum/src_object)
	var/src_object_key = "\ref[src_object]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
		return 0 // Couldn't find any UIs for this object.
  ...
  * return int The number of UIs closed.
 **/
/datum/subsystem/processing/tgui/proc/close_all_uis()
	var/close_count = 0
  ...
  * return int The number of UIs updated.
 **/
/datum/subsystem/processing/tgui/proc/update_user_uis(mob/user, datum/src_object = null, ui_key = null)
  ...
  * return int The number of UIs closed.
 **/
/datum/subsystem/processing/tgui/proc/close_user_uis(mob/user, datum/src_object = null, ui_key = null)
	if(isnull(user.open_uis) || !istype(user.open_uis, /list) || open_uis.len == 0)
		return 0 // Couldn't find any UIs for this user.
 ...
 **/
/datum/subsystem/processing/tgui/proc/on_open(datum/tgui/ui)
 ...
 **/
/datum/subsystem/processing/tgui/proc/on_close(datum/tgui/ui)
	var/src_object_key = "\ref[ui.src_object]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
  ...
  * return int The number of UIs closed.
 **/
/datum/subsystem/processing/tgui/proc/on_logout(mob/user)
 ...
 **/
/datum/subsystem/processing/tgui/proc/on_transfer(mob/source, mob/target)
