 ...
 */
GAME_VERB(/client, fix_tgui_panel, "Fix chat", "Special") // BANDASTATION EDIT: Special category
	var/action
...
GAME_VERB(/client, refresh_tgui, "Refresh TGUI", "Special") // BANDASTATION EDIT: Special category
