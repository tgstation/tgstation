...
/obj/structure/disposaloutlet/proc/expel(obj/structure/disposalholder/H)
	...
	if((start_eject + 30) < world.time)
		...
		playsound(src, 'sound/machines/warning-buzzer.ogg').extra_range(FALSE).play()
...
/obj/structure/disposaloutlet/proc/expel_holder(obj/structure/disposalholder/H, playsound=FALSE)
	if(playsound)
		playsound(src, 'sound/machines/hiss.ogg').extra_range(FALSE).play()
...
/obj/structure/disposaloutlet/welder_act(mob/living/user, obj/item/I)
	...
	playsound(src, 'sound/items/tools/welder2.ogg').volume(100).vary(TRUE).play()
