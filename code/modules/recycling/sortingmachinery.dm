...
/obj/item/delivery/update_overlays()
	...
	if(sort_tag)
		...
		switch(icon_state)
			if("deliverypackage1")
				destination_tag.pixel_w = 5
				destination_tag.pixel_z = -4
			if("deliverypackage2")
				destination_tag.pixel_w = 5
				destination_tag.pixel_z = -4
			if("deliverypackage3")
			...
			if("deliverypackage4")
				...
				destination_tag.pixel_z = -4
			if("deliverypackage5")
				destination_tag.pixel_w = 6
				destination_tag.pixel_z = -6
			if("deliverypackage6")
				destination_tag.pixel_w = -1
				destination_tag.pixel_z = -9
			if("deliverycloset")
				destination_tag.pixel_w = 4
				destination_tag.pixel_z = -10
			if("deliverybox")
				destination_tag.pixel_w = -1
				destination_tag.pixel_z = -9
			else
