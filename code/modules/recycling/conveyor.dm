...
/obj/machinery/conveyor/proc/build_neighbors()
	...
	for(var/direction in GLOB.cardinals)
		...
		RegisterSignal(valid, COMSIG_MOVABLE_MOVED, .proc/nearby_belt_, override=TRUE)
...
/obj/machinery/conveyor_switch/examine(mob/user)
	...
	. += span_notice("[src] speed is set to [conveyor_speed] seconds. It can be changed with a <b>multitool</b>.")
