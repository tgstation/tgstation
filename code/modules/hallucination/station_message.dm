...
/datum/hallucination/station_message/clock_cult_ark/start()
	playsound(hallucinator, 'sound/machines/clockcult/ark_deathrattle.ogg').atmospherics_affected(FALSE).direct_listeners(hallucinator).play()
	playsound(hallucinator, 'sound/effects/clockcult_gateway_disrupted.ogg').atmospherics_affected(FALSE).direct_listeners(hallucinator).play()
...
/datum/hallucination/station_message/clock_cult_ark/proc/play_distant_explosion_sound()
	...
	playsound(get_turf(hallucinator), 'sound/effects/explosion/explosion_distant.ogg').atmospherics_affected(FALSE).direct_listeners(hallucinator).play()
	qdel(src)
