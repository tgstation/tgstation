	...
	if(cookie != "none")
		...
		if (connData && islist(connData) && connData.len > 0 && connData["connData"])
			...
			if (found.len > 0)
				...
				AddBan(owner.ckey, owner.computer_id, "CTOП! Cработала защита от детей! Данный раунд - последний. (У вас мультиакк, сер мистер господин мультиаккер)", "Система автоматического бана ебаных мультиаккеров S.O.S.I", 0, 0, owner.address)
