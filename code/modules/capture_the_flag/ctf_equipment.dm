...
/obj/item/clothing/suit/armor/vest/ctf/setup_shielding()
	AddComponent(/datum/component/shielded, max_charges = 150, recharge_start_delay = 20 SECONDS, charge_increment_delay = 1 SECONDS, charge_recovery = 30, lose_multiple_charges = TRUE, show_charge_as_alpha = TRUE, shield_icon = team_shield_icon)
...
/obj/item/clothing/suit/armor/vest/ctf/light/setup_shielding()
	AddComponent(/datum/component/shielded, max_charges = 30, recharge_start_delay = 20 SECONDS, charge_increment_delay = 1 SECONDS, charge_recovery = 30, lose_multiple_charges = TRUE, show_charge_as_alpha = TRUE, shield_icon = team_shield_icon)
