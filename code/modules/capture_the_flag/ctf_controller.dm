...
/datum/ctf_controller/proc/start_ctf()
	...
	for(var/team in teams)
		...
		notify_ghosts("[spawner.name] has been activated!", source = spawner, action = NOTIFY_ORBIT, header = "CTF has been activated", notify_flags = (NOTIFY_CATEGORY_DEFAULT | GHOST_NOTIFY_MAKE_ANNOUNCEMENT))
