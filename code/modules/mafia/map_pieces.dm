...
/datum/map_template/mafia/snowy
	name = "Snowdin"
	description = "Based off of the icey moon map of the same name, the guy who reworked it did a good enough job to recieve a derivative piece of work based on it. Cool!"
