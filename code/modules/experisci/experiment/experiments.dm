...
/datum/experiment/scanning/random/cytology/medium
	...
	total_requirement = 3
	max_requirement_per_type = 2
	possible_types = list(/mob/living/basic/carp, /mob/living/simple_animal/hostile/retaliate/snake, /mob/living/simple_animal/pet/cat, /mob/living/simple_animal/pet/dog/corgi, /mob/living/basic/cow, /mob/living/simple_animal/chicken)
