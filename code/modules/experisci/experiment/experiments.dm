...
/datum/experiment/scanning/random/plants/wild
	...
	description = "Nanotrasen has recently observed a phenomenon of plants mutating upon harvest. They require you to send a scan of a sample for further investigation."
