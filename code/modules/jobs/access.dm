...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(4) //research
			return list(ACCESS_RESEARCH, ACCESS_RND, ACCESS_TOXINS, ACCESS_GENETICS, ACCESS_ROBOTICS, ACCESS_XENOBIOLOGY, ACCESS_MECH_SCIENCE, ACCESS_MINISAT, ACCESS_RD, ACCESS_NETWORK)
