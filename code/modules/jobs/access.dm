...
/proc/get_command_accesses()
	return list(ACCESS_SECURITY, ACCESS_WEAPONS, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_MECH_SECURITY, ACCESS_NETWORK,
				ACCESS_TCOMSAT, ACCESS_MINISAT, ACCESS_QM, ACCESS_VAULT, ACCESS_HEADS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_CHANGE_IDS,
				ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_AI_UPLOAD)

/proc/get_private_command_accesses()
	return list(ACCESS_HOS, ACCESS_CMO, ACCESS_RD, ACCESS_CE, ACCESS_HOP)
