...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(8) //paramedic
			var/datum/job/J = new /datum/job/paramedic
			return J.get_access()
		if(9) //head of personel
			var/datum/job/J = new /datum/job/hop
			return J.get_access()
		if(10)// warden
...
/proc/get_common_accesses() // for determining what wildcard slot to use
	return list(ACCESS_KITCHEN, ACCESS_BAR, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_CHAPEL_OFFICE, ACCESS_CREMATORIUM, ACCESS_LIBRARY, ACCESS_THEATRE, ACCESS_LAWYER, ACCESS_SEC_DOORS,
				ACCESS_SECURITY, ACCESS_COURT, ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_CHEMISTRY, ACCESS_VIROLOGY, ACCESS_SURGERY, ACCESS_MECH_MEDICAL, ACCESS_PHARMACY, ACCESS_PSYCHOLOGY,
				ACCESS_RESEARCH, ACCESS_RND, ACCESS_TOXINS, ACCESS_TOXINS_STORAGE, ACCESS_GENETICS, ACCESS_ROBOTICS, ACCESS_XENOBIOLOGY, ACCESS_MECH_SCIENCE, ACCESS_MINISAT,
...
/proc/get_command_accesses() // command level not the department or area
	return list(ACCESS_SECURITY, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_MECH_SECURITY, ACCESS_HOS, ACCESS_CMO, ACCESS_MINISAT, ACCESS_RD, ACCESS_NETWORK,
				ACCESS_TCOMSAT, ACCESS_MINISAT, ACCESS_CE, ACCESS_QM, ACCESS_VAULT, ACCESS_HEADS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_CHANGE_IDS, ACCESS_AI_UPLOAD,
				ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_HOP, ACCESS_CAPTAIN, ACCESS_VAULT)

/proc/get_captain_level()
	return list(ACCESS_CAPTAIN, ACCESS_ALL_PERSONAL_LOCKERS)
