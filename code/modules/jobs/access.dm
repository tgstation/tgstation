...
/proc/get_command_accesses() // command level not the department or area
	return list(ACCESS_SECURITY, ACCESS_WEAPONS, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_MECH_SECURITY, ACCESS_HOS, ACCESS_CMO, ACCESS_RD, ACCESS_NETWORK,
				ACCESS_TCOMSAT, ACCESS_MINISAT, ACCESS_CE, ACCESS_QM, ACCESS_VAULT, ACCESS_HEADS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_CHANGE_IDS,
				ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_HOP, ACCESS_ALL_PERSONAL_LOCKERS)

/proc/get_captain_accesses()
	return list(ACCESS_CAPTAIN, ACCESS_AI_UPLOAD)
