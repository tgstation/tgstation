/datum/job/captain
	title = JOB_CAPTAIN
	description = "Отвечайте за станцию, управляйте своими руководителями персонала, \
	поддерживайте жизнь экипажа, будьте готовы сделать все, что угодно, или умереть \
	ужасно мучительно."
