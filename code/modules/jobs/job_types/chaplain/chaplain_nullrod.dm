...
/obj/item/nullrod/Initialize(mapload)
	...
	if(!GLOB.holy_weapon_type && type == /obj/item/nullrod)
		...
		rods[/obj/item/organ/internal/cyberimp/arm/shard/scythe] = "A shard that implants itself into your arm, allowing you to conjure forth a vorpal scythe. \
																Allows you to behead targets for empowered strikes. \
																Harms you if dismiss the scythe without first causing harm to a creature. \
