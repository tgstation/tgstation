...
/datum/outfit/job/rd
	...
	backpack_contents = list(/obj/item/melee/classic_baton/telescopic=1, /obj/item/device/modular_computer/tablet/preset/advanced=1, /obj/item/gun/energy/e_gun/mini = 1)
