/datum/ntcode/module
	...
	var/datum/ntcode/variable/variables = list()
	
	var/datum/ntcode/function/functions = list()

/datum/ntcode/module/proc/add_byond_proc(name, proc_ref, list/arguments)
	functions += new /datum/ntcode/function/byond(name, list(arguments), src, proc_ref)
