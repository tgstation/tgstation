...
/area/virtual_domain
	...
	area_flags = UNIQUE_AREA | NOTELEPORT | EVENT_PROTECTED | HIDDEN_AREA | UNLIMITED_FISHING | BLOCK_SUICIDE
...
/area/virtual_domain/safehouse
	...
	area_flags = UNIQUE_AREA | NOTELEPORT | EVENT_PROTECTED | VIRTUAL_SAFE_AREA | UNLIMITED_FISHING | BLOCK_SUICIDE
	icon_state = "bit_safe"
	requires_power = FALSE
