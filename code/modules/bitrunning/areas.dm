...
/area/virtual_domain
	...
	area_flags = UNIQUE_AREA | NOTELEPORT | EVENT_PROTECTED | HIDDEN_AREA | BLOCK_SUICIDE
...
/area/virtual_domain/safehouse
	...
	area_flags = UNIQUE_AREA | NOTELEPORT | EVENT_PROTECTED | VIRTUAL_SAFE_AREA | BLOCK_SUICIDE
	icon_state = "bit_safe"
	requires_power = FALSE
