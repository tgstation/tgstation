/datum/component/bitrunning_loot_signal
...
/datum/component/bitrunning_loot_signal/Initialize(datum/lazy_template/virtual_domain/domain)
	. = ..()
	if(isturf(parent))
...
/datum/component/bitrunning_loot_signal/proc/on_add_points(datum/source, points_to_add)
	SIGNAL_HANDLER
...
/datum/component/bitrunning_loot_signal/proc/reveal()
