/datum/outfit/bitrunning_glitch
	name = "Generic Glitch"
...
/datum/outfit/bitrunning_glitch/pre_equip(mob/living/carbon/human/user, visualsOnly)
...
/datum/outfit/bitrunning_glitch/post_equip(mob/living/carbon/human/user, visualsOnly)
