 ...
 */
/obj/item/circuit_component/toggle
	display_name = "Toggle"
...
/obj/item/circuit_component/toggle/Initialize()
	. = ..()
	trigger = add_input_port("Toggle", PORT_TYPE_SIGNAL)

	output = add_output_port("Output", PORT_TYPE_NUMBER)

/obj/item/circuit_component/toggle/Destroy()
	trigger = null
	output = null
	return ..()

/obj/item/circuit_component/toggle/input_received(datum/port/input/port)
	. = ..()
	if(.)
		return
