...
/obj/item/circuit_component/save_shell/add_to(obj/item/integrated_circuit/added_to)
	...
	register_signal(added_to, COMSIG_CIRCUIT_PRE_SAVE_TO_JSON, .proc/on_pre_save_to_json)

/obj/item/circuit_component/save_shell/removed_from(obj/item/integrated_circuit/removed_from)
	unregister_signal(removed_from, list(COMSIG_CIRCUIT_POST_LOAD, COMSIG_CIRCUIT_PRE_SAVE_TO_JSON))
	return ..()
