...
/proc/generate_circuit_signal_list()
	...
	return list(
		...
		COMSIG_ITEM_AFTERATTACK = list(cancel_attack, target, user), // melbert todo
		...
		COMSIG_ITEM_AFTERATTACK_SECONDARY = list(secondary_cancel_attack, secondary_continue_attack, target, user), // melbert todo
