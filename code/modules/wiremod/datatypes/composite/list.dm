...
/datum/circuit_datatype/composite_instance/list/convert_value(datum/port/port, list/value_to_convert, force)
	var/datum/circuit_datatype/datatype_handler = GLOB.circuit_datatypes[composite_datatypes[1]]

	var/list/converted_list = list()
	for(var/value in value_to_convert)
		converted_list += list(datatype_handler.convert_value(value_to_convert))
