...
/obj/structure/cursed_slot_machine/interact(mob/user)
	...
	update_appearance()
	playsound(src, 'sound/sound/machines/lavaland/cursed_slot_machine.ogg', 50, FALSE)
...
/obj/structure/cursed_slot_machine/proc/determine_victor(mob/living/carbon/human/user)
	...
	playsound(src, 'sound/sound/machines/lavaland/cursed_slot_machine_jackpot.ogg', 50, FALSE)
