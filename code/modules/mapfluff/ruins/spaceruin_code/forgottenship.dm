...
/obj/item/disk/surgery/forgottenship
	...
	surgeries = list(/datum/surgery/advanced/lobotomy, /datum/surgery/advanced/bioware/vein_threading, /datum/surgery/advanced/bioware/nerve_splicing, /datum/surgery_step/heal/combo/upgraded)
