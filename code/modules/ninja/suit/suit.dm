...
/obj/item/clothing/suit/space/space_ninja
	...
	var/list/reagent_list = list("doctorsdelight","dexalin","spaceacillin","anti_toxin","nutriment","radium","potass_iodide")//The reagents ids which are added to the suit at New().
