...
/obj/structure/energy_net/play_attack_sound(damage, damage_type = BRUTE, damage_flag = 0)
	switch(damage_type)
		if(BRUTE)
			playsound(src, 'sound/weapons/slash.ogg', 80, DEFAULT_SOUND_VARY)
		if(BURN)
			playsound(src, 'sound/weapons/slash.ogg', 80, DEFAULT_SOUND_VARY)
...
/obj/structure/energy_net/process()
	...
	playsound(affecting, 'sound/effects/sparks4.ogg', 50, DEFAULT_SOUND_VARY)
	...
	playsound(affecting, 'sound/effects/phasein.ogg', 25, DEFAULT_SOUND_VARY)
	playsound(affecting, 'sound/effects/sparks2.ogg', 50, DEFAULT_SOUND_VARY)
