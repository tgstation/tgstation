...
/mob/living/carbon/ninjadrain_act(obj/item/clothing/suit/space/space_ninja/S, mob/living/carbon/human/H, obj/item/clothing/gloves/space_ninja/G)
	...
	if(S.cell && S.cell.charge && S.cell.use(1000))
		...
		visible_message("<span class='danger'>[IDENTITY_SUBJECT(1)] electrocutes [IDENTITY_SUBJECT(1)] with [H.p_their()] touch!</span>", "<span class='userdanger'>[H] electrocutes you with [H.p_their()] touch!</span>", subjects=list(H, src))
