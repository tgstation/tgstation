...
/client/proc/cmd_admin_ninjafy(mob/living/carbon/human/H in SLOTH.player_list)
	set category = null
...
/client/proc/send_space_ninja()
	...
	var/client/C = input("Pick character to spawn as the Space Ninja", "Key", "") as null|anything in SLOTH.clients
	if(!C)
		return
