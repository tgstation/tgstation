...
/datum/crafting_recipe/hotcrossbun
	name = "Hot-Cross Bun"
	reqs = list(
...
/datum/crafting_recipe/briochecake
	name = "Brioche cake"
	reqs = list(
...
/datum/crafting_recipe/scotchegg
	name = "Scotch egg"
	reqs = list(
...
/datum/crafting_recipe/chocolatebunny
	name = "Chocolate bunny"
	reqs = list(
		/datum/reagent/consumable/sugar = 2,
		/obj/item/weapon/reagent_containers/food/snacks/chocolatebar = 1
