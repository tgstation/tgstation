...
/obj/structure/closet/proc/trigger_spooky_trap()
	if(!trapped)
		...
		playsound(loc, 'sound/spookoween/girlscream.ogg', 300, DEFAULT_SOUND_VARY)
		trapped = 0
		...
		playsound(loc, 'sound/spookoween/ghosty_wind.ogg', 300, DEFAULT_SOUND_VARY)
		...
		playsound(loc, 'sound/spookoween/bats.ogg', 300, DEFAULT_SOUND_VARY)
		var/number = rand(1,3)
		...
		playsound(loc, 'sound/hallucinations/wail.ogg', 300, DEFAULT_SOUND_VARY)
		...
		playsound(loc, 'sound/spookoween/scary_clown_appear.ogg', 300, DEFAULT_SOUND_VARY)
...
/mob/living/simple_animal/shade/howling_ghost/proc/spooky_ghosty()
	if(prob(20)) //haunt
		playsound(loc, pick('sound/spookoween/ghosty_wind.ogg','sound/spookoween/ghost_whisper.ogg','sound/spookoween/chain_rattling.ogg'), 300, DEFAULT_SOUND_VARY)
	if(prob(10)) //flickers
...
/mob/living/simple_animal/hostile/retaliate/clown/insane/proc/stalk()
	...
	if(M.stat == DEAD)
		playsound(M.loc, 'sound/spookoween/insane_low_laugh.ogg', 300, DEFAULT_SOUND_VARY)
		qdel(src)
	if(timer == 0)
		timer = rand(5,15)
		playsound(M.loc, pick('sound/spookoween/scary_horn.ogg','sound/spookoween/scary_horn2.ogg', 'sound/spookoween/scary_horn3.ogg'), 300, DEFAULT_SOUND_VARY)
		spawn(12)
			forceMove(M.loc)
...
/mob/living/simple_animal/hostile/retaliate/clown/insane/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	. = 0
	if(prob(5))
		playsound(loc, 'sound/spookoween/insane_low_laugh.ogg', 300, DEFAULT_SOUND_VARY)
