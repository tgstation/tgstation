...
/datum/adventure_loot_generator/pet
	...
	var/list/possible_pets = list(/mob/living/simple_animal/pet/cat/space,/mob/living/basic/pet/dog/corgi,/mob/living/basic/pet/penguin/baby,/mob/living/basic/pet/dog/pug)
