...
/mob/proc/say_dead(var/message)
	...
	var/rendeblue = "<span class='game deadsay'><span class='prefix'>DEAD:</span> <span class='name'>[name]</span>[alt_name] <span class='message'>[message]</span></span>"

	deadchat_broadcast(rendeblue, follow_target = src, speaker_key = K)
