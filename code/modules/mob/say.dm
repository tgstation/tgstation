...
/mob/proc/say_dead(var/message)
	 ...
	 */
	var/rendered2 = "<span class='game deadsay'><span class='prefix'>DEAD:</span> <a href='byond://?src=\ref[usr];follow2=\ref[usr];follow=\ref[src]'><span class='name'>[name]</span>[alt_name] </a><span class='message'>[message]</span></span>"//edited
