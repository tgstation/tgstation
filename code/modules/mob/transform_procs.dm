...
/mob/living/silicon/robot/proc/replace_banned_cyborg()
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob("Do you want to play as [src]?", jobban = "Cyborg", poll_time = 5 SECONDS, target_mob = src, pic_source = src)
