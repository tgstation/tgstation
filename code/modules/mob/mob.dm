...
/mob/living/handle_eye_contact(mob/living/examined_mob)
	...
	if(!(examined_mob.obscured_slots & HIDEFACE) && SEND_SIGNAL(src, COMSIG_MOB_EYECONTACT, examined_mob, TRUE) != COMSIG_BLOCK_EYECONTACT)
	...
	if(!imagined_eye_contact && !(obscured_slots & HIDEFACE) && !examined_mob.is_blind() && SEND_SIGNAL(examined_mob, COMSIG_MOB_EYECONTACT, src, FALSE) != COMSIG_BLOCK_EYECONTACT)
