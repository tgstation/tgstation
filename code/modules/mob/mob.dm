...
/mob/proc/display_output(sound/S, list/icon, text, turf/turf_source, vol as num, vary, frequency, falloff, channel = 0, pressure_affected = TRUE)
	//Process sound
	if(S && can_hear())
		S.wait = 0 //No queue
