...
/mob/verb/abandon_mob()
	...
	if (CONFIG_GET(flag/norespawn) && (!check_rights_for(usr.client, R_SPAWN) || alert(usr, "Respawn configs disabled. Do you want to use your permissions to circumvent it?", "Respawn", "Yes", "No") != "Yes"))
		return
