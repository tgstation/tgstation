...
/mob/living/handle_eye_contact(mob/living/examined_mob)
	...
	if(!imagined_eye_contact && is_face_visible() && !is_eyes_covered() && !examined_mob.is_blind() && SEND_SIGNAL(examined_mob, COMSIG_MOB_EYECONTACT, src, FALSE) != COMSIG_BLOCK_EYECONTACT)
