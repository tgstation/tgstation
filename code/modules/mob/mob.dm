...
/mob/Stat()
	...
	if(statpanel("Status"))
		...
		stat(null, "Time Dilation: [round(SStime_track.time_dilation_current,1)]% Tick Lag: ([SStime_track.current_tick_lag]) AVG:([round(SStime_track.time_dilation_avg_fast,1)]%, [round(SStime_track.time_dilation_avg,1)]%, [round(SStime_track.time_dilation_avg_slow,1)]%)")
