...
/datum/preferences/proc/update_preview_icon()		//seriously. This is horrendous.
	...
	if(job_civilian_low & ASSISTANT)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
		...
		switch(job_engsec_high)
			...
			if(HOS)
				clothes_s = new /icon('icons/mob/uniform.dmi', "hosformal_s")
			...
			if(WARDEN)
				clothes_s = new /icon('icons/mob/uniform.dmi', "wardenformal_s")
				clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
			...
			if(DETECTIVE)
				...
				if(backbag == 3)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-norm"), ICON_OVERLAY)
			if(OFFICER)
				clothes_s = new /icon('icons/mob/uniform.dmi', "secformal_s")
				clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
