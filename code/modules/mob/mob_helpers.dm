 ...
 *
 * Automatic logging and uses SSpolling.poll_ghost_candidates_for_mob, how convenient
 */
/proc/offer_control(mob/M)
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob(poll_message, jobban = ROLE_PAI, poll_time = 10 SECONDS, target_mob = M, pic_source = M, role_name_text = "offer control")
