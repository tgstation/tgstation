...
/proc/offer_control(mob/M)
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob(poll_message, jobban = ROLE_PAI, poll_time = 10 SECONDS, target_mob = M, pic_source = M)
