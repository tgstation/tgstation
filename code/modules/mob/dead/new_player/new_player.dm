...
//	SEND_GLOBAL_SIGNAL(COMSIG_GLOB_CREWMEMBER_JOINED, new_character, new_character.mind.assigned_role.title) //monkestation edit, this makes this signal send twice
	new_character = null
	qdel(src)
