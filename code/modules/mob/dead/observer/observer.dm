...
/mob/dead/observer/verb/stay_dead()
	...
	var/response = alert(src, "Are you sure you want to prevent (almost) all means of resuscitation? This cannot be undone. ","Are you sure you want to stay dead?","DNR","Hope")
	if(response != "DNR")
		return 
