...
/mob/dead/observer/update_icon(updates=ALL, new_form)
	...
	if(ghost_accs == GHOST_ACCS_FULL && (icon_state in GLOB.ghost_forms_with_accessories_list)) //check if this form supports accessories and if the client wants to show them
		if(facial_hairstyle)
			var/datum/sprite_accessory/S = DSaccessories.facial_hairstyles_list[facial_hairstyle]
			if(S)
		...
		if(hairstyle)
			var/datum/sprite_accessory/hair/S = DSaccessories.hairstyles_list[hairstyle]
			if(S)
