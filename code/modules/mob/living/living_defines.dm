/mob/living
	...
	var/icon/held_lh = 'icons/mob/simple/held-pets/pets_held_lh.dmi'
	///right hand icon for holding mobs
	var/icon/held_rh = 'icons/mob/simple/held-pets/pets_held_rh.dmi'
	///what it looks like when the mob is held on your head
	var/icon/head_icon = 'icons/mob/simple/held-pets/pets_held.dmi'
