/mob/living
	...
	var/list/datum/autopsy_record/damage_record = list()  //Is used to record what happened with the body before death. vars are deleted from the list when damage is healed
