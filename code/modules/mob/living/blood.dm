...
/mob/living/carbon/monkey/handle_blood()
	if(bodytemperature >= 225 && !(disabilities & HUSK)) //cryosleep or husked people do not pump the blood.
...
/mob/living/carbon/human/get_blood_id()
	...
	else if((NOBLOOD in dna.species.species_traits) || (disabilities & HUSK))
		return
	return "blood"
