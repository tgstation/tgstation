...
/mob/living/proc/on_lying_down(new_lying_angle)
	...
	AddTraits(list(TRAIT_UI_BLOCKED, TRAIT_PULL_BLOCKED), LYING_DOWN_TRAIT)
...
/mob/living/proc/on_standing_up()
	...
	RemoveTraits(list(TRAIT_UI_BLOCKED, TRAIT_PULL_BLOCKED), LYING_DOWN_TRAIT)
...
/mob/living/proc/wabbajack(what_to_randomize, change_flags = WABBAJACK)
	...
	notransform = TRUE
	AddTraits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED), MAGIC_TRAIT)
	icon = null
	cut_overlays()
...
/mob/living/set_stat(new_stat)
	...
	switch(.) //Previous stat.
		if(CONSCIOUS)
			...
			AddTraits(list(TRAIT_HANDS_BLOCKED, TRAIT_INCAPACITATED, TRAIT_FLOORED), STAT_TRAIT)
		if(SOFT_CRIT)
			if(stat >= UNCONSCIOUS)
	...
	switch(stat) //Current stat.
		if(CONSCIOUS)
			...
			RemoveTraits(list(TRAIT_HANDS_BLOCKED, TRAIT_INCAPACITATED, TRAIT_FLOORED), STAT_TRAIT)
		if(SOFT_CRIT)
			if(pulledby)
...
/mob/living/proc/set_buckled(new_buckled)
	...
	if(buckled)
		...
		RemoveTraits(list(TRAIT_IMMOBILIZED, TRAIT_FLOORED), BUCKLED_TRAIT)
...
/mob/living/proc/on_handsblocked_start()
	drop_all_held_items()
	AddTraits(list(TRAIT_UI_BLOCKED, TRAIT_PULL_BLOCKED), TRAIT_HANDS_BLOCKED)
...
/mob/living/proc/on_handsblocked_end()
	RemoveTraits(list(TRAIT_UI_BLOCKED, TRAIT_PULL_BLOCKED), TRAIT_HANDS_BLOCKED)
