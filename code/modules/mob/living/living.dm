...
/mob/living/verb/succumb()
	...
	if ((src.health < 0 && src.health > -95.0))
		...
		src.apply_damage(105 + src.health, OXY) // This will ensure people die when using the command, but don't go into overkill. 15 oxy points over the limit for safety since brute and burn regenerates
