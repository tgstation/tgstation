...
/datum/action/innate/slime/IsAvailable()
	if(..())
		var/mob/living/animal/slime/S = owner
...
/mob/living/animal/slime/verb/Feed()
	set category = "Slime"
...
/mob/living/animal/slime/proc/CanFeedon(mob/living/M)
	if(!Adjacent(M))
		return 0
	...
	if(locate(/mob/living/animal/slime) in M.buckled_mobs)
		to_chat(src, "<span class='warning'><i>Another slime is already feeding on this subject...</i></span>")
		return 0
	return 1

/mob/living/animal/slime/proc/Feedon(mob/living/M)
...
/mob/living/animal/slime/proc/Feedstop(silent=0, living=1)
	if(buckled)
		if(!living)
...
/mob/living/animal/slime/verb/Evolve()
	set category = "Slime"
...
/mob/living/animal/slime/verb/Reproduce()
	set category = "Slime"
	...
	if(is_adult)
		if(amount_grown >= SLIME_EVOLUTION_THRESHOLD)
			...
			var/mob/living/animal/slime/new_slime = pick(babies)
