...
/mob/living/animal/hostile/asteroid/goliath
	name = "goliath"
...
/mob/living/animal/hostile/asteroid/goliath/Life()
	. = ..()
	handle_preattack()

/mob/living/animal/hostile/asteroid/goliath/proc/handle_preattack()
...
/mob/living/animal/hostile/asteroid/goliath/revive(full_heal = 0, admin_revive = 0)
	if(..())
		anchored = TRUE
		. = 1

/mob/living/animal/hostile/asteroid/goliath/death(gibbed)
	anchored = FALSE
	..(gibbed)

/mob/living/animal/hostile/asteroid/goliath/OpenFire()
...
/mob/living/animal/hostile/asteroid/goliath/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	ranged_cooldown -= 10
	handle_preattack()
	. = ..()

/mob/living/animal/hostile/asteroid/goliath/Aggro()
...
//Lavaland Goliath
/mob/living/animal/hostile/asteroid/goliath/beast
	name = "goliath"
...
/mob/living/animal/hostile/asteroid/goliath/beast/random/Initialize()
	. = ..()
	if(prob(1))
		new /mob/living/animal/hostile/asteroid/goliath/beast/ancient(loc)
		return INITIALIZE_HINT_QDEL

/mob/living/animal/hostile/asteroid/goliath/beast/ancient
...
/mob/living/animal/hostile/asteroid/goliath/beast/ancient/Life()
	. = ..()
	if(isturf(loc))
...
/mob/living/animal/hostile/asteroid/goliath/beast/tendril
	fromtendril = TRUE
