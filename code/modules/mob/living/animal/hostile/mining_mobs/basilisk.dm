...
/mob/living/animal/hostile/asteroid/basilisk
	name = "basilisk"
...
/mob/living/animal/hostile/asteroid/basilisk/GiveTarget(new_target)
	if(..()) //we have a target
...
/mob/living/animal/hostile/asteroid/basilisk/ex_act(severity, target)
	switch(severity)
		if(1)
			gib()
		if(2)
...
//Watcher
/mob/living/animal/hostile/asteroid/basilisk/watcher
	name = "watcher"
...
/mob/living/animal/hostile/asteroid/basilisk/watcher/random/Initialize()
	. = ..()
	if(prob(1))
		if(prob(75))
			new /mob/living/animal/hostile/asteroid/basilisk/watcher/magmawing(loc)
		else
			new /mob/living/animal/hostile/asteroid/basilisk/watcher/icewing(loc)
		return INITIALIZE_HINT_QDEL

/mob/living/animal/hostile/asteroid/basilisk/watcher/magmawing
...
/mob/living/animal/hostile/asteroid/basilisk/watcher/icewing
...
/mob/living/animal/hostile/asteroid/basilisk/watcher/tendril
	fromtendril = TRUE
