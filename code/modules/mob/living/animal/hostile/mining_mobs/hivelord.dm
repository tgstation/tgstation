/mob/living/animal/hostile/asteroid/hivelord
	name = "hivelord"
	...
	var/brood_type = /mob/living/animal/hostile/asteroid/hivelordbrood

/mob/living/animal/hostile/asteroid/hivelord/OpenFire(the_target)
	if(world.time >= ranged_cooldown)
		var/mob/living/animal/hostile/asteroid/hivelordbrood/A = new brood_type(src.loc)
...
/mob/living/animal/hostile/asteroid/hivelord/AttackingTarget()
	OpenFire()
	return TRUE

/mob/living/animal/hostile/asteroid/hivelord/spawn_crusher_loot()
	loot += crusher_loot //we don't butcher

/mob/living/animal/hostile/asteroid/hivelord/death(gibbed)
	mouse_opacity = MOUSE_OPACITY_ICON
	..(gibbed)

//A fragile but rapidly produced creature
/mob/living/animal/hostile/asteroid/hivelordbrood
	name = "hivelord brood"
...
/mob/living/animal/hostile/asteroid/hivelordbrood/Initialize()
	. = ..()
	addtimer(CALLBACK(src, .proc/death), 100)

//Legion
/mob/living/animal/hostile/asteroid/hivelord/legion
	name = "legion"
	...
	brood_type = /mob/living/animal/hostile/asteroid/hivelordbrood/legion
	del_on_death = 1
...
/mob/living/animal/hostile/asteroid/hivelord/legion/random/Initialize()
	. = ..()
	if(prob(5))
		new /mob/living/animal/hostile/asteroid/hivelord/legion/dwarf(loc)
		return INITIALIZE_HINT_QDEL

/mob/living/animal/hostile/asteroid/hivelord/legion/dwarf
	name = "dwarf legion"
...
/mob/living/animal/hostile/asteroid/hivelord/legion/death(gibbed)
...
/mob/living/animal/hostile/asteroid/hivelord/legion/tendril
	fromtendril = TRUE

//Legion skull
/mob/living/animal/hostile/asteroid/hivelordbrood/legion
	name = "legion"
	desc = "One of many."
	icon = 'icons/mob/lavaland/lavaland_monsters.dmi'
...
/mob/living/animal/hostile/asteroid/hivelordbrood/legion/Life()
	if(isturf(loc))
...
/mob/living/animal/hostile/asteroid/hivelordbrood/legion/proc/infest(mob/living/carbon/human/H)
	visible_message("<span class='warning'>[name] burrows into the flesh of [H]!</span>")
	var/mob/living/animal/hostile/asteroid/hivelord/legion/L
	if(H.dna.check_mutation(DWARFISM)) //dwarf legions aren't just fluff!
		L = new /mob/living/animal/hostile/asteroid/hivelord/legion/dwarf(H.loc)
	else
		L = new(H.loc)
...
/mob/living/animal/hostile/asteroid/hivelord/legion/advanced
	stat_attack = DEAD
	maxHealth = 120
	health = 120
	brood_type = /mob/living/animal/hostile/asteroid/hivelordbrood/legion/advanced
	icon_state = "dwarf_legion"
	icon_living = "dwarf_legion"
	icon_aggro = "dwarf_legion"
	icon_dead = "dwarf_legion"

/mob/living/animal/hostile/asteroid/hivelordbrood/legion/advanced
	stat_attack = DEAD
	can_infest_dead = TRUE

//Legion that spawns Legions
/mob/living/animal/hostile/spawner/legion
	name = "legion"
	desc = "One of many."
	...
	mob_type = /mob/living/animal/hostile/asteroid/hivelord/legion
