...
/mob/living/animal/hostile/spawner/lavaland
	...
	mob_type = /mob/living/animal/hostile/asteroid/basilisk/watcher/tendril
...
/mob/living/animal/hostile/spawner/lavaland/goliath
	mob_type = /mob/living/animal/hostile/asteroid/goliath/beast/tendril

/mob/living/animal/hostile/spawner/lavaland/legion
	mob_type = /mob/living/animal/hostile/asteroid/hivelord/legion/tendril

/mob/living/animal/hostile/spawner/lavaland/Initialize()
	. = ..()
...
/mob/living/animal/hostile/spawner/lavaland/Destroy()
	QDEL_NULL(emitted_light)
	QDEL_NULL(gps)
	. = ..()

#define MEDAL_PREFIX "Tendril"
/mob/living/animal/hostile/spawner/lavaland/death()
	var/last_tendril = TRUE
	for(var/mob/living/animal/hostile/spawner/lavaland/other in GLOB.mob_list)
		if(other != src)
			last_tendril = FALSE
			break
