...
/mob/living/animal/hostile/megafauna/bubblegum
	name = "bubblegum"
...
/mob/living/animal/hostile/megafauna/bubblegum/adjustBruteLoss(amount, updating_health = TRUE, forced = FALSE)
	. = ..()
	if(. > 0 && prob(25))
...
/mob/living/animal/hostile/megafauna/bubblegum/Life()
	..()
	move_to_delay = Clamp((health/maxHealth) * 10, 5, 10)

/mob/living/animal/hostile/megafauna/bubblegum/OpenFire()
...
/mob/living/animal/hostile/megafauna/bubblegum/Initialize()
	. = ..()
	for(var/mob/living/animal/hostile/megafauna/bubblegum/B in GLOB.mob_list)
		if(B != src)
...
/mob/living/animal/hostile/megafauna/bubblegum/grant_achievement(medaltype,scoretype)
	. = ..()
	if(.)
		SSshuttle.shuttle_purchase_requirements_met |= "bubblegum"

/mob/living/animal/hostile/megafauna/bubblegum/do_attack_animation(atom/A, visual_effect_icon)
	if(!charging)
		..()

/mob/living/animal/hostile/megafauna/bubblegum/AttackingTarget()
	if(!charging)
		return ..()

/mob/living/animal/hostile/megafauna/bubblegum/Goto(target, delay, minimum_distance)
	if(!charging)
		..()

/mob/living/animal/hostile/megafauna/bubblegum/Move()
	if(charging)
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/warp_charge()
	blood_warp()
	charge()

/mob/living/animal/hostile/megafauna/bubblegum/proc/charge(bonus_charges)
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/charge_end(bonus_charges, list/effects_to_destroy)
	charging = FALSE
	try_bloodattack()
	if(target)
		if(bonus_charges)
...
/mob/living/animal/hostile/megafauna/bubblegum/Collide(atom/A)
	if(charging)
...
/mob/living/animal/hostile/megafauna/bubblegum/throw_impact(atom/A)
	if(!charging)
		return ..()
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/get_mobs_on_blood()
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/try_bloodattack()
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/bloodattack(list/targets, handedness)
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/bloodsmack(turf/T, handedness)
	if(handedness)
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/bloodgrab(turf/T, handedness)
	if(handedness)
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/blood_warp()
	if(Adjacent(target))
		return FALSE
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/get_pools(turf/T, range)
	. = list()
	for(var/obj/effect/decal/cleanable/nearby in view(T, range))
		if(nearby.can_bloodcrawl_in())
			. += nearby

/mob/living/animal/hostile/megafauna/bubblegum/proc/blood_spray()
...
/mob/living/animal/hostile/megafauna/bubblegum/proc/slaughterlings()
	...
	for(var/H in get_pools(get_turf(src), 1))
		...
		new /mob/living/animal/hostile/asteroid/hivelordbrood/slaughter(B.loc)
	return max_amount

/mob/living/animal/hostile/asteroid/hivelordbrood/slaughter
	name = "slaughterling"
...
/mob/living/animal/hostile/asteroid/hivelordbrood/slaughter/CanPass(atom/movable/mover, turf/target)
	if(istype(mover, /mob/living/animal/hostile/megafauna/bubblegum))
		return 1
	return 0
