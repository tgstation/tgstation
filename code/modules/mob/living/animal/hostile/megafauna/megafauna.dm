...
/mob/living/animal/hostile/megafauna
...
/mob/living/animal/hostile/megafauna/Initialize(mapload)
	. = ..()
	apply_status_effect(STATUS_EFFECT_CRUSHERDAMAGETRACKING)

/mob/living/animal/hostile/megafauna/Destroy()
	QDEL_NULL(internal)
	. = ..()

/mob/living/animal/hostile/megafauna/death(gibbed)
	if(health > 0)
		return
	else
...
/mob/living/animal/hostile/megafauna/proc/spawn_crusher_loot()
	loot = crusher_loot

/mob/living/animal/hostile/megafauna/gib()
	if(health > 0)
		return
	else
		..()

/mob/living/animal/hostile/megafauna/dust()
	if(health > 0)
		return
	else
		..()

/mob/living/animal/hostile/megafauna/AttackingTarget()
...
/mob/living/animal/hostile/megafauna/proc/devour(mob/living/L)
	if(!L)
		return
	visible_message(
...
/mob/living/animal/hostile/megafauna/ex_act(severity, target)
	switch (severity)
		if (1)
			adjustBruteLoss(250)
...
/mob/living/animal/hostile/megafauna/proc/SetRecoveryTime(buffer_time)
	recovery_time = world.time + buffer_time

/mob/living/animal/hostile/megafauna/proc/grant_achievement(medaltype,scoretype)
