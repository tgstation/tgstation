...
/mob/living/animal/hostile/megafauna/colossus
	name = "colossus"
...
/mob/living/animal/hostile/megafauna/colossus/devour(mob/living/L)
	visible_message("<span class='colossus'>[src] disintegrates [L]!</span>")
	L.dust()

/mob/living/animal/hostile/megafauna/colossus/OpenFire()
...
/mob/living/animal/hostile/megafauna/colossus/Initialize()
	. = ..()
...
/mob/living/animal/hostile/megafauna/colossus/bullet_act(obj/item/projectile/P)
	if(!stat)
...
/mob/living/animal/hostile/megafauna/colossus/proc/enrage(mob/living/L)
	if(ishuman(L))
...
/mob/living/animal/hostile/megafauna/colossus/proc/alternating_dir_shots()
...
/mob/living/animal/hostile/megafauna/colossus/proc/double_spiral()
...
/mob/living/animal/hostile/megafauna/colossus/proc/spiral_shoot(negative = FALSE, counter_start = 8)
...
/mob/living/animal/hostile/megafauna/colossus/proc/shoot_projectile(turf/marker, set_angle)
...
/mob/living/animal/hostile/megafauna/colossus/proc/random_shots()
...
/mob/living/animal/hostile/megafauna/colossus/proc/blast(set_angle)
...
/mob/living/animal/hostile/megafauna/colossus/proc/dir_shots(list/dirs)
	if(!islist(dirs))
...
/mob/living/animal/hostile/megafauna/colossus/proc/telegraph()
...
/obj/machinery/anomalous_crystal/theme_warp/Initialize()
	...
	switch(terrain_theme)
		if("lavaland")//Depressurizes the place... and free cult metal, I guess.
			...
			NewFlora = list(/mob/living/animal/hostile/asteroid/goldgrub)
			florachance = 1
...
/obj/machinery/anomalous_crystal/helpers/attack_ghost(mob/dead/observer/user)
	...
	if(ready_to_deploy)
		...
		if(be_helper == "Yes" && !QDELETED(src) && isobserver(user))
			var/mob/living/animal/hostile/lightgeist/W = new /mob/living/animal/hostile/lightgeist(get_turf(loc))
			W.key = user.key
...
/mob/living/animal/hostile/lightgeist
	name = "lightgeist"
...
/mob/living/animal/hostile/lightgeist/Initialize()
	. = ..()
...
/mob/living/animal/hostile/lightgeist/AttackingTarget()
	. = ..()
...
/mob/living/animal/hostile/lightgeist/ghostize()
	. = ..()
	if(.)
		death()
...
/obj/machinery/anomalous_crystal/possessor/ActivationReaction(mob/user, method)
	if(..())
		if(ishuman(user))
			var/mobcheck = 0
			for(var/mob/living/animal/A in range(1, src))
				...
				break
			if(!mobcheck)
				new /mob/living/animal/cockroach(get_step(src,dir)) //Just in case there aren't any animals on the station, this will leave you with a terrible option to possess if you feel like it
...
/obj/structure/closet/stasis
	...
	var/mob/living/animal/holder_animal
