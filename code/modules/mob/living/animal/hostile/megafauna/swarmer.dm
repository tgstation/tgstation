...
GLOBAL_LIST_INIT(AISwarmerCapsByType, list(/mob/living/animal/hostile/swarmer/ai/resource = 30, /mob/living/animal/hostile/swarmer/ai/ranged_combat = 20, /mob/living/animal/hostile/swarmer/ai/melee_combat = 10))


//returns a type of AI swarmer that is NOT at max cap
//type order is shuffled, to prevent bias
/proc/GetUncappedAISwarmerType()
	var/static/list/swarmerTypes = subtypesof(/mob/living/animal/hostile/swarmer/ai)
...
/mob/living/animal/hostile/megafauna/swarmer_swarm_beacon
	name = "swarmer beacon"
...
/mob/living/animal/hostile/megafauna/swarmer_swarm_beacon/Initialize()
	. = ..()
	...
	for(var/ddir in GLOB.cardinals)
		...
		var/mob/living/animal/hostile/swarmer/ai/resource/R = new(loc)
		step(R, ddir) //Step the swarmers, instead of spawning them there, incase the turf is solid


/mob/living/animal/hostile/megafauna/swarmer_swarm_beacon/Life()
	. = ..()
	if(.)
...
/mob/living/animal/hostile/megafauna/swarmer_swarm_beacon/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	. = ..()
...
/mob/living/animal/hostile/swarmer/ai
	wander = 1
	faction = list("swarmer", "mining")
	weather_immunities = list("ash") //wouldn't be fun otherwise
	AIStatus = AI_ON

/mob/living/animal/hostile/swarmer/ai/Initialize()
	. = ..()
...
/mob/living/animal/hostile/swarmer/ai/Destroy()
	GLOB.AISwarmers -= src
	GLOB.AISwarmersByType[type] -= src
	return ..()


/mob/living/animal/hostile/swarmer/ai/SwarmerTypeToCreate()
	return GetUncappedAISwarmerType()


/mob/living/animal/hostile/swarmer/ai/resource/handle_automated_action()
	. = ..()
	if(.)
...
/mob/living/animal/hostile/swarmer/ai/Move(atom/newloc)
	if(newloc)
...
/mob/living/animal/hostile/swarmer/ai/proc/StartAction(deci = 0)
	stop_automated_movement = TRUE
	AIStatus = AI_OFF
	addtimer(CALLBACK(src, .proc/EndAction), deci)


/mob/living/animal/hostile/swarmer/ai/proc/EndAction()
...
/mob/living/animal/hostile/swarmer/ai/resource
	search_objects = 1
...
/mob/living/animal/hostile/swarmer/ai/resource/Initialize()
	. = ..()
...
/mob/living/animal/hostile/swarmer/ai/resource/CanAttack(atom/the_target)
...
/mob/living/animal/hostile/swarmer/ai/resource/OpenFire(atom/A)
	if(isliving(A)) //don't shoot rocks, sillies.
		..()


/mob/living/animal/hostile/swarmer/ai/resource/AttackingTarget()
...
/mob/living/animal/hostile/swarmer/ai/resource/proc/add_type_to_wanted(typepath)
	LAZYINITLIST(sharedWanted)
	if(!sharedWanted[typepath])// this and += is faster than |=
		sharedWanted += typecacheof(typepath)


/mob/living/animal/hostile/swarmer/ai/resource/proc/add_type_to_ignore(typepath)
...
//RANGED SWARMER
/mob/living/animal/hostile/swarmer/ai/ranged_combat
...
/mob/living/animal/hostile/swarmer/ai/ranged_combat/Aggro()
	..()
	summon_backup(15, TRUE) //Exact matching, so that goliaths don't come to aid the swarmers, that'd be silly


//MELEE SWARMER
/mob/living/animal/hostile/swarmer/ai/melee_combat
...
/mob/living/animal/hostile/swarmer/ai/melee_combat/Aggro()
	..()
	summon_backup(15, TRUE)


/mob/living/animal/hostile/swarmer/ai/melee_combat/AttackingTarget()
	if(isliving(target))
		if(prob(35))
			StartAction(30)
