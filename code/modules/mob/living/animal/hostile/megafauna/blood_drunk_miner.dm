...
/mob/living/animal/hostile/megafauna/blood_drunk_miner
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/guidance
	guidance = TRUE

/mob/living/animal/hostile/megafauna/blood_drunk_miner/hunter/AttackingTarget()
	. = ..()
	if(. && prob(12))
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/Initialize()
	. = ..()
	internal = new/obj/item/device/gps/internal/miner(src)
	miner_saw = new(src)

/mob/living/animal/hostile/megafauna/blood_drunk_miner/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	var/adjustment_amount = amount * 0.1
	if(world.time + adjustment_amount > next_move)
		changeNext_move(adjustment_amount) //attacking it interrupts it attacking, but only briefly
	. = ..()

/mob/living/animal/hostile/megafauna/blood_drunk_miner/death()
	if(health > 0)
		return
	new /obj/effect/temp_visual/dir_setting/miner_death(loc, dir)
	return ..()

/mob/living/animal/hostile/megafauna/blood_drunk_miner/Move(atom/newloc)
	if(dashing || (newloc && newloc.z == z && (istype(newloc, /turf/open/lava) || istype(newloc, /turf/open/chasm)))) //we're not stupid!
		return FALSE
	return ..()

/mob/living/animal/hostile/megafauna/blood_drunk_miner/ex_act(severity, target)
	if(dash())
		return
	return ..()

/mob/living/animal/hostile/megafauna/blood_drunk_miner/AttackingTarget()
	if(QDELETED(target))
		return
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect, end_pixel_y)
	if(!used_item && !isturf(A))
		used_item = miner_saw
	..()

/mob/living/animal/hostile/megafauna/blood_drunk_miner/GiveTarget(new_target)
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/OpenFire()
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/proc/shoot_ka()
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/proc/quick_attack_loop()
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/proc/dash(atom/dash_target)
...
/mob/living/animal/hostile/megafauna/blood_drunk_miner/proc/transform_weapon()
