...
/mob/living/animal/hostile/jungle/seedling
	name = "seedling"
...
/mob/living/animal/hostile/jungle/seedling/Goto()
	if(combatant_state != SEEDLING_STATE_NEUTRAL)
		return
	return ..()

/mob/living/animal/hostile/jungle/seedling/AttackingTarget()
	if(isliving(target))
...
/mob/living/animal/hostile/jungle/seedling/OpenFire()
	WarmupAttack()

/mob/living/animal/hostile/jungle/seedling/proc/WarmupAttack()
	if(combatant_state == SEEDLING_STATE_NEUTRAL)
...
/mob/living/animal/hostile/jungle/seedling/proc/SolarBeamStartup(mob/living/living_target)//It's more like requiem than final spark
...
/mob/living/animal/hostile/jungle/seedling/proc/Beamu(mob/living/living_target, beam_id = 0)
...
/mob/living/animal/hostile/jungle/seedling/proc/Volley()
	if(combatant_state == SEEDLING_STATE_WARMUP && target)
		combatant_state = SEEDLING_STATE_ACTIVE
		update_icons()
...
/mob/living/animal/hostile/jungle/seedling/proc/InaccurateShot()
...
/mob/living/animal/hostile/jungle/seedling/proc/AttackRecovery()
...
/mob/living/animal/hostile/jungle/seedling/proc/ResetNeutral()
	combatant_state = SEEDLING_STATE_NEUTRAL
	if(target && !stat)
		update_icons()
		Goto(target, move_to_delay, minimum_distance)

/mob/living/animal/hostile/jungle/seedling/adjustHealth()
	. = ..()
...
/mob/living/animal/hostile/jungle/seedling/update_icons()
	. = ..()
	if(!stat)
...
/mob/living/animal/hostile/jungle/seedling/GiveTarget()
	if(target)
...
/mob/living/animal/hostile/jungle/seedling/LoseTarget()
