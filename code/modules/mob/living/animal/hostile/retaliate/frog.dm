/mob/living/animal/hostile/retaliate/frog
	name = "frog"
...
/mob/living/animal/hostile/retaliate/frog/Initialize()
	. = ..()
	if(prob(1))
		name = "rare frog"
...
/mob/living/animal/hostile/retaliate/frog/Crossed(AM as mob|obj)
	if(!stat && isliving(AM))
		var/mob/living/L = AM
