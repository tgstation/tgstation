...
/mob/living/animal/hostile/gorilla
	name = "Gorilla"
...
/mob/living/animal/hostile/gorilla/proc/target_bodyparts(atom/the_target)
	var/list/parts = list()
...
/mob/living/animal/hostile/gorilla/AttackingTarget()
	if(client)
		oogaooga()
...
/mob/living/animal/hostile/gorilla/CanAttack(atom/the_target)
	var/list/parts = target_bodyparts(target)
	return ..() && !istype(the_target, /mob/living/carbon/monkey) && (!parts  || parts.len > 3)

/mob/living/animal/hostile/gorilla/CanSmashTurfs(turf/T)
	return iswallturf(T)

/mob/living/animal/hostile/gorilla/gib(no_brain)
	if(!no_brain)
...
/mob/living/animal/hostile/gorilla/handle_automated_speech(override)
	if(speak_chance && (override || prob(speak_chance)))
		playsound(src, "sound/creatures/gorilla.ogg", 200)
	..()

/mob/living/animal/hostile/gorilla/can_use_guns(obj/item/G)
	to_chat(src, "<span class='warning'>Your meaty finger is much too large for the trigger guard!</span>")
	return FALSE


/mob/living/animal/hostile/gorilla/proc/oogaooga()
	oogas++
	if(oogas >= rand(2,6))
		playsound(src, "sound/creatures/gorilla.ogg", 200)
		oogas = 0
