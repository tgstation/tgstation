/mob/living/animal/hostile/gorilla/proc/apply_overlay(cache_index)
	. = gorilla_overlays[cache_index]
	if(.)
		add_overlay(.)

/mob/living/animal/hostile/gorilla/proc/remove_overlay(cache_index)
	var/I = gorilla_overlays[cache_index]
	if(I)
		cut_overlay(I)
		gorilla_overlays[cache_index] = null

/mob/living/animal/hostile/gorilla/update_inv_hands()
...
/mob/living/animal/hostile/gorilla/regenerate_icons()
	update_inv_hands()
