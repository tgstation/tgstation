...
/mob/living/animal/hostile/poison/bees/Process_Spacemove(movement_dir = 0)
	return 1


/mob/living/animal/hostile/poison/bees/Initialize()
	. = ..()
	generate_bee_visuals()


/mob/living/animal/hostile/poison/bees/Destroy()
	if(beehome)
		beehome.bees -= src
		beehome = null
	beegent = null
...
/mob/living/animal/hostile/poison/bees/death(gibbed)
	if(beehome)
		beehome.bees -= src
		beehome = null
	beegent = null
...
/mob/living/animal/hostile/poison/bees/examine(mob/user)
	..()
...
/mob/living/animal/hostile/poison/bees/proc/generate_bee_visuals()
	cut_overlays()
...
/mob/living/animal/hostile/poison/bees/CanAttack(atom/the_target)
	. = ..()
	if(!.)
		return FALSE
...
/mob/living/animal/hostile/poison/bees/Found(atom/A)
	if(isliving(A))
		var/mob/living/H = A
		return !H.bee_friendly()
...
/mob/living/animal/hostile/poison/bees/AttackingTarget()
 	//Pollinate
...
/mob/living/animal/hostile/poison/bees/proc/assign_reagent(datum/reagent/R)
	if(istype(R))
		beegent = R
...
/mob/living/animal/hostile/poison/bees/proc/pollinate(obj/machinery/hydroponics/Hydro)
...
/mob/living/animal/hostile/poison/bees/handle_automated_action()
	. = ..()
	if(!.)
		return
...
/mob/living/animal/hostile/poison/bees/queen/Found(atom/A)
	return FALSE


//leave pollination for the peasent bees
/mob/living/animal/hostile/poison/bees/queen/AttackingTarget()
	. = ..()
	if(. && beegent && isliving(target))
		var/mob/living/L = target
...
//PEASENT BEES
/mob/living/animal/hostile/poison/bees/queen/pollinate()
	return


/mob/living/animal/hostile/poison/bees/proc/reagent_incompatible(mob/living/animal/hostile/poison/bees/B)
	if(!B)
		return FALSE
...
/obj/item/queen_bee
	...
	item_state = ""
	icon = 'icons/mob/bees.dmi'
	var/mob/living/animal/hostile/poison/bees/queen/queen
