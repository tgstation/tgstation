/mob/living/animal/hostile/tree
	name = "pine tree"
...
/mob/living/animal/hostile/tree/Life()
	..()
	if(isopenturf(loc))
...
/mob/living/animal/hostile/tree/AttackingTarget()
	. = ..()
	if(iscarbon(target))
...
/mob/living/animal/hostile/tree/festivus
	name = "festivus pole"
