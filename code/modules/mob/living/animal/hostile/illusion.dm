/mob/living/animal/hostile/illusion
	name = "illusion"
	desc = "It's a fake!"
...
/mob/living/animal/hostile/illusion/Life()
	..()
	if(world.time > life_span)
		death()


/mob/living/animal/hostile/illusion/proc/Copy_Parent(mob/living/original, life = 50, health = 100, damage = 0, replicate = 0 )
...
/mob/living/animal/hostile/illusion/examine(mob/user)
	if(parent_mob)
...
/mob/living/animal/hostile/illusion/AttackingTarget()
	. = ..()
	if(. && isliving(target) && prob(multiply_chance))
		var/mob/living/L = target
		if(L.stat == DEAD)
			return
		var/mob/living/animal/hostile/illusion/M = new(loc)
...
/mob/living/animal/hostile/illusion/escape
	retreat_distance = 10
	minimum_distance = 10
...
/mob/living/animal/hostile/illusion/escape/AttackingTarget()
	return FALSE
