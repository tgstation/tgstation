...
/mob/living/animal/hostile/asteroid/fugu
	name = "wumborian fugu"
...
/mob/living/animal/hostile/asteroid/fugu/Life()
	if(!wumbo)
...
/mob/living/animal/hostile/asteroid/fugu/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	if(!forced && wumbo)
		return FALSE
	. = ..()

/mob/living/animal/hostile/asteroid/fugu/Aggro()
	..()
	Inflate()

/mob/living/animal/hostile/asteroid/fugu/verb/Inflate()
	set name = "Inflate"
	set category = "Fugu"
...
/mob/living/animal/hostile/asteroid/fugu/proc/Deflate()
	if(wumbo)
		walk(src, 0)
		wumbo = 0
		icon_state = "Fugu"
...
/mob/living/animal/hostile/asteroid/fugu/death(gibbed)
	Deflate()
	..(gibbed)
