/mob/living/animal/hostile/mimic
	name = "crate"
...
/mob/living/animal/hostile/mimic/crate
	attacktext = "bites"
...
// Pickup loot
/mob/living/animal/hostile/mimic/crate/Initialize(mapload)
	. = ..()
	if(mapload)	//eat shit
		for(var/obj/item/I in loc)
			I.loc = src

/mob/living/animal/hostile/mimic/crate/DestroySurroundings()
	..()
	if(prob(90))
...
/mob/living/animal/hostile/mimic/crate/ListTargets()
	if(attempt_open)
		return ..()
	return ..(1)

/mob/living/animal/hostile/mimic/crate/FindTarget()
	. = ..()
	if(.)
		trigger()

/mob/living/animal/hostile/mimic/crate/AttackingTarget()
	. = ..()
	if(.)
		icon_state = initial(icon_state)
...
/mob/living/animal/hostile/mimic/crate/proc/trigger()
	if(!attempt_open)
		visible_message("<b>[src]</b> starts to move!")
		attempt_open = TRUE

/mob/living/animal/hostile/mimic/crate/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	trigger()
	. = ..()

/mob/living/animal/hostile/mimic/crate/LoseTarget()
	..()
	icon_state = initial(icon_state)

/mob/living/animal/hostile/mimic/crate/death()
...
/mob/living/animal/hostile/mimic/copy
	health = 100
	maxHealth = 100
...
/mob/living/animal/hostile/mimic/copy/Initialize(mapload, obj/copy, mob/living/creator, destroy_original = 0)
	. = ..()
	CopyObject(copy, creator, destroy_original)

/mob/living/animal/hostile/mimic/copy/Life()
	..()
...
/mob/living/animal/hostile/mimic/copy/death()
	for(var/atom/movable/M in src)
		M.loc = get_turf(src)
	..()

/mob/living/animal/hostile/mimic/copy/ListTargets()
	. = ..()
	return . - creator

/mob/living/animal/hostile/mimic/copy/proc/ChangeOwner(mob/owner)
	if(owner != creator)
		LoseTarget()
		creator = owner
		faction |= "\ref[owner]"

/mob/living/animal/hostile/mimic/copy/proc/CheckObject(obj/O)
	if((isitem(O) || isstructure(O)) && !is_type_in_list(O, GLOB.protected_objects))
		return 1
	return 0

/mob/living/animal/hostile/mimic/copy/proc/CopyObject(obj/O, mob/living/user, destroy_original = 0)
...
/mob/living/animal/hostile/mimic/copy/DestroySurroundings()
	if(destroy_objects)
		..()

/mob/living/animal/hostile/mimic/copy/AttackingTarget()
	. = ..()
...
/mob/living/animal/hostile/mimic/copy/machine
...
/mob/living/animal/hostile/mimic/copy/machine/CanAttack(atom/the_target)
...
/mob/living/animal/hostile/mimic/copy/ranged
...
/mob/living/animal/hostile/mimic/copy/ranged/CopyObject(obj/O, mob/living/creator, destroy_original = 0)
	if(..())
...
/mob/living/animal/hostile/mimic/copy/ranged/OpenFire(the_target)
	if(Zapgun)
		if(Zapgun.cell)
