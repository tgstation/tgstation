//Space bears!
/mob/living/animal/hostile/bear
	name = "space bear"
...
/mob/living/animal/hostile/bear/Hudson
	name = "Hudson"
	gender = MALE
	desc = "Feared outlaw, this guy is one bad news bear." //I'm sorry...

/mob/living/animal/hostile/bear/snow
...
/mob/living/animal/hostile/bear/russian
	name = "combat bear"
...
/mob/living/animal/hostile/bear/Process_Spacemove(movement_dir = 0)
	return 1	//No drifting in space for space bears!

/mob/living/animal/hostile/bear/update_icons()
	..()
	if(armored)
...
/obj/item/bear_armor/afterattack(atom/target, mob/user, proximity_flag)
	if(istype(target, /mob/living/animal/hostile/bear) && proximity_flag)
		var/mob/living/animal/hostile/bear/A = target
		if(A.armored)
