/mob/living/animal/hostile/stickman
...
/mob/living/animal/hostile/stickman/ranged
	ranged = 1
	retreat_distance = 5
	minimum_distance = 5
...
/mob/living/animal/hostile/stickman/dog
...
/mob/living/animal/hostile/stickman/Initialize(mapload, var/wizard_summoned)
	. = ..()
	new /obj/effect/temp_visual/paper_scatter(src)
	summoned_by_wizard = wizard_summoned

/mob/living/animal/hostile/stickman/death()
	..()
