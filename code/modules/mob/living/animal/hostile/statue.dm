...
/mob/living/animal/hostile/statue
...
/mob/living/animal/hostile/statue/Initialize(mapload, var/mob/living/creator)
	. = ..()
	// Give spells
...
/mob/living/animal/hostile/statue/med_hud_set_health()
	return //we're a statue we're invincible

/mob/living/animal/hostile/statue/med_hud_set_status()
	return //we're a statue we're invincible

/mob/living/animal/hostile/statue/Move(turf/NewLoc)
...
/mob/living/animal/hostile/statue/Life()
	..()
...
/mob/living/animal/hostile/statue/AttackingTarget()
...
/mob/living/animal/hostile/statue/DestroySurroundings()
	if(!can_be_seen(get_turf(loc)))
		..()

/mob/living/animal/hostile/statue/face_atom()
	if(!can_be_seen(get_turf(loc)))
		..()

/mob/living/animal/hostile/statue/proc/can_be_seen(turf/destination)
	if(!cannot_be_seen)
		return null
	// Check for darkness
...
/mob/living/animal/hostile/statue/say()
	return 0

// Turn to dust when gibbed

/mob/living/animal/hostile/statue/gib()
	dust()


// Stop attacking clientless mobs

/mob/living/animal/hostile/statue/CanAttack(atom/the_target)
...
/mob/living/animal/hostile/statue/ListTargets()
	. = ..()
	return . - creator
...
/mob/living/animal/hostile/statue/sentience_act()
	faction -= "neutral"

/mob/living/animal/hostile/statue/restrained(ignore_grab)
	. = ..()
	if(can_be_seen(loc))
		return 1
