/mob/living/animal/hostile/construct
	name = "Construct"
	real_name = "Construct"
	desc = ""
	gender = NEUTER
...
/mob/living/animal/hostile/construct/Initialize()
	. = ..()
	update_health_hud()
	for(var/spell in construct_spells)
		AddSpell(new spell(null))

/mob/living/animal/hostile/construct/Login()
	..()
	to_chat(src, playstyle_string)

/mob/living/animal/hostile/construct/examine(mob/user)
...
/mob/living/animal/hostile/construct/attack_animal(mob/living/animal/M)
...
/mob/living/animal/hostile/construct/Process_Spacemove(movement_dir = 0)
	return 1

/mob/living/animal/hostile/construct/narsie_act()
	return

/mob/living/animal/hostile/construct/electrocute_act(shock_damage, obj/source, siemens_coeff = 1, safety = 0, tesla_shock = 0, illusion = 0, stun = TRUE)
	return 0

/mob/living/animal/hostile/construct/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	. = ..()
	if(updating_health)
		update_health_hud()
...
/mob/living/animal/hostile/construct/armored/hostile //actually hostile, will move around, hit things
	AIStatus = AI_ON
	environment_smash = ENVIRONMENT_SMASH_STRUCTURES //only token destruction, don't smash the cult wall NO STOP

/mob/living/animal/hostile/construct/armored/bullet_act(obj/item/projectile/P)
...
////////////////////////Wraith/////////////////////////////////////////////
/mob/living/animal/hostile/construct/wraith
	name = "Wraith"
	real_name = "Wraith"
...
/mob/living/animal/hostile/construct/wraith/AttackingTarget() //refund jaunt cooldown when attacking living targets
	var/prev_stat
...
/mob/living/animal/hostile/construct/wraith/hostile //actually hostile, will move around, hit things
	AIStatus = AI_ON



/////////////////////////////Artificer/////////////////////////
/mob/living/animal/hostile/construct/builder
	name = "Artificer"
	real_name = "Artificer"
...
/mob/living/animal/hostile/construct/builder/Found(atom/A) //what have we found here?
	if(isconstruct(A)) //is it a construct?
		var/mob/living/animal/hostile/construct/C = A
...
/mob/living/animal/hostile/construct/builder/CanAttack(atom/the_target)
...
/mob/living/animal/hostile/construct/builder/MoveToTarget(var/list/possible_targets)
	..()
	if(isliving(target))
		var/mob/living/L = target
...
/mob/living/animal/hostile/construct/builder/Aggro()
	..()
	if(isconstruct(target)) //oh the target is a construct no need to flee
		retreat_distance = null
		minimum_distance = 1

/mob/living/animal/hostile/construct/builder/LoseAggro()
	..()
	retreat_distance = initial(retreat_distance)
	minimum_distance = initial(minimum_distance)

/mob/living/animal/hostile/construct/builder/hostile //actually hostile, will move around, hit things, heal other constructs
	AIStatus = AI_ON
	environment_smash = ENVIRONMENT_SMASH_STRUCTURES //only token destruction, don't smash the cult wall NO STOP

/////////////////////////////Non-cult Artificer/////////////////////////
/mob/living/animal/hostile/construct/builder/noncult
	construct_spells = list(/obj/effect/proc_holder/spell/aoe_turf/conjure/wall,
							/obj/effect/proc_holder/spell/aoe_turf/conjure/floor,
...
/////////////////////////////Harvester/////////////////////////
/mob/living/animal/hostile/construct/harvester
	name = "Harvester"
	real_name = "Harvester"
...
/mob/living/animal/hostile/construct/harvester/Collide(atom/AM)
	. = ..()
...
/mob/living/animal/hostile/construct/harvester/AttackingTarget()
	if(iscarbon(target))
...
/mob/living/animal/hostile/construct/harvester/Initialize()
	. = ..()
...
/datum/action/innate/seek_master
	...
	var/tracking = FALSE
	var/mob/living/animal/hostile/construct/the_construct
...
/datum/action/innate/seek_prey
	...
	buttontooltipstyle = "cult"
	button_icon_state = "cult_mark"
	var/mob/living/animal/hostile/construct/harvester/the_construct
...
/mob/living/animal/hostile/construct/update_health_hud()
	if(hud_used)
		if(health >= maxHealth)
