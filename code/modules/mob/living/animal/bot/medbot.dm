...
/mob/living/animal/bot/medbot/mysterious
...
/mob/living/animal/bot/medbot/derelict
...
/mob/living/animal/bot/medbot/update_icon()
	cut_overlays()
	if(skin)
...
/mob/living/animal/bot/medbot/Initialize(mapload, new_skin)
	. = ..()
...
/mob/living/animal/bot/medbot/update_canmove()
	. = ..()
	update_icon()

/mob/living/animal/bot/medbot/bot_reset()
	..()
	patient = null
	oldpatient = null
	oldloc = null
...
/mob/living/animal/bot/medbot/proc/soft_reset() //Allows the medibot to still actively perform its medical duties without being completely halted as a hard reset does.
	path = list()
	patient = null
	mode = BOT_IDLE
	last_found = world.time
...
/mob/living/animal/bot/medbot/set_custom_texts()
...
/mob/living/animal/bot/medbot/attack_paw(mob/user)
	return attack_hand(user)

/mob/living/animal/bot/medbot/get_controls(mob/user)
	var/dat
	dat += hack(user)
	dat += showpai(user)
...
/mob/living/animal/bot/medbot/Topic(href, href_list)
	if(..())
		return 1
...
/mob/living/animal/bot/medbot/attackby(obj/item/W as obj, mob/user as mob, params)
...
/mob/living/animal/bot/medbot/emag_act(mob/user)
	..()
	if(emagged == 2)
		declare_crit = 0
		if(user)
...
/mob/living/animal/bot/medbot/process_scan(mob/living/carbon/human/H)
	if(H.stat == DEAD)
		return
...
/mob/living/animal/bot/medbot/handle_automated_action()
	if(!..())
		return
...
/mob/living/animal/bot/medbot/proc/assess_patient(mob/living/carbon/C)
...
/mob/living/animal/bot/medbot/UnarmedAttack(atom/A)
	if(iscarbon(A))
...
/mob/living/animal/bot/medbot/examinate(atom/A as mob|obj|turf in view())
	..()
	if(!is_blind(src))
		chemscan(src, A)

/mob/living/animal/bot/medbot/proc/medicate_patient(mob/living/carbon/C)
	if(!on)
		return
...
/mob/living/animal/bot/medbot/proc/check_overdose(mob/living/carbon/patient,reagent_id,injection_amount)
...
/mob/living/animal/bot/medbot/explode()
	on = FALSE
...
/mob/living/animal/bot/medbot/proc/declare(crit_patient)
