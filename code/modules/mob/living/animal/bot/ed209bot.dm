...
/mob/living/animal/bot/ed209/Initialize(mapload,created_name,created_lasercolor)
	. = ..()
	if(created_name)
		name = created_name
...
/mob/living/animal/bot/ed209/turn_on()
	. = ..()
	icon_state = "[lasercolor]ed209[on]"
	mode = BOT_IDLE

/mob/living/animal/bot/ed209/turn_off()
	..()
	icon_state = "[lasercolor]ed209[on]"

/mob/living/animal/bot/ed209/bot_reset()
	..()
	target = null
	oldtarget_name = null
	anchored = FALSE
...
/mob/living/animal/bot/ed209/set_custom_texts()
...
/mob/living/animal/bot/ed209/get_controls(mob/user)
	var/dat
	dat += hack(user)
	dat += showpai(user)
	dat += text({"
...
/mob/living/animal/bot/ed209/Topic(href, href_list)
...
/mob/living/animal/bot/ed209/proc/judgement_criteria()
	var/final = FALSE
	if(idcheck)
...
/mob/living/animal/bot/ed209/proc/retaliate(mob/living/carbon/human/H)
...
/mob/living/animal/bot/ed209/attack_hand(mob/living/carbon/human/H)
	if(H.a_intent == INTENT_HARM)
		retaliate(H)
	return ..()

/mob/living/animal/bot/ed209/attackby(obj/item/W, mob/user, params)
	..()
...
/mob/living/animal/bot/ed209/emag_act(mob/user)
	..()
	if(emagged == 2)
		if(user)
...
/mob/living/animal/bot/ed209/bullet_act(obj/item/projectile/Proj)
...
/mob/living/animal/bot/ed209/handle_automated_action()
	if(!..())
		return
...
/mob/living/animal/bot/ed209/proc/back_to_idle()
	anchored = FALSE
	mode = BOT_IDLE
	target = null
	last_found = world.time
...
/mob/living/animal/bot/ed209/proc/back_to_hunt()
	anchored = FALSE
	frustration = 0
	mode = BOT_HUNT
	INVOKE_ASYNC(src, .proc/handle_automated_action) //ensure bot quickly responds
...
/mob/living/animal/bot/ed209/proc/look_for_perp()
	if(disabled)
		return
	anchored = FALSE
	threatlevel = 0
...
/mob/living/animal/bot/ed209/proc/check_for_weapons(var/obj/item/slot_item)
	if(slot_item && slot_item.needs_permit)
		return 1
	return 0

/mob/living/animal/bot/ed209/explode()
	walk_to(src,0)
...
/mob/living/animal/bot/ed209/proc/set_weapon()  //used to update the projectile type and firing sound
...
/mob/living/animal/bot/ed209/proc/shootAt(mob/target)
...
/mob/living/animal/bot/ed209/attack_alien(mob/living/carbon/alien/user)
	..()
	if(!isalien(target))
		target = user
		mode = BOT_HUNT
...
/mob/living/animal/bot/ed209/emp_act(severity)
...
/mob/living/animal/bot/ed209/bluetag
	lasercolor = "b"

/mob/living/animal/bot/ed209/redtag
	lasercolor = "r"

/mob/living/animal/bot/ed209/UnarmedAttack(atom/A)
	if(!on)
		return
	if(iscarbon(A))
...
/mob/living/animal/bot/ed209/RangedAttack(atom/A)
	if(!on)
		return
	shootAt(A)

/mob/living/animal/bot/ed209/proc/stun_attack(mob/living/carbon/C)
...
/mob/living/animal/bot/ed209/proc/cuff(mob/living/carbon/C)
	mode = BOT_ARREST
