//Cleanbot
/mob/living/animal/bot/cleanbot
...
/mob/living/animal/bot/cleanbot/Initialize()
	. = ..()
	get_targets()
...
/mob/living/animal/bot/cleanbot/turn_on()
	..()
	icon_state = "cleanbot[on]"
	bot_core.updateUsrDialog()

/mob/living/animal/bot/cleanbot/turn_off()
	..()
	icon_state = "cleanbot[on]"
	bot_core.updateUsrDialog()

/mob/living/animal/bot/cleanbot/bot_reset()
	..()
	ignore_list = list() //Allows the bot to clean targets it previously ignored due to being unreachable.
	target = null
	oldloc = null

/mob/living/animal/bot/cleanbot/set_custom_texts()
	text_hack = "You corrupt [name]'s cleaning software."
	text_dehack = "[name]'s software has been reset!"
	text_dehack_fail = "[name] does not seem to respond to your repair code!"

/mob/living/animal/bot/cleanbot/attackby(obj/item/W, mob/user, params)
...
/mob/living/animal/bot/cleanbot/emag_act(mob/user)
	..()
	if(emagged == 2)
		if(user)
			to_chat(user, "<span class='danger'>[src] buzzes and beeps.</span>")

/mob/living/animal/bot/cleanbot/process_scan(atom/A)
	if(iscarbon(A))
...
/mob/living/animal/bot/cleanbot/handle_automated_action()
	if(!..())
		return
...
/mob/living/animal/bot/cleanbot/proc/get_targets()
	target_types = list(
	...
	if(pests)
		target_types += /mob/living/animal/cockroach
		target_types += /mob/living/animal/mouse
...
/mob/living/animal/bot/cleanbot/UnarmedAttack(atom/A)
	if(istype(A, /obj/effect/decal/cleanable))
		...
		A.acid_act(75, 10)
	else if(istype(A, /mob/living/animal/cockroach) || istype(A, /mob/living/animal/mouse))
...
/mob/living/animal/bot/cleanbot/explode()
	on = FALSE
...
/mob/living/animal/bot/cleanbot/get_controls(mob/user)
	var/dat
	dat += hack(user)
	dat += showpai(user)
	dat += text({"
...
/mob/living/animal/bot/cleanbot/Topic(href, href_list)
	if(..())
		return 1
