...
/obj/item/bucket_sensor/attackby(obj/item/W, mob/user as mob, params)
	...
	if(istype(W, /obj/item/bodypart/l_arm/robot) || istype(W, /obj/item/bodypart/r_arm/robot))
		...
		var/mob/living/animal/bot/cleanbot/A = new /mob/living/animal/bot/cleanbot(T)
		A.name = created_name
	...
	switch(build_step)
		...
		if(9)
			if(istype(W, /obj/item/stock_parts/cell))
				...
				new /mob/living/animal/bot/ed209(T,created_name,lasercolor)
				qdel(W)
				qdel(src)
...
/obj/item/toolbox_tiles_sensor/attackby(obj/item/W, mob/user, params)
	...
	if(istype(W, /obj/item/bodypart/l_arm/robot) || istype(W, /obj/item/bodypart/r_arm/robot))
		...
		var/mob/living/animal/bot/floorbot/A = new /mob/living/animal/bot/floorbot(T)
		A.name = created_name
		...
		switch(build_step)
			...
			if(1)
				if(isprox(W))
					...
					var/turf/T = get_turf(src)
					var/mob/living/animal/bot/medbot/S = new /mob/living/animal/bot/medbot(T, skin)
					S.name = created_name
					qdel(src)
...
/obj/item/secbot_assembly/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/weldingtool))
		...
		var/mob/living/animal/bot/secbot/S = new /mob/living/animal/bot/secbot(get_turf(src))
		S.name = created_name
		S.baton_type = I.type
		qdel(I)
		qdel(src)
