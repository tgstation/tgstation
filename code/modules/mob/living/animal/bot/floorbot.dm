...
/mob/living/animal/bot/floorbot/Initialize()
	. = ..()
	update_icon()
...
/mob/living/animal/bot/floorbot/Process_Spacemove(movement_dir = 0)
	return 1

/mob/living/animal/bot/floorbot/turn_on()
	. = ..()
	update_icon()

/mob/living/animal/bot/floorbot/turn_off()
	..()
	update_icon()

/mob/living/animal/bot/floorbot/bot_reset()
	..()
	target = null
	oldloc = null
	ignore_list = list()
...
/mob/living/animal/bot/floorbot/set_custom_texts()
	text_hack = "You corrupt [name]'s construction protocols."
	text_dehack = "You detect errors in [name] and reset his programming."
	text_dehack_fail = "[name] is not responding to reset commands!"

/mob/living/animal/bot/floorbot/get_controls(mob/user)
	var/dat
	dat += hack(user)
	dat += showpai(user)
...
/mob/living/animal/bot/floorbot/attackby(obj/item/W , mob/user, params)
...
/mob/living/animal/bot/floorbot/emag_act(mob/user)
	..()
	if(emagged == 2)
		if(user)
			to_chat(user, "<span class='danger'>[src] buzzes and beeps.</span>")

/mob/living/animal/bot/floorbot/Topic(href, href_list)
	if(..())
		return 1
...
/mob/living/animal/bot/floorbot/proc/empty_tiles()
...
/mob/living/animal/bot/floorbot/handle_automated_action()
	if(!..())
		return
...
/mob/living/animal/bot/floorbot/proc/is_hull_breach(turf/t) //Ignore space tiles not considered part of a structure, also ignores shuttle docking areas.
...
/mob/living/animal/bot/floorbot/process_scan(scan_target)
	var/result
...
/mob/living/animal/bot/floorbot/proc/repair(turf/target_turf)
...
/mob/living/animal/bot/floorbot/update_icon()
	icon_state = "floorbot[on]"


/mob/living/animal/bot/floorbot/explode()
	on = FALSE
...
/mob/living/animal/bot/floorbot/UnarmedAttack(atom/A)
	if(isturf(A))
		repair(A)
	else
		..()
