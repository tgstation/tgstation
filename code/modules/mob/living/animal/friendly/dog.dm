...
/mob/living/animal/pet/dog/corgi
	...
	childtype = list(/mob/living/animal/pet/dog/corgi/puppy = 95, /mob/living/animal/pet/dog/corgi/puppy/void = 5)
	animal_species = /mob/living/animal/pet/dog
	var/shaved = 0
...
/mob/living/animal/pet/dog/Initialize()
	. = ..()
...
/mob/living/animal/pet/dog/corgi/Initialize()
	. = ..()
	regenerate_icons()


/mob/living/animal/pet/dog/corgi/death(gibbed)
	..(gibbed)
	regenerate_icons()

/mob/living/animal/pet/dog/corgi/show_inv(mob/user)
...
/mob/living/animal/pet/dog/corgi/getarmor(def_zone, type)
	var/armorval = 0
...
/mob/living/animal/pet/dog/corgi/attackby(obj/item/O, mob/user, params)
...
/mob/living/animal/pet/dog/corgi/Topic(href, href_list)
	if(usr.stat)
		return
...
/mob/living/animal/pet/dog/corgi/proc/place_on_head(obj/item/item_to_add, mob/user)
...
/mob/living/animal/pet/dog/corgi/proc/update_corgi_fluff()
...
//IAN! SQUEEEEEEEEE~
/mob/living/animal/pet/dog/corgi/Ian
	name = "Ian"
...
/mob/living/animal/pet/dog/corgi/Ian/Initialize()
	. = ..()
	...
	if(age == 0)
		...
		if(target)
			var/mob/living/animal/pet/dog/corgi/puppy/P = new /mob/living/animal/pet/dog/corgi/puppy(target)
			P.name = "Ian"
			P.real_name = "Ian"
			P.gender = MALE
...
/mob/living/animal/pet/dog/corgi/Ian/Life()
	if(!stat && SSticker.current_state == GAME_STATE_FINISHED && !memory_saved)
		Write_Memory(FALSE)
		memory_saved = TRUE
	..()

/mob/living/animal/pet/dog/corgi/Ian/death()
	if(!memory_saved)
		Write_Memory(TRUE)
	..()

/mob/living/animal/pet/dog/corgi/Ian/proc/Read_Memory()
...
/mob/living/animal/pet/dog/corgi/Ian/proc/Write_Memory(dead)
	var/json_file = file("data/npc_saves/Ian.json")
...
/mob/living/animal/pet/dog/corgi/Ian/narsie_act()
	playsound(src, 'sound/magic/demon_dies.ogg', 75, TRUE)
	var/mob/living/animal/pet/dog/corgi/narsie/N = new(loc)
	N.setDir(dir)
	gib()

/mob/living/animal/pet/dog/corgi/narsie
	name = "Nars-Ian"
	desc = "Ia! Ia!"
	icon_state = "narsian"
	icon_living = "narsian"
...
/mob/living/animal/pet/dog/corgi/narsie/Life()
	..()
	for(var/mob/living/animal/pet/P in range(1, src))
		if(P != src && prob(5))
...
/mob/living/animal/pet/dog/corgi/narsie/update_corgi_fluff()
	..()
...
/mob/living/animal/pet/dog/corgi/narsie/narsie_act()
	adjustBruteLoss(-maxHealth)


/mob/living/animal/pet/dog/corgi/regenerate_icons()
	cut_overlays()
	if(inventory_head)
		var/image/head_icon
		var/datum/dog_fashion/DF = new inventory_head.dog_fashion(src)
...
/mob/living/animal/pet/dog/corgi/puppy
...
/mob/living/animal/pet/dog/corgi/puppy/Topic(href, href_list)
...
/mob/living/animal/pet/dog/corgi/puppy/void		//Tribute to the corgis born in nullspace
...
/mob/living/animal/pet/dog/corgi/puppy/void/Process_Spacemove(movement_dir = 0)
	return 1	//Void puppies can navigate space.


//LISA! SQUEEEEEEEEE~
/mob/living/animal/pet/dog/corgi/Lisa
	name = "Lisa"
	real_name = "Lisa"
	gender = FEMALE
...
/mob/living/animal/pet/dog/corgi/Lisa/Topic(href, href_list)
	if(href_list["remove_inv"] || href_list["add_inv"])
		to_chat(usr, "<span class='danger'>[src] already has a cute bow!</span>")
		return
	..()

/mob/living/animal/pet/dog/corgi/Lisa/Life()
	..()
...
/mob/living/animal/pet/dog/pug/Life()
	..()
...
/mob/living/animal/pet/dog/attack_hand(mob/living/carbon/human/M)
	. = ..()
	switch(M.a_intent)
		if("help")
			wuv(1,M)
...
/mob/living/animal/pet/dog/proc/wuv(change, mob/M)
	if(change)
		if(change > 0)
