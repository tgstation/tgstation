...
/obj/item/drone_shell
	...
	var/drone_type = /mob/living/animal/drone //Type of drone that will be spawned
...
/obj/item/drone_shell/attack_ghost(mob/user)
	...
	if(be_drone == "No" || QDELETED(src) || !isobserver(user))
		return
	var/mob/living/animal/drone/D = new drone_type(get_turf(loc))
...
/obj/item/clothing/head/drone_holder//Only exists in someones hand.or on their head
	...
	var/mob/living/animal/drone/drone //stored drone
...
/obj/item/clothing/head/drone_holder/proc/updateVisualAppearence(mob/living/animal/drone/D)
	if(!D)
		return
