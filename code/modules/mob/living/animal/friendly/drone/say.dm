...
/mob/living/animal/drone/handle_inherent_channels(message, message_mode)
...
/mob/living/animal/drone/get_spans()
	return ..() | SPAN_ROBOT
...
/proc/_alert_drones(msg, dead_can_hear = 0, atom/source, mob/living/faction_checked_mob, exact_faction_match)
	for(var/W in GLOB.mob_list)
		var/mob/living/animal/drone/M = W
