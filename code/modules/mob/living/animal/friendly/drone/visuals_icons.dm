...
/mob/living/animal/drone/proc/apply_overlay(cache_index)
	if((. = drone_overlays[cache_index]))
		add_overlay(.)


/mob/living/animal/drone/proc/remove_overlay(cache_index)
...
/mob/living/animal/drone/update_inv_hands()
...
/mob/living/animal/drone/update_inv_wear_mask()
	update_inv_head()

/mob/living/animal/drone/regenerate_icons()
...
/mob/living/animal/drone/proc/pickVisualAppearence()
	picked = FALSE
...
/mob/living/animal/drone/proc/getItemPixelShiftY()
...
/mob/living/animal/drone/proc/updateSeeStaticMobs()
	if(!client)
		return
...
/mob/living/animal/drone/generateStaticOverlay()
	return
