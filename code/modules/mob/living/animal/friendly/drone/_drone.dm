...
/mob/living/animal/drone/Initialize()
	. = ..()
	...
	if(seeStatic)
		...
		verbs -= /mob/living/animal/drone/verb/toggle_statics

	var/datum/atom_hud/data/diagnostic/diag_hud = GLOB.huds[DATA_HUD_DIAGNOSTIC]
	diag_hud.add_to_hud(src)


/mob/living/animal/drone/med_hud_set_health()
	var/image/holder = hud_list[DIAG_HUD]
	var/icon/I = icon(icon, icon_state, dir)
	holder.pixel_y = I.Height() - world.icon_size
	holder.icon_state = "huddiag[RoundDiagBar(health/maxHealth)]"

/mob/living/animal/drone/med_hud_set_status()
...
/mob/living/animal/drone/Destroy()
	qdel(access_card) //Otherwise it ends up on the floor!
	return ..()

/mob/living/animal/drone/Login()
	..()
	check_laws()
...
/mob/living/animal/drone/death(gibbed)
	..(gibbed)
	if(internal_storage)
...
/mob/living/animal/drone/gib()
	dust()

/mob/living/animal/drone/ratvar_act()
	...
	if(head)
		dropItemToGround(head)
	var/mob/living/animal/drone/cogscarab/ratvar/R = new /mob/living/animal/drone/cogscarab/ratvar(loc)
	R.setDir(dir)
	if(mind)
...
/mob/living/animal/drone/examine(mob/user)
...
/mob/living/animal/drone/assess_threat(judgement_criteria, lasercolor = "", datum/callback/weaponcheck=null) //Secbots won't hunt maintenance drones.
	return -10


/mob/living/animal/drone/emp_act(severity)
	Stun(100)
...
/mob/living/animal/drone/proc/triggerAlarm(class, area/A, O, obj/alarmsource)
	if(alarmsource.z != z)
		return
	if(stat != DEAD)
...
/mob/living/animal/drone/proc/cancelAlarm(class, area/A, obj/origin)
	if(stat != DEAD)
...
/mob/living/animal/drone/handle_temperature_damage()
	return

/mob/living/animal/drone/flash_act(intensity = 1, override_blindness_check = 0, affect_silicon = 0)
	if(affect_silicon)
		return ..()

/mob/living/animal/drone/mob_negates_gravity()
	return 1

/mob/living/animal/drone/mob_has_gravity()
	return ..() || mob_negates_gravity()

/mob/living/animal/drone/experience_pressure_difference(pressure_difference, direction)
	return

/mob/living/animal/drone/bee_friendly()
	// Why would bees pay attention to drones?
	return 1

/mob/living/animal/drone/electrocute_act(shock_damage, obj/source, siemens_coeff = 1, safety = 0, tesla_shock = 0, illusion = 0, stun = TRUE)
