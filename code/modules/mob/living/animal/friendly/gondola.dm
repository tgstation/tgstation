...
/mob/living/animal/pet/gondola/Initialize()
	. = ..()
	CreateGondola()

/mob/living/animal/pet/gondola/proc/CreateGondola()
	icon_state = null
	icon_living = null
...
/mob/living/animal/pet/gondola/IsVocal() //Gondolas are the silent walker.
	return FALSE

/mob/living/animal/pet/gondola/emote()
	return
