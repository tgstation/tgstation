...
/mob/living/animal/cockroach/death(gibbed)
...
/mob/living/animal/cockroach/Crossed(var/atom/movable/AM)
	if(ismob(AM))
		if(isliving(AM))
			var/mob/living/A = AM
...
/mob/living/animal/cockroach/ex_act() //Explosions are a terrible way to handle a cockroach.
	return
