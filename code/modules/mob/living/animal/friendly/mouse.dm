...
/mob/living/animal/mouse/proc/splat()
	src.health = 0
	src.icon_dead = "mouse_[body_color]_splat"
	death()

/mob/living/animal/mouse/death(gibbed, toast)
	if(!ckey)
		..(1)
...
/mob/living/animal/mouse/Crossed(AM as mob|obj)
	if( ishuman(AM) )
		if(!stat)
			var/mob/M = AM
...
/mob/living/animal/mouse/handle_automated_action()
...
/mob/living/animal/mouse/white
	body_color = "white"
	icon_state = "mouse_white"

/mob/living/animal/mouse/gray
	body_color = "gray"
	icon_state = "mouse_gray"

/mob/living/animal/mouse/brown
	body_color = "brown"
	icon_state = "mouse_brown"

//TOM IS ALIVE! SQUEEEEEEEE~K :)
/mob/living/animal/mouse/brown/Tom
	name = "Tom"
