...
/mob/living/animal/hostile/guardian/beam
...
/mob/living/animal/hostile/guardian/beam/AttackingTarget()
	. = ..()
...
/mob/living/animal/hostile/guardian/beam/Destroy()
	removechains()
	return ..()

/mob/living/animal/hostile/guardian/beam/Manifest()
	. = ..()
	if(.)
		if(summoner)
...
/mob/living/animal/hostile/guardian/beam/Recall()
	. = ..()
	if(.)
		removechains()

/mob/living/animal/hostile/guardian/beam/proc/cleardeletedchains()
...
/mob/living/animal/hostile/guardian/beam/proc/shockallchains()
	. = 0
	cleardeletedchains()
	if(summoner)
		if(!summonerchain)
...
/mob/living/animal/hostile/guardian/beam/proc/removechains()
	if(summonerchain)
		qdel(summonerchain)
		summonerchain = null
	if(enemychains.len)
...
/mob/living/animal/hostile/guardian/beam/proc/chainshock(datum/beam/B)
	. = 0
	var/list/turfs = list()
