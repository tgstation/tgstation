//Bomb
/mob/living/animal/hostile/guardian/bomb
...
/mob/living/animal/hostile/guardian/bomb/Stat()
	..()
	if(statpanel("Status"))
		if(bomb_cooldown >= world.time)
			stat(null, "Bomb Cooldown Remaining: [DisplayTimeText(bomb_cooldown - world.time)]")

/mob/living/animal/hostile/guardian/bomb/AttackingTarget()
	. = ..()
...
/mob/living/animal/hostile/guardian/bomb/AltClickOn(atom/movable/A)
	if(!istype(A))
		return
	if(src.loc == summoner)
