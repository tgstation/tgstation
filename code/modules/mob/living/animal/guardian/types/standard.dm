//Standard
/mob/living/animal/hostile/guardian/punch
...
/mob/living/animal/hostile/guardian/punch/verb/Battlecry()
...
/mob/living/animal/hostile/guardian/punch/AttackingTarget()
	. = ..()
	if(isliving(target))
