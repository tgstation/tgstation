//Charger
/mob/living/animal/hostile/guardian/charger
...
/mob/living/animal/hostile/guardian/charger/Life()
	. = ..()
...
/mob/living/animal/hostile/guardian/charger/OpenFire(atom/A)
	if(!charging)
...
/mob/living/animal/hostile/guardian/charger/Shoot(atom/targeted_atom)
	charging = 1
	throw_at(targeted_atom, range, 1, src, 0, callback = CALLBACK(src, .proc/charging_end))

/mob/living/animal/hostile/guardian/charger/proc/charging_end()
	charging = 0

/mob/living/animal/hostile/guardian/charger/Move()
	if(charging)
		new /obj/effect/temp_visual/decoy/fading(loc,src)
	. = ..()

/mob/living/animal/hostile/guardian/charger/snapback()
	if(!charging)
		..()

/mob/living/animal/hostile/guardian/charger/throw_impact(atom/A)
	if(!charging)
		return ..()
