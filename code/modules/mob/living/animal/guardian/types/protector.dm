//Protector
/mob/living/animal/hostile/guardian/protector
...
/mob/living/animal/hostile/guardian/protector/ex_act(severity)
	if(severity == 1)
...
/mob/living/animal/hostile/guardian/protector/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	. = ..()
	if(. > 0 && toggle)
...
/mob/living/animal/hostile/guardian/protector/ToggleMode()
...
/mob/living/animal/hostile/guardian/protector/snapback() //snap to what? snap to the guardian!
	if(summoner)
