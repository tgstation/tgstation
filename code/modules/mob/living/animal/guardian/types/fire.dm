//Fire
/mob/living/animal/hostile/guardian/fire
...
/mob/living/animal/hostile/guardian/fire/Life()
	. = ..()
	if(summoner)
		summoner.ExtinguishMob()
		summoner.adjust_fire_stacks(-20)

/mob/living/animal/hostile/guardian/fire/AttackingTarget()
	. = ..()
	if(. && ishuman(target) && target != summoner)
		new /datum/hallucination/delusion(target,TRUE,"custom",200,0, icon_state,icon)

/mob/living/animal/hostile/guardian/fire/Crossed(AM as mob|obj)
	..()
	collision_ignite(AM)

/mob/living/animal/hostile/guardian/fire/CollidedWith(atom/movable/AM)
	..()
	collision_ignite(AM)

/mob/living/animal/hostile/guardian/fire/Collide(AM as mob|obj)
	..()
	collision_ignite(AM)

/mob/living/animal/hostile/guardian/fire/proc/collision_ignite(AM as mob|obj)
	if(isliving(AM))
		var/mob/living/M = AM
