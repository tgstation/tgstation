//Dextrous
/mob/living/animal/hostile/guardian/dextrous
...
/mob/living/animal/hostile/guardian/dextrous/death(gibbed)
	..()
	if(internal_storage)
		dropItemToGround(internal_storage)

/mob/living/animal/hostile/guardian/dextrous/examine(mob/user)
	if(dextrous)
...
/mob/living/animal/hostile/guardian/dextrous/Recall(forced)
	if(!summoner || loc == summoner || (cooldown > world.time && !forced))
		return FALSE
	drop_all_held_items()
	return ..() //lose items, then return

/mob/living/animal/hostile/guardian/dextrous/snapback()
...
/mob/living/animal/hostile/guardian/dextrous/doUnEquip(obj/item/I, force)
	if(..())
		update_inv_hands()
...
/mob/living/animal/hostile/guardian/dextrous/can_equip(obj/item/I, slot)
	switch(slot)
...
/mob/living/animal/hostile/guardian/dextrous/equip_to_slot(obj/item/I, slot)
	if(!..())
		return
...
/mob/living/animal/hostile/guardian/dextrous/getBackSlot()
	return slot_generic_dextrous_storage

/mob/living/animal/hostile/guardian/dextrous/getBeltSlot()
	return slot_generic_dextrous_storage

/mob/living/animal/hostile/guardian/dextrous/proc/update_inv_internal_storage()
	if(internal_storage && client && hud_used && hud_used.hud_shown)
		internal_storage.screen_loc = ui_id
		client.screen += internal_storage

/mob/living/animal/hostile/guardian/dextrous/regenerate_icons()
	..()
	update_inv_internal_storage()