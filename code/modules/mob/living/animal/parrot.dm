...
/mob/living/animal/parrot/Initialize()
	. = ..()
	if(!ears)
	...
	verbs.Add(/mob/living/animal/parrot/proc/steal_from_ground, \
			  /mob/living/animal/parrot/proc/steal_from_mob, \
			  /mob/living/animal/parrot/verb/drop_held_item_player, \
			  /mob/living/animal/parrot/proc/perch_player, \
			  /mob/living/animal/parrot/proc/toggle_mode,
			  /mob/living/animal/parrot/proc/perch_mob_player)


/mob/living/animal/parrot/examine(mob/user)
	..()
	if(stat)
		to_chat(user, pick("This parrot is no more.", "This is a late parrot.", "This is an ex-parrot."))

/mob/living/animal/parrot/death(gibbed)
	if(held_item)
...
/mob/living/animal/parrot/Stat()
	..()
	if(statpanel("Status"))
		stat("Held Item", held_item)
		stat("Mode",a_intent)

/mob/living/animal/parrot/Hear(message, atom/movable/speaker, message_langs, raw_message, radio_freq, list/spans, message_mode)
...
/mob/living/animal/parrot/radio(message, message_mode, list/spans, language) //literally copied from human/radio(), but there's no other way to do this. at least it's better than it used to be.
	. = ..()
	if(. != 0)
		return .
 ...
 * Inventory
 */
/mob/living/animal/parrot/show_inv(mob/user)
...
/mob/living/animal/parrot/Topic(href, href_list)
...
/mob/living/animal/parrot/attack_hand(mob/living/carbon/M)
	..()
	if(client)
		return
...
/mob/living/animal/parrot/attack_paw(mob/living/carbon/monkey/M)
	attack_hand(M)

/mob/living/animal/parrot/attack_alien(mob/living/carbon/alien/M)
	attack_hand(M)

//Simple animals
/mob/living/animal/parrot/attack_animal(mob/living/animal/M)
...
//Mobs with objects
/mob/living/animal/parrot/attackby(obj/item/O, mob/living/user, params)
...
//Bullets
/mob/living/animal/parrot/bullet_act(obj/item/projectile/Proj)
	..()
	if(!stat && !client)
		if(parrot_state == PARROT_PERCH)
			parrot_sleep_dur = parrot_sleep_max //Reset it's sleep timer if it was perched
...
/mob/living/animal/parrot/handle_automated_speech()
	..()
...
/mob/living/animal/parrot/handle_automated_movement()
...
/mob/living/animal/parrot/movement_delay()
...
/mob/living/animal/parrot/proc/isStuck()
...
/mob/living/animal/parrot/proc/search_for_item()
	var/item
...
/mob/living/animal/parrot/proc/search_for_perch()
...
/mob/living/animal/parrot/proc/search_for_perch_and_item()
	for(var/atom/movable/AM in view(src))
 ...
 */
/mob/living/animal/parrot/proc/steal_from_ground()
...
/mob/living/animal/parrot/proc/drop_held_item(drop_gently = 1)
	set name = "Drop held item"
	set category = "Parrot"
	set desc = "Drop the item you're holding."
...
/mob/living/animal/parrot/proc/perch_on_human(mob/living/carbon/human/H)
	if(!H)
		return
	loc = get_turf(H)
...
/mob/living/animal/parrot/Poly/Initialize()
...
/mob/living/animal/parrot/Poly/Life()
	if(!stat && SSticker.current_state == GAME_STATE_FINISHED && !memory_saved)
		Write_Memory(FALSE)
		memory_saved = TRUE
	..()

/mob/living/animal/parrot/Poly/death(gibbed)
	if(!memory_saved)
		Write_Memory(TRUE)
	if(rounds_survived == longest_survival || rounds_survived == longest_deathstreak || prob(0.666))
		var/mob/living/animal/parrot/Poly/ghost/G = new(loc)
		if(mind)
			mind.transfer_to(G)
		else
			G.key = key
...
/mob/living/animal/parrot/Poly/proc/Read_Memory()
...
/mob/living/animal/parrot/Poly/proc/Write_Memory(dead)
	var/json_file = file("data/npc_saves/Poly.json")
...
/mob/living/animal/parrot/Poly/ratvar_act()
	playsound(src, 'sound/magic/clockwork/fellowship_armory.ogg', 75, TRUE)
	var/mob/living/animal/parrot/clock_hawk/H = new(loc)
	H.setDir(dir)
	dust()

/mob/living/animal/parrot/Poly/ghost
...
/mob/living/animal/parrot/Poly/ghost/Initialize()
	memory_saved = TRUE //At this point nothing is saved
	. = ..()

/mob/living/animal/parrot/Poly/ghost/handle_automated_speech()
	if(ismob(loc))
		return
	..()

/mob/living/animal/parrot/Poly/ghost/handle_automated_movement()
	if(isliving(parrot_interest))
...
/mob/living/animal/parrot/Poly/ghost/proc/Possess(mob/living/carbon/human/H)
	if(!ishuman(H))
		return
...
/mob/living/animal/parrot/clock_hawk
	name = "clock hawk"
...
/mob/living/animal/parrot/clock_hawk/ratvar_act()
	return
