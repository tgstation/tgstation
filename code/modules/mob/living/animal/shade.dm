...
/mob/living/animal/shade/death()
	deathmessage = "lets out a contented sigh as [p_their()] form unwinds."
	..()

/mob/living/animal/shade/canSuicide()
	if(istype(loc, /obj/item/device/soulstone)) //do not suicide inside the soulstone
		return 0
	return ..()

/mob/living/animal/shade/Process_Spacemove(movement_dir = 0)
	return TRUE //this doesn't make much sense; you'd thing TRUE would mean it'd process spacemove but it means it doesn't

/mob/living/animal/shade/attack_animal(mob/living/animal/M)
	if(isconstruct(M))
		var/mob/living/animal/hostile/construct/C = M
...
/mob/living/animal/shade/attackby(obj/item/O, mob/user, params)  //Marker -Agouri
