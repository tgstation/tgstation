...
/mob/living/bullet_act(obj/projectile/P, def_zone)
	...
	if(!P.nodamage && on_hit_state != BULLET_ACT_BLOCK)
		apply_damage(P.damage, P.damage_type, def_zone, armor, wound_bonus=P.wound_bonus, bare_wound_bonus=P.bare_wound_bonus, atk_type = P.atk_type)
...
/mob/living/hitby(atom/movable/AM, skipcatch, hitpush = TRUE, blocked = FALSE, datum/thrownthing/throwingdatum)
	if(istype(AM, /obj/item))
		...
		if(!blocked)
			...
			apply_damage(I.throwforce, dtype, zone, armor, atk_type=I.atk_type)
			if(I.thrownby)
