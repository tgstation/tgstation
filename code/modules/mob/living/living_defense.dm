...
/mob/living/proc/create_splatter(splatter_dir)
	...
	new /obj/effect/temp_visual/dir_setting/bloodsplatter(get_turf(src), splatter_dir, splatter_color)new /obj/effect/temp_visual/dir_setting/bloodsplatter(get_turf(src), splatter_dir)
