...
/mob/living/attack_animal(mob/living/simple_animal/M)
	...
	if(M.melee_damage_upper == 0)
		visible_message("<span class='notice'>\The [M] [M.friendly] [src]!</span>", \
						"<span class='notice'>\The [M] [M.friendly] you!</span>", null, COMBAT_MESSAGE_RANGE, M)
		to_chat(M, "<span class='notice'>You [M.friendly2] [src]!</span>")
		return FALSE
	...
	visible_message("<span class='danger'>\The [M] [M.attacktext] [src]!</span>", \
					"<span class='userdanger'>\The [M] [M.attacktext] you!</span>", null, COMBAT_MESSAGE_RANGE, M)
	to_chat(M, "<span class='danger'>You [M.attacktext2] [src]!</span>")
	log_combat(M, src, "attacked")
	return TRUE
