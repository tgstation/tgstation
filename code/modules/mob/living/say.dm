...
/mob/living/say(var/message, var/bubble_type)
	...
	// Special message handling
		...
		if (message_mode)
			...
			if (!(ishuman(src) || (ismonkey(src) && message_mode=="changeling") || istype(src, /mob/living/simple_animal/parrot) || isrobot(src) && (message_mode=="department" || (message_mode in radiochannels))))
