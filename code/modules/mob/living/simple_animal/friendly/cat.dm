...
/mob/living/simple_animal/pet/cat/cak/CheckParts(list/parts)
	...
	to_chat(src, span_boldannounce("You are a cak!"))
	to_chat(src, span_notice("You're a harmless cat/cake hybrid that everyone loves. People can take bites out of you if they're hungry, but you regenerate health \
	...
	if(new_name)
		to_chat(src, span_boldnotice("Your name is now [new_name]!"))
		name = new_name
