...
/mob/living/simple_animal/pet/cat/cak/CheckParts(list/parts)
	...
	so quickly that it generally doesn't matter. You're remarkably resilient to any damage besides this and it's hard for you to really die at all. You should go around and bring mood and \
