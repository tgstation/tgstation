/mob/living/simple_animal/hostile/lizard
	...
	environment_smash = 0
	var/list/edibles = list(/mob/living/simple_animal/butterfly,/mob/living/simple_animal/cockroach,/mob/living/simple_animal/hostile/poison/bees) //list of atoms, however turfs won't affect AI, but will affect consumption.
