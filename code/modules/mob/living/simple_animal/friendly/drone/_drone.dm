...
/mob/living/simple_animal/drone/examine(mob/user)
	...
	if(head && !(head.flags&ABSTRACT))
		if(head.blood_DNA)
			msg += "<span class='warning'>It is wearing [bIcon(head, user)] [head.gender==PLURAL?"some":"a"] blood-stained [head.name] on its head!</span>\n"
		else
			msg += "It is wearing [bIcon(head, user)] \a [head] on its head.\n"
