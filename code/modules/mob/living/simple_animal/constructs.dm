/mob/living/simple_animal/hostile/construct
	...
	var/playstyle_string = "<span class='big_bold'>You are a generic construct!</span><b> Your job is to not exist, and you should probably adminhelp this.</b>"
	var/master = null
	var/seeking = FALSE
...
/mob/living/simple_animal/hostile/construct/armored
	...
	playstyle_string = "<span class='big_bold'>You are a Juggernaut.</span><b> Though slow, your shell can withstand extreme punishment, \
...
/mob/living/simple_animal/hostile/construct/wraith
	...
	playstyle_string = "<span class='big_bold'>You are a Wraith.</span><b> Though relatively fragile, you are fast, deadly, can phase through walls, and your attacks will lower the cooldown on phasing.</b>"
...
/mob/living/simple_animal/hostile/construct/builder
	...
	playstyle_string = "<span class='big_bold'>You are an Artificer.</span><b> You are incredibly weak and fragile, but you are able to construct fortifications, \
...
/mob/living/simple_animal/hostile/construct/harvester
	...
	playstyle_string = "<span class='big_bold'>You are a Harvester.</span><b> You are incapable of directly killing humans, but your attacks will remove their limbs: \
