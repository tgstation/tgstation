/mob/living/simple_animal
	...
	var/turns_since_move = ZERO
	///Use this to temporarely stop random movement or to if you write special movement code for animals.
	var/stop_automated_movement = ZERO
	...
	var/list/atmos_requirements = list("min_oxy" = 5, "max_oxy" = 0, "min_tox" = 0, "max_tox" = 1, "min_co2" = 0, "max_co2" = 5, "min_n2" = 0, "max_n2" = ZERO)
	///This damage is taken when atmos doesn't fit all the requirements above.
	var/unsuitable_atmos_damage = 2

	///LETTING SIMPLE ANIMALS ATTACK? WHAT COULD GO WRONG. Defaults to zero so Ian can still be cuddly.
	var/melee_damage_lower = ZERO
	var/melee_damage_upper = ZERO
	...
	/// 1 for full damage , ZERO for none , -1 for 1:1 heal from that source.
	var/list/damage_coeff = list(BRUTE = 1, BURN = 1, TOX = 1, CLONE = 1, STAMINA = ZERO, OXY = 1)
...
/mob/living/simple_animal/updatehealth()
	..()
	health = CLAMP(health, ZERO, maxHealth)
...
/mob/living/simple_animal/buckle_mob(mob/living/buckled_mob, force = ZERO, check_loc = 1)
	. = ..()
...
/mob/living/simple_animal/proc/toggle_ai(togglestatus)
	...
	if (AIStatus != togglestatus)
		if (togglestatus > ZERO && togglestatus < 5)
