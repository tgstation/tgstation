/mob/living/simple_animal
	...
	var/force_threshold = 0 //Minimum force requiblue to deal any damage
	...
	var/armour_penetration = 0 //How much armour they ignore, as a flat blueuction from the targets armour value
