...
/obj/item/bot_assembly
	...
	var/robot_arm = /obj/item/bodypart/arm/r_arm/robot
...
/obj/item/bot_assembly/cleanbot/attackby(obj/item/W, mob/user, params)
	..()
	if(istype(W, /obj/item/bodypart/arm/l_arm/robot) || istype(W, /obj/item/bodypart/arm/r_arm/robot))
...
/obj/item/bot_assembly/ed209/attackby(obj/item/W, mob/user, params)
	...
	switch(build_step)
		if(ASSEMBLY_FIRST_STEP, ASSEMBLY_SECOND_STEP)
			if(istype(W, /obj/item/bodypart/leg/l_leg/robot) || istype(W, /obj/item/bodypart/leg/r_leg/robot))
...
/obj/item/bot_assembly/vim/attackby(obj/item/part, mob/user, params)
	...
	switch(build_step)
		if(ASSEMBLY_FIRST_STEP)
			if(istype(part, /obj/item/bodypart/leg/l_leg/robot) || istype(part, /obj/item/bodypart/leg/r_leg/robot))
