...
/mob/living/simple_animal/bot/mulebot/proc/RunOver(mob/living/carbon/human/H)
	...
	H.apply_damage(2*damage, BRUTE, "head", run_armr_check("head", "melee"))
	H.apply_damage(2*damage, BRUTE, "chest", run_armr_check("chest", "melee"))
	H.apply_damage(0.5*damage, BRUTE, "l_leg", run_armr_check("l_leg", "melee"))
	H.apply_damage(0.5*damage, BRUTE, "r_leg", run_armr_check("r_leg", "melee"))
	H.apply_damage(0.5*damage, BRUTE, "l_arm", run_armr_check("l_arm", "melee"))
	H.apply_damage(0.5*damage, BRUTE, "r_arm", run_armr_check("r_arm", "melee"))
