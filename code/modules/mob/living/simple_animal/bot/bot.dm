...
/mob/living/simple_animal/bot/proc/call_bot(caller, turf/waypoint, message=TRUE)
	...
	set_path(get_path_to(src, waypoint, 0, 200, id=all_access))
...
/mob/living/simple_animal/bot/proc/calc_path(turf/avoid)
	check_bot_access()
	set_path(get_path_to(src, patrol_target, 0, 120, id=access_card, exclude=avoid))
...
/mob/living/simple_animal/bot/proc/do_calc_summon_path(turf/avoid)
	set_path(get_path_to(src, summon_target, 0, 150, id=access_card, exclude=avoid))
