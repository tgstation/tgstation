...
/mob/living/simple_animal/bot/proc/turn_on()
	...
	REMOVE_TRAIT(src, TRAIT_IMMOBILIZED, SOURCE_POWER_LACK)
	REMOVE_TRAIT(src, TRAIT_HANDS_BLOCKED, SOURCE_POWER_LACK)
...
/mob/living/simple_animal/bot/proc/turn_off()
	...
	ADD_TRAIT(src, TRAIT_IMMOBILIZED, SOURCE_POWER_LACK)
	ADD_TRAIT(src, TRAIT_HANDS_BLOCKED, SOURCE_POWER_LACK)
	set_light_on(bot_mode_flags & BOT_MODE_ON ? TRUE : FALSE)
