...
/mob/living/simple_animal/hostile/alien_larva/attack_hand(mob/living/carbon/human/user, list/modifiers)
	. = ..()
	if(!.)
		return
	var/damage = rand(1, 9)
...
/mob/living/simple_animal/hostile/alien_larva/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
