...
/mob/living/simple_animal/hostile/asteroid/fugu/proc/Deflate()
	if(wumbo)
		...
		inflate_cooldown = 4
		environment_smash = ENVIRONMENT_SMASH_NONE
		RemoveElement(/datum/element/wall_smasher) // TODO replace with a proc, make the element assign traits to simple mobs
		mob_size = MOB_SIZE_SMALL
		speed = 0
...
/obj/item/fugu_gland/afterattack(atom/target, mob/user, proximity_flag)
	...
	animal.AddElement(/datum/element/wall_smasher)
