...
/mob/living/simple_animal/hostile/space_dragon
	...
	deathmessage = "screeches as its wings turn to dust and it collapses on the floor, its life exstinguished."
...
/mob/living/simple_animal/hostile/space_dragon/proc/victory()
	...
	sleep(100)
	priority_announce("A large amount of lifeforms have been detected approaching [station_name()] at extreme speeds.  Evacuation of the remaining crew will begin immediately.", "Central Command Spacial Corps")
	for(var/obj/structure/carp_rift/rift in rift_list)
