...
/mob/living/simple_animal/hostile/carp/paprika
	name = "Paprike"
	real_name = "Paprika"
	desc = "It's Paprika! The Spider Clan's lovable Space Carp!"
	gender = FEMALE
	speak_emote = list("squeaks")
	ai_controller = null
	gold_core_spawnable = NO_SPAWN
...
/mob/living/simple_animal/hostile/carp/paprika/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/pet_bonus, "bloops happily!")
