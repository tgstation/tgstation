/mob/living/simple_animal/hostile/lizard
	...
	can_be_held = TRUE
	var/static/list/edibles = STATIC_INIT(typecacheof(list(/mob/living/simple_animal/butterfly, /mob/living/basic/cockroach))) //list of atoms, however turfs won't affect AI, but will affect consumption.
