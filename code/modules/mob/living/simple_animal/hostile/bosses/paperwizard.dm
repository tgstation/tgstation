...
/obj/effect/temp_visual/paperwiz_dying/Initialize()
	...
	playsound(get_turf(src),'sound/magic/mandswap.ogg', 50, 1, DEFAULT_SOUND_VARY)
	playsound(get_turf(src),'sound/hallucinations/wail.ogg', 50, 1, DEFAULT_SOUND_VARY)

/obj/effect/temp_visual/paperwiz_dying/Destroy()
	shake_area(src, 7, 1, 1, 1, 1, 7)
	var/turf/T = get_turf(src)
	playsound(T,'sound/magic/summon_magic.ogg', 50, 1, DEFAULT_SOUND_VARY)
