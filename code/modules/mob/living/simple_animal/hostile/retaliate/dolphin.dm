/mob/living/simple_animal/hostile/retaliate/dolphin
	...
	speak_chance = 0
	turns_per_move = 5
	butcher_results = list(/obj/item/weapon/reagent_containers/food/snacks/dolphinmeat = 3, /obj/item/organ/brain = 2, /obj/item/weapon/dolphinfin = 1) //dolphins are intelligent beings
	response_help = "pets"
