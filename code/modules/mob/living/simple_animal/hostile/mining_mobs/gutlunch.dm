...
/mob/living/simple_animal/hostile/asteroid/gutlunch/guthen/Life(delta_time = SSmobs.wait / (1 SECONDS), times_fired)
	..()
...
/mob/living/simple_animal/hostile/asteroid/gutlunch/grublunch/Life(delta_time = SSmobs.wait / (1 SECONDS), times_fired)
	..()
	growth++
