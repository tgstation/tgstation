...
/obj/structure/elite_tumor/proc/spawn_elite(mob/dead/observer/elitemind)
	...
	if(boosted)
		...
		notify_ghosts("\A [mychild] has been awakened in \the [get_area(src)]!", source = mychild, action = NOTIFY_ORBIT, notify_flags = NOTIFY_CATEGORY_NOFLASH, header = "Lavaland Elite awakened")
...
/obj/structure/elite_tumor/proc/return_elite()
	...
	if(boosted)
		...
		notify_ghosts("\A [mychild] has been challenged in \the [get_area(src)]!", source = mychild, action = NOTIFY_ORBIT, notify_flags = NOTIFY_CATEGORY_NOFLASH, header = "Lavaland Elite challenged")
