...
//These vars are related to how mobs locate and target
	...
	var/stat_exclusive = TRUE //Mobs with this set to TRUE will exclusively attack things defined by stat_attack, stat_attack DEAD means they will only attack corpses
