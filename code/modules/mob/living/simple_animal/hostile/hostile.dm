...
//These vars are related to how mobs locate and target
	...
	var/list/wanted_objects = list() //A list of objects that will be checked against to attack, should we have search_objects enabled, is turned into a typecache in New()
