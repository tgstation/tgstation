...
/mob/living/simple_animal/hostile/proc/ListTargets()//Step 1, find out what we can see
	if(!search_objects)
		...
		var/static/hostile_machines = typecacheof(list(/obj/machinery/porta_turret, /obj/mecha, /obj/pod, /obj/structure/destructible/clockwork/ocular_warden,/obj/item/device/electronic_assembly))
