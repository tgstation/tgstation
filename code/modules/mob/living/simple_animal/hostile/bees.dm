...
/mob/living/simple_animal/hostile/poison/bees
	name = "bee"
	desc = "Hey buddy, I think you got the wrong hive, the wasp club's two trays down.<br>Fuck you.<br>Ah, fuck you wasp-man! Maybe you and I should settle it right here on the hive floor."
	icon_state = ""
	icon_living = ""
