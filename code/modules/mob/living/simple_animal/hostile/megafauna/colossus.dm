...
/mob/living/simple_animal/hostile/megafauna/colossus/OpenFire()
	...
	if(prob(20+anger_modifier)) //Major attack
		...
		if(health < maxHealth/3)
			...
			INVOKE((src, .proc/spiral_shoot, rand(0, 1)))
		...
		if(prob(70))
			...
			INVOKE((src, .proc/alternating_dir_shots))
...
/obj/effect/overlay/temp/at_shield/New(new_loc, new_target)
	..()
	target = new_target
	INVOKE((src, /atom/movable/proc/orbit, target, 0, FALSE, 0, 0, FALSE, TRUE))
...
/mob/living/simple_animal/hostile/megafauna/colossus/proc/double_spiral()
	...
	sleep(10)
	INVOKE((src, .proc/spiral_shoot))
	INVOKE_AGAIN((src, .proc/spiral_shoot, 1))
