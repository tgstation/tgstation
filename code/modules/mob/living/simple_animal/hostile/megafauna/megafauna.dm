...
/proc/UnlockMedal(medal,client/player)
	...
	if(SENSITIVE.medal_hub && SENSITIVE.medal_pass && SENSITIVE.medals_enabled)
		spawn()
			var/result = world.SetMedal(medal, player, SENSITIVE.medal_hub, SENSITIVE.medal_pass)
			if(isnull(result))
				SENSITIVE.medals_enabled = FALSE
...
/proc/SetScore(score,client/player,increment,force)
	...
	if(SENSITIVE.medal_hub && SENSITIVE.medal_pass && SENSITIVE.medals_enabled)
		spawn()
			...
			var/result = world.SetScores(player.ckey, newscoreparam, SENSITIVE.medal_hub, SENSITIVE.medal_pass)
...
/proc/GetScore(score,client/player,returnlist)
	...
	if(SENSITIVE.medal_hub && SENSITIVE.medal_pass && SENSITIVE.medals_enabled)
		...
		var/scoreget = world.GetScores(player.ckey, score, SENSITIVE.medal_hub, SENSITIVE.medal_pass)
		if(isnull(scoreget))
			SENSITIVE.medals_enabled = FALSE
...
/proc/CheckMedal(medal,client/player)
	...
	if(SENSITIVE.medal_hub && SENSITIVE.medal_pass && SENSITIVE.medals_enabled)
		...
		var/result = world.GetMedal(medal, player, SENSITIVE.medal_hub, SENSITIVE.medal_pass)
...
/proc/LockMedal(medal,client/player)
	...
	if(SENSITIVE.medal_hub && SENSITIVE.medal_pass && SENSITIVE.medals_enabled)
		...
		var/result = world.ClearMedal(medal, player, SENSITIVE.medal_hub, SENSITIVE.medal_pass)
...
/proc/ClearScore(client/player)
	world.SetScores(player.ckey, "", SENSITIVE.medal_hub, SENSITIVE.medal_pass)
