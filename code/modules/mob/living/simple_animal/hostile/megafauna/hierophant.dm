...
/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	loot = list(/obj/item/hierophant_club, /obj/structure/closet/crate/necropolis/hierophant)
	crusher_loot = list(/obj/item/hierophant_club, /obj/item/crusher_trophy/vortex_talisman, /obj/structure/closet/crate/necropolis/hierophant)
	wander = FALSE
