...
/mob/living/simple_animal/hostile/megafauna/swarmer_swarm_beacon
	...
	achievement_type = /datum/achievement/swarmer_beacon_kill
	crusher_achievement_type = /datum/achievement/swarmer_beacon_crusher
	score_achievement_type = /datum/achievement/swarmer_beacon_score
