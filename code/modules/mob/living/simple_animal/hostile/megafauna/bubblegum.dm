...
/mob/living/simple_animal/hostile/megafauna/bubblegum/bullet_act(obj/item/projectile/P)
	if(is_enraged())
		...
		playsound(src, pick('sound/weapons/bulletflyby.ogg', 'sound/weapons/bulletflyby2.ogg', 'sound/weapons/bulletflyby3.ogg'), 300, DEFAULT_SOUND_VARY)
		return 0
	return ..()
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/Moved()
	...
	if(charging)
		DestroySurroundings()
	playsound(src, 'sound/effects/meteorimpact.ogg', 200, 1, 2, DEFAULT_SOUND_VARY)
	return ..()
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/Bump(atom/A)
	if(charging)
		...
		if(isliving(A))
			...
			playsound(get_turf(L), 'sound/effects/meteorimpact.ogg', 100, DEFAULT_SOUND_VARY)
			shake_camera(L, 4, 3)
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/proc/bloodsmack(turf/T, handedness)
	...
	for(var/mob/living/L in T)
		if(!faction_check_mob(L))
			...
			playsound(T, attack_sound, 100, DEFAULT_SOUND_VARY, extra_range = -1)
	...
	for(var/mob/living/L in T)
		if(!faction_check_mob(L))
			if(L.stat != CONSCIOUS)
				...
				playsound(T, 'sound/magic/enter_blood.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -1)
				var/turf/targetturf = get_step(src, dir)
				L.forceMove(targetturf)
				playsound(targetturf, 'sound/magic/exit_blood.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -1)
