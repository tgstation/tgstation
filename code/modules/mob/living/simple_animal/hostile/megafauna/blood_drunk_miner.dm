...
/mob/living/simple_animal/hostile/megafauna/blood_drunk_miner/proc/dash(atom/dash_target)
	...
	playsound(own_turf, 'sound/weapons/punchmiss.ogg', 40, DEFAULT_SOUND_VARY, extra_range = -1)
	dashing = TRUE
	alpha = 0
	...
	playsound(target_turf, 'sound/weapons/punchmiss.ogg', 40, DEFAULT_SOUND_VARY, extra_range = -1)
	sleep(1)
	dashing = FALSE
	shoot_ka()
	return TRUE
