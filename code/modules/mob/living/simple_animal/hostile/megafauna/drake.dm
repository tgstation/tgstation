...
/mob/living/simple_animal/hostile/megafauna/dragon/Initialize()
	...
	register_signal(src, COMSIG_SWOOP_INVULNERABILITY_STARTED, .proc/swoop_invulnerability_started)
	register_signal(src, COMSIG_LAVA_ARENA_FAILED, .proc/on_arena_fail)
