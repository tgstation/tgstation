...
/mob/living/simple_animal/hostile/asteroid/basilisk
	...
	idle_vision_range = 2
	turns_per_move = 5
	loot = list(/obj/item/stack/diamond{layer = ABOVE_MOB_LAYER},
				/obj/item/stack/diamond{layer = ABOVE_MOB_LAYER})
...
/mob/living/simple_animal/hostile/asteroid/goldgrub/New()
	...
	var/i = rand(1,3)
	while(i)
		loot += pick(/obj/item/stack/silver, /obj/item/stack/gold, /obj/item/stack/uranium, /obj/item/stack/diamond)
		i--

/mob/living/simple_animal/hostile/asteroid/goldgrub/GiveTarget(new_target)
	target = new_target
	if(target != null)
		if(istype(target, /obj/item/stack) && loot.len < 10)
...
/mob/living/simple_animal/hostile/asteroid/goldgrub/proc/EatOre(atom/targeted_ore)
	for(var/obj/item/stack/O in targeted_ore.loc)
		if(loot.len < 10)
			loot += O.type
			qdel(O)
...
/mob/living/simple_animal/hostile/asteroid/basilisk/watcher
	...
	robust_searching = 1
	loot = list()
	butcher_results = list(/obj/item/stack/diamond = 2, /obj/item/stack/sheet/sinew = 2, /obj/item/stack/sheet/bone = 1)
