...
/mob/living/simple_animal/hostile/bear
	...
	turns_per_move = 5
	see_in_dark = 6
	butcher_results = list(/obj/item/weapon/reagent_containers/food/snacks/meat/slab/bear = 5, /obj/item/clothing/head/bearpelt = 1, /obj/item/stack/sheet/animalhide/generic = 2)
	response_help  = "pets"
...
/mob/living/simple_animal/hostile/bear/russian
	...
	faction = list("russian")
	butcher_results = list(/obj/item/weapon/reagent_containers/food/snacks/meat/slab/bear = 5, /obj/item/clothing/head/bearpelt = 1, /obj/item/bear_armor = 1, /obj/item/stack/sheet/animalhide/generic = 2)
