...
/datum/guardian_abilities/punch/handle_stats()
	...
	stando.next_move_modifier = 0.8 //attacks 20% faster
...
/datum/guardian_abilities/bomb/handle_stats()
	...
	stando.damage_coeff -= list(BRUTE = 0.2, BURN = 0.2, TOX = 0.2, CLONE = 0.2, STAMINA = 0, OXY = 0.4)
	stando.range += 6
...
/datum/guardian_abilities/ranged/handle_stats()
	...
	stando.damage_coeff -= list(BRUTE = 0.05, BURN = 0.05, TOX = 0.05, CLONE = 0.05, STAMINA = 0, OXY = 0.05)
...
/datum/guardian_abilities/fire/handle_stats()
	...
	stando.damage_coeff -= list(BRUTE = 0.3, BURN = 0.3, TOX = 0.3, CLONE = 0.3, STAMINA = 0, OXY = 0.3)
	stando.range += 4.5
...
/datum/guardian_abilities/lightning/handle_stats()
	...
	stando.damage_coeff -= list(BRUTE = 0.15, BURN = 0.15, TOX = 0.15, CLONE = 0.15, STAMINA = 0, OXY = 0.15)
	stando.range += 4
...
/datum/guardian_abilities/charge/handle_stats()
	...
	stando.speed -= 1
	stando.damage_coeff -= list(BRUTE = 0.2, BURN = 0.2, TOX = 0.2, CLONE = 0.2, STAMINA = 0, OXY = 0.2)
...
/datum/guardian_abilities/protector/handle_mode()
	...
	if(toggle)
		...
		stando.damage_coeff = initial(stando.damage_coeff)
		stando << "<span class='danger'><B>You switch to combat mode.</span></B>"
		toggle = FALSE
	else
