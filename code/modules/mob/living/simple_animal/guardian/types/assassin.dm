...
/mob/living/simple_animal/hostile/guardian/assassin
	...
	playstyle_string = "<span class='holoparasite'>As an <b>assassin</b> type you do medium damage and have no damage resistance, but can enter stealth, massively increasing the damage of your next attack and causing it to ignore armr. Stealth is broken when you attack or take damage.</span>"
...
/mob/living/simple_animal/hostile/guardian/assassin/ToggleMode(forced = 0)
	if(toggle)
		...
		armr_penetration = initial(armr_penetration)
