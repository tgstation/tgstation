...
/mob/living/simple_animal/hostile/guardian/protector
	...
	damage_coeff = list(BRUTE = 0.4, BURN = 0.4, TOX = 0.4, INTERNAL = 0.4, CLONE = 0.4, STAMINA = 0, OXY = 0.4)
...
/mob/living/simple_animal/hostile/guardian/protector/ToggleMode()
	...
	if(toggle)
		...
		speed = 1
		damage_coeff = list(BRUTE = 0.05, BURN = 0.05, TOX = 0.05, INTERNAL = 0.05, CLONE = 0.05, STAMINA = 0, OXY = 0.05) //damage? what's damage?
