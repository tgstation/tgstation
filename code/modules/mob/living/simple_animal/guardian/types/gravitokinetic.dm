...
/mob/living/simple_animal/hostile/guardian/gravitokinetic/UnarmedAttack(atom/attack_target, proximity_flag)
	if((istate & ISTATE_SECONDARY) && proximity_flag && !gravity_targets[target])
