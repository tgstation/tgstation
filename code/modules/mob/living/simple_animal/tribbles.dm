...
/obj/machinery/furbricator/proc/wires_win(mob/user as mob)
	..()
	var/dat as text
...
/obj/machinery/furbricator/proc/regular_win(mob/user as mob)
	..()
	var/dat as text
...
/obj/machinery/furbricator/proc/shock(mob/user, prb)
	..()
...
/obj/machinery/furbricator/interact(mob/user as mob)
	..()
	if(..())
		return
	if (src.shocked)
...
/obj/machinery/furbricator/attackby(var/obj/item/O as obj, var/mob/user as mob)
	..()
	if (stat)
		return 1
	if (busy)
...
/obj/machinery/furbricator/attack_paw(mob/user as mob)
	..()
	return src.attack_hand(user)

/obj/machinery/furbricator/attack_hand(mob/user as mob)
	..()
	user.set_machine(src)
	interact(user)


/obj/machinery/furbricator/Topic(href, href_list)
	..()
	if(..())
		return
	usr.set_machine(src)
