 ...
 */
/mob/living/simple_animal/parrot/Life(delta_time = SSSIMPLE_MOBS_DT, times_fired)
	..()
...
/mob/living/simple_animal/parrot/poly/Life(delta_time = SSSIMPLE_MOBS_DT, times_fired)
