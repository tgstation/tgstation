 ...
 */
/mob/living/simple_animal/parrot/Life(delta_time = SSmobs.wait / (1 SECONDS), times_fired)
	..()
...
/mob/living/simple_animal/parrot/poly/Life(delta_time = SSmobs.wait / (1 SECONDS), times_fired)
