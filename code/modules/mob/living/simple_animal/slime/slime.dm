...
/mob/living/simple_animal/slime/on_reagent_change()
	...
	var/amount = 0
	if(reagents.has_reagent(/datum/reagent/medicine/opioid/morphine) || reagents.has_reagent(/datum/reagent/medicine/opioid/dimorphine)) // morphine slows slimes down
		amount = 2
