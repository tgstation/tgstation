//Protector
/mob/living/simple_animal/hostile/sutando/protector
	...
	magic_fluff_string = "<span class='holoparasite'>..And draw the sutando, a stalwart protector that never leaves the side of its charge.</span>"
	...
	abilities = list(/datum/sutando_abilities/protector)
