//Healer
/mob/living/simple_animal/hostile/sutando/healer
	...
	abilities = list(/datum/sutando_abilities/heal)
...
/obj/structure/recieving_pad/New(loc, mob/living/simple_animal/hostile/sutando/healer/G)
	. = ..()
	if(G.namedatum)
