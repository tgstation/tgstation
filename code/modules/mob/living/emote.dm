...
/datum/emote/living/gasp/get_sound(mob/living/user)
	...
	if(human_user.physique == FEMALE)
		return pick('sound/mobs/voice/human/gasp_female1.ogg', 'sound/mobs/voice/human/gasp_female2.ogg', 'sound/mobs/voice/human/gasp_female3.ogg')
	return pick('sound/mobs/voice/human/gasp_male1.ogg', 'sound/mobs/voice/human/gasp_male2.ogg')
...
/datum/emote/living/carbon/whistle/get_sound(mob/living/user)
	return 'sound/mobs/voice/human/whistle1.ogg'
