...
//Colonist human. No real difference from an Earth one (yet).
/datum/species/human/colonist
	name = "Colonial Human"
	id = "human_colonist"
	default_color = "FFFFFE"
...
/datum/species/andorian
	name = "Andorian"
	id = "andorian"
	default_color = "0540FF"
	specflags = list(EYECOLOR,HAIR,FACEHAIR,LIPS)
	mutant_bodyparts = list("antennae")
	default_features = list("antennae" = "Short")
	use_skintones = 0
	skinned_type = /obj/item/stack/sheet/animalhide/human
...
/datum/species/klingon
	name = "Klingon"
	id = "klingon"
	default_color = "93664A" //Brown?
	specflags = list(EYECOLOR,HAIR,FACEHAIR,LIPS)
	mutant_bodyparts = list("crests")
	default_features = list("crests" = "Simple")
	use_skintones = 1 //May have to tweak this...
	skinned_type = /obj/item/stack/sheet/animalhide/human
...
/datum/species/romulan
	...
	id = "romulan"
	blacklisted = 1 //Nope
	default_color = "CCFF99" //Greenish?
	specflags = list(EYECOLOR,HAIR,FACEHAIR,LIPS)
	mutant_bodyparts = list("ears")
	default_features = list("ears" = "Vulcan")
	use_skintones = 0//May have to tweak this...
	skinned_type = /obj/item/stack/sheet/animalhide/human

//Bajorans!
/datum/species/bajoran
	name = "Bajoran"
	id = "bajoran"
	default_color = "FFFFFF"
	specflags = list(EYECOLOR,HAIR,FACEHAIR,LIPS)
	mutant_bodyparts = list("crests")
	default_features = list("crests" = "Bajoran") //Actually a nose crest
	skinned_type = /obj/item/stack/sheet/animalhide/human
...
/datum/species/cardassian
	name = "Cardassian"
	id = "cardassian"
	default_color = "A8A8A8" //Kinda grey
	specflags = list(EYECOLOR,HAIR,FACEHAIR,LIPS)
	mutant_bodyparts = list("crests")
	default_features = list("crests" = "Cardassian")
	skinned_type = /obj/item/stack/sheet/animalhide/human
...
/datum/species/gorn
	...
	mutant_bodyparts = list("snout", "spines", "horns", "frills", "body_markings")
	mutant_organs = list(/obj/item/organ/tongue/lizard)
	default_features = list("mcolor" = "0F0", "snout" = "Round", "horns" = "None", "frills" = "None", "spines" = "None", "body_markings" = "None")
	attack_verb = "slash"
...
/datum/species/gorn/random_name(gender,unique,lastname)
	if(unique)
...
/datum/species/orion
	name = "Orion"
	id = "orion"
	default_color = "336633" //Pretty fuckin green (tm)
	specflags = list(EYECOLOR,HAIR,FACEHAIR,LIPS)
	default_features = list("mcolor" = "FFF")
	use_skintones = 1 //Hmm what will this do
	skinned_type = /obj/item/stack/sheet/animalhide/human
