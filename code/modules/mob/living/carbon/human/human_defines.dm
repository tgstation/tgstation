...
/mob/living/carbon/human
	...
	var/static/list/can_ride_typecache = STATIC_INIT(typecacheof(list(/mob/living/carbon/human, /mob/living/simple_animal/slime, /mob/living/simple_animal/parrot)))
	var/lastpuke = 0
	var/account_id
