/mob/living/carbon/human
	...
	var/static/list/can_ride_typecache = typecacheof(list(/mob/living/carbon/human, /mob/living/simple_animal/slime, /mob/living/simple_animal/parrot, /mob/living/simple_animal/hostile/handofgod))
	var/lastpuke = 0
