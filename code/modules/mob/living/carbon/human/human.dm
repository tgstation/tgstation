		...
		if(href_list["hud"] == "s")
			...
			if(ishuman(human_or_ghost_user))
				...
				if(href_list["add_citation"])
					...
					SSblackbox.ReportCitation(REF(new_citation), "Citation Created", human_user.ckey, human_user.real_name, target_record.name, citation_name, null, fine)
				...
				if(href_list["add_crime"])
					...
					SSblackbox.ReportCitation(REF(new_crime), "Crime Created", human_user.ckey, human_user.real_name, target_record.name, crime_name, null)
