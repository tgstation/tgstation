...
//	if(!dna)	//removed. sanity procs should handle this nicely now
//		dna = new /datum/dna()	//make a dna datum but don't bother generating UI/SE/UE as we'll want to redo these after everything else is set
