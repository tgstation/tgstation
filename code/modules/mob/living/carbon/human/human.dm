										...
										if("Minor Crime")
											if(R)
												...
												if(R)
													...
													investigate_log("New Minor Crime: <strong>[t1]</strong>: [t2] | Added to [R.fields["name"]] by [usr.name] ([usr.key])", INVESTIGATE_RECORDS)
										...
										if("Major Crime")
											if(R)
												...
												if(R)
													...
													investigate_log("New Major Crime: <strong>[t1]</strong>: [t2] | Added to [R.fields["name"]] by [usr.name] ([usr.key])", INVESTIGATE_RECORDS)
