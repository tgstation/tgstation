...
/mob/living/carbon/human/proc/canUseHUD()
	return !(src.stat || src.knockdown || src.paralysis || src.restrained())
...
/mob/living/carbon/human/vomit(lost_nutrition = 10, blood = 0, paralyse = 1, distance = 0, message = 1, toxic = 0)
