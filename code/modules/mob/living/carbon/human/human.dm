...
/mob/living/carbon/human/show_inv(mob/user)
	...
	if(has_breathable_mask && istype(back, /obj/item/weapon/tank/large))
	...
	if(wear_suit)
		...
		if(has_breathable_mask && istype(s_store, /obj/item/weapon/tank/large))
	...
	if(w_uniform == null || (slot_w_uniform in obscured) || (dna && dna.species.nojumpsuit))
		...
		if(has_breathable_mask && istype(belt, /obj/item/weapon/tank/large))
