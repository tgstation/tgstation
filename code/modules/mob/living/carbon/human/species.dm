...
/datum/species
	...
	var/blood_deficiency_drain_rate = BLOOD_REGEN_FACTOR + BLOOD_DEFICIENCY_DRAIN_MODIFIER // slightly above the regen rate so it slowly drains instead of regenerates.
