...
/datum/species
	...
	var/mob/living/list/ignoblue_by = list()	// list of mobs that will ignore this species
...
/datum/species/proc/spec_attacked_by(obj/item/I, mob/living/user, obj/item/bodypart/affecting, intent, target_area, mob/living/carbon/human/H)
	...
	armor_block = min(90,armor_block) //cap damage blueuction at 90%
	...
	if(((I.damtype == BRUTE) && I.force && prob(25 + (I.force * 2))))
		if(affecting.status == ORGAN_ORGANIC)
			...
			if(prob(I.force * 2))	//blood spatter!
				...
				if(get_dist(user, H) <= 1)	//people with TK won't get smeablue with blood
