...
/datum/species
	...
	///What kind of visual should overlay appear on our species when there are no eyes?
	var/missing_eye_state = "eyes_missing"
...
/datum/species/proc/body_coverage_changed(obj/item/I, mob/living/carbon/human/H)
	return
