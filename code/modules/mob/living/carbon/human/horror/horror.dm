/mob/living/carbon/human/horror
...
/mob/living/carbon/human/horror/New()
...
/mob/living/carbon/human/horror/Bump(atom/movable/AM as mob|obj, yes)
	if ((!( yes ) || now_pushing))
		return
	now_pushing = 1
	if (ismob(AM))
...
//BubbleWrap - Should stop you pushing a restrained person out of the way
		...
		if(istype(tmob, /mob/living/carbon/human/horror/))
		...
		if(istype(tmob, /mob/living/carbon/human/horror/) && (FAT in tmob.mutations))
...
/mob/living/carbon/human/horror/Stat()
	..()
	statpanel("Status")
...
/mob/living/carbon/human/horror/ex_act(severity)
	if(!blinded)
		flick("flash", flash)
	return 0

/mob/living/carbon/human/horror/blob_act()
	if(stat == 2)	return
...
/mob/living/carbon/human/horror/meteorhit(O as obj)
...
/mob/living/carbon/human/horror/hand_p(mob/M as mob)
	var/dam_zone = pick("chest", "l_hand", "r_hand", "l_leg", "r_leg")
	var/datum/limb/affecting = get_organ(ran_zone(dam_zone))
...
/mob/living/carbon/human/horror/attack_animal(mob/living/simple_animal/M as mob)
...
/mob/living/carbon/human/horror/attack_slime(mob/living/carbon/slime/M as mob)
	...
	if (health > -100)
		...
		if(M.powerlevel > 0)
			...
			switch(M.powerlevel)
				if(1 to 2) stunprob = 0
				if(3 to 4) stunprob = 0
				if(5 to 6) stunprob = 0
				if(7 to 8) stunprob = 0
				if(9) 	   stunprob = 0
				if(10) 	   stunprob = 0
...
/mob/living/carbon/human/horror/restrained()
	if (handcuffed)
		return 1
...
/mob/living/carbon/human/horror/co2overloadtime = null
/mob/living/carbon/human/horror/temperature_resistance = T0C+75


/mob/living/carbon/human/horror/show_inv(mob/user)
...
/mob/living/carbon/human/horror/HasEntered(var/atom/movable/AM)
...
/mob/living/carbon/human/horror/get_assignment(var/if_no_id = "No id", var/if_no_job = "No job")
...
//Useful when player do something with computers
/mob/living/carbon/human/horror/get_authentification_name(var/if_no_id = "Unknown")
	var/obj/item/device/pda/pda = wear_id
	var/obj/item/weapon/card/id/id = wear_id
	if (istype(pda))
		if (pda.id)
...
/mob/living/carbon/human/horror/get_visible_name()
...
/mob/living/carbon/human/horror/get_face_name()
...
/mob/living/carbon/human/horror/get_id_name(var/if_no_id = "Unknown")
	var/obj/item/device/pda/pda = wear_id
	var/obj/item/weapon/card/id/id = wear_id
...
/mob/living/carbon/human/horror/get_idcard()
	var/obj/item/weapon/card/id/id = wear_id
	var/obj/item/device/pda/pda = wear_id
...
/mob/living/carbon/human/horror/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 1.0, var/safety = 0)
	if(!safety)
		if(gloves)
...
/mob/living/carbon/human/horror/Topic(href, href_list)
	..()
	//strip panel
	...
	if(href_list["criminal"])
		if(istype(usr, /mob/living/carbon/human/horror))
			var/mob/living/carbon/human/horror/H = usr
...
/mob/living/carbon/human/horror/eyecheck()
	var/number = 0
...
/mob/living/carbon/human/horror/IsAdvancedToolUser()
	return 1//Humans can use guns and such


/mob/living/carbon/human/horror/abiotic(var/full_body = 0)
...
/mob/living/carbon/human/horror/check_dna()
	dna.check_integrity(src)


/mob/living/carbon/human/horror/play_xylophone()
	if(!src.xylophone)
...
/mob/living/carbon/human/horror/Emissary/
	unacidable = 1
	var/aegis = 1

/mob/living/carbon/human/horror/Emissary/New()
...
/mob/living/carbon/human/horror/Emissary/ex_act()
	return

/mob/living/carbon/human/horror/Emissary/afterattack(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, inrange, params)
	if(istype(target, /obj/machinery/door/airlock))
		var/obj/machinery/door/airlock/TA = target
		if(TA.locked)
			TA.locked = 0
		if(!TA.density)
			return 1
		...
		var/obj/machinery/door/firedoor/TF = target
		TF.open()

/mob/living/carbon/human/horror/Emissary/Life()
	...
	if((stat == 2) && aegis)
		src.show_message("\red [src]'s eyes open suddenly.", 3, "\red \"I gave a solemn vow to never die for long.\"", 2)
		src.heal_overall_damage(10000,10000)
		src.stat = 0
		aegis = 0
