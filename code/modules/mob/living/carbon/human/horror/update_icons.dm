...
/mob/living/carbon/human/horror/update_icons()
...
/mob/living/carbon/human/horror/UpdateDamageIcon(var/update_icons=1)
...
//BASE MOB SPRITE
/mob/living/carbon/human/horror/update_body(var/update_icons=1)
	...
	if(husk)
		...
		stand_icon = new /icon('icons/mob/mob.dmi', "horror_s")
		lying_icon = new /icon('icons/mob/mob.dmi', "horror_l")
	else if(skeleton)
...
//HAIR OVERLAY
/mob/living/carbon/human/horror/update_hair(var/update_icons=1)
	//Reset our hair
...
/mob/living/carbon/human/horror/update_mutations(var/update_icons=1)
...
/mob/living/carbon/human/horror/update_mutantrace(var/update_icons=1)
...
/* --------------------------------------- */
//For legacy support.
/mob/living/carbon/human/horror/regenerate_icons()
	..()
...
/mob/living/carbon/human/horror/update_inv_w_uniform(var/update_icons=1)
...
/mob/living/carbon/human/horror/update_inv_wear_id(var/update_icons=1)
	if(wear_id)
...
/mob/living/carbon/human/horror/update_inv_gloves(var/update_icons=1)
	if(gloves)
		if(client && hud_used && hud_used.hud_shown && hud_used.inventory_shown)
...
/mob/living/carbon/human/horror/update_inv_glasses(var/update_icons=1)
	if(glasses)
		if(client && hud_used && hud_used.hud_shown && hud_used.inventory_shown)
...
/mob/living/carbon/human/horror/update_inv_ears(var/update_icons=1)
	if(ears)
		if(client && hud_used && hud_used.hud_shown && hud_used.inventory_shown)
...
/mob/living/carbon/human/horror/update_inv_shoes(var/update_icons=1)
	if(shoes)
		if(client && hud_used && hud_used.hud_shown && hud_used.inventory_shown)
...
/mob/living/carbon/human/horror/update_inv_s_store(var/update_icons=1)
	if(s_store)
		if(client && hud_used && hud_used.hud_shown)
...
/mob/living/carbon/human/horror/update_inv_head(var/update_icons=1)
	if(head)
		if(client && hud_used && hud_used.hud_shown && hud_used.inventory_shown)
...
/mob/living/carbon/human/horror/update_inv_belt(var/update_icons=1)
	if(belt)
		if(client && hud_used && hud_used.hud_shown)
...
/mob/living/carbon/human/horror/update_inv_wear_suit(var/update_icons=1)
...
/mob/living/carbon/human/horror/update_inv_pockets(var/update_icons=1)
	if(l_store)
		if(client && hud_used && hud_used.hud_shown)
...
/mob/living/carbon/human/horror/update_inv_wear_mask(var/update_icons=1)
...
/mob/living/carbon/human/horror/update_inv_back(var/update_icons=1)
	if(back)
		if(client && hud_used && hud_used.hud_shown)
...
/mob/living/carbon/human/horror/update_hud()	//TODO: do away with this if possible
	if(client)
...
/mob/living/carbon/human/horror/update_inv_handcuffed(var/update_icons=1)
	if(handcuffed)
		drop_r_hand()
		drop_l_hand()
...
/mob/living/carbon/human/horror/update_inv_legcuffed(var/update_icons=1)
	if(legcuffed)
...
/mob/living/carbon/human/horror/update_inv_r_hand(var/update_icons=1)
	if(r_hand)
		if(client)
...
/mob/living/carbon/human/horror/update_inv_l_hand(var/update_icons=1)
	if(l_hand)
		if(client)
