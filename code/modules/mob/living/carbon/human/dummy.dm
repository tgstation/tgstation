...
/proc/create_consistent_human_dna(mob/living/carbon/human/target)
	...
	target.dna.features["bodymarks_lizard"] = get_consistent_feature_entry(GLOB.body_markings_list) /// SKYRAPTOR EDIT
	...
	target.dna.features["snout_lizard"] = get_consistent_feature_entry(GLOB.snouts_list) /// SKYRAPTOR EDIT
