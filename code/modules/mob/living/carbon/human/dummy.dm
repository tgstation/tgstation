...
/proc/create_consistent_human_dna(mob/living/carbon/human/target)
	...
	target.dna.features["body_markings"] = get_consistent_feature_entry(DSaccessories.body_markings_list)
	target.dna.features["ears"] = get_consistent_feature_entry(DSaccessories.ears_list)
	target.dna.features["frills"] = get_consistent_feature_entry(DSaccessories.frills_list)
	target.dna.features["horns"] = get_consistent_feature_entry(DSaccessories.horns_list)
	target.dna.features["moth_antennae"] = get_consistent_feature_entry(DSaccessories.moth_antennae_list)
	target.dna.features["moth_markings"] = get_consistent_feature_entry(DSaccessories.moth_markings_list)
	target.dna.features["moth_wings"] = get_consistent_feature_entry(DSaccessories.moth_wings_list)
	target.dna.features["snout"] = get_consistent_feature_entry(DSaccessories.snouts_list)
	target.dna.features["spines"] = get_consistent_feature_entry(DSaccessories.spines_list)
	target.dna.features["tail_cat"] = get_consistent_feature_entry(DSaccessories.tails_list_human) // it's a lie
	target.dna.features["tail_lizard"] = get_consistent_feature_entry(DSaccessories.tails_list_lizard)
	target.dna.features["tail_monkey"] = get_consistent_feature_entry(DSaccessories.tails_list_monkey)
	target.dna.features["pod_hair"] = get_consistent_feature_entry(DSaccessories.pod_hair_list)
