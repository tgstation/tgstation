...
/datum/species/jelly/prepare_human_for_preview(mob/living/carbon/human/human)
	human.dna.features[/datum/dna_block/feature/mutant_color] = COLOR_PINK
...
/datum/action/innate/split_body/proc/make_dupe()
	...
	spare.dna.features[/datum/dna_block/feature/mutant_color] = "#[pick("7F", "FF")][pick("7F", "FF")][pick("7F", "FF")]"
...
/datum/action/innate/swap_body/ui_data(mob/user)
	...
	for(var/b in SS.bodies)
		...
		var/list/L = list()
		L["htmlcolor"] = body.dna.features[/datum/dna_block/feature/mutant_color]
...
/datum/species/jelly/luminescent/proc/update_glow(mob/living/carbon/human/glowie, intensity)
	...
	glow.set_light_range_power_color(glow_intensity, glow_intensity, glowie.dna.features[/datum/dna_block/feature/mutant_color])
