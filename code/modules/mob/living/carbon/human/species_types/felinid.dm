...
/datum/species/human/felinid/get_scream_sound(mob/living/carbon/human/felinid)
	return pick(
		'sound/mobs/humanoids/felinid/felinid_scream1.ogg',
		'sound/mobs/humanoids/felinid/felinid_scream2.ogg',
		'sound/mobs/humanoids/felinid/felinid_scream3.ogg',
		'sound/mobs/humanoids/felinid/felinid_scream4.ogg',
	)
