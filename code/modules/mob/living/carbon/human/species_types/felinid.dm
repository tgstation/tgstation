...
/datum/species/human/felinid/on_species_gain(mob/living/carbon/carbon_being, datum/species/old_species, pref_load, regenerate_icons)
	if(ishuman(carbon_being))
		...
		if(!pref_load) //Hah! They got forcefully purrbation'd. Force default felinid parts on them if they have no mutant parts in those areas!
			target_human.dna.features[/datum/dna_block/feature/tail] = "Cat"
			if(target_human.dna.features[/datum/dna_block/feature/ears] == "None")
				target_human.dna.features[/datum/dna_block/feature/ears] = "Cat"
		if(target_human.dna.features[/datum/dna_block/feature/ears] == "None")
			mutantears = /obj/item/organ/ears
		else
			var/obj/item/organ/ears/cat/ears = new(FALSE, target_human.dna.features[/datum/dna_block/feature/ears])
...
/datum/species/human/felinid/randomize_features(mob/living/carbon/human/human_mob)
	var/list/features = ..()
	features[/datum/dna_block/feature/ears] = pick("None", "Cat")
	return features
