...
/datum/species/human/felinid/get_species_lore()
	return "Bio-engineering at its felinest, Felinids are the peak example of humanity's mastery of genetic code. \
		One of many \"Animalid\" variants, Felinids are the most popular and common, as well as one of the \
		biggest points of contention in genetic-modification. Body modders were eager to splice human and feline DNA \
		in search of the holy trifecta: ears, eyes, and tail. These traits were in high demand, with the corresponding \
		side effects of vocal and neurochemical changes being seen as a minor inconvenience. Sadly for the Felinids, \
		they were not minor inconveniences. Shunned as subhuman and monstrous by many, Felinids (and other Animalids) \
