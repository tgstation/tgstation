...
//	knife_butcher_results = list(/obj/item/food/meat/slab/monkey = 5, /obj/item/stack/sheet/animalhide/monkey = 1)
	...
	no_equip = list(ITEM_SLOT_OCLOTHING|ITEM_SLOT_ICLOTHING|ITEM_SLOT_GLOVES|ITEM_SLOT_EYES|ITEM_SLOT_EARS|ITEM_SLOT_MASK|ITEM_SLOT_HEAD|ITEM_SLOT_FEET|ITEM_SLOT_ID|ITEM_SLOT_BELT|ITEM_SLOT_BACK|ITEM_SLOT_NECK|ITEM_SLOT_BACKPACK|ITEM_SLOT_SUITSTORE|ITEM_SLOT_LPOCKET|ITEM_SLOT_RPOCKET)
...
/datum/species/alien/spec_unarmedattack(mob/living/carbon/human/user, mob/living/target, modifiers)
	. = ..()
	if(!ishuman(target))
		return
	var/mob/living/carbon/human/human_target = target
	if(human_target.check_shields(user, 0, "the [user.name]"))
