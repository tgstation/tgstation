...
/datum/species/vampire
	...
	exotic_bloodtype = "U"
	blood_deficiency_drain_rate = BLOOD_DEFICIENCY_DRAIN_MODIFIER // vampires already passively lose blood, so this just makes them lose it slightly more quickly when they have blood deficiency.
	use_skintones = TRUE
