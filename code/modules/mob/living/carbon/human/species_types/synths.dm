/datum/species/synth
	...
	sexes = 0
	species_traits = list(NOTRANSSTING,NOMUTATIONS) //all of these + whatever we inherit from the real species
	...
	limbs_id = "synth"
	var/list/initial_species_traits = list(NOTRANSSTING,NOMUTATIONS) //for getting these values back for assume_disguise()
