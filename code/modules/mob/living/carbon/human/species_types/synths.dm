/datum/species/synth
	...
	limbs_id = "synth"
	var/disguise_fail_health = 75 //When their health gets to this level their synthflesh partially falls off // austation comment change -- revert cobbychem
...
/datum/species/synth/handle_chemicals(datum/reagent/chem, mob/living/carbon/human/H)
	if(chem.type == /datum/reagent/medicine/synthflesh) // austation -- revert cobbychem
