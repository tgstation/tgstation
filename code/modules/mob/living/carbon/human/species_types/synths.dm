/datum/species/synth
	...
	inherent_traits = list(TRAIT_VIRUSIMMUNE,TRAIT_INTERNALIMMUNE,TRAIT_NODISMEMBER,TRAIT_NOHUNGER,TRAIT_NOBREATH)
	inherent_biotypes = list(MOB_ROBOTIC, MOB_HUMANOID)
	meat = null
	damage_overlay_type = "synth"
	limbs_id = "synth"
	var/list/initial_species_traits = list(NOTRANSSTING) //for getting these values back for assume_disguise()
	var/list/initial_inherent_traits = list(TRAIT_VIRUSIMMUNE,TRAIT_INTERNALIMMUNE,TRAIT_NODISMEMBER,TRAIT_NOLIMBDISABLE,TRAIT_NOHUNGER,TRAIT_NOBREATH)
