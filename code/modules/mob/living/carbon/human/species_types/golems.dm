...
/datum/species/golem/bananium
	...
	fixed_mut_color = "ff0"
	say_mod = "honks"
	inherent_traits = list(TRAIT_RESISTHEAT, TRAIT_NOBREATH, TRAIT_RESISTCOLD, TRAIT_RESISTHIGHPRESSURE, TRAIT_RESISTLOWPRESSURE, TRAIT_NOFIRE, TRAIT_CHUNKYFINGERS, TRAIT_CLUMSY, TRAIT_RADIMMUNE, TRAIT_GENELESS, TRAIT_PIERCEIMMUNE, TRAIT_NODISMEMBER)
	punchdamagelow = 0
	punchdamagehigh = 1
