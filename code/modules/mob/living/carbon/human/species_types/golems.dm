/datum/species/golem
	...
	punchdamagelow = 5
	punchdamagehigh = 14
	punchstuntreshold = 11 //about 40% chance to stun
...
/datum/species/golem/silver
	...
	id = "silver golem"
	fixed_mut_color = "ddd"
	punchstuntreshold = 9 //60% chance, from 40%
...
/datum/species/golem/plasteel
	...
	punchdamagelow = 12
	punchdamagehigh = 21
	punchstuntreshold = 18 //still 40% stun chance
...
/datum/species/golem/bananium
	...
	punchdamagelow = 0
	punchdamagehigh = 1
	punchstuntreshold = 2 //Harmless and can't stun
