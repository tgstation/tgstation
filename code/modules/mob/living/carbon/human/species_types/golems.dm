...
/datum/species/golem/titanium/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	. = ..()
	ADD_TRAIT(src, TRAIT_ASHSTORM_IMMUNE, SPECIES_TRAIT)

/datum/species/golem/titanium/on_species_loss(mob/living/carbon/C)
	. = ..()
	REMOVE_TRAIT(src, TRAIT_ASHSTORM_IMMUNE, SPECIES_TRAIT)
...
/datum/species/golem/plastitanium/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	. = ..()
	ADD_TRAIT(src, TRAIT_LAVA_IMMUNE, SPECIES_TRAIT)
	ADD_TRAIT(src, TRAIT_ASHSTORM_IMMUNE, SPECIES_TRAIT)

/datum/species/golem/plastitanium/on_species_loss(mob/living/carbon/C)
	. = ..()
	REMOVE_TRAIT(src, TRAIT_LAVA_IMMUNE, SPECIES_TRAIT)
	REMOVE_TRAIT(src, TRAIT_ASHSTORM_IMMUNE, SPECIES_TRAIT)
...
/datum/species/golem/snow/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	. = ..()
	ADD_TRAIT(src, TRAIT_SNOWSTORM_IMMUNE, SPECIES_TRAIT)
	ball = new
...
/datum/species/golem/snow/on_species_loss(mob/living/carbon/C)
	. = ..()
	REMOVE_TRAIT(src, TRAIT_SNOWSTORM_IMMUNE, SPECIES_TRAIT)
	if(ball)
		C.RemoveSpell(ball)
	if(cryo)
		C.RemoveSpell(cryo)
