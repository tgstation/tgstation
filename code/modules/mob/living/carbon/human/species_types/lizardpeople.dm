...
/datum/species/lizard/randomize_features()
	var/list/features = ..()
	features[/datum/dna_block/feature/lizard_marking] = pick(SSaccessories.lizard_markings_list)
	return features
...
/datum/species/lizard/silverscale/on_species_gain(mob/living/carbon/human/new_silverscale, datum/species/old_species, pref_load, regenerate_icons)
	old_mutcolor = new_silverscale.dna.features[/datum/dna_block/feature/mutant_color]
	new_silverscale.dna.features[/datum/dna_block/feature/mutant_color] = "#eeeeee"
...
/datum/species/lizard/silverscale/on_species_loss(mob/living/carbon/human/was_silverscale, datum/species/new_species, pref_load)
	was_silverscale.dna.features[/datum/dna_block/feature/mutant_color] = old_mutcolor
