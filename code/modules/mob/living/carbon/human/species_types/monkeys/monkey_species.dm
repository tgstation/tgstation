...
/datum/species/monkey/on_species_gain(mob/living/carbon/human/new_monkey, datum/species/old_species)
	. = ..()
	new_monkey.pass_flags |= PASSTABLE
...
/datum/species/monkey/on_species_loss(mob/living/carbon/old_monkey)
	. = ..()
	UnregisterSignal(old_monkey, COMSIG_LIVING_GIBBED)
	old_monkey.pass_flags = initial(old_monkey.pass_flags)
	old_monkey.butcher_results = null
	old_monkey.dna.remove_mutation(/datum/mutation/human/race)
