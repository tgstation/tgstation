...
/datum/species/ethereal/get_scream_sound(mob/living/carbon/human/ethereal)
	return pick(
		'sound/mobs/voice/ethereal/ethereal_scream_1.ogg',
		'sound/mobs/voice/ethereal/ethereal_scream_2.ogg',
		'sound/mobs/voice/ethereal/ethereal_scream_3.ogg',
	)
...
/datum/species/ethereal/lustrous/get_scream_sound(mob/living/carbon/human/ethereal)
	return pick(
		'sound/mobs/voice/ethereal/lustrous_scream_1.ogg',
		'sound/mobs/voice/ethereal/lustrous_scream_2.ogg',
		'sound/mobs/voice/ethereal/lustrous_scream_3.ogg',
	)
