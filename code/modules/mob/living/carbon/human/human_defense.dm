...
/mob/living/carbon/human/check_self_for_injuries()
	...
	if(HAS_TRAIT(src, TRAIT_SELF_AWARE))
		...
		if(oxyloss)
			if(oxyloss > 10)
				combined_msg += span_danger("You feel lightheaded. The oxygen is low in this room!")
			else if(oxyloss > 20)
				combined_msg += span_danger("Your thinking is clouded and distant. The oxygen is dangerously low in this room!")
			else if(oxyloss > 30)
