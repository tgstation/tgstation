...
/mob/living/carbon/human/proc/check_block()
	if(mind)
		if(mind.martial_art && prob(mind.martial_art.block_chance) && mind.martial_art.can_use(src) && in_throw_mode && !IS_PRONE(src) && LIVING_CAN_MOVE(src) && LIVING_CAN_USE_HANDS(src))
			return TRUE
	return FALSE
