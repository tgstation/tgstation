...
/mob/living/carbon/human/attack_paw(mob/living/carbon/human/M, modifiers)
	...
	if(LAZYACCESS(modifiers, "right")) //Always drop item in hand, if no item, get stunned instead.
...
/mob/living/carbon/human/attack_alien(mob/living/carbon/alien/humanoid/M, modifiers)
	...
	if(LAZYACCESS(modifiers, "right")) //Always drop item in hand, if no item, get stun instead.
		var/obj/item/I = get_active_held_item()
