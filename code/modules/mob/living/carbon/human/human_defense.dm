...
/mob/living/carbon/human/bullet_act(var/obj/item/weapon/projectile/P, var/def_zone)
	if(wear_suit && istype(wear_suit, /obj/item/clothing/suit/armor/laserproof))
		if(istype(P, /obj/item/weapon/projectile/energy) || istype(P, /obj/item/weapon/projectile/beam))
