...
/mob/living/carbon/human/bullet_act(obj/item/projectile/P, def_zone)
	...
	if(mind)
		if(mind.martial_art && mind.martial_art.can_use(src) && mind.martial_art.deflection_chance) //Some martial arts users can deflect projectiles!
...
/mob/living/carbon/human/proc/check_block()
	if(mind)
		if(mind.martial_art && prob(mind.martial_art.block_chance) && mind.martial_art.can_use(src) && in_throw_mode && !stat && !IsKnockdown() && !IsStun())
			return TRUE
	return FALSE
