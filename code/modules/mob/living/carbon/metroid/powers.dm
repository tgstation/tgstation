...
/mob/living/carbon/slime/proc/Feedon(var/mob/living/carbon/M)
	...
	//if(M.client) M << "<span class='danger'>You legs become paralyzed!</span>"
	if(is_adult)
	...
	while(Victim && M.health > -70 && stat != 2)
		...
		if(Adjacent(M))
			...
			if(prob(15) && M.client && istype(M, /mob/living/carbon))
				M << "<span class='danger'>[pick("You can feel your body becoming weak!</span>", \
			...
			if(istype(M, /mob/living/carbon))
				...
				if(prob(25))
					src << "<span class='danger'><i>[pick("This subject is incompatable</span>", \
