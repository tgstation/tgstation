...
/mob/living/carbon/get_ear_protection()
	...
	var/list/component_protection = list(0) // Need to wrap this in a list so we can pass a reference
	SEND_SIGNAL(src, COMSIG_CARBON_SOUND_PROTECTION_CHECKED, component_protection)
