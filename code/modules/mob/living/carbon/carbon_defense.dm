...
/mob/living/carbon/proc/help_shake_act(mob/living/carbon/M)
	...
	if(body_position == LYING_DOWN)
		...
		M.visible_message(span_notice("[M] shake [src]'s hand with a firm grip!"), \
					null, span_hear("You hear someone shaking hands."), DEFAULT_MESSAGE_RANGE, list(M, src))
		to_chat(M, span_notice("You shake [src]'s hand firmly!"))
		to_chat(src, span_notice("[M] grasps your hand and shakes it firmly!"))
