...
/mob/living/carbon/attacked_by(obj/item/I, mob/living/user)
	...
	if(I.force)
		apply_damage(I.force, I.damtype, affecting, wound_bonus = I.wound_bonus, bare_wound_bonus = I.bare_wound_bonus, sharpness = I.get_sharpness(), tool_behaviour = I.tool_behaviour)
