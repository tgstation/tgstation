...
/mob/living/carbon/take_overall_damage(brute = 0, burn = 0, stamina = 0, updating_health = TRUE, only_robotic = FALSE, only_organic = FALSE)
	...
	while(parts.len && (brute > 0 || burn > 0 || stamina > 0))
		...
		update |= picked.receive_damage(brute_per_part, burn_per_part, stamina_per_part, FALSE, only_robotic, only_organic)
