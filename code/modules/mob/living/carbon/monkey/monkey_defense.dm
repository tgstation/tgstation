		...
		if("harm")
			...
			if (prob(75))
				visible_message("<span class='danger'>[M] punches [name]!</span>", \
								"<span class='userdanger'>[M] punches you!</span>", null, COMBAT_MESSAGE_RANGE, M)
				...
				if(prob(40))
					...
					if(AmountUnconscious() < 100 && health > 0)
						...
						visible_message("<span class='danger'>[M] knocks [name] out!</span>", \
										"<span class='userdanger'>[M] knocks you out!</span>", null, 5, M)
			...
			if(!IsUnconscious())
				...
				if (prob(25))
					...
					visible_message("<span class='danger'>[M] pushes [src] down!</span>", \
									"<span class='userdanger'>[M] pushes you down!</span>", null, null, M)
					...
					visible_message("<span class='danger'>[M] disarms [src]!</span>", \
									"<span class='userdanger'>[M] disarms you!</span>", null, COMBAT_MESSAGE_RANGE, M)
			...
			if ((prob(95) && health > 0))
				...
				if (damage >= 25)
					...
					visible_message("<span class='danger'>[M] wounds [name]!</span>", \
									"<span class='userdanger'>[M] wounds you!</span>", null, COMBAT_MESSAGE_RANGE, M)
					to_chat(M, "<span class='danger'>You wound [name]!</span>")
				else
					visible_message("<span class='danger'>[M] slashes [name]!</span>", \
									"<span class='userdanger'>[M] slashes you!</span>", null, COMBAT_MESSAGE_RANGE, M)
		...
		if (M.a_intent == INTENT_DISARM)
			...
			if(prob(95))
				...
				visible_message("<span class='danger'>[M] tackles [name] down!</span>", \
								"<span class='userdanger'>[M] tackles you down!</span>", null, COMBAT_MESSAGE_RANGE, M)
