/mob/living/carbon/monkey
	...
	//can_be_held = TRUE //uncomment when someone wants to make sure monkeys cant steal shit while being held
	//cam_head = TRUE
	//held_state = "monkey"
	////please yell at imsxz and delete this commented bit if leaving commented code is bad i forgot if it is or not
