...
/mob/living/carbon/show_inv(mob/user)
	...
	if(istype(wear_mask, /obj/item/clothing/mask) && istype(back, /obj/item/weapon/tank/large))
...
/mob/living/carbon/Topic(href, href_list)
	...
	if(usr.canUseTopic(src, BE_CLOSE, NO_DEXTERY))
		if(href_list["internal"])
			...
			if(ITEM && istype(ITEM, /obj/item/weapon/tank/large) && wear_mask && (wear_mask.flags & MASKINTERNALS))
				...
				if(do_mob(usr, src, POCKET_STRIP_DELAY))
					...
					else if(ITEM && istype(ITEM, /obj/item/weapon/tank/large) && wear_mask && (wear_mask.flags & MASKINTERNALS))
						internal = ITEM
						if(internals)
