...
/obj/effect/proc_holder/alien/larva_evolve/fire(var/mob/living/carbon/alien/user)
	...
	if(L.amount_grown >= L.max_grown)	//TODO ~Carn
		...
		switch(alien_caste)
			if("Hunter")
				new_xeno = new /mob/living/carbon/alien/humanoid/hunter(L.loc, L.organsystem)
			if("Sentinel")
				new_xeno = new /mob/living/carbon/alien/humanoid/sentinel(L.loc, L.organsystem)
			if("Drone")
				new_xeno = new /mob/living/carbon/alien/humanoid/drone(L.loc, L.organsystem)
