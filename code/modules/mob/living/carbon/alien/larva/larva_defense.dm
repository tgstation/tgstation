...
/mob/living/carbon/human/species/alien/larva/attack_hand(mob/living/carbon/human/user, list/modifiers)
	if(..())
		var/damage = rand(1, 9)
		if (prob(90))
...
/mob/living/carbon/human/species/alien/larva/attack_hulk(mob/living/carbon/human/user)
	. = ..()
	if(!.)
		return
...
/mob/living/carbon/human/species/alien/larva/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
