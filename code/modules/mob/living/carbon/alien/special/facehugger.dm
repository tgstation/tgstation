...
/obj/item/clothing/mask/facehugger/proc/Impregnate(mob/living/target)
	...
	if(!sterile)
		...
		if((!LC || IS_ORGANIC_LIMB(LC)) && !target.getorgan(/obj/item/organ/internal/body_egg/alien_embryo))
			...
			if(target.stat != DEAD && (target.buckled && istype(target.buckled, /obj/structure/bed/nest))) //Handles toggling the nest sustenance status effect if the user was already buckled to a nest.
