...
/mob/living/carbon/human/species/alien/humanoid/attack_hand(mob/living/carbon/human/user, list/modifiers)
	if(!..() || !user.combat_mode)
		return
...
/mob/living/carbon/human/species/alien/humanoid/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
