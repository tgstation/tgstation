...
/mob/living/carbon/human/species/alien/humanoid/hunter/create_internal_organs()
	internal_organs += new /obj/item/organ/alien/plasmavessel/small
	..()

//Hunter verbs

/mob/living/carbon/human/species/alien/humanoid/hunter/proc/toggle_leap(message = 1)
...
/mob/living/carbon/human/species/alien/humanoid/hunter/ClickOn(atom/A, params)
	face_atom(A)
	if(leap_on_click)
		leap_at(A)
	else
...
/mob/living/carbon/human/species/alien/humanoid/hunter/proc/leap_at(atom/A)
	if(body_position == LYING_DOWN || HAS_TRAIT(src, TRAIT_IMMOBILIZED) || HAS_TRAIT_FROM(src, TRAIT_MOVE_FLOATING, LEAPING_TRAIT))
		return
...
/mob/living/carbon/human/species/alien/humanoid/hunter/proc/leap_end()
	body_position_pixel_x_offset = 0
	body_position_pixel_y_offset = 0
	REMOVE_TRAIT(src, TRAIT_MOVE_FLOATING, LEAPING_TRAIT)
	update_icons()

/mob/living/carbon/human/species/alien/humanoid/hunter/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
