...
/obj/item/organ/internal/stomach/alien/relaymove(mob/living/user, direction)
	...
	if(!prob((damage_ratio * 100) - 50) && damage_ratio != 1)
		playsound(play_from, 'sound/mobs/creatures/alien_organ_cut.ogg', 100, 1)
	...
	playsound(get_turf(play_from), 'sound/mobs/creatures/alien_explode.ogg', 100, extrarange = 4)
