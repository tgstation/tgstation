...
/obj/item/organ/alien/hivenode/Insert(mob/living/carbon/target, special = FALSE)
	. = ..()
	ADD_TRAIT(target, TRAIT_FACTION_ALIEN, ORGAN_TRAIT)
	ADD_TRAIT(target, TRAIT_XENO_IMMUNE, ORGAN_TRAIT)

/obj/item/organ/alien/hivenode/Remove(mob/living/carbon/target, special = FALSE)
	REMOVE_TRAIT(target, TRAIT_FACTION_ALIEN, ORGAN_TRAIT)
	REMOVE_TRAIT(target, TRAIT_XENO_IMMUNE, ORGAN_TRAIT)
	return ..()
