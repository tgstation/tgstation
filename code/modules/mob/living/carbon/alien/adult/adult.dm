...
/mob/living/carbon/alien/adult/cuff_resist(obj/item/I)
	playsound(src, 'sound/mobs/voice/hiss5.ogg', 40, TRUE, TRUE)  //Alien roars when starting to break free
...
/mob/living/carbon/alien/adult/check_breath(datum/gas_mixture/breath)
	if(breath?.total_moles() > 0 && !HAS_TRAIT(src, TRAIT_SNEAK))
		playsound(get_turf(src), pick('sound/mobs/voice/lowHiss2.ogg', 'sound/mobs/voice/lowHiss3.ogg', 'sound/mobs/voice/lowHiss4.ogg'), 50, FALSE, -5)
	return ..()
...
/mob/living/carbon/alien/adult/proc/devour_lad(atom/movable/candidate, devour_time = 13.5 SECONDS)
	...
	playsound(lucky_winner, 'sound/mobs/creatures/alien_eat.ogg', 100)
