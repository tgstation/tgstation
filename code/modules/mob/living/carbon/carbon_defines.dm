/mob/living/carbon
	...
	var/dreaming = ZERO //How many dream images we have left to send
...
//inventory slots
	...
	var/failed_last_breath = ZERO //This is used to determine if the mob failed a breath. If they did fail a brath, they will attempt to breathe each tick, otherwise just once per 4 ticks.
	...
	var/tinttotal = ZERO	// Total level of visualy impairing items
	...
	var/next_hallucination = ZERO
	var/cpr_time = 1 //CPR cooldown.
	var/damageoverlaytemp = ZERO

	var/drunkenness = ZERO //Overall drunkenness - check handle_alcohol() in life.dm for effects
	var/stam_regen_start_time = ZERO //used to halt stamina regen temporarily
