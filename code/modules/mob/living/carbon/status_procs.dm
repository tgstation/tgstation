...
/mob/living/carbon/adjust_disgust(amount)
	disgust = CLAMP(disgust+amount, ZERO, DISGUST_LEVEL_MAXEDOUT)

/mob/living/carbon/set_disgust(amount)
	disgust = CLAMP(amount, ZERO, DISGUST_LEVEL_MAXEDOUT)
