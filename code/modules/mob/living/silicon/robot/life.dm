	...
	if(cell)
		...
		switch(cellcharge)
			if(0.75 to INFINITY)
				clear_alert("charge")
			if(0.5 to 0.75)
				throw_alert("charge", /obj/screen/alert_icon/lowcell, 1)
			if(0.25 to 0.5)
				throw_alert("charge", /obj/screen/alert_icon/lowcell, 2)
			if(0.01 to 0.25)
				throw_alert("charge", /obj/screen/alert_icon/lowcell, 3)
			else
				throw_alert("charge", /obj/screen/alert_icon/emptycell)
	else
		throw_alert("charge", /obj/screen/alert_icon/nocell)
