...
/obj/item/robot_model/peacekeeper/do_transform_animation()
	..()
	to_chat(loc, span_binaryannounce("Under ASIMOV, you are an enforcer of the PEACE and preventer of HUMAN HARM. \
...
/obj/item/robot_model/security/do_transform_animation()
	..()
	to_chat(loc, span_binaryannounce("While you have picked the security model, you still have to follow your laws, NOT Space Law. \
