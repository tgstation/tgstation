...
/mob/living/silicon/robot/canPerformAction(atom/movable/target, action_bitflags)
	if(lockcharge || low_power_mode)
		to_chat(src, span_warning("You can't do that right now!"))
		return FALSE
	return can_see(target) && ..() //stop cyborgs from leaving windows open and using then after they lose vision
