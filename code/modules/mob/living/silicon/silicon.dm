...
/mob/living/silicon/Initialize(mapload)
	...
	diag_hud_set_health()
	add_sensors()
	ADD_TRAIT(src, TRAIT_ADVANCEDTOOLUSER, SOURCE_ROUNDSTART)
	ADD_TRAIT(src, TRAIT_LITERATE, SOURCE_ROUNDSTART)
	ADD_TRAIT(src, TRAIT_NOFIRE_SPREAD, SOURCE_ROUNDSTART)

	ADD_TRAIT(src, TRAIT_ASHSTORM_IMMUNE, SOURCE_ROUNDSTART)
	ADD_TRAIT(src, TRAIT_MADNESS_IMMUNE, SOURCE_ROUNDSTART)
	ADD_TRAIT(src, TRAIT_MARTIAL_ARTS_IMMUNE, SOURCE_ROUNDSTART)
