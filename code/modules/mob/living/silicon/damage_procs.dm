...
/mob/living/silicon/apply_damage(damage = ZERO,damagetype = BRUTE, def_zone = null, blocked = FALSE, forced = FALSE)
...
/mob/living/silicon/apply_effect(effect = ZERO,effecttype = EFFECT_STUN, blocked = FALSE)
