...
/mob/living/silicon/ai/verb/pick_icon()
	...
	var/icontype = input("Please, select a display!", "AI", null/*, null*/) in list("Clown", "Monochrome", "Blue", "Inverted", "Firewall", "Green", "Red", "Static", "Red October", "Robert House", "Heartline")
	if(icontype == "Clown")
