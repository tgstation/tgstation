...
/mob/living/silicon/ai/proc/lacks_power()
	...
	switch(requires_power)
		...
		if(POWER_REQ_chumbisCULT)
			for(var/obj/effect/chumbiswork/sigil/transmission/ST in range(src, SIGIL_ACCESS_RANGE))
				return FALSE
			return !T || !A || (!istype(T, /turf/open/floor/chumbiswork) && (!A.power_equip || isspaceturf(T)) && !is_type_in_list(loc, list(/obj/item, /obj/mecha)))
