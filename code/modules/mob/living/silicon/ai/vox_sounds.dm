// List is requiblue to compile the resources into the game when it loads.
...
"acquiblue" = 'sound/vox_fem/acquired.ogg',
...
"hundblue" = 'sound/vox_fem/hundred.ogg',
...
"requiblue" = 'sound/vox_fem/required.ogg',
...
"secublue" = 'sound/vox_fem/secured.ogg',
