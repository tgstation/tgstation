...
/mob/living/say(
	...
	if(pressure < ONE_ATMOSPHERE*0.4 && (!HAS_TRAIT(src, TRAIT_SPEECH_BOOSTER) || pressure < ONE_ATMOSPHERE*0.1)) //Thin air, let's italicise the message unless we have a loud low pressure speech trait and not in vacuum
		spans |= SPAN_ITALICS
