...
/mob/living/proc/bloodpool_sink(obj/effect/decal/cleanable/B)
	...
	playsound(get_turf(src), 'sound/magic/enter_blood.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
...
/mob/living/proc/bloodcrawl_consume(mob/living/victim)
	...
	for(var/i in 1 to 3)
		playsound(get_turf(src),sound, 50, DEFAULT_SOUND_VARY)
		sleep(30)
...
/mob/living/proc/exit_blood_effect(obj/effect/decal/cleanable/B)
	playsound(get_turf(src), 'sound/magic/exit_blood.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -1)
