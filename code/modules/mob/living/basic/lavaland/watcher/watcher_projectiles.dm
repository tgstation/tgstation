...
/obj/projectile/temp/watcher/magmawing
	name = "scorching blast"
	icon_state = "lava"
	damage = 5
	temperature = 200

/obj/projectile/temp/watcher/magmawing/apply_status(mob/living/target)
	target.adjust_fire_stacks(0.1)
	target.ignite_mob()

/// Freezing projectile, freezes you
/obj/projectile/temp/watcher/icewing
	name = "freezing blast"
	damage = 5

/obj/projectile/temp/watcher/icewing/apply_status(mob/living/target)
