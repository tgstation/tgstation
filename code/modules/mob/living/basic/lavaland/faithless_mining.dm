/mob/living/basic/mining/faithless_mining
	name = "The Faithless"
	...
	ai_controller = /datum/ai_controller/basic_controller/faithless_mining
	...
	var/static/list/death_loot = list(/obj/item/stack/sheet/animalhide/goliath_hide = 1)
...
/mob/living/basic/mining/faithless_mining/melee_attack(atom/target, list/modifiers, ignore_cooldown)
	. = ..()
	if (!. || !isliving(target))
		return
...
/datum/ai_controller/basic_controller/faithless_mining
	blackboard = list(
