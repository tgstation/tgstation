...
/datum/bt_node/ai_behavior/targeted_mob_ability/cardinal
	var/goddamn_it = "fuck"

/// Brimdemon's beam only fires when the target is lined up on a cardinal direction.
/datum/bt_node/ai_behavior/targeted_mob_ability/cardinal/perform(seconds_per_tick, datum/ai_controller/controller)
