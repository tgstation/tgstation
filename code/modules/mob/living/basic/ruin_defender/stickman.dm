...
/mob/living/basic/stickman/Initialize(mapload)
	...
	add_element(/datum/element/basic_body_temp_sensitive, cold_damage = 7.5, heat_damage = 7.5)
	add_element(/datum/element/atmos_requirements, list("min_oxy" = 5, "max_oxy" = 0, "min_plas" = 0, "max_plas" = 1, "min_co2" = 0, "max_co2" = 5, "min_n2" = 0, "max_n2" = 0), 7.5)
...
/mob/living/basic/stickman/ranged/Initialize(mapload)
	. = ..()
	add_element(/datum/element/death_drops, list(/obj/item/gun/ballistic/automatic/pistol/stickman))
	add_element(/datum/element/ranged_attacks, /obj/item/ammo_casing/c9mm, 'sound/misc/bang.ogg')
