...
/mob/living/basic/bot/firebot/generate_speak_list()
	var/static/list/idle_lines = list(
		FIREBOT_VOICED_NO_FIRES = 'sound/mobs/voice/firebot/nofires.ogg',
		FIREBOT_VOICED_ONLY_YOU = 'sound/mobs/voice/firebot/onlyyou.ogg',
		FIREBOT_VOICED_TEMPERATURE_NOMINAL = 'sound/mobs/voice/firebot/tempnominal.ogg',
		FIREBOT_VOICED_KEEP_COOL = 'sound/mobs/voice/firebot/keepitcool.ogg',
	)
	var/static/list/fire_detected_lines = list(
		FIREBOT_VOICED_FIRE_DETECTED = 'sound/mobs/voice/firebot/detected.ogg',
		FIREBOT_VOICED_STOP_DROP = 'sound/mobs/voice/firebot/stopdropnroll.ogg',
		FIREBOT_VOICED_EXTINGUISHING = 'sound/mobs/voice/firebot/extinguishing.ogg',
	)
	var/static/list/emagged_lines = list(
		FIREBOT_VOICED_CANDLE_TIP = 'sound/mobs/voice/firebot/candle_tip.ogg',
		FIREBOT_VOICED_ELECTRIC_FIRE = 'sound/mobs/voice/firebot/electric_fire_tip.ogg',
		FIREBOT_VOICED_FUEL_TIP = 'sound/mobs/voice/firebot/gasoline_tip.ogg'
	)
