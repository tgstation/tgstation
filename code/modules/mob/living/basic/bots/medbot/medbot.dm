...
/mob/living/basic/bot/medbot
	...
	var/static/list/wait_announcements = list(
		MEDIBOT_VOICED_HOLD_ON = 'sound/mobs/voice/medbot/coming.ogg',
		MEDIBOT_VOICED_WANT_TO_HELP = 'sound/mobs/voice/medbot/help.ogg',
		MEDIBOT_VOICED_YOU_ARE_INJURED = 'sound/mobs/voice/medbot/injured.ogg',
	)

	///announcements after we heal someone
	var/static/list/afterheal_announcements = list(
		MEDIBOT_VOICED_ALL_PATCHED_UP = 'sound/mobs/voice/medbot/patchedup.ogg',
		MEDIBOT_VOICED_APPLE_A_DAY = 'sound/mobs/voice/medbot/apple.ogg',
		MEDIBOT_VOICED_FEEL_BETTER = 'sound/mobs/voice/medbot/feelbetter.ogg',
	)

	///announcements when we are healing someone near death
	var/static/list/near_death_announcements = list(
		MEDIBOT_VOICED_STAY_WITH_ME = 'sound/mobs/voice/medbot/no.ogg',
		MEDIBOT_VOICED_LIVE = 'sound/mobs/voice/medbot/live.ogg',
		MEDIBOT_VOICED_NEVER_LOST = 'sound/mobs/voice/medbot/lost.ogg',
	)
	///announcements when we are idle
	var/static/list/idle_lines = list(
		MEDIBOT_VOICED_DELICIOUS = 'sound/mobs/voice/medbot/delicious.ogg',
		MEDIBOT_VOICED_PLASTIC_SURGEON = 'sound/mobs/voice/medbot/surgeon.ogg',
		MEDIBOT_VOICED_MASK_ON = 'sound/mobs/voice/medbot/radar.ogg',
		MEDIBOT_VOICED_ALWAYS_A_CATCH = 'sound/mobs/voice/medbot/catch.ogg',
		MEDIBOT_VOICED_LIKE_FLIES = 'sound/mobs/voice/medbot/flies.ogg',
		MEDIBOT_VOICED_SUFFER = 'sound/mobs/voice/medbot/why.ogg',
	)
	///announcements when we are emagged
	var/static/list/emagged_announcements = list(
		MEDIBOT_VOICED_FUCK_YOU = 'sound/mobs/voice/medbot/fuck_you.ogg',
		MEDIBOT_VOICED_NOT_A_GAME = 'sound/mobs/voice/medbot/turn_off.ogg',
		MEDIBOT_VOICED_IM_DIFFERENT = 'sound/mobs/voice/medbot/im_different.ogg',
		MEDIBOT_VOICED_FOURTH_WALL = 'sound/mobs/voice/medbot/close.ogg',
		MEDIBOT_VOICED_SHINDEMASHOU = 'sound/mobs/voice/medbot/shindemashou.ogg',
	)
	///announcements when we are being tipped
	var/static/list/tipped_announcements = list(
		MEDIBOT_VOICED_WAIT = 'sound/mobs/voice/medbot/hey_wait.ogg',
		MEDIBOT_VOICED_DONT = 'sound/mobs/voice/medbot/please_dont.ogg',
		MEDIBOT_VOICED_TRUSTED_YOU = 'sound/mobs/voice/medbot/i_trusted_you.ogg',
		MEDIBOT_VOICED_NO_SAD = 'sound/mobs/voice/medbot/nooo.ogg',
		MEDIBOT_VOICED_OH_FUCK = 'sound/mobs/voice/medbot/oh_fuck.ogg',
	)
	///announcements when we are being untipped
	var/static/list/untipped_announcements = list(
		MEDIBOT_VOICED_FORGIVE = 'sound/mobs/voice/medbot/forgive.ogg',
		MEDIBOT_VOICED_THANKS = 'sound/mobs/voice/medbot/thank_you.ogg',
		MEDIBOT_VOICED_GOOD_PERSON = 'sound/mobs/voice/medbot/youre_good.ogg',
	)
	///announcements when we are worried
	var/static/list/worried_announcements = list(
		MEDIBOT_VOICED_PUT_BACK = 'sound/mobs/voice/medbot/please_put_me_back.ogg',
		MEDIBOT_VOICED_IM_SCARED = 'sound/mobs/voice/medbot/please_im_scared.ogg',
		MEDIBOT_VOICED_NEED_HELP = 'sound/mobs/voice/medbot/dont_like.ogg',
		MEDIBOT_VOICED_THIS_HURTS = 'sound/mobs/voice/medbot/pain_is_real.ogg',
		MEDIBOT_VOICED_THE_END = 'sound/mobs/voice/medbot/is_this_the_end.ogg',
		MEDIBOT_VOICED_NOOO = 'sound/mobs/voice/medbot/nooo.ogg',
	)
	var/static/list/misc_announcements= list(
		MEDIBOT_VOICED_CHICKEN = 'sound/mobs/voice/medbot/i_am_chicken.ogg',
	)
