...
/mob/living/basic/bot/proc/generate_bot_path(datum/move_loop/has_target/navmesh_astar/source, list/path)
	SIGNAL_HANDLER

	UnregisterSignal(src, COMSIG_MOVELOOP_NAVMESH_FINISHED_PATHING)
