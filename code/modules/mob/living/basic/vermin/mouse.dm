...
/mob/living/basic/mouse/Initialize(mapload, tame = FALSE, new_body_color)
	...
	AddComponent(/datum/component/squeak, list('sound/mobs/creatures/mousesqueek.ogg' = 1), 100, extrarange = SHORT_RANGE_SOUND_EXTRARANGE) //as quiet as a mouse or whatever
