...
/mob/living/basic/netherworld/migo/health_full_behaviour()
	set_varspeed(1)
	dodge_prob = 10

/mob/living/basic/netherworld/migo/health_high_behaviour()
	set_varspeed(0.5)
	dodge_prob = 20

/mob/living/basic/netherworld/migo/health_medium_behaviour()
	set_varspeed(0)
	dodge_prob = 30

/mob/living/basic/netherworld/migo/health_low_behaviour()
	set_varspeed(-0.5)
	dodge_prob = 50

/mob/living/basic/netherworld/migo/say(message, bubble_type, list/spans = list(), sanitize = TRUE, datum/language/language = null, ignore_spam = FALSE, forced = null, filterproof = null, message_range = 7, datum/saymode/saymode = null)
	..()
	if(stat)
		return
...
/mob/living/basic/netherworld/migo/Life(delta_time = SSMOBS_DT, times_fired)
	..()
	if(stat)
		return
