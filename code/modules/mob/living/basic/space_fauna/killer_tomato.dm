...
/mob/living/basic/killer_tomato
	...
	gender = NEUTER
	speed = 1 // if you want to touch this, keep in mind we want to incentivize people growing really good botany plants in order to make these buggers faster.
	maxHealth = 30
	health = 30
...
/datum/ai_controller/basic_controller/killer_tomato
	...
	blackboard = list(
		...
		BB_BASIC_MOB_SPEAK_LINES = list(
			BB_EMOTE_HEAR = list("gnashes.", "growls lowly.", "snarls."),
			BB_EMOTE_SEE = list("salivates."),
			BB_SPEAK_CHANCE = 3,
		),
	)
