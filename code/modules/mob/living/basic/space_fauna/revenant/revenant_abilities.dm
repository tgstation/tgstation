...
/datum/action/cooldown/spell/aoe/revenant/defile/cast_on_thing_in_aoe(turf/victim, mob/living/basic/revenant/caster)
	...
	for(var/obj/item/reagent_containers/cursed_container in victim)
	...
	for(var/obj/item/food/cursed_food in victim)
	...
	for(var/obj/machinery/dna_scannernew/dna in victim)
		turf_was_defiled = TRUE
		dna.open_machine()
	for(var/obj/machinery/cryo_cell/cursed_cryo_cell in victim)
		turf_was_defiled = TRUE
		cursed_cryo_cell.open_machine()
	for(var/obj/machinery/stasis/cursed_stasis in victim)
		turf_was_defiled = TRUE
		cursed_stasis.unbuckle_all_mobs()

	// obscure
	for(var/obj/item/reagent_containers/applicator/patch/cursed_patch in victim)
		turf_was_defiled = TRUE
	...
	for(var/obj/item/storage/pill_bottle/cursed_pill_bottle in victim)
		turf_was_defiled = TRUE
		cursed_pill_bottle.name = /obj/item/storage/pill_bottle::name
		cursed_pill_bottle.desc = /obj/item/storage/pill_bottle::desc
	for(var/obj/item/reagent_containers/applicator/pill/cursed_pill in victim)
		turf_was_defiled = TRUE
	...
	for(var/obj/item/reagent_containers/cup/bottle/cursed_bottle in victim)
		turf_was_defiled = TRUE
	...
	for(var/obj/item/reagent_containers/syringe/cursed_syringe in victim)
		turf_was_defiled = TRUE
		cursed_syringe.name = /obj/item/reagent_containers/syringe::name
		cursed_syringe.desc = /obj/item/reagent_containers/syringe::desc
	for(var/obj/item/reagent_containers/hypospray/medipen/cursed_medipen in victim)
		turf_was_defiled = TRUE
	...
	for(var/obj/item/reagent_containers/medigel/cursed_medigel in victim)
		turf_was_defiled = TRUE
	...
	for(var/obj/item/reagent_containers/spray/cursed_spray in victim)
		turf_was_defiled = TRUE
	...
	for(var/obj/item/storage/lockbox/order/cursed_order in victim)
		turf_was_defiled = TRUE
		cursed_order.name = initial(cursed_order.name) // initial() is fine since we just want to remove the cargo info
	for(var/obj/structure/closet/crate/cursed_crate in victim)
		turf_was_defiled = TRUE
