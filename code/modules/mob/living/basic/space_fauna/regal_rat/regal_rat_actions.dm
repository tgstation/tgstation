...
/datum/reagent/rat_spit/overdose_start(mob/living/affected_mob, metabolized_volume)
	. = ..()
...
/datum/reagent/rat_spit/on_mob_life(mob/living/carbon/affected_mob, metabolized_volume)
	. = ..()
	if(prob(15))
