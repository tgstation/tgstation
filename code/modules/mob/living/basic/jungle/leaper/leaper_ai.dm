...
/datum/pet_command/leaper_ability
	///leaper's ability
	var/leaper_ability_key

/datum/pet_command/leaper_ability/execute_action(datum/ai_controller/controller)
	var/datum/action/cooldown/leaper_ability = controller.blackboard[leaper_ability_key]
	if(!leaper_ability?.IsAvailable())
		return
	controller.queue_behavior(/datum/ai_behavior/use_mob_ability, leaper_ability_key)
...
/datum/pet_command/leaper_ability/blood_rain
	...
	leaper_ability_key = BB_LEAPER_VOLLEY
...
/datum/pet_command/leaper_ability/summon_toad
	...
	leaper_ability_key = BB_LEAPER_SUMMON
