...
/mob/living/basic/venus_human_trap
	...
	attacked_sound = 'sound/mobs/creatures/venus_trap_hurt.ogg'
	death_sound = 'sound/mobs/creatures/venus_trap_death.ogg'
	attack_sound = 'sound/mobs/creatures/venus_trap_hit.ogg'
