...
/datum/ai_controller/basic_controller/penguin
	behavior_tree_json = "code/modules/mob/living/basic/pets/penguin/penguin.bt.json"
	blackboard = list(
...
/datum/ai_controller/basic_controller/penguin/baby
	behavior_tree_json = "code/modules/mob/living/basic/pets/penguin/penguin_baby.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
