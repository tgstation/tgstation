...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("Leporazine Medipen",	/obj/item/weapon/reagent_containers/hypospray/medipen/leppen,		50),
		new /datum/data/mining_equipment("Leppen Bundle",		/obj/item/weapon/storage/box/medipens/leppen,						200),
