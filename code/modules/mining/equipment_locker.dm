...
/obj/machinery/mineral/equipment_vendor/proc/RedeemVoucher(obj/item/weapon/mining_voucher/voucher, mob/redeemer)
	var/selection = input(redeemer, "Pick your equipment", "Mining Voucher Redemption") as null|anything in list("Kinetic Accelerator", "Resonator", "Mining Drone")
...
/obj/item/device/mining_scanner
	desc = "A tool for disarming Gibtonite and interacting with mining bots."
	name = "mining scanner"
	icon_state = "mining1"
	item_state = "analyzer"
	w_class = 2.0
