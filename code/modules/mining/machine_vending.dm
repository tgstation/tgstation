...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, use tabs and not spaces.
		...
		new /datum/data/mining_equipment("KA Brown Tracer Rounds",	/obj/item/borg/upgrade/modkit/tracer/brown,							250),
		new /datum/data/mining_equipment("KA Yellow Tracer Rounds",	/obj/item/borg/upgrade/modkit/tracer/yellow,						250),
		new /datum/data/mining_equipment("KA Orange Tracer Rounds",	/obj/item/borg/upgrade/modkit/tracer/orange,						250),
		new /datum/data/mining_equipment("KA Green Tracer Rounds",	/obj/item/borg/upgrade/modkit/tracer/green,							250),
		new /datum/data/mining_equipment("KA Purple Tracer Rounds",	/obj/item/borg/upgrade/modkit/tracer/purple,						250),
