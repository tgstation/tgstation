...
/obj/machinery/mineral/equipment_vendor/proc/RedeemVoucher(obj/item/mining_voucher/voucher, mob/redeemer, obj/machinery/machine)
	...
	switch(selection)
		if("Survival Capsule and Explorer's Webbing")
			new /obj/item/storage/belt/mining/vendor(machine.loc)
		if("Resonator Kit")
			new /obj/item/extinguisher/mini(machine.loc)
			new /obj/item/resonator(machine.loc)
		if("Minebot Kit")
			new /mob/living/simple_animal/hostile/mining_drone(machine.loc)
			new /obj/item/weldingtool/hugetank(machine.loc)
			new /obj/item/clothing/head/welding(machine.loc)
			new /obj/item/borg/upgrade/modkit/minebot_passthrough(machine.loc)
		if("Extraction and Rescue Kit")
			new /obj/item/extraction_pack(machine.loc)
			new /obj/item/fulton_core(machine.loc)
			new /obj/item/stack/marker_beacon/thirty(machine.loc)
		if("Crusher Kit")
			new /obj/item/extinguisher/mini(machine.loc)
			new /obj/item/twohanded/required/kinetic_crusher(machine.loc)
		if("Mining Conscription Kit")
			new /obj/item/storage/backpack/duffelbag/mining_conscript(machine.loc)
