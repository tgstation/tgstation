...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Gold Pickaxe",		/obj/item/weapon/pickaxe/gold,											1800),
		new /datum/data/mining_equipment("Uranium Pickaxe",		/obj/item/weapon/pickaxe/uranium,										2500),
		new /datum/data/mining_equipment("Plasma Pickaxe",		/obj/item/weapon/pickaxe/plasma,										3500),
		new /datum/data/mining_equipment("Diamond Pickaxe",		/obj/item/weapon/pickaxe/diamond,										4500),
