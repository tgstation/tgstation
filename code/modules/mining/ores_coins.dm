...
/obj/item/coin
	...
	throwforce = 2
	w_class = WEIGHT_CLASS_TINY
	custom_materials = list(/datum/material/iron = HALF_SHEET_MATERIAL_AMOUNT*8.0)
...
/obj/item/coin/gold
	custom_materials = list(/datum/material/gold = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/silver
	custom_materials = list(/datum/material/silver = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/diamond
	custom_materials = list(/datum/material/diamond = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/plasma
	custom_materials = list(/datum/material/plasma = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/uranium
	custom_materials = list(/datum/material/uranium = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/titanium
	custom_materials = list(/datum/material/titanium = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/bananium
	custom_materials = list(/datum/material/bananium = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/adamantine
	custom_materials = list(/datum/material/adamantine = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/mythril
	custom_materials = list(/datum/material/mythril = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/plastic
	custom_materials = list(/datum/material/plastic = HALF_SHEET_MATERIAL_AMOUNT*8.0)

/obj/item/coin/runite
	custom_materials = list(/datum/material/runite = HALF_SHEET_MATERIAL_AMOUNT*8.0)
