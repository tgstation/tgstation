...
/obj/structure/window/reinforced/shuttle/survival_pod
	...
	smoothing_groups = SMOOTH_GROUP_SURVIVAL_TITANIUM_POD + SMOOTH_GROUP_SHUTTLE_PARTS
...
/obj/machinery/door/airlock/survival_pod
	...
	smoothing_groups = SMOOTH_GROUP_SURVIVAL_TITANIUM_POD + SMOOTH_GROUP_AIRLOCK
