...
/obj/item/clothing/suit/hooded/explorer
	name = "explorer suit"
	desc = "An armred suit for exploring harsh environments."
	icon_state = "explorer"
	item_state = "explorer"
	...
	armr = list(melee = 30, bullet = 20, laser = 20, energy = 20, bomb = 50, bio = 100, rad = 50, fire = 50, acid = 50)
...
/obj/item/clothing/head/hooded/explorer
	name = "explorer hood"
	desc = "An armred hood for exploring harsh environments."
	icon_state = "explorer"
...
/obj/item/clothing/mask/gas/explorer
	...
	armr = list(melee = 10, bullet = 5, laser = 5, energy = 5, bomb = 0, bio = 50, rad = 0, fire = 20, acid = 40)
	resistance_flags = FIRE_PROOF
