	...
	if(proximity_flag && ishuman(target))
		...
		if(inert)
			...
			if(H != user)
				...
				to_chat(user, "<span class='notice'>You start to smear [src] on yourself. You feel the torment of the soul locked inside, but feel a lot healthier besides that..</span>")
