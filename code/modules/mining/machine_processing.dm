...
/obj/machinery/mineral/proc/register_input_turf()
	...
	if(input_turf) // make sure there is actually a turf
		register_signal(input_turf, list(COMSIG_ATOM_INITIALIZED_ON, COMSIG_ATOM_ENTERED), .proc/pickup_item)
...
/obj/machinery/mineral/proc/unregister_input_turf()
	if(input_turf)
		unregister_signal(input_turf, list(COMSIG_ATOM_ENTERED, COMSIG_ATOM_INITIALIZED_ON))
...
/obj/machinery/mineral/processing_unit/Initialize(mapload)
	...
	add_component(/datum/component/material_container, allowed_materials, INFINITY, MATCONTAINER_EXAMINE|BREAKDOWN_FLAGS_ORE_PROCESSOR, allowed_items=/obj/item/stack)
