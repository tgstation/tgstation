...
/obj/structure/fans/tiny
	...
	density = 0
	icon_state = "fan_tiny"
	var/buildstacktype1 = /obj/item/stack/sheet/metal
	var/buildstackamount1 = 2

/obj/structure/fans/tiny/deconstruct()
	if(buildstacktype1)
		new buildstacktype1(loc,buildstackamount1)
	..()

/obj/structure/fans/tiny/attackby(obj/item/weapon/W, mob/user, params)
	if(istype(W, /obj/item/weapon/wrench) && !(flags&NODECONSTRUCT))
		playsound(src.loc, 'sound/items/Ratchet.ogg', 50, 1)
		user.visible_message("<span class='warning'>[user] disassembles the fan.</span>", \
						"<span class='notice'>You start to disassemble the fan...</span>", "You hear clanking and banging noises.")
