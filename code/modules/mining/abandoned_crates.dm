...
/obj/structure/closet/crate/secure/loot/proc/spawn_loot()
	...
	switch(loot)
		...
		if(16 to 20)
			SSwardrobe.provide(/obj/item/stack/ore/diamond, src, STACK_AMOUNT(10))
		if(21 to 25)
			for(var/i in 1 to 5)
		...
		if(69 to 70)
			SSwardrobe.provide(/obj/item/stack/ore/bluespace_crystal, src, STACK_AMOUNT(5))
		if(71 to 72)
		...
		if(79 to 80)
			SSwardrobe.provide(/obj/item/stack/sheet/mineral/bananium, src, STACK_AMOUNT(10))
		if(81 to 82)
			new /obj/item/bikehorn/airhorn(src)
		if(83 to 84)
