...
/obj/structure/plasma_extraction_hub/part/pipe/proc/on_lockon_component(list/locked_weakrefs)
	...
	var/list/pipe_locations = get_path_to(src, real_target, max_distance = 4, diagonal_handling = DIAGONAL_REMOVE_ALL)
...
/obj/structure/plasma_extraction_hub/part/pipe/proc/build_pipes(turf/starting_location)
	building_pipes = TRUE
	var/list/pipe_locations = get_path_to(src, starting_location, max_distance = 4, diagonal_handling = DIAGONAL_REMOVE_ALL)
