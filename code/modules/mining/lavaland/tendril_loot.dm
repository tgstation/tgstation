...
/obj/item/cursed_katana/proc/strike(mob/living/target, mob/user)
	...
	PLAYSOUND(src, 'sound/items/weapons/genhit3.ogg').vary_frequency(TRUE).play()
...
/obj/item/cursed_katana/proc/uncloak(mob/user)
	...
	PLAYSOUND(src, 'sound/effects/magic/summonitems_generic.ogg').vary_frequency(TRUE).play()
	new /obj/effect/temp_visual/mook_dust(get_turf(src))
...
/obj/item/cursed_katana/proc/cut(mob/living/target, mob/user)
	...
	PLAYSOUND(src, 'sound/items/weapons/rapierhit.ogg').vary_frequency(TRUE).play()
