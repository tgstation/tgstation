...
/obj/item/clothing/gloves/gauntlets
	...
	armor = list(MELEE = 15, BULLET = 25, LASER = 15, ENERGY = 15, BOMB = 100, FIRE = 100, ACID = 30) //mostly bone bracer armor
...
/obj/item/clothing/suit/hooded/berserker
	...
	armor = list(MELEE = 30, BULLET = 30, LASER = 10, ENERGY = 20, BOMB = 50, FIRE = 100, ACID = 100)
