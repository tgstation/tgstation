...
/obj/item/clothing/head/hooded/berserker/proc/berserk_mode(mob/living/carbon/human/user)
	...
	PLAYSOUND(user, 'sound/effects/magic/staff_healing.ogg').volume(50).play()
...
/obj/item/clothing/head/hooded/berserker/proc/end_berserk(mob/living/carbon/human/user)
	...
	PLAYSOUND(user, 'sound/effects/magic/summonitems_generic.ogg').volume(50).play()
...
/obj/item/cursed_katana/proc/strike(mob/living/target, mob/user)
	...
	PLAYSOUND(src, 'sound/items/weapons/genhit3.ogg').volume(50).vary_frequency(TRUE).play()
...
/obj/item/cursed_katana/proc/uncloak(mob/user)
	...
	PLAYSOUND(src, 'sound/effects/magic/summonitems_generic.ogg').volume(50).vary_frequency(TRUE).play()
	new /obj/effect/temp_visual/mook_dust(get_turf(src))
...
/obj/item/cursed_katana/proc/cut(mob/living/target, mob/user)
	...
	PLAYSOUND(src, 'sound/items/weapons/rapierhit.ogg').volume(50).vary_frequency(TRUE).play()
