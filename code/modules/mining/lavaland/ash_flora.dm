...
/obj/structure/flora/ash/attackby(obj/item/W, mob/user, params)
	if(!harvested && needs_sharp_harvest && W.is_sharp())
		user.visible_message("<span class='none'>[user] starts to harvest from [src] with [W].</span>","<span class='notice'>You begin to harvest from [src] with [W].</span>")
...
/obj/structure/flora/ash/attack_hand(mob/user)
	...
	if(!harvested && !needs_sharp_harvest)
		user.visible_message("<span class='none'>[user] starts to harvest from [src].</span>","<span class='notice'>You begin to harvest from [src].</span>")
		if(do_after(user, harvest_time, target = src))
			harvest(user)
