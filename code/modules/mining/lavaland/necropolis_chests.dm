...
/obj/item/weapon/dragons_blood/attack_self(mob/living/carbon/human/user)
	...
	switch(random)
		if(1)
			...
			H.dna.features = list("mcolor" = "F00", "tail_lizard" = "Dark Tiger", "tail_human" = "None", "snout" = "Sharp", "horns" = "Curled", "ears" = "None", "wings" = "None", "frills" = "None", "spines" = "Long", "body_markings" = "Dark Tiger Body")
			H.eye_color = "ff0"
