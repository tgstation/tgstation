...
/datum/weather/advanced_darkness
	...
	wind_down_message = "The darkness is receding. Thankfully."
...
/datum/weather/ash_storm
	...
	duration_message = "Smoldering clouds of ash billow down around you. Get inside!"
	wind_down = 300 // 30 seconds
	wind_down_message = "The howling wind whips away the ash storm and drops to its usual murmur. It should be safe to go outside."
...
/datum/weather/ash_storm/false_alarm //No storm, just light ember fall
	...
	duration_message = "<span class='notice'>Gentle billows of ash fall around you like grotesque snowflakes. The storm has passed by.</span>."
	wind_down_message = "The fall of ash slows, then stops. Another layer hardens around the volcanic rock."
