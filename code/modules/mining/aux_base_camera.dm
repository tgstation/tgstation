...
/datum/action/innate/aux_base/build/Activate()
	...
	playsound(target_turf, 'sound/items/deconstruct.ogg', 60, DEFAULT_SOUND_VARY)
...
datum/action/innate/aux_base/place_fan/Activate()
	...
	playsound(fan_turf, 'sound/machines/click.ogg', 50, DEFAULT_SOUND_VARY)
...
datum/action/innate/aux_base/install_turret/Activate()
	...
	playsound(turret_turf, 'sound/items/drill_use.ogg', 65, DEFAULT_SOUND_VARY)
