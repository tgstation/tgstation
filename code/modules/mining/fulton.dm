...
/obj/item/extraction_pack/afterattack(atom/movable/A, mob/living/carbon/human/user, flag, params)
	...
	if(!istype(A))
		...
		if(do_after(user,50,target=A))
			...
			playsound(holder_obj.loc, 'sound/items/fultext_deploy.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -3)
			...
			animate(holder_obj, pixel_z = 10, time = 10)
			sleep(10)
			playsound(holder_obj.loc, 'sound/items/fultext_launch.ogg', 50, DEFAULT_SOUND_VARY, extra_range = -3)
