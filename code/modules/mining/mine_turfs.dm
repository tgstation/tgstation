...
/turf/simulated/mineral/random
	...
	var/mineralSpawnChanceList = list("Uranium" = 5, "Iron" = 50, "Diamond" = 5, "Gold" = 8, "Silver" = 15, "Plasma" = 25/*, "Adamantine" =5*/)//Currently, Adamantine won't spawn as it has no uses. -Durandan
...
/turf/simulated/mineral/random/high_chance
	mineralChance = 25
	mineralSpawnChanceList = list("Uranium" = 10, "Iron" = 30, "Diamond" = 10, "Gold" = 10, "Silver" = 10, "Plasma" = 25)
