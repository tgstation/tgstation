...
/obj/machinery/mineral/ore_redemption
	...
	var/list/ore_values = list(/datum/material/iron = 1, /datum/material/glass = 1,  /datum/material/plasma = 15,  /datum/material/silver = 16, /datum/material/gold = 18, /datum/material/titanium = 30, /datum/material/uranium = 30, /datum/material/diamond =SMALL_MATERIAL_AMOUNT*0.5, /datum/material/bluespace =SMALL_MATERIAL_AMOUNT*0.5, /datum/material/bananium = 60)
