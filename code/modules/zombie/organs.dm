...
/obj/item/organ/zombie_infection/proc/zombify()
	...
	to_chat(owner, "<span class='alertalien'>You are now a zombie! Do not seek to be cured, do not help any non-zombies in any way, do not harm your zombie brethren and spread the disease by biting others. Grab someone aggressively, then punch them to bite. You are a creature of hunger and violence.</span>")
