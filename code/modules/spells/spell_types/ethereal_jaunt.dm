...
/obj/effect/proc_holder/spell/targeted/ethereal_jaunt/cast(list/targets, mob/user = usr) //magnets, so mostly hardcoded
	...
	for(var/mob/living/target in targets)
		...
		spawn(0)
			...
			if (in_jaunt)
				exit_jaunt(target, user)
				in_jaunt = 0

/obj/effect/proc_holder/spell/targeted/ethereal_jaunt/proc/enter_jaunt(mob/living/target)
...
/obj/effect/proc_holder/spell/targeted/ethereal_jaunt/proc/exit_jaunt(mob/living/target, mob/user)
