...
/datum/action/cooldown/spell/touch/proc/register_hand_signals()
	...
	RegisterSignal(attached_hand, COMSIG_ITEM_AFTERATTACK, PROC_REF(on_hand_hit)) // melbert todo
	RegisterSignal(attached_hand, COMSIG_ITEM_AFTERATTACK_SECONDARY, PROC_REF(on_secondary_hand_hit)) // melbert todo
 ...
 */
/datum/action/cooldown/spell/touch/proc/on_secondary_hand_hit(datum/source, atom/victim, mob/caster, click_parameters)
	SIGNAL_HANDLER
