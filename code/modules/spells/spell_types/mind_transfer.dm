...
/obj/effect/proc_holder/spell/targeted/mind_transfer/cast(list/targets, mob/user = usr, distanceoverride)
	...
	caster.playsound_direct('sound/magic/MandSwap.ogg')
	victim.playsound_direct('sound/magic/MandSwap.ogg')// only the caster and victim hear the sounds, that way no one knows for sure if the swap happened
