/obj/effect/proc_holder/spell/targeted/mind_transfer
	...
	var/unconscious_amount_caster = 200 //how much the caster is stunned for after the spell
	var/unconscious_amount_victim = 200 //how much the victim is stunned for after the spell
