...
/obj/effect/proc_holder/spell/targeted/summon_wealth/cast(list/targets, mob/user = usr)
	for(var/mob/living/carbon/C in targets)
		if(user.dropItemToGround(user.get_active_held_item()))
			var/obj/item = pick(
					new /obj/item/coin/gold(user.drop_location()[1]),
					new /obj/item/coin/diamond(user.drop_location()[1]),
					new /obj/item/coin/silver(user.drop_location()[1]),
					new /obj/item/clothing/accessory/medal/gold(user.drop_location()[1]),
					new /obj/item/stack/sheet/mineral/gold(user.drop_location()[1]),
					new /obj/item/stack/sheet/mineral/silver(user.drop_location()[1]),
					new /obj/item/stack/sheet/mineral/diamond(user.drop_location()[1]),
					new /obj/item/holochip(user.drop_location()[1], 1000))
			C.put_in_hands(item)
