...
/obj/effect/proc_holder/spell/targeted/summon_wealth/cast(list/targets, mob/user = usr)
	for(var/mob/living/carbon/C in targets)
		if(user.dropItemToGround(user.get_active_held_item()))
			var/obj/item = pick(
					new /obj/item/coin/gold(user.dropLocation()),
					new /obj/item/coin/diamond(user.dropLocation()),
					new /obj/item/coin/silver(user.dropLocation()),
					new /obj/item/clothing/accessory/medal/gold(user.dropLocation()),
					new /obj/item/stack/sheet/mineral/gold(user.dropLocation()),
					new /obj/item/stack/sheet/mineral/silver(user.dropLocation()),
					new /obj/item/stack/sheet/mineral/diamond(user.dropLocation()),
					new /obj/item/holochip(user.dropLocation(), 1000)),
			C.put_in_hands(item)
