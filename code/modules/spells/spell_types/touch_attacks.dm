...
/obj/effect/proc_holder/spell/targeted/touch/disintegrate
	name = "Disintegrate"
	desc = "This spell charges your hand with vile energy that can be used to instantly turn all but the mightiest of creatures to dust- provided, of course, that they are not resistant to magic."
