	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		if(!summon_type)
			...
			switch (randomizeguns)
				if("taser")
					G = new /obj/item/weapon/gun/energy/frame/hybrid_taser(get_turf(H))
				if("egun")
					G = new /obj/item/weapon/gun/energy/frame/egun(get_turf(H))
				if("laser")
					G = new /obj/item/weapon/gun/energy/frame/lasergun(get_turf(H))
				if("revolver")
