...
/obj/effect/proc_holder/spell/aimed/chill_touch
	...
	charge_max = 60
	clothes_req = FALSE
	invocation = "GRAV WALKA"
	invocation_type = "shout"
	range = 20
	cooldown_min = 15
	projectile_type = /obj/projectile/magic/projectile/chill_touch
	base_icon_state = "grease"
	action_icon_state = "grease0"
	sound = 'sound/magic/fireball.ogg'
	active_msg = "You prepare to cast Chill Touch!"
	deactive_msg = "You vanish your Chill Touch...for now."
	active = FALSE