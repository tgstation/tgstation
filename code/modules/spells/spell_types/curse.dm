...
/proc/curse_of_madness(mob/user, message)
	...
	deadchat_broadcast(message = "A <span class='name'>Curse of Madness</span> has stricken the station, shattering their minds with the awful secret: \"<span class='big hypnophrase'>[message]</span>\"")
