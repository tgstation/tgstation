...
/mob/living/proc/infernalphaseout()
	...
	playsound(get_turf(src), 'sound/magic/enter_blood.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -1)
...
/mob/living/proc/infernalphasein()
	...
	playsound(get_turf(src), 'sound/magic/exit_blood.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -1)
