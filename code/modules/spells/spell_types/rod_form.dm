...
/obj/effect/proc_holder/spell/targeted/rod_form/cast(list/targets,mob/user = usr)
	...
	if(istype(A, /area/wizard_station))
		...
		to_chat(user, "<span class='warning'>Some foul goat based magic is preventing you from using rod form here!. You must beat escape the arena before you can use [src].</span>")
		return
