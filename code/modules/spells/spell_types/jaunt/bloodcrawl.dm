 ...
 * Every 10 SECONDS check if demon still crawling and update timer.
 */
...
/datum/action/cooldown/spell/jaunt/bloodcrawl/proc/exit_blood_effect(mob/living/exited)
	...
	addtimer(CALLBACK(exited, TYPE_PROC_REF(/atom/, remove_atom_colour), TEMPORARY_COLOUR_PRIORITY, new_color), 10 SECONDS)
...
/datum/action/cooldown/spell/jaunt/bloodcrawl/slaughter_demon/try_enter_jaunt(obj/effect/decal/cleanable/blood, mob/living/jaunter)
	...
	if((victim.stat == CONSCIOUS) && (victim.getStaminaLoss() < 100))
