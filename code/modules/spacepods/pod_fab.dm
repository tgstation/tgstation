...
/obj/machinery/spod_part_fabricator/Initialize()
...
/obj/machinery/spod_part_fabricator/emag_act()
	if(emagged)
		return
	emagged = TRUE
	req_access = null
...
/obj/machinery/spod_part_fabricator/on_deconstruction()
	materials.retrieve_all()
	..()

/obj/machinery/spod_part_fabricator/attackby(obj/item/W, mob/user, params)
...
/obj/machinery/spod_part_fabricator/proc/material2name(ID)
	return copytext(ID,2)

/obj/machinery/spod_part_fabricator/proc/is_insertion_ready(mob/user)
	if(panel_open)
...
/obj/machinery/spod_part_fabricator/proc/try_insert(mob/user, obj/item/I, material_amount)
	if(!material_amount)
