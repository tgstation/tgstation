	...
	if(targeted)
		if(M.flash_act(1, 1))
			...
			if(!hypnosis)
				...
				M.add_timed_status_effect(20 SECONDS, /datum/status_effect/dizziness, max_duration = 40 SECONDS)
		...
		M.add_timed_status_effect(8 SECONDS, /datum/status_effect/dizziness, max_duration = 40 SECONDS)
