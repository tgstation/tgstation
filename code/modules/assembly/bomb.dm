...
/obj/item/tank/proc/ignite() //This happens when a bomb is told to explode
	...
	if(bomb_mixture.temperature > (T0C + 400))
		...
		if(strength >=2)
			explosion(src, round(strength,1), round(strength*2,1), round(strength*3,1), round(strength*4,1))
		else if(strength >=1)
			explosion(src, round(strength,1), round(strength*2,1), round(strength*2,1), round(strength*3,1))
		else if(strength >=0.5)
			explosion(src, 0, 1, 2, 4)
		else if(strength >=0.2)
			explosion(src, -1, 0, 1, 2)
		else
