...
/obj/item/assembly/timer/suicide_act(mob/living/user)
	...
	activate()// doesnt rely on timer_end to prevent weird metas where one person can control the timer and so someone's life.. (maybe that should be how it works...)
