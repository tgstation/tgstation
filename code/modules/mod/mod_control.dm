...
/obj/item/mod/control/proc/quick_module(mob/user)
	...
	for(var/obj/item/mod/module/module as anything in modules)
		...
		if(module == selected_module)
			module_image.underlays += image(icon = 'icons/ui/hud/radial.dmi', icon_state = "module_selected")
		else if(module.active)
			module_image.underlays += image(icon = 'icons/ui/hud/radial.dmi', icon_state = "module_active")
		if(!COOLDOWN_FINISHED(module, cooldown_timer))
			module_image.add_overlay(image(icon = 'icons/ui/hud/radial.dmi', icon_state = "module_cooldown"))
