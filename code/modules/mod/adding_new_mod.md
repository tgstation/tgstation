...
```dm
			/obj/item/clothing/head/mod = list(
				...
				SEALED_CLOTHING = STOPS_HIGH_PRESSURE_DAMAGE|STOPS_LOW_PRESSURE_DAMAGE|BLOCK_GAS_SMOKE_EFFECT,
...
```dm
			/obj/item/clothing/head/mod = list(
				...
				SEALED_CLOTHING = THICKMATERIAL|STOPS_HIGH_PRESSURE_DAMAGE|STOPS_LOW_PRESSURE_DAMAGE,
	...
	variants = list(
		"psychological" = list(
			...
			/obj/item/clothing/suit/mod = list(
				...
				SEALED_CLOTHING = STOPS_HIGH_PRESSURE_DAMAGE|STOPS_LOW_PRESSURE_DAMAGE,
