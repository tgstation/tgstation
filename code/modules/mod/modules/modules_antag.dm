...
/obj/item/mod/module/armor_booster/on_activation()
	PLAYSOUND(src, 'sound/vehicles/mecha/mechmove03.ogg').vlume(25).vary_frequency(TRUE).range(SOUND_RANGE + SHORT_RANGE_SOUND_EXTRARANGE).play()
...
/obj/item/mod/module/flamethrower/on_select_use(atom/target)
	...
	PLAYSOUND(src, 'sound/items/modsuit/flamethrower.ogg').volume(75).vary_frequency(TRUE).play()
