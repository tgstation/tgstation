...
/obj/item/mod/module/anti_magic/on_suit_activation()
	ADD_TRAITS(mod.wearer, list(TRAIT_ANTIMAGIC, TRAIT_HOLY), MOD_TRAIT)

/obj/item/mod/module/anti_magic/on_suit_deactivation(deleting = FALSE)
	REMOVE_TRAITS(mod.wearer, list(TRAIT_ANTIMAGIC, TRAIT_HOLY), MOD_TRAIT)
...
/obj/item/mod/module/anti_magic/wizard/on_suit_activation()
	ADD_TRAITS(mod.wearer, list(TRAIT_ANTIMAGIC, TRAIT_ANTIMAGIC_NO_SELFBLOCK), MOD_TRAIT)

/obj/item/mod/module/anti_magic/wizard/on_suit_deactivation(deleting = FALSE)
	REMOVE_TRAITS(mod.wearer, list(TRAIT_ANTIMAGIC, TRAIT_ANTIMAGIC_NO_SELFBLOCK), MOD_TRAIT)
...
/obj/item/mod/module/infiltrator/on_suit_activation()
	ADD_TRAITS(mod.wearer, list(TRAIT_SILENT_FOOTSTEPS, TRAIT_UNKNOWN), MOD_TRAIT)
	mod.helmet.flash_protect = FLASH_PROTECTION_WELDER

/obj/item/mod/module/infiltrator/on_suit_deactivation(deleting = FALSE)
	REMOVE_TRAITS(mod.wearer, list(TRAIT_SILENT_FOOTSTEPS, TRAIT_UNKNOWN), MOD_TRAIT)
	if(deleting)
		return
	mod.helmet.flash_protect = initial(mod.helmet.flash_protect)
