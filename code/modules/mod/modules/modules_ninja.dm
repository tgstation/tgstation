...
/obj/item/mod/module/emp_shield/pulse/on_use()
	PLAYSOUND(src, 'sound/effects/empulse.ogg').volume(60).vary_frequency(TRUE).play()
...
/obj/item/mod/module/energy_net/on_select_use(atom/target)
	...
	PLAYSOUND(src, 'sound/items/weapons/punchmiss.ogg').volume(25).vary_frequency(TRUE).play()
