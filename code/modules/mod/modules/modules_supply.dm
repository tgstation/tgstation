...
/obj/item/mod/module/sphere_transform/on_activation()
	...
	mod.wearer.remove_element(/datum/element/footstep, FOOTSTEP_MOB_HUMAN, 1, -6)
	mod.wearer.add_element(/datum/element/footstep, FOOTSTEP_OBJ_ROBOT, 1, -6, sound_vary = TRUE)
...
/obj/item/mod/module/sphere_transform/on_deactivation(display_message = TRUE)
	...
	mod.wearer.remove_element(/datum/element/footstep, FOOTSTEP_OBJ_ROBOT, 1, -6, sound_vary = TRUE)
	mod.wearer.add_element(/datum/element/footstep, FOOTSTEP_MOB_HUMAN, 1, -6)
