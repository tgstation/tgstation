...
/obj/item/mod/module/ash_accretion/on_suit_activation()
	ADD_TRAIT(mod.wearer, TRAIT_ASHSTORM_IMMUNE, SOURCE_MOD)
	ADD_TRAIT(mod.wearer, TRAIT_SNOWSTORM_IMMUNE, SOURCE_MOD)
...
/obj/item/mod/module/ash_accretion/on_suit_deactivation(deleting = FALSE)
	REMOVE_TRAIT(mod.wearer, TRAIT_ASHSTORM_IMMUNE, SOURCE_MOD)
	REMOVE_TRAIT(mod.wearer, TRAIT_SNOWSTORM_IMMUNE, SOURCE_MOD)
	UnregisterSignal(mod.wearer, COMSIG_MOVABLE_MOVED)
	if(!traveled_tiles)
		return
...
/obj/item/mod/module/sphere_transform/on_activation()
	...
	ADD_TRAIT(mod.wearer, TRAIT_LAVA_IMMUNE, SOURCE_MOD)
	ADD_TRAIT(mod.wearer, TRAIT_HANDS_BLOCKED, SOURCE_MOD)
	ADD_TRAIT(mod.wearer, TRAIT_FORCED_STANDING, SOURCE_MOD)
	ADD_TRAIT(mod.wearer, TRAIT_NOSLIPALL, SOURCE_MOD)
...
/obj/item/mod/module/sphere_transform/on_deactivation(display_message = TRUE, deleting = FALSE)
	...
	REMOVE_TRAIT(mod.wearer, TRAIT_LAVA_IMMUNE, SOURCE_MOD)
	REMOVE_TRAIT(mod.wearer, TRAIT_HANDS_BLOCKED, SOURCE_MOD)
	REMOVE_TRAIT(mod.wearer, TRAIT_FORCED_STANDING, SOURCE_MOD)
	REMOVE_TRAIT(mod.wearer, TRAIT_NOSLIPALL, SOURCE_MOD)
	mod.wearer.remove_movespeed_mod_immunities(SOURCE_MOD, /datum/movespeed_modifier/damage_slowdown)
