...
/obj/item/mod/module/anomaly_locked/kinesis/proc/grab_atom(atom/movable/target)
	...
	PLAYSOUND(grabbed_atom, 'sound/items/weapons/contractor_baton/contractorbatonhit.ogg').volume(75).vary_frequency(TRUE).play()
...
/obj/item/mod/module/anomaly_locked/kinesis/proc/clear_grab(playsound = TRUE)
	...
	. = grabbed_atom
	if(playsound)
		PLAYSOUND(grabbed_atom, 'sound/effects/empulse.ogg').volume(75).vary_frequency(TRUE).play()
...
/obj/item/mod/module/anomaly_locked/kinesis/proc/launch(atom/movable/launched_object)
	PLAYSOUND(launched_object, 'sound/effects/magic/repulse.ogg').volume(100).vary_frequency(TRUE).play()
