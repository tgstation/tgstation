...
/obj/item/mod/module/stealth/on_activation()
	...
	if(!.)
		return
	if(bumpoff)
		register_signal(mod.wearer, COMSIG_LIVING_MOB_BUMP, .proc/unstealth)
	register_signal(mod.wearer, COMSIG_HUMAN_MELEE_UNARMED_ATTACK, .proc/on_unarmed_attack)
	register_signal(mod.wearer, COMSIG_ATOM_BULLET_ACT, .proc/on_bullet_act)
	register_signal(mod.wearer, list(COMSIG_ITEM_ATTACK, COMSIG_PARENT_ATTACKBY, COMSIG_ATOM_ATTACK_HAND, COMSIG_ATOM_HITBY, COMSIG_ATOM_HULK_ATTACK, COMSIG_ATOM_ATTACK_PAW, COMSIG_CARBON_CUFF_ATTEMPTED), .proc/unstealth)
...
/obj/item/mod/module/stealth/on_deactivation(display_message = TRUE)
	...
	if(!.)
		return
	if(bumpoff)
		unregister_signal(mod.wearer, COMSIG_LIVING_MOB_BUMP)
	unregister_signal(mod.wearer, list(COMSIG_HUMAN_MELEE_UNARMED_ATTACK, COMSIG_ITEM_ATTACK, COMSIG_PARENT_ATTACKBY, COMSIG_ATOM_ATTACK_HAND, COMSIG_ATOM_BULLET_ACT, COMSIG_ATOM_HITBY, COMSIG_ATOM_HULK_ATTACK, COMSIG_ATOM_ATTACK_PAW, COMSIG_CARBON_CUFF_ATTEMPTED))
