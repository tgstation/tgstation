...
/obj/item/instrument/trumpet/spectral/attack(mob/living/target_mob, mob/living/user, params)
	PLAYSOUND(src, 'sound/runtime/instruments/trombone/En4.mid').volume(1000).vary_frequency(1).range(-1 + SOUND_RANGE).play()
	return ..()
...
/obj/item/instrument/trombone/spectral/attack(mob/living/target_mob, mob/living/user, params)
	PLAYSOUND(src, 'sound/runtime/instruments/trombone/Cn4.mid').volume(1000).vary_frequency(1).range(-1 + SOUND_RANGE).play()
	return ..()
