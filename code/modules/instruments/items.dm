...
/obj/item/instrument/trumpet/spectral/attack(mob/living/target_mob, mob/living/user, params)
	playsound(src, 'sound/runtime/instruments/trombone/En4.mid').volume(1000).vary(1).extra_range(-1).play()
	return ..()
...
/obj/item/instrument/trombone/spectral/attack(mob/living/target_mob, mob/living/user, params)
	playsound(src, 'sound/runtime/instruments/trombone/Cn4.mid').volume(1000).vary(1).extra_range(-1).play()
	return ..()
