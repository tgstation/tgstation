...
/obj/machinery/computer/telescience/Topic(href, href_list)
	...
	if(href_list["setrotation"])
		var/new_rot = tginput("Please input desired bearing in degrees.", name, rotation) as num
	...
	if(href_list["setangle"])
		var/new_angle = tginput("Please input desired elevation in degrees.", name, angle) as num
		if(..())
			return
	...
	if(href_list["setz"])
		var/new_z = tginput("Please input desired sector.", name, z_co) as num
		if(..())
			return
