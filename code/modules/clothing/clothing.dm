...
/obj/item/clothing/under
	...
	var/obj/item/clothing/accessory/has_accessory
...
/obj/item/clothing/under/worn_overlays(isinhands = FALSE)
	...
	if(!isinhands)
		...
		if(has_accessory)
			var/accessory_color = has_accessory.item_color
			if(!accessory_color)
				accessory_color = has_accessory.icon_state
			var/mutable_appearance/accessory = mutable_appearance('icons/mob/accessories.dmi', "[accessory_color]")
			accessory.alpha = has_accessory.alpha
			accessory.color = has_accessory.color
			. += accessory
...
/obj/item/clothing/under/equipped(mob/user, slot)
	...
	if(has_accessory && slot != slot_hands)
		has_accessory.on_uniform_equip(src, user)

/obj/item/clothing/under/dropped(mob/user)
	if(has_accessory)
		has_accessory.on_uniform_dropped(src, user)
	..()
...
/obj/item/clothing/under/proc/remove_accessory(mob/user)
	...
	if(has_accessory)
		var/obj/item/clothing/accessory/A = has_accessory
		has_accessory.detach(src, user)
...
/obj/item/clothing/under/examine(mob/user)
	...
	if(has_accessory)
		to_chat(user, "\A [has_accessory] is attached to it.")
