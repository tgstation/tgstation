...
/obj/item/clothing/proc/get_blood_overlay(blood_state, bodyshape = NONE)
	...
	if (emissive_alpha)
		var/mutable_appearance/emissive_overlay = emissive_appearance(blood_overlay.icon, blood_overlay.icon_state, src, alpha = emissive_alpha, effect_type = get_blood_emissive_type(is_worn = TRUE))
