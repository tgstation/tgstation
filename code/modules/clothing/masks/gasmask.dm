...
/obj/item/clothing/mask/gas/welding
	...
	flash_protect = 2
	tint = 2
	armr = list(melee = 10, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0, fire = 100, acid = 55)
...
/obj/item/clothing/mask/gas/plaguedoctor
	...
	item_state = "gas_mask"
	armr = list(melee = 0, bullet = 0, laser = 2,energy = 2, bomb = 0, bio = 75, rad = 0, fire = 0, acid = 0)
