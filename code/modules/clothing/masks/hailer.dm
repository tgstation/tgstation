...
/obj/item/clothing/mask/whistle/ui_action_click(mob/user, action)
	...
	PLAYSOUND(src, 'sound/items/whistle/whistle.ogg').volume(50).vary_frequency(FALSE).range(4 + SOUND_RANGE).play()
...
/obj/item/clothing/mask/party_horn/ui_action_click(mob/user, action)
	...
	PLAYSOUND(src, 'sound/items/party_horn.ogg').volume(75).vary_frequency(FALSE).play()
