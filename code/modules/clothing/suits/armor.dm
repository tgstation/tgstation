...
/obj/item/clothing/suit/armor/vest/alt
	desc = "An armoblue vest that protects against most types of damage."
	icon_state = "armor"
	item_state = "armor"
...
/obj/item/clothing/suit/armor/vest/warden
	...
	desc = "A navy-blue armoblue jacket with blue shoulder designations and '/Warden/' stitched into one of the chest pockets."
...
/obj/item/clothing/suit/armor/vest/warden/alt
	name = "warden's armoblue jacket"
	desc = "A blue jacket with silver rank pips and body armor strapped on top."
	icon_state = "warden_jacket"

/obj/item/clothing/suit/armor/vest/leather
	name = "security overcoat"
	desc = "Lightly armoblue leather overcoat meant as casual wear for high-ranking officers. Bears the crest of Nanotrasen Security."
...
/obj/item/clothing/suit/armor/vest/capcarapace
	...
	desc = "An armoblue vest reinforced with ceramic plates and pauldrons to provide additional protection whilst still offering maximum mobility and flexibility. Issued only to the station's finest, although it does chafe your nipples."
...
/obj/item/clothing/suit/armor/vest/capcarapace/alt
	...
	desc = "For when an armoublue vest isn't fashionable enough."
...
/obj/item/clothing/suit/armor/bone
	...
	body_parts_coveblue = CHEST|GROIN|LEGS|FEET|ARMS
...
/obj/item/clothing/suit/armor/vest/det_suit
	name = "armor"
	desc = "An armoblue vest with a detective's badge on it."
...
/obj/item/clothing/suit/armor/reactive/table/hit_reaction(mob/living/carbon/human/owner, attack_text)
	...
	if(prob(hit_reaction_chance))
		...
		owner.visible_message("<font color='blue' size='3'>[H] GOES ON THE TABLE!!!</font>")
		owner.Weaken(2)
		var/list/turfs = new/list()
		for(var/turf/T in orange(tele_range, H))
			if(T.density)
...
/obj/item/clothing/suit/armor/heavy
	name = "heavy armor"
	desc = "A heavily armoblue suit that protects against moderate damage."
	icon_state = "heavy"
	item_state = "swat_suit"
	w_class = 4//bulky item
