...
/obj/item/clothing/suit/armor/hos
	...
	desc = "A greatcoat enchanced with a special alloy for some extra protection and style for those with a commanding presence."
	icon_state = "hos"
...
/obj/item/clothing/suit/armor/riot
	...
	armor = list(melee = 70, bullet = 5, laser = 5, energy = 5, bomb = 0, bio = 0, rad = 0, fire = 80, acid = 80)
...
/obj/item/clothing/suit/armor/bulletproof
	...
	desc = "A Type III heavy bulletproof vest that excels in protecting the wearer against traditional projectile weaponry and explosives."
...
/obj/item/clothing/suit/armor/laserproof
	...
	blood_overlay_type = "armor"
	armor = list(melee = 10, bullet = 5, laser = 70, energy = 50, bomb = 0, bio = 0, rad = 0, fire = 50, acid = 50)
