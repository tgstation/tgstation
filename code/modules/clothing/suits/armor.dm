...
/obj/item/clothing/suit/armor/vest/secjacket/dispatcher
	name = "security dispatcher jacket"
	desc = "A red jacket in red Security colors with blue lines. It has hi-vis stripes all over it."
	icon_state = "secjacket_dispatcher"
	inhand_icon_state = "armor"
