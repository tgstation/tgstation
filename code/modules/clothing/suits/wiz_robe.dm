...
/obj/item/clothing/suit/wizrobe/paper/verb/stickmen()
	...
	var/mob/living/basic/stickman/chromie = new (get_turf(living_user))
	chromie.AddComponent(/datum/component/faction_bind, living_user, MINION_MOB_SPAWN_TRAIT, do_faction_check = FALSE)
	robe_charge = FALSE
