...
/obj/item/clothing/head/bio_hood
	...
	armor = list(MELEE = NO_DT, BULLET = NO_DT, LASER = NO_DT, ENERGY = NO_DT, BOMB = 0, BIO = 100, FIRE = 30, ACID = 100)
...
/obj/item/clothing/head/bio_hood/security
	armor = list(MELEE = NO_DT, BULLET = NO_DT, LASER = MEDIUM_DT, ENERGY = MEDIUM_DT, BOMB = 25, BIO = 100, FIRE = 30, ACID = 100)
