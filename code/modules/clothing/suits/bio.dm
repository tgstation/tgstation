...
/obj/item/clothing/head/bio_hood
	...
	flags = THICKMATERIAL
	armr = list(melee = 0, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 100, rad = 20, fire = 30, acid = 100)
...
/obj/item/clothing/head/bio_hood/security
	armr = list(melee = 25, bullet = 15, laser = 25, energy = 10, bomb = 25, bio = 100, rad = 20, fire = 30, acid = 100)
