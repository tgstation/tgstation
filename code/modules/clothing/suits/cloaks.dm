...
/obj/item/clothing/suit/cloak/hos
	...
	icon_state = "hoscloak"
	armor = list(melee = 20, bullet = 15, laser = 15, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/cloak/qm
	name = "quartermaster's cloak"
	desc = "Worn by Cargonia, supplying the station with the necessary tools for survival."
	armor = list(melee = 0, bullet = 15, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/suit/cloak/rd
	...
	icon_state = "rdcloak"
	armor = list(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 20, bio = 10, rad = 5)

/obj/item/clothing/suit/cloak/cap
	name = "captain's cloak"
	desc = "Worn by the commander of Space Station 13."
	icon_state = "capcloak"
	armor = list(melee = 30, bullet = 20, laser = 20, energy = 10, bomb = 20, bio = 10, rad = 10)
