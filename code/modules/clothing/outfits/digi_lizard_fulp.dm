...
/datum/outfit/digitigrade/mime
	...
	shoes = /obj/item/clothing/shoes/sneakers/mime/digitigrade

/datum/outfit/digitigrade/clown
	name = "Clown Digitigrade"

	shoes = /obj/item/clothing/shoes/clown_shoes/digitigrade
