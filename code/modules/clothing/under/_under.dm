...
/obj/item/clothing/under/proc/break_sensors()
	...
	visible_message(span_danger("[src]'s medical sensors short out!"))
...
/obj/item/clothing/under/emp_act(severity)
	...
	if(severity <= EMP_HEAVY)
		...
		visible_message(span_warning("The [src]'s medical sensors flash and change rapidly!"), blind_message = span_warning("The [src] makes an electronic sizzling sound!"))
