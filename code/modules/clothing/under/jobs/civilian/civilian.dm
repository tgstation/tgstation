...
/obj/item/clothing/under/rank/civilian/head_of_personnel/mess_suit
	name = "head of personnel's mess kit"
	desc = "A mess kit uniform for the \"Head of Personnel\"."
	icon_state = "hop_mess_suit"
	inhand_icon_state = "b_suit"
	can_adjust = FALSE

/obj/item/clothing/under/rank/civilian/head_of_personnel/mess_skirt
	name = "head of personnel's skirt"
	desc = "A mess kit uniform for the \"Head of Personnel\"."
	icon_state = "hop_mess_skirt"
	inhand_icon_state = "b_suit"
	body_parts_covered = CHEST|GROIN|ARMS
	dying_key = DYE_REGISTRY_JUMPSKIRT
	female_sprite_flags = FEMALE_UNIFORM_TOP_ONLY
