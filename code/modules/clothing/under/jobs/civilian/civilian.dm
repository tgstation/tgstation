...
/obj/item/clothing/under/rank/civilian/head_of_personnel
	desc = "A slick uniform worn by those to earn the position of \"Second Captain\"."
	name = "second captain's uniform"
	icon_state = "hop"
	inhand_icon_state = "b_suit"

/obj/item/clothing/under/rank/civilian/head_of_personnel/skirt
	name = "second captain's skirt"
	desc = "A slick uniform and skirt combo worn by those to earn the position of \"Second Captain\"."
