/obj/item/clothing/under/plasmaman/captain
	...
	random_sensor = FALSE
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 95, ACID = 95, WOUND = 15)
...
/obj/item/clothing/under/plasmaman/security/head_of_security
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 95, ACID = 95, WOUND = 10)
	sensor_mode = 3
	random_sensor = FALSE
