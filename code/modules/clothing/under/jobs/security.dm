...
/obj/item/clothing/under/rank/security
	...
	armr = list(melee = 10, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0, fire = 30, acid = 30)
	strip_delay = 50
	alt_covers_chest = 1
...
/obj/item/clothing/under/rank/head_of_security
	...
	item_state = "r_suit"
	item_color = "rhos"
	armr = list(melee = 10, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0, fire = 50, acid = 50)
	strip_delay = 60
	alt_covers_chest = 1
	sensor_mode = 3
	random_sensor = 0
