...
/obj/item/clothing/under/rank/security
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 30, ACID = 30, WOUND = 10)
	strip_delay = 50
...
/obj/item/clothing/under/rank/security/head_of_security
	...
	icon_state = "rhos"
	inhand_icon_state = "r_suit"
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 50, ACID = 50, WOUND = 10)
	strip_delay = 60
