...
/obj/item/clothing/tie/storage/holster
	...
	icon_state = "holster"
	item_color = "holster"
	pockets = /obj/item/weapon/storage/internal/pocket/holster
	minimize_when_attached = TRUE

/obj/item/clothing/tie/storage/vest
	name = "webbing vest"
	desc = "Worn brownish vest with lots of pockets to unload your hands."
	icon_state = "vest_brown"
	item_color = "vest_brown"
	pockets = /obj/item/weapon/storage/internal/pocket/wide

/obj/item/clothing/tie/storage/vest/black
	desc = "Robust black vest with lots of pockets to hold whatever you need."
