...
/obj/item/clothing/shoes/magboots
	...
	var/magpulse = FALSE
	/// Slowdown applied when magpulse is active. This is added onto existing slowdown
...
/obj/item/clothing/shoes/magboots/attack_self(mob/user)
	...
	//we want to update our speed so we aren't running at max speed in regular magboots
