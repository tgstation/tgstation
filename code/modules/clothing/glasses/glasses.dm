...
/obj/item/clothing/glasses/regular/kick_act(mob/living/H) //Stomp on the sunglasses
	if(..()) return 1
...
/obj/item/clothing/glasses/sunglasses/kick_act(mob/living/H) //Stomp on the sunglasses
	if(..()) return 1
