...
/obj/item/clothing/suit/space/eva/plasmaman
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 100, ACID = 75)
...
/obj/item/clothing/head/helmet/space/plasmaman
	...
	clothing_flags = STOPSPRESSUREDAMAGE|THICKMATERIAL|SNUG_FIT|PLASMAMAN_HELMET_EXEMPT|PLASMAMAN_PREVENT_IGNITION|DISEASE_IMMUNITY
...
/obj/item/clothing/head/helmet/space/plasmaman/security
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, FIRE = 100, ACID = 75)
...
/obj/item/clothing/head/helmet/space/plasmaman/security/head_of_security
	...
	armor = list(MELEE = 20, BULLET = 10, LASER = 10, ENERGY = 10, BOMB = 10, FIRE = 100, ACID = 75, WOUND = 10)
