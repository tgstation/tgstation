...
/obj/item/clothing/suit/space/eva/plasmaman
	...
	// ARMOR TODO armor = list(BIO = 100, FIRE = 100, ACID = 75)
...
/obj/item/clothing/head/helmet/space/plasmaman/security
	...
	// ARMOR TODO armor = list(MELEE = 10, BIO = 100, FIRE = 100, ACID = 75)
...
/obj/item/clothing/head/helmet/space/plasmaman/security/head_of_security
	...
	inhand_icon_state = null
	// ARMOR TODO armor = list(MELEE = 20, BULLET = 10, LASER = 10, ENERGY = 10, BOMB = 10, BIO = 100, FIRE = 100, ACID = 75, WOUND = 10)
