...
/obj/item/clothing/head/helmet/space/hardsuit/engine/atmos
	...
	desc = "A modified engineering hardsuit for work in hazardous, low-pressure environments. The radiation shielding plates were removed to allow for improved thermal protection instead."
