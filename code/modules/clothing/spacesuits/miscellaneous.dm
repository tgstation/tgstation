...
Contains:
 ...
 - Pirate's spacesuit
 - ERT hardsuit: command, sec, engi, med, jani
 - EVA spacesuit
...
/obj/item/clothing/suit/space/hardsuit/ert/jani
	...
	desc = "The standard issue hardsuit of the ERT, this one has purple highlights. Offers superb protection against environmental hazards and has extra clips for holding various janitorial tools."
	icon_state = "ert_janitor"
	item_state = "ert_janitor"
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/ert/jani
	allowed = list(/obj/item/storage/bag/trash, /obj/item/melee/flyswatter, /obj/item/mop, /obj/item/holosign_creator/janibarrier, /obj/item/reagent_containers/glass/bucket)
