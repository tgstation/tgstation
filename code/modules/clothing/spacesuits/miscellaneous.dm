...
/obj/item/clothing/suit/space/captain
	...
	w_class = 4
	allowed_more = list(/obj/item/weapon/gun/energy, /obj/item/weapon/gun/projectile, /obj/item/ammo_box, /obj/item/ammo_casing, /obj/item/weapon/melee/baton,/obj/item/weapon/restraints/handcuffs)
	slowdown = 1
	armor = list(melee = 65, bullet = 50, laser = 50, energy = 25, bomb = 50, bio = 100, rad = 50)
...
/obj/item/clothing/suit/space/deathsquad
	...
	allowed_more = list(/obj/item/weapon/gun,/obj/item/ammo_box,/obj/item/ammo_casing,/obj/item/weapon/melee/baton,/obj/item/weapon/restraints/handcuffs)
	armor = list(melee = 80, bullet = 80, laser = 50,energy = 50, bomb = 100, bio = 100, rad = 100)
	slowdown = 1
	strip_delay = 130
	max_heat_protection_temperature = FIRE_IMMUNITY_HELM_MAX_TEMP_PROTECT
...
/obj/item/clothing/suit/space/nasavoid
	...
	slowdown = 1
	allowed_more = list(/obj/item/device/multitool)
...
/obj/item/clothing/suit/space/santa
	...
	slowdown = 0
	flags = STOPSPRESSUREDMAGE
	allowed_more = list(/obj/item) //for stuffing exta special presents
