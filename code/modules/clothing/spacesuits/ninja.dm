...
/obj/item/clothing/suit/space/space_ninja
	...
	var/reagent_list[] = list("doctorsdelight","dexalin","spaceacillin","antitoxin","nutriment","radium","potass_iodide")//The reagents ids which are added to the suit at New().
