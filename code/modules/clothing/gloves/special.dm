...
/obj/item/clothing/gloves/tinkerer
	...
	custom_materials = list(/datum/material/iron=MINERAL_MATERIAL_AMOUNT, /datum/material/silver=ROD_MATERIAL_AMOUNT*1.5, /datum/material/gold =ROD_MATERIAL_AMOUNT)
	resistance_flags = NONE
