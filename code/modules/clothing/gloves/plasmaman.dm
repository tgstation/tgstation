...
/obj/item/clothing/gloves/color/plasmaman/head_of_personnel
	name = "second captain's envirogloves"
	desc = "Covers up those scandalous, bony hands. Appears to be an attempt at making a replica of the other captain's gloves."
