...
/obj/item/clothing/head/HoS
	...
	icon_state = "hoscap"
	armor = list(melee = 45, bullet = 30, laser = 25, energy = 10, bomb = 25, bio = 10, rad = 0)
	strip_delay = 80
...
/obj/item/clothing/head/warden
	...
	armor = list(melee = 35, bullet = 5, laser = 25, energy = 10, bomb = 25, bio = 0, rad = 0)
	strip_delay = 60
...
/obj/item/clothing/head/beret/sec
	...
	armor = list(melee = 35, bullet = 25, laser = 25, energy = 10, bomb = 0, bio = 0, rad = 0)
	strip_delay = 60
