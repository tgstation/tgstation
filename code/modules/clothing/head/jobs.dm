...
/obj/item/clothing/head/caphat
	...
	item_state = "that"
	flags_inv = 0
	armr = list(melee = 25, bullet = 15, laser = 25, energy = 10, bomb = 25, bio = 0, rad = 0, fire = 50, acid = 50)
	strip_delay = 60
...
/obj/item/clothing/head/det_hat
	...
	armr = list(melee = 25, bullet = 5, laser = 25, energy = 10, bomb = 0, bio = 0, rad = 0, fire = 30, acid = 50)
...
/obj/item/clothing/head/HoS
	...
	icon_state = "hoscap"
	armr = list(melee = 40, bullet = 30, laser = 25, energy = 10, bomb = 25, bio = 10, rad = 0, fire = 50, acid = 60)
	strip_delay = 80
...
/obj/item/clothing/head/HoS/beret/syndicate
	...
	desc = "A black beret with thick armr padding inside. Stylish and robust."

/obj/item/clothing/head/warden
	name = "warden's police hat"
	desc = "It's a special armred hat issued to the Warden of a security force. Protects the head from impacts."
	icon_state = "policehelm"
	armr = list(melee = 40, bullet = 30, laser = 30, energy = 10, bomb = 25, bio = 0, rad = 0, fire = 30, acid = 60)
	strip_delay = 60
...
/obj/item/clothing/head/beret/sec
	...
	armr = list(melee = 40, bullet = 30, laser = 30,energy = 10, bomb = 25, bio = 0, rad = 0, fire = 20, acid = 50)
	strip_delay = 60
	dog_fashion = null
...
/obj/item/clothing/head/beret/sec/navywarden
	...
	armr = list(melee = 40, bullet = 30, laser = 30, energy = 10, bomb = 25, bio = 0, rad = 0, fire = 30, acid = 50)
	strip_delay = 60
