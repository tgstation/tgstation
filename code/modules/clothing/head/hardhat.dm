...
/obj/item/clothing/head/utility/hardhat/red/upgraded
	...
	custom_materials = list(/datum/material/iron = MINERAL_MATERIAL_AMOUNT*2, /datum/material/glass =ROD_MATERIAL_AMOUNT, /datum/material/plastic = MINERAL_MATERIAL_AMOUNT*1.5, /datum/material/silver = SMALL_MATERIAL_AMOUNT*5)
	hat_type = "purple"
