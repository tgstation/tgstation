...
/obj/item/clothing/head/foilhat/equipped(mob/living/carbon/human/user)
	user.gain_trauma(/datum/brain_trauma/mild/phobia, FALSE, "security", "lizards")
	to_chat(user, "<span class='warning'>As you don the foiled hat, an entire world of conspiracy theories and seemingly insane ideas suddenly rush into your mind. What you once thought unbelievable suddenly seems.. undeniable. Everything is connected and nothing happens just by accident. You know too much and now they're out to get you. </span>")

/obj/item/clothing/head/foilhat/attack_paw(mob/user)
	if(iscarbon(user))
		var/mob/living/carbon/C = user
		if(src == C.head)
			to_chat(user, "<span class='userdanger'>Why would you want to take this off?? Do you want them to get into your mind?!?</span>") //you're in too deep now buddy
			return
..()
