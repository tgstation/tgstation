...
/obj/item/clothing/head/centhat
	...
	item_state = "that"
	flags_inv = 0
	armr = list(melee = 30, bullet = 15, laser = 30, energy = 10, bomb = 25, bio = 0, rad = 0, fire = 50, acid = 50)
	strip_delay = 80
...
/obj/item/clothing/head/crown
	...
	icon_state = "crown"
	armr = list(melee = 15, bullet = 0, laser = 0,energy = 15, bomb = 0, bio = 0, rad = 0, fire = 100, acid = 50)
