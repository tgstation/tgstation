...
/obj/item/clothing/head/wig/update_icon_state()
	var/datum/sprite_accessory/hair/hair_style = ACCESSORIES.hairstyles_list[hairstyle]
	if(hair_style)
...
/obj/item/clothing/head/wig/worn_overlays(mutable_appearance/standing, isinhands = FALSE, file2use)
	...
	var/datum/sprite_accessory/hair/hair = ACCESSORIES.hairstyles_list[hairstyle]
	if(!hair)
		return
...
/obj/item/clothing/head/wig/attack_self(mob/user)
	var/new_style = tgui_input_list(user, "Select a hairstyle", "Wig Styling", ACCESSORIES.hairstyles_list - "Bald")
...
/obj/item/clothing/head/wig/random/Initialize(mapload)
	hairstyle = pick(ACCESSORIES.hairstyles_list - "Bald") //Don't want invisible wig
...
/obj/item/clothing/head/wig/natural/Initialize(mapload)
	hairstyle = pick(ACCESSORIES.hairstyles_list - "Bald")
	. = ..()
