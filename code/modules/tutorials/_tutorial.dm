...
/datum/tutorial/proc/animate_ui_element(icon_state, initial_screen_loc, target_screen_loc, animate_start_time)
	...
	var/matrix/origin_transform = TRANSLATE_MATRIX(origin_offsets[1] - ICONSIZE_X * 0.5, origin_offsets[2] - ICONSIZE_Y * 1.5)
	...
	var/matrix/animate_to_transform = TRANSLATE_MATRIX(target_offsets[1] - ICONSIZE_X * 1.5, target_offsets[2] - ICONSIZE_Y)
