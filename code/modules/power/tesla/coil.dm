...
/obj/machinery/power/tesla_coil/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		to_chat(user, "<span class='notice'>The status display reads: Power generation at [input_power_multiplier*100]%.<br>Shock interval at [zap_cooldown*0.1] seconds.<span>")
