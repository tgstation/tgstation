...
/obj/energy_ball/process()
	if(orbiting)
		...
		playsound(src.loc, 'sound/magic/lightningbolt.ogg', 100, TRUE, extrarange = 30, , pressure_affected = FALSE, ignore_walls = TRUE)
...
/obj/energy_ball/proc/handle_energy()
	if(energy >= energy_to_raise)
		...
		playsound(src.loc, 'sound/magic/lightning_chargeup.ogg', 100, TRUE, extrarange = 30, pressure_affected = FALSE, ignore_walls = TRUE)
