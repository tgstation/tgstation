...
/obj/machinery/light/update_overlays()
	...
	var/area/A = get_area(src)
	if(emergency_mode || (A?.fire))
		. += mutable_appearance(overlayicon, "[base_state]_emergency", layer, plane, dir)
		return
	if(nightshift_enabled)
		. += mutable_appearance(overlayicon, "[base_state]_nightshift", layer, plane, dir)
		return
	. += mutable_appearance(overlayicon, base_state, layer, plane, dir)
