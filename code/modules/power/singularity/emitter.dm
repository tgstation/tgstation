...
/obj/item/emitter_disk/stamina
	...
	desc = "This disk can be used on an emitter with an open panel to make it shoot lasers which will electrically disrupt the engine. The disk will be consumed in the process."
