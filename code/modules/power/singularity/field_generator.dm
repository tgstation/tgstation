...
field_generator power level display
   The icon used for the field_generator need to have 'FG_NUM_POWER_LEVELS' number of icon states
   named 'Field_Gen +p[num]' where 'num' ranges from 1 to 'FG_NUM_POWER_LEVELS'
...
/obj/machinery/field/generator/proc/check_power_level()
	var/new_level = round(FG_NUM_POWER_LEVELS * power / field_generator_max_power)
