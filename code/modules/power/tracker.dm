...
/obj/machinery/power/tracker/proc/set_control(obj/machinery/power/solar_control/SC)
	...
	sun_update(SSsun, SSsun.azimuth, SSsun.elevation)
...
/obj/machinery/power/tracker/proc/sun_update(datum/source, azimuth, elevation)
	setDir(angle2dir(azimuth))
	if(control)
		control.set_panels(azimuth, elevation)
