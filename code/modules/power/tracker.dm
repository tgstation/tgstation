...
/obj/machinery/power/tracker/attackby(var/obj/item/weapon/W, var/mob/user, params)
	...
	if(istype(W, /obj/item/weapon/crowbar))
		...
		user.visible_message("<span class='notice'>[user] begins to take the glass off the solar tracker.</span>", "<span class='notice'>You begin to take the glass off the solar tracker...</span>")
		if(do_after(user, 50))
			...
			user.visible_message("<span class='notice'>[user] takes the glass off the tracker.</span>", "<span class='notice'>You take the glass off the tracker.</span>")
			qdel(src)
		return
	..()
