/obj/item/device/antimatter/containment
...
/obj/item/device/antimatter/containment/ex_act(severity)
	switch(severity)
		if(1.0)
...
/obj/item/device/antimatter/containment/proc/usefuel(var/wanted)
	if(fuel < wanted)
		wanted = fuel
	fuel -= wanted
	return wanted