...
/obj/machinery/power/apc/update_icon()
	...
	if(update & 2)
		...
		if(!(machine_stat & (BROKEN|MAINT)) && update_state & UPSTATE_ALLGOOD)
			...
			SSvis_overlays.add_vis_overlay(src, icon, "apcox-[locked]", layer, EMISSIVE_OBJ_PLANE, dir)
			SSvis_overlays.add_vis_overlay(src, icon, "apco3-[charging]", layer, plane, dir)
			SSvis_overlays.add_vis_overlay(src, icon, "apco3-[charging]", layer, EMISSIVE_OBJ_PLANE, dir)
			if(operating)
				SSvis_overlays.add_vis_overlay(src, icon, "apco0-[equipment]", layer, plane, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco0-[equipment]", layer, EMISSIVE_OBJ_PLANE, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco1-[lighting]", layer, plane, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco1-[lighting]", layer, EMISSIVE_OBJ_PLANE, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco2-[environ]", layer, plane, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco2-[environ]", layer, EMISSIVE_OBJ_PLANE, dir)
