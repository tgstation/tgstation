...
/obj/machinery/power/apc/update_overlays()
	...
	. += mutable_appearance(icon, "apcox-[locked]", layer, plane, dir)
	. += mutable_appearance(icon, "apcox-[locked]", layer, EMISSIVE_PLANE, dir)
	. += mutable_appearance(icon, "apco3-[charging]", layer, plane, dir)
	. += mutable_appearance(icon, "apco3-[charging]", layer, EMISSIVE_PLANE, dir)
	if(!operating)
		return

	. += mutable_appearance(icon, "apco0-[equipment]", layer, plane, dir)
	. += mutable_appearance(icon, "apco0-[equipment]", layer, EMISSIVE_PLANE, dir)
	. += mutable_appearance(icon, "apco1-[lighting]", layer, plane, dir)
	. += mutable_appearance(icon, "apco1-[lighting]", layer, EMISSIVE_PLANE, dir)
	. += mutable_appearance(icon, "apco2-[environ]", layer, plane, dir)
	. += mutable_appearance(icon, "apco2-[environ]", layer, EMISSIVE_PLANE, dir)
