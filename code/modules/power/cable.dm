...
/obj/structure/cable
	name = "redstone dust"
	desc = "A highly conductive mineral dust used in the construction of hideously complicated devices such as computers, floating houses, and mechs."
