...
#define HYDROGEN_PLUOXIDE_HEAT_PENALTY -3
#define HALOCARBON_29_HEAT_PENALTY 8
...
#define HYDROGEN_PLUOXIDE_TRANSMIT_MODIFIER 15
#define HALOCARBON_29_TRANSMIT_MODIFIER 20
...
#define HYDROGEN_PLUOXIDE_HEAT_RESISTANCE 5
...
/obj/machinery/power/supermatter_crystal
	...
	var/list/gas_comp = list(
		...
		/datum/gas/healium = 0,
		/datum/gas/hydrogen_pluoxide = 0,
		/datum/gas/halocarbon_29 = 0,
	)
	...
	var/list/gas_trans = list(
		...
		/datum/gas/hydrogen_pluoxide = HYDROGEN_PLUOXIDE_TRANSMIT_MODIFIER,
		/datum/gas/halocarbon_29 = HALOCARBON_29_TRANSMIT_MODIFIER,
	)
	...
	var/list/gas_heat = list(
		...
		/datum/gas/hydrogen_pluoxide = HYDROGEN_PLUOXIDE_HEAT_PENALTY,
		/datum/gas/halocarbon_29 = HALOCARBON_29_HEAT_PENALTY,
	)
	...
	var/list/gas_resist = list(
		...
		/datum/gas/hydrogen_pluoxide = HYDROGEN_PLUOXIDE_HEAT_RESISTANCE,
	)
	...
	var/list/gas_powermix = list(
		...
		/datum/gas/healium = 1,
		/datum/gas/hydrogen_pluoxide = 1,
		/datum/gas/halocarbon_29 = 1,
	)
...
/obj/machinery/power/supermatter_crystal/process_atmos()
	...
	if(!removed || !removed.total_moles() || isspaceturf(T)) //we're in space or there is no gas to process
		...
		if(prob(gas_comp[/datum/gas/halocarbon_29]))
