...
/obj/machinery/power/supermatter_crystal/proc/count_down()
	...
	notify_ghosts("[src] has begun the delamination process!", source = src, header = "Meltdown Incoming", notify_flags = (NOTIFY_CATEGORY_DEFAULT | GHOST_NOTIFY_MAKE_ANNOUNCEMENT))
