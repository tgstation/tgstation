...
#define HYDROGEN_TRANSMIT_MODIFIER 25
...
#define HYDROGEN_HEAT_RESISTANCE 2
...
/obj/machinery/power/supermatter_crystal
	...
	var/list/gas_trans = list("PL" = PLASMA_TRANSMIT_MODIFIER, "O2" = OXYGEN_TRANSMIT_MODIFIER, "TRIT" = TRITIUM_TRANSMIT_MODIFIER, "PLX" = PLUOXIUM_TRANSMIT_MODIFIER, "BZ" = BZ_TRANSMIT_MODIFIER, "H2" = HYDROGEN_TRANSMIT_MODIFIER)
...
/obj/machinery/power/supermatter_crystal/process_atmos()
	...
	if(!removed || !removed.total_moles() || isspaceturf(T)) //we're in space or there is no gas to process
		...
		removed.assert_gases(/datum/gas/oxygen, /datum/gas/plasma, /datum/gas/carbon_dioxide, /datum/gas/nitrous_oxide, /datum/gas/nitrogen, /datum/gas/pluoxium, /datum/gas/tritium, /datum/gas/bz, /datum/gas/freon, /datum/gas/hydrogen)
		...
		gasmix_power_ratio = min(max(plasmacomp + o2comp + co2comp + tritiumcomp + bzcomp + h2comp - pluoxiumcomp - n2comp - freoncomp, 0), 1)
