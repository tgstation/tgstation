...
/obj/machinery/power/smes
	...
	/// TRUE = trying to charge, FALSE = not trying to charge
	var/input_attempt = TRUE
	/// TRUE = actually inputting, FALSE = not inputting
	var/inputting = TRUE
	/// amount of power the SMES tries to charge by
	...
	/// TRUE = trying to output, FALSE = not trying to output
	var/output_attempt = TRUE
	/// TRUE = actually outputting, FALSE = not outputting
	var/outputting = TRUE
	/// amount of power the SMES tries to output
