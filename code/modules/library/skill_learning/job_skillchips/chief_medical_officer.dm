/obj/item/skillchip/job/chief_medical_officer
	...
	activate_message = "<span class='notice'>You hear muffled screaming, flesh being sliced and burned, organs popping from their sockets... Hey, you know this one!</span>"
	deactivate_message = "<span class='notice'>You no longer have an unsettling knowledge of the inside of the (meta)human body.</span>"
