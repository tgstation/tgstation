/obj/item/skillchip/job/research_director
	...
	skill_icon = "dumbbell"
	activate_message = "<span class='notice'>You feel the urge to prove yourself in the upcoming Feats of Strength.</span>"
	deactivate_message = "<span class='notice'>You no care about the upcoming Feats of Strength, and are no longer clear on what they were in the first place.</span>"
