...
/obj/structure/bookcase/examine(mob/user)
	..()
	if(!anchored)
		to_chat(user, "<span class='info'>The <i>bolts</i> on the bottom are unsecured.</span>")
	if(anchored)
		to_chat(user, "<span class='info'>It's secured in place with <b>bolts</b>.</span>")
	switch(state)
		if(0)
			to_chat(user, "<span class='info'>There's a <b>small crack</b> visible on the back panel.</span>")
		if(1)
			to_chat(user, "<span class='info'>There's space inside for a <i>wooden</i> shelf.</span>")
		if(2)
			to_chat(user, "<span class='info'>There's a <b>small crack</b> visible on the shelf.</span>")
