...
/mob/living/carbon/proc/hallucinate(hal_type, specific) // specific is used to specify a particular hallucination
	...
	switch(hal_type)
		...
		if("fake_alert")
			...
			switch(alert_type)
				if("oxy")
					throw_alert("oxy", /obj/screen/alert_icon/oxy, override = TRUE)
				if("not_enough_tox")
					throw_alert("not_enough_tox", /obj/screen/alert_icon/not_enough_tox, override = TRUE)
				if("not_enough_co2")
					throw_alert("not_enough_co2", /obj/screen/alert_icon/not_enough_co2, override = TRUE)
				if("too_much_oxy")
					throw_alert("too_much_oxy", /obj/screen/alert_icon/too_much_oxy, override = TRUE)
				if("too_much_co2")
					throw_alert("too_much_co2", /obj/screen/alert_icon/too_much_co2, override = TRUE)
				if("tox_in_air")
					throw_alert("tox_in_air", /obj/screen/alert_icon/tox_in_air, override = TRUE)
				if("nutrition")
					if(prob(50))
						throw_alert("nutrition", /obj/screen/alert_icon/fat, override = TRUE)
					else
						throw_alert("nutrition", /obj/screen/alert_icon/starving, override = TRUE)
				if("weightless")
					throw_alert("weightless", /obj/screen/alert_icon/weightless, override = TRUE)
				if("fire")
					throw_alert("fire", /obj/screen/alert_icon/fire, override = TRUE)
				if("temp")
					if(prob(50))
						throw_alert("temp", /obj/screen/alert_icon/hot, 3, override = TRUE)
					else
						throw_alert("temp", /obj/screen/alert_icon/cold, 3, override = TRUE)
				if("pressure")
					if(prob(50))
						throw_alert("pressure", /obj/screen/alert_icon/highpressure, 2, override = TRUE)
					else
						throw_alert("pressure", /obj/screen/alert_icon/lowpressure, 2, override = TRUE)
				//BEEP BOOP I AM A ROBOT
				if("newlaw")
					throw_alert("newlaw", /obj/screen/alert_icon/newlaw, override = TRUE)
				if("locked")
					throw_alert("locked", /obj/screen/alert_icon/locked, override = TRUE)
				if("hacked")
					throw_alert("hacked", /obj/screen/alert_icon/hacked, override = TRUE)
				if("charge")
					throw_alert("charge",/obj/screen/alert_icon/emptycell, override = TRUE)
			SLEEP(rand(100,200))
