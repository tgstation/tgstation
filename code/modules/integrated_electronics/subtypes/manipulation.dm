...
/obj/item/integrated_circuit/manipulation/weapon_firing
	...
	lethal (TRUE) or stun (FALSE) modes. It uses the internal battery of the weapon itself, not the assembly."
	complexity = 20
...
/obj/item/integrated_circuit/manipulation/grabber
	...
	icon_state = "grabber"
	extended_desc = "This circuit accepts a reference to an object to be grabbed, and can store up to 10 objects. Modes: 1 to grab, 0 to eject the first object, and -1 to eject all objects."
	w_class = WEIGHT_CLASS_SMALL
	size = 3
	cooldown_per_use = 5
	complexity = 10
...
/obj/item/integrated_circuit/manipulation/thrower
	...
	projectile needs to be inside the machine, or on an adjacent tile, and must be medium sized or smaller."
	complexity = 25
	w_class = WEIGHT_CLASS_SMALL
	size = 2
	cooldown_per_use = 10
