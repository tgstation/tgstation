...
/obj/machinery/vending/wardrobe/sec_wardrobe
	...
	icon_state = "secdrobe"
	product_ads = "Избиение преступников со стилем!;Оно красное, поэтому крови видно не будет!;У вас есть право быть модным!;Теперь вы можете стать полицией моды, которой вы всегда хотели быть!"
	vend_reply = "Благодарим за использование SecDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/engi_wardrobe
	...
	product_ads = "Гарантированно защитит ваши ноги от несчастных случаев!;Боитесь радиации? Тогда носите желтое!"
	vend_reply = "Благодарим за использование EngiDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/cargo_wardrobe
	...
	product_ads = "Обновленный стиль ассистента! Подбери подходящую одежду уже сегодня!;Эти шорты удобны и просты в носке, получи свои сейчас!"
	vend_reply = "Благодарим за использование CargoDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/robo_wardrobe
	...
	product_ads = "Ты превратишь меня в TRUE, используй определения!;0110001101101100011011110111010001101000011001010111001101101000011001010111001001100101"
	vend_reply = "Благодарим за использование RoboDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/science_wardrobe
	...
	vend_reply = "Благодарим за использование SciDrobe!"
	products = list(
		/obj/item/clothing/accessory/pocketprotector = 3,
...
/obj/machinery/vending/wardrobe/hydro_wardrobe
	...
	icon_state = "hydrobe"
	product_ads = "Вы любите почву? Тогда покупайте нашу одежду!;Приобретайте вещи, соответствующие вашему большому зеленому пальцу, прямо здесь!"
	vend_reply = "Благодарим за использование Hydrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/coroner_wardrobe
	...
	product_ads = "Любой день на земле - хороший день!;Мой день начинается там, где заканчивается твой!;И они называют это гиблым бизнесом?!;Когда умрёшь, тогда и приходи!"
	vend_reply = "Не забывай про свою услугу по захоронению \"Купи одну - вторая в подарок!\"."
	products = list(
...
/obj/machinery/vending/wardrobe/bar_wardrobe
	...
	vend_reply = "Благодарим за использование BarDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/chef_wardrobe
	...
	product_ads = "Наша одежда гарантированно защитит вас от возможных пятен от пищи!"
	vend_reply = "Благодарим за использование ChefDrobe!"
	products = list(
		/obj/item/clothing/accessory/waistcoat = 2,
...
/obj/machinery/vending/wardrobe/law_wardrobe
	...
	icon_state = "lawdrobe"
	product_ads = "ПРОТЕСТУЮ! Добейтесь законности для самого себя!"
	vend_reply = "Благодарим за использование LawDrobe!"
...
/obj/machinery/vending/wardrobe/chap_wardrobe
	...
	product_ads = "Вас донимают культисты или надоедливые призраки? Тогда приходите и оденьтесь как священнослужитель!;Одежда для персон в рясе!"
	vend_reply = "Благодарим за использование DeusVend!"
	products = list(
...
/obj/machinery/vending/wardrobe/chem_wardrobe
	...
	product_ads = "Наша одежда на 0,5% более устойчива к воздействию кислот! Получите свою прямо сейчас!"
	vend_reply = "Благодарим за использование ChemDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/gene_wardrobe
	...
	vend_reply = "Благодарим за использование GeneDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/det_wardrobe
	...
	vend_reply = "Благодарим за использование DetDrobe!"
	products = list(
...
/obj/machinery/vending/wardrobe/cent_wardrobe
	...
	product_ads = "Покажите этим ОБР кто здесь самый стильный в зале совещаний!"
	vend_reply = "Благодарим за использование CentDrobe!"
	products = list(
