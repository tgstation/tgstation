	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/shoes/heels/custom = 4, // MONKESTATION EDIT ADDITION
			),
		),
		list(
			"name" = "Animals",
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/under/costume/playbunny/custom = 2, // MONKESTATION EDIT ADDITION
				/obj/item/clothing/neck/tie/bunnytie/custom = 2, // MONKESTATION EDIT ADDITION
				/obj/item/clothing/head/playbunnyears/custom = 2, // MONKESTATION EDIT ADDITION
				/obj/item/clothing/suit/jacket/tailcoat/custom = 2, // MONKESTATION EDIT ADDITION
			),
		),
		list(
			"name" = "Other",
