/obj/machinery/vending/autodrobe
	...
	contraband = list(
		...
		/obj/item/clothing/head/costume/Maid_Syndie_Headband = 1,
		/obj/item/clothing/mask/muzzle = 2,
		/obj/item/clothing/under/syndicate/syndimaid_Fake = 1,
		/obj/item/clothing/gloves/syndimaid_arms_fake = 1,
		/obj/item/clothing/accessory/maidapronsynd = 1,
