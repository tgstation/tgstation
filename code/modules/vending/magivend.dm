/obj/machinery/vending/magivend
	...
	contraband = list(/obj/item/reagent_containers/cup/bottle/wizarditis = 1) // No one can get to the machine to temporary solution it anyways; for the lulz - Microwave
