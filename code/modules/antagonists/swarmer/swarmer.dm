...
/mob/living/simple_animal/hostile/swarmer/proc/DisperseTarget(mob/living/target)
	...
	S.start()
	playsound(src,'sound/effects/sparks4.ogg',50,DEFAULT_SOUND_VARY)
...
/obj/effect/temp_visual/swarmer/disintegration/Initialize()
	. = ..()
	playsound(loc, "sparks", 100, DEFAULT_SOUND_VARY)
...
/obj/structure/swarmer/play_attack_sound(damage_amount, damage_type = BRUTE, damage_flag = 0)
	switch(damage_type)
		if(BRUTE)
			playsound(src, 'sound/weapons/egloves.ogg', 80, DEFAULT_SOUND_VARY)
		if(BURN)
...
/obj/structure/swarmer/trap/Crossed(atom/movable/AM)
	if(isliving(AM))
		...
		if(!istype(L, /mob/living/simple_animal/hostile/swarmer))
			playsound(loc,'sound/effects/snap.ogg',50, DEFAULT_SOUND_VARY, extra_range = -1)
...
/mob/living/simple_animal/hostile/swarmer/proc/CreateSwarmer()
	...
	if(do_mob(src, src, 100))
		...
		if(createtype && Fabricate(createtype, 50))
			playsound(loc,'sound/items/poster_being_created.ogg',50, DEFAULT_SOUND_VARY, extra_range = -1)
