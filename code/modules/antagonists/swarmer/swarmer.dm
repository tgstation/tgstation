...
/mob/living/simple_animal/hostile/swarmer
	...
	var/resources = ZERO //Resource points, generated by consuming metal/glass
...
/mob/living/simple_animal/hostile/swarmer/proc/Fabricate(atom/fabrication_object,fabrication_cost = ZERO)
	if(!isturf(loc))
...
/mob/living/simple_animal/hostile/swarmer/proc/DisperseTarget(mob/living/target)
	...
	S.set_up(4,ZERO,get_turf(target))
	S.start()
	playsound(src,'sound/effects/sparks4.ogg',50,TRUE)
	do_teleport(target, F, ZERO, channel = TELEPORT_CHANNEL_BLUESPACE)
...
/obj/structure/swarmer/play_attack_sound(damage_amount, damage_type = BRUTE, damage_flag = ZERO)
	switch(damage_type)
		if(BRUTE)
...
/obj/structure/swarmer/trap/Crossed(atom/movable/AM)
	if(isliving(AM))
		...
		if(!istype(L, /mob/living/simple_animal/hostile/swarmer))
			...
			L.electrocute_act(ZERO, src, 1, flags = SHOCK_NOGLOVES|SHOCK_ILLUSION)
			if(iscyborg(L))
				L.Paralyze(100)
			qdel(src)
	..()
