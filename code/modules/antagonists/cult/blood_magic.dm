	...
	if(IS_CULTIST(user))
		...
		if(target.can_block_magic())
			...
			if(issilicon(target))
				...
				carbon_target.add_speech_impediment(30 SECONDS, /datum/status_effect/speech/stutter)
				carbon_target.add_speech_impediment(30 SECONDS, /datum/status_effect/speech/slurring/cult)
