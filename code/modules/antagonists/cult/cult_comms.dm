...
/proc/pollCultists(mob/living/Nominee,datum/team/cult/team) //Cult Master Poll
	...
	var/list/yes_voters = SSpolling.poll_candidates("[Nominee] seeks to lead your cult, do you support [Nominee.p_them()]?", poll_time = 300, group = asked_cultists, pic_source = Nominee)
