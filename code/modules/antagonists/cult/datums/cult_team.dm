...
/datum/team/cult/proc/check_size()
	...
	if(ratio > CULT_RISEN && !cult_risen)
		for(var/datum/mind/mind as anything in members)
			if(mind.current)
				SEND_SOUND(mind.current, 'sound/instrumental/antag/bloodcult/bloodcult_eyes.ogg')
	...
	if(ratio > CULT_ASCENDENT && !cult_ascendent)
		for(var/datum/mind/mind as anything in members)
			if(mind.current)
				SEND_SOUND(mind.current, 'sound/instrumental/antag/bloodcult/bloodcult_halos.ogg')
