...
/obj/item/cult_bastard
	...
	attack_verb_continuous = list("cleaved", "slashed", "tore", "lacerated", "hacked", "ripped", "diced", "carved")
...
/obj/item/cult_spear
	...
	block_chance = 30
	attack_verb_continuous = list("attacked", "impaled", "stabbed", "tore", "lacerated", "gored")
...
/obj/item/shield/mirror
	...
	throw_range = 4
	w_class = WEIGHT_CLASS_BULKY
	attack_verb_continuous = list("bumped", "prodded")
