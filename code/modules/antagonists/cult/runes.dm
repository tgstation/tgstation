...
/obj/effect/rune/raise_dead/invoke(list/invokers)
	...
	if(!mob_to_revive.client || mob_to_revive.client.is_afk())
		...
		if(chosen_one)
			...
			fail_invoke()
			return
	SEND_SOUND(mob_to_revive, 'sound/instrumental/antag/bloodcult/bloodcult_gain.ogg')
...
/obj/effect/rune/apocalypse/invoke(list/invokers)
	...
	for(var/mob/living/M in GLOB.alive_mob_list)
		...
		if(ishuman(M))
			...
			images += A
			SEND_SOUND(M, pick(sound('sound/instrumental/antag/bloodcult/bloodcult_gain.ogg'),sound('sound/mobs/voice/ghost_whisper.ogg'),sound('sound/misc/ghosty_wind.ogg')))
		else
