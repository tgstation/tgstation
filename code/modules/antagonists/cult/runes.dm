...
/obj/effect/rune/convert/proc/do_sacrifice(mob/living/sacrificial, list/invokers)
	...
	if(sacrificial)
		if(iscyborg(sacrificial))
			playsound(sacrificial, 'sound/magic/disable_tech.ogg', 100, DEFAULT_SOUND_VARY)
			sacrificial.dust() //To prevent the MMI from remaining
		else
			playsound(sacrificial, 'sound/magic/disintegrate.ogg', 100, DEFAULT_SOUND_VARY)
			sacrificial.gib()
	return TRUE
...
/obj/effect/rune/teleport/proc/handle_portal(portal_type, turf/origin)
	...
	playsound(T, "sparks", 100, DEFAULT_SOUND_VARY, extra_range = 14)
...
/obj/effect/rune/manifest/invoke(var/list/invokers)
	...
	if(choice == "Summon a Cult Ghost")
		...
		ghosts++
		playsound(src, 'sound/magic/exit_blood.ogg', 50, DEFAULT_SOUND_VARY)
...
/obj/effect/rune/apocalypse/invoke(var/list/invokers)
	...
	playsound(T, 'sound/magic/enter_blood.ogg', 100, DEFAULT_SOUND_VARY)
