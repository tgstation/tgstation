...
/datum/antagonist/obsessed/greet()
	...
	to_chat(owner, "<B>The Voices will retaliate if you fail to complete your tasks. You MUST free yourself from this foreign presence in your head controlling you by following their orders.</B>")
