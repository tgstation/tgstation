...
/mob/living/simple_animal/revenant/Login()
	...
	if(!. || !client)
		return FALSE
	to_chat(src, span_revenbignotice("You are a revenant."))
	to_chat(src, span_revenboldnotice("Your formerly mundane spirit has been infused with alien energies and empowered into a revenant."))
	to_chat(src, span_revenboldnotice("You are not dead, not alive, but somewhere in between. You are capable of limited interaction with both worlds."))
	to_chat(src, span_revenboldnotice("You are invincible and invisible to everyone but other ghosts. Most abilities will reveal you, rendering you vulnerable."))
	to_chat(src, span_revenboldnotice("To function, you are to drain the life essence from humans. This essence is a resource, as well as your health, and will power all of your abilities."))
	to_chat(src, span_revenwarning("You do not remember anything of your past lives, nor will you remember anything about this one after your death."))
	to_chat(src, span_revenboldnotice("Be sure to read <a href=\"https://tgstation13.org/wiki/Revenant\">the wiki page</a> to learn more."))
