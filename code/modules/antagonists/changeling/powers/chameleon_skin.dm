...
/datum/action/changeling/chameleon_skin/sting_action(mob/living/carbon/human/cling) //SHOULD always be human, because req_human = TRUE
	..()
	if(is_active)
...
/datum/action/changeling/chameleon_skin/Remove(mob/living/carbon/human/cling)
	..()
	disable_ability(cling)
...
/datum/action/changeling/chameleon_skin/proc/eye_implanted(mob/living/source, obj/item/organ/gained, special)
	SIGNAL_HANDLER
...
/datum/action/changeling/chameleon_skin/proc/eye_removed(mob/living/source, obj/item/organ/removed, special)
	SIGNAL_HANDLER
