...
/obj/item/clothing/suit/space/changeling
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0,ENERGY = 0, BOMB = 0, FIRE = 90, ACID = 90) //No armor at all.
	actions_types = list()
	cell = null
	show_hud = FALSE
...
/obj/item/clothing/suit/armor/changeling
	...
	armor = list(MELEE = 40, BULLET = 40, LASER = 40, ENERGY = 50, BOMB = 10, FIRE = 90, ACID = 90)
