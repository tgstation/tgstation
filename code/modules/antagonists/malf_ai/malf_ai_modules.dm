...
/datum/action/innate/ai/ranged/remote_vendor_tilt/do_ability(mob/living/caller, atom/clicked_on)
	...
	var/picked_dir_string = show_radial_menu(ai_caller, clicked_vendor, SStransport.all_radial_directions, custom_check = CALLBACK(src, PROC_REF(radial_check), caller, clicked_vendor))
