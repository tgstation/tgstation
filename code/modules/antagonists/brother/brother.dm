...
/datum/antagonist/brother/get_preview_icon()
	...
	brother1_icon.Blend(icon('icons/turf/floor_overlays/viscera.dmi', "maskblood"), ICON_OVERLAY)
	brother1_icon.Shift(WEST, 8)

	var/icon/brother2_icon = render_preview_outfit(/datum/outfit/job/scientist/consistent, brother2)
	brother2_icon.Blend(icon('icons/turf/floor_overlays/viscera.dmi', "uniformblood"), ICON_OVERLAY)
