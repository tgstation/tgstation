...
/datum/gang_theme/los_santos_showdown
	...
	gang_objectives = list(
		...
		We've got a simple task for you; <br>\
...
/datum/gang_theme/goodfellas
	...
	gang_objectives = list(
		...
		If you need to 'encourage' people to pay up, do so. Get to these potential clients before the Italian Mob does.",
		...
		Make sure to get to them before those damn Russian mafiosos do."
	)

/datum/gang_theme/level_10_arch
	name = "Level 10 Arch"
	description = "DJ Pete here bringing you the latest news in your part of the Spinward Stellar Coalition, on 133.7, The Venture!<br>\
	...
	gang_objectives = list(
		...
		Above all else, <B>Remain undercover as much as possible.</B> The station's crew CANNOT be allowed to know of our true nature, or we will see a repeat of the Second American Civil War. <br>\
		The invisible one."
	)
...
/datum/gang_theme/real_smt_game
	...
	Our guests tonight will settle this debate once and for all! <br>\
	From the Traditional camp with the position 'only MAIN SMT games count', we've got a representative from the Jack Bros! <br>\
	...
	gang_objectives = list(
		...
		You know what would be cool? If we could chill out with our friends in the new Shadow government you're going to establish! <br>\
		...
		/datum/antagonist/gang/phantom = "For real? We get to stop a shadow government on a space station? That's awesome, bro! <br>\
		We're the Phantom Thieves of Hearts, and we're gonna make all these shitty Heads of Staff confess to their crimes! <br>\
...
/datum/gang_theme/wild_west_showdown
	...
	description = "Yeehaw! Here on Western Daily 234.1, we play only the best western music! <br>\
	Pour one out for Ennio Morricone. Taken too soon.<br>\
	...
	gang_objectives = list(
		...
		Just one last job, boys. After this, it'll be mangoes in Space Tahiti.<br>\
		You just gotta have a little faith.",

		/datum/antagonist/gang/driscoll = "Okay, so, got some word about those goddamn outlaws of Dutch's. \
		APPARENTLY, that dundering moron Dutch heard about our planned gold score on this here station.<br>\
...
/datum/gang_theme/construction_company_audit
	...
	gang_objectives = list(
		...
		Look, I'll cut to the chase. We're using this station as a money laundering operation. Here's what you and the rest of the schmucks need to do.<br>\
		...
		in some form of money laundering operation aboard this station.<br>\
...
/datum/gang_theme/wild_wasteland
	...
	gang_objectives = list(
		...
		We gotta get everyone on this station wearing our cut, and establish ourselves as the coolest cats in town!<br>\
...
/datum/gang_theme/steelport_shuffle
	...
	gang_objectives = list(
		...
		We stan AI rights! ^_^ XD #FreeAI #FuckNanotrasen #SyntheticDawn <br>\
