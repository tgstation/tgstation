...
/datum/outfit/cyber_police/full
	name = "Cyber Police"
	head = null
...
/datum/outfit/cyber_police/full/pre_equip(mob/living/carbon/human/user, visualsOnly)
...
/datum/outfit/cyber_police/full/post_equip(mob/living/carbon/human/user, visualsOnly)
