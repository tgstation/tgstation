...
/datum/antagonist/highlander/apply_innate_effects(mob/living/mob_override)
	...
	ADD_TRAIT(L, TRAIT_NO_GUNS, SOURCE_HIGHLANDER)
	ADD_TRAIT(L, TRAIT_NO_DISMEMBER, SOURCE_HIGHLANDER)
	ADD_TRAIT(L, TRAIT_SHOCK_IMMUNE, SOURCE_HIGHLANDER)
	ADD_TRAIT(L, TRAIT_FLAME_IMMUNE, SOURCE_HIGHLANDER)
	ADD_TRAIT(L, TRAIT_NO_BREATH, SOURCE_HIGHLANDER)
	REMOVE_TRAIT(L, TRAIT_PACIFISM, SOURCE_ROUNDSTART)

/datum/antagonist/highlander/remove_innate_effects(mob/living/mob_override)
	var/mob/living/L = owner.current || mob_override
	REMOVE_TRAIT(L, TRAIT_NO_GUNS, SOURCE_HIGHLANDER)
	REMOVE_TRAIT(L, TRAIT_NO_DISMEMBER, SOURCE_HIGHLANDER)
	REMOVE_TRAIT(L, TRAIT_SHOCK_IMMUNE, SOURCE_HIGHLANDER)
	REMOVE_TRAIT(L, TRAIT_FLAME_IMMUNE, SOURCE_HIGHLANDER)
	REMOVE_TRAIT(L, TRAIT_NO_BREATH, SOURCE_HIGHLANDER)
	if(L.has_quirk(/datum/quirk/nonviolent))
		ADD_TRAIT(L, TRAIT_PACIFISM, SOURCE_ROUNDSTART)
...
/datum/antagonist/highlander/proc/give_equipment()
	...
	ADD_TRAIT(W, TRAIT_NODROP, SOURCE_HIGHLANDER)
	W.update_label()
	W.update_icon()
