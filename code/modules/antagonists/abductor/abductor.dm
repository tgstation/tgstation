...
/datum/antagonist/abductor/scientist/on_gain()
	owner.add_traits(list(TRAIT_ABDUCTOR_SCIENTIST_TRAINING, TRAIT_SURGEON, TRAIT_SURGICAL_TRAINING), ABDUCTOR_ANTAGONIST)
	return ..()

/datum/antagonist/abductor/scientist/on_removal()
	owner.remove_traits(list(TRAIT_ABDUCTOR_SCIENTIST_TRAINING, TRAIT_SURGEON, TRAIT_SURGICAL_TRAINING), ABDUCTOR_ANTAGONIST)
	return ..()
