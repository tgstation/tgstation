...
/obj/item/melee/touch_attack/mansus_fist/proc/on_mob_hit(mob/living/hit, mob/living/heretic)
	...
	if(iscarbon(hit))
		...
		carbon_hit.add_timed_status_effect(4 SECONDS, /datum/status_effect/speech/slurring/heretic)
	...
	while(carbon_user.stat == CONSCIOUS)
		...
		if(prob(70))
			...
			if(prob(50))
				...
				carbon_user.add_timed_status_effect(26 SECONDS, /datum/status_effect/speech/stutter)
