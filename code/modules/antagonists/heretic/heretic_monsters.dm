...
/datum/antagonist/heretic_monster/proc/set_owner(datum/mind/master)
	...
	to_chat(owner, span_boldnotice("You are a [ishuman(owner.current) ? "shambling corpse":"horrible creation"] brought to this plane through the Gates of the Mansus."))
