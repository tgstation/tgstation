...
/datum/heretic_knowledge/summon/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob("Do you want to play as a [summoned.real_name]?", jobban = ROLE_HERETIC, poll_time = 10 SECONDS, target_mob = summoned, pic_source = /obj/item/book, role_name_text = "heretic summon")
