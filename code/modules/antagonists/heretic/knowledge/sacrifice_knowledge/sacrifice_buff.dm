...
/datum/status_effect/unholy_determination/on_apply()
	ADD_TRAIT_LIST(owner, list(TRAIT_COAGULATING, TRAIT_NOCRITDAMAGE, TRAIT_NOSOFTCRIT), type)
	return TRUE

/datum/status_effect/unholy_determination/on_remove()
	REMOVE_TRAIT_LIST(owner, list(TRAIT_COAGULATING, TRAIT_NOCRITDAMAGE, TRAIT_NOSOFTCRIT), type)
