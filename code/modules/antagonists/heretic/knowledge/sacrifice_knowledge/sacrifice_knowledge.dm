...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/return_target(mob/living/carbon/human/sac_target)
	...
	sac_target.add_timed_status_effect(40 SECONDS, /datum/status_effect/speech/slurring/heretic)
	sac_target.add_timed_status_effect(40 SECONDS, /datum/status_effect/speech/stutter)
