...
/datum/heretic_knowledge/limited_amount/starting/base_cosmic
	...
	gain_text = "A nebula appeared in the sky, its infernal births shone onto me, this was the start of a great transcendence."
...
/datum/heretic_knowledge/cosmic_grasp
	...
	gain_text = "Some stars dimmed, other's magnitude increased. With newfound strength I could channel the nebula's power into myself."
...
/datum/heretic_knowledge/spell/cosmic_runes
	...
	gain_text = "A sigil appeared below me, I lowered my face to it and heard distant roars, I flung myself in and saw a beast behind dense clouds of gas."
	next_knowledge = list(
