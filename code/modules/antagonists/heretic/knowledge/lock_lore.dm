...
/datum/heretic_knowledge/key_ring
	...
	desc = "Позволяет создать Мистическую карту. \
	...
	transmute_text = "Трансмутируйте кошелёк, железный прут и ID-карту."
...
/datum/heretic_knowledge/limited_amount/concierge_rite
	...
	desc = "Позволяет создать Справочник лабиринта. \
...
/datum/heretic_knowledge/armor/lock
	...
	desc = "Позволяет создать Меняющийся облик. \
	...
	transmute_text = "Трансмутируйте стол (или комбинезон), маску и монтировку."
...
/datum/heretic_knowledge/ultimate/lock_final
	...
	transmute_text = "Трансмутируйте три трупа без органов в их торсе."
