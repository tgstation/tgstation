...
/proc/generate_global_heretic_tree()
	...
	for(var/heretic_path as anything in subtypesof(/datum/heretic_knowledge_tree_column))
		var/datum/heretic_knowledge_tree_column/heretic_route = new heretic_path()
