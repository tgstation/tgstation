...
/datum/heretic_knowledge/limited_amount/flesh_ghoul/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	if(!soon_to_be_ghoul.mind || !soon_to_be_ghoul.client)
		...
		var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob("Do you want to play as a [soon_to_be_ghoul.real_name], a voiceless dead?", role = ROLE_HERETIC, jobban = ROLE_HERETIC, poll_time = 5 SECONDS, target_mob = soon_to_be_ghoul, pic_source = /obj/item/food/grown/poppy, role_name_text = "voiceless dead")
