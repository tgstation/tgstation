...
/datum/antagonist/space_dragon/greet()
	...
	to_chat(owner, "<span class='boldwarning'>You have five minutes to find a safe location to place down the rift.  If you take longer than five minutes to place a rift, you will be returned from whence you came.</span>")
