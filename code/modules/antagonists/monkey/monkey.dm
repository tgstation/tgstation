	...
	switch(get_result())
		if(MONKEYS_ESCAPED)
			...
			parts += {"<span class='greentext big'><B>Monkey Major Victory!</B></span>
				<span class='greentext'><B>Central Command and [station_name()] were taken over by the monkeys! Ook ook!</B></span>"}
			
		if(MONKEYS_LIVED)

			parts += {"<FONT size = 3><B>Monkey Minor Victory!</B></FONT>
				<span class='greentext'><B>[station_name()] was taken over by the monkeys! Ook ook!</B></span>"}
