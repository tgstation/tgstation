...
/mob/camera/ghostmaster/proc/check_death(datum/source,mob/M,gibbed)
...
/mob/camera/ghostmaster/Hear(message, atom/movable/speaker, message_language, raw_message, radio_freq, list/spans, message_mode)
	. = ..()
	if(!client)
		return
