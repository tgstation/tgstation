...
/obj/item/melee/sickly_blade/update_overlays()
	...
	for(var/incantation in user_knowledge)
		...
		if(initial(incantation.name) == initial(/datum/eldritch_knowledge/void_blade_upgrade.name))
			. += "seeking_blade"
			break
...
/obj/item/melee/sickly_blade/update_appearance()
	...
	for(var/incantation in user_knowledge)
		...
		if(initial(incantation.name) == initial(/datum/eldritch_knowledge/rust_blade_upgrade.name))
			underlays += "toxic_blade"
			break

		if(initial(incantation.name) == initial(/datum/eldritch_knowledge/flesh_blade_upgrade.name))
			underlays += "bleeding_steel"
			break
