...
/datum/eldritch_knowledge/curse/corrosion
	...
	desc = "Curse someone for 2 minutes of vomiting and major organ damage. Using a wirecutter, a pool of blood, a heart and an item that the victim touched  with their bare hands."
	cost = 1
