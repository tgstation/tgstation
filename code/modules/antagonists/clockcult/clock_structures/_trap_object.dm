...
/obj/structure/destructible/clockwork/trap/wrench_act(mob/living/user, obj/item/tool)
...
/obj/structure/destructible/clockwork/trap/wirecutter_act(mob/living/user, obj/item/tool)
	if(!is_servant_of_ratvar(user))
		return
	if(!wired_to.len)
