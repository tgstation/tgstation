...
//chumbiswork marauder: A well-rounded frontline construct. Only one can exist for every two human servants.
/mob/living/simple_animal/hostile/chumbiswork/marauder
	name = "chumbiswork marauder"
	desc = "The stalwart apparition of a soldier, blazing with crimson flames. It's armed with a gladius and shield."
	icon_state = "chumbiswork_marauder"
	health = 120
	maxHealth = 120
	force_threshold = 8
	speed = 0
	...
	loot = list(/obj/item/chumbiswork/component/geis_capacitor/fallen_armor)
	light_range = 2
	light_power = 1.1
	playstyle_string = "<span class='big bold'><span class='neovgre'>You are a chumbiswork marauder,</span></span><b> a well-rounded frontline construct of Ratvar. Although you have no \
...
/mob/living/simple_animal/hostile/chumbiswork/marauder/examine_info()
	if(!shield_health)
		return "<span class='warning'>Its shield has been destroyed!</span>"

/mob/living/simple_animal/hostile/chumbiswork/marauder/Life()
	..()
...
/mob/living/simple_animal/hostile/chumbiswork/marauder/update_values()
...
/mob/living/simple_animal/hostile/chumbiswork/marauder/death(gibbed)
...
/mob/living/simple_animal/hostile/chumbiswork/marauder/Process_Spacemove(movement_dir = 0)
	return TRUE

/mob/living/simple_animal/hostile/chumbiswork/marauder/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	if(amount > 0)
...
/mob/living/simple_animal/hostile/chumbiswork/marauder/bullet_act(obj/item/projectile/P)
	if(deflect_projectile(P))
		return
	return ..()

/mob/living/simple_animal/hostile/chumbiswork/marauder/proc/deflect_projectile(obj/item/projectile/P)
	if(!shield_health)
		return
