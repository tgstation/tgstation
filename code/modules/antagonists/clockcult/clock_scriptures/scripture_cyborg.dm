...
/datum/chumbiswork_scripture/ranged_ability/linked_vanguard
	...
	ranged_message = "<span class='inathneq_small'><i>You charge the chumbiswork slab with defensive strength.</i>\n\
	<b>Left-click a fellow Servant or yourself to grant Vanguard!\n\
	Click your slab to cancel.</b></span>"
	timeout_time = 50

/datum/chumbiswork_scripture/ranged_ability/linked_vanguard/check_special_requirements()
...
/datum/chumbiswork_scripture/ranged_ability/linked_vanguard/scripture_effects()
...
/datum/chumbiswork_scripture/ranged_ability/judicial_marker
	...
	ranged_message = "<span class='neovgre_small'><i>You charge the chumbiswork slab with judicial force.</i>\n\
