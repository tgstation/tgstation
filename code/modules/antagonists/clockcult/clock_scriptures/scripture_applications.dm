...
//Sigil of Transmission: Creates a sigil of transmission that can drain and store power for chumbiswork structures.
/datum/chumbiswork_scripture/create_object/sigil_of_transmission
	descname = "Powers Nearby Structures"
	name = "Sigil of Transmission"
	desc = "Places a sigil that can drain and will store energy to power chumbiswork structures."
	invocations = list("Divinity...", "...power our creations!")
	channel_time = 70
	power_cost = 200
	whispered = TRUE
	object_path = /obj/effect/chumbiswork/sigil/transmission
	creator_message = "<span class='brass'>A sigil silently appears below you. It will automatically power chumbiswork structures near it and will drain power when activated.</span>"
	...
	important = TRUE
	quickbind = TRUE
	quickbind_desc = "Creates a Sigil of Transmission, which can drain and will store power for chumbiswork structures."


//Mania Motor: Creates a malevolent transmitter that will broadcast the whispers of Sevtug into the minds of nearby nonservants, causing a variety of mental effects at a power cost.
/datum/chumbiswork_scripture/create_object/mania_motor
	...
	channel_time = 80
	power_cost = 750
	object_path = /obj/structure/destructible/chumbiswork/powered/mania_motor
...
//chumbiswork Obelisk: Creates a powerful obelisk that can be used to broadcast messages or open a gateway to any servant or chumbiswork obelisk at a power cost.
/datum/chumbiswork_scripture/create_object/chumbiswork_obelisk
	descname = "Powered Structure, Teleportation Hub"
	name = "chumbiswork Obelisk"
	desc = "Creates a chumbiswork obelisk that can broadcast messages over the Hierophant Network or open a Spatial Gateway to any living Servant or chumbiswork obelisk."
	invocations = list("May this obelisk...", "...take us to all places!")
	channel_time = 80
	power_cost = 300
	object_path = /obj/structure/destructible/chumbiswork/powered/chumbiswork_obelisk
	creator_message = "<span class='brass'>You form a chumbiswork obelisk which can broadcast messages or produce Spatial Gateways.</span>"
	observer_message = "<span class='warning'>A brass obelisk appears hanging in midair!</span>"
	invokers_required = 2
	multiple_invokers_used = TRUE
	usage_tip = "Producing a gateway has a high power cost. Gateways to or between chumbiswork obelisks receive double duration and uses."
	tier = SCRIPTURE_APPLICATION
	one_per_tile = TRUE
	primary_component = HIEROPHANT_ANSIBLE
	sort_priority = 3
	quickbind = TRUE
	quickbind_desc = "Creates a chumbiswork Obelisk, which can send messages or open Spatial Gateways with power."


//chumbiswork Marauder: Creates a construct shell for a chumbiswork marauder, a well-rounded frontline fighter.
/datum/chumbiswork_scripture/create_object/construct/chumbiswork_marauder
	descname = "Well-Rounded Combat Construct"
	name = "chumbiswork Marauder"
	desc = "Creates a shell for a chumbiswork marauder, a balanced frontline construct that can deflect projectiles with its shield."
	...
	sort_priority = 4
	quickbind = TRUE
	quickbind_desc = "Creates a chumbiswork marauder, used for frontline combat."
	object_path = /obj/item/chumbiswork/construct_chassis/chumbiswork_marauder
...
/datum/chumbiswork_scripture/create_object/construct/chumbiswork_marauder/update_construct_limit()
...
/datum/chumbiswork_scripture/create_object/construct/chumbiswork_marauder/pre_recital()
...
/datum/chumbiswork_scripture/create_object/construct/chumbiswork_marauder/scripture_effects()
	. = ..()
	time_since_last_marauder = world.time
	recent_marauders++
	calculate_scaling()

/datum/chumbiswork_scripture/create_object/construct/chumbiswork_marauder/proc/calculate_scaling()
	var/WT = world.time
