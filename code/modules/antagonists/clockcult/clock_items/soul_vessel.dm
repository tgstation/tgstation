...
/obj/item/mmi/posibrain/soul_vessel/attack(mob/living/target, mob/living/carbon/human/user)
	...
	playsound(H, 'sound/misc/splort.ogg', 60, DEFAULT_SOUND_VARY, extra_range = -1)
	playsound(H, 'sound/magic/clockwork/anima_fragment_attack.ogg', 40, DEFAULT_SOUND_VARY, extra_range = -1)
