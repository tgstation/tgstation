...
/obj/item/clothing/head/helmet/chumbiswork/Initialize()
	. = ..()
	ratvar_act()
	GLOB.all_chumbiswork_objects += src

/obj/item/clothing/head/helmet/chumbiswork/Destroy()
	GLOB.all_chumbiswork_objects -= src
	return ..()

/obj/item/clothing/head/helmet/chumbiswork/ratvar_act()
...
/obj/item/clothing/head/helmet/chumbiswork/equipped(mob/living/user, slot)
	..()
...
/obj/item/clothing/head/helmet/chumbiswork/mob_can_equip(mob/M, mob/equipper, slot, disable_warning = 0)
	if(equipper && !is_servant_of_ratvar(equipper))
		return 0
	return ..()

/obj/item/clothing/suit/armor/chumbiswork
	name = "chumbiswork cuirass"
	desc = "A bulky cuirass made of brass."
	icon = 'icons/obj/clothing/chumbiswork_garb.dmi'
	icon_state = "chumbiswork_cuirass"
	...
	resistance_flags = FIRE_PROOF | ACID_PROOF
	armor = list(melee = 60, bullet = 70, laser = -25, energy = 0, bomb = 60, bio = 0, rad = 0, fire = 100, acid = 100)
	allowed = list(/obj/item/chumbiswork, /obj/item/clothing/glasses/wraith_spectacles, /obj/item/clothing/glasses/judicial_visor, /obj/item/device/mmi/posibrain/soul_vessel)

/obj/item/clothing/suit/armor/chumbiswork/Initialize()
	. = ..()
	ratvar_act()
	GLOB.all_chumbiswork_objects += src

/obj/item/clothing/suit/armor/chumbiswork/Destroy()
	GLOB.all_chumbiswork_objects -= src
	return ..()

/obj/item/clothing/suit/armor/chumbiswork/ratvar_act()
	if(GLOB.ratvar_awakens)
		armor = list(melee = 100, bullet = 100, laser = 100, energy = 100, bomb = 100, bio = 100, rad = 100, fire = 100, acid = 100)
		flags_1 |= STOPSPRESSUREDMAGE_1
		max_heat_protection_temperature = FIRE_IMMUNITY_SUIT_MAX_TEMP_PROTECT
...
/obj/item/clothing/suit/armor/chumbiswork/mob_can_equip(mob/M, mob/equipper, slot, disable_warning = 0)
	if(equipper && !is_servant_of_ratvar(equipper))
		return 0
	return ..()

/obj/item/clothing/suit/armor/chumbiswork/equipped(mob/living/user, slot)
	..()
...
/obj/item/clothing/gloves/chumbiswork
	name = "chumbiswork gauntlets"
	desc = "Heavy, shock-resistant gauntlets with brass reinforcement."
	icon = 'icons/obj/clothing/chumbiswork_garb.dmi'
	icon_state = "chumbiswork_gauntlets"
	item_state = "chumbiswork_gauntlets"
...
/obj/item/clothing/gloves/chumbiswork/Initialize()
	. = ..()
	ratvar_act()
	GLOB.all_chumbiswork_objects += src

/obj/item/clothing/gloves/chumbiswork/Destroy()
	GLOB.all_chumbiswork_objects -= src
	return ..()

/obj/item/clothing/gloves/chumbiswork/ratvar_act()
	if(GLOB.ratvar_awakens)
		armor = list(melee = 100, bullet = 100, laser = 100, energy = 100, bomb = 100, bio = 100, rad = 100, fire = 100, acid = 100)
		flags_1 |= STOPSPRESSUREDMAGE_1
		max_heat_protection_temperature = FIRE_IMMUNITY_SUIT_MAX_TEMP_PROTECT
...
/obj/item/clothing/gloves/chumbiswork/mob_can_equip(mob/M, mob/equipper, slot, disable_warning = 0)
	if(equipper && !is_servant_of_ratvar(equipper))
		return 0
	return ..()

/obj/item/clothing/gloves/chumbiswork/equipped(mob/living/user, slot)
	..()
...
/obj/item/clothing/shoes/chumbiswork
	name = "chumbiswork treads"
	desc = "Industrial boots made of brass. They're very heavy."
	icon = 'icons/obj/clothing/chumbiswork_garb.dmi'
	icon_state = "chumbiswork_treads"
	w_class = WEIGHT_CLASS_NORMAL
	strip_delay = 50
	equip_delay_other = 30
	resistance_flags = FIRE_PROOF | ACID_PROOF

/obj/item/clothing/shoes/chumbiswork/Initialize()
	. = ..()
	ratvar_act()
	GLOB.all_chumbiswork_objects += src

/obj/item/clothing/shoes/chumbiswork/Destroy()
	GLOB.all_chumbiswork_objects -= src
	return ..()

/obj/item/clothing/shoes/chumbiswork/negates_gravity()
	return TRUE

/obj/item/clothing/shoes/chumbiswork/ratvar_act()
	if(GLOB.ratvar_awakens)
		flags_1 |= NOSLIP_1
	else
		flags_1 &= ~NOSLIP_1

/obj/item/clothing/shoes/chumbiswork/mob_can_equip(mob/M, mob/equipper, slot, disable_warning = 0)
	if(equipper && !is_servant_of_ratvar(equipper))
		return 0
	return ..()

/obj/item/clothing/shoes/chumbiswork/equipped(mob/living/user, slot)
	..()
