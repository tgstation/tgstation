	...
	switch(section)
		...
		if("Getting Started")
			...
			dat += {"<font color=#BE8700 size=3>Getting Started</font><br><br>
				Welcome, Servant! This section houses the utmost basics of being a Servant of Ratvar, and is much more informal than the other sections. Being a Servant of
			...
			If you aren't willing or don't have the time to read through every section, you can still help your teammates! Ask if they've set up a base. If they have, head there
			...
			Once you have a base up and running, contact your fellows and let them know. You should come back here often to drop off the slab's components, and your fellows
			should do the same, either in this cache or in ones of their own.<br><br>"
			If you think you're confident in taking further steps to help the cult, feel free to move onto the other sections. If not, let your allies know that you're new and
			...
			For now, welcome! If you're looking to learn, you should start with the <b>Basics</b> section, then move onto <b>Components</b> and <b>Scripture</b>. At the very
		...
		if("Basics")
			...
			dat += {"<font color=#BE8700 size=3>Servant Basics</font><br><br>
				The first thing any Servant should know is their slab, inside and out. The clockwork slab is by far your most important tool. It allows you to speak with your
			...
			As a Servant of Ratvar, the tools you are given focus around building and maintaining bases and outposts. A great deal of your power comes from stationary
			...
			Because of how complex being a Servant is, it isn't possible to fit much information into this section. It's highly recommended that you read the <b>Components</b>
		...
		if("Components")
			...
			dat += {"<font color=#BE8700 size=3>Components & Their Uses</font><br><br>
				...
				Although this is a good rule of thumb, their effects become much more nuanced when used together. For instance, a turret might have both belligerent eyes and
				vanguard cogwheels as construction requirements, because it defends its allies by harming its enemies.<br><br>"
				Components' primary use is fueling <b>scripture</b> (covered in its own section), and they can be created through various ways. This clockwork slab, for instance,
				...
				Your slab has an internal storage of components, but it isn't meant to be the main one. Instead, there's a <b>global storage</b> of components that can be
		...
		if("Scripture")
			...
			dat += {"<font color=#BE8700 size=3>The Ancient Scripture</font><br><br>
				If you have experience with the Nar-Sian cult (or the "blood cult") then you will know of runes. They are the manifestations of the Geometer's power, and where most
				...
				Each piece of scripture has widely-varying effects. Your most important scripture, <i>Geis</i>, is obvious and suspicious, but charges your slab with energy and allows
				...
				Any given piece of scripture has a component cost listed in its "Recite" button. The acronyms for the components should be obvious if you've read about components
				...
				It should also be noted that some scripture cannot be recited alone. Especially with more powerful scripture, you may need multiple Servants to recite a piece of
				...
				Finally, scripture is separated into three "tiers" based on power: Drivers, Scripts, and Applications.
				You can view the requirements to unlock each tier in its scripture list. Once a tier is unlocked, it's unlocked permanently; the cult only needs to fill the
				requirement for unlocking a tier once!<br><br>
				<font color=#BE8700 size=3>-=-=-=-=-=-</font>"}
		if("Power")
			dat += {"<font color=#BE8700 size=3>Power! Unlimited Power!</font><br><br>
				In the early stages of the cult, the only resource that must be actively worried about is components. However, as new scripture is unlocked, a new resource
				...
				To begin with, if there is no other source of power nearby, structures will draw from the area's APC, assuming it has one. This is inefficient and ill-advised as
				...
				Generating power is less easy. The most reliable and efficient way is using brass sheets; attacking a sigil of transmission with brass sheets will convert them
				...
				Without power, many structures will not function, making a base vulnerable to attack. For this reason, it is critical that you keep an eye on your power reserves and
				ensure that they remain comfortably high.<br><br>
				<font color=#BE8700 size=3>-=-=-=-=-=-</font>"}
		if("Conversion")

			dat += {"<font color=#BE8700 size=3>Growing the Ranks</font><br><br>
				Because the Servants of Ratvar are a cult, the main method to gain more power is to "enlighten" normal crew into new Servants. When a crewmember is converted,
				...
				<font color=#BE8700><b>A Note on Geis:</b></font> There are several ways to convert humans and silicons. However, the most important tool to making them work is
				...
				<font color=#BE8700><b>Converting:</b></font> The two methods of conversion are the <b>sigil of submission</b>, whose purpose is to do so, and the <b>mania motor.</b>
				...
				<font color=#BE8700><b>Converting Humans:</b></font> For obvious reasons, humans are the most common conversion target. Because every crew member is different, and
				...
				<font color=#BE8700><b>Converting Silicons:</b></font> Due to their robotic nature, silicons are generally more predictable than humans in terms of conversion.
				...
				Converting AIs is very often the hardest task of the cult, and has been the downfall of countless successful Servants. Their omnipresence across the station,
				...
				Even once an AI is converted, care must be taken to ensure that it remains hidden. Not only does the AI's core become brassy and thus obvious to an outside
				...
				<font color=#BE8700><b>Converting the Station:</b></font> Converted objects all serve a purpose and are important to the cult's success. To convert objects,
				...
				The replica fabricator itself is also worth noting. In addition to replacing objects, it can also create brass sheets at the cost of power by using the
				fabricator in-hand. It can also be used to repair any damaged clockwork structures.<br><br>"
				Replacing objects is almost as, if not as important as, converting new Servants. A base is impossible to manage without clockwork walls at the very least, and
