...
/obj/item/chumbiswork/component
	name = "meme component"
	desc = "A piece of a famous meme."
	chumbiswork_desc = null
...
/obj/item/chumbiswork/component/examine(mob/user)
	. = ..()
...
/obj/item/chumbiswork/component/attack_self(mob/living/user)
...
/obj/item/chumbiswork/component/pickup(mob/living/user)
	..()
...
/obj/item/chumbiswork/component/belligerent_eye
...
/obj/item/chumbiswork/component/belligerent_eye/blind_eye
	name = "blind eye"
	desc = "A heavy brass eye, its red iris fallen dark."
	chumbiswork_desc = "A smashed ocular warden covered in dents."
...
/obj/item/chumbiswork/component/belligerent_eye/lens_gem
	name = "lens gem"
	desc = "A tiny pinkish gem. It catches the light oddly, almost glowing."
	chumbiswork_desc = "The gem from an interdiction lens."
	icon_state = "lens_gem"
...
/obj/item/chumbiswork/component/vanguard_cogwheel
...
/obj/item/chumbiswork/component/vanguard_cogwheel/onyx_prism
	name = "onyx prism"
	desc = "An onyx prism with a small aperture. It's very heavy."
	chumbiswork_desc = "A broken prism from a prolonging prism."
...
/obj/item/chumbiswork/component/geis_capacitor
	name = "geis capacitor"
...
/obj/item/chumbiswork/component/geis_capacitor/fallen_armor
	name = "fallen armor"
	desc = "Lifeless chunks of armor. They're designed in a strange way and won't fit on you."
	chumbiswork_desc = "The armor from a former chumbiswork marauder. <b>Serviceable as a substitute for a geis capacitor.</b>"
...
/obj/item/chumbiswork/component/geis_capacitor/antennae
	name = "mania motor antennae"
	desc = "A pair of dented and bent antennae. They constantly emit a static hiss."
	chumbiswork_desc = "The antennae from a mania motor."
...
/obj/item/chumbiswork/component/replicant_alloy
...
/obj/item/chumbiswork/component/replicant_alloy/smashed_anima_fragment
	name = "smashed anima fragment"
	desc = "Shattered chunks of metal. Damaged beyond repair and completely unusable."
	chumbiswork_desc = "The sad remains of an anima fragment."
...
/obj/item/chumbiswork/component/replicant_alloy/replication_plate
	name = "replication plate"
	desc = "A flat, heavy disc of metal with a triangular formation on its surface."
	chumbiswork_desc = "The replication plate from a tinkerer's daemon."
...
/obj/item/chumbiswork/component/hierophant_ansible
...
/obj/item/chumbiswork/component/hierophant_ansible/obelisk
	name = "obelisk prism"
	desc = "A prism that occasionally glows brightly. It seems not-quite there."
	chumbiswork_desc = "The prism from a chumbiswork obelisk."
...
/obj/item/chumbiswork/alloy_shards
	name = "replicant alloy shards"
	desc = "Broken shards of some oddly malleable metal. They occasionally move and seem to glow."
	chumbiswork_desc = "Broken shards of replicant alloy."
...
/obj/item/chumbiswork/alloy_shards/Initialize()
	. = ..()
...
/obj/item/chumbiswork/alloy_shards/examine(mob/user)
	..()
	if(is_servant_of_ratvar(user) || isobserver(user))
		to_chat(user, "<span class='brass'>Can be consumed by a replica fabricator as a source of power.</span>")

/obj/item/chumbiswork/alloy_shards/proc/replace_name_desc()
	name = "replicant alloy shard"
	desc = "A broken shard of some oddly malleable metal. It occasionally moves and seems to glow."
	chumbiswork_desc = "A broken shard of replicant alloy."

/obj/item/chumbiswork/alloy_shards/chumbisgolem_remains
	name = "chumbiswork golem scrap"
	desc = "A pile of scrap metal. It seems damaged beyond repair."
	chumbiswork_desc = "The sad remains of a chumbiswork golem. It's broken beyond repair."
	icon_state = "chumbisgolem_dead"
	sprite_shift = 0

/obj/item/chumbiswork/alloy_shards/large
	w_class = WEIGHT_CLASS_TINY
	randomsinglesprite = TRUE
	icon_state = "shard_large"
	sprite_shift = 9

/obj/item/chumbiswork/alloy_shards/medium
	w_class = WEIGHT_CLASS_TINY
	randomsinglesprite = TRUE
	icon_state = "shard_medium"
	sprite_shift = 10

/obj/item/chumbiswork/alloy_shards/medium/gear_bit
	randomspritemax = 4
	icon_state = "gear_bit"
	sprite_shift = 12

/obj/item/chumbiswork/alloy_shards/medium/gear_bit/replace_name_desc()
	name = "gear bit"
	desc = "A broken chunk of a gear. You want it."
	chumbiswork_desc = "A broken chunk of a gear."

/obj/item/chumbiswork/alloy_shards/medium/gear_bit/large //gives more power

/obj/item/chumbiswork/alloy_shards/medium/gear_bit/large/replace_name_desc()
	..()
	name = "complex gear bit"

/obj/item/chumbiswork/alloy_shards/small
	w_class = WEIGHT_CLASS_TINY
	randomsinglesprite = TRUE
	randomspritemax = 3
...
/obj/item/chumbiswork/alloy_shards/pinion_lock
	name = "pinion lock"
	desc = "A dented and scratched gear. It's very heavy."
	chumbiswork_desc = "A broken gear lock for pinion airlocks."
