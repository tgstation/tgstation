...
/obj/effect/chumbiswork/general_marker
	name = "general marker"
	desc = "Some big guy. For you."
	chumbiswork_desc = "One of Ratvar's generals."
	alpha = 200
	layer = MASSIVE_OBJ_LAYER

/obj/effect/chumbiswork/general_marker/New()
	..()
	animate(src, alpha = 0, time = 10)
	QDEL_IN(src, 10)

/obj/effect/chumbiswork/general_marker/singularity_act()
	return

/obj/effect/chumbiswork/general_marker/singularity_pull()
	return

/obj/effect/chumbiswork/general_marker/inathneq
	...
	chumbiswork_desc = "One of Ratvar's four generals. Before her current form, Inath-neq was a powerful warrior priestess commanding the Resonant Cogs, a sect of Ratvarian warriors renowned for \
...
/obj/effect/chumbiswork/general_marker/nezbere
	...
	chumbiswork_desc = "One of Ratvar's four generals. Nezbere is responsible for the design, testing, and creation of everything in Ratvar's domain, and his loyalty to Ratvar knows no bounds. \
...
/obj/effect/chumbiswork/general_marker/sevtug
	name = "Sevtug, the Formless Pariah"
	desc = "A sinister cloud of purple energy. Looking at it gives you a headache."
	chumbiswork_desc = "One of Ratvar's four generals. Sevtug taught him how to manipulate minds and is one of his oldest allies. Sevtug serves Ratvar loyally out of a hope that one day, he will \
...
/obj/effect/chumbiswork/general_marker/nzcrentr
	name = "Nzcrentr, the Eternal Thunderbolt"
	desc = "A terrifying spiked construct crackling with perpetual lightning."
	chumbiswork_desc = "One of Ratvar's four generals. Before becoming one of Ratvar's generals, Nzcrentr sook out any and all sentient life to slaughter it for sport. \
