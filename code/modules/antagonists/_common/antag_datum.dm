...
/datum/antagonist/proc/on_gain()
	...
	give_antag_moodies()
	register_signal(owner, COMSIG_PRE_MINDSHIELD_IMPLANT, .proc/pre_mindshield)
	register_signal(owner, COMSIG_MINDSHIELD_IMPLANTED, .proc/on_mindshield)
...
/datum/antagonist/proc/on_removal()
	...
	if(!silent && owner.current)
		farewell()
	unregister_signal(owner, COMSIG_PRE_MINDSHIELD_IMPLANT)
	unregister_signal(owner, COMSIG_MINDSHIELD_IMPLANTED)
