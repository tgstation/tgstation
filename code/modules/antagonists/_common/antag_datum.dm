...
/datum/antagonist/proc/on_body_transfer(mob/living/old_body, mob/living/new_body)
	...
	if(count_against_dynamic_roll_chance && old_body && old_body.stat != DEAD && !LAZYLEN(old_body.mind?.antag_datums))
...
/datum/antagonist/proc/on_removal()
	...
	clear_antag_moodies()
	LAZYREMOVE(owner.antag_datums, src)
	if(!LAZYLEN(owner.antag_datums) && count_against_dynamic_roll_chance)
