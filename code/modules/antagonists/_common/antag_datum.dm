...
/datum/antagonist/proc/replace_banned_player()
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob(role = job_rank, jobban = job_rank, poll_time = 5 SECONDS, target_mob = owner.current, pic_source = owner.current)
