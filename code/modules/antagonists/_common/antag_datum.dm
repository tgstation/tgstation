...
/datum/antagonist/proc/replace_banned_player()
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob("Do you want to play as a [name]?", role = job_rank, jobban = "[name]", poll_time = 5 SECONDS, target_mob = owner.current, pic_source = owner.current)
