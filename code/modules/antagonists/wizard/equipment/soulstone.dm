...
/obj/item/soulstone/proc/get_ghost_to_replace_shade(mob/living/carbon/victim, mob/user)
	...
	var/list/consenting_candidates = SSpolling.poll_ghost_candidates(role = ROLE_CULTIST, jobban = ROLE_CULTIST, poll_time = 5 SECONDS, ignore_category = POLL_IGNORE_SHADE, pic_source = /mob/living/simple_animal/shade, role_name_text = "shade")
