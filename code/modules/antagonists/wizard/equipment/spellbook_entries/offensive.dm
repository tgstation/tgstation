...
/datum/spellbook_entry/item/mjolnir
	name = "Mjolnir"
	desc = "A mighty hammer on loan from Thor, God of Thunder. It crackles with barely contained power. Requires dual wielding to unleash its true potential."
	item_path = /obj/item/mjollnir
	category = SPELLBOOK_CATEGORY_OFFENSIVE

/datum/spellbook_entry/item/singularity_hammer
	name = "Singularity Hammer"
	desc = "A hammer that creates an intensely powerful field of gravity where it strikes, pulling everything nearby to the point of impact. Requires dual wielding to unleash its true potential."
