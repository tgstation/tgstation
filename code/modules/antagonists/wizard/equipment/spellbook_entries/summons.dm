...
/datum/spellbook_entry/summon/ghosts/buy_spell(mob/living/carbon/human/user, obj/item/spellbook/book, log_buy = TRUE)
	summon_ghosts(user)
	PLAYSOUND(get_turf(user), 'sound/effects/ghost2.ogg').volume(50).vary_frequency(TRUE).play()
	return ..()
...
/datum/spellbook_entry/summon/guns/buy_spell(mob/living/carbon/human/user, obj/item/spellbook/book, log_buy = TRUE)
	summon_guns(user, 10)
	PLAYSOUND(get_turf(user), 'sound/effects/magic/castsummon.ogg').volume(50).vary_frequency(TRUE).play()
	return ..()
