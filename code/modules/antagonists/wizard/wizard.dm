...
/datum/antagonist/wizard/apprentice/equip_wizard()
	...
	switch(school)
		...
		if(APPRENTICE_ROBELESS)
			...
			to_chat(owner, "<B>Your service has not gone unrewarded, however. Studying under [master.current.real_name], you have learned stealthy, robeless spells. You are able to cast knock and mind swap.")
