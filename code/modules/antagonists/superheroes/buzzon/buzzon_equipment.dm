...
/mob/living/simple_animal/hostile/bee/toxin_type
	var/toxin_type = /datum/reagent/toxin

/mob/living/simple_animal/hostile/bee/toxin_type/Initialize()
	. = ..()
	assign_reagent(GLOB.chemical_reagents_list[toxin_type])

/mob/living/simple_animal/hostile/bee/toxin_type/cryo
