...
/obj/item/borg_chameleon/proc/toggle(mob/living/silicon/robot/user)
	if(active)
		playsound(src, 'sound/effects/pop.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -6)
		...
		playsound(src, 'sound/effects/seedling_chargeup.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -6)
		...
		if (do_after(user, 50, target=user) && user.cell.use(activationCost))
			playsound(src, 'sound/effects/bamf.ogg', 100, DEFAULT_SOUND_VARY, extra_range = -6)
