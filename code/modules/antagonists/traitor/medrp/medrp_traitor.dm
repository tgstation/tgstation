...
/datum/antagonist/traitor/roleplay
	name = "Corporate Traitor"
	should_equip = FALSE //called manually
	var/role_title = "Bugged Antagonist. Report this!"
	var/hijacking

/datum/antagonist/traitor/roleplay/on_gain()
	employer = pickweight(list("Syndicate" = 5, "Nanotrasen" = 3))
...
/datum/antagonist/traitor/roleplay/proc/fluff_strings()
	...
	switch(role_title)
		if("Tiger Cooperative")
			...
			. += "<span class='notice'>Only the enlightened Tiger brethren can be trusted; all others must be expelled from this mortal realm!</span>"
			. += "<span class='bold'>Remember the teachings of Hy-lurgixon; kill first, ask questions later!</span>"
		...
		if("Waffle Corporation Terrorist")
			...
			. += "<span class='notice'>Most other syndicate operatives are not to be trusted, except for members of the Gorlex Marauders. Do not trust fellow members of the Waffle.co (but try not to rat them out), as they might have been assigned opposing objectives.</span>"
			. += "<span class='bold'>An egregiously loud feat like hijacking a Nanotrasen emergency shuttle should attract customers.</span>"
		...
		if("Animal Rights Consortium")
			...
			. += "<span class='notice'>You may cooperate with other syndicate operatives if they support our cause. Maybe you can convince the Bee Liberation Front operatives to cooperate for once?</span>"
			. += "<span class='bold'>The creatures of this world must be freed from the iron grasp of Nanotrasen, and you are their only hope!</span>"
		...
		if("Bee Liberation Front")
			...
			. += "<span class='notice'>You may cooperate with other syndicate operatives if they support our cause. Maybe you can recruit an Animal Rights Consort to be useful for once?</span>"
			. += "<span class='bold'>We must prove ourselves to the Syndicate or we will not be able to join. Animal Rights Consort will roll us!</span>"
		...
		if("Cybersun Industries")
			...
			. += "<span class='notice'>Fellow Cybersun operatives are to be trusted. Members of the MI13 organization can be trusted. All other syndicate operatives are not to be trusted. </span>"
			. += "<span class='bold'>Do not establish substantial presence on the designated facility, as larger incidents are harder to cover up.</span>"
		...
		if("MI13")
			...
			. += "<span class='notice'>You are the only operative we are sending, any others are fake. All other syndicate operatives are not to be trusted, with the exception of Cybersun operatives.</span>"
			. += "<span class='bold'>Avoid killing innocent personnel at all costs. You are not here to mindlessly kill people, as that would attract too much attention and is not our goal. Avoid detection at all costs.</span>"
			. += "<span class='notice'>You have been provided with a standard uplink to accomplish your task.</span>"
		if("Gorlex Marauders")
			. += "<span class='userdanger'>You are a Gorlex Marauder.</span>"
			. += "<span class='notice'>You may collaborate with any friends of the Syndicate coalition, but keep an eye on any of those Tiger punks if they do show up.</span>"
			. += "<span class='bold'>Getting noticed is not an issue, and you may use any level of ordinance to get the job done. That being said, do not make this sloppy by dragging in random slaughter.</span>"
			. += "<span class='notice'>You have been provided with a standard uplink to accomplish your task.</span>"
		if("Donk Corporation")
			. += "<span class='userdanger'>You are the Donk Co. Traitor.</span>"
			. += "<span class='notice'>Members of Waffle Co. are to be killed on sight; they are not allowed to be on the station while we're around.</span>"
			. += "<span class='bold'>We do not approve of mindless killing of innocent workers; \"get in, get done, get out\" is our motto.</span>"
			. += "<span class='notice'>You have been provided with a standard uplink to accomplish your task.</span>"
		if("Waffle Corporation")
			. += "<span class='userdanger'>You are the Waffle Co. Traitor.</span>"
			. += "<span class='notice'>Members of Donk Co. are to be killed on sight; they are not allowed to be on the station while we're around. Do not trust fellow members of the Waffle.co (but try not to rat them out), as they might have been assigned opposing objectives.</span>"
			. += "<span class='bold'>You are not here for a stationwide demonstration. Again, other Waffle Co. Traitors may be, so watch out. Your job is to only accomplish your objectives.</span>"
			. += "<span class='notice'>You have been provided with a standard uplink to accomplish your task.</span>"
		if("Gone Postal")
			. += "<span class='userdanger'>You have gone postal.</span>"
			. += "<span class='notice'>If a syndicate learns of your plan, they're going to kill you and take your uplink. Take no chances.</span>"
			. += "<span class='bold'>The preparations are finally complete. Today is the day you go postal. You're going to hijack the emergency shuttle and live a new life free of Nanotrasen.</span>"
		...
		if("Internal Affairs Agent")
			...
			. += "<span class='notice'>If a syndicate learns of your plan, they're going to kill you and take your uplink. Take no chances.</span>"
			. += "<span class='bold'>While you have a license to kill, unneeded property damage or loss of employee life will lead to your contract being terminated.</span>"
		...
		if("Corporate Climber")
			...
			. += "<span class='bold'>Killing needlessly would make you some kind of traitor, or at least definitely seen as one. This is all just a means to an end.</span>"
