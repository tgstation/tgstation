...
/datum/reagent/blob/cryogenic_poison/on_mob_life(mob/living/carbon/exposed_mob, delta_time, times_fired)
	exposed_mob.adjustBruteLoss(0.25*REAGENTS_EFFECT_MULTIPLIER*delta_time, FALSE)
	exposed_mob.adjustFireLoss(0.25*REAGENTS_EFFECT_MULTIPLIER*delta_time, FALSE)
	exposed_mob.adjustToxLoss(0.25*REAGENTS_EFFECT_MULTIPLIER*delta_time, FALSE)
	. = 1
	..()
