/datum/antagonist/blob
	...
	stinger_sound = 'sound/instrumental/antag/blobalert.ogg'
...
/datum/action/innate/blobpop/Activate(timer_activated = FALSE)
	...
	playsound(get_turf(blob_cam), 'sound/instrumental/antag/blobalert.ogg', 50, FALSE)
	blobtag.has_already_popped = TRUE

	notify_ghosts(
		"A Blob host has burst in [get_area_name(blob_cam.blob_core)]",
		source = blob_cam.blob_core,
		ghost_sound = 'sound/instrumental/antag/blobalert.ogg',
