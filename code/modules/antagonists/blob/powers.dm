...
/mob/camera/blob/proc/create_blobbernaut()
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_candidates("Do you want to play as a [blobstrain.name] blobbernaut?", ROLE_BLOB, ROLE_BLOB, 50) //players must answer rapidly
