...
/mob/living/simple_animal/hostile/blob/blobspore/Life(delta_time = SSSIMPLE_MOBS_DT, times_fired)
...
/mob/living/simple_animal/hostile/blob/blobbernaut/Life(delta_time = SSSIMPLE_MOBS_DT, times_fired)
	if(!..())
		return
