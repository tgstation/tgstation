...
/datum/forensics/proc/check_blood()
	...
	if (blood_color)
		parent.AddElement(/datum/element/decal/blood, _color = blood_color, _emissive = parent.get_blood_emissive_alpha(), _emissive_type = parent.get_blood_emissive_type())
