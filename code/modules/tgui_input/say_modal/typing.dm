...
/mob/living/create_thinking_indicator()
	if(active_thinking_indicator || active_typing_indicator || IS_UNCONSCIOUS_CRIT_OR_DEAD(src) || !HAS_TRAIT(src, TRAIT_THINKING_IN_CHARACTER))
		return FALSE
...
/mob/living/create_typing_indicator()
	if(active_typing_indicator || active_thinking_indicator || IS_UNCONSCIOUS_CRIT_OR_DEAD(src) || !HAS_TRAIT(src, TRAIT_THINKING_IN_CHARACTER))
		return FALSE
