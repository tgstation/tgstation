...
/datum/surgery_step/retract_skin
	...
	time = 24
	preop_sound = list('sound/surgery/retractor1.ogg')
...
/datum/surgery_step/close
	...
	time = 24
	preop_sound = list('sound/surgery/cautery1.ogg')
	success_sound = list('sound/surgery/cautery2.ogg')
...
/datum/surgery_step/saw
	...
	time = 54
	preop_sound = list('sound/surgery/saw.ogg')
