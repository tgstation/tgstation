...
/obj/item/organ/internal/cyberimp/eyes/hud/on_insert(mob/living/carbon/eye_owner)
	if(HUD_type)
...
/obj/item/organ/internal/cyberimp/eyes/hud/on_remove(mob/living/carbon/eye_owner)
	if(HUD_type)
		var/datum/atom_hud/hud = GLOB.huds[HUD_type]
