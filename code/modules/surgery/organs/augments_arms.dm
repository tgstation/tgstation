...
/obj/item/organ/cyberimp/arm/surgery/alien
	...
	desc = "A hightec set of alien surgical tools hidden behind a concealed panel on the user's arm"
	...
	origin_tech = "materials=5;engineering=3;biotech=5;programming=3;magnets=4;abductor=3"
