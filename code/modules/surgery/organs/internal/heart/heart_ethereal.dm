...
/obj/structure/ethereal_crystal/atom_destruction(damage_flag)
	playsound(get_turf(ethereal_heart.owner), 'sound/mobs/humanoids/ethereal/ethereal_revive_fail.ogg').volume(100).play()
	return ..()
...
/obj/structure/ethereal_crystal/proc/heal_ethereal()
	...
	playsound(get_turf(regenerating), 'sound/mobs/humanoids/ethereal/ethereal_revive.ogg').volume(100).play()
