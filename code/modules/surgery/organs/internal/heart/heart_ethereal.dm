...
/obj/structure/ethereal_crystal/Initialize(mapload, obj/item/organ/internal/heart/ethereal/ethereal_heart)
	...
	playsound(get_turf(src), 'sound/mobs/humanoids/ethereal_crystalization.ogg', 50)
...
/obj/structure/ethereal_crystal/atom_destruction(damage_flag)
	playsound(get_turf(ethereal_heart.owner), 'sound/mobs/humanoids/ethereal_revive_fail.ogg', 100)
	return ..()
...
/obj/structure/ethereal_crystal/proc/heal_ethereal()
	...
	playsound(get_turf(regenerating), 'sound/mobs/humanoids/ethereal_revive.ogg', 100)
