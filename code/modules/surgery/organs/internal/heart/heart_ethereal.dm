...
/obj/structure/ethereal_crystal/Initialize(mapload, obj/item/organ/heart/ethereal/ethereal_heart)
	...
	create_sound(get_turf(src), 'sound/mobs/humanoids/ethereal/ethereal_crystalization.ogg').play()
...
/obj/structure/ethereal_crystal/atom_destruction(damage_flag)
	create_sound(get_turf(ethereal_heart.owner), 'sound/mobs/humanoids/ethereal/ethereal_revive_fail.ogg').volume(100).play()
	return ..()
...
/obj/structure/ethereal_crystal/proc/heal_ethereal()
	...
	create_sound(get_turf(regenerating), 'sound/mobs/humanoids/ethereal/ethereal_revive.ogg').volume(100).play()
