...
/obj/item/organ/lungs/on_mob_insert(mob/living/carbon/receiver, special = FALSE, movement_flags, movement_flags)
	. = ..()
...
/obj/item/organ/lungs/on_mob_remove(mob/living/carbon/organ_owner, special, movement_flags, movement_flags)
	. = ..()
