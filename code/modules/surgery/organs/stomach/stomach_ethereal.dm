...
/obj/item/organ/stomach/ethereal/proc/handle_charge(mob/living/carbon/carbon, delta_time, times_fired)
	switch(crystal_charge)
		if(-INFINITY to ETHEREAL_CHARGE_NONE)
			...
			carbon.throw_alert("ethereal_charge", /obj/screen/alert/emptycell/ethereal)
			if(carbon.health > 10.5)
				carbon.apply_damage(0.65, TOX, null, null, carbon)
		if(ETHEREAL_CHARGE_NONE to ETHEREAL_CHARGE_LOWPOWER)
			SEND_SIGNAL(carbon, COMSIG_ADD_MOOD_EVENT, "charge", /datum/mood_event/decharged)
			carbon.throw_alert("ethereal_charge", /obj/screen/alert/lowcell/ethereal, 3)
			if(carbon.health > 10.5)
		...
		if(ETHEREAL_CHARGE_LOWPOWER to ETHEREAL_CHARGE_NORMAL)
			...
			carbon.throw_alert("ethereal_charge", /obj/screen/alert/lowcell/ethereal, 2)
		...
		if(ETHEREAL_CHARGE_FULL to ETHEREAL_CHARGE_OVERLOAD)
			...
			carbon.throw_alert("ethereal_overcharge", /obj/screen/alert/ethereal_overcharge, 1)
		...
		if(ETHEREAL_CHARGE_OVERLOAD to ETHEREAL_CHARGE_DANGEROUS)
			...
			carbon.throw_alert("ethereal_overcharge", /obj/screen/alert/ethereal_overcharge, 2)
			carbon.apply_damage(0.325 * delta_time, TOX, null, null, carbon)
