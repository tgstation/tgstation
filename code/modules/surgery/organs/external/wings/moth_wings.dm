...
/obj/item/organ/wings/moth/proc/can_fly()
	if(isspaceturf(owner.loc) || burnt || owner.obscured_slots & HIDEMUTWINGS)
		return FALSE //No flight in space/burnt wings/flight with hidden wings
	return TRUE
