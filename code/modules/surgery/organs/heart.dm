...
/obj/item/organ/heart/on_life(delta_time, times_fired)
	...
	if(organ_flags & ORGAN_FAILING && !HAS_TRAIT(TRAIT_STABLEHEART)) //heart broke, stopped beating, death imminent... unless you have veins that pump blood without a heart
