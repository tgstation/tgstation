...
/obj/item/organ/internal/ears/cybernetic/upgraded
	...
	icon_state = "ears-c-u"
	desc = "Advanced cybernetic ears that surpass the performance of organic ears. They contain sound compensators that reduce the impact of loud, sudden noises."
