...
/obj/item/shears/attack(mob/living/amputee, mob/living/user)
	...
	if(HAS_TRAIT(patient, TRAIT_KNOCKEDOUT) || HAS_TRAIT(patient, TRAIT_INCAPACITATED)) //if you're incapacitated (due to paralysis, a stun, being in staminacrit, etc.), critted, unconscious, or dead, it's much easier to properly line up a snip
