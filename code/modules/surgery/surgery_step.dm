...
/datum/surgery_step/proc/play_preop_sound(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	...
	create_sound(tool, sound_file_use).volume(75).vary(TRUE).falloff_exponent(12).falloff_distance(1).play()
...
/datum/surgery_step/proc/play_success_sound(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	if(!success_sound)
		return
	create_sound(tool, success_sound).volume(75).vary(TRUE).falloff_exponent(12).falloff_distance(1).play()
...
/datum/surgery_step/proc/play_failure_sound(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	if(!failure_sound)
		return
	create_sound(tool, failure_sound).volume(75).vary(TRUE).falloff_exponent(12).falloff_distance(1).play()
