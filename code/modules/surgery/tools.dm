/obj/item/retractor
	...
	materials = list(MAT_CATEGORY_IRON=6000, MAT_CATEGORY_GLASS=3000)
	flags_1 = CONDUCT_1
...
/obj/item/cautery
	...
	icon = 'icons/obj/surgery.dmi'
	icon_state = "cautery"
	materials = list(MAT_CATEGORY_IRON=2500, MAT_CATEGORY_GLASS=750)
	flags_1 = CONDUCT_1
	item_flags = SURGICAL_TOOL
	w_class = WEIGHT_CLASS_TINY
...
/obj/item/surgicaldrill
	...
	materials = list(MAT_CATEGORY_IRON=10000, MAT_CATEGORY_GLASS=6000)
	flags_1 = CONDUCT_1
	item_flags = SURGICAL_TOOL
	force = 15
...
/obj/item/scalpel
	...
	throw_speed = 3
	throw_range = 5
	materials = list(MAT_CATEGORY_IRON=4000, MAT_CATEGORY_GLASS=1000)
