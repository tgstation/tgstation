/obj/item/retractor
	...
	materials = list(/datum/material/hematite=6000, /datum/material/glass=3000)
	flags_1 = CONDUCT_1
...
/obj/item/cautery
	...
	icon = 'icons/obj/surgery.dmi'
	icon_state = "cautery"
	materials = list(/datum/material/hematite=2500, /datum/material/glass=750)
	flags_1 = CONDUCT_1
	item_flags = SURGICAL_TOOL
	w_class = WEIGHT_CLASS_TINY
...
/obj/item/surgicaldrill
	...
	materials = list(/datum/material/hematite=10000, /datum/material/glass=6000)
	flags_1 = CONDUCT_1
	item_flags = SURGICAL_TOOL
	force = 15
...
/obj/item/scalpel
	...
	throw_speed = 3
	throw_range = 5
	materials = list(/datum/material/hematite=4000, /datum/material/glass=1000)
