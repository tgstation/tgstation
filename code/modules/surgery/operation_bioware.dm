...
/datum/surgery_operation/organ_bioware/get_default_radial_image(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(image('icons/hud/implants.dmi', "lighting_bolt"))
	return base

/datum/surgery_operation/organ_bioware/state_check(obj/item/bodypart/limb)
...
/datum/surgery_operation/organ_bioware/thread_veins
	name = "thread veins"
...
/datum/surgery_operation/organ_bioware/thread_veins/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/thread_veins/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/muscled_veins
	name = "muscled veins"
...
/datum/surgery_operation/organ_bioware/muscled_veins/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/muscled_veins/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/splice_nerves
	name = "splice nerves"
...
/datum/surgery_operation/organ_bioware/splice_nerves/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/splice_nerves/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/ground_nerves
	name = "ground nerves"
...
/datum/surgery_operation/organ_bioware/ground_nerves/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/ground_nerves/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/reshape_ligaments
...
/datum/surgery_operation/organ_bioware/reshape_ligaments/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/reshape_ligaments/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/strengthen_ligaments
...
/datum/surgery_operation/organ_bioware/strengthen_ligaments/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/strengthen_ligaments/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/cortex_folding
	name = "cortex folding"
...
/datum/surgery_operation/organ_bioware/cortex_folding/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/cortex_folding/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/cortex_folding/failure(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, total_penalty_modifier)
...
/datum/surgery_operation/organ_bioware/cortex_imprint
...
/datum/surgery_operation/organ_bioware/cortex_imprint/preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/cortex_imprint/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/organ_bioware/cortex_imprint/failure(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, total_penalty_modifier)
	if(limb.owner.get_organ_slot(ORGAN_SLOT_BRAIN))
		display_results(
			surgeon,
			limb.owner,
