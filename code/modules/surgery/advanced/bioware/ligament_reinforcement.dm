...
/datum/bioware/reinforced_ligaments/on_gain()
	..()
	ADD_TRAIT(owner, TRAIT_NO_DISMEMBER, SOURCE_EXPERIMENTAL_SURGERY)
	ADD_TRAIT(owner, TRAIT_EASILY_WOUNDED, SOURCE_EXPERIMENTAL_SURGERY)

/datum/bioware/reinforced_ligaments/on_lose()
	..()
	REMOVE_TRAIT(owner, TRAIT_NO_DISMEMBER, SOURCE_EXPERIMENTAL_SURGERY)
	REMOVE_TRAIT(owner, TRAIT_EASILY_WOUNDED, SOURCE_EXPERIMENTAL_SURGERY)
