...
/datum/bioware/hooked_ligaments/on_gain()
	..()
	ADD_TRAIT(owner, TRAIT_LIMB_ATTACHMENT, SOURCE_EXPERIMENTAL_SURGERY)
	ADD_TRAIT(owner, TRAIT_EASY_DISMEMBER, SOURCE_EXPERIMENTAL_SURGERY)

/datum/bioware/hooked_ligaments/on_lose()
	..()
	REMOVE_TRAIT(owner, TRAIT_LIMB_ATTACHMENT, SOURCE_EXPERIMENTAL_SURGERY)
	REMOVE_TRAIT(owner, TRAIT_EASY_DISMEMBER, SOURCE_EXPERIMENTAL_SURGERY)
