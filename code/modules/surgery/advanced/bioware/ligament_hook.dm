...
/datum/bioware/hooked_ligaments/on_gain()
	..()
	ADD_TRAIT_LIST(owner, list(TRAIT_LIMBATTACHMENT, TRAIT_EASYDISMEMBER), EXPERIMENTAL_SURGERY_TRAIT)

/datum/bioware/hooked_ligaments/on_lose()
	..()
	REMOVE_TRAIT_LIST(owner, list(TRAIT_LIMBATTACHMENT, TRAIT_EASYDISMEMBER), EXPERIMENTAL_SURGERY_TRAIT)
