...
/datum/surgery_operation/incise_skin/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/scalpel)
	return base

/datum/surgery_operation/incise_skin/tool_check(obj/item/tool)
	// Require sharpness OR a tool behavior match
	return (tool.get_sharpness() || implements[tool.tool_behaviour])

/datum/surgery_operation/incise_skin/state_check(obj/item/bodypart/limb)
	if(limb.surgery_skin_state != SURGERY_SKIN_CLOSED)
		return FALSE
	return TRUE

/datum/surgery_operation/incise_skin/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/incise_skin/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
...
/datum/surgery_operation/retract_skin/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/retractor)
	return base

/datum/surgery_operation/retract_skin/state_check(obj/item/bodypart/limb)
	if(limb.surgery_skin_state != SURGERY_SKIN_CUT)
		return FALSE
	return TRUE

/datum/surgery_operation/retract_skin/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/retract_skin/on_success(obj/item/bodypart/limb)
	. = ..()
...
/datum/surgery_operation/close_skin/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
...
/datum/surgery_operation/close_skin/tool_check(obj/item/tool)
...
/datum/surgery_operation/close_skin/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/close_skin/on_success(obj/item/bodypart/limb)
	. = ..()
...
/datum/surgery_operation/clamp_bleeders/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/hemostat)
	return base

/datum/surgery_operation/clamp_bleeders/state_check(obj/item/bodypart/limb)
	if(limb.surgery_vessel_state != SURGERY_VESSELS_UNCLAMPED)
		return FALSE
	return TRUE

/datum/surgery_operation/clamp_bleeders/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/clamp_bleeders/on_success(obj/item/bodypart/limb)
	. = ..()
...
/datum/surgery_operation/unclamp_bleeders/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/hemostat)
	return base

/datum/surgery_operation/unclamp_bleeders/state_check(obj/item/bodypart/limb)
	if(limb.surgery_vessel_state != SURGERY_VESSELS_CLAMPED)
		return FALSE
	return TRUE

/datum/surgery_operation/unclamp_bleeders/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/unclamp_bleeders/on_success(obj/item/bodypart/limb)
	. = ..()
...
/datum/surgery_operation/saw_bones/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/circular_saw)
	return base

/datum/surgery_operation/saw_bones/state_check(obj/item/bodypart/limb)
...
/datum/surgery_operation/saw_bones/tool_check(obj/item/tool)
...
/datum/surgery_operation/saw_bones/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/saw_bones/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
...
/datum/surgery_operation/fix_bones/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/stack)
	return base

/datum/surgery_operation/fix_bones/state_check(obj/item/bodypart/limb)
	if(limb.surgery_bone_state == SURGERY_BONE_INTACT)
		return FALSE
	if(limb.surgery_skin_state < SURGERY_SKIN_OPEN)
		return FALSE
...
/datum/surgery_operation/fix_bones/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/fix_bones/on_success(obj/item/bodypart/limb)
	. = ..()
...
/datum/surgery_operation/drill_bones/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/surgicaldrill)
	return base

/datum/surgery_operation/drill_bones/state_check(obj/item/bodypart/limb)
	if(limb.surgery_bone_state != SURGERY_BONE_INTACT)
		return FALSE
	if(limb.surgery_skin_state < SURGERY_SKIN_OPEN)
		return FALSE
...
/datum/surgery_operation/drill_bones/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/drill_bones/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
...
/datum/surgery_operation/incise_organs/get_default_radial_image(obj/item/bodypart/chest/limb, mob/living/surgeon, obj/item/tool)
	var/image/base = ..()
	base.overlays += add_radial_overlays(/obj/item/scalpel)
	return base

/datum/surgery_operation/incise_organs/state_check(obj/item/bodypart/limb)
	if(limb.surgery_skin_state < SURGERY_SKIN_OPEN)
		return FALSE
	if(limb.surgery_vessel_state != SURGERY_VESSELS_CLAMPED)
		return FALSE
...
/datum/surgery_operation/incise_organs/tool_check(obj/item/tool)
	// Require sharpness OR a tool behavior match
	return (tool.get_sharpness() || implements[tool.tool_behaviour])

/datum/surgery_operation/incise_organs/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
...
/datum/surgery_operation/incise_organs/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	. = ..()
