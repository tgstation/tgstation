...
/obj/item/bodypart/head/proc/get_hair_and_lips_icon(dropped)
	...
	if(!facial_hair_hidden && facial_hairstyle && (head_flags & HEAD_FACIAL_HAIR))
		sprite_accessory = SSsprite_accessories.facial_hairstyles_list[facial_hairstyle]
		if(sprite_accessory)
			//Overlay
			...
			if(facial_hair_gradient_style)
				...
				var/image/facial_hair_gradient_overlay = get_gradient_overlay(sprite_accessory.icon, sprite_accessory.icon_state, -HAIR_LAYER, SSsprite_accessories.facial_hair_gradients_list[facial_hair_gradient_style], facial_hair_gradient_color, image_dir)
	...
	if(!(show_debrained && (head_flags & HEAD_DEBRAIN)) && !hair_hidden && hairstyle && (head_flags & HEAD_HAIR))
		var/datum/sprite_accessory/hair/hair_sprite_accessory = SSsprite_accessories.hairstyles_list[hairstyle]
		if(hair_sprite_accessory)
			...
			if(hair_gradient_style)
				...
				var/image/hair_gradient_overlay = get_gradient_overlay(hair_sprite_accessory.icon, hair_sprite_accessory.icon_state, -HAIR_LAYER, SSsprite_accessories.hair_gradients_list[hair_gradient_style], hair_gradient_color, image_dir)
