...
/obj/item/bodypart/l_leg
	...
	var/right_leg_mask_key
	/// The associated list of all the right leg mask keys associated to their cached right leg masks.
	...
	var/static/list/right_leg_mask_cache = list()
