...
/mob/living/carbon/alien/humanoid/newBodyPart(zone)
	...
	switch(zone)
		if(BODY_ZONE_L_ARM)
			new_bodypart = new /obj/item/bodypart/arm/l_arm/alien()
		if(BODY_ZONE_R_ARM)
			new_bodypart = new /obj/item/bodypart/arm/r_arm/alien()
		if(BODY_ZONE_HEAD)
			new_bodypart = new /obj/item/bodypart/head/alien()
		if(BODY_ZONE_L_LEG)
			new_bodypart = new /obj/item/bodypart/leg/l_leg/alien()
		if(BODY_ZONE_R_LEG)
			new_bodypart = new /obj/item/bodypart/leg/r_leg/alien()
		if(BODY_ZONE_CHEST)
