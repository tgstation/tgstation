/obj/item/bodypart
	...
	/// Lazylist of /datum/status_effect/bodypart_effect types. Instances of this are applied to the carbon when added the limb is attached, and merged with similair limbs
