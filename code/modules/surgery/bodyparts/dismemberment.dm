...
/obj/item/bodypart/head/attach_limb(mob/living/carbon/new_head_owner, special = FALSE, abort = FALSE)
	...
	if(!special && ishuman(new_head_owner))
		...
		LAZYSET(sexy_chad.grad_style, GRADIENT_HAIR_KEY, hair_gradient_style)
		LAZYSET(sexy_chad.grad_color, GRADIENT_HAIR_KEY, hair_gradient_color)
		LAZYSET(sexy_chad.grad_style, GRADIENT_FACIAL_HAIR_KEY, facial_hair_gradient_style)
		LAZYSET(sexy_chad.grad_color, GRADIENT_FACIAL_HAIR_KEY, facial_hair_gradient_color)
