...
/datum/surgery_operation/limb/repair_puncture/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
		span_notice("You begin to realign the torn blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]..."),
		span_notice("[surgeon] begins to realign the torn blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]."),
		span_notice("[surgeon] begins to realign the torn blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
	)
...
/datum/surgery_operation/limb/repair_puncture/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	...
	if(QDELETED(pierce_wound))
		display_results(
			surgeon,
			limb.owner,
			span_notice("You successfully realign the last of the torn blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
			span_notice("[surgeon] successfully realigns the last of the torn blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]!"),
			span_notice("[surgeon] successfully realigns the last of the torn blood vessels in  [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]!"),
		)
		return
	...
	display_results(
		surgeon,
		limb.owner,
		span_notice("You successfully realign some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
		span_notice("[surgeon] successfully realigns some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]!"),
		span_notice("[surgeon] successfully realigns some of the blood vessels in  [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]!"),
	)
...
/datum/surgery_operation/limb/repair_puncture/on_failure(obj/item/bodypart/limb, mob/living/surgeon, tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
		span_notice("You jerk apart some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
		span_notice("[surgeon] jerks apart some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]!"),
		span_notice("[surgeon] jerks apart some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
	)
...
/datum/surgery_operation/limb/seal_veins/on_preop(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	display_results(
		surgeon,
		limb.owner,
		span_notice("You begin to seal the realigned blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]..."),
		span_notice("[surgeon] begins to seal the realigned blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]."),
		span_notice("[surgeon] begins to seal the realigned blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
	)
...
/datum/surgery_operation/limb/seal_veins/on_success(obj/item/bodypart/limb, mob/living/surgeon, obj/item/tool, list/operation_args)
	...
	if(QDELETED(pierce_wound))
		display_results(
			surgeon,
			limb.owner,
			span_notice("You successfully seal the last of the ruptured blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
			span_notice("[surgeon] successfully seals the last of the ruptured blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]!"),
			span_notice("[surgeon] successfully seals the last of the ruptured blood vessels in  [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]!"),
		)
		return
	...
	display_results(
		surgeon,
		limb.owner,
		span_notice("You successfully seal some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]."),
		span_notice("[surgeon] successfully seals some of the blood vessels in [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb] with [tool]!"),
		span_notice("[surgeon] successfully seals some of the blood vessels in  [limb.owner ? "[limb.owner]'s [limb.plaintext_zone]" : limb]!"),
	)
