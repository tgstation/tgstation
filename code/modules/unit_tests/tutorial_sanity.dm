...
/datum/unit_test/tutorial_sanity/Run()
	...
	for (var/datum/tutorial/tutorial_type as anything in SStutorials.tutorial_managers)
		var/datum/tutorial_manager/tutorial_manager = SStutorials.tutorial_manager[tutorial_type]
		...
		TEST_ASSERT(key.len < 64, "[key] is more than 64 characters, it won't fit in the SQL table.")
