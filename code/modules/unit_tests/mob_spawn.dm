...
/datum/unit_test/mob_spawn/Run()
	...
	var/static/list/human_only_vars = list(
		NAMEOF_STATIC(ghost_role, facial_haircolor),
		NAMEOF_STATIC(ghost_role, facial_hairstyle),
		NAMEOF_STATIC(ghost_role, haircolor),
		NAMEOF_STATIC(ghost_role, hairstyle),
		NAMEOF_STATIC(ghost_role, mob_species),
		NAMEOF_STATIC(ghost_role, outfit),
		NAMEOF_STATIC(ghost_role, skin_tone),
	)
	...
	var/static/list/required_vars = list(
		...
		NAMEOF_STATIC(ghost_role, prompt_name) = "Your ghost role has broken tgui without it.",
		...
		NAMEOF_STATIC(ghost_role, flavour_text) = "Spawners menu uses it.",
		NAMEOF_STATIC(ghost_role, you_are_text) = "Spawners menu uses it.",
	)
