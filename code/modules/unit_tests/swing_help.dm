...
/datum/unit_test/help_click/Run()
	var/mob/living/carbon/human/helps_the_guy = allocate(/mob/living/carbon/human/consistent)
	var/mob/living/carbon/human/gets_the_help = allocate(/mob/living/carbon/human/consistent)
