...
/datum/unit_test/mind_swap_spell/Run()
	...
	var/mob/living/carbon/human/swapper = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/to_swap = allocate(/mob/living/carbon/human/unit_test)
