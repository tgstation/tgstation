/datum/unit_test/amputation/Run()
	var/mob/living/carbon/human/patient = allocate(/mob/living/carbon/human/unit_test)
...
/datum/unit_test/head_transplant/Run()
	var/mob/living/carbon/human/user = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/alice = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/bob = allocate(/mob/living/carbon/human/unit_test)
...
/datum/unit_test/multiple_surgeries/Run()
	var/mob/living/carbon/human/user = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/patient_zero = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/patient_one = allocate(/mob/living/carbon/human/unit_test)
...
/datum/unit_test/tend_wounds/Run()
	...
	var/mob/living/carbon/human/naked_patient = allocate(/mob/living/carbon/human/unit_test)
	naked_patient.take_overall_damage(100)

	var/mob/living/carbon/human/clothed_patient = allocate(/mob/living/carbon/human/unit_test)
