...
/datum/unit_test/slips/Run()
	...
	var/mob/living/carbon/human/mso = allocate(/mob/living/carbon/human/unit_test)
	...
	var/mob/living/carbon/human/msos_friend_mso = allocate(/mob/living/carbon/human/unit_test, run_loc_floor_bottom_left)
