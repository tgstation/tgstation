...
/datum/unit_test/heretic_rituals/Run()
	...
	// Got to create ourselves a rune and a user to start.
	...
	// Now, let's instantiate our all_ritual_knowledge list with knowledge we're going to test.
	for(var/knowledge_type in typesof(/datum/heretic_knowledge))
		...
		// No needed atoms = it's not a ritual, delete it and move on
	...
	for(var/datum/heretic_knowledge/knowledge as anything in all_ritual_knowledge)
		...
		// if the ritual needs specific circumstances we can't setup in this test,
		...
		// Try to run the knowledge via the sacrifice rune.
