...
/datum/unit_test/embedding/Run()
	...
	TEST_ASSERT_EQUAL(bullet.embed_data.embed_chance, 100, "embed_chance failed to modify")
	...
	TEST_ASSERT_EQUAL(shrapnel.embed_data.embed_chance, 100, "embed_chance modification did not transfer to shrapnel")
