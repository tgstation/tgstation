...
/datum/unit_test/human_through_recycler/Run()
	var/mob/living/carbon/human/assistant = allocate(/mob/living/carbon/human/unit_test, run_loc_floor_bottom_left) // we should be in the bottom_left by default, but let's be sooper dooper sure :)
