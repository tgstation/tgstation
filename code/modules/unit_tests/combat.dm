/datum/unit_test/harm_punch/Run()
	var/mob/living/carbon/human/puncher = allocate(/mob/living/carbon/human/unit_test)
...
/datum/unit_test/harm_melee/Run()
	var/mob/living/carbon/human/tider = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/victim = allocate(/mob/living/carbon/human/unit_test)
...
/datum/unit_test/harm_different_damage/Run()
	var/mob/living/carbon/human/attacker = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/victim = allocate(/mob/living/carbon/human/unit_test)
