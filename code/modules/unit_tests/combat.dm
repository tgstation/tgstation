...
/datum/unit_test/attack_chain/Run()
	...
	register_signal(toolbox, COMSIG_ITEM_PRE_ATTACK, .proc/pre_attack_hit)
	register_signal(toolbox, COMSIG_ITEM_ATTACK, .proc/attack_hit)
	register_signal(toolbox, COMSIG_ITEM_AFTERATTACK, .proc/post_attack_hit)
