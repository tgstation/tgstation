...
// Todo : move all of these into their own files
...
/datum/unit_test/baton_swings/proc/check_results(mob/living/carbon/human/attacker, mob/living/carbon/human/victim)
...
/datum/unit_test/baton_swings/combat_mode_right_click/check_results(mob/living/carbon/human/attacker, mob/living/carbon/human/victim)
	. = ..()
...
/datum/unit_test/baton_swings/no_combat_mode_right_click/check_results(mob/living/carbon/human/attacker, mob/living/carbon/human/victim)
	TEST_ASSERT(attacker.next_move <= world.time, "Attacker had a cooldown despite not being in combat mode / swinging")
	TEST_ASSERT(victim.getStaminaLoss() == 0, "Victim took stamina damage despite not being hit by any swing")
