...
/// Tests the standard lungs organ to ensure it behaves the way we expect.
...
/// Tests the Plasmaman lungs organs to ensure it behaves the way we expect.
...
/datum/unit_test/lungs_sanity/proc/create_gas_mix(list/gases_to_percentages)
...
/datum/unit_test/lungs_sanity/proc/create_nitrogen_mix()
