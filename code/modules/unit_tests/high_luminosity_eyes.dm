...
/datum/unit_test/high_luminosity_eyes

/datum/unit_test/high_luminosity_eyes/Run()
	...
	test_screenshot("light_eyes_on", get_flat_icon_for_all_directions(test_subject))
	...
	test_screenshot("light_eyes_emissive", get_flat_icon_for_all_directions(test_subject))
