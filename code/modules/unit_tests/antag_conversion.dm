...
/datum/unit_test/revolution_conversion/Run()
	...
	TEST_ASSERT((peasant.get_status_effect_strength(/datum/status_effect/confusion) > 0), "Peasant was not confused after being flashed by the leader.") // Flash confuse
