...
/datum/unit_test/on_mob_end_metabolize/Run()
	...
	var/mob/living/carbon/human/user = allocate(/mob/living/carbon/human/unit_test)
...
/datum/unit_test/addictions/Run()
	...
	var/mob/living/carbon/human/pill_user = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/syringe_user = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/pill_syringe_user = allocate(/mob/living/carbon/human/unit_test)
