...
/datum/unit_test/knockoff_component/Run()
	var/mob/living/carbon/human/wears_the_glasses = allocate(/mob/living/carbon/human/unit_test)
	var/mob/living/carbon/human/shoves_the_guy = allocate(/mob/living/carbon/human/unit_test)
