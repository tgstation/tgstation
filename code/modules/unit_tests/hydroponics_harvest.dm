...
/datum/unit_test/hydroponics_harvest/proc/test_seed(obj/machinery/hydroponics/tray, obj/item/seeds/seed, mob/living/carbon/user)
	...
	var/expected_nutriments = descendent_seed.reagents_add[/datum/reagent/consumable/nutriment] * descendent_seed.potency / 100
	var/expected_vitamins = descendent_seed.reagents_add[/datum/reagent/consumable/nutriment/vitamin] * descendent_seed.potency / 100
