...
// 	var/list/list_to_check = deep_copy_list_alt(GLOB.heretic_start_knowledge)
...
// 			if(!knowledge_data)
// 				TEST_FAIL("Heretic Knowledge: Got a null knowledge data for [knowledge_path] in the heretic paths!")
// 				continue
...
// 				continue
// 			// Artur todo make this check across all shops
