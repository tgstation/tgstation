...
/turf/floor/holofloor/attackby(obj/item/weapon/W as obj, mob/user as mob)
...
/turf/floor/holofloor/beach/coast_t
	name = "coastline"
	icon_state = "sandwater_t"

/turf/floor/holofloor/beach/coast_b
	name = "coastline"
...
/turf/floor/holofloor/asteroid
	name = "Asteroid"
	icon_state = "asteroid0"

/turf/floor/holofloor/asteroid/New()
...
/turf/floor/holofloor/hyperspace
	name = "Hyperspace"
	icon = 'icons/turf/space.dmi'
	icon_state = "speedspace_ew_1"

/turf/floor/holofloor/hyperspace/New()
	icon_state = "speedspace_ew_[(x + 5*y + (y%2+1)*7)%15+1]"
	..()

/turf/floor/holofloor/hyperspace/ns/New()
	..()
...
/turf/floor/holofloor/carpet/New()
	..()
	spawn(1)
		update_icon()

/turf/floor/holofloor/carpet/update_icon()
	if(!..())
		return 0
	if(intact)
		smooth_icon(src)
