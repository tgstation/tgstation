...
/datum/uplink_item/dangerous/rapid
	...
	desc = "These gloves teach a martial art that allows the user to punch people very fast. Does not improve weapon attack speed or the meaty fists of a hulk."
