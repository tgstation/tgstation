...
/datum/uplink_item/role_restricted/rage_serum
	...
	desc = "An experimental mutation serum engineered by Syndicate researchers, based on stolen research on the Hulk gene discovered by Nanotrasen's Genetics divison. The serum heavily modifies the user's DNA and turns even the most timid person into a raging war-machine,\
