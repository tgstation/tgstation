...
/datum/uplink_item/dangerous/normalrevolver
	...
	desc = "A modernized, .357 revolver. Grown straight from our gatfruit farms. Fires 7 brutal rounds of .357 magnum. \
			Less obvious than our modernized revolvers, for plausible deniability."
...
/datum/uplink_item/dangerous/spes12
	...
	desc = "A shotgun capable of automatic fire but must still have it's pump racked to the next shell, can have 12 shells loaded at any time. \
			It'll be loaded with lethal shells upon purchase. Additional ammunition can be purchased under the ammunition tab."
	item = /obj/item/gun/ballistic/shotgun/combat/spes12
	cost = 12
	surplus = 15
	illegal_tech = TRUE
	purchasable_from = ~(UPLINK_NUKE_OPS | UPLINK_CLOWN_OPS)
...
/datum/uplink_item/dangerous/temperaturegun
	...
	desc = "A temperature gun orginally designed by Nanotrasen, given more lethal firepower by the Syndicate. \
			This temperature gun alters bodily temperature to a more significant degree disregarding the target's protection. \
			It's so powerful, it even burns the target on hit slightly. Comes loaded with a super power cell."
	item = /obj/item/gun/energy/temperature/syndicate
	cost = 8
	surplus = 15
	illegal_tech = TRUE
	purchasable_from = ~UPLINK_CLOWN_OPS
