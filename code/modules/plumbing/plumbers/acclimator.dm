...
/obj/machinery/plumbing/acclimator/process()
	...
	reagents.adjust_thermal_energy((target_temperature - reagents.chem_temp) * heater_coefficient * SSMACHINES_DT * SPECIFIC_HEAT_DEFAULT * reagents.total_volume) //keep constant with chem heater
