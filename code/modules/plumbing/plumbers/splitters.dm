...
/// it splits the reagents but you want.. So you can "every 60 units, 45 goes left and 15 goes straight".. The side direction is EAST, you can change this in the component
