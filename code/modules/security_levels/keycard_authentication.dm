...
/proc/make_maint_all_access()
	...
	minor_announce("Были сняты ограничения на доступ к техническому обслуживанию и внешним воздушным шлюзам.", "Внимание! По всей станции объявлена чрезвычайная ситуация!",1)
...
/proc/revoke_maint_all_access()
	...
	minor_announce("Ограничения доступа в зоны технического обслуживания были восстановлены.", "Внимание! Аварийная ситуация на всей станции отменена:")
