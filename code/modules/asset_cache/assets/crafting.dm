...
/datum/asset/spritesheet/crafting/proc/add_tool_icons()
	var/list/tool_icons = list(
		...
		TOOL_MULTITOOL = icon('icons/obj/devices/device.dmi', "multitool"),
		...
		TOOL_ANALYZER = icon('icons/obj/devices/device.dmi', "analyzer"),
		TOOL_MINING = icon('icons/obj/mining_zones/equipement.dmi', "minipick"),
		TOOL_SHOVEL = icon('icons/obj/mining_zones/equipement.dmi', "spade"),
