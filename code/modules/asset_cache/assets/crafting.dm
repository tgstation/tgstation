...
/datum/asset/spritesheet/crafting/proc/add_tool_icons()
	var/list/tool_icons = list(
		...
		TOOL_WRENCH = icon('icons/obj/tools.dmi', "wrench_stg"),
		...
		TOOL_RETRACTOR = icon('icons/obj/medical/surgery_tools.dmi', "retractor_stg"),
		TOOL_HEMOSTAT = icon('icons/obj/medical/surgery_tools.dmi', "hemostat_stg"),
		TOOL_CAUTERY = icon('icons/obj/medical/surgery_tools.dmi', "cautery_stg"),
		TOOL_DRILL = icon('icons/obj/medical/surgery_tools.dmi', "drill_stg"),
		TOOL_SCALPEL = icon('icons/obj/medical/surgery_tools.dmi', "scalpel_stg"),
		TOOL_SAW = icon('icons/obj/medical/surgery_tools.dmi', "saw_stg"),
		TOOL_BONESET = icon('icons/obj/medical/surgery_tools.dmi', "bonesetter_stg"),
		TOOL_KNIFE = icon('icons/obj/service/kitchen.dmi', "knife"),
		TOOL_BLOODFILTER = icon('icons/obj/medical/surgery_tools.dmi', "bloodfilter_stg"),
