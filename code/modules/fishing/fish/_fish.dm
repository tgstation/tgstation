...
#define FISH_SUBMERGING_THRESHOLD 80
#define STARVING_FISH_SUBMERGING_THRESHOLD 15
...
/obj/item/fish/process(seconds_per_tick)
	...
	if(on_safe_turf_counter >= (get_starvation_mult() ? STARVING_FISH_SUBMERGING_THRESHOLD : FISH_SUBMERGING_THRESHOLD))
