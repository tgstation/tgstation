...
/obj/item/fish/proc/pet_fish(mob/living/user)
	...
	if((/datum/fish_trait/aggressive in fish_traits) && prob(50))
		...
		playsound(src, 'sound/items/weapons/bite.ogg').volume(45).vary(TRUE).extra_range(-1).play()
	else
		if(in_aquarium)
		...
		playsound(src, 'sound/items/weapons/thudswoosh.ogg').volume(30).vary(TRUE).extra_range(-1).play()
