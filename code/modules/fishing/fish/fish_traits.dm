...
/datum/fish_trait/proc/apply_to_fish(obj/item/fish/fish)
	...
	if(reagents_to_add)
		...
		RegisterSignal(fish, COMSIG_EDIBLE_FISH_EATEN, PROC_REF(on_fish_eaten))
...
///Signal sent when the fish is being eaten by a mob because it has the edible component.
...
/datum/fish_trait/lubed
	...
	added_difficulty = 5
	reagents_to_add = list(/datum/reagent/lube = 3)
...
/datum/fish_trait/electrogenesis
	...
	reagents_to_add = list(/datum/reagent/consumable/liquidelectricity = 4)
...
/datum/fish_trait/electrogenesis/apply_to_fish(obj/item/fish/fish)
	...
	fish.grind_results -= /datum/reagent/blood

/datum/fish_trait/electrogenesis/on_fish_eaten(obj/item/fish/fish, list/reagents)
	. = ..()
...
/datum/fish_trait/hallucinogenic
	...
	reagents_to_add = list(/datum/reagent/toxin/mindbreaker/fish = 2.5)
