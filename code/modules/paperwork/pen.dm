...
/datum/writing_style/pen/New()
	...
	addReplacement(REG_BBTAG("small"), "<font size = \"2\">")
	addReplacement(REG_BBTAG("/small"), "</font>")
	addReplacement(REG_BBTAG("tiny"), "<font size = \"1\">")
	addReplacement(REG_BBTAG("/tiny"), "</font>")
	addReplacement(REG_BBTAG("list"), "<ul>")
	addReplacement(REG_BBTAG("/list"), "</ul>")
	addReplacement(REG_BBTAG("agency"),  	"<font face=\"Agency FB\">")
	addReplacement(REG_BBTAG("/agency"), 	"</font>")
	addReplacement(REG_BBTAG("algerian"),  	"<font face=\"Algerian\">")
	addReplacement(REG_BBTAG("/algerian"), 	"</font>")
	addReplacement(REG_BBTAG("arial"),  	"<font face=\"Arial\">")
	addReplacement(REG_BBTAG("/arial"), 	"</font>")
	addReplacement(REG_BBTAG("arialb"),  	"<font face=\"Arial Black\">")
	addReplacement(REG_BBTAG("/arialb"), 	"</font>")
	addReplacement(REG_BBTAG("calibri"),  	"<font face=\"Calibri\">")
	addReplacement(REG_BBTAG("/calibri"), 	"</font>")
	addReplacement(REG_BBTAG("courier"),  	"<font face=\"Courier\">")
	addReplacement(REG_BBTAG("/courier"), 	"</font>")
	addReplacement(REG_BBTAG("helvetica"),  "<font face=\"Helvetica\">")
	addReplacement(REG_BBTAG("/helvetica"), "</font>")
	addReplacement(REG_BBTAG("impact"),  	"<font face=\"Impact\">")
	addReplacement(REG_BBTAG("/impact"), 	"</font>")
	addReplacement(REG_BBTAG("palatino"),  	"<font face=\"Palatino Linotype\">")
	addReplacement(REG_BBTAG("/palatino"), 	"</font>")
	addReplacement(REG_BBTAG("tnr"),  		"<font face=\"Times New Roman\">")
	addReplacement(REG_BBTAG("/tnr"), 		"</font>")
