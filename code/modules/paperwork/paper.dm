...
/obj/item/office/paper/update_icon()
	if(info)
...
/obj/item/office/paper/verb/rename()
...
/obj/item/office/paper/attack_self(mob/user)
	examine()
...
/obj/item/office/paper/attack_ai(mob/living/silicon/ai/user)
	var/dist
...
/obj/item/office/paper/proc/addtofield(id, text, links = 0)
	var/locid = 0
	var/laststart = 1
	var/textindex = 1
...
/obj/item/office/paper/proc/updateinfolinks()
	info_links = info
	var/i = 0
	for(i=1,i<=fields,i++)
...
/obj/item/office/paper/proc/clearpaper()
	info = null
	stamps = null
	stamped = list()
	overlays.Cut()
...
/obj/item/office/paper/proc/parsepencode(t, obj/item/office/pen/P, mob/user, iscrayon = 0)
...
/obj/item/office/paper/proc/openhelp(mob/user)
...
/obj/item/office/paper/Topic(href, href_list)
	..()
	...
	if(href_list["write"])
		...
		if(!in_range(src, usr) && loc != usr && !istype(loc, /obj/item/office/clipboard) && loc.loc != usr && usr.get_active_hand() != i)	//Some check to see if he's allowed to write
			return
...
/obj/item/office/paper/attackby(obj/item/weapon/P, mob/user)
	..()
	...
	if(istype(P, /obj/item/office/pen) || istype(P, /obj/item/toy/crayon))
	...
	else if(istype(P, /obj/item/office/stamp))
		if(!in_range(src, usr) && loc != user && !istype(loc, /obj/item/office/clipboard) && loc.loc != user && user.get_active_hand() != P)
			return
		...
		if(istype(P, /obj/item/office/stamp/clown))
			if(!clown)
...
/obj/item/office/paper/Court
	name = "paper- 'Judgement'"
	info = "For crimes against the station, the offender is sentenced to:<BR>\n<BR>\n"

/obj/item/office/paper/Toxin
...
/obj/item/office/paper/courtroom
...
/obj/item/office/paper/hydroponics
...
/obj/item/office/paper/djstation
...
/obj/item/office/paper/crumpled
	name = "paper scrap"
	icon_state = "scrap"

/obj/item/office/paper/crumpled/update_icon()
	return


/obj/item/office/paper/crumpled/bloody
