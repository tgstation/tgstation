...
/obj/effect/mob_spawn/attack_ghost(mob/user)
	...
	if(jobban_isbanned(user, banType))
		...
		return
	var/ghost_role = wrap_alert(usr, "Become [mob_name]? (Warning, You can no longer be cloned!)",,"Yes","No")
...
/obj/effect/mob_spawn/human/alive/space_bar_patron/attack_hand(mob/user)
	var/despawn = wrap_alert(usr, "Return to cryosleep? (Warning, Your mob will be deleted!)",,"Yes","No")
