...
/obj/item/paper/fluff/awaymissions/caves/safety_notice
	name = "safety notice"
	info = "<center>Some of the miners have gone to laying some mine traps throughout the lower levels of the mine to keep the monsters at bay.  This probably isn't the smartest idea in a cavern like this but the boys seem to get a chuckle out of every distant blast they hear go off, so I guess it works </center>"
