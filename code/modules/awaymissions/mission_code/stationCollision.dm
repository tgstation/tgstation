...
//	projectile_type = "/obj/projectile/practice"
	clumsy_check = ZERO //No sense in having a harmless gun blow up in the clowns face
...
/obj/singularity/narsie/mini
	...
	move_self = ZERO //Contianed narsie does not move!
	grav_pull = ZERO //Contained narsie does not pull stuff in!
