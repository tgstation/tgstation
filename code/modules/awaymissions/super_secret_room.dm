...
/obj/structure/speaking_tile/interact(mob/user)
	...
	switch(times_spoken_to)
		...
		if(251)
			...
			var/obj/item/reagent_containers/food/drinks/trophy/silver_cup/the_ride = new(user.drop_location())
		...
		if(5643)
			...
			var/obj/item/reagent_containers/food/drinks/trophy/gold_cup/never_ends = new(user.drop_location())
