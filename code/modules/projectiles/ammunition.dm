...
GLOBAL_LIST_INIT(bullet_bounce_away_sizzle, typecacheof(list(
	...
	/turf/open2/floor/grass/snow,
	/turf/open2/floor/holofloor/snow,
	/turf/open2/floor/plating/asteroid/snow,
	/turf/open2/floor/plating/ice,
	/turf/open2/water)))
...
GLOBAL_LIST_INIT(bullet_bounce_away_blacklist, typecacheof(list(
	...
	/turf/closed/wall/mineral/snow,
	/turf/open2/chasm,
	/turf/open2/floor/carpet,
	/turf/open2/floor/grass,
	...
	/turf/open2/floor/holofloor/snow,
	/turf/open2/floor/plating/asteroid/snow,
	/turf/open2/floor/plating/beach,
