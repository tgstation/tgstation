...
/obj/item/ammo_casing/a40mm/sabot
	name = "40mm amfsd sabot"
	desc = "A 40mm shell packed with one anti-material, fin stabalised, discarding sabot."
	caliber = "40mm"
	icon_state = "40mmsabot"
