...
/obj/item/projectile/proc/on_hit(atom/target, blocked = 0)
	...
	if(blocked != 100) // not completely blocked
		...
		if(suppressed)
			...
			L.visible_message("<span class='danger'>[IDENTITY_SUBJECT(1)] is hit by \a [src][organ_hit_text]!</span>", \
					"<span class='userdanger'>[IDENTITY_SUBJECT(1)] is hit by \a [src][organ_hit_text]!</span>", null, COMBAT_MESSAGE_RANGE, subjects=list(L))
		L.on_hit(src)
