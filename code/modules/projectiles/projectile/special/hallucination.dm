...
/obj/projectile/hallucination/taser/hal_apply_effect()
	...
	hal_target.add_timed_status_effect(40 SECONDS, /datum/status_effect/speech/stutter)
...
/obj/projectile/hallucination/ebow/hal_apply_effect()
	hal_target.Paralyze(100)
	hal_target.add_timed_status_effect(10 SECONDS, /datum/status_effect/speech/stutter)
