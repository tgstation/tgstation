...
/obj/projectile/hallucination/taser/hal_apply_effect()
	...
	hal_target.add_speech_impediment(40 SECONDS, /datum/status_effect/speech/stutter)
...
/obj/projectile/hallucination/ebow/hal_apply_effect()
	hal_target.Paralyze(100)
	hal_target.add_speech_impediment(10 SECONDS, /datum/status_effect/speech/stutter)
