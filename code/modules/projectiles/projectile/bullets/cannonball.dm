...
/obj/projectile/bullet/cannonball/on_hit(atom/target, blocked = FALSE, pierce_hit)
...
/obj/projectile/bullet/cannonball/explosive/on_hit(atom/target, blocked = FALSE, pierce_hit)
...
/obj/projectile/bullet/cannonball/emp/on_hit(atom/target, blocked = FALSE, pierce_hit)
	empulse(src, 4, 10)
	. = ..()
...
/obj/projectile/bullet/cannonball/biggest_one/on_hit(atom/target, blocked = FALSE, pierce_hit)
