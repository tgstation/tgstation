...
/obj/projectile/bullet/c38/trac/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/bullet/c38/hotshot/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
	if(iscarbon(target))
		var/mob/living/carbon/M = target
...
/obj/projectile/bullet/c38/iceblox/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
	if(isliving(target))
