...
/obj/projectile/magic/wipe/proc/possession_test(mob/living/carbon/target)
	...
	var/list/mob/dead/observer/candidates = SSpolling.poll_ghost_candidates_for_mob(poll_message, jobban = ROLE_PAI, poll_time = 10 SECONDS, target_mob = target, pic_source = target)
