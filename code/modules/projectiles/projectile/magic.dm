...
/obj/projectile/magic/locker/Destroy()
	locker_suck = FALSE
	remove_element(/datum/element/connect_loc, projectile_connections) //We do this manually so the forcemoves don't "hit" us. This behavior is kinda dumb, someone refactor this
	for(var/atom/movable/AM in contents)
