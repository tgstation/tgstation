...
/obj/item/gun/magic/hook/can_trigger_gun(mob/living/user) // This isn't really a gun, so it shouldn't be checking for TRAIT_NO_GUNS, a firing pin (pinless), or a trigger guard (guardless)
	return TRUE
