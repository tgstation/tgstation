...
/obj/item/gun/ballistic/automatic/pistol/clandestine/fisher
	...
	desc = "An aftermarket modification to the Ansem, featuring an integral suppressor and push-button trigger on the grip for an underbarrel-mounted light-disruptor. \
	Chambered in 10mm."
