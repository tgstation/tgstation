...
/obj/item/gun/ballistic/rifle/boltaction/pipegun/donk
	name = "\improper Donk Co. Arquebus"
	icon_state = "donk_musket"
	inhand_icon_state = "donk_musket"
	worn_icon_state = "donk_musket"
	desc = "A large bore breechloading firearm with a classy wooden frame. Cheap to buy and easy to maintain, but needs to reload after every shot."
	semi_auto = TRUE
