...
/obj/item/gun/energy/plasmacutter/use_tool(atom/target, mob/living/user, delay, amount=1, volume=0, bonus_time=0, focus_sound=null, datum/callback/extra_checks)
	if(amount)
		. = ..()
	else
		. = ..(amount=1)
