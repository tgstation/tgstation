DEFINE_PROC_VERB(/client, makepAI, "Make pAI", "Specify a location to spawn a pAI device, then specify a key to play that pAI", FALSE, "Admin.Fun", turf/target in GLOB.mob_list)
