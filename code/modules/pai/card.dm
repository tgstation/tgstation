...
/obj/item/pai_card/proc/find_pai(mob/user)
	...
	notify_ghosts("[user] is requesting a pAI companion! Use the pAI button to submit yourself as one.", source = user, alert_overlay = alert_overlay, action = NOTIFY_ORBIT, notify_flags = NOTIFY_CATEGORY_NOFLASH, header = "pAI Request!", ignore_key = POLL_IGNORE_PAI)
