...
/proc/get_all_jobs()
	return list("Commanding Officer","Executive Officer","Bartender","Chef","Chief Engineering Officer","Engineer",
				"Transporter Technician","Holodeck Technician","Chief Medical Officer","Medical Officer","Nurse","Counsellor",
				"Chief of Operations","Helmsman","Quartermaster","Comms Technician","Duty Officer","Research Director",
				"Science Officer","Astrometrics Officer","Biologist","Sensor Technician","Chief Security Officer",
				"Tactical Officer","Security Officer","Armory Officer","AI","Morale Officer","Intelligence Officer","Diplomat",
				"Judge Advocate General","Honored Guest","Trader")
