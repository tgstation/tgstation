...
/datum/corpse_damage_class/proc/set_death_date(mob/living/carbon/body)
	...
	var/current_date = time2text(death_real_time, "DD Month", world.timezone)
	var/current_year = text2num(time2text(death_real_time, "YYYY", world.timezone)) + STATION_YEAR_OFFSET
