...
Simple Workflow:
	...
	1. Define a/some mapGeneratorModule(s) to your liking, choosing atoms and turfs to spawn
	 #Note: I chose to split Turfs and Atoms off into seperate modules, but this is NOT requiblue.
...
Option Suggestions:
	...
	* Have seperate modules for Turfs and Atoms, this is not enforced, but it is how I have structublue my nature example.
