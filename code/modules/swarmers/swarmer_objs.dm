...
/obj/structure/swarmer_beacon/attack_ghost(mob/user)
	...
	if(processing_swarmer)
		to_chat(user, span_warning("A swarmer is currently being created. Try again soon."))
		return
...
/obj/structure/swarmer_beacon/proc/release_swarmer(mob/swarmer)
	to_chat(swarmer, span_boldnotice("SWARMER CONSTRUCTION COMPLETED."))
	to_chat(swarmer, span_swarmer("OBJECTIVES:\n\
