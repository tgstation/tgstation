...
/mob/living/animal/hostile/spawner/lavaland/ash_walker
...
/mob/living/animal/hostile/spawner/lavaland/ash_walker/death()
	new /obj/item/device/assembly/signaler/anomaly (get_step(loc, pick(GLOB.alldirs)))
	return ..()

/mob/living/animal/hostile/spawner/lavaland/ash_walker/handle_automated_action()
	consume()
	return ..()

/mob/living/animal/hostile/spawner/lavaland/ash_walker/proc/consume()
...
/mob/living/animal/hostile/spawner/lavaland/ash_walker/spawn_mob()
