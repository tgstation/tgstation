...
/datum/export/material/bananium
	cost = 1000
	material_id = MAT_CATEGORY_BANANIUM
	message = "cm3 of bananium"

/datum/export/material/diamond
	cost = 500
	material_id = MAT_CATEGORY_DIAMOND
	message = "cm3 of diamonds"

/datum/export/material/plasma
	cost = 200
	k_elasticity = 0
	material_id = MAT_CATEGORY_PLASMA
	message = "cm3 of plasma"

/datum/export/material/uranium
	cost = 100
	material_id = MAT_CATEGORY_URANIUM
	message = "cm3 of uranium"

/datum/export/material/gold
	cost = 125
	material_id = MAT_CATEGORY_GOLD
	message = "cm3 of gold"

/datum/export/material/silver
	cost = 50
	material_id = MAT_CATEGORY_SILVER
	message = "cm3 of silver"

/datum/export/material/titanium
	cost = 125
	material_id = MAT_CATEGORY_TITANIUM
	message = "cm3 of titanium"

/datum/export/material/plastitanium
	cost = 325 // plasma + titanium costs
	material_id = MAT_CATEGORY_TITANIUM // code can only check for one material_id; plastitanium is half plasma, half titanium
	message = "cm3 of plastitanium"

/datum/export/material/metal
	cost = 5
	message = "cm3 of metal"
	material_id = MAT_CATEGORY_IRON
	export_types = list(
...
/datum/export/material/glass
	...
	material_id = MAT_CATEGORY_GLASS
