...
/datum/supply_pack/security/ammo
	...
	desc = "Contains three boxes of beanbag shotgun shells, three boxes \
		...
		Requires Security access to open, or Armory access to purchase."
...
/datum/supply_pack/security/armor
	...
	desc = "Three vests of well-rounded, decently-protective armor. \
		Requires Security access to open or purchase."
...
/datum/supply_pack/security/disabler
	name = "Disabler Crate"
	desc = "Three stamina-draining disabler weapons. Requires Security access to open or purchase."
...
/datum/supply_pack/security/forensics
	...
	desc = "Stay hot on the criminal's heels with Nanotrasen's Detective Essentials™. \
		...
		and of course, a fedora. Requires Security access to open, or Morgue access to purchase."
...
/datum/supply_pack/security/laser
	name = "Lasers Crate"
	desc = "Contains three lethal, high-energy laser guns. Requires Security access to open, or Armory access to purchase."
...
/datum/supply_pack/security/securitybarriers
	...
	desc = "Stem the tide with four Security Barrier grenades. Requires Security access to open, or Brig access to purchase."
...
/datum/supply_pack/security/stingpack
	...
	desc = "Contains five \"stingbang\" grenades, perfect for stopping \
		riots and playing morally unthinkable pranks. Requires Security access to open, or Armory access to purchase."
...
/datum/supply_pack/security/armory/bulletarmor
	...
	desc = "Contains three sets of bulletproof armor. Guaranteed to reduce a bullet's \
		stopping power by over half. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 3
...
/datum/supply_pack/security/armory/bullethelmets
	...
	desc = "Contains three bulletproof helmets. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 3
...
/datum/supply_pack/security/armory/chemimp
	...
	desc = "Contains five Remote Chemical implants. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 3.5
...
/datum/supply_pack/security/armory/ballistic
	...
	desc = "For when the enemy absolutely needs to be replaced with lead. \
		...
		Requires Armory access to open or purchase."
...
/datum/supply_pack/security/armory/energy
	...
	desc = "Contains two Energy Guns, capable of firing both nonlethal and lethal \
		blasts of light. Requires Armory access to open or purchase."
...
/datum/supply_pack/security/armory/exileimp
	...
	desc = "Contains five Exile implants. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 3.5
...
/datum/supply_pack/security/armory/fire
	...
	desc = "Burn, baby burn. Contains three incendiary grenades, three plasma canisters, \
		and a flamethrower. Requires Armory access to open or purchase."
...
/datum/supply_pack/security/armory/laserarmor
	...
	desc = "Contains two vests of highly reflective material. Each armor piece \
		...
		to reflect the laser entirely. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 5
...
/datum/supply_pack/security/armory/riotarmor
	...
	desc = "Contains three sets of heavy body armor. Advanced padding protects \
		...
		potent to the user. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 6
...
/datum/supply_pack/security/armory/riothelmets
	...
	desc = "Contains three riot helmets. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 4
...
/datum/supply_pack/security/armory/russian
	...
	desc = "Hello Comrade, we have the most modern russian military equipment the \
		...
		the lock, so it requires Armory access to open or purchase."
...
/datum/supply_pack/security/armory/swat
	...
	desc = "Contains two fullbody sets of tough, fireproof suits designed in a joint \
		...
		and combat gloves. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 7
...
/datum/supply_pack/security/armory/thermal
	...
	desc = "Contains a pair of holsters each with two experimental thermal pistols, \
		using nanites as the basis for their ammo. Requires Armory access to open or purchase."
	cost = CARGO_CRATE_VALUE * 7
