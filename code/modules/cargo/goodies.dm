...
/datum/supply_pack/goody/dumdum38
	...
	desc = "Contains one speedloader of .38 DumDum ammunition, good for embedding in soft targets. Requires Brig access to purchase."
...
/datum/supply_pack/goody/match38
	...
	desc = "Contains one speedloader of match grade .38 ammunition, perfect for showing off trickshots. Requires Brig access to purchase."
	cost = PAYCHECK_CREW * 2
	access_view = ACCESS_BRIG
...
/datum/supply_pack/goody/rubber
	...
	desc = "Contains one speedloader of bouncy rubber .38 ammunition, for when you want to bounce your shots off anything and everything. Requires Brig access to purchase."
...
/datum/supply_pack/goody/mars_single
	...
	desc = "The HoS took your gun and your badge? No problem! Just pay the absurd taxation fee and you too can be reunited with the lethal power of a .38! Requires Detective access to purchase."
...
/datum/supply_pack/goody/stingbang
	...
	desc = "Contains one \"stingbang\" grenade, perfect for playing meanhearted pranks. Requires Brig access to purchase."
...
/datum/supply_pack/goody/ballistic_single
	...
	desc = "For when the enemy absolutely needs to be replaced with lead. Contains one Aussec-designed Combat Shotgun, and one Shotgun Bandolier. Requires Armory access to purchase."
...
/datum/supply_pack/goody/energy_single
	...
	desc = "Contains one energy gun, capable of firing both nonlethal and lethal blasts of light. Requires Armory access to purchase."
...
/datum/supply_pack/goody/hell_single
	...
	desc = "Contains one hellgun degradation kit, an old pattern of laser gun infamous for its ability to horribly disfigure targets with burns. Technically violates the Space Geneva Convention when used on humanoids. Requires Armory access to purchase."
	cost = PAYCHECK_CREW * 2
	access_view = ACCESS_ARMORY
...
/datum/supply_pack/goody/thermal_single
	...
	desc = "Contains twinned thermal pistols in a holster, ready for use in the field. Requires Armory access to purchase."
	cost = PAYCHECK_COMMAND * 15
	access_view = ACCESS_ARMORY
