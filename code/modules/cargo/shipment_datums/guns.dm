/datum/shipping/foam_force_shotguns
	name = "FOAM FORCE(tm) Shotguns"
	value = 126
	sell_type = /obj/item/weapon/gun/projectile/shotgun/toy
	amount_on_market = 200
	category = "Weapons"

/datum/shipping/flashbangs
	name = "Flashbang Boxes"
	value = 250
