...
/datum/supply_pack/security/ammo
	name = "Ammo Crate"
	desc = "Contains two boxes each of voidshot, beanbag, and rubbershot shotgun shells, as well one of each kind of special .38 speedloaders. Requires Security access to open."
