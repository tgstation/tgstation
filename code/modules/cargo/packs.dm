...
/datum/supply_pack/organic/exoticseeds
	...
	desc = "Any entrepreneuring botanist's dream. Contains fifteen different seeds, including two replica-pod seeds, two genesis-pod seeds, and two mystery seeds!"
	cost = 1500
