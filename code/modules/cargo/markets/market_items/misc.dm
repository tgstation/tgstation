...
/datum/market_item/misc/smugglers_satchel
	...
	desc = "This easily hidden satchel can become a versatile tool to anybody with the desire to keep certain items out of sight and out of mind. It contents cannot be detected by contraband scanners."
