...
ADMIN_VERB(centcom_podlauncher, "Config/Launch Supplypod", "Configure and launch a CentCom supplypod full of whatever your heart desires!", R_ADMIN, VERB_CATEGORY_EVENTS)
