...
/datum/round_event/coffee/start()
	for(var/mob/living/carbon/human/H in living_mob_list)
		H.unEquip(H.r_hand)
		var/obj/item/I = new /obj/item/weapon/reagent_containers/food/drinks/coffee(get_turf(H))
		H.equip_to_slot_or_del(I, H.r_hand)
		for(var/obj/structure/table/T in range(H,5))
			var/obj/item/J = new /obj/item/weapon/reagent_containers/food/drinks/coffee(get_turf(T))

/datum/round_event/coffee/announce()
