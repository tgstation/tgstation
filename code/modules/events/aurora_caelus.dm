...
/datum/round_event/aurora_caelus/announce()
	priority_announce("[station_name()]: A harmless cloud of ions is approaching your station, and will exhaust their energy battering the hull. The Animal Rights Consortium has stepped in to ensure you get to view the lights! During this time, starlight will be bright but gentle, shifting between quiet green and blue colors. Any staff who would like to view these lights for themselves may proceed to the area nearest to them with viewing ports to open space. This is what we fight for. The freedom of the universe.",
	sound = 'sound/misc/notice2.ogg',
	sender_override = "Animal Rights Consortium")
