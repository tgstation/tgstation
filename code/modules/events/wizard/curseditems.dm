...
/datum/round_event/wizard/cursed_items/start()
	...
	switch(item_set)
		if("wizardmimic")	loadout = list(/obj/item/clothing/suit/wizrobe, /obj/item/clothing/shoes/sandal, /obj/item/clothing/head/wizard)
		if("swords")		loadout[5] = /obj/item/weapon/katana
		if("bigfatdoobie")	loadout[4] = /obj/item/clothing/mask/cigarette/rollie/trippy/
		if("boxing")
