...
/datum/round_event/wizard/deprevolt/start()
	...
	switch(tidecolor)
		if("grey") //God help you
			...
			nation = pick("Assa", "Mainte", "Tunnel", "Gris", "Grey", "Liath", "Xám", "Grigio", "グレー", "Ass", "Assi")
		if("white")
	...
	nation += pick("stan", "topia", "land", "nia", "ca", "tova", "dor", "ador", "tia", "sia", "ano", "tica", "tide", "cis", "marea", "co", "潮", "marée", "taoide", "slavia", "stotska")
