/datum/round_event_control/portal_storm_syndicate
	name = "Portal Storm: Nanotrasen Shocktroops"
...
/datum/round_event/portal_storm/syndicate_shocktroop
	boss_types = list(/mob/living/simple_animal/hostile/nanotrasen/ranged/smg = 2)
	hostile_types = list(/mob/living/simple_animal/hostile/nanotrasen = 8,\
						/mob/living/simple_animal/hostile/nanotrasen/ranged = 2)
