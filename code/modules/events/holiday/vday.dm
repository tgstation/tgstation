...
/datum/round_event/valentines/start()
	...
	while(valentines.len)
		...
		if(valentines.len)
			...
			if(valentines.len && SSrng.probability(4))
...
/obj/item/reagent_containers/food/snacks/candyheart/New()
	..()
	desc = "A heart-shaped candy that reads: " + SSrng.pick_from_list(
		"HONK ME",
		"ERP",
		"LEWD",
		"LUSTY",
		...
		"COCK CULT",
		"PET ME")
	icon_state = SSrng.pick_from_list("candyheart", "candyheart2", "candyheart3", "candyheart4")
