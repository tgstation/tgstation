/datum/round_event_control/anomaly_bluespace
	name = "Bluespace Anomaly"
	typepath = /datum/round_event/anomaly_bluespace
	max_occurrences = 1
	weight = 5

/datum/round_event/anomaly_bluespace
	startWhen = 3
	announceWhen = 10
	endWhen = 55
...
/datum/round_event/anomaly_bluespace/setup()
...
/datum/round_event/anomaly_bluespace/announce()
...
/datum/round_event/anomaly_bluespace/start()
	var/turf/T = pick(get_area_turfs(impact_area))
	if(T)
		newblue = new /obj/effect/anomaly/bluespace(T.loc)

/datum/round_event/anomaly_bluespace/tick()
	if(!newblue)
		kill()
		return

/datum/round_event/anomaly_bluespace/end()
	if(newblue)
		var/turf/T = pick(get_area_turfs(impact_area))
		if(T)
