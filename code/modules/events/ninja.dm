...
/mob/living/carbon/human/proc/equip_space_ninja(safety=0)//Safety in case you need to unequip stuff for existing characters.
	...
	equip_to_slot_or_qdel(R, slot_ears)
	if(gender==FEMALE)
	...
	equip_to_slot_or_qdel(new /obj/item/clothing/shoes/space_ninja(src), slot_shoes)
	equip_to_slot_or_qdel(new /obj/item/clothing/suit/space/space_ninja(src), slot_wear_suit)
	equip_to_slot_or_qdel(new /obj/item/clothing/gloves/space_ninja(src), slot_gloves)
	equip_to_slot_or_qdel(new /obj/item/clothing/head/helmet/space/space_ninja(src), slot_head)
	equip_to_slot_or_qdel(new /obj/item/clothing/mask/gas/voice/space_ninja(src), slot_wear_mask)
	equip_to_slot_or_qdel(new /obj/item/device/flashlight(src), slot_belt)
	equip_to_slot_or_qdel(new /obj/item/weapon/plastique(src), slot_r_store)
	equip_to_slot_or_qdel(new /obj/item/weapon/plastique(src), slot_l_store)
	equip_to_slot_or_qdel(new /obj/item/weapon/tank/emergency_oxygen(src), slot_s_store)
	equip_to_slot_or_qdel(new /obj/item/weapon/tank/jetpack/carbondioxide(src), slot_back)
