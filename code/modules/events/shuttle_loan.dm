...
/datum/round_event/shuttle_loan/announce()
	...
	switch(dispatch_type)
		...
		if (PIZZA_DELIVERY)
			priority_announce("Cargo: Your station lacks socialzations skills. Centcomm will dispatch emergency pizza to remedy this.","Centcomm Station Socialisation Programme")
...
/datum/round_event/shuttle_loan/proc/loan_shuttle()
	...
	switch(dispatch_type)
		...
		if(PIZZA_DELIVERY)
			SSshuttle.centcom_message += "Pizza delivery for Spacestation 13"
