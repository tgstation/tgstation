...
/datum/round_event/tram_malfunction/end()
	...
	priority_announce("We've successfully reset the software of the tram, normal operations are now resuming. Sorry for the inconvienence.", "CentCom Engineering Division")
