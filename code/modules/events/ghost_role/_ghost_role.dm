...
/datum/round_event/ghost_role
	...
	VAR_FINAL/list/priority_candidates = list() //expected to contain 0 or more /clients (or things with .key)
	...
	VAR_FINAL/list/spawned_mobs = list()
	...
	VAR_FINAL/cached_announcement_chance
