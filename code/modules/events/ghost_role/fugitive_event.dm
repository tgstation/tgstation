...
/datum/round_event/ghost_role/fugitives/spawn_role()
	...
	var/list/candidates = SSpolling.poll_ghost_candidates(check_jobban = ROLE_FUGITIVE, role = ROLE_FUGITIVE)
...
/datum/round_event/ghost_role/fugitives/proc/spawn_hunters(backstory)
	var/list/candidates = SSpolling.poll_ghost_candidates("Do you wish to be considered for a group of [backstory]?", check_jobban = ROLE_FUGITIVE_HUNTER, role_name_text = backstory)
