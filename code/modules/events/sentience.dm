...
/datum/round_event/ghost_role/sentience/spawn_role()
	...
	candidates = SSpolling.poll_ghost_candidates(role = ROLE_SENTIENCE, jobban = ROLE_SENTIENCE, pic_source = /obj/item/slimepotion/slime/sentience, role_name_text = role_name)
