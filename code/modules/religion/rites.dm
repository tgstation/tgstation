...
/datum/religion_rites/synthconversion
        ...
        ritual_invocations = list("По внутренним разработкам бога нашего...",
                                                "... Призываем тебя,пред лицом невзгод ...",
                                                "... Дабы завершить нас, удалив ненужное ...")
        invoke_msg = "... Восстань же,чемпион наш, Стань тем что твоя душа желает,живи в мире таком же как и твоя форма истинная!!"
        favor_cost = 1000
...
/datum/religion_rites/machine_blessing
        ...
        ritual_invocations =list( "Дай нам силы своей...",
                                                        "...Помоги нам в нашем великом завоевании!")
        invoke_msg = "КОНЕЦ ПЛОТИ ГРЯДЕТ НЕОСТАНОВИМЫМ МАРШЕМ!"
        favor_cost = 2000
...
/datum/religion_rites/greed
        ritual_length = 5 SECONDS
        invoke_msg = "Прости я опоздал, Я просто зарабатывал кучу денег."
        var/money_cost = 0
...
/datum/religion_rites/greed/vendatray
        ...
        invoke_msg = "Мне нужен Венд-О-Трей чтобы получить денег!"
        money_cost = 300
...
/datum/religion_rites/greed/custom_vending
        ...
        invoke_msg = "Если Я получу вендомат который я смогу менять, Я стану богатым!"
...
/datum/religion_rites/maint_adaptation
        ...
        ritual_invocations = list("Я отказываюсь от мира ...",
        "... дабы стать одним с глубиной.",
        "Моя форма станет искажённой ...")
        invoke_msg = "... но улыбка моя останется на века!"
...
/datum/religion_rites/adapted_eyes
        ...
        ritual_length = 10 SECONDS
        invoke_msg = "Больше Я не хочу видеть свет..."
...
/datum/religion_rites/sparring_contract
        ...
        invoke_msg = "Я буду тренироваться во имя господа своего..."
...
/datum/religion_rites/declare_arena
        ...
        ritual_invocations = list("Я ищу место для боёв своих ...")
        invoke_msg = "... может путь мой быть не лёгким."
