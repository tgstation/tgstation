...
/datum/religion_sect/spook/tool_examine(mob/living/holy_creature) //explain how the ghost and cooldown system works
	return "To use the power of [GLOB.deity], the spirits of the dead must surround you. After granting you a favor, they will need time to recuperate."
