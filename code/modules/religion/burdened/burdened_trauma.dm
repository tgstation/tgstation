	...
	switch(burden_level)
		...
		if(2)
			if(increase)
				...
				dna.remove_mutation(/datum/mutation/telepathy)
				dna.remove_mutation(/datum/mutation/unintelligible)
		...
		if(3)
			if(increase)
				...
				dna.add_mutation(/datum/mutation/telepathy)
				dna.add_mutation(/datum/mutation/unintelligible)
		...
		if(5)
			if(increase)
				...
				if (!silent)
					to_chat(owner, span_warning("The weight on your shoulders feels lighter. You have lost some universal truths."))
				dna.remove_mutation(/datum/mutation/telekinesis)
				dna.remove_mutation(/datum/mutation/mindreader)
		if(6)
			if(increase)
				if (!silent)
				...
				dna.add_mutation(/datum/mutation/telekinesis)
				dna.add_mutation(/datum/mutation/mindreader)
			else
				if (!silent)
					to_chat(owner, span_warning("The weight on your shoulders feels lighter. You feel like you're about to forget."))
		if(7)
