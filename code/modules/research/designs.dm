...
- MAT_CATEGORY_IRON (/obj/item/stack/metal).
- MAT_CATEGORY_GLASS (/obj/item/stack/glass).
- MAT_CATEGORY_PLASMA (/obj/item/stack/plasma).
- MAT_CATEGORY_SILVER (/obj/item/stack/silver).
- MAT_CATEGORY_GOLD (/obj/item/stack/gold).
- MAT_CATEGORY_URANIUM (/obj/item/stack/uranium).
- MAT_CATEGORY_DIAMOND (/obj/item/stack/diamond).
- MAT_CATEGORY_BANANIUM (/obj/item/stack/bananium).
