...
/datum/design/hostile_environiment_suit
	...
	build_path = /obj/item/clothing/suit/space/hostile_environiment
	category = list("Mining Designs")

/datum/design/hostile_environiment_helmet
	...
	build_path = /obj/item/clothing/head/helmet/space/hostile_environiment
	category = list("Mining Designs")
