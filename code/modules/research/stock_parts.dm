...
/obj/item/stock_parts/manipulator
	...
	materials = list(/datum/material/hematite=30)

/obj/item/stock_parts/micro_laser
	name = "micro-laser"
	desc = "A tiny laser used in certain devices."
	icon_state = "micro_laser"
	materials = list(/datum/material/hematite=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin
	name = "matter bin"
	desc = "A container designed to hold compressed matter awaiting reconstruction."
	icon_state = "matter_bin"
	materials = list(/datum/material/hematite=80)
...
/obj/item/stock_parts/subspace/ansible
	...
	materials = list(/datum/material/hematite=30, /datum/material/glass=10)
