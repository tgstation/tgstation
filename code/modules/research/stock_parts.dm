...
/obj/item/stock_parts/capacitor
	...
	materials = list(MAT_CATEGORY_IRON=50, MAT_CATEGORY_GLASS=50)

/obj/item/stock_parts/scanning_module
	name = "scanning module"
	desc = "A compact, high resolution scanning module used in the construction of certain devices."
	icon_state = "scan_module"
	materials = list(MAT_CATEGORY_IRON=50, MAT_CATEGORY_GLASS=20)

/obj/item/stock_parts/manipulator
	name = "micro-manipulator"
	desc = "A tiny little manipulator used in the construction of certain devices."
	icon_state = "micro_mani"
	materials = list(MAT_CATEGORY_IRON=30)

/obj/item/stock_parts/micro_laser
	name = "micro-laser"
	desc = "A tiny laser used in certain devices."
	icon_state = "micro_laser"
	materials = list(MAT_CATEGORY_IRON=10, MAT_CATEGORY_GLASS=20)

/obj/item/stock_parts/matter_bin
	name = "matter bin"
	desc = "A container designed to hold compressed matter awaiting reconstruction."
	icon_state = "matter_bin"
	materials = list(MAT_CATEGORY_IRON=80)
...
/obj/item/stock_parts/subspace/ansible
	...
	materials = list(MAT_CATEGORY_IRON=30, MAT_CATEGORY_GLASS=10)
...
/obj/item/stock_parts/subspace/crystal
	...
	materials = list(MAT_CATEGORY_GLASS=50)
