...
/obj/machinery/computer/rdservercontrol/Topic(href, href_list)
	...
	if(href_list["main"])
		...
		var/choice = wrap_alert(usr, "Technology Data Reset", "Are you sure you want to reset this technology to its default data? Data lost cannot be recovered.", "Continue", "Cancel")
		...
		var/choice = wrap_alert(usr, "Design Data Deletion", "Are you sure you want to delete this design? Data lost cannot be recovered.", "Continue", "Cancel")
		if(choice == "Continue" && usr.canUseTopic(src))
