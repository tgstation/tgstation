...
/obj/item/autoslime/attack_self(mob/user)
	var/reagentselect = input(user, "Choose the reagent the extract will produce.", "Self-sustaining Reaction") as null|anything in sortList(extract.activate_reagents)
	var/amount = 5
	var/secondary
