...
/obj/item/slime_cookie/attack(mob/living/M, mob/user)
	...
	if(fed)
		...
		playsound(get_turf(M), 'sound/items/eatfood.ogg', 20, DEFAULT_SOUND_VARY)
		if(nutrition)
...
/obj/item/slime_cookie/bluespace/do_effect(mob/living/M, mob/user)
	...
	if(target)
		...
		playsound(get_turf(M), "sparks", 50, DEFAULT_SOUND_VARY)
...
/obj/item/slime_cookie/red/do_effect(mob/living/M, mob/user)
	...
	playsound(get_turf(M), 'sound/effects/splat.ogg', 10, DEFAULT_SOUND_VARY)
	if(iscarbon(M))
...
/obj/item/slime_cookie/gold/do_effect(mob/living/M, mob/user)
	...
	playsound(get_turf(C), 'sound/items/coinflip.ogg', 50, DEFAULT_SOUND_VARY)
	M.put_in_hand(C)
