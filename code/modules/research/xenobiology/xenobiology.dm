...
/obj/item/slimepotion/speed/interact_with_atom(obj/interacting_with, mob/living/user, list/modifiers)
	...
	interacting_with.add_atom_colour(color_transition_filter(COLOR_RED, SATURATION_ALWAYS), FIXED_COLOUR_PRIORITY)
...
/obj/item/slimepotion/fireproof/interact_with_atom(atom/interacting_with, mob/living/user, list/modifiers)
	...
	clothing.add_atom_colour(color_transition_filter(COLOR_NAVY, SATURATION_ALWAYS), FIXED_COLOUR_PRIORITY)
