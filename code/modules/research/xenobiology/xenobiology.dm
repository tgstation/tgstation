...
/obj/item/slimepotion/slime/sentience/attack(mob/living/M, mob/user)
	...
	var/list/candidates = pollCandidatesForMob("Do you want to play as [SM.name]?", ROLE_SENTIENCE, null, 0, 50, SM, POLL_IGNORE_SENTIENCE_POTION) // see poll_ignore.dm
...
/obj/item/slimepotion/transference/afterattack(mob/living/M, mob/user)
	...
	if(SM.sentience_type != animal_type)
		...
		return ..()
	var/jb = jobban_isbanned(user, ROLE_CONSCIOUSNESS_TRANSFER)
