...
/datum/micro_organism/cell_line/netherworld
	...
	virus_suspectibility = 0
	resulting_atoms = list(/mob/living/basic/netherworld/creature = 1)

/datum/micro_organism/cell_line/netherworld/succeed_growing(obj/machinery/plumbing/growing_vat/vat)
	var/random_result = pick(typesof(/mob/living/basic/netherworld/creature)) //i looked myself, pretty much all of them are reasonably strong and somewhat on the same level. except migo is the jackpot and the blank body is whiff.
