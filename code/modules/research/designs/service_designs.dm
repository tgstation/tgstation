...
/datum/design/synthesizer //needs to be created
	...
	id = "synthesizer"
	req_tech = list("materials" = 3 "magnets" = 3, "powerstorage" = 4, "bluespace" = 4, "service" = 6)
	build_type = PROTOLATHE
	materials = list("$metal" = 5000, "$glass" = 1000, "$diamond" = 2000)
	build_path = /obj/item/weapon/chainsaw
	category = list("service")
	
/datum/design/crack //needs to be created
	name = "Secret Spice"
...
/datum/design/chainsaw //needs to be ported
	...
	id = "chainsaw"
	req_tech = list("materials" = 5 "magnets" = 4, "powerstorage" = 3, "syndicate" = 5, "service" = 8)
	build_type = PROTOLATHE
...
/datum/design/muffinbutton //needs to be created and sprited
	...
	id = "muffinbutton"
	req_tech = list("materials" = 6 "magnets" = 5, "powerstorage" = 4, "bluespace" = 6 "service" = 8)
	build_type = PROTOLATHE
