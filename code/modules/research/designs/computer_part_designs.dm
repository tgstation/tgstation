...
/datum/design/disk/normal
	...
	materials = list(MAT_CATEGORY_IRON = 400, MAT_CATEGORY_GLASS = 100)
...
/datum/design/disk/super
	...
	id = "hdd_super"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 1600, MAT_CATEGORY_GLASS = 400)
...
/datum/design/disk/cluster
	...
	id = "hdd_cluster"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 3200, MAT_CATEGORY_GLASS = 800)
...
/datum/design/netcard/basic
	...
	materials = list(MAT_CATEGORY_IRON = 250, MAT_CATEGORY_GLASS = 100)
...
/datum/design/netcard/advanced
	...
	id = "netcard_advanced"
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_IRON = 500, MAT_CATEGORY_GLASS = 200)
...
/datum/design/netcard/wired
	...
	id = "netcard_wired"
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_IRON = 2500, MAT_CATEGORY_GLASS = 400)
...
/datum/design/portabledrive/basic
	...
	id = "portadrive_basic"
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_GLASS = 800)
...
/datum/design/portabledrive/advanced
	...
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_GLASS = 1600)
...
/datum/design/portabledrive/super
	...
	id = "portadrive_super"
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_GLASS = 3200)
...
/datum/design/cardslot
	...
	id = "cardslot"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 600)
...
/datum/design/battery/advanced
	...
	id = "bat_advanced"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 800)
...
/datum/design/battery/super
	...
	id = "bat_super"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 1600)
...
/datum/design/cpu/photonic
	...
	id = "pcpu_normal"
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_GLASS= 6400, MAT_CATEGORY_GOLD = 2000)
...
/datum/design/cpu/photonic/small
	...
	id = "pcpu_small"
	build_type = IMPRINTER
	materials = list(MAT_CATEGORY_GLASS = 3200, MAT_CATEGORY_GOLD = 1000)
