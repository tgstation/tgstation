...
/datum/design/controller_shell
	...
	build_type = COMPONENT_PRINTER
	materials = list(/datum/material/glass =MINERAL_MATERIAL_AMOUNT, /datum/material/iron = 7000)
	category = list(
		RND_CATEGORY_CIRCUITRY + RND_SUBCATEGORY_CIRCUITRY_SHELLS
	)
...
/datum/design/keyboard_shell
	...
	materials = list(/datum/material/glass =MINERAL_MATERIAL_AMOUNT, /datum/material/iron = 10000)
	build_type = COMPONENT_PRINTER
	category = list(
		RND_CATEGORY_CIRCUITRY + RND_SUBCATEGORY_CIRCUITRY_SHELLS
	)
