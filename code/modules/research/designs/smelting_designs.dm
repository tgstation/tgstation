...
/datum/design/plasteel_alloy
	...
	materials = list(/datum/material/hematite = MINERAL_MATERIAL_AMOUNT, /datum/material/plasma = MINERAL_MATERIAL_AMOUNT)
...
/datum/design/alienalloy
	...
	materials = list(/datum/material/hematite = 4000, /datum/material/plasma = 4000)
