...
/datum/design/exwelder
	...
	id = "exwelder"
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron =ROD_MATERIAL_AMOUNT, /datum/material/glass = 500, /datum/material/plasma =ROD_MATERIAL_AMOUNT * 1.5, /datum/material/uranium = 200)
...
/datum/design/rangedanalyzer
	...
	id = "rangedanalyzer"
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron =SMALL_MATERIAL_AMOUNT, /datum/material/glass = 20, /datum/material/gold = 300, /datum/material/bluespace=200)
...
/datum/design/rcd_upgrade/frames
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron = 5000, /datum/material/glass = 2500, /datum/material/silver =ROD_MATERIAL_AMOUNT * 1.5, /datum/material/titanium =MINERAL_MATERIAL_AMOUNT)
...
/datum/design/geneshears
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron=4000, /datum/material/uranium=ROD_MATERIAL_AMOUNT * 1.5, /datum/material/silver=500)
	category = list(
...
/datum/design/alienwrench
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron = 5000, /datum/material/silver = 2500, /datum/material/plasma =ROD_MATERIAL_AMOUNT, /datum/material/titanium =MINERAL_MATERIAL_AMOUNT, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT)
	category = list(
...
/datum/design/alienscalpel
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron =MINERAL_MATERIAL_AMOUNT, /datum/material/silver =ROD_MATERIAL_AMOUNT * 1.5, /datum/material/plasma = 500, /datum/material/titanium =ROD_MATERIAL_AMOUNT * 1.5)
	category = list(
