...
/datum/design/intellicard
	...
	materials = list(MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_GOLD = 200)
...
/datum/design/paicard
	...
	id = "paicard"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_GLASS = 500, MAT_CATEGORY_IRON = 500)
...
/datum/design/ai_cam_upgrade
	...
	id = "ai_cam_upgrade"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 5000, MAT_CATEGORY_GLASS = 5000, MAT_CATEGORY_GOLD = 15000, MAT_CATEGORY_SILVER = 15000, MAT_CATEGORY_DIAMOND = 20000, MAT_CATEGORY_PLASMA = 10000)
