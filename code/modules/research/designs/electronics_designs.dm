...
/datum/design/ai_cam_upgrade
	...
	id = "ai_cam_upgrade"
	build_type = PROTOLATHE
	materials = list(/datum/material/hematite = 5000, /datum/material/glass = 5000, /datum/material/gold = 15000, /datum/material/silver = 15000, /datum/material/diamond = 20000, /datum/material/plasma = 10000)
