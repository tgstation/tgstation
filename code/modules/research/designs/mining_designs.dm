...
/datum/design/drill
	...
	id = "drill"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 6000, MAT_CATEGORY_GLASS = 1000) //expensive, but no need for miners.
...
/datum/design/drill_diamond
	...
	id = "drill_diamond"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 6000, MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_DIAMOND = 2000) //Yes, a whole diamond is needed.
...
/datum/design/plasmacutter
	...
	id = "plasmacutter"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 1500, MAT_CATEGORY_GLASS = 500, MAT_CATEGORY_PLASMA = 400)
...
/datum/design/plasmacutter_adv
	...
	id = "plasmacutter_adv"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 3000, MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_PLASMA = 2000, MAT_CATEGORY_GOLD = 500)
...
/datum/design/jackhammer
	...
	id = "jackhammer"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 6000, MAT_CATEGORY_GLASS = 2000, MAT_CATEGORY_SILVER = 2000, MAT_CATEGORY_DIAMOND = 6000)
...
/datum/design/superresonator
	...
	id = "superresonator"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 4000, MAT_CATEGORY_GLASS = 1500, MAT_CATEGORY_SILVER = 1000, MAT_CATEGORY_URANIUM = 1000)
...
/datum/design/trigger_guard_mod
	...
	id = "triggermod"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 2000, MAT_CATEGORY_GLASS = 1500, MAT_CATEGORY_GOLD = 1500, MAT_CATEGORY_URANIUM = 1000)
...
/datum/design/hyperaccelerator
	...
	id = "hypermod"
	build_type = PROTOLATHE | MECHFAB
	materials = list(MAT_CATEGORY_IRON = 8000, MAT_CATEGORY_GLASS = 1500, MAT_CATEGORY_SILVER = 2000, MAT_CATEGORY_GOLD = 2000, MAT_CATEGORY_DIAMOND = 2000)
