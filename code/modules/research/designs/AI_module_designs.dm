...
/datum/design/board/onehuman_module
	...
	id = "onehuman_module"
	materials = list(MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_DIAMOND = 6000)
...
/datum/design/board/freeform_module
	...
	id = "freeform_module"
	materials = list(MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_GOLD = 10000)//Custom inputs should be more expensive to get
...
/datum/design/board/purge_module
	...
	id = "purge_module"
	materials = list(MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_DIAMOND = 2000)
...
/datum/design/board/freeformcore_module
	...
	materials = list(MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_DIAMOND = 10000)//Ditto
