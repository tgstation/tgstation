...
/datum/design/board/safeguard_module
	...
	id = "safeguard_module"
	materials = list(/datum/material/glass = 1000, /datum/material/gold =MINERAL_MATERIAL_AMOUNT, /datum/material/bluespace = 1000)
...
/datum/design/board/freeform_module
	...
	id = "freeform_module"
	materials = list(/datum/material/glass = 1000, /datum/material/gold = 10000, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)//Custom inputs should be more expensive to get
...
/datum/design/board/purge_module
	...
	id = "purge_module"
	materials = list(/datum/material/glass = 1000, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT, /datum/material/bluespace = 1000)
...
/datum/design/board/freeformcore_module
	...
	materials = list(/datum/material/glass = 1000, /datum/material/diamond = 10000, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)//Ditto
