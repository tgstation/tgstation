...
/datum/design/board/safeguard_module
	...
	id = "safeguard_module"
	materials = list(/datum/material/glass =HALF_SHEET_MATERIAL_AMOUNT, /datum/material/gold =MINERAL_MATERIAL_AMOUNT, /datum/material/bluespace =HALF_SHEET_MATERIAL_AMOUNT)
...
/datum/design/board/freeform_module
	...
	id = "freeform_module"
	materials = list(/datum/material/glass =HALF_SHEET_MATERIAL_AMOUNT, /datum/material/gold = 10000, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)//Custom inputs should be more expensive to get
...
/datum/design/board/purge_module
	...
	id = "purge_module"
	materials = list(/datum/material/glass =HALF_SHEET_MATERIAL_AMOUNT, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT, /datum/material/bluespace =HALF_SHEET_MATERIAL_AMOUNT)
...
/datum/design/board/freeformcore_module
	...
	materials = list(/datum/material/glass =HALF_SHEET_MATERIAL_AMOUNT, /datum/material/diamond = 10000, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)//Ditto
