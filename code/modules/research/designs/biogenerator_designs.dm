...
/datum/design/milk
	...
	materials = list(MAT_CATEGORY_BIOMASS = 20)
...
/datum/design/cream
	...
	id = "cream"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 30)
...
/datum/design/milk_carton
	...
	id = "milk_carton"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 100)
...
/datum/design/cream_carton
	...
	id = "cream_carton"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 300)
...
/datum/design/black_pepper
	...
	id = "black_pepper"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 25)
...
/datum/design/pepper_mill
	...
	id = "pepper_mill"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 50)
...
/datum/design/flour_sack
	...
	id = "flour_sack"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 150)
...
/datum/design/monkey_cube
	...
	id = "mcube"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 250)
...
/datum/design/ez_nut
	...
	id = "ez_nut"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 10)
...
/datum/design/botany_bottle
	...
	id = "botany_bottle"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 5)
...
/datum/design/s_holster
	...
	id = "s_holster"
	build_type = BIOGENERATOR
	materials = list(MAT_CATEGORY_BIOMASS = 400)
