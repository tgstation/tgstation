...
/datum/design/milk
	...
	category = list(CATEGORY_INITIAL,CATEGORY_FOOD)
...
/datum/design/ez_nut   //easy nut :)
	...
	category = list(CATEGORY_INITIAL,CATEGORY_BOTANY_CHEMICALS)
...
/datum/design/cloth
	...
	category = list(CATEGORY_INITIAL,CATEGORY_ORGANIC_MATERIALS)
