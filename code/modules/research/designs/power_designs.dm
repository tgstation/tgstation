...
/datum/design/basic_cell
	...
	category = list(CATEGORY_MISC,CATEGORY_POWER_DESIGNS,CATEGORY_MACHINERY,CATEGORY_INITIAL)
...
/datum/design/high_cell
	...
	category = list(CATEGORY_MISC,CATEGORY_POWER_DESIGNS)
...
/datum/design/inducer
	...
	category = list(CATEGORY_POWER_DESIGNS)
	departmental_flags = DEPARTMENTAL_FLAG_SCIENCE | DEPARTMENTAL_FLAG_ENGINEERING
