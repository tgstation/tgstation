...
/datum/design/reticence_torso
	...
	materials = list(/datum/material/iron=20000,/datum/material/glass = 10000,/datum/material/tranquillite=10000)
	construction_time = 300
	category = list("Reticence")
...
/datum/design/reticence_head
	...
	materials = list(/datum/material/iron=10000,/datum/material/glass = 5000,/datum/material/tranquillite=5000)
	construction_time = 200
	category = list("Reticence")
...
/datum/design/reticence_left_arm
	...
	materials = list(/datum/material/iron=15000,/datum/material/tranquillite=5000)
	construction_time = 200
	category = list("Reticence")
...
/datum/design/reticence_left_leg
	...
	materials = list(/datum/material/iron=20000,/datum/material/tranquillite=5000)
	construction_time = 200
	category = list("Reticence")
