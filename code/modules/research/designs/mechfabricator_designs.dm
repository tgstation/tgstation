...
/datum/design/honk_torso
	...
	materials = list(MAT_METAL=20000,MAT_GLASS=10000,"$bananium"=10000)
	construction_time = 300
	category = list("H.O.N.K")
...
/datum/design/honk_head
	...
	materials = list(MAT_METAL=10000,MAT_GLASS=5000,"$bananium"=5000)
	construction_time = 200
	category = list("H.O.N.K")
...
/datum/design/honk_left_arm
	...
	materials = list(MAT_METAL=15000,"$bananium"=5000)
	construction_time = 200
	category = list("H.O.N.K")
...
/datum/design/honk_left_leg
	...
	materials = list(MAT_METAL=20000,"$bananium"=5000)
	construction_time = 200
	category = list("H.O.N.K")
...
/datum/design/mech_honker
	...
	materials = list(MAT_METAL=20000,"$bananium"=10000)
