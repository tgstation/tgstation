...
/datum/design/ripley_chassis
	...
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_RIPLEY
	)
...
/datum/design/odysseus_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_ODYSSEUS
	)
...
/datum/design/gygax_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_GYGAX
	)
...
/datum/design/durand_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_DURAND
	)
...
/datum/design/honk_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_HONK
	)
...
/datum/design/phazon_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_PHAZON
	)
...
/datum/design/savannah_ivanov_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_SAVANNAH_IVANOV
	)
...
/datum/design/justice_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_JUSTICE
	)
...
/datum/design/clarke_chassis
	...
	construction_time = 10 SECONDS
	category = list(
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_CLARKE
	)
...
/datum/design/paddyupgrade
	...
	category = list(
		...
		RND_CATEGORY_MECHFAB_EXOSUITS + RND_SUBCATEGORY_MECHFAB_EXOSUITS_PADDY,
	)
...
/datum/design/borg_upgrade_rename
	...
	build_type = MECHFAB | ROBO_IMPRINTER
