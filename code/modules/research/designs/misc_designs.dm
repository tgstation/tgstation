...
/datum/design/health_hud_night
	...
	id = "health_hud_night"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 600, MAT_CATEGORY_GLASS = 600, MAT_CATEGORY_URANIUM = 1000, MAT_CATEGORY_SILVER = 350)
...
/datum/design/security_hud_night
	...
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 600, MAT_CATEGORY_GLASS = 600, MAT_CATEGORY_URANIUM = 1000, MAT_CATEGORY_GOLD = 350)
...
/datum/design/diagnostic_hud_night
	...
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 600, MAT_CATEGORY_GLASS = 600, MAT_CATEGORY_URANIUM = 1000, MAT_CATEGORY_PLASMA = 300)
...
/datum/design/portaseeder
	...
	id = "portaseeder"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 1000, MAT_CATEGORY_GLASS = 400)
...
/datum/design/air_horn
	...
	id = "air_horn"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 4000, MAT_CATEGORY_BANANIUM = 1000)
...
/datum/design/engine_goggles
	...
	id = "engine_goggles"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 500, MAT_CATEGORY_GLASS = 500, MAT_CATEGORY_PLASMA = 100)
...
/datum/design/nvgmesons
	...
	id = "nvgmesons"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 600, MAT_CATEGORY_GLASS = 600, MAT_CATEGORY_PLASMA = 350, MAT_CATEGORY_URANIUM = 1000)
...
/datum/design/magboots
	...
	id = "magboots"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 4500, MAT_CATEGORY_SILVER = 1500, MAT_CATEGORY_GOLD = 2500)
...
/datum/design/forcefield_projector
	...
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 2500, MAT_CATEGORY_GLASS = 1000)
...
/datum/design/locator
	...
	id = "locator"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON=1000, MAT_CATEGORY_GLASS=500, MAT_CATEGORY_SILVER = 500)
...
/datum/design/quantum_keycard
	...
	id = "quantum_keycard"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_GLASS = 500, MAT_CATEGORY_IRON = 500, MAT_CATEGORY_SILVER = 500, MAT_BLUESPACE = 1000)
...
/datum/design/anomaly_neutralizer
	...
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 2000, MAT_CATEGORY_GOLD = 2000, MAT_CATEGORY_PLASMA = 5000, MAT_CATEGORY_URANIUM = 2000)
...
/datum/design/donksoft_refill
	...
	id = "donksoft_refill"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 25000, MAT_CATEGORY_GLASS = 15000, MAT_CATEGORY_PLASMA = 20000, MAT_CATEGORY_GOLD = 10000, MAT_CATEGORY_SILVER = 10000)
...
/datum/design/advmop
	...
	id = "advmop"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 2500, MAT_CATEGORY_GLASS = 200)
...
/datum/design/blutrash
	...
	id = "blutrash"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_GOLD = 1500, MAT_CATEGORY_URANIUM = 250, MAT_CATEGORY_PLASMA = 1500)
...
/datum/design/buffer
	...
	id = "buffer"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 3000, MAT_CATEGORY_GLASS = 200)
...
/datum/design/beartrap
	...
	id = "beartrap"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 5000, MAT_CATEGORY_TITANIUM = 1000)
...
/datum/design/holobarrier_jani
	...
	id = "holobarrier_jani"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 2000, MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_SILVER = 1000)
...
/datum/design/holosignsec
	...
	id = "holosignsec"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 5000, MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_GOLD = 1000, MAT_CATEGORY_SILVER = 1000)
...
/datum/design/holobarrier_med
	...
	materials = list(MAT_CATEGORY_IRON = 500, MAT_CATEGORY_GLASS = 500, MAT_CATEGORY_SILVER = 100) //a hint of silver since it can troll 2 antags (bad viros and sentient disease)
	id = "holobarrier_med"
...
/datum/design/reactive_armour
	...
	id = "reactive_armour"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 10000, MAT_CATEGORY_DIAMOND = 5000, MAT_CATEGORY_URANIUM = 8000, MAT_CATEGORY_SILVER = 4500, MAT_CATEGORY_GOLD = 5000)
...
/datum/design/seclite
	...
	id = "seclite"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 2500)
...
/datum/design/detective_scanner
	...
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_IRON = 5000, MAT_CATEGORY_GLASS = 1000, MAT_CATEGORY_GOLD = 2500, MAT_CATEGORY_SILVER = 2000)
...
/datum/design/bola_energy
	...
	id = "bola_energy"
	build_type = PROTOLATHE
	materials = list(MAT_CATEGORY_SILVER = 500, MAT_CATEGORY_PLASMA = 500, MAT_CATEGORY_TITANIUM = 500)
