...
/datum/design //Datum for object designs, used in construction
	...
	/// A list of techwebs nodes that unlock this design. Auto-generated by SSresearch.
	var/list/unlocked_by
...
/datum/design/New()
	...
	asset_id = replacetext(splicetext("[type]", 1, base_path_len + 1), "/", "_")
