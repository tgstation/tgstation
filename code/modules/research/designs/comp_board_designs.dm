...
/datum/design/board/aiupload
	...
	id = "aiupload"
	materials = list(/datum/material/glass =ROD_MATERIAL_AMOUNT, /datum/material/gold =MINERAL_MATERIAL_AMOUNT, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)
...
/datum/design/board/robocontrol
	...
	id = "robocontrol"
	materials = list(/datum/material/glass =ROD_MATERIAL_AMOUNT, /datum/material/gold =ROD_MATERIAL_AMOUNT, /datum/material/silver =ROD_MATERIAL_AMOUNT, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)
