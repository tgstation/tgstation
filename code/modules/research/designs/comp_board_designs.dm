...
/datum/design/board/aiupload
	...
	id = "aiupload"
	materials = list(/datum/material/glass = 1000, /datum/material/gold =MINERAL_MATERIAL_AMOUNT, /datum/material/diamond =MINERAL_MATERIAL_AMOUNT, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)
...
/datum/design/board/robocontrol
	...
	id = "robocontrol"
	materials = list(/datum/material/glass = 1000, /datum/material/gold = 1000, /datum/material/silver = 1000, /datum/material/bluespace =MINERAL_MATERIAL_AMOUNT)
