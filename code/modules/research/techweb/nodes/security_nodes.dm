...
/datum/techweb_node/sec_equip
	...
	prereq_ids = list(/datum/techweb_node/basic_arms)
	design_ids = list(
...
/datum/techweb_node/riot_supression
	...
	prereq_ids = list(/datum/techweb_node/sec_equip)
	design_ids = list(
...
/datum/techweb_node/explosives
	...
	prereq_ids = list(/datum/techweb_node/riot_supression)
	design_ids = list(
...
/datum/techweb_node/exotic_ammo
	...
	prereq_ids = list(/datum/techweb_node/explosives)
	design_ids = list(
...
/datum/techweb_node/beam_weapons
	...
	prereq_ids = list(/datum/techweb_node/electric_weapons)
	design_ids = list(
		/datum/design/xray,
