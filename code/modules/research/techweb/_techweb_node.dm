...
/datum/techweb_node
	...
	var/unlocks_packs = FALSE
	/// What cargo packs are unlocked by this node upon research?
	var/list/unlocked_packs = list()
	...
	/// Hidden Mech nodes unlocked when mech fabricator emagged.
