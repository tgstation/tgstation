...
/datum/techweb_node/base
	...
	"rglass","plasteel","plastitanium","plasmaglass","plasmareinforcedglass","titaniumglass","plastitaniumglass","showerparts")
...
/datum/techweb_node/janitor
	...
	description = "Clean things and people better, faster, stronger, and harder!"
	prereq_ids = list("adv_engi")
	design_ids = list("advmop", "buffer", "blutrash", "light_replacer", "spraybottle", "beartrap","d-showerparts", "srdgunammo", "srdgun")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
