...
/datum/techweb_node/adv_engi
	...
	"HFR_waste_output", "HFR_moderator_input", "HFR_corner", "HFR_interface", "rtg")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
...
/datum/techweb_node/adv_power
	...
	design_ids = list("smes", "super_cell", "hyper_cell", "super_capacitor", "superpacman", "power_turbine", "power_turbine_console", "power_compressor", "artg")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
...
/datum/techweb_node/cyborg_upg_util
	...
	design_ids = list("borg_upgrade_thrusters", "borg_upgrade_selfrepair", "borg_upgrade_expand", "borg_upgrade_disablercooler", "borg_upgrade_trashofholding", "borg_upgrade_advancedmop", "borg_upgrade_broomer", "borg_upgrade_prt", "borg_upgrade_shrink")
...
/datum/techweb_node/exp_tools
	...
	design_ids = list("exwelder", "jawsoflife", "handdrill", "laserscalpel", "mechanicalpinches", "searingtool", "gene_shears", "powercutter", "rangedanalyzer")
	prereq_ids = list("adv_engi")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
