...
/datum/techweb_node/nanite_base
	...
	design_ids = list("nanite_disk","nanite_remote","nanite_comm_remote","nanite_scanner",\
						...
						"relay_nanites", "sensor_cloud_sync","cloud_sync_nanites", "monitoring_nanites", "access_nanites", "repairing_nanites","sensor_nanite_volume", "repeater_nanites", "relay_repeater_nanites")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
