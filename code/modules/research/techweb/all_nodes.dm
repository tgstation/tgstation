...
/datum/techweb_node/engineering
	...
	"oxygen_tank", "plasma_tank", "emergency_oxygen", "emergency_oxygen_engi", "plasmaman_tank_belt", "electrolyzer", "adv_electrolite", "pneumatic_seal", "generic_tank_t2")
...
/datum/techweb_node/practical_bluespace
	...
	design_ids = list("bs_rped","minerbag_holding", "bluespacebeaker", "bluespacesyringe", "phasic_scanning", "roastingstick", "ore_silo", "plumbing_receiver", "generic_tank_t3")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 5000)
...
/datum/techweb_node/adv_weaponry
	...
	design_ids = list("pin_loyalty", "generic_tank_t4")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 10000)
