...
/datum/techweb_node/nanite_base
	...
	design_ids = list("nanite_disk","nanite_remote","nanite_comm_remote","nanite_scanner",\
						...
						"relay_nanites", "monitoring_nanites", "research_nanites" ,"researchplus_nanites", "access_nanites", "repairing_nanites","sensor_nanite_volume", "repeater_nanites", "relay_repeater_nanites","enh_diag_nanites")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1000)
	export_price = 5000
