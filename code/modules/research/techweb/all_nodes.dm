...
/datum/techweb_node/bluespace_basic //Bluespace-memery
	...
	prereq_ids = list("base")
	design_ids = list("beacon", "xenobioconsole", "telesci_gps", "bluespace_crystal", "proto_sh_emitter", "proto_sh_emitter_small")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
...
/datum/techweb_node/emp_basic //EMP tech for some reason
	...
	prereq_ids = list("base")
	design_ids = list("holosign", "holosignsec", "holosignengi", "holosignatmos", "holosignshield", "inducer", "tray_goggles", "holopad")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
