...
/datum/gizmo_effect/mood_pulser
...
/datum/gizmo_effect/mood_pulser/activate(atom/movable/holder, datum/gizmo_effect_combination/master, datum/gizmo_interface/interface)
	mood_pulse(holder)

/// Send a mood pulse to a range
/datum/gizmo_effect/mood_pulser/proc/mood_pulse(atom/movable/holder)
...
/datum/gizmo_effect/mood_pulser/positive
	mood = /datum/mood_event/gizmo_positive
	ring_color = COLOR_GREEN

/// Make a negative mood pulse
/datum/gizmo_effect/mood_pulser/negative
	mood = /datum/mood_event/gizmo_negative
	ring_color = COLOR_RED

/datum/gizmo_effect/radiation_pulse/activate(atom/movable/holder, datum/gizmo_effect_combination/master, datum/gizmo_interface/interface)
