...
/obj/item/photo/suicide_act(mob/living/carbon/user)
	...
	if (user.gender == MALE)
		playsound(user, 'sound/voice/human/manlaugh1.ogg', 50, DEFAULT_SOUND_VARY)//EVERY TIME I DO IT MAKES ME LAUGH
	else if (user.gender == FEMALE)
		playsound(user, 'sound/voice/human/womanlaugh.ogg', 50, DEFAULT_SOUND_VARY)
	return OXYLOSS
