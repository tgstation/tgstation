...
/obj/machinery/transport/guideway_sensor/proc/pair_sensor()
	...
	playsound(src, 'sound/machines/synth/synth_yes.ogg').volume(75).use_reverb(TRUE).play()
...
/obj/machinery/transport/guideway_sensor/Destroy()
	...
	if(paired_sensor)
		...
		divorcee.paired_sensor = null
		divorcee.update_appearance()
		playsound(src, 'sound/machines/synth/synth_no.ogg').volume(75).use_reverb(TRUE).play()
		paired_sensor = null
	. = ..()
