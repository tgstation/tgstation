...
/datum/lift_master
	...
	///whether the platforms in lift_platforms have been ordered in order of lowest z level -> highest z level yet
	var/z_level_ordered = FALSE
...
/datum/lift_master/proc/MoveLiftHorizontal(going, z)
	...
	if(multitile_tram)
		//if(!(going & UP))
		//for(var/obj/structure/industrial_lift/tram/tram_platform as anything in lift_platforms)
		var/obj/structure/industrial_lift/tram/tram_platform = lift_platforms[1]
		if(!tram_platform)
			return FALSE
