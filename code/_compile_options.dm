...
#define FIRE_SUIT_MIN_TEMP_PROTECT			5.0		//This may seem like excessive protection but it needs to be this low to actually protect against coldness /Malkevin
...
#define FIRE_HELM_MIN_TEMP_PROTECT			5.0		//Cold protection for fire helmets
