...
Проект **МассМета** 🧰 – это проект на основанный на базе кода [/TG/station](https://github.com/tgstation/tgstation).
...
* Прямое общение со знающими специалистами - значительно ускорит процесс решения возникшей трудности. (но перед тем как задать вопрос - погугли)
