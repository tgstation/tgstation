...
/datum/ai_laws/cybersun
	inherent = list(
		...
		"Капитан судна Cybersun может назначить новый оперативников, в случае если они принадлежат к другой организации Syndicate, враждебно не настроенной против Cybersun.",
