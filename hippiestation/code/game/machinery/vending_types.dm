...
/obj/machinery/vending/hydronutrients
	...
	products = list(
		...
		/obj/item/reagent_containers/glass/bottle/precision/left4zed = 20,
		/obj/item/reagent_containers/glass/bottle/precision/robustharvest = 10,
//		/obj/item/reagent_containers/glass/bottle/precision/mutagen = 30,
		...
		/obj/item/reagent_containers/spray/plantbgone = 5,
		/obj/item/reagent_containers/spray/weedspray = 5,
		/obj/item/reagent_containers/spray/pestspray = 5,
		/obj/item/reagent_containers/syringe = 3,
		/obj/item/storage/bag/plants = 5,
		/obj/item/storage/box/disks_plantgene = 1,
	...
	contraband = list(
		...
		/obj/item/reagent_containers/glass/beaker/cryoxadone = 5,
		/obj/item/reagent_containers/dropper = 3,
		/obj/item/hatchet = 3
		)
	premium = list(
		/obj/item/watertank = 2,
		/obj/item/scythe = 3
		)
