/datum/map_template/ruin/space/cloning_facility //hippie start, re-add cloning
	id = "cloning_facility"
	prefix = "hippiestation/_maps/RandomRuins/SpaceRuins/"   //check our own hippie path for the map, it's modularised
