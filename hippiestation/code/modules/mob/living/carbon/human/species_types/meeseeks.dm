/datum/species/meeseeks
	...
	coldmod = 0
	heatmod = 0
	species_traits = list(NOBLOOD,NOTRANSSTING,NOCRITDAMAGE,NOZOMBIE,NO_UNDERWEAR,NO_DNA_COPY)
	inherent_traits = list(TRAIT_RESISTHEAT,TRAIT_RESISTCOLD,TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,TRAIT_RADIMMUNE,TRAIT_NOBREATH,TRAIT_NOFIRE,TRAIT_VIRUSIMMUNE,TRAIT_PIERCEIMMUNE,TRAIT_NOHUNGER,TRAIT_EASYDISMEMBER)
