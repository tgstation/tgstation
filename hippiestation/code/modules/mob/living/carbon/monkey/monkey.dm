/mob/living/carbon/monkey/hippie_equip_mob_with_items(rand_int)
	switch(rand_int)
		if(2)
			put_in_hands_or_del(new /obj/item/reagent_containers/food/snacks/icecream(src))
			put_in_hands_or_del(new /obj/item/reagent_containers/food/snacks/icecream(src))
		...
		if(7)
			...
			put_in_hands_or_del(martini)
			put_in_hands_or_del(new /obj/item/toy/gun(src))
		if(12)
			put_in_hands_or_del(new /obj/item/toy/gun(src))
			put_in_hands_or_del(new /obj/item/toy/gun(src))
		...
		if(17)
			if(prob(17))
				name = "monkey (100)"
		if(18)
			put_in_hands_or_del(new /obj/item/reagent_containers/food/drinks/beer(src))
			put_in_hands_or_del(new /obj/item/reagent_containers/food/drinks/beer(src))
		if(44)
			put_in_hands_or_del(new /obj/item/book(src))
			put_in_hands_or_del(new /obj/item/pen(src))
		if(64)
		...
		if(255)
			aggressive = TRUE
			put_in_hands_or_del(new /obj/item/toy/nuke(src))
		if(322)
			name = "Solo"
		if(420)
