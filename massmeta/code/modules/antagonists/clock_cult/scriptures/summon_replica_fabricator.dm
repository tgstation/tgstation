...
/datum/clockcult/scripture/replica_fabricator
	...
	desc = "Призывает производителя реплик, который может изготовить латунь для строительства защитных сооружений, а так же конвертировать некоторые обьекты в их латунную версию."
	tip = "Создавай латунь, строй укрепления и трансформируй обьекты на станции."
