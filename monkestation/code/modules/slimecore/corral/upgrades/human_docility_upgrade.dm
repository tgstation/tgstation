/datum/corral_upgrade/human_docility
	name = "Human Docility Upgrade"
	desc = "Makes the non rabid slimes docile to people with souls."
	cost = 2500

/datum/corral_upgrade/human_docility/on_add(datum/corral_data/parent)
...
/datum/corral_upgrade/human_docility/on_slime_entered(mob/living/basic/slime/slime)
	slime.ai_controller.set_blackboard_key(BB_WONT_TARGET_CLIENTS, TRUE)

/datum/corral_upgrade/human_docility/on_slime_exited(mob/living/basic/slime/slime)
