...
/proc/generate_redemption_code()
	if(!check_rights(R_FUN))
		return
	var/choice = tgui_input_list(usr, "Please choose a code type", "Code generation", list("Coins", "Loadout Items"))
...
/proc/generate_antag_token_code()
	if(!check_rights(R_FUN))
		return
