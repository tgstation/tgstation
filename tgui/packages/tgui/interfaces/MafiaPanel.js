...
export const MafiaPanel = (_, context) => {
...
const MafiaListOfRoles = (_, context) => {
	const { act, data } = useBackend(context);
...
const MafiaJudgement = (_, context) => {
	const { act, data } = useBackend(context);
