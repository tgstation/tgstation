...
export const ScannerGate = (_, context) => {
...
const ScannerGateControl = (_, context) => {
	const { act, data } = useBackend(context);
...
const ScannerGateOff = (_, context) => {
...
const ScannerGateWanted = (_, context) => {
...
const ScannerGateGuns = (_, context) => {
	const { data } = useBackend(context);
	const { reverse } = data;
	return (
		<>
...
const ScannerGateMindshield = (_, context) => {
	const { data } = useBackend(context);
	const { reverse } = data;
	return (
		<>
...
const ScannerGateDisease = (_, context) => {
	const { act, data } = useBackend(context);
...
const ScannerGateSpecies = (_, context) => {
	const { act, data } = useBackend(context);
...
const ScannerGateNutrition = (_, context) => {
	const { act, data } = useBackend(context);
...
const ScannerGateMode = (_, context) => {
	const { act, data } = useBackend(context);
	const { reverse } = data;
	return (
		<LabeledList>
