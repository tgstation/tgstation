...
export type ScrubberData = {
  ...
  scrubbing: number;
  widenet: boolean;
  filter_types: { gas_id: string; gas_name: string; enabled: boolean }[];
};
          ...
          label={
            <>
              <Button
                ...
                tooltip={
                  direction // True means pumping out
                    ? 'The pump will shut off when the internal pressure is lower than the target or the external pressure is greater than the target. No checks means the vent will keep on pumping'
                    : 'The pump will shut off when the internal pressure is higher than the target or the external pressure is lesser than the target. No checks means the vent will keep on scrubbing.'
                }
              />
              {' Pressure Regulator'}
            </>
