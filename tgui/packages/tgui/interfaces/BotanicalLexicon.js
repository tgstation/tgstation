...
export const BotanicalLexicon = (props, context) => {
  const { act, data } = useBackend(context);

  const { plant_list = [] } = data;
  const [selectedPlant] = useLocalState(context, 'plant', plant_list[0]);
