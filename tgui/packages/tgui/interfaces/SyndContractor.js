...
export const SyndContractorContent = (props, context) => {
  ...
  const terminalMessages = [
    ...
    "ALERT: Foreign software detected.",
    "Initiating diagnostics...",
    "NanoBounty Beta v0.4 loaded.",
    "Awaiting response...",
    "ERRORERRORERROR",
    "Awaiting response...",
    ...
    "Searching for available contracts...",
    "ERRORERRORERROR",
    "Rerouting to alternative database...",
    "CONTRACTS FOUND",
    "WELCOME, AGENT",
  ];

  const infoEntries = [
    "NanoBounty Beta v0.4",
    "--IF YOU'RE READING THIS, WE'VE CORRECTLY INJECTED THE--",
    ...
    "--VIRUS PAYLOAD INTO THE CONTRACTING SYSTEM. YOUR TARGETS--",
    ...
    "--ARE SYNDICATE AGENTS THAT MAY BE LINKED TO PREVIOUS--",
    ...
    "this system.",
    "--TERRORIST ATTACKS. DEAD OR ALIVE, AGENT. NANOTRASEN OUT.--",
