...
export const MedicalKiosk = (_, context) => {
...
const MedicalKioskInstructions = (_, context) => {
	const { act, data } = useBackend(context);
...
const MedicalKioskScanResults1 = (_, context) => {
	const { data } = useBackend(context);
	const {
		patient_health,
		brute_health,
...
const MedicalKioskScanResults2 = (_, context) => {
	const { data } = useBackend(context);
	const {
		patient_status,
		patient_illness,
...
const MedicalKioskScanResults3 = (_, context) => {
	const { data } = useBackend(context);
...
const MedicalKioskScanResults4 = (_, context) => {
	const { data } = useBackend(context);
	const {
		chemical_list = [],
		overdose_list = [],
