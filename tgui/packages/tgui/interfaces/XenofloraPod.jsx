...
export const XenofloraPod = (props, context) => {
  ...
  return (
    <Window width={1000} height={360 + 24 * data.additional_bars}>
      <Window.Content>
        <Section
          title="Xenoflora Pod"
          buttons={
            ...
            <Stack.Item>
              <Stack fill>
                <Stack.Item width="60%">
                  ...
                  <Stack.Item>{data.plant_desc}</Stack.Item>
                  {!!data.plant_name && (
                    <Stack.Item>
                      {data.safe_temp
                        ? data.safe_temp
                        : 'Plant has no temperature requirements.'}
                    </Stack.Item>
                  )}
                </Stack.Item>
                <Stack.Divider mr={1} />
            ...
            {data.plant_name && (
              <>
                {!!(data.required_gases && data.required_gases.length) && (
                  <>
                    <Stack.Item fontSize="13px">Required gases:</Stack.Item>
                    <Stack.Item>
                      <LabeledList>
                ...
                {!!(data.required_chems && data.required_chems.length) && (
                  <>
                    <Stack.Item fontSize="13px">Required chemicals:</Stack.Item>
                    <Stack.Item>
                      <LabeledList>
                ...
                {!!(data.produced_gases && data.produced_gases.length) && (
                  <>
                    <Stack.Item fontSize="13px">Produced gases:</Stack.Item>
                    <Stack.Item>
                      <LabeledList>
                ...
                {!!(data.produced_chems && data.produced_chems.length) && (
                  <>
                    <Stack.Item fontSize="13px">Produced chemicals:</Stack.Item>
                    <Stack.Item>
                      <LabeledList>
          ...
          {data.chemical_data && (
            <LabeledList>
              ...
              {data.chemical_data.map((chemical) => (
                <LabeledList.Item key={chemical.name} label={chemical.name}>
                  <ProgressBar
