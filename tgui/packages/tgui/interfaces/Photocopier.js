...
export const Photocopier = (_, context) => {
...
const Blanks = (_, context) => {
	const { act, data } = useBackend(context);
	const { blanks, category, has_toner } = data;

	const sortedBlanks = sortBy(() => blanks.category)(blanks || []);
