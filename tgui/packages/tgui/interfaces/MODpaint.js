...
export const MODpaint = (_, context) => {
					...
					<Stack.Item width="25%">
						...
						<Section textAlign="center" fontSize="28px">
							<Button
								...
								color="average"
								tooltipPosition="top"
								tooltip={multiline`This is a color matrix.
                  Think of it as editing the image in 3 layers,
                  red, green, and blue, rather than editing
                  the final image like with RGB.`}
							/>
							<Button
								height="50px"
								width="50px"
