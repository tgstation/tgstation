...
export const NtosSyndiCyborgRemoteMonitor = (props, context) => {
  return (
    <NtosWindow theme="syndicate">
      <NtosWindow.Content scrollable>
        <NtosSyndiCyborgRemoteMonitorContent />
      </NtosWindow.Content>
    </NtosWindow>
  );
};

export const NtosSyndiCyborgRemoteMonitorContent = (props, context) => {
