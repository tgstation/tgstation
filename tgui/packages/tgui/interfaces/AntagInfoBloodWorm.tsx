          ...
          <Stack vertical>
            ...
            <Stack.Item>
              <Section fill title="Способности">
                <LabeledList>
                  <LabeledList.Item label="Бездыханность">
                  Вам не нужно дышать. Это распространяется и на носителя в том числе.
                  </LabeledList.Item>
            ...
            <Stack.Item>
              <Section fill title="Слабости">
                <LabeledList>
                  ...
                  Ваш вид крайне устойчив к высокому давлению и холоду, но экстремально низкое давление и температура всё ещё могут вам навредить.
                  Эта не относится к случаям, когда у вас есть носитель и вы можете экипировать защитный скафандр.
                  </LabeledList.Item>
