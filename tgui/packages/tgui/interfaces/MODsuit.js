...
const ParametersSection = (_, context) => {
...
const HardwareSection = (_, context) => {
	const { data } = useBackend(context);
	const { control, helmet, chestplate, gauntlets, boots, core, charge } = data;
...
export const MODsuit = (_, context) => {
	const { data } = useBackend(context);
