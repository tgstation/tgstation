  ...
  return (
    <>
      {!!(
        ...
        <Box
          position="absolute"
          left={`${position.x + appearance.boundingBox[0].x + 6}px`}
          top={`${position.y + appearance.boundingBox[0].y - 10}px`}
        ...
        <Box className={classes(['ObjectComponent__Content'])} py={1} px={1}>
          <Stack vertical>
            ...
            <Stack.Item style={{ borderBottom: '1px dashed hsl(0, 0%, 60%);' }}>
              <Tooltip
                content={`True plane: ${appearance.data.plane_true} ${appearance.boundingBox[0].x} ${appearance.boundingBox[0].y} ${appearance.boundingBox[1].x} ${appearance.boundingBox[1].y}`}
              >
