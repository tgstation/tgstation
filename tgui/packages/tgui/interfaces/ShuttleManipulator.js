...
export const ShuttleManipulator = (_, context) => {
...
export const ShuttleManipulatorStatus = (_, context) => {
...
export const ShuttleManipulatorTemplates = (_, context) => {
	const { act, data } = useBackend(context);
...
export const ShuttleManipulatorModification = (_, context) => {
	const { act, data } = useBackend(context);
			...
			{selected ? (
				<>
					...
					{existing_shuttle ? (
						<Section
							level={2}
							title={'Existing Shuttle: ' + existing_shuttle.name}>
							<LabeledList>
								<LabeledList.Item
									label="Status"
									buttons={
