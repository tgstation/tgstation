              ...
              <Stack.Item width="75%">
                <Stack>
                  ...
                  <Stack.Item width="33%">
                    ...
                    trading. <b>{material.ordered}</b> sheets ordered.
                  </Stack.Item>
                  <Stack.Item
                    width="40%"
                    color={
              ...
              <Stack.Item>
                <Button
                  disabled={
                    catastrophe === 1 ||
                    material.price <= 0 ||
                    material.ordered + 1 >= material.quantity
                  }
                  tooltip={material.price * 1 + ' cr'}
                  onClick={() =>
                    act('buy', {
                      quantity: 1,
                ...
                <Button
                  disabled={
                    catastrophe === 1 ||
                    material.price <= 0 ||
                    material.ordered + 5 >= material.quantity
                  }
                  tooltip={material.price * 5 + ' cr'}
                  onClick={() =>
                    act('buy', {
                      quantity: 5,
                      material: material.name,
                ...
                <Button
                  disabled={
                    catastrophe === 1 ||
                    material.price <= 0 ||
                    material.ordered + 10 >= material.quantity
                  }
                  tooltip={material.price * 10 + ' cr'}
                  onClick={() =>
                    act('buy', {
                      quantity: 10,
                      material: material.name,
                ...
                <Button
                  disabled={
                    catastrophe === 1 ||
                    material.price <= 0 ||
                    material.ordered + 25 >= material.quantity
                  }
                  tooltip={material.price * 25 + ' cr'}
                  onClick={() =>
                    act('buy', {
                      quantity: 25,
                      material: material.name,
                ...
                <Button
                  disabled={
                    catastrophe === 1 ||
                    material.price <= 0 ||
                    material.ordered + 50 >= material.quantity
                  }
                  tooltip={material.price * 50 + ' cr'}
                  onClick={() =>
                    act('buy', {
                      quantity: 50,
                      material: material.name,
