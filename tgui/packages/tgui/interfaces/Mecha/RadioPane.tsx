  ...
  return (
    <LabeledList>
      <LabeledList.Item label="Microphone">
        <Button
          onClick={() => act('toggle_microphone')} selected={microphone} icon={microphone ? 'microphone' : 'microphone-slash'}>
          {(microphone ? "En" : "Dis") + "abled"}
        </Button>
      </LabeledList.Item>
      <LabeledList.Item label="Speaker">
        <Button
          onClick={() => act('toggle_speaker')} selected={speaker} icon={speaker ? 'volume-up' : 'volume-mute'}>
