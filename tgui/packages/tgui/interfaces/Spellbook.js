...
const TAB2NAME = [
	{
		...
		blurb: `This book answers only to its owner, and of course, must have one.
      The permanence of the pact between a spellbook and its owner ensures
      such a powerful artifact cannot fall into enemy hands, or be used in
      ways that break the Federation's rules such as bartering spells.`,
	...
	{
		title: 'Defensive',
		blurb: `Spells and items geared towards improving your survivability or
      reducing foes' ability to attack.`,
	},
	{
		title: 'Mobility',
		blurb: `Spells and items geared towards improving your ability to move.
      It is a good idea to take at least one.`,
	},
	{
		title: 'Assistance',
		blurb: `Spells and items geared towards bringing in outside forces to aid
      you or improving upon your other items and abilities.`,
	},
	{
		title: 'Challenges',
		blurb: `The Wizard Federation is looking for shows of power. Arming
      the station against you will increase the danger, but will grant you
      more charges for your spellbook.`,
		locked: true,
		noScrollable: 1,
	},
	{
		title: 'Rituals',
		blurb: `These powerful spells change the very fabric of reality.
      Not always in your favour.`,
	},
	{
		title: 'Loadouts',
		blurb: `The Wizard Federation accepts that sometimes, choosing is hard.
      You can choose from some approved wizard loadouts here.`,
		component: () => Loadouts,
		noScrollable: 2,
	},
	{
		title: 'Randomize',
		blurb: `If you didn't like the loadouts offered, you can embrace chaos.
...
export const Spellbook = (_, context) => {
	const { act, data } = useBackend(context);
