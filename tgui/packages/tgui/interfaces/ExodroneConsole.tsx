...
type DroneAdventure = AdventureDataProvider & {
	drone_status: typeof DroneStatusEnum.Adventure;
};
...
type DroneBusy = {
	drone_status: typeof DroneStatusEnum.Busy;
	wait_time_left: number;
	wait_message: string;
};

type DroneExploration = {
	drone_status: typeof DroneStatusEnum.Exploration;
...
type DroneIdle = {
	drone_status: typeof DroneStatusEnum.Idle;
	sites: Array<SiteData>;
	site: null;
};

type DroneTravel = {
	drone_status: typeof DroneStatusEnum.Travel;
	travel_time: number;
