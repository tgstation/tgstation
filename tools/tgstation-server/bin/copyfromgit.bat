...
del /q gamecode\%AB%\_maps\RandomZLevels\fileList.txt >nul 2>nul
...
mklink gamecode\%AB%\_maps\RandomZLevels\fileList.txt ..\..\..\..\Gamedata\config\awaymissionconfig.txt >nul
