	...
	for(var/state in states)
		...
		switch(statename)
			if("box")
				...
				corner1i.DrawBox(null, 1, 1, 50, 25)
				corner1i.DrawBox(null, 26, 1, 50, 50)
				outputIcon.Insert(corner1i, "1-i")

				var/icon/corner2i = icon(box)
				corner2i.DrawBox(null, 1, 1, 25, 50)
				corner2i.DrawBox(null, 26, 1, 50, 25)
				outputIcon.Insert(corner2i, "2-i")

				var/icon/corner3i = icon(box)
				corner3i.DrawBox(null, 1, 50, 50, 26)
				corner3i.DrawBox(null, 26, 50, 50, 1)
				outputIcon.Insert(corner3i, "3-i")

				var/icon/corner4i = icon(box)
				corner4i.DrawBox(null, 1, 1, 25, 50)
				corner4i.DrawBox(null, 26, 26, 50, 50)
			...
			if("line")
				...
				line1n.DrawBox(null, 1, 1, 50, 25)
				line1n.DrawBox(null, 26, 1, 50, 50)
				outputIcon.Insert(line1n, "1-n")

				var/icon/line2n = icon(line)
				line2n.DrawBox(null, 1, 1, 25, 50)
				line2n.DrawBox(null, 26, 1, 50, 25)
				outputIcon.Insert(line2n, "2-n")

				var/icon/line3s = icon(line)
				line3s.DrawBox(null, 1, 50, 50, 26)
				line3s.DrawBox(null, 26, 50, 50, 1)
				outputIcon.Insert(line3s, "3-s")

				var/icon/line4s = icon(line)
				line4s.DrawBox(null, 1, 1, 25, 50)
				line4s.DrawBox(null, 26, 26, 50, 50)
			...
			if("center_4")
				...
				corner1nw.DrawBox(null, 1, 1, 50, 25)
				corner1nw.DrawBox(null, 26, 1, 50, 50)
				outputIcon.Insert(corner1nw, "1-nw")

				var/icon/corner2ne = icon(center4)
				corner2ne.DrawBox(null, 1, 1, 25, 50)
				corner2ne.DrawBox(null, 26, 1, 50, 25)
				outputIcon.Insert(corner2ne, "2-ne")

				var/icon/corner3sw = icon(center4)
				corner3sw.DrawBox(null, 1, 50, 50, 26)
				corner3sw.DrawBox(null, 26, 50, 50, 1)
				outputIcon.Insert(corner3sw, "3-sw")

				var/icon/corner4se = icon(center4)
				corner4se.DrawBox(null, 1, 1, 25, 50)
				corner4se.DrawBox(null, 26, 26, 50, 50)
			...
			if("center_8")
				...
				corner1f.DrawBox(null, 1, 1, 50, 25)
				corner1f.DrawBox(null, 26, 1, 50, 50)
				outputIcon.Insert(corner1f, "1-f")

				var/icon/corner2f = icon(center8)
				corner2f.DrawBox(null, 1, 1, 25, 50)
				corner2f.DrawBox(null, 26, 1, 50, 25)
				outputIcon.Insert(corner2f, "2-f")

				var/icon/corner3f = icon(center8)
				corner3f.DrawBox(null, 1, 50, 50, 26)
				corner3f.DrawBox(null, 26, 50, 50, 1)
				outputIcon.Insert(corner3f, "3-f")

				var/icon/corner4f = icon(center8)
				corner4f.DrawBox(null, 1, 1, 25, 50)
				corner4f.DrawBox(null, 26, 26, 50, 50)
