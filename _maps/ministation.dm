...
Many jobs have been combined or just plainly cut out, mainly heads and some misc. civilians. These are the remaining jobs with their duties next to them.

 * Captain	- Make sure your station is running.
 * HoP		- You're second in command, protect the Captain and be his right hand man.

 * AI, Cyborg, MoMMI x2	- Exactly as on Meta

 * Cargo Tech x3	- Running cargo bay
 * Shaft Miner		- Mining minerals

 * Bartender	- Keeping the bar, serving drinks and food. Hire the unemployeed to grow food for you, or do it yourself.
 * Cook			- Bartender without a weapon permit
 ...
 * Scientist x3	- Research and development of new technologies and create bombs.
 * Roboticist	- Making borgs and mechs. Complaining that you share a room with R&D

 * Medical Doctor x3 - Healing the crew and performing surgeries.
 * Chemist - Creating useful chemicals for the crew to use.
 * Geneticist - Cloning and genetics. Complaining about having no monkeys and MDs barging into your workplace
 * Virologist - Making and curing viruses. Complaining about having to work in the OR, surely this can't go wrong.
