...
/datum/job/doctor/New()
	...
	total_positions = 3
	spawn_positions = 3
	access = list(ACCESS_MEDICAL, ACCESS_SURGERY, ACCESS_CHEMISTRY)
	minimal_access = list(ACCESS_MEDICAL, ACCESS_SURGERY, ACCESS_CHEMISTRY)
...
/datum/job/scientist/New()
	...
	total_positions = 2
	spawn_positions = 2
	access = list(ACCESS_ROBOTICS, ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_RESEARCH, ACCESS_MINERAL_STOREROOM)
	minimal_access = list(ACCESS_ROBOTICS, ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_RESEARCH, ACCESS_MINERAL_STOREROOM)
