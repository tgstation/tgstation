#define JOB_MODIFICATION_MAP_NAME "Runtime Station"
...
/datum/job/assistant/New()
    ...
    total_positions = 200
    spawn_positions = 200
    supervisors = "<span class='danger'>the Gods</span>. Make sure to report to the locker rooms if you're participating in a fight"
