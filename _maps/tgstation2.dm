...
#if !defined(MAP_FILE)
		//zlevel amount:7
        #include "map_files\TgStation\tgstation.2.1.3.dmm"//1 linked
        #include "map_files\generic\z2.dmm"//2 unlinked
        #include "map_files\generic\z3.dmm"//3 linked
        #include "map_files\generic\z4.dmm"//4 linked
        #include "map_files\generic\z5.dmm"//5 linked
        #include "map_files\generic\z6.dmm"//6 linked
        #include "map_files\generic\z7.dmm"//7 linked

        #define MAP_FILE "tgstation.2.1.3.dmm"
        #define MAP_NAME "TGstation2"
