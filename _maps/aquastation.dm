...
*/
		...
		#define MAP_PATH "map_files/AquaStation"
        #define MAP_FILE "aquastation.dmm"
        #define MAP_NAME "AquaStation"
	...
	#warn a map has already been included, ignoring AquaStation.
