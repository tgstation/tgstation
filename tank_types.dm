...
/obj/item/tank/internals/plasmaman
	...
	desc = "A tank of plasma gas designed specifically for use as internals, particularly for plasma-based lifeforms.  It has a sophisticated set of jaws for devouring plasma sheets.  If you're not a Plasmaman, you probably shouldn't use this."
